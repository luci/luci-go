...
type GitilesClient interface {
	...
	History(c context.Context, oldRevision, newRevision string) ([]gitiles.Commit, error)
}
...
func (g *GitilesClientImpl) History(c context.Context, oldRevision, newRevision string) ([]gitiles.Commit, error) {
