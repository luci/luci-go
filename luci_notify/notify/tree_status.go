...
func UpdateTreeStatus(c *router.Context) {
	...
	if err := updateTrees(ctx, &DummyTreeStatusApp{}); err != nil {
...
func updateTrees(c context.Context, ts TreeStatusApp) error {
...
func updateHost(ts TreeStatusApp, host string, treeClosers []*config.TreeCloser) error {
