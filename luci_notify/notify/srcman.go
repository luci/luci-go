...
func getCheckout(c context.Context, build *Build) (Checkout, error) {
	...
	case log == nil:
		return nil, errors.Reason(
			"unable to find source manifest in project %s at path %s",
			build.Infra.Logdog.Project, logPath).Err()
	}
