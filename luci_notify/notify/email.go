...
// HTMLBody sets the Email's HTML body by rendering a template.
func (e *Email) HTMLBody(body *template.Template, context interface{}) (*Email, error) {
	var buffer bytes.Buffer
	if err := body.Execute(&buffer, context); err != nil {
		return nil, err
	}
	e.m.HTMLBody = buffer.String()
	return e, nil
}
