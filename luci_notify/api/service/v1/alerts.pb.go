...
const file_go_chromium_org_luci_luci_notify_api_service_v1_alerts_proto_rawDesc = "" +
	"\n" +
	"<go.chromium.org/luci/luci_notify/api/service/v1/alerts.proto\x12\x0eluci.notify.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"-\n" +
	"\x15BatchGetAlertsRequest\x12\x14\n" +
	"\x05names\x18\x01 \x03(\tR\x05names\"\xcd\x01\n" +
	"\x05Alert\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x03\xe0A\x05R\x04name\x12\x10\n" +
	"\x03bug\x18\x03 \x01(\x03R\x03bug\x12#\n" +
	"\rsilence_until\x18\x04 \x01(\x03R\fsilenceUntil\x12\x1b\n" +
	"\tgerrit_cl\x18\a \x01(\x03R\bgerritCl\x12@\n" +
	"\vmodify_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"modifyTime\x12\x12\n" +
	"\x04etag\x18\x06 \x01(\tR\x04etag\"G\n" +
	"\x16BatchGetAlertsResponse\x12-\n" +
	"\x06alerts\x18\x01 \x03(\v2\x15.luci.notify.v1.AlertR\x06alerts\"A\n" +
	"\x12UpdateAlertRequest\x12+\n" +
	"\x05alert\x18\x01 \x01(\v2\x15.luci.notify.v1.AlertR\x05alert\"Z\n" +
	"\x18BatchUpdateAlertsRequest\x12>\n" +
	"\brequests\x18\x01 \x03(\v2\".luci.notify.v1.UpdateAlertRequestR\brequests\"J\n" +
	"\x19BatchUpdateAlertsResponse\x12-\n" +
	"\x06alerts\x18\x01 \x03(\v2\x15.luci.notify.v1.AlertR\x06alerts2\xd7\x01\n" +
	"\x06Alerts\x12a\n" +
	"\x0eBatchGetAlerts\x12%.luci.notify.v1.BatchGetAlertsRequest\x1a&.luci.notify.v1.BatchGetAlertsResponse\"\x00\x12j\n" +
	"\x11BatchUpdateAlerts\x12(.luci.notify.v1.BatchUpdateAlertsRequest\x1a).luci.notify.v1.BatchUpdateAlertsResponse\"\x00B>Z<go.chromium.org/luci/luci_notify/api/service/v1;lucinotifypbb\x06proto3"
