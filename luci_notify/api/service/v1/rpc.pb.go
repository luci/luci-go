...
func file_go_chromium_org_luci_luci_notify_api_service_v1_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_luci_notify_api_service_v1_rpc_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_luci_notify_api_service_v1_rpc_proto_msgTypes[1].Exporter = func(v any, i int) any {
