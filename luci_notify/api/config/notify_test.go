...
func TestNotification(t *testing.T) {
	...
	Convey("ShouldNotify", t, func() {
		n := Notification{}
		n.OnOccurrence = &Notification_NotificationStatus{}
		n.OnNewStatus = &Notification_NotificationStatus{}
		...
		Convey("Success", func() {
			n.OnOccurrence.StatusSuccess = true
		...
		Convey("Failure", func() {
			n.OnOccurrence.StatusFailure = true
		...
		Convey("InfraFailure", func() {
			n.OnOccurrence.StatusInfraFailure = true
		...
		Convey("New Failure", func() {
			n.OnNewStatus.StatusFailure = true
		...
		Convey("New InfraFailure", func() {
			n.OnNewStatus.StatusInfraFailure = true
		...
		Convey("InfraFailure and new Failure and new Success", func() {
			n.OnOccurrence.StatusInfraFailure = true
			n.OnNewStatus.StatusFailure = true
			n.OnNewStatus.StatusSuccess = true
