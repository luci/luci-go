...
const luciNotifyAccessGroup = "luci-notify-access"
const luciNotifyWriteAccessGroup = "luci-notify-writers"
...
func checkAllowedPrelude(ctx context.Context, methodName string, req proto.Message) (context.Context, error) {
	if err := checkAllowed(ctx, luciNotifyAccessGroup); err != nil {
		return ctx, err
	}
	return ctx, nil
}
