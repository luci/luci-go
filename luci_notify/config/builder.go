...
type Builder struct {
	...
	// StatusGitilesCommits are the gitiles commits checked out by the last build
	// that caused a Status update AND had a non-empty checkout. It can also be used
	// to compute a blamelist.
