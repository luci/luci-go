...
// NotifyBlamelist returns true if this builder has any blamelist notifications set.
func (b *Builder) NotifyBlamelist() bool {
	for _, n := range b.Notifications.GetNotifications() {
		if n.GetNotifyBlamelist() != nil {
			return true
		}
	}
	return false
