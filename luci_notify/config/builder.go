...
type Builder struct {
	...
	// for this builder is encountered. More specifically, if the internal value is
	// non-nil, then notifications will be sent to the blamelist for the build, using
	// the configuration defined therein.
	BlamelistNotification notifypb.OptionalBlamelistNotification
