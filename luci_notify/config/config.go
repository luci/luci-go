...
// WithRemoteConfigService sets a luci_notify config interface to be used for all config interaction.
func WithRemoteConfigService(c context.Context, cInterface configInterface.Interface) context.Context {
