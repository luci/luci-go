...
![LUCI chip in Gerrit](https://github.com/luci/luci-go/raw/master/docs/images/gerrit.png)
...
by adding to your CL description footer 
`No-Equivalent-Builders: true` 
[example](https://chromium-review.googlesource.com/c/chromium/src/+/541299/4..5//COMMIT_MSG).
