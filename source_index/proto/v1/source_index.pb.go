...
var file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDesc = []byte{
...
var (
	...
	file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDescData = file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDesc
)
...
func file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryCommitHashRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryCommitHashResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_go_chromium_org_luci_source_index_proto_v1_source_index_proto_rawDesc = nil
...
type SourceIndexClient interface {
	// QueryCommitHash returns commit that matches desired position of commit, based on
	// QueryCommitHashRequest parameters. Commit position is based on git-footer
