...
func file_go_chromium_org_luci_source_index_proto_config_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_source_index_proto_config_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_source_index_proto_config_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_source_index_proto_config_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
