...
GOOS=windows go build -o tmp/cas.exe go.chromium.org/luci/client/cmd/cas
GOOS=windows go build -o tmp/isolated.exe go.chromium.org/luci/client/cmd/isolated
