...
func BenchmarkS(b *testing.B) {
	for i := 0; i < 1000; i++ {
		ValidateProjectID(`abcdefghijklmnopqrstuvwxy`)
		ValidateProjectID(`abcdefghijklmnopqrtuvwxy`)
		ValidateProjectID(`abcdefghijklmnopqruvwxy`)
		ValidateProjectID(`abcdefghijklmnotuvwxy`)
		ValidateProjectID(`abcdefghijknoqrstuvwxy`)
		ValidateProjectID(`abcdefgilmnoqrstuvwxy`)
	}
}
