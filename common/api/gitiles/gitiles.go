...
// ancestors of rx (rx-1, rx-2, ..., rx-n) but may not reach r1 necessarily if
// the delta between the commits reachable from rx and the commits reachable
// from r1 is larger than the a given limit; LogForward will keep paging back
// until it reaches r1 and will return the last page in reverse order (r1, r2,
// r3, ..., rlimit).
//
