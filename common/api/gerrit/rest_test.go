...
func TestCheckAccess(t *testing.T) {
	...
	Convey("CheckAccess validate args", t, func() {
		srv, c := newMockClient2(func(w http.ResponseWriter, r *http.Request) {})
		defer srv.Close()
...
func newMockClient2(handler func(w http.ResponseWriter, r *http.Request)) (*httptest.Server, gerritpb.GerritClient) {
