...
// WARNING: The structs in this file are incomplete, so if you want access to
// a particular field from this API, you may need to tweak rest.go to add
...
func (fi *fileInfo) ToProto() *gerritpb.FileInfo {
	return &gerritpb.FileInfo{
		LinesInserted: int32(fi.LinesInserted),
		LinesDeleted:  int32(fi.LinesDeleted),
