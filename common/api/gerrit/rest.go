...
func (c *client) GetBranchInfo(ctx context.Context, req *gerritpb.BranchInfoRequest, opts ...grpc.CallOption) (*gerritpb.BranchInfo, error) {
	var resp gerritpb.BranchInfo
