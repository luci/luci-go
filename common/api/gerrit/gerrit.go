...
type AccountInfo struct {
	// AccountID is the numeric ID of the account managed by Gerrit.
...
type ReviewInput struct {
	...
	//
	// Tags may be used for by CI or other automated systems to distinguish them from human
	// reviews.
	Tag string `json:"tag,omitempty"`

	// Labels represnets the votes that should be added to the revision as a map of label names
	// to voting values.
...
// ReviewerInfo contains information about a reviewer and its votes on a change.
//
// It has the same fields as AccountInfo, except the _account_id is optional if an unregistered reviewer
// was added.
...
// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#change-id
//
// The revisionID paramater may be in any of the forms supported by Gerrit:
//   - "current"
//   - a commit ID
