...
// the buffer. This will not be re-computed by Buffer, but can be adjusted
...
type Batch struct {
	// Data is the work items pushed into the Buffer, plus their computed
	// Size.
	Data []BatchItem
	...
	// countedSize is the number of bytes of this Batch as the Buffer counts
...
func (b *Batch) canAccept(o *Options, itemSize int) bool {
	...
	if o.BatchItemsMax > -1 && b.countedItems+1 > o.BatchItemsMax {
		return false
	}
	if o.BatchSizeMax > -1 && b.countedSize+itemSize > o.BatchSizeMax {
		return false
	}
	return true
}
