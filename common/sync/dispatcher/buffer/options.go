...
type Options struct {
	...
	// dropped.
	//
	// If the retry.Iterator returns <= 0, it makes the NACK'd batch available to
	// send at its previously-allotted time. You can use this to implement
	// 'in-order' transmission of data by setting MaxLeases to 1 and having the
