...
type Options struct {
	...
	// [OPTIONAL] A retry.Factory which governs the retry behavior of each
	// individual Batch. When a Batch is ReQueue'd, it will be assigned a nextSend
	// value according to the Iterator produced from this.
	Retry retry.Factory
}
