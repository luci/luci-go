...
// ItemSizerFunc returns a size larger than Buffer.BatchSizeMax (i.e. you pushed
// an item which couldn't fit inside of a Batch). Similarly, if your
// ItemSizerFunc returns 0, this is invoked with buffer.ErrZeroSizeItem.
...
type Options struct {
	...
	//
	// Must return a non-zero value less than BatchSizeMax.
	ItemSizerFunc func(itm interface{}) int
