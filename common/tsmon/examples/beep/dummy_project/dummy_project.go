...
func (t *DummyProject) PopulateProto(d *pb.MetricsCollection) {
	...
	// it's questionable whether (2) is meaningfully slower than (1).
	...
	// represents the client of the platform. If a given Target proto will be
	// used to report monitoring data in platform software, (1) would probably
