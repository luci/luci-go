...
func RunStoreImplementationTests(t *testing.T, ctx context.Context, opts TestOptions) {
				...
				Convey(fmt.Sprintf("%d. %s", i, test.typ), func() {
					...
					if test.bucketer != nil {
						m = &fakeDistributionMetric{FakeMetric{
							types.MetricInfo{"m", "", []field.Field{}, test.typ, target.TaskType},
		...
		Convey("With fields", func() {
			for i, test := range tests {
				Convey(fmt.Sprintf("%d. %s", i, test.typ), func() {
					...
					if test.bucketer != nil {
						m = &fakeDistributionMetric{FakeMetric{
							types.MetricInfo{"m", "", []field.Field{field.String("f")}, test.typ, target.TaskType},
							types.MetricMetadata{}}, test.bucketer}
					} else {
						m = &FakeMetric{
							types.MetricInfo{"m", "", []field.Field{field.String("f")}, test.typ, target.TaskType},
				...
				Convey(fmt.Sprintf("%d. %s", i, test.typ), func() {
					...
					if test.bucketer != nil {
						m = &fakeDistributionMetric{
							FakeMetric{types.MetricInfo{"m", "", []field.Field{}, test.typ, target.TaskType},
								types.MetricMetadata{}},
							test.bucketer}
					} else {
						m = &FakeMetric{
	...
	Convey("GetAll", t, func() {
		...
		s := opts.Factory()
		foo := &FakeMetric{
			types.MetricInfo{"foo", "", []field.Field{}, types.NonCumulativeIntType, target.TaskType},
			types.MetricMetadata{}}
		bar := &FakeMetric{
			types.MetricInfo{"bar", "", []field.Field{field.String("f")}, types.StringType, target.TaskType},
			types.MetricMetadata{}}
		baz := &FakeMetric{
			types.MetricInfo{"baz", "", []field.Field{field.String("f")}, types.NonCumulativeFloatType, target.TaskType},
			types.MetricMetadata{}}
		opts.RegistrationFinished(s)
	...
	Convey("Concurrency", t, func() {
		...
		Convey("Incr", func(c C) {
			s := opts.Factory()
			m := &FakeMetric{
				types.MetricInfo{"m", "", []field.Field{}, types.CumulativeIntType, target.TaskType},
				types.MetricMetadata{}}
