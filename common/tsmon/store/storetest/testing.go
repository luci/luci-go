		...
		Convey("With no fields", func() {
			for i, test := range tests {
				Convey(fmt.Sprintf("%d. %s", i, test.typ), func() {
					...
					// Delete the value. Then, get should return nil.
		...
		Convey("With a target set in the context", func() {
			for i, test := range tests {
				...
				Convey(fmt.Sprintf("%d. %s", i, test.typ), func() {
					...
					// Del the value for the custom target. Then, get should return
					// the value for the default target, but nil for the custom target.
