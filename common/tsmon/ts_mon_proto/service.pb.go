...
var file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x5f, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x17, 0x67, 0x6f,
	...
	,
...
var (
	...
	file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDescData = file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDesc
)
...
func file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_goTypes = []interface{}{
	(*MonitoringInsertRequest)(nil),  // 0: ts_mon.proto.MonitoringInsertRequest
	(*MonitoringInsertResponse)(nil), // 1: ts_mon.proto.MonitoringInsertResponse
...
var file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_depIdxs = []int32{
	2, // 0: ts_mon.proto.MonitoringInsertRequest.payload:type_name -> ts_mon.proto.MetricsPayload
	3, // 1: ts_mon.proto.MonitoringInsertResponse.response_status:type_name -> google.rpc.Status
	0, // 2: ts_mon.proto.MonitoringService.Insert:input_type -> ts_mon.proto.MonitoringInsertRequest
	1, // 3: ts_mon.proto.MonitoringService.Insert:output_type -> ts_mon.proto.MonitoringInsertResponse
...
func file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MonitoringInsertRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MonitoringInsertResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_go_chromium_org_luci_common_tsmon_ts_mon_proto_service_proto_rawDesc = nil
...
func (c *monitoringServicePRPCClient) Insert(ctx context.Context, in *MonitoringInsertRequest, opts ...grpc.CallOption) (*MonitoringInsertResponse, error) {
	...
	err := c.client.Call(ctx, "ts_mon.proto.MonitoringService", "Insert", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *monitoringServiceClient) Insert(ctx context.Context, in *MonitoringInsertRequest, opts ...grpc.CallOption) (*MonitoringInsertResponse, error) {
	out := new(MonitoringInsertResponse)
	err := c.cc.Invoke(ctx, "/ts_mon.proto.MonitoringService/Insert", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MonitoringService_Insert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ts_mon.proto.MonitoringService/Insert",
	}
...
var _MonitoringService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ts_mon.proto.MonitoringService",
