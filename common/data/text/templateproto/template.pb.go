...
It is generated from these files:
	go.chromium.org/luci/common/data/text/templateproto/template.proto
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/common/data/text/templateproto/template.proto", fileDescriptor0)
}
