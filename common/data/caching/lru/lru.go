...
//
// The returned Item will be stored in the cache after Maker exits.
//
// If the Maker returns an error, the returned Item will not be cached, and
...
// no modifications will be made to the Cache. If Maker returns nil, the value
// that it returns will be added into the Cache and returned.
//
