...
func getRand(ctx context.Context) Rand {
	if r, ok := ctx.Value(&key).(Rand); ok {
		return r
	}
	return nil
}
...
func Get(ctx context.Context) Rand {
	if r := getRand(ctx); r != nil {
		return r
	}
...
func Int63(ctx context.Context) int64 { return Get(ctx).Int63() }

// Uint32 returns a pseudo-random 32-bit value as a uint32 from the source in
// the context or the shared global source.
func Uint32(ctx context.Context) uint32 { return Get(ctx).Uint32() }
...
func Int31(ctx context.Context) int32 { return Get(ctx).Int31() }

// Int returns a non-negative pseudo-random int from the source in the context
// or the shared global source.
func Int(ctx context.Context) int { return Get(ctx).Int() }

// Int63n returns, as an int64, a non-negative pseudo-random number in [0,n)
// from the source in the context or the shared global source.
//
// It panics if n <= 0.
func Int63n(ctx context.Context, n int64) int64 { return Get(ctx).Int63n(n) }

// Int31n returns, as an int32, a non-negative pseudo-random number in [0,n)
// from the source in the context or the shared global source.
//
// It panics if n <= 0.
func Int31n(ctx context.Context, n int32) int32 { return Get(ctx).Int31n(n) }

// Intn returns, as an int, a non-negative pseudo-random number in [0,n) from
// the source in the context or the shared global source.
//
// It panics if n <= 0.
func Intn(ctx context.Context, n int) int { return Get(ctx).Intn(n) }

// Float64 returns, as a float64, a pseudo-random number in [0.0,1.0) from
// the source in the context or the shared global source.
func Float64(ctx context.Context) float64 { return Get(ctx).Float64() }

// Float32 returns, as a float32, a pseudo-random number in [0.0,1.0) from
// the source in the context or the shared global source.
func Float32(ctx context.Context) float32 { return Get(ctx).Float32() }
...
func Perm(ctx context.Context, n int) []int { return Get(ctx).Perm(n) }
...
// and a nil error.
func Read(ctx context.Context, p []byte) (n int, err error) { return Get(ctx).Read(p) }
...
func NormFloat64(ctx context.Context) float64 { return Get(ctx).NormFloat64() }
...
func ExpFloat64(ctx context.Context) float64 { return Get(ctx).ExpFloat64() }
