...
func (e *Emulator) NewTempDB(ctx context.Context, cfg TempDBConfig) (*TempDB, error) {
	...
	opts := []option.ClientOption{option.WithGRPCDialOption(grpc.WithPerRPCCredentials(creds))}
