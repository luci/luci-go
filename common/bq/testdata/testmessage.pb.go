...
type TestMessage struct {
	...
	Struct         *google_protobuf2.Struct    `protobuf:"bytes,5,opt,name=struct" json:"struct,omitempty"`
	...
	Empty          *google_protobuf.Empty      `protobuf:"bytes,8,opt,name=empty" json:"empty,omitempty"`
	Empties        []*google_protobuf.Empty    `protobuf:"bytes,9,rep,name=empties" json:"empties,omitempty"`
}
...
func (m *TestMessage) GetStruct() *google_protobuf2.Struct {
	if m != nil {
		return m.Struct
	}
	return nil
...
func (m *TestMessage) GetEmpty() *google_protobuf.Empty {
	if m != nil {
		return m.Empty
	}
	return nil
...
func (m *TestMessage) GetEmpties() []*google_protobuf.Empty {
	if m != nil {
		return m.Empties
	}
	return nil
