...
type Location_Range struct {
	...
	//
	// If unset, the range includes the entire file, and all the other fields
	// are ignored.
	...
	//
	// If unset, the range includes the entire line specified by start_line.
	...
	//
	// Must be set if start_column is set.
	// Ignored, if start_column or end_line is unset.
	// If unset, the range includes the entire line specified by end_line.
