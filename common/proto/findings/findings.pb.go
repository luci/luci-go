...
func (Finding_SeverityLevel) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_findings_findings_proto_rawDescGZIP(), []int{0, 0}
}
...
type Finding struct {
	...
	Fix []*Fix `protobuf:"bytes,7,rep,name=fix,proto3" json:"fix,omitempty"`
}
...
type Fix struct {
	...
	Replacement []*Fix_Replacement `protobuf:"bytes,2,rep,name=replacement,proto3" json:"replacement,omitempty"`
}
...
func (x *Fix) GetReplacement() []*Fix_Replacement {
	if x != nil {
...
type Location_Range struct {
	...
	//
	// If not provided, the entire file is included in the range. The rest of
	// the fields will be omitted.
	StartLine int32 `protobuf:"varint,1,opt,name=start_line,json=startLine,proto3" json:"start_line,omitempty"`
	// Start column of the range (1-based).
	//
	// Must provide start_line if provided. If not provided, the entire line is
	...
	//
	// Must provide start_line if provided. If not provided, the range will only
	// include the entire line specified by start_line.
	EndLine int32 `protobuf:"varint,3,opt,name=end_line,json=endLine,proto3" json:"end_line,omitempty"`
	// End column of the range (1-based).
	// Must provide all other fields if provided. If not provided, the range
	// include the entire line specified by end_line.
...
func (*Location_Range) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_findings_findings_proto_rawDescGZIP(), []int{1, 1}
}
...
var file_go_chromium_org_luci_common_proto_findings_findings_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x66, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x22, 0xa5, 0x02, 0x0a, 0x07, 0x46,
	...
	0x0d, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x24,
	0x0a, 0x03, 0x66, 0x69, 0x78, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x75,
	0x63, 0x69, 0x2e, 0x66, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x46, 0x69, 0x78, 0x52,
	0x03, 0x66, 0x69, 0x78, 0x22, 0x3c, 0x0a, 0x0d, 0x53, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79,
	...
	,
	...
	0x08, 0x70, 0x61, 0x74, 0x63, 0x68, 0x73, 0x65, 0x74, 0x1a, 0x83, 0x01, 0x0a, 0x05, 0x52, 0x61,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x65, 0x6e, 0x64, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x42,
	0x08, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x03, 0x46, 0x69,
	...
	,
...
var file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_go_chromium_org_luci_common_proto_findings_findings_proto_goTypes = []any{
	...
	(*Finding)(nil),                        // 1: luci.findings.Finding
	(*Location)(nil),                       // 2: luci.findings.Location
	(*Fix)(nil),                            // 3: luci.findings.Fix
	(*Location_GerritChangeReference)(nil), // 4: luci.findings.Location.GerritChangeReference
	(*Location_Range)(nil),                 // 5: luci.findings.Location.Range
	(*Fix_Replacement)(nil),                // 6: luci.findings.Fix.Replacement
}
var file_go_chromium_org_luci_common_proto_findings_findings_proto_depIdxs = []int32{
	2, // 0: luci.findings.Finding.location:type_name -> luci.findings.Location
	0, // 1: luci.findings.Finding.severity_level:type_name -> luci.findings.Finding.SeverityLevel
	3, // 2: luci.findings.Finding.fix:type_name -> luci.findings.Fix
	4, // 3: luci.findings.Location.gerrit_change_ref:type_name -> luci.findings.Location.GerritChangeReference
	5, // 4: luci.findings.Location.range:type_name -> luci.findings.Location.Range
	6, // 5: luci.findings.Fix.replacement:type_name -> luci.findings.Fix.Replacement
	2, // 6: luci.findings.Fix.Replacement.location:type_name -> luci.findings.Location
...
func file_go_chromium_org_luci_common_proto_findings_findings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Fix); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Location_GerritChangeReference); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Fix_Replacement); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_common_proto_findings_findings_proto_msgTypes[1].OneofWrappers = []any{
