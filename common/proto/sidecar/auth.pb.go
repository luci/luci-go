...
func file_go_chromium_org_luci_common_proto_sidecar_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_common_proto_sidecar_auth_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_common_proto_sidecar_auth_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
