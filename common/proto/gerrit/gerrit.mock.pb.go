...
func (m *MockGerritClient) AddToAttentionSet(ctx context.Context, in *AttentionSetRequest, opts ...grpc.CallOption) (*AddToAttentionSetResult, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*AddToAttentionSetResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// AddToAttentionSet mocks base method.
func (m *MockGerritServer) AddToAttentionSet(arg0 context.Context, arg1 *AttentionSetRequest) (*AddToAttentionSetResult, error) {
	m.ctrl.T.Helper()
