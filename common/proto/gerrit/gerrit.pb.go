...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x29, 0x0a, 0x13, 0x4c, 0x69,
	...
	0x0a, 0x06, 0x54, 0x48, 0x45, 0x49, 0x52, 0x53, 0x10, 0x05, 0x32, 0xec, 0x08, 0x0a, 0x06, 0x47,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	(*AccountOptions)(nil),               // 40: gerrit.AccountOptions
	(*ListFileOwnersRequest)(nil),        // 41: gerrit.ListFileOwnersRequest
	(*OwnerInfo)(nil),                    // 42: gerrit.OwnerInfo
	(*ListOwnersResponse)(nil),           // 43: gerrit.ListOwnersResponse
	nil,                                  // 44: gerrit.ChangeInfo.RevisionsEntry
	nil,                                  // 45: gerrit.ChangeInfo.LabelsEntry
	nil,                                  // 46: gerrit.RevisionInfo.FilesEntry
	nil,                                  // 47: gerrit.ReviewerInfo.ApprovalsEntry
	nil,                                  // 48: gerrit.SetReviewRequest.LabelsEntry
	nil,                                  // 49: gerrit.ReviewResult.LabelsEntry
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	44, // 5: gerrit.ChangeInfo.revisions:type_name -> gerrit.ChangeInfo.RevisionsEntry
	45, // 6: gerrit.ChangeInfo.labels:type_name -> gerrit.ChangeInfo.LabelsEntry
	16, // 7: gerrit.ChangeInfo.messages:type_name -> gerrit.ChangeMessageInfo
	53, // 8: gerrit.ChangeInfo.created:type_name -> google.protobuf.Timestamp
	53, // 9: gerrit.ChangeInfo.updated:type_name -> google.protobuf.Timestamp
	...
	46, // 12: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	...
	53, // 19: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	...
	47, // 24: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	...
	48, // 27: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	49, // 28: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	...
	50, // 33: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	8,  // 34: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	51, // 35: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	35, // 36: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	52, // 37: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	40, // 38: gerrit.ListFileOwnersRequest.options:type_name -> gerrit.AccountOptions
	12, // 39: gerrit.OwnerInfo.account:type_name -> gerrit.AccountInfo
	42, // 40: gerrit.ListOwnersResponse.owners:type_name -> gerrit.OwnerInfo
