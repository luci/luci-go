...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x54, 0x48, 0x45, 0x49, 0x52, 0x53, 0x10, 0x05, 0x32, 0xd6, 0x0a, 0x0a, 0x06, 0x47, 0x65, 0x72,
	...
	0x6f, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d,
	0x2e, 0x6f, 0x72, 0x67, 0x2f, 0x6c, 0x75, 0x63, 0x69, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x3b, 0x67, 0x65,
	0x72, 0x72, 0x69, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	(*GetPureRevertRequest)(nil),         // 50: gerrit.GetPureRevertRequest
	(*PureRevertInfo)(nil),               // 51: gerrit.PureRevertInfo
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	64, // 8: gerrit.ChangeInfo.created:type_name -> google.protobuf.Timestamp
	64, // 9: gerrit.ChangeInfo.updated:type_name -> google.protobuf.Timestamp
	...
	54, // 13: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	55, // 14: gerrit.CommitInfo.parents:type_name -> gerrit.CommitInfo.Parent
	...
	56, // 20: gerrit.LabelInfo.values:type_name -> gerrit.LabelInfo.ValuesEntry
	...
	64, // 23: gerrit.ApprovalInfo.date:type_name -> google.protobuf.Timestamp
	...
	64, // 26: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	...
	57, // 31: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	...
	58, // 34: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	59, // 35: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	...
	60, // 40: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	61, // 41: gerrit.GetRelatedChangesResponse.changes:type_name -> gerrit.GetRelatedChangesResponse.ChangeAndCommit
	8,  // 42: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	62, // 43: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	41, // 44: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	63, // 45: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	...
	50, // 63: gerrit.Gerrit.GetPureRevert:input_type -> gerrit.GetPureRevertRequest
	...
	51, // 82: gerrit.Gerrit.GetPureRevert:output_type -> gerrit.PureRevertInfo
	13, // 83: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	65, // 84: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	65, // 85: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	65, // 86: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	29, // 87: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	65, // 88: gerrit.Gerrit.DeleteReviewer:output_type -> google.protobuf.Empty
	32, // 89: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	12, // 90: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	13, // 91: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	13, // 92: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
