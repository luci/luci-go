...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2a, 0x89, 0x04, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f, 0x70, 0x74,
	...
	0x48, 0x45, 0x49, 0x52, 0x53, 0x10, 0x05, 0x32, 0x9b, 0x0b, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72,
	...
	0x65, 0x52, 0x65, 0x76, 0x65, 0x72, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x3f, 0x0a, 0x0c, 0x43,
	...
	0x69, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x41, 0x0a,
	0x0d, 0x41, 0x62, 0x61, 0x6e, 0x64, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x1c,
	0x2e, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x2e, 0x41, 0x62, 0x61, 0x6e, 0x64, 0x6f, 0x6e, 0x43,
	...
	,
}
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	70, // 42: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	...
	71, // 45: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	...
	72, // 50: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	...
	73, // 57: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	74, // 58: gerrit.GetRelatedChangesResponse.changes:type_name -> gerrit.GetRelatedChangesResponse.ChangeAndCommit
	10, // 59: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	75, // 60: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	50, // 61: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	76, // 62: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	...
	4,  // 70: gerrit.NotifyDetails.Recipient.recipient_type:type_name -> gerrit.NotifyDetails.RecipientType
	63, // 71: gerrit.NotifyDetails.Recipient.info:type_name -> gerrit.NotifyDetails.Info
	19, // 72: gerrit.ChangeInfo.RevisionsEntry.value:type_name -> gerrit.RevisionInfo
	21, // 73: gerrit.ChangeInfo.LabelsEntry.value:type_name -> gerrit.LabelInfo
	26, // 74: gerrit.RevisionInfo.FilesEntry.value:type_name -> gerrit.FileInfo
	26, // 75: gerrit.ListFilesResponse.FilesEntry.value:type_name -> gerrit.FileInfo
	20, // 76: gerrit.GetRelatedChangesResponse.ChangeAndCommit.commit:type_name -> gerrit.CommitInfo
	51, // 77: gerrit.ListProjectsResponse.ProjectsEntry.value:type_name -> gerrit.ProjectInfo
	49, // 78: gerrit.Gerrit.ListProjects:input_type -> gerrit.ListProjectsRequest
	53, // 79: gerrit.Gerrit.GetRefInfo:input_type -> gerrit.RefInfoRequest
	56, // 80: gerrit.Gerrit.ListFileOwners:input_type -> gerrit.ListFileOwnersRequest
	13, // 81: gerrit.Gerrit.ListChanges:input_type -> gerrit.ListChangesRequest
	15, // 82: gerrit.Gerrit.GetChange:input_type -> gerrit.GetChangeRequest
	43, // 83: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	45, // 84: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	47, // 85: gerrit.Gerrit.GetRelatedChanges:input_type -> gerrit.GetRelatedChangesRequest
	59, // 86: gerrit.Gerrit.GetPureRevert:input_type -> gerrit.GetPureRevertRequest
	27, // 87: gerrit.Gerrit.CreateChange:input_type -> gerrit.CreateChangeRequest
	31, // 88: gerrit.Gerrit.ChangeEditFileContent:input_type -> gerrit.ChangeEditFileContentRequest
	32, // 89: gerrit.Gerrit.DeleteEditFileContent:input_type -> gerrit.DeleteEditFileContentRequest
	33, // 90: gerrit.Gerrit.ChangeEditPublish:input_type -> gerrit.ChangeEditPublishRequest
	35, // 91: gerrit.Gerrit.AddReviewer:input_type -> gerrit.AddReviewerRequest
	38, // 92: gerrit.Gerrit.DeleteReviewer:input_type -> gerrit.DeleteReviewerRequest
	39, // 93: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	41, // 94: gerrit.Gerrit.AddToAttentionSet:input_type -> gerrit.AttentionSetRequest
	28, // 95: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	34, // 96: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	29, // 97: gerrit.Gerrit.SubmitRevision:input_type -> gerrit.SubmitRevisionRequest
	52, // 98: gerrit.Gerrit.ListProjects:output_type -> gerrit.ListProjectsResponse
	54, // 99: gerrit.Gerrit.GetRefInfo:output_type -> gerrit.RefInfo
	58, // 100: gerrit.Gerrit.ListFileOwners:output_type -> gerrit.ListOwnersResponse
	14, // 101: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	17, // 102: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	44, // 103: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	46, // 104: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
	48, // 105: gerrit.Gerrit.GetRelatedChanges:output_type -> gerrit.GetRelatedChangesResponse
	60, // 106: gerrit.Gerrit.GetPureRevert:output_type -> gerrit.PureRevertInfo
	17, // 107: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	78, // 108: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	78, // 109: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	78, // 110: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	37, // 111: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	78, // 112: gerrit.Gerrit.DeleteReviewer:output_type -> google.protobuf.Empty
	40, // 113: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	16, // 114: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	17, // 115: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	17, // 116: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
	30, // 117: gerrit.Gerrit.SubmitRevision:output_type -> gerrit.SubmitInfo
