...
func (Requirement_Status) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDescGZIP(), []int{12, 0}
}
...
func (AddReviewerRequest_State) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDescGZIP(), []int{20, 0}
}
...
func (MergeableInfo_SubmitType) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDescGZIP(), []int{28, 0}
}
...
// Information for requesting the comments on a change.
//
...
func (x *ListChangeCommentsRequest) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *ListChangeCommentsRequest) GetProject() string {
	if x != nil {
		return x.Project
	}
	return ""
...
func (x *ListChangeCommentsRequest) GetRevisionId() string {
	if x != nil {
		return x.RevisionId
	}
	return ""
...
type CommentRange struct {
	...
	StartCharacter int64 `protobuf:"varint,2,opt,name=start_character,json=startCharacter,proto3" json:"start_character,omitempty"`
	EndLine        int64 `protobuf:"varint,3,opt,name=end_line,json=endLine,proto3" json:"end_line,omitempty"`
	EndCharacter   int64 `protobuf:"varint,4,opt,name=end_character,json=endCharacter,proto3" json:"end_character,omitempty"`
}

func (x *CommentRange) Reset() {
	*x = CommentRange{}
	if protoimpl.UnsafeEnabled {
...
func (x *CommentRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CommentRange) ProtoMessage() {}

func (x *CommentRange) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[46]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CommentRange.ProtoReflect.Descriptor instead.
func (*CommentRange) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDescGZIP(), []int{46}
}

func (x *CommentRange) GetStartLine() int64 {
	if x != nil {
		return x.StartLine
	}
	return 0
...
func (x *CommentRange) GetStartCharacter() int64 {
	if x != nil {
...
func (x *CommentRange) GetEndLine() int64 {
	if x != nil {
		return x.EndLine
	}
	return 0
...
func (x *CommentRange) GetEndCharacter() int64 {
	if x != nil {
...
// Comment represents a comment on a Gerrit CL.
// See:
...
type Comment struct {
	...
	Author          *AccountInfo `protobuf:"bytes,2,opt,name=author,proto3" json:"author,omitempty"`
	ChangeMessageId string       `protobuf:"bytes,3,opt,name=change_message_id,json=changeMessageId,proto3" json:"change_message_id,omitempty"`
	// Patch set on which this comment was made.
	PatchSet int64 `protobuf:"varint,4,opt,name=patch_set,json=patchSet,proto3" json:"patch_set,omitempty"`
	// Line on which this comment was made.
	Line int64 `protobuf:"varint,5,opt,name=line,proto3" json:"line,omitempty"`
	// Selection on which this comment was made.
	Range *CommentRange `protobuf:"bytes,6,opt,name=range,proto3" json:"range,omitempty"`
	// Timestamp of comment.
	Updated string `protobuf:"bytes,7,opt,name=updated,proto3" json:"updated,omitempty"`
	// Text of the comment.
	Message string `protobuf:"bytes,8,opt,name=message,proto3" json:"message,omitempty"`
	// Is this comment still unresolved?
	Unresolved bool `protobuf:"varint,9,opt,name=unresolved,proto3" json:"unresolved,omitempty"`
	// change_message_id of comment that this comment is in reply to.
	InReplyTo string `protobuf:"bytes,10,opt,name=in_reply_to,json=inReplyTo,proto3" json:"in_reply_to,omitempty"`
	// Hash of patch set on which this comment was made.
...
func (x *Comment) GetAuthor() *AccountInfo {
	if x != nil {
		return x.Author
	}
	return nil
...
func (x *Comment) GetChangeMessageId() string {
	if x != nil {
		return x.ChangeMessageId
	}
	return ""
}

func (x *Comment) GetPatchSet() int64 {
	if x != nil {
		return x.PatchSet
	}
	return 0
...
func (x *Comment) GetRange() *CommentRange {
	if x != nil {
		return x.Range
	}
	return nil
...
func (x *Comment) GetUnresolved() bool {
	if x != nil {
		return x.Unresolved
	}
	return false
...
func (x *Comment) GetInReplyTo() string {
	if x != nil {
		return x.InReplyTo
	}
	return ""
...
func (x *Comment) GetCommitId() string {
	if x != nil {
		return x.CommitId
	}
	return ""
...
// Information about the comments on a change.
//
// See
// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#list-change-comments
type ListChangeCommentsResponse struct {
	...
	// A map of file paths to FileInfos.
	Comments map[string]*CommentList `protobuf:"bytes,1,rep,name=comments,proto3" json:"comments,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *ListChangeCommentsResponse) Reset() {
	*x = ListChangeCommentsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListChangeCommentsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListChangeCommentsResponse) ProtoMessage() {}

func (x *ListChangeCommentsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListChangeCommentsResponse.ProtoReflect.Descriptor instead.
func (*ListChangeCommentsResponse) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDescGZIP(), []int{49}
}

func (x *ListChangeCommentsResponse) GetComments() map[string]*CommentList {
	if x != nil {
		return x.Comments
	}
	return nil
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x22, 0xdc, 0x06, 0x0a,
	...
	0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x12, 0x34, 0x0a,
	...
	0x6b, 0x4f, 0x66, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x1a, 0x52, 0x0a, 0x0e, 0x52, 0x65, 0x76,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9b, 0x04, 0x0a, 0x0c,
	...
	0x09, 0x52, 0x03, 0x72, 0x65, 0x66, 0x12, 0x34, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12,
	0x2e, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x35, 0x0a, 0x05, 0x66, 0x69,
	0x6c, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x67, 0x65, 0x72, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x47, 0x0a, 0x13, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	...
	0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x87, 0x01, 0x0a, 0x1c, 0x43, 0x68,
	...
	0x22, 0x62, 0x0a, 0x14, 0x41, 0x62, 0x61, 0x6e, 0x64, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	0x09, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x22, 0xc9, 0x02, 0x0a, 0x12, 0x41, 0x64, 0x64, 0x52, 0x65, 0x76, 0x69,
	...
	0x08, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x67, 0x65, 0x72, 0x72, 0x69,
	...
	,
	...
	0x52, 0x07, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x22, 0x68, 0x0a, 0x15, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x6a, 0x65, 0x63, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x49, 0x64, 0x22, 0x92, 0x03, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x52, 0x65, 0x76, 0x69, 0x65,
	0x77, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72,
	0x12, 0x18, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	,
	...
	0x01, 0x0a, 0x13, 0x41, 0x74, 0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x74, 0x52,
	...
	0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	...
	0x61, 0x73, 0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x06, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x2e, 0x4e, 0x6f,
	0x74, 0x69, 0x66, 0x79, 0x52, 0x06, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x22, 0xb7, 0x01, 0x0a,
	...
	0x69, 0x73, 0x50, 0x75, 0x72, 0x65, 0x52, 0x65, 0x76, 0x65, 0x72, 0x74, 0x22, 0x6e, 0x0a, 0x19,
	0x4c, 0x69, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d,
	...
	,
	...
	,
	...
	0x41, 0x4e, 0x44, 0x53, 0x10, 0x80, 0x80, 0x80, 0x01, 0x2a, 0x6f, 0x0a, 0x06, 0x4e, 0x6f, 0x74,
	...
	0x05, 0x32, 0xb3, 0x0b, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74, 0x12, 0x49, 0x0a, 0x0c,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5b, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x21, 0x2e, 0x67, 0x65, 0x72,
	0x72, 0x69, 0x74, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e,
	...
	,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	(*RevisionInfo)(nil),                 // 17: gerrit.RevisionInfo
	(*CommitInfo)(nil),                   // 18: gerrit.CommitInfo
	(*LabelInfo)(nil),                    // 19: gerrit.LabelInfo
	(*ApprovalInfo)(nil),                 // 20: gerrit.ApprovalInfo
	(*VotingRangeInfo)(nil),              // 21: gerrit.VotingRangeInfo
	(*ChangeMessageInfo)(nil),            // 22: gerrit.ChangeMessageInfo
	(*Requirement)(nil),                  // 23: gerrit.Requirement
	(*FileInfo)(nil),                     // 24: gerrit.FileInfo
	(*CreateChangeRequest)(nil),          // 25: gerrit.CreateChangeRequest
	(*SubmitChangeRequest)(nil),          // 26: gerrit.SubmitChangeRequest
	(*ChangeEditFileContentRequest)(nil), // 27: gerrit.ChangeEditFileContentRequest
	(*DeleteEditFileContentRequest)(nil), // 28: gerrit.DeleteEditFileContentRequest
	(*ChangeEditPublishRequest)(nil),     // 29: gerrit.ChangeEditPublishRequest
	(*AbandonChangeRequest)(nil),         // 30: gerrit.AbandonChangeRequest
	(*AddReviewerRequest)(nil),           // 31: gerrit.AddReviewerRequest
	(*ReviewerInfo)(nil),                 // 32: gerrit.ReviewerInfo
	(*AddReviewerResult)(nil),            // 33: gerrit.AddReviewerResult
	(*DeleteReviewerRequest)(nil),        // 34: gerrit.DeleteReviewerRequest
	(*SetReviewRequest)(nil),             // 35: gerrit.SetReviewRequest
	(*ReviewResult)(nil),                 // 36: gerrit.ReviewResult
	(*AttentionSetRequest)(nil),          // 37: gerrit.AttentionSetRequest
	(*GetMergeableRequest)(nil),          // 38: gerrit.GetMergeableRequest
	(*MergeableInfo)(nil),                // 39: gerrit.MergeableInfo
	(*ListFilesRequest)(nil),             // 40: gerrit.ListFilesRequest
	(*ListFilesResponse)(nil),            // 41: gerrit.ListFilesResponse
	(*GetRelatedChangesRequest)(nil),     // 42: gerrit.GetRelatedChangesRequest
	(*GetRelatedChangesResponse)(nil),    // 43: gerrit.GetRelatedChangesResponse
	(*ListProjectsRequest)(nil),          // 44: gerrit.ListProjectsRequest
	(*WebLinkInfo)(nil),                  // 45: gerrit.WebLinkInfo
	(*ProjectInfo)(nil),                  // 46: gerrit.ProjectInfo
	(*ListProjectsResponse)(nil),         // 47: gerrit.ListProjectsResponse
	(*RefInfoRequest)(nil),               // 48: gerrit.RefInfoRequest
	(*RefInfo)(nil),                      // 49: gerrit.RefInfo
	(*AccountOptions)(nil),               // 50: gerrit.AccountOptions
	(*ListFileOwnersRequest)(nil),        // 51: gerrit.ListFileOwnersRequest
	(*OwnerInfo)(nil),                    // 52: gerrit.OwnerInfo
	(*ListOwnersResponse)(nil),           // 53: gerrit.ListOwnersResponse
	(*GetPureRevertRequest)(nil),         // 54: gerrit.GetPureRevertRequest
	(*PureRevertInfo)(nil),               // 55: gerrit.PureRevertInfo
	(*ListChangeCommentsRequest)(nil),    // 56: gerrit.ListChangeCommentsRequest
	(*CommentRange)(nil),                 // 57: gerrit.CommentRange
	(*Comment)(nil),                      // 58: gerrit.Comment
	(*CommentList)(nil),                  // 59: gerrit.CommentList
	(*ListChangeCommentsResponse)(nil),   // 60: gerrit.ListChangeCommentsResponse
	(*NotifyDetails_Info)(nil),           // 61: gerrit.NotifyDetails.Info
	(*NotifyDetails_Recipient)(nil),      // 62: gerrit.NotifyDetails.Recipient
	nil,                                  // 63: gerrit.ChangeInfo.RevisionsEntry
	nil,                                  // 64: gerrit.ChangeInfo.LabelsEntry
	nil,                                  // 65: gerrit.RevisionInfo.FilesEntry
	(*CommitInfo_Parent)(nil),            // 66: gerrit.CommitInfo.Parent
	nil,                                  // 67: gerrit.LabelInfo.ValuesEntry
	nil,                                  // 68: gerrit.ReviewerInfo.ApprovalsEntry
	nil,                                  // 69: gerrit.SetReviewRequest.LabelsEntry
	nil,                                  // 70: gerrit.ReviewResult.LabelsEntry
	nil,                                  // 71: gerrit.ListFilesResponse.FilesEntry
	(*GetRelatedChangesResponse_ChangeAndCommit)(nil), // 72: gerrit.GetRelatedChangesResponse.ChangeAndCommit
	nil,                           // 73: gerrit.ProjectInfo.RefsEntry
	nil,                           // 74: gerrit.ListProjectsResponse.ProjectsEntry
	nil,                           // 75: gerrit.ListChangeCommentsResponse.CommentsEntry
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	62, // 0: gerrit.NotifyDetails.recipients:type_name -> gerrit.NotifyDetails.Recipient
	...
	63, // 6: gerrit.ChangeInfo.revisions:type_name -> gerrit.ChangeInfo.RevisionsEntry
	64, // 7: gerrit.ChangeInfo.labels:type_name -> gerrit.ChangeInfo.LabelsEntry
	22, // 8: gerrit.ChangeInfo.messages:type_name -> gerrit.ChangeMessageInfo
	23, // 9: gerrit.ChangeInfo.requirements:type_name -> gerrit.Requirement
	76, // 10: gerrit.ChangeInfo.created:type_name -> google.protobuf.Timestamp
	76, // 11: gerrit.ChangeInfo.updated:type_name -> google.protobuf.Timestamp
	5,  // 12: gerrit.RevisionInfo.kind:type_name -> gerrit.RevisionInfo.Kind
	15, // 13: gerrit.RevisionInfo.uploader:type_name -> gerrit.AccountInfo
	76, // 14: gerrit.RevisionInfo.created:type_name -> google.protobuf.Timestamp
	18, // 15: gerrit.RevisionInfo.commit:type_name -> gerrit.CommitInfo
	65, // 16: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	66, // 17: gerrit.CommitInfo.parents:type_name -> gerrit.CommitInfo.Parent
	15, // 18: gerrit.LabelInfo.approved:type_name -> gerrit.AccountInfo
	15, // 19: gerrit.LabelInfo.rejected:type_name -> gerrit.AccountInfo
	15, // 20: gerrit.LabelInfo.recommended:type_name -> gerrit.AccountInfo
	15, // 21: gerrit.LabelInfo.disliked:type_name -> gerrit.AccountInfo
	20, // 22: gerrit.LabelInfo.all:type_name -> gerrit.ApprovalInfo
	67, // 23: gerrit.LabelInfo.values:type_name -> gerrit.LabelInfo.ValuesEntry
	15, // 24: gerrit.ApprovalInfo.user:type_name -> gerrit.AccountInfo
	21, // 25: gerrit.ApprovalInfo.permitted_voting_range:type_name -> gerrit.VotingRangeInfo
	76, // 26: gerrit.ApprovalInfo.date:type_name -> google.protobuf.Timestamp
	15, // 27: gerrit.ChangeMessageInfo.author:type_name -> gerrit.AccountInfo
	15, // 28: gerrit.ChangeMessageInfo.real_author:type_name -> gerrit.AccountInfo
	76, // 29: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	6,  // 30: gerrit.Requirement.status:type_name -> gerrit.Requirement.Status
	7,  // 31: gerrit.FileInfo.status:type_name -> gerrit.FileInfo.Status
	8,  // 32: gerrit.AddReviewerRequest.state:type_name -> gerrit.AddReviewerRequest.State
	1,  // 33: gerrit.AddReviewerRequest.notify:type_name -> gerrit.Notify
	15, // 34: gerrit.ReviewerInfo.account:type_name -> gerrit.AccountInfo
	68, // 35: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	32, // 36: gerrit.AddReviewerResult.reviewers:type_name -> gerrit.ReviewerInfo
	32, // 37: gerrit.AddReviewerResult.ccs:type_name -> gerrit.ReviewerInfo
	69, // 38: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	1,  // 39: gerrit.SetReviewRequest.notify:type_name -> gerrit.Notify
	11, // 40: gerrit.SetReviewRequest.notify_details:type_name -> gerrit.NotifyDetails
	70, // 41: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	1,  // 42: gerrit.AttentionSetRequest.notify:type_name -> gerrit.Notify
	3,  // 43: gerrit.GetMergeableRequest.strategy:type_name -> gerrit.MergeableStrategy
	9,  // 44: gerrit.MergeableInfo.submit_type:type_name -> gerrit.MergeableInfo.SubmitType
	3,  // 45: gerrit.MergeableInfo.strategy:type_name -> gerrit.MergeableStrategy
	71, // 46: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	72, // 47: gerrit.GetRelatedChangesResponse.changes:type_name -> gerrit.GetRelatedChangesResponse.ChangeAndCommit
	10, // 48: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	73, // 49: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	45, // 50: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	74, // 51: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	50, // 52: gerrit.ListFileOwnersRequest.options:type_name -> gerrit.AccountOptions
	15, // 53: gerrit.OwnerInfo.account:type_name -> gerrit.AccountInfo
	52, // 54: gerrit.ListOwnersResponse.owners:type_name -> gerrit.OwnerInfo
	15, // 55: gerrit.Comment.author:type_name -> gerrit.AccountInfo
	57, // 56: gerrit.Comment.range:type_name -> gerrit.CommentRange
	58, // 57: gerrit.CommentList.comments:type_name -> gerrit.Comment
	75, // 58: gerrit.ListChangeCommentsResponse.comments:type_name -> gerrit.ListChangeCommentsResponse.CommentsEntry
	4,  // 59: gerrit.NotifyDetails.Recipient.recipient_type:type_name -> gerrit.NotifyDetails.RecipientType
	61, // 60: gerrit.NotifyDetails.Recipient.info:type_name -> gerrit.NotifyDetails.Info
	17, // 61: gerrit.ChangeInfo.RevisionsEntry.value:type_name -> gerrit.RevisionInfo
	19, // 62: gerrit.ChangeInfo.LabelsEntry.value:type_name -> gerrit.LabelInfo
	24, // 63: gerrit.RevisionInfo.FilesEntry.value:type_name -> gerrit.FileInfo
	24, // 64: gerrit.ListFilesResponse.FilesEntry.value:type_name -> gerrit.FileInfo
	18, // 65: gerrit.GetRelatedChangesResponse.ChangeAndCommit.commit:type_name -> gerrit.CommitInfo
	46, // 66: gerrit.ListProjectsResponse.ProjectsEntry.value:type_name -> gerrit.ProjectInfo
	59, // 67: gerrit.ListChangeCommentsResponse.CommentsEntry.value:type_name -> gerrit.CommentList
	44, // 68: gerrit.Gerrit.ListProjects:input_type -> gerrit.ListProjectsRequest
	48, // 69: gerrit.Gerrit.GetRefInfo:input_type -> gerrit.RefInfoRequest
	51, // 70: gerrit.Gerrit.ListFileOwners:input_type -> gerrit.ListFileOwnersRequest
	12, // 71: gerrit.Gerrit.ListChanges:input_type -> gerrit.ListChangesRequest
	14, // 72: gerrit.Gerrit.GetChange:input_type -> gerrit.GetChangeRequest
	38, // 73: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	40, // 74: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	56, // 75: gerrit.Gerrit.ListChangeComments:input_type -> gerrit.ListChangeCommentsRequest
	42, // 76: gerrit.Gerrit.GetRelatedChanges:input_type -> gerrit.GetRelatedChangesRequest
	54, // 77: gerrit.Gerrit.GetPureRevert:input_type -> gerrit.GetPureRevertRequest
	25, // 78: gerrit.Gerrit.CreateChange:input_type -> gerrit.CreateChangeRequest
	27, // 79: gerrit.Gerrit.ChangeEditFileContent:input_type -> gerrit.ChangeEditFileContentRequest
	28, // 80: gerrit.Gerrit.DeleteEditFileContent:input_type -> gerrit.DeleteEditFileContentRequest
	29, // 81: gerrit.Gerrit.ChangeEditPublish:input_type -> gerrit.ChangeEditPublishRequest
	31, // 82: gerrit.Gerrit.AddReviewer:input_type -> gerrit.AddReviewerRequest
	34, // 83: gerrit.Gerrit.DeleteReviewer:input_type -> gerrit.DeleteReviewerRequest
	35, // 84: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	37, // 85: gerrit.Gerrit.AddToAttentionSet:input_type -> gerrit.AttentionSetRequest
	26, // 86: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	30, // 87: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	47, // 88: gerrit.Gerrit.ListProjects:output_type -> gerrit.ListProjectsResponse
	49, // 89: gerrit.Gerrit.GetRefInfo:output_type -> gerrit.RefInfo
	53, // 90: gerrit.Gerrit.ListFileOwners:output_type -> gerrit.ListOwnersResponse
	13, // 91: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	16, // 92: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	39, // 93: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	41, // 94: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
	60, // 95: gerrit.Gerrit.ListChangeComments:output_type -> gerrit.ListChangeCommentsResponse
	43, // 96: gerrit.Gerrit.GetRelatedChanges:output_type -> gerrit.GetRelatedChangesResponse
	55, // 97: gerrit.Gerrit.GetPureRevert:output_type -> gerrit.PureRevertInfo
	16, // 98: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	77, // 99: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	77, // 100: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	77, // 101: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	33, // 102: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	77, // 103: gerrit.Gerrit.DeleteReviewer:output_type -> google.protobuf.Empty
	36, // 104: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	15, // 105: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	16, // 106: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	16, // 107: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
...
func file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListChangeCommentsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListChangeCommentsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[61].Exporter = func(v interface{}, i int) interface{} {
...
type GerritClient interface {
	...
	// Lists the comments that were made on a change.
	//
	// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#list-change-comments
	ListChangeComments(ctx context.Context, in *ListChangeCommentsRequest, opts ...grpc.CallOption) (*ListChangeCommentsResponse, error)
...
func (c *gerritPRPCClient) ListChangeComments(ctx context.Context, in *ListChangeCommentsRequest, opts ...grpc.CallOption) (*ListChangeCommentsResponse, error) {
	out := new(ListChangeCommentsResponse)
	err := c.client.Call(ctx, "gerrit.Gerrit", "ListChangeComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gerritClient) ListChangeComments(ctx context.Context, in *ListChangeCommentsRequest, opts ...grpc.CallOption) (*ListChangeCommentsResponse, error) {
	out := new(ListChangeCommentsResponse)
	err := c.cc.Invoke(ctx, "/gerrit.Gerrit/ListChangeComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GerritServer interface {
	...
	//
	// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#list-change-comments
	ListChangeComments(context.Context, *ListChangeCommentsRequest) (*ListChangeCommentsResponse, error)
	// Retrieves related changes of a revision.
	//
	// Related changes are changes that either depend on, or are dependencies of
	// the revision.
...
func (*UnimplementedGerritServer) ListChangeComments(context.Context, *ListChangeCommentsRequest) (*ListChangeCommentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListChangeComments not implemented")
}
...
func _Gerrit_ListChangeComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListChangeCommentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GerritServer).ListChangeComments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gerrit.Gerrit/ListChangeComments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GerritServer).ListChangeComments(ctx, req.(*ListChangeCommentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Gerrit_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Gerrit_ListChangeComments_Handler,
		},
		{
