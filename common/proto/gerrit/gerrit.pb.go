...
type AddReviewerRequest_Notify int32

const (
	AddReviewerRequest_ADD_REVIEWER_NOTIFY_UNSPECIFIED     AddReviewerRequest_Notify = 0
	AddReviewerRequest_ADD_REVIEWER_NOTIFY_NONE            AddReviewerRequest_Notify = 1
	AddReviewerRequest_ADD_REVIEWER_NOTIFY_OWNER           AddReviewerRequest_Notify = 2
	AddReviewerRequest_ADD_REVIEWER_NOTIFY_OWNER_REVIEWERS AddReviewerRequest_Notify = 3
	AddReviewerRequest_ADD_REVIEWER_NOTIFY_ALL             AddReviewerRequest_Notify = 4
)

// Enum value maps for AddReviewerRequest_Notify.
var (
	AddReviewerRequest_Notify_name = map[int32]string{
		0: "ADD_REVIEWER_NOTIFY_UNSPECIFIED",
		1: "ADD_REVIEWER_NOTIFY_NONE",
		2: "ADD_REVIEWER_NOTIFY_OWNER",
		3: "ADD_REVIEWER_NOTIFY_OWNER_REVIEWERS",
		4: "ADD_REVIEWER_NOTIFY_ALL",
	}
	AddReviewerRequest_Notify_value = map[string]int32{
		"ADD_REVIEWER_NOTIFY_UNSPECIFIED":     0,
		"ADD_REVIEWER_NOTIFY_NONE":            1,
		"ADD_REVIEWER_NOTIFY_OWNER":           2,
		"ADD_REVIEWER_NOTIFY_OWNER_REVIEWERS": 3,
		"ADD_REVIEWER_NOTIFY_ALL":             4,
	}
)

func (x AddReviewerRequest_Notify) Enum() *AddReviewerRequest_Notify {
	p := new(AddReviewerRequest_Notify)
	*p = x
	return p
}

func (x AddReviewerRequest_Notify) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AddReviewerRequest_Notify) Descriptor() protoreflect.EnumDescriptor {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_enumTypes[6].Descriptor()
}

func (AddReviewerRequest_Notify) Type() protoreflect.EnumType {
	return &file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_enumTypes[6]
}

func (x AddReviewerRequest_Notify) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AddReviewerRequest_Notify.Descriptor instead.
func (AddReviewerRequest_Notify) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDescGZIP(), []int{15, 1}
}

type AttentionSetRequest_Notify int32

const (
	AttentionSetRequest_ATTENTION_SET_NOTIFY_UNSPECIFIED     AttentionSetRequest_Notify = 0
	AttentionSetRequest_ATTENTION_SET_NOTIFY_NONE            AttentionSetRequest_Notify = 1
	AttentionSetRequest_ATTENTION_SET_NOTIFY_OWNER           AttentionSetRequest_Notify = 2
	AttentionSetRequest_ATTENTION_SET_NOTIFY_OWNER_REVIEWERS AttentionSetRequest_Notify = 3
	AttentionSetRequest_ATTENTION_SET_NOTIFY_ALL             AttentionSetRequest_Notify = 4
)

// Enum value maps for AttentionSetRequest_Notify.
var (
	AttentionSetRequest_Notify_name = map[int32]string{
		0: "ATTENTION_SET_NOTIFY_UNSPECIFIED",
		1: "ATTENTION_SET_NOTIFY_NONE",
		2: "ATTENTION_SET_NOTIFY_OWNER",
		3: "ATTENTION_SET_NOTIFY_OWNER_REVIEWERS",
		4: "ATTENTION_SET_NOTIFY_ALL",
	}
	AttentionSetRequest_Notify_value = map[string]int32{
		"ATTENTION_SET_NOTIFY_UNSPECIFIED":     0,
		"ATTENTION_SET_NOTIFY_NONE":            1,
		"ATTENTION_SET_NOTIFY_OWNER":           2,
		"ATTENTION_SET_NOTIFY_OWNER_REVIEWERS": 3,
		"ATTENTION_SET_NOTIFY_ALL":             4,
	}
)

func (x AttentionSetRequest_Notify) Enum() *AttentionSetRequest_Notify {
	p := new(AttentionSetRequest_Notify)
	*p = x
	return p
}

func (x AttentionSetRequest_Notify) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AttentionSetRequest_Notify) Descriptor() protoreflect.EnumDescriptor {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_enumTypes[7].Descriptor()
}

func (AttentionSetRequest_Notify) Type() protoreflect.EnumType {
	return &file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_enumTypes[7]
}

func (x AttentionSetRequest_Notify) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AttentionSetRequest_Notify.Descriptor instead.
func (AttentionSetRequest_Notify) EnumDescriptor() ([]byte, []int) {
...
type AddReviewerRequest struct {
	...
	Notify AddReviewerRequest_Notify `protobuf:"varint,6,opt,name=notify,proto3,enum=gerrit.AddReviewerRequest_Notify" json:"notify,omitempty"`
}
...
func (x *AddReviewerRequest) GetNotify() AddReviewerRequest_Notify {
	if x != nil {
		return x.Notify
	}
	return AddReviewerRequest_ADD_REVIEWER_NOTIFY_UNSPECIFIED
}
...
type AttentionSetRequest struct {
	...
	Notify AttentionSetRequest_Notify `protobuf:"varint,5,opt,name=notify,proto3,enum=gerrit.AttentionSetRequest_Notify" json:"notify,omitempty"`
}
...
func (x *AttentionSetRequest) GetNotify() AttentionSetRequest_Notify {
	if x != nil {
		return x.Notify
	}
	return AttentionSetRequest_ATTENTION_SET_NOTIFY_UNSPECIFIED
}

// The response from adding a user to the attention set.
type AddToAttentionSetResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The account ID of the added user
	XAccountId int64 `protobuf:"varint,1,opt,name=_account_id,json=AccountId,proto3" json:"_account_id,omitempty"`
	// The user's name
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// The added user's email
	Email string `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	// The added user's username
	Username string `protobuf:"bytes,4,opt,name=username,proto3" json:"username,omitempty"`
}

func (x *AddToAttentionSetResult) Reset() {
	*x = AddToAttentionSetResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *AddToAttentionSetResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddToAttentionSetResult) ProtoMessage() {}

func (x *AddToAttentionSetResult) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddToAttentionSetResult.ProtoReflect.Descriptor instead.
func (*AddToAttentionSetResult) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDescGZIP(), []int{21}
}

func (x *AddToAttentionSetResult) GetXAccountId() int64 {
	if x != nil {
		return x.XAccountId
	}
	return 0
...
func (x *AddToAttentionSetResult) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AddToAttentionSetResult) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *AddToAttentionSetResult) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x8f, 0x04, 0x0a, 0x12, 0x41, 0x64, 0x64,
	...
	0x6d, 0x65, 0x64, 0x12, 0x39, 0x0a, 0x06, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x2e, 0x41, 0x64, 0x64,
	...
	,
	...
	0x69, 0x72, 0x6d, 0x22, 0xf8, 0x01, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x52, 0x65, 0x76, 0x69, 0x65,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xe7, 0x02, 0x0a, 0x13, 0x41, 0x74, 0x74, 0x65, 0x6e, 0x74, 0x69,
	0x6f, 0x6e, 0x53, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06,
	0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6e, 0x75,
	0x6d, 0x62, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18,
	...
	,
	...
	0x0b, 0x43, 0x48, 0x45, 0x52, 0x52, 0x59, 0x5f, 0x50, 0x49, 0x43, 0x4b, 0x10, 0x06, 0x22, 0xa6,
	...
	0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x22, 0x9b, 0x01, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74,
	0x46, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a,
	0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x67,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0xd3, 0x03, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f,
	...
	0x4d, 0x4d, 0x41, 0x4e, 0x44, 0x53, 0x10, 0x80, 0x80, 0x80, 0x01, 0x2a, 0x85, 0x01, 0x0a, 0x11,
	...
	0x53, 0x10, 0x05, 0x32, 0xa9, 0x07, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74, 0x12, 0x46,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x3b, 0x0a, 0x09, 0x53, 0x65, 0x74, 0x52, 0x65, 0x76, 0x69,
	...
	0x6c, 0x74, 0x12, 0x51, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x41, 0x74, 0x74, 0x65, 0x6e,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x2e, 0x41, 0x64,
	0x64, 0x54, 0x6f, 0x41, 0x74, 0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x74, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x3f, 0x0a, 0x0c, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x43,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	(AddReviewerRequest_State)(0),        // 5: gerrit.AddReviewerRequest.State
	(AddReviewerRequest_Notify)(0),       // 6: gerrit.AddReviewerRequest.Notify
	(AttentionSetRequest_Notify)(0),      // 7: gerrit.AttentionSetRequest.Notify
	...
	(*AddToAttentionSetResult)(nil),      // 30: gerrit.AddToAttentionSetResult
	...
	nil,                                  // 35: gerrit.ChangeInfo.RevisionsEntry
	nil,                                  // 36: gerrit.ChangeInfo.LabelsEntry
	nil,                                  // 37: gerrit.RevisionInfo.FilesEntry
	nil,                                  // 38: gerrit.ReviewerInfo.ApprovalsEntry
	nil,                                  // 39: gerrit.SetReviewRequest.LabelsEntry
	nil,                                  // 40: gerrit.ReviewResult.LabelsEntry
	nil,                                  // 41: gerrit.ListFilesResponse.FilesEntry
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	35, // 5: gerrit.ChangeInfo.revisions:type_name -> gerrit.ChangeInfo.RevisionsEntry
	36, // 6: gerrit.ChangeInfo.labels:type_name -> gerrit.ChangeInfo.LabelsEntry
	...
	37, // 10: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	...
	42, // 17: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	4,  // 18: gerrit.FileInfo.status:type_name -> gerrit.FileInfo.Status
	5,  // 19: gerrit.AddReviewerRequest.state:type_name -> gerrit.AddReviewerRequest.State
	6,  // 20: gerrit.AddReviewerRequest.notify:type_name -> gerrit.AddReviewerRequest.Notify
	12, // 21: gerrit.ReviewerInfo.account:type_name -> gerrit.AccountInfo
	38, // 22: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	...
	39, // 25: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	40, // 26: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	7,  // 27: gerrit.AttentionSetRequest.notify:type_name -> gerrit.AttentionSetRequest.Notify
	1,  // 28: gerrit.GetMergeableRequest.strategy:type_name -> gerrit.MergeableStrategy
	8,  // 29: gerrit.MergeableInfo.submit_type:type_name -> gerrit.MergeableInfo.SubmitType
	1,  // 30: gerrit.MergeableInfo.strategy:type_name -> gerrit.MergeableStrategy
	41, // 31: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	14, // 32: gerrit.ChangeInfo.RevisionsEntry.value:type_name -> gerrit.RevisionInfo
	15, // 33: gerrit.ChangeInfo.LabelsEntry.value:type_name -> gerrit.LabelInfo
	17, // 34: gerrit.RevisionInfo.FilesEntry.value:type_name -> gerrit.FileInfo
	17, // 35: gerrit.ListFilesResponse.FilesEntry.value:type_name -> gerrit.FileInfo
	9,  // 36: gerrit.Gerrit.ListChanges:input_type -> gerrit.ListChangesRequest
	11, // 37: gerrit.Gerrit.GetChange:input_type -> gerrit.GetChangeRequest
	18, // 38: gerrit.Gerrit.CreateChange:input_type -> gerrit.CreateChangeRequest
	20, // 39: gerrit.Gerrit.ChangeEditFileContent:input_type -> gerrit.ChangeEditFileContentRequest
	21, // 40: gerrit.Gerrit.DeleteEditFileContent:input_type -> gerrit.DeleteEditFileContentRequest
	22, // 41: gerrit.Gerrit.ChangeEditPublish:input_type -> gerrit.ChangeEditPublishRequest
	24, // 42: gerrit.Gerrit.AddReviewer:input_type -> gerrit.AddReviewerRequest
	27, // 43: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	29, // 44: gerrit.Gerrit.AddToAttentionSet:input_type -> gerrit.AttentionSetRequest
	19, // 45: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	23, // 46: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	31, // 47: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	33, // 48: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	10, // 49: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	13, // 50: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	13, // 51: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	43, // 52: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	43, // 53: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	43, // 54: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	26, // 55: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	28, // 56: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	30, // 57: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AddToAttentionSetResult
	13, // 58: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	13, // 59: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
	32, // 60: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	34, // 61: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
...
func file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AddToAttentionSetResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GerritClient interface {
	...
	// Adds a single user to the attension set of a change.
	//
	// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#set-review
	AddToAttentionSet(ctx context.Context, in *AttentionSetRequest, opts ...grpc.CallOption) (*AddToAttentionSetResult, error)
	// Submit a change.
	//
	// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#submit-change
...
func (c *gerritPRPCClient) AddToAttentionSet(ctx context.Context, in *AttentionSetRequest, opts ...grpc.CallOption) (*AddToAttentionSetResult, error) {
	out := new(AddToAttentionSetResult)
...
func (c *gerritClient) AddToAttentionSet(ctx context.Context, in *AttentionSetRequest, opts ...grpc.CallOption) (*AddToAttentionSetResult, error) {
	out := new(AddToAttentionSetResult)
...
type GerritServer interface {
	...
	//
	// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#set-review
	AddToAttentionSet(context.Context, *AttentionSetRequest) (*AddToAttentionSetResult, error)
	// Submit a change.
	//
	// https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#submit-change
...
func (*UnimplementedGerritServer) AddToAttentionSet(context.Context, *AttentionSetRequest) (*AddToAttentionSetResult, error) {
