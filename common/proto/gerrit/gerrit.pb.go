...
// The state to add reviewer in, defaults to REVEWER
type AddReviewerRequest_State int32

const (
	AddReviewerRequest_REVIEWER AddReviewerRequest_State = 0
	AddReviewerRequest_CC       AddReviewerRequest_State = 1
)
...
// Defines who should be notified after reviewer is added
// Defaults to ALL
type AddReviewerRequest_Notify int32

const (
	AddReviewerRequest_NONE            AddReviewerRequest_Notify = 0
	AddReviewerRequest_OWNER           AddReviewerRequest_Notify = 1
	AddReviewerRequest_OWNER_REVIEWERS AddReviewerRequest_Notify = 2
	AddReviewerRequest_ALL             AddReviewerRequest_Notify = 3
)
...
func (x *AddReviewerRequest) GetState() AddReviewerRequest_State {
	...
	return AddReviewerRequest_REVIEWER
}
...
func (x *AddReviewerRequest) GetNotify() AddReviewerRequest_Notify {
	...
	return AddReviewerRequest_NONE
}
...
type ReviewerInfo struct {
	...
	Approvals map[string]int32 `protobuf:"bytes,5,rep,name=approvals,proto3" json:"approvals,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *ReviewerInfo) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *ReviewerInfo) GetSecondaryEmails() []string {
	if x != nil {
		return x.SecondaryEmails
	}
	return nil
...
func (x *ReviewerInfo) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xcf, 0x02, 0x0a, 0x12, 0x41, 0x64, 0x64,
	...
	,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb7, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4d, 0x65,
	...
	0x80, 0x01, 0x2a, 0x85, 0x01, 0x0a, 0x11, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x61, 0x62, 0x6c, 0x65,
	...
	0x0a, 0x06, 0x54, 0x48, 0x45, 0x49, 0x52, 0x53, 0x10, 0x05, 0x32, 0xd6, 0x06, 0x0a, 0x06, 0x47,
	...
	0x69, 0x65, 0x77, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x3f, 0x0a, 0x0c, 0x53, 0x75, 0x62,
	...
	0x6e, 0x73, 0x65, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	35, // 21: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	24, // 22: gerrit.AddReviewerResult.reviewers:type_name -> gerrit.ReviewerInfo
	24, // 23: gerrit.AddReviewerResult.ccs:type_name -> gerrit.ReviewerInfo
	36, // 24: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	37, // 25: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	1,  // 26: gerrit.GetMergeableRequest.strategy:type_name -> gerrit.MergeableStrategy
	7,  // 27: gerrit.MergeableInfo.submit_type:type_name -> gerrit.MergeableInfo.SubmitType
	1,  // 28: gerrit.MergeableInfo.strategy:type_name -> gerrit.MergeableStrategy
	38, // 29: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	13, // 30: gerrit.ChangeInfo.RevisionsEntry.value:type_name -> gerrit.RevisionInfo
	14, // 31: gerrit.ChangeInfo.LabelsEntry.value:type_name -> gerrit.LabelInfo
	16, // 32: gerrit.RevisionInfo.FilesEntry.value:type_name -> gerrit.FileInfo
	16, // 33: gerrit.ListFilesResponse.FilesEntry.value:type_name -> gerrit.FileInfo
	8,  // 34: gerrit.Gerrit.ListChanges:input_type -> gerrit.ListChangesRequest
	10, // 35: gerrit.Gerrit.GetChange:input_type -> gerrit.GetChangeRequest
	17, // 36: gerrit.Gerrit.CreateChange:input_type -> gerrit.CreateChangeRequest
	19, // 37: gerrit.Gerrit.ChangeEditFileContent:input_type -> gerrit.ChangeEditFileContentRequest
	20, // 38: gerrit.Gerrit.DeleteEditFileContent:input_type -> gerrit.DeleteEditFileContentRequest
	21, // 39: gerrit.Gerrit.ChangeEditPublish:input_type -> gerrit.ChangeEditPublishRequest
	23, // 40: gerrit.Gerrit.AddReviewer:input_type -> gerrit.AddReviewerRequest
	26, // 41: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	18, // 42: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	22, // 43: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	28, // 44: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	30, // 45: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	9,  // 46: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	12, // 47: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	12, // 48: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	40, // 49: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	40, // 50: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	40, // 51: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	25, // 52: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	27, // 53: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	12, // 54: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	12, // 55: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
	29, // 56: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	31, // 57: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
