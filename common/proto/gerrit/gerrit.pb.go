...
// CheckAccessResponse is response message for gerrit.CheckAccess.
...
type GerritClient interface {
	// CheckAccess checks if a user has a permission on give repo and ref.
	//
