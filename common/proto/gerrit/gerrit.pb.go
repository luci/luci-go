...
const (
	AddReviewerRequest_ADD_REVIEWER_STATE_UNKNOWN  AddReviewerRequest_State = 0
...
const (
	AddReviewerRequest_ADD_REVIEWER_NOTIFY_UNKNOWN         AddReviewerRequest_Notify = 0
...
func (x *AddReviewerRequest) GetState() AddReviewerRequest_State {
	...
	return AddReviewerRequest_ADD_REVIEWER_STATE_UNKNOWN
}
...
func (x *AddReviewerRequest) GetNotify() AddReviewerRequest_Notify {
	...
	return AddReviewerRequest_ADD_REVIEWER_NOTIFY_UNKNOWN
}
...
type ReviewerInfo struct {
	...
	Approvals map[string]string `protobuf:"bytes,2,rep,name=approvals,proto3" json:"approvals,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ReviewerInfo) GetApprovals() map[string]string {
	if x != nil {
		return x.Approvals
	}
	return nil
...
type AddReviewerResult struct {
	...
	// TODO: yulanlin document why there might be multiple
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x87, 0x04, 0x0a, 0x12, 0x41, 0x64, 0x64,
	...
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x52, 0x06, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x22, 0x63,
	0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1e, 0x0a, 0x1a, 0x41, 0x44, 0x44, 0x5f, 0x52,
	0x45, 0x56, 0x49, 0x45, 0x57, 0x45, 0x52, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x55, 0x4e,
	0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x1f, 0x0a, 0x1b, 0x41, 0x44, 0x44, 0x5f, 0x52,
	...
	,
	...
	0x38, 0x01, 0x2a, 0xd3, 0x03, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f, 0x70, 0x74, 0x69,
	...
	0x4e, 0x44, 0x53, 0x10, 0x80, 0x80, 0x80, 0x01, 0x2a, 0x85, 0x01, 0x0a, 0x11, 0x4d, 0x65, 0x72,
	...
	0x32, 0xd6, 0x06, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74, 0x12, 0x46, 0x0a, 0x0b, 0x4c,
	...
	0x6c, 0x74, 0x12, 0x3b, 0x0a, 0x09, 0x53, 0x65, 0x74, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x12,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	(*ListChangesRequest)(nil),           // 8: gerrit.ListChangesRequest
	(*ListChangesResponse)(nil),          // 9: gerrit.ListChangesResponse
	(*GetChangeRequest)(nil),             // 10: gerrit.GetChangeRequest
	(*AccountInfo)(nil),                  // 11: gerrit.AccountInfo
	(*ChangeInfo)(nil),                   // 12: gerrit.ChangeInfo
	(*RevisionInfo)(nil),                 // 13: gerrit.RevisionInfo
	(*LabelInfo)(nil),                    // 14: gerrit.LabelInfo
	(*ChangeMessageInfo)(nil),            // 15: gerrit.ChangeMessageInfo
	(*FileInfo)(nil),                     // 16: gerrit.FileInfo
	(*CreateChangeRequest)(nil),          // 17: gerrit.CreateChangeRequest
	(*SubmitChangeRequest)(nil),          // 18: gerrit.SubmitChangeRequest
	(*ChangeEditFileContentRequest)(nil), // 19: gerrit.ChangeEditFileContentRequest
	(*DeleteEditFileContentRequest)(nil), // 20: gerrit.DeleteEditFileContentRequest
	(*ChangeEditPublishRequest)(nil),     // 21: gerrit.ChangeEditPublishRequest
	(*AbandonChangeRequest)(nil),         // 22: gerrit.AbandonChangeRequest
	(*AddReviewerRequest)(nil),           // 23: gerrit.AddReviewerRequest
	(*ReviewerInfo)(nil),                 // 24: gerrit.ReviewerInfo
	(*AddReviewerResult)(nil),            // 25: gerrit.AddReviewerResult
	(*SetReviewRequest)(nil),             // 26: gerrit.SetReviewRequest
	(*ReviewResult)(nil),                 // 27: gerrit.ReviewResult
	(*GetMergeableRequest)(nil),          // 28: gerrit.GetMergeableRequest
	(*MergeableInfo)(nil),                // 29: gerrit.MergeableInfo
	(*ListFilesRequest)(nil),             // 30: gerrit.ListFilesRequest
	(*ListFilesResponse)(nil),            // 31: gerrit.ListFilesResponse
	nil,                                  // 32: gerrit.ChangeInfo.RevisionsEntry
	nil,                                  // 33: gerrit.ChangeInfo.LabelsEntry
	nil,                                  // 34: gerrit.RevisionInfo.FilesEntry
	nil,                                  // 35: gerrit.ReviewerInfo.ApprovalsEntry
	nil,                                  // 36: gerrit.SetReviewRequest.LabelsEntry
	nil,                                  // 37: gerrit.ReviewResult.LabelsEntry
	nil,                                  // 38: gerrit.ListFilesResponse.FilesEntry
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	12, // 1: gerrit.ListChangesResponse.changes:type_name -> gerrit.ChangeInfo
	0,  // 2: gerrit.GetChangeRequest.options:type_name -> gerrit.QueryOption
	11, // 3: gerrit.ChangeInfo.owner:type_name -> gerrit.AccountInfo
	2,  // 4: gerrit.ChangeInfo.status:type_name -> gerrit.ChangeInfo.Status
	32, // 5: gerrit.ChangeInfo.revisions:type_name -> gerrit.ChangeInfo.RevisionsEntry
	33, // 6: gerrit.ChangeInfo.labels:type_name -> gerrit.ChangeInfo.LabelsEntry
	15, // 7: gerrit.ChangeInfo.messages:type_name -> gerrit.ChangeMessageInfo
	3,  // 8: gerrit.RevisionInfo.kind:type_name -> gerrit.RevisionInfo.Kind
	11, // 9: gerrit.RevisionInfo.uploader:type_name -> gerrit.AccountInfo
	34, // 10: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	11, // 11: gerrit.LabelInfo.approved:type_name -> gerrit.AccountInfo
	11, // 12: gerrit.LabelInfo.rejected:type_name -> gerrit.AccountInfo
	11, // 13: gerrit.LabelInfo.recommended:type_name -> gerrit.AccountInfo
	11, // 14: gerrit.LabelInfo.disliked:type_name -> gerrit.AccountInfo
	11, // 15: gerrit.ChangeMessageInfo.author:type_name -> gerrit.AccountInfo
	11, // 16: gerrit.ChangeMessageInfo.real_author:type_name -> gerrit.AccountInfo
	39, // 17: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	...
	11, // 21: gerrit.ReviewerInfo.account:type_name -> gerrit.AccountInfo
	35, // 22: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	24, // 23: gerrit.AddReviewerResult.reviewers:type_name -> gerrit.ReviewerInfo
	24, // 24: gerrit.AddReviewerResult.ccs:type_name -> gerrit.ReviewerInfo
	36, // 25: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	37, // 26: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	1,  // 27: gerrit.GetMergeableRequest.strategy:type_name -> gerrit.MergeableStrategy
	7,  // 28: gerrit.MergeableInfo.submit_type:type_name -> gerrit.MergeableInfo.SubmitType
	1,  // 29: gerrit.MergeableInfo.strategy:type_name -> gerrit.MergeableStrategy
	38, // 30: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	13, // 31: gerrit.ChangeInfo.RevisionsEntry.value:type_name -> gerrit.RevisionInfo
	14, // 32: gerrit.ChangeInfo.LabelsEntry.value:type_name -> gerrit.LabelInfo
	16, // 33: gerrit.RevisionInfo.FilesEntry.value:type_name -> gerrit.FileInfo
	16, // 34: gerrit.ListFilesResponse.FilesEntry.value:type_name -> gerrit.FileInfo
	8,  // 35: gerrit.Gerrit.ListChanges:input_type -> gerrit.ListChangesRequest
	10, // 36: gerrit.Gerrit.GetChange:input_type -> gerrit.GetChangeRequest
	17, // 37: gerrit.Gerrit.CreateChange:input_type -> gerrit.CreateChangeRequest
	19, // 38: gerrit.Gerrit.ChangeEditFileContent:input_type -> gerrit.ChangeEditFileContentRequest
	20, // 39: gerrit.Gerrit.DeleteEditFileContent:input_type -> gerrit.DeleteEditFileContentRequest
	21, // 40: gerrit.Gerrit.ChangeEditPublish:input_type -> gerrit.ChangeEditPublishRequest
	23, // 41: gerrit.Gerrit.AddReviewer:input_type -> gerrit.AddReviewerRequest
	26, // 42: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	18, // 43: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	22, // 44: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	28, // 45: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	30, // 46: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	9,  // 47: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	12, // 48: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	12, // 49: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	40, // 50: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	40, // 51: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	40, // 52: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	25, // 53: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	27, // 54: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	12, // 55: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	12, // 56: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
	29, // 57: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	31, // 58: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
