...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x97, 0x03, 0x0a, 0x0c,
	...
	0x09, 0x52, 0x03, 0x72, 0x65, 0x66, 0x12, 0x35, 0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18,
	...
	,
	...
	0x0c, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xd0, 0x01,
	...
	0x28, 0x08, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x22, 0xf8, 0x01, 0x0a, 0x10,
	...
	0x73, 0x65, 0x74, 0x22, 0x27, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65,
	0x66, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x72, 0x65, 0x66, 0x22, 0x50, 0x0a, 0x0b,
	...
	0x72, 0x73, 0x2a, 0xd3, 0x03, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f, 0x70, 0x74, 0x69,
	...
	0x32, 0xc6, 0x09, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74, 0x12, 0x49, 0x0a, 0x0c, 0x4c,
	...
	0x61, 0x6e, 0x67, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a,
	...
	0x74, 0x12, 0x3b, 0x0a, 0x09, 0x53, 0x65, 0x74, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x12, 0x18,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	(*SetReviewRequest)(nil),             // 28: gerrit.SetReviewRequest
	(*ReviewResult)(nil),                 // 29: gerrit.ReviewResult
	(*AttentionSetRequest)(nil),          // 30: gerrit.AttentionSetRequest
	(*GetMergeableRequest)(nil),          // 31: gerrit.GetMergeableRequest
	(*MergeableInfo)(nil),                // 32: gerrit.MergeableInfo
	(*ListFilesRequest)(nil),             // 33: gerrit.ListFilesRequest
	(*ListFilesResponse)(nil),            // 34: gerrit.ListFilesResponse
	(*GetRelatedChangesRequest)(nil),     // 35: gerrit.GetRelatedChangesRequest
	(*GetRelatedChangesResponse)(nil),    // 36: gerrit.GetRelatedChangesResponse
	(*ListProjectsRequest)(nil),          // 37: gerrit.ListProjectsRequest
	(*WebLinkInfo)(nil),                  // 38: gerrit.WebLinkInfo
	(*ProjectInfo)(nil),                  // 39: gerrit.ProjectInfo
	(*ListProjectsResponse)(nil),         // 40: gerrit.ListProjectsResponse
	(*RefInfoRequest)(nil),               // 41: gerrit.RefInfoRequest
	(*RefInfo)(nil),                      // 42: gerrit.RefInfo
	(*AccountOptions)(nil),               // 43: gerrit.AccountOptions
	(*ListFileOwnersRequest)(nil),        // 44: gerrit.ListFileOwnersRequest
	(*OwnerInfo)(nil),                    // 45: gerrit.OwnerInfo
	(*ListOwnersResponse)(nil),           // 46: gerrit.ListOwnersResponse
	nil,                                  // 47: gerrit.ChangeInfo.RevisionsEntry
	nil,                                  // 48: gerrit.ChangeInfo.LabelsEntry
	nil,                                  // 49: gerrit.RevisionInfo.FilesEntry
	(*CommitInfo_Parent)(nil),            // 50: gerrit.CommitInfo.Parent
	nil,                                  // 51: gerrit.ReviewerInfo.ApprovalsEntry
	nil,                                  // 52: gerrit.SetReviewRequest.LabelsEntry
	nil,                                  // 53: gerrit.ReviewResult.LabelsEntry
	nil,                                  // 54: gerrit.ListFilesResponse.FilesEntry
	(*GetRelatedChangesResponse_ChangeAndCommit)(nil), // 55: gerrit.GetRelatedChangesResponse.ChangeAndCommit
	nil,                           // 56: gerrit.ProjectInfo.RefsEntry
	nil,                           // 57: gerrit.ListProjectsResponse.ProjectsEntry
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	47, // 5: gerrit.ChangeInfo.revisions:type_name -> gerrit.ChangeInfo.RevisionsEntry
	48, // 6: gerrit.ChangeInfo.labels:type_name -> gerrit.ChangeInfo.LabelsEntry
	17, // 7: gerrit.ChangeInfo.messages:type_name -> gerrit.ChangeMessageInfo
	58, // 8: gerrit.ChangeInfo.created:type_name -> google.protobuf.Timestamp
	58, // 9: gerrit.ChangeInfo.updated:type_name -> google.protobuf.Timestamp
	...
	49, // 12: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	50, // 13: gerrit.CommitInfo.parents:type_name -> gerrit.CommitInfo.Parent
	12, // 14: gerrit.LabelInfo.approved:type_name -> gerrit.AccountInfo
	12, // 15: gerrit.LabelInfo.rejected:type_name -> gerrit.AccountInfo
	12, // 16: gerrit.LabelInfo.recommended:type_name -> gerrit.AccountInfo
	12, // 17: gerrit.LabelInfo.disliked:type_name -> gerrit.AccountInfo
	12, // 18: gerrit.ChangeMessageInfo.author:type_name -> gerrit.AccountInfo
	12, // 19: gerrit.ChangeMessageInfo.real_author:type_name -> gerrit.AccountInfo
	58, // 20: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	5,  // 21: gerrit.FileInfo.status:type_name -> gerrit.FileInfo.Status
	6,  // 22: gerrit.AddReviewerRequest.state:type_name -> gerrit.AddReviewerRequest.State
	1,  // 23: gerrit.AddReviewerRequest.notify:type_name -> gerrit.Notify
	12, // 24: gerrit.ReviewerInfo.account:type_name -> gerrit.AccountInfo
	51, // 25: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	26, // 26: gerrit.AddReviewerResult.reviewers:type_name -> gerrit.ReviewerInfo
	26, // 27: gerrit.AddReviewerResult.ccs:type_name -> gerrit.ReviewerInfo
	52, // 28: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	53, // 29: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	1,  // 30: gerrit.AttentionSetRequest.notify:type_name -> gerrit.Notify
	3,  // 31: gerrit.GetMergeableRequest.strategy:type_name -> gerrit.MergeableStrategy
	7,  // 32: gerrit.MergeableInfo.submit_type:type_name -> gerrit.MergeableInfo.SubmitType
	3,  // 33: gerrit.MergeableInfo.strategy:type_name -> gerrit.MergeableStrategy
	54, // 34: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	55, // 35: gerrit.GetRelatedChangesResponse.changes:type_name -> gerrit.GetRelatedChangesResponse.ChangeAndCommit
	8,  // 36: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	56, // 37: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	38, // 38: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	57, // 39: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	43, // 40: gerrit.ListFileOwnersRequest.options:type_name -> gerrit.AccountOptions
	12, // 41: gerrit.OwnerInfo.account:type_name -> gerrit.AccountInfo
	45, // 42: gerrit.ListOwnersResponse.owners:type_name -> gerrit.OwnerInfo
	14, // 43: gerrit.ChangeInfo.RevisionsEntry.value:type_name -> gerrit.RevisionInfo
	16, // 44: gerrit.ChangeInfo.LabelsEntry.value:type_name -> gerrit.LabelInfo
	18, // 45: gerrit.RevisionInfo.FilesEntry.value:type_name -> gerrit.FileInfo
	18, // 46: gerrit.ListFilesResponse.FilesEntry.value:type_name -> gerrit.FileInfo
	15, // 47: gerrit.GetRelatedChangesResponse.ChangeAndCommit.commit:type_name -> gerrit.CommitInfo
	39, // 48: gerrit.ListProjectsResponse.ProjectsEntry.value:type_name -> gerrit.ProjectInfo
	37, // 49: gerrit.Gerrit.ListProjects:input_type -> gerrit.ListProjectsRequest
	41, // 50: gerrit.Gerrit.GetRefInfo:input_type -> gerrit.RefInfoRequest
	44, // 51: gerrit.Gerrit.ListFileOwners:input_type -> gerrit.ListFileOwnersRequest
	9,  // 52: gerrit.Gerrit.ListChanges:input_type -> gerrit.ListChangesRequest
	11, // 53: gerrit.Gerrit.GetChange:input_type -> gerrit.GetChangeRequest
	31, // 54: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	33, // 55: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	35, // 56: gerrit.Gerrit.GetRelatedChanges:input_type -> gerrit.GetRelatedChangesRequest
	19, // 57: gerrit.Gerrit.CreateChange:input_type -> gerrit.CreateChangeRequest
	21, // 58: gerrit.Gerrit.ChangeEditFileContent:input_type -> gerrit.ChangeEditFileContentRequest
	22, // 59: gerrit.Gerrit.DeleteEditFileContent:input_type -> gerrit.DeleteEditFileContentRequest
	23, // 60: gerrit.Gerrit.ChangeEditPublish:input_type -> gerrit.ChangeEditPublishRequest
	25, // 61: gerrit.Gerrit.AddReviewer:input_type -> gerrit.AddReviewerRequest
	28, // 62: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	30, // 63: gerrit.Gerrit.AddToAttentionSet:input_type -> gerrit.AttentionSetRequest
	20, // 64: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	24, // 65: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	40, // 66: gerrit.Gerrit.ListProjects:output_type -> gerrit.ListProjectsResponse
	42, // 67: gerrit.Gerrit.GetRefInfo:output_type -> gerrit.RefInfo
	46, // 68: gerrit.Gerrit.ListFileOwners:output_type -> gerrit.ListOwnersResponse
	10, // 69: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	13, // 70: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	32, // 71: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	34, // 72: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
	36, // 73: gerrit.Gerrit.GetRelatedChanges:output_type -> gerrit.GetRelatedChangesResponse
	13, // 74: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	59, // 75: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	59, // 76: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	59, // 77: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	27, // 78: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	29, // 79: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	12, // 80: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	13, // 81: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	13, // 82: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
