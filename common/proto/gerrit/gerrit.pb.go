...
type ListProjectsRequest struct {
	...
	// Limit results to projects with the specified ref, e.g.: refs/heads/master.
...
type ProjectInfo struct {
	...
	// The gerrit API may return short branch name (master instead of
	// refs/heads/master) but we convert it to a ref for consistency across the
	// API.
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0xd3, 0x03, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x0a, 0x4e, 0x4f, 0x54, 0x49, 0x46, 0x59, 0x5f, 0x41, 0x4c, 0x4c, 0x10, 0x04, 0x2a, 0x85, 0x01,
	...
	0x49, 0x52, 0x53, 0x10, 0x05, 0x32, 0xe8, 0x07, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74,
	...
	0x12, 0x2e, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x49,
	0x6e, 0x66, 0x6f, 0x12, 0x3f, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61,
	...
	0x65, 0x72, 0x72, 0x69, 0x74, 0x2e, 0x41, 0x64, 0x64, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x3b, 0x0a, 0x09, 0x53, 0x65, 0x74, 0x52, 0x65,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	nil,                                  // 38: gerrit.ChangeInfo.RevisionsEntry
	nil,                                  // 39: gerrit.ChangeInfo.LabelsEntry
	nil,                                  // 40: gerrit.RevisionInfo.FilesEntry
	nil,                                  // 41: gerrit.ReviewerInfo.ApprovalsEntry
	nil,                                  // 42: gerrit.SetReviewRequest.LabelsEntry
	nil,                                  // 43: gerrit.ReviewResult.LabelsEntry
	nil,                                  // 44: gerrit.ListFilesResponse.FilesEntry
	nil,                                  // 45: gerrit.ProjectInfo.RefsEntry
	nil,                                  // 46: gerrit.ListProjectsResponse.ProjectsEntry
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	38, // 5: gerrit.ChangeInfo.revisions:type_name -> gerrit.ChangeInfo.RevisionsEntry
	39, // 6: gerrit.ChangeInfo.labels:type_name -> gerrit.ChangeInfo.LabelsEntry
	...
	40, // 10: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	...
	47, // 17: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	...
	41, // 22: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	...
	42, // 25: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	43, // 26: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	...
	44, // 31: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	8,  // 32: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	45, // 33: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	35, // 34: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	46, // 35: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	...
	10, // 55: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	13, // 56: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	13, // 57: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	48, // 58: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	48, // 59: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	48, // 60: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	26, // 61: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	28, // 62: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	12, // 63: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	13, // 64: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	13, // 65: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
	31, // 66: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	33, // 67: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
	37, // 68: gerrit.Gerrit.ListProjects:output_type -> gerrit.ListProjectsResponse
