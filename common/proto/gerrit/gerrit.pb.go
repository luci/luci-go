...
type ChangeInfo struct {
	...
	// Branch of this change, without the refs/heads/ prefix.
	Branch string `protobuf:"bytes,4,opt,name=branch,proto3" json:"branch,omitempty"`
	// Change-ID of this change.
	ChangeId             string            `protobuf:"bytes,5,opt,name=change_id,json=changeId,proto3" json:"change_id,omitempty"`
	Status               ChangeInfo_Status `protobuf:"varint,6,opt,name=status,proto3,enum=gerrit.ChangeInfo_Status" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *ChangeInfo) GetBranch() string {
	if m != nil {
		return m.Branch
	}
	return ""
...
func (m *ChangeInfo) GetChangeId() string {
	if m != nil {
		return m.ChangeId
	}
	return ""
...
func (m *CreateChangeRequest) GetBranch() string {
	if m != nil {
		return m.Branch
	}
	return ""
...
func (m *SubmitChangeRequest) GetChangeId() string {
	if m != nil {
		return m.ChangeId
	}
	return ""
...
func (m *ChangeEditFileContentRequest) GetChangeId() string {
	if m != nil {
		return m.ChangeId
	}
	return ""
...
func (m *ChangeEditPublishRequest) GetChangeId() string {
	if m != nil {
		return m.ChangeId
	}
	return ""
...
var fileDescriptor_3c6e096860f6adc3 = []byte{
	...
	,
}
