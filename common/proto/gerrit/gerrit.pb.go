...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	50, // 12: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	51, // 13: gerrit.CommitInfo.parents:type_name -> gerrit.CommitInfo.Parent
	...
	59, // 20: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	...
	52, // 25: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	...
	53, // 28: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	54, // 29: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	...
	55, // 34: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	56, // 35: gerrit.GetRelatedChangesResponse.changes:type_name -> gerrit.GetRelatedChangesResponse.ChangeAndCommit
	8,  // 36: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	57, // 37: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	39, // 38: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	58, // 39: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	44, // 40: gerrit.ListFileOwnersRequest.options:type_name -> gerrit.AccountOptions
	12, // 41: gerrit.OwnerInfo.account:type_name -> gerrit.AccountInfo
	46, // 42: gerrit.ListOwnersResponse.owners:type_name -> gerrit.OwnerInfo
	...
	40, // 48: gerrit.ListProjectsResponse.ProjectsEntry.value:type_name -> gerrit.ProjectInfo
	38, // 49: gerrit.Gerrit.ListProjects:input_type -> gerrit.ListProjectsRequest
	42, // 50: gerrit.Gerrit.GetRefInfo:input_type -> gerrit.RefInfoRequest
	45, // 51: gerrit.Gerrit.ListFileOwners:input_type -> gerrit.ListFileOwnersRequest
	...
	32, // 54: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	34, // 55: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	36, // 56: gerrit.Gerrit.GetRelatedChanges:input_type -> gerrit.GetRelatedChangesRequest
	...
	28, // 62: gerrit.Gerrit.DeleteReviewer:input_type -> gerrit.DeleteReviewerRequest
	29, // 63: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	31, // 64: gerrit.Gerrit.AddToAttentionSet:input_type -> gerrit.AttentionSetRequest
	20, // 65: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	24, // 66: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	41, // 67: gerrit.Gerrit.ListProjects:output_type -> gerrit.ListProjectsResponse
	43, // 68: gerrit.Gerrit.GetRefInfo:output_type -> gerrit.RefInfo
	47, // 69: gerrit.Gerrit.ListFileOwners:output_type -> gerrit.ListOwnersResponse
	10, // 70: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	13, // 71: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	33, // 72: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	35, // 73: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
	37, // 74: gerrit.Gerrit.GetRelatedChanges:output_type -> gerrit.GetRelatedChangesResponse
	13, // 75: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	60, // 76: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	60, // 77: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	60, // 78: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	27, // 79: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	60, // 80: gerrit.Gerrit.DeleteReviewer:output_type -> google.protobuf.Empty
	30, // 81: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	12, // 82: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	13, // 83: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	13, // 84: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
