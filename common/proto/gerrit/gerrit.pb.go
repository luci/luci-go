...
func (x *ListChangesRequest) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *ListChangesRequest) GetStart() int64 {
	if x != nil {
		return x.Start
	}
	return 0
...
type ListChangesResponse struct {
	...
	//
	// Specifically, this is true iff the number of changes matching the query
	// exceeds either the internal limit or the limit supplied in the `number`
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65,
	0x72, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x22, 0x66, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x43,
