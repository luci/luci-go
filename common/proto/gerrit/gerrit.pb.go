...
type CommitInfo struct {
	...
	// The commit message. Not set when part of the GetRelatedChangesResponse.
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x6f, 0x52, 0x06, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x2a, 0xd3, 0x03, 0x0a, 0x0b,
	...
	0x01, 0x2a, 0x6f, 0x0a, 0x06, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x16, 0x0a, 0x12, 0x4e,
	...
	0x06, 0x54, 0x48, 0x45, 0x49, 0x52, 0x53, 0x10, 0x05, 0x32, 0xc6, 0x09, 0x0a, 0x06, 0x47, 0x65,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	...
	49, // 13: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	50, // 14: gerrit.CommitInfo.parents:type_name -> gerrit.CommitInfo.Parent
	...
	58, // 21: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	...
	51, // 26: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	...
	52, // 29: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	53, // 30: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	...
	54, // 35: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	55, // 36: gerrit.GetRelatedChangesResponse.changes:type_name -> gerrit.GetRelatedChangesResponse.ChangeAndCommit
	8,  // 37: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	56, // 38: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	38, // 39: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	57, // 40: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	43, // 41: gerrit.ListFileOwnersRequest.options:type_name -> gerrit.AccountOptions
	12, // 42: gerrit.OwnerInfo.account:type_name -> gerrit.AccountInfo
	45, // 43: gerrit.ListOwnersResponse.owners:type_name -> gerrit.OwnerInfo
	...
	39, // 49: gerrit.ListProjectsResponse.ProjectsEntry.value:type_name -> gerrit.ProjectInfo
	37, // 50: gerrit.Gerrit.ListProjects:input_type -> gerrit.ListProjectsRequest
	41, // 51: gerrit.Gerrit.GetRefInfo:input_type -> gerrit.RefInfoRequest
	44, // 52: gerrit.Gerrit.ListFileOwners:input_type -> gerrit.ListFileOwnersRequest
	...
	31, // 55: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	33, // 56: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	35, // 57: gerrit.Gerrit.GetRelatedChanges:input_type -> gerrit.GetRelatedChangesRequest
	...
	28, // 63: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	30, // 64: gerrit.Gerrit.AddToAttentionSet:input_type -> gerrit.AttentionSetRequest
	...
	40, // 67: gerrit.Gerrit.ListProjects:output_type -> gerrit.ListProjectsResponse
	42, // 68: gerrit.Gerrit.GetRefInfo:output_type -> gerrit.RefInfo
	46, // 69: gerrit.Gerrit.ListFileOwners:output_type -> gerrit.ListOwnersResponse
	...
	32, // 72: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	34, // 73: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
	36, // 74: gerrit.Gerrit.GetRelatedChanges:output_type -> gerrit.GetRelatedChangesResponse
	13, // 75: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	59, // 76: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	59, // 77: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	59, // 78: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	27, // 79: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	29, // 80: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	12, // 81: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	13, // 82: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	13, // 83: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
