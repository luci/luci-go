...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x89, 0x04, 0x0a, 0x0b, 0x51,
	...
	0x10, 0x04, 0x12, 0x0a, 0x0a, 0x06, 0x54, 0x48, 0x45, 0x49, 0x52, 0x53, 0x10, 0x05, 0x32, 0x9b,
	0x0b, 0x0a, 0x06, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74, 0x12, 0x49, 0x0a, 0x0c, 0x4c, 0x69, 0x73,
	...
	0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x42, 0x0a, 0x0c, 0x47,
	0x65, 0x74, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x1b, 0x2e, 0x67, 0x65,
	0x72, 0x72, 0x69, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x61, 0x62, 0x6c,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x67, 0x65, 0x72, 0x72, 0x69,
	0x74, 0x2e, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	0x40, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x18, 0x2e, 0x67,
	...
	,
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_goTypes = []interface{}{
	...
	(*NotifyDetails_Info)(nil),              // 63: gerrit.NotifyDetails.Info
	(*NotifyDetails_Recipient)(nil),         // 64: gerrit.NotifyDetails.Recipient
	nil,                                     // 65: gerrit.ChangeInfo.RevisionsEntry
	nil,                                     // 66: gerrit.ChangeInfo.LabelsEntry
	nil,                                     // 67: gerrit.RevisionInfo.FilesEntry
	(*CommitInfo_Parent)(nil),               // 68: gerrit.CommitInfo.Parent
	nil,                                     // 69: gerrit.LabelInfo.ValuesEntry
	nil,                                     // 70: gerrit.ReviewerInfo.ApprovalsEntry
	nil,                                     // 71: gerrit.SetReviewRequest.LabelsEntry
	nil,                                     // 72: gerrit.ReviewResult.LabelsEntry
	nil,                                     // 73: gerrit.ListFilesResponse.FilesEntry
	(*GetRelatedChangesResponse_ChangeAndCommit)(nil), // 74: gerrit.GetRelatedChangesResponse.ChangeAndCommit
	nil,                           // 75: gerrit.ProjectInfo.RefsEntry
	nil,                           // 76: gerrit.ListProjectsResponse.ProjectsEntry
...
var file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_depIdxs = []int32{
	64, // 0: gerrit.NotifyDetails.recipients:type_name -> gerrit.NotifyDetails.Recipient
	...
	65, // 6: gerrit.ChangeInfo.revisions:type_name -> gerrit.ChangeInfo.RevisionsEntry
	66, // 7: gerrit.ChangeInfo.labels:type_name -> gerrit.ChangeInfo.LabelsEntry
	...
	77, // 10: gerrit.ChangeInfo.created:type_name -> google.protobuf.Timestamp
	77, // 11: gerrit.ChangeInfo.updated:type_name -> google.protobuf.Timestamp
	...
	77, // 19: gerrit.RevisionInfo.created:type_name -> google.protobuf.Timestamp
	20, // 20: gerrit.RevisionInfo.commit:type_name -> gerrit.CommitInfo
	67, // 21: gerrit.RevisionInfo.files:type_name -> gerrit.RevisionInfo.FilesEntry
	68, // 22: gerrit.CommitInfo.parents:type_name -> gerrit.CommitInfo.Parent
	...
	69, // 28: gerrit.LabelInfo.values:type_name -> gerrit.LabelInfo.ValuesEntry
	...
	77, // 31: gerrit.ApprovalInfo.date:type_name -> google.protobuf.Timestamp
	...
	77, // 34: gerrit.ChangeMessageInfo.date:type_name -> google.protobuf.Timestamp
	...
	2,  // 37: gerrit.SubmitInfo.status:type_name -> gerrit.ChangeStatus
	8,  // 38: gerrit.AddReviewerRequest.state:type_name -> gerrit.AddReviewerRequest.State
	1,  // 39: gerrit.AddReviewerRequest.notify:type_name -> gerrit.Notify
	16, // 40: gerrit.ReviewerInfo.account:type_name -> gerrit.AccountInfo
	70, // 41: gerrit.ReviewerInfo.approvals:type_name -> gerrit.ReviewerInfo.ApprovalsEntry
	36, // 42: gerrit.AddReviewerResult.reviewers:type_name -> gerrit.ReviewerInfo
	36, // 43: gerrit.AddReviewerResult.ccs:type_name -> gerrit.ReviewerInfo
	71, // 44: gerrit.SetReviewRequest.labels:type_name -> gerrit.SetReviewRequest.LabelsEntry
	1,  // 45: gerrit.SetReviewRequest.notify:type_name -> gerrit.Notify
	12, // 46: gerrit.SetReviewRequest.notify_details:type_name -> gerrit.NotifyDetails
	42, // 47: gerrit.SetReviewRequest.add_to_attention_set:type_name -> gerrit.AttentionSetInput
	42, // 48: gerrit.SetReviewRequest.remove_from_attention_set:type_name -> gerrit.AttentionSetInput
	72, // 49: gerrit.ReviewResult.labels:type_name -> gerrit.ReviewResult.LabelsEntry
	42, // 50: gerrit.AttentionSetRequest.input:type_name -> gerrit.AttentionSetInput
	1,  // 51: gerrit.AttentionSetInput.notify:type_name -> gerrit.Notify
	12, // 52: gerrit.AttentionSetInput.notify_details:type_name -> gerrit.NotifyDetails
	3,  // 53: gerrit.GetMergeableRequest.strategy:type_name -> gerrit.MergeableStrategy
	9,  // 54: gerrit.MergeableInfo.submit_type:type_name -> gerrit.MergeableInfo.SubmitType
	3,  // 55: gerrit.MergeableInfo.strategy:type_name -> gerrit.MergeableStrategy
	73, // 56: gerrit.ListFilesResponse.files:type_name -> gerrit.ListFilesResponse.FilesEntry
	74, // 57: gerrit.GetRelatedChangesResponse.changes:type_name -> gerrit.GetRelatedChangesResponse.ChangeAndCommit
	10, // 58: gerrit.ProjectInfo.state:type_name -> gerrit.ProjectInfo.State
	75, // 59: gerrit.ProjectInfo.refs:type_name -> gerrit.ProjectInfo.RefsEntry
	50, // 60: gerrit.ProjectInfo.web_links:type_name -> gerrit.WebLinkInfo
	76, // 61: gerrit.ListProjectsResponse.Projects:type_name -> gerrit.ListProjectsResponse.ProjectsEntry
	55, // 62: gerrit.ListFileOwnersRequest.options:type_name -> gerrit.AccountOptions
	16, // 63: gerrit.OwnerInfo.account:type_name -> gerrit.AccountInfo
	57, // 64: gerrit.ListOwnersResponse.owners:type_name -> gerrit.OwnerInfo
	11, // 65: gerrit.SubmitRequirementResultInfo.status:type_name -> gerrit.SubmitRequirementResultInfo.Status
	62, // 66: gerrit.SubmitRequirementResultInfo.applicability_expression_result:type_name -> gerrit.SubmitRequirementExpressionInfo
	62, // 67: gerrit.SubmitRequirementResultInfo.submittability_expression_result:type_name -> gerrit.SubmitRequirementExpressionInfo
	62, // 68: gerrit.SubmitRequirementResultInfo.override_expression_result:type_name -> gerrit.SubmitRequirementExpressionInfo
	4,  // 69: gerrit.NotifyDetails.Recipient.recipient_type:type_name -> gerrit.NotifyDetails.RecipientType
	63, // 70: gerrit.NotifyDetails.Recipient.info:type_name -> gerrit.NotifyDetails.Info
	19, // 71: gerrit.ChangeInfo.RevisionsEntry.value:type_name -> gerrit.RevisionInfo
	21, // 72: gerrit.ChangeInfo.LabelsEntry.value:type_name -> gerrit.LabelInfo
	26, // 73: gerrit.RevisionInfo.FilesEntry.value:type_name -> gerrit.FileInfo
	26, // 74: gerrit.ListFilesResponse.FilesEntry.value:type_name -> gerrit.FileInfo
	20, // 75: gerrit.GetRelatedChangesResponse.ChangeAndCommit.commit:type_name -> gerrit.CommitInfo
	51, // 76: gerrit.ListProjectsResponse.ProjectsEntry.value:type_name -> gerrit.ProjectInfo
	49, // 77: gerrit.Gerrit.ListProjects:input_type -> gerrit.ListProjectsRequest
	53, // 78: gerrit.Gerrit.GetRefInfo:input_type -> gerrit.RefInfoRequest
	56, // 79: gerrit.Gerrit.ListFileOwners:input_type -> gerrit.ListFileOwnersRequest
	13, // 80: gerrit.Gerrit.ListChanges:input_type -> gerrit.ListChangesRequest
	15, // 81: gerrit.Gerrit.GetChange:input_type -> gerrit.GetChangeRequest
	43, // 82: gerrit.Gerrit.GetMergeable:input_type -> gerrit.GetMergeableRequest
	45, // 83: gerrit.Gerrit.ListFiles:input_type -> gerrit.ListFilesRequest
	47, // 84: gerrit.Gerrit.GetRelatedChanges:input_type -> gerrit.GetRelatedChangesRequest
	59, // 85: gerrit.Gerrit.GetPureRevert:input_type -> gerrit.GetPureRevertRequest
	27, // 86: gerrit.Gerrit.CreateChange:input_type -> gerrit.CreateChangeRequest
	31, // 87: gerrit.Gerrit.ChangeEditFileContent:input_type -> gerrit.ChangeEditFileContentRequest
	32, // 88: gerrit.Gerrit.DeleteEditFileContent:input_type -> gerrit.DeleteEditFileContentRequest
	33, // 89: gerrit.Gerrit.ChangeEditPublish:input_type -> gerrit.ChangeEditPublishRequest
	35, // 90: gerrit.Gerrit.AddReviewer:input_type -> gerrit.AddReviewerRequest
	38, // 91: gerrit.Gerrit.DeleteReviewer:input_type -> gerrit.DeleteReviewerRequest
	39, // 92: gerrit.Gerrit.SetReview:input_type -> gerrit.SetReviewRequest
	41, // 93: gerrit.Gerrit.AddToAttentionSet:input_type -> gerrit.AttentionSetRequest
	28, // 94: gerrit.Gerrit.SubmitChange:input_type -> gerrit.SubmitChangeRequest
	34, // 95: gerrit.Gerrit.AbandonChange:input_type -> gerrit.AbandonChangeRequest
	29, // 96: gerrit.Gerrit.SubmitRevision:input_type -> gerrit.SubmitRevisionRequest
	52, // 97: gerrit.Gerrit.ListProjects:output_type -> gerrit.ListProjectsResponse
	54, // 98: gerrit.Gerrit.GetRefInfo:output_type -> gerrit.RefInfo
	58, // 99: gerrit.Gerrit.ListFileOwners:output_type -> gerrit.ListOwnersResponse
	14, // 100: gerrit.Gerrit.ListChanges:output_type -> gerrit.ListChangesResponse
	17, // 101: gerrit.Gerrit.GetChange:output_type -> gerrit.ChangeInfo
	44, // 102: gerrit.Gerrit.GetMergeable:output_type -> gerrit.MergeableInfo
	46, // 103: gerrit.Gerrit.ListFiles:output_type -> gerrit.ListFilesResponse
	48, // 104: gerrit.Gerrit.GetRelatedChanges:output_type -> gerrit.GetRelatedChangesResponse
	60, // 105: gerrit.Gerrit.GetPureRevert:output_type -> gerrit.PureRevertInfo
	17, // 106: gerrit.Gerrit.CreateChange:output_type -> gerrit.ChangeInfo
	78, // 107: gerrit.Gerrit.ChangeEditFileContent:output_type -> google.protobuf.Empty
	78, // 108: gerrit.Gerrit.DeleteEditFileContent:output_type -> google.protobuf.Empty
	78, // 109: gerrit.Gerrit.ChangeEditPublish:output_type -> google.protobuf.Empty
	37, // 110: gerrit.Gerrit.AddReviewer:output_type -> gerrit.AddReviewerResult
	78, // 111: gerrit.Gerrit.DeleteReviewer:output_type -> google.protobuf.Empty
	40, // 112: gerrit.Gerrit.SetReview:output_type -> gerrit.ReviewResult
	16, // 113: gerrit.Gerrit.AddToAttentionSet:output_type -> gerrit.AccountInfo
	17, // 114: gerrit.Gerrit.SubmitChange:output_type -> gerrit.ChangeInfo
	17, // 115: gerrit.Gerrit.AbandonChange:output_type -> gerrit.ChangeInfo
	30, // 116: gerrit.Gerrit.SubmitRevision:output_type -> gerrit.SubmitInfo
...
func file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_common_proto_gerrit_gerrit_proto_msgTypes[62].Exporter = func(v interface{}, i int) interface{} {
