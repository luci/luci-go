...
const (
	...
	Gerrit_CheckRapt_FullMethodName             = "/gerrit.Gerrit/CheckRapt"
...
type GerritClient interface {
	...
	CheckRapt(ctx context.Context, in *CheckRaptRequest, opts ...grpc.CallOption) (*CheckRaptResponse, error)
...
func (c *gerritClient) CheckRapt(ctx context.Context, in *CheckRaptRequest, opts ...grpc.CallOption) (*CheckRaptResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckRaptResponse)
	err := c.cc.Invoke(ctx, Gerrit_CheckRapt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GerritServer interface {
	...
	// Check the RAPT requirement status for the user.
	CheckRapt(context.Context, *CheckRaptRequest) (*CheckRaptResponse, error)
	// Lists changes that match a query.
	//
	// TODO(tandrii): recommend a paging query.
	//
...
func (UnimplementedGerritServer) CheckRapt(context.Context, *CheckRaptRequest) (*CheckRaptResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckRapt not implemented")
}
...
func _Gerrit_CheckRapt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckRaptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GerritServer).CheckRapt(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gerrit_CheckRapt_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GerritServer).CheckRapt(ctx, req.(*CheckRaptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Gerrit_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckRapt",
			Handler:    _Gerrit_CheckRapt_Handler,
		},
		{
