...
var file_go_chromium_org_luci_common_proto_options_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_common_proto_options_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_common_proto_options_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_common_proto_options_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_common_proto_options_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_common_proto_options_proto_rawDesc), len(file_go_chromium_org_luci_common_proto_options_proto_rawDesc)))
	})
...
func file_go_chromium_org_luci_common_proto_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_common_proto_options_proto_rawDesc), len(file_go_chromium_org_luci_common_proto_options_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 3,
			NumServices:   0,
