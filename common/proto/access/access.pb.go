...
func (x *PermittedActionsResponse) GetValidityDuration() *duration.Duration {
	if x != nil {
...
func (*UnimplementedAccessServer) Description(context.Context, *empty.Empty) (*DescriptionResponse, error) {
