...
func (FailureDetails_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{0, 0} }
...
func (*FailureDetails) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
type Step struct {
	...
	// Used by Kitchen to determine whether to send time series data.
	// monitoring_id will be used as a metric field as a unique identifier for a
	// stream of step data. Thus, the MASH queries and alert definitions using
	// these metrics do not need to be updated when, for example a step name
	// changes. Steps without id monitoring_id will not send step data to Monarch.
	// We do not send data for all steps because the metric field cardinality
	// would be too high. Only set the monitoring_id on steps for which you'd like
	// to configure alerts. Otherwise, use step data in BigQuery for analysis.
	MonitoringId string `protobuf:"bytes,26,opt,name=monitoring_id,json=monitoringId" json:"monitoring_id,omitempty"`
}

func (m *Step) Reset()                    { *m = Step{} }
func (m *Step) String() string            { return proto.CompactTextString(m) }
func (*Step) ProtoMessage()               {}
func (*Step) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func (m *Step) GetMonitoringId() string {
	if m != nil {
...
func (*Step_Command) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 0} }
...
func (*Step_Substep) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 1} }
...
func (*Step_Progress) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 2} }
...
func (*Step_Property) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 3} }
...
func (*Link) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (*LogdogStream) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{3} }
...
func (*IsolateObject) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{4} }
...
func (*DMLink) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{5} }
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/common/proto/milo/annotations.proto", fileDescriptor2)
}
...
var fileDescriptor2 = []byte{
	...
	,
}
