...
type Step struct {
	...
	// Steps without monitor=true will not send step data to Monarch.
	// We do not send data for all steps because the metric field cardinality
	// would be too high. Only set monitor=true for steps for which you'd
	// like to configure alerts. Otherwise, use step data in BigQuery for
	// analysis.
	Monitor bool `protobuf:"varint,26,opt,name=monitor" json:"monitor,omitempty"`
	// A "what is this?" identifier for a step, which identifies steps with the
	// same implementation. This value is set by a human when defining the step.
	// Required if monitor=true.
	StepClass string `protobuf:"bytes,27,opt,name=step_class,json=stepClass" json:"step_class,omitempty"`
}
...
func (m *Step) GetStepClass() string {
	if m != nil {
		return m.StepClass
	}
	return ""
...
var fileDescriptor2 = []byte{
	...
	,
}
