...
func (x *TestMessage) GetIntchoice() int32 {
	if x != nil {
		if x, ok := x.Choice.(*TestMessage_Intchoice); ok {
			return x.Intchoice
		}
	}
	return 0
...
func (x *TestMessage) GetStrchoice() string {
	if x != nil {
		if x, ok := x.Choice.(*TestMessage_Strchoice); ok {
			return x.Strchoice
		}
	}
	return ""
...
var file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDesc), len(file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDesc)))
	})
...
var file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_goTypes = []any{
...
func file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_init() {
	...
	file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDesc), len(file_go_chromium_org_luci_common_proto_msgpackpb_msg_test_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
