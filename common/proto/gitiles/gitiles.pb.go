...
func file_go_chromium_org_luci_common_proto_gitiles_gitiles_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_common_proto_gitiles_gitiles_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_common_proto_gitiles_gitiles_proto_msgTypes[15].Exporter = func(v any, i int) any {
