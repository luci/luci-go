...
var file_go_chromium_org_luci_common_proto_gitiles_gitiles_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x32, 0x95, 0x03, 0x0a, 0x07,
	...
	0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x69, 0x74, 0x69, 0x6c, 0x65, 0x73,
...
var file_go_chromium_org_luci_common_proto_gitiles_gitiles_proto_goTypes = []interface{}{
	...
	nil,                          // 13: gitiles.RefsResponse.RevisionsEntry
	(*git.Commit)(nil),           // 14: git.Commit
}
var file_go_chromium_org_luci_common_proto_gitiles_gitiles_proto_depIdxs = []int32{
	14, // 0: gitiles.LogResponse.log:type_name -> git.Commit
	13, // 1: gitiles.RefsResponse.revisions:type_name -> gitiles.RefsResponse.RevisionsEntry
	0,  // 2: gitiles.ArchiveRequest.format:type_name -> gitiles.ArchiveRequest.Format
	1,  // 3: gitiles.Gitiles.Log:input_type -> gitiles.LogRequest
	3,  // 4: gitiles.Gitiles.Refs:input_type -> gitiles.RefsRequest
	5,  // 5: gitiles.Gitiles.Archive:input_type -> gitiles.ArchiveRequest
	7,  // 6: gitiles.Gitiles.DownloadFile:input_type -> gitiles.DownloadFileRequest
	9,  // 7: gitiles.Gitiles.DownloadDiff:input_type -> gitiles.DownloadDiffRequest
	11, // 8: gitiles.Gitiles.Projects:input_type -> gitiles.ProjectsRequest
	2,  // 9: gitiles.Gitiles.Log:output_type -> gitiles.LogResponse
	4,  // 10: gitiles.Gitiles.Refs:output_type -> gitiles.RefsResponse
	6,  // 11: gitiles.Gitiles.Archive:output_type -> gitiles.ArchiveResponse
	8,  // 12: gitiles.Gitiles.DownloadFile:output_type -> gitiles.DownloadFileResponse
	10, // 13: gitiles.Gitiles.DownloadDiff:output_type -> gitiles.DownloadDiffResponse
	12, // 14: gitiles.Gitiles.Projects:output_type -> gitiles.ProjectsResponse
