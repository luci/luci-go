...
func TestTrim(t *testing.T) {
	Convey("Test", t, func() {
		...
		Convey("No op for leaf mask trim", func() {
		...
		Convey("Error when descriptor mismatch", func() {
			...
			So(err, ShouldErrLike, "expected the provided message has same descriptor as that of mask; got message descriptor name: internal.testing.Simple and mask descriptor name: internal.testing.Full")
		})
	})
}
