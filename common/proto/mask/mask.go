...
//
// Supports advanced field mask semantics:which
...
const (
	...
	// PartiallyInclude indicates some subfields of the field value is included.
	PartiallyInclude
	// EntirelyInclude indicates the entire field value is included.
	EntirelyInclude
)
...
// fields or map fields will be overwritten entirely. Partial updates is not
