...
// MustFromReadMask is a shortcut for panicking FromFieldMask with
// isFieldNameJSON and isUpdateMask as false.
func MustFromReadMask(fieldMask *field_mask.FieldMask, targetMsg proto.Message) Mask {
	ret, err := FromFieldMask(fieldMask, targetMsg, false, false)
	if err != nil {
		panic(err)
	}
	return ret
