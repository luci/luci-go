...
//   file := protodesc.ToFileDescriptorProto(myMsg.ProtoReflect().ParentFile().Descriptor())
//   p.AppendLeadingComments(protodesc.ToMessageDescriptorProto(myMsg.ProtoReflect()), []string{
//     "This is a line.",
