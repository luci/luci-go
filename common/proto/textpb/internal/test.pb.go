...
type Container struct {
	...
	Mapping       map[string]*Leaf       `protobuf:"bytes,3,rep,name=mapping,proto3" json:"mapping,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDesc), len(file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDesc)))
	})
...
func file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDesc), len(file_go_chromium_org_luci_common_proto_textpb_internal_test_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
