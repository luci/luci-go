...
// Take from https://cs.chromium.org/chromium/infra/luci/appengine/components/components/config/endpoint.py
const (
...
// Metadata to for config validation.
type Metadata interface {
	// For adding additional ConfigPatterns
...
func GetMetadata(validationURL string, cs string, csPath string) (Metadata, error) {
	// cs and path are added to patterns by default..but this should be an exact?
