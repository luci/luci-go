...
import (
	...
	"go.chromium.org/luci/srcman/git"
)
...
func decodeMD(data []byte) (*srcman.ManifestDiff, error) {
...
func encodeMD(d *srcman.ManifestDiff) ([]byte, error) {
...
// object be cached).
func PopulateHistory(c context.Context, diff *srcman.ManifestDiff, withFiles bool) (ok bool) {
...
func DiffWithBlamelist(c context.Context, a, b *srcman.ManifestLink, options *DiffOptions) (*srcman.ManifestDiff, error) {
