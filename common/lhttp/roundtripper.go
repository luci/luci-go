...
// RoundTripper creates an http.RoundTripper from a function.
// It might make your code more concise.
func RoundTripper(roundTrip func(r *http.Request) (*http.Response, error)) http.RoundTripper {
	return &delegatedTransport{roundTrip: roundTrip}
}
...
func (t *delegatedTransport) RoundTrip(r *http.Request) (*http.Response, error) {
