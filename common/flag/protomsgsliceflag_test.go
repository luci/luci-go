...
import (
	...
	"github.com/golang/protobuf/ptypes/emtpy"
...
func TestProtoMessageSliceFlag(t *testing.T) {
	...
	Convey(`Panic when input pointer dose not point to slice`, t, func() {
	...
	Convey(`Panic when element pointer does not point to struct`, t, func() {
		So(func() { MessageSliceFlag(&[]*messageImpl{}) }, ShouldPanic)
	})
}
