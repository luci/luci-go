	...
	Convey("Test annotation struct", t, func() {
		...
		Convey("annotation can render itself for internal usage", func() {
			...
			So(lines, ShouldResemble, []string{
				...
				``,
				`#? github.com/jtolds/gls@v4.20.0+incompatible/context.go:97 - gls.(*ContextManager).SetValues.func1()`,
				`#? github.com/jtolds/gls@v4.20.0+incompatible/gid.go:24 - gls.EnsureGoroutineId.func1()`,
				`#? github.com/jtolds/gls@v4.20.0+incompatible/stack_tags.go:108 - gls._m()`,
				`#? github.com/jtolds/gls@v4.20.0+incompatible/stack_tags.go:56 - gls.github_com_jtolds_gls_markS()`,
				`#? github.com/jtolds/gls@v4.20.0+incompatible/stack_tags.go:49 - gls.addStackTag()`,
				`#? github.com/jtolds/gls@v4.20.0+incompatible/gid.go:24 - gls.EnsureGoroutineId()`,
				`#? github.com/jtolds/gls@v4.20.0+incompatible/context.go:63 - gls.(*ContextManager).SetValues()`,
				`... skipped SOME frames in pkg "github.com/smartystreets/goconvey/convey"...`,
				``,
