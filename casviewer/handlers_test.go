...
const testTemplatePath = "appengine/templates"

const testInstance = "projects/test-proj/instances/default_instance"

var perm = realms.RegisterPermission("luci.serviceAccounts.mintToken")
...
func TestHandlers(t *testing.T) {
	...
	Convey("Templates", t, func() {
		...
		templateBundleMW := templates.WithTemplates(getTemplateBundle("appengine/templates"))
	...
	Convey("InstallHandlers", t, func() {
		...
		InstallHandlers(r, cc, testTemplatePath)
