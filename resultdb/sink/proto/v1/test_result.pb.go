...
const file_go_chromium_org_luci_resultdb_sink_proto_v1_test_result_proto_rawDesc = "" +
	"\n" +
	"=go.chromium.org/luci/resultdb/sink/proto/v1/test_result.proto\x12\x12luci.resultsink.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a3go.chromium.org/luci/resultdb/proto/v1/common.proto\x1a;go.chromium.org/luci/resultdb/proto/v1/failure_reason.proto\x1a;go.chromium.org/luci/resultdb/proto/v1/skipped_reason.proto\x1a:go.chromium.org/luci/resultdb/proto/v1/test_metadata.proto\x1a8go.chromium.org/luci/resultdb/proto/v1/test_result.proto\"\xca\b\n" +
	"\n" +
	"TestResult\x12P\n" +
	"\x12test_id_structured\x18\x0f \x01(\v2\".luci.resultsink.v1.TestIdentifierR\x10testIdStructured\x12\x17\n" +
	"\atest_id\x18\x01 \x01(\tR\x06testId\x12\x1b\n" +
	"\tresult_id\x18\x02 \x01(\tR\bresultId\x12\x1a\n" +
	"\bexpected\x18\x03 \x01(\bR\bexpected\x124\n" +
	"\x06status\x18\x04 \x01(\x0e2\x1c.luci.resultdb.v1.TestStatusR\x06status\x12@\n" +
	"\tstatus_v2\x18\x10 \x01(\x0e2#.luci.resultdb.v1.TestResult.StatusR\bstatusV2\x12!\n" +
	"\fsummary_html\x18\x05 \x01(\tR\vsummaryHtml\x129\n" +
	"\n" +
	"start_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bduration\x18\a \x01(\v2\x19.google.protobuf.DurationR\bduration\x120\n" +
	"\x04tags\x18\b \x03(\v2\x1c.luci.resultdb.v1.StringPairR\x04tags\x12K\n" +
	"\tartifacts\x18\t \x03(\v2-.luci.resultsink.v1.TestResult.ArtifactsEntryR\tartifacts\x12C\n" +
	"\rtest_metadata\x18\v \x01(\v2\x1e.luci.resultdb.v1.TestMetadataR\ftestMetadata\x12F\n" +
	"\x0efailure_reason\x18\f \x01(\v2\x1f.luci.resultdb.v1.FailureReasonR\rfailureReason\x123\n" +
	"\avariant\x18\r \x01(\v2\x19.luci.resultdb.v1.VariantR\avariant\x127\n" +
	"\n" +
	...
	"\x14framework_extensions\x18\x16 \x01(\v2%.luci.resultdb.v1.FrameworkExtensionsR\x13frameworkExtensions\x1aZ\n" +
	"\x0eArtifactsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.luci.resultsink.v1.ArtifactR\x05value:\x028\x01J\x04\b\n" +
	"\x10\vR\rtest_location\"\x8d\x01\n" +
	"\bArtifact\x12\x1d\n" +
	"\tfile_path\x18\x01 \x01(\tH\x00R\bfilePath\x12\x1c\n" +
	"\bcontents\x18\x02 \x01(\fH\x00R\bcontents\x12\x19\n" +
	"\agcs_uri\x18\x04 \x01(\tH\x00R\x06gcsUri\x12!\n" +
	"\fcontent_type\x18\x03 \x01(\tR\vcontentTypeB\x06\n" +
	"\x04body\"\xac\x01\n" +
	"\x0eTestResultFile\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12A\n" +
	"\x06format\x18\x02 \x01(\x0e2).luci.resultsink.v1.TestResultFile.FormatR\x06format\"C\n" +
	"\x06Format\x12\b\n" +
	"\x04LUCI\x10\x00\x12\x1e\n" +
	"\x1aCHROMIUM_JSON_TEST_RESULTS\x10\x01\x12\x0f\n" +
	"\vGOOGLE_TEST\x10\x02\"\x80\x01\n" +
	"\x0eTestIdentifier\x12\x1f\n" +
	"\vcoarse_name\x18\x01 \x01(\tR\n" +
	"coarseName\x12\x1b\n" +
	"\tfine_name\x18\x02 \x01(\tR\bfineName\x120\n" +
	"\x14case_name_components\x18\x03 \x03(\tR\x12caseNameComponentsB4Z2go.chromium.org/luci/resultdb/sink/proto/v1;sinkpbb\x06proto3"
