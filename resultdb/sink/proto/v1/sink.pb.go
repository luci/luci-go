...
func (x *ReportTestExonerationsRequest) Reset() {
	*x = ReportTestExonerationsRequest{}
	mi := &file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportTestExonerationsRequest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_rawDescGZIP(), []int{5}
}
...
func (x *ReportTestExonerationsResponse) Reset() {
	*x = ReportTestExonerationsResponse{}
	mi := &file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportTestExonerationsResponse) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_rawDescGZIP(), []int{6}
}

func (x *ReportTestExonerationsResponse) GetTestExonerationNames() []string {
	if x != nil {
		return x.TestExonerationNames
	}
	return nil
}
...
const file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_rawDesc = "" +
	"\n" +
	"6go.chromium.org/luci/resultdb/sink/proto/v1/sink.proto\x12\x12luci.resultsink.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/protobuf/struct.proto\x1aBgo.chromium.org/luci/resultdb/sink/proto/v1/test_exoneration.proto\x1a=go.chromium.org/luci/resultdb/sink/proto/v1/test_result.proto\"]\n" +
	"\x18ReportTestResultsRequest\x12A\n" +
	"\ftest_results\x18\x01 \x03(\v2\x1e.luci.resultsink.v1.TestResultR\vtestResults\"G\n" +
	"\x19ReportTestResultsResponse\x12*\n" +
	"\x11test_result_names\x18\x01 \x03(\tR\x0ftestResultNames\"\xeb\x01\n" +
	"%ReportInvocationLevelArtifactsRequest\x12f\n" +
	"\tartifacts\x18\x01 \x03(\v2H.luci.resultsink.v1.ReportInvocationLevelArtifactsRequest.ArtifactsEntryR\tartifacts\x1aZ\n" +
	"\x0eArtifactsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.luci.resultsink.v1.ArtifactR\x05value:\x028\x01\"\x96\x01\n" +
	"\x17UpdateInvocationRequest\x12>\n" +
	"\n" +
	"invocation\x18\x01 \x01(\v2\x1e.luci.resultsink.v1.InvocationR\n" +
	"invocation\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\xd5\x01\n" +
	"\n" +
	"Invocation\x12g\n" +
	"\x13extended_properties\x18\x01 \x03(\v26.luci.resultsink.v1.Invocation.ExtendedPropertiesEntryR\x12extendedProperties\x1a^\n" +
	"\x17ExtendedPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05value:\x028\x01\"q\n" +
	"\x1dReportTestExonerationsRequest\x12P\n" +
	"\x11test_exonerations\x18\x01 \x03(\v2#.luci.resultsink.v1.TestExonerationR\x10testExonerations\"V\n" +
	"\x1eReportTestExonerationsResponse\x124\n" +
	"\x16test_exoneration_names\x18\x01 \x03(\tR\x14testExonerationNames2\xd8\x03\n" +
	"\x04Sink\x12r\n" +
	"\x11ReportTestResults\x12,.luci.resultsink.v1.ReportTestResultsRequest\x1a-.luci.resultsink.v1.ReportTestResultsResponse\"\x00\x12u\n" +
	"\x1eReportInvocationLevelArtifacts\x129.luci.resultsink.v1.ReportInvocationLevelArtifactsRequest\x1a\x16.google.protobuf.Empty\"\x00\x12a\n" +
	"\x10UpdateInvocation\x12+.luci.resultsink.v1.UpdateInvocationRequest\x1a\x1e.luci.resultsink.v1.Invocation\"\x00\x12\x81\x01\n" +
	"\x16ReportTestExonerations\x121.luci.resultsink.v1.ReportTestExonerationsRequest\x1a2.luci.resultsink.v1.ReportTestExonerationsResponse\"\x00B4Z2go.chromium.org/luci/resultdb/sink/proto/v1;sinkpbb\x06proto3"
...
var file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_goTypes = []any{
	...
	(*ReportTestExonerationsRequest)(nil),         // 5: luci.resultsink.v1.ReportTestExonerationsRequest
	(*ReportTestExonerationsResponse)(nil),        // 6: luci.resultsink.v1.ReportTestExonerationsResponse
	nil,                                           // 7: luci.resultsink.v1.ReportInvocationLevelArtifactsRequest.ArtifactsEntry
	nil,                                           // 8: luci.resultsink.v1.Invocation.ExtendedPropertiesEntry
	(*TestResult)(nil),                            // 9: luci.resultsink.v1.TestResult
	(*fieldmaskpb.FieldMask)(nil),                 // 10: google.protobuf.FieldMask
	(*TestExoneration)(nil),                       // 11: luci.resultsink.v1.TestExoneration
	(*Artifact)(nil),                              // 12: luci.resultsink.v1.Artifact
	(*structpb.Struct)(nil),                       // 13: google.protobuf.Struct
	(*emptypb.Empty)(nil),                         // 14: google.protobuf.Empty
}
var file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_depIdxs = []int32{
	9,  // 0: luci.resultsink.v1.ReportTestResultsRequest.test_results:type_name -> luci.resultsink.v1.TestResult
	7,  // 1: luci.resultsink.v1.ReportInvocationLevelArtifactsRequest.artifacts:type_name -> luci.resultsink.v1.ReportInvocationLevelArtifactsRequest.ArtifactsEntry
	4,  // 2: luci.resultsink.v1.UpdateInvocationRequest.invocation:type_name -> luci.resultsink.v1.Invocation
	10, // 3: luci.resultsink.v1.UpdateInvocationRequest.update_mask:type_name -> google.protobuf.FieldMask
	8,  // 4: luci.resultsink.v1.Invocation.extended_properties:type_name -> luci.resultsink.v1.Invocation.ExtendedPropertiesEntry
	11, // 5: luci.resultsink.v1.ReportTestExonerationsRequest.test_exonerations:type_name -> luci.resultsink.v1.TestExoneration
	12, // 6: luci.resultsink.v1.ReportInvocationLevelArtifactsRequest.ArtifactsEntry.value:type_name -> luci.resultsink.v1.Artifact
	13, // 7: luci.resultsink.v1.Invocation.ExtendedPropertiesEntry.value:type_name -> google.protobuf.Struct
	0,  // 8: luci.resultsink.v1.Sink.ReportTestResults:input_type -> luci.resultsink.v1.ReportTestResultsRequest
	2,  // 9: luci.resultsink.v1.Sink.ReportInvocationLevelArtifacts:input_type -> luci.resultsink.v1.ReportInvocationLevelArtifactsRequest
	3,  // 10: luci.resultsink.v1.Sink.UpdateInvocation:input_type -> luci.resultsink.v1.UpdateInvocationRequest
	5,  // 11: luci.resultsink.v1.Sink.ReportTestExonerations:input_type -> luci.resultsink.v1.ReportTestExonerationsRequest
	1,  // 12: luci.resultsink.v1.Sink.ReportTestResults:output_type -> luci.resultsink.v1.ReportTestResultsResponse
	14, // 13: luci.resultsink.v1.Sink.ReportInvocationLevelArtifacts:output_type -> google.protobuf.Empty
	4,  // 14: luci.resultsink.v1.Sink.UpdateInvocation:output_type -> luci.resultsink.v1.Invocation
	6,  // 15: luci.resultsink.v1.Sink.ReportTestExonerations:output_type -> luci.resultsink.v1.ReportTestExonerationsResponse
...
func file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_init() {
	...
	file_go_chromium_org_luci_resultdb_sink_proto_v1_test_exoneration_proto_init()
...
func (c *sinkPRPCClient) ReportTestExonerations(ctx context.Context, in *ReportTestExonerationsRequest, opts ...grpc.CallOption) (*ReportTestExonerationsResponse, error) {
	out := new(ReportTestExonerationsResponse)
	err := c.client.Call(ctx, "luci.resultsink.v1.Sink", "ReportTestExonerations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sinkClient) ReportTestExonerations(ctx context.Context, in *ReportTestExonerationsRequest, opts ...grpc.CallOption) (*ReportTestExonerationsResponse, error) {
	out := new(ReportTestExonerationsResponse)
	err := c.cc.Invoke(ctx, "/luci.resultsink.v1.Sink/ReportTestExonerations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSinkServer) ReportTestExonerations(context.Context, *ReportTestExonerationsRequest) (*ReportTestExonerationsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportTestExonerations not implemented")
}
...
func _Sink_ReportTestExonerations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportTestExonerationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SinkServer).ReportTestExonerations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/luci.resultsink.v1.Sink/ReportTestExonerations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SinkServer).ReportTestExonerations(ctx, req.(*ReportTestExonerationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Sink_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReportTestExonerations",
			Handler:    _Sink_ReportTestExonerations_Handler,
		},
	},
