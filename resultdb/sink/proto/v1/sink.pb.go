...
type ReportInvocationToUpdateRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Invocation message which contains the updated information.
	// Note it's not the invocation to be updated, but only a temporary container
...
func (x *ReportInvocationToUpdateRequest) Reset() {
	*x = ReportInvocationToUpdateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportInvocationToUpdateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportInvocationToUpdateRequest) ProtoMessage() {}

func (x *ReportInvocationToUpdateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportInvocationToUpdateRequest.ProtoReflect.Descriptor instead.
func (*ReportInvocationToUpdateRequest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_rawDescGZIP(), []int{2}
}

func (x *ReportInvocationToUpdateRequest) GetInvocation() *Invocation {
	if x != nil {
		return x.Invocation
	}
	return nil
...
func (x *ReportInvocationToUpdateRequest) GetUpdateMask() *field_mask.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
var file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_rawDesc = []byte{
	...
	0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x3c, 0x67, 0x6f, 0x2e,
	...
	0x22, 0x9e, 0x01, 0x0a, 0x1f, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x6f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x0a, 0x69, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e,
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x69, 0x6e, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e,
	...
	0x6b, 0x32, 0xe5, 0x01, 0x0a, 0x04, 0x53, 0x69, 0x6e, 0x6b, 0x12, 0x72, 0x0a, 0x11, 0x52, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12,
	0x2c, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x69, 0x6e,
	0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52,
	...
	0x75, 0x6c, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x69,
	0x0a, 0x18, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x54, 0x6f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x33, 0x2e, 0x6c, 0x75, 0x63,
	0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x69, 0x6e, 0x6b, 0x2e, 0x76, 0x31, 0x2e,
	0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x54, 0x6f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
...
var file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_goTypes = []interface{}{
	...
	(*ReportInvocationToUpdateRequest)(nil), // 2: luci.resultsink.v1.ReportInvocationToUpdateRequest
	(*TestResult)(nil),                      // 3: luci.resultsink.v1.TestResult
...
var file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_depIdxs = []int32{
	3, // 0: luci.resultsink.v1.ReportTestResultsRequest.test_results:type_name -> luci.resultsink.v1.TestResult
	4, // 1: luci.resultsink.v1.ReportInvocationToUpdateRequest.invocation:type_name -> luci.resultsink.v1.Invocation
	5, // 2: luci.resultsink.v1.ReportInvocationToUpdateRequest.update_mask:type_name -> google.protobuf.FieldMask
	0, // 3: luci.resultsink.v1.Sink.ReportTestResults:input_type -> luci.resultsink.v1.ReportTestResultsRequest
	2, // 4: luci.resultsink.v1.Sink.ReportInvocationToUpdate:input_type -> luci.resultsink.v1.ReportInvocationToUpdateRequest
	1, // 5: luci.resultsink.v1.Sink.ReportTestResults:output_type -> luci.resultsink.v1.ReportTestResultsResponse
	6, // 6: luci.resultsink.v1.Sink.ReportInvocationToUpdate:output_type -> google.protobuf.Empty
...
func file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_init() {
	...
	file_go_chromium_org_luci_resultdb_sink_proto_v1_invocation_proto_init()
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_sink_proto_v1_sink_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportInvocationToUpdateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type SinkClient interface {
	...
	// Updates the current invocation by copying the updated information in the
	// request.
	ReportInvocationToUpdate(ctx context.Context, in *ReportInvocationToUpdateRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *sinkPRPCClient) ReportInvocationToUpdate(ctx context.Context, in *ReportInvocationToUpdateRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.client.Call(ctx, "luci.resultsink.v1.Sink", "ReportInvocationToUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sinkClient) ReportInvocationToUpdate(ctx context.Context, in *ReportInvocationToUpdateRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/luci.resultsink.v1.Sink/ReportInvocationToUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SinkServer interface {
	...
	// Updates the current invocation by copying the updated information in the
	// request.
	ReportInvocationToUpdate(context.Context, *ReportInvocationToUpdateRequest) (*empty.Empty, error)
}
...
func (*UnimplementedSinkServer) ReportInvocationToUpdate(context.Context, *ReportInvocationToUpdateRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportInvocationToUpdate not implemented")
}
...
func _Sink_ReportInvocationToUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportInvocationToUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SinkServer).ReportInvocationToUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/luci.resultsink.v1.Sink/ReportInvocationToUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SinkServer).ReportInvocationToUpdate(ctx, req.(*ReportInvocationToUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Sink_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReportInvocationToUpdate",
			Handler:    _Sink_ReportInvocationToUpdate_Handler,
		},
	},
