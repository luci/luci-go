...
const file_go_chromium_org_luci_resultdb_sink_proto_v1_location_tag_proto_rawDesc = "" +
	"\n" +
	">go.chromium.org/luci/resultdb/sink/proto/v1/location_tag.proto\x12\x12luci.resultsink.v1\x1a3go.chromium.org/luci/resultdb/proto/v1/common.proto\x1a:go.chromium.org/luci/resultdb/proto/v1/test_metadata.proto\"\x85\x06\n" +
	"\fLocationTags\x12A\n" +
	"\x05repos\x18\x01 \x03(\v2+.luci.resultsink.v1.LocationTags.ReposEntryR\x05repos\x1a\xd3\x02\n" +
	"\x04Repo\x12C\n" +
	"\x04dirs\x18\x01 \x03(\v2/.luci.resultsink.v1.LocationTags.Repo.DirsEntryR\x04dirs\x12F\n" +
	"\x05files\x18\x02 \x03(\v20.luci.resultsink.v1.LocationTags.Repo.FilesEntryR\x05files\x1a]\n" +
	"\tDirsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12:\n" +
	"\x05value\x18\x02 \x01(\v2$.luci.resultsink.v1.LocationTags.DirR\x05value:\x028\x01\x1a_\n" +
	"\n" +
	"FilesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.luci.resultsink.v1.LocationTags.FileR\x05value:\x028\x01\x1a|\n" +
	"\x03Dir\x120\n" +
	"\x04tags\x18\x01 \x03(\v2\x1c.luci.resultdb.v1.StringPairR\x04tags\x12C\n" +
	"\rbug_component\x18\x02 \x01(\v2\x1e.luci.resultdb.v1.BugComponentR\fbugComponent\x1a}\n" +
	"\x04File\x120\n" +
	"\x04tags\x18\x01 \x03(\v2\x1c.luci.resultdb.v1.StringPairR\x04tags\x12C\n" +
	"\rbug_component\x18\x02 \x01(\v2\x1e.luci.resultdb.v1.BugComponentR\fbugComponent\x1a_\n" +
	"\n" +
	"ReposEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.luci.resultsink.v1.LocationTags.RepoR\x05value:\x028\x01B4Z2go.chromium.org/luci/resultdb/sink/proto/v1;sinkpbb\x06proto3"
