...
func (u *ArtifactUploader) StreamUpload(ctx context.Context, t *uploadTask, updateToken string) error {
	...
	// Client.Do closes the body on 3xx responses and calls GetBody to get a new copy of
	// the body. If the artifact content is from a file, then the following overrides
	// simply move the cursor w/o reopening the file on GetBody.
