...
type artifactUploader struct {
	// Recorder is a gRPC client to be used for uploading artifacts smaller than
	// or equal to MaxBatchableArtifactSize.
	Recorder pb.RecorderClient

	// StreamClient is an HTTP client to be used for uploading artifacts larger than
