...
type ServerConfig struct {
	...
	//
	// If true, a test will be reported without the duration, if the duration was negative.
	// If false, ReportTestResults() will return an error if a test result had a negative duration.
