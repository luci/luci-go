...
type ServerConfig struct {
	...
	// BaseVariant will be added to the variant of each TestResult. If there are duplicates,
	// the variant value given by the test command always wins.
