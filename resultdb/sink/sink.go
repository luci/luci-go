...
type ServerConfig struct {
	...
	// AUMaxLease specifies the maximum number of concurrent requests for Artifact uploads.
	// If not specified or set with 0, DefaultAUMaxLease will be set.
	AUMaxLease uint16

	// TRMaxLease specifies the maximum number of concurrent requests for TestResults uploads.
