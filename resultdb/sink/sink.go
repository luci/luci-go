...
type ServerConfig struct {
	...
	// LocationBase will be prepended to the Location.FileName of each TestResult.
	LocationBase string
...
func (c *ServerConfig) Validate() error {
	...
	if err := c.validateLocationBase(); err != nil {
		return errors.Annotate(err, "LocationBase").Err()
	}
	return nil
}

func (c *ServerConfig) validateLocationBase() error {
	switch {
	case c.LocationBase == "":
		return nil
	case !locationPrefixRe.MatchString(c.LocationBase):
