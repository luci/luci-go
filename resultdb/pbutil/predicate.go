...
func NormalizeTestPathPredicate(pred *pb.TestPathPredicate) *pb.TestPathPredicate {
	...
	// The following alogrithm is linear (ignoring the length of prefixes).
	...
	// For example, with input ["a", "a.a", "a.b", ..., "a.z", "b", "b.a"]
	// when we process "b.a", covered() processes only "a" and "b" and does not
	// have to compare to "a.a", "a.b", etc.
