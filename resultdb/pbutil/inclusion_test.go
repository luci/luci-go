...
func TestInclusionName(t *testing.T) {
	Convey("ParseInclusionName", t, func() {
		...
		Convey("Parse failed", func() {
			...
			So(err, ShouldErrLike, `does not match format "invocations/{including_invocation_id}/inclusions/{included_invocation_id}"`)
		})
...
func TestValidateCreateInclusionRequest(t *testing.T) {
	Convey(`ValidateCreateInclusionRequest`, t, func() {
		...
		Convey(`Invalid invocation`, func() {
			...
			So(err, ShouldErrLike, `invocation: does not match format`)
		})
		...
		Convey(`Invalid included_invocation`, func() {
			...
			So(err, ShouldErrLike, `inclusion.included_invocation: does not match format`)
		})

		Convey(`overridden_by`, func() {
			err := ValidateCreateInclusionRequest(&pb.CreateInclusionRequest{
				Invocation: "invocations/a",
				Inclusion: &pb.Inclusion{
					IncludedInvocation: "invocations/b",
			...
			So(err, ShouldErrLike, `inclusion.overridden_by: must be empty`)
		})
...
func TestValidateOverrideInclusionRequest(t *testing.T) {
	Convey(`ValidateOverrideInclusionRequest`, t, func() {
		...
		Convey(`Invalid including_invocation`, func() {
			...
			So(err, ShouldErrLike, `including_invocation: does not match format`)
		})
		...
		Convey(`Invalid overridden_included_invocation`, func() {
			...
			So(err, ShouldErrLike, `overridden_included_invocation: does not match format`)
		})
		...
		Convey(`Invalid overriding_included_invocation`, func() {
			...
			So(err, ShouldErrLike, `overriding_included_invocation: does not match format`)
		})
