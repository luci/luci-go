...
// itemC the paging query is exhausted or context is canceled.
...
// respectively.
//
// QueryTestResults does not return a next page token because ctx can be
// canceled in the middle of a page.
//
...
// queryResponses pages through query results and sends responses to itemC.
...
// Returned batch is a slice of items.
