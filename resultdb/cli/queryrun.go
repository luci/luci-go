...
func (r *queryRun) registerFlags(p Params, jsonUsage string) {
	r.RegisterGlobalFlags(p)
	r.RegisterJSONFlag(help(`
	...
	r.Flags.BoolVar(&r.merge, "merge", false, help(`
...
// This format supports streaming, and is easy to parse by languages that do
// cannot otherwise parse a sequence of JSON values, such as Python.
