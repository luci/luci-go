...
func TestSwarming(t *testing.T) {
	...
	Convey(`deriveProtosForWriting works`, t, func() {
	...
	Convey(`converts swarming timestamps`, t, func() {
		withoutZ := "2014-09-24T13:49:16.012345"
		tpb, err := convertSwarmingTs(withoutZ)
		So(err, ShouldBeNil)
		So(tpb, ShouldResembleProto, &tspb.Timestamp{Seconds: 1411566556, Nanos: 12345e3})

		withZ := "2014-09-24T13:49:16.012345Z"
		tpb, err = convertSwarmingTs(withZ)
		So(err, ShouldBeNil)
		So(tpb, ShouldResembleProto, &tspb.Timestamp{Seconds: 1411566556, Nanos: 12345e3})
	})
}
