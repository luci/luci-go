...
func TestIncludeInvocation(t *testing.T) {
	Convey(`TestIncludeInvocation`, t, func() {
		...
		Convey(`without overriding`, func() {
			Convey(`invalid request`, func() {
				_, err := recorder.IncludeInvocation(ctx, &pb.IncludeInvocationRequest{})
