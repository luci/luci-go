...
const (
	// The file is a sequence of TestResult JSON objects (not JSON Array).
	// The default format.
...
type TestResult struct {
	...
	ExtraVariantPairs *v1.VariantDef `protobuf:"bytes,2,opt,name=extra_variant_pairs,json=extraVariantPairs,proto3" json:"extra_variant_pairs,omitempty"`
	...
	InputArtifacts map[string]*Artifact `protobuf:"bytes,8,rep,name=input_artifacts,json=inputArtifacts,proto3" json:"input_artifacts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Equivalent of luci.resultpb.TestResult.output_artifacts.
	// The map key is an artifact name.
	OutputArtifacts      map[string]*Artifact `protobuf:"bytes,9,rep,name=output_artifacts,json=outputArtifacts,proto3" json:"output_artifacts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
// in ../../rpc/v1/test_result.proto.
// See its comments for details.
// Does not have a name because it is avialable as a map key in
...
var fileDescriptor_c45f29128cb6d695 = []byte{
	...
	,
}
