...
// A container for message to a ResultSink server. The server accepts a sequenc
// of these messages in JSON format.
type SinkMessageContainer struct {
	...
	Entry                isSinkMessageContainer_Entry `protobuf_oneof:"entry"`
...
type isSinkMessageContainer_Entry interface {
	isSinkMessageContainer_Entry()
}
...
func (*SinkMessageContainer_Handshake) isSinkMessageContainer_Entry() {}

func (*SinkMessageContainer_TestResult) isSinkMessageContainer_Entry() {}

func (*SinkMessageContainer_TestResultFile) isSinkMessageContainer_Entry() {}

func (m *SinkMessageContainer) GetEntry() isSinkMessageContainer_Entry {
	if m != nil {
		return m.Entry
	}
	return nil
...
func (m *SinkMessageContainer) GetHandshake() *Handshake {
	if x, ok := m.GetEntry().(*SinkMessageContainer_Handshake); ok {
		return x.Handshake
	}
	return nil
}
...
func (m *SinkMessageContainer) GetTestResult() *TestResult {
	if x, ok := m.GetEntry().(*SinkMessageContainer_TestResult); ok {
		return x.TestResult
	}
	return nil
}
...
func (m *SinkMessageContainer) GetTestResultFile() *TestResultFile {
	if x, ok := m.GetEntry().(*SinkMessageContainer_TestResultFile); ok {
...
var fileDescriptor_67e05c474f1f0646 = []byte{
	...
	,
}
