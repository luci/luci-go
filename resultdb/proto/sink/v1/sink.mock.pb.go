...
// ReportTestResultsFromFile mocks base method
func (m *MockSinkClient) ReportTestResultsFromFile(ctx context.Context, in *ReportTestResultsFromFileRequest, opts ...grpc.CallOption) (*ReportTestResultsFromFileResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ReportTestResultsFromFile", varargs...)
	ret0, _ := ret[0].(*ReportTestResultsFromFileResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReportTestResultsFromFile indicates an expected call of ReportTestResultsFromFile
func (mr *MockSinkClientMockRecorder) ReportTestResultsFromFile(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReportTestResultsFromFile", reflect.TypeOf((*MockSinkClient)(nil).ReportTestResultsFromFile), varargs...)
}
...
// ReportTestResultsFromFile mocks base method
func (m *MockSinkServer) ReportTestResultsFromFile(arg0 context.Context, arg1 *ReportTestResultsFromFileRequest) (*ReportTestResultsFromFileResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReportTestResultsFromFile", arg0, arg1)
	ret0, _ := ret[0].(*ReportTestResultsFromFileResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// ReportTestResultsFromFile indicates an expected call of ReportTestResultsFromFile
func (mr *MockSinkServerMockRecorder) ReportTestResultsFromFile(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReportTestResultsFromFile", reflect.TypeOf((*MockSinkServer)(nil).ReportTestResultsFromFile), arg0, arg1)
}
