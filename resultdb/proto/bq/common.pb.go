...
var file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDesc), len(file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDesc)))
	})
...
var file_go_chromium_org_luci_resultdb_proto_bq_common_proto_goTypes = []any{
...
func file_go_chromium_org_luci_resultdb_proto_bq_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDesc), len(file_go_chromium_org_luci_resultdb_proto_bq_common_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
