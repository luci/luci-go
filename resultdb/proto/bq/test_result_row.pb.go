...
func (x *InvocationRecord) Reset() {
	*x = InvocationRecord{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_bq_test_result_row_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InvocationRecord) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_bq_test_result_row_proto_rawDescGZIP(), []int{1}
}
...
var file_go_chromium_org_luci_resultdb_proto_bq_test_result_row_proto_rawDesc = []byte{
	...
	0x2f, 0x62, 0x71, 0x3b, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func file_go_chromium_org_luci_resultdb_proto_bq_test_result_row_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_bq_test_result_row_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
