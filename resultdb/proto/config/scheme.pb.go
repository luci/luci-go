...
const file_go_chromium_org_luci_resultdb_proto_config_scheme_proto_rawDesc = "" +
	"\n" +
	"7go.chromium.org/luci/resultdb/proto/config/scheme.proto\x12\x14luci.resultdb.config\"\xda\x02\n" +
	"\x06Scheme\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12.\n" +
	"\x13human_readable_name\x18\x02 \x01(\tR\x11humanReadableName\x12:\n" +
	"\x06coarse\x18\x03 \x01(\v2\".luci.resultdb.config.Scheme.LevelR\x06coarse\x126\n" +
	"\x04fine\x18\x04 \x01(\v2\".luci.resultdb.config.Scheme.LevelR\x04fine\x126\n" +
	"\x04case\x18\x05 \x01(\v2\".luci.resultdb.config.Scheme.LevelR\x04case\x1ad\n" +
	"\x05Level\x12.\n" +
	"\x13human_readable_name\x18\x01 \x01(\tR\x11humanReadableName\x12+\n" +
	"\x11validation_regexp\x18\x02 \x01(\tR\x10validationRegexpB5Z3go.chromium.org/luci/resultdb/proto/config;configpbb\x06proto3"
