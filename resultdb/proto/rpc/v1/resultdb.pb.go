...
type ListTestResultsRequest struct {
	...
	// Test results in the response must satisfy this predicate.
	// Field predicate.invocation MUST NOT be specified.
	...
	// Does NOT guarantee returning all test results from chained RPCs until
...
func (m *ListTestResultsRequest) GetPredicate() *TestResultPredicate {
	if m != nil {
		return m.Predicate
	}
	return nil
...
type QueryTestResultsRequest struct {
	...
	// The response is allowed to be stale up to this duration.
...
type QueryTestResultsResponse struct {
	...
	Groups []*QueryTestResultsResponse_Group `protobuf:"bytes,1,rep,name=groups,proto3" json:"groups,omitempty"`
	// A token, which can be sent as `page_token` to retrieve the next page.
	// If this field is omitted, there were no subsequent pages at the time of
	// request.
	NextPageToken        string   `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
func (m *QueryTestResultsResponse) GetGroups() []*QueryTestResultsResponse_Group {
	if m != nil {
		return m.Groups
	}
	return nil
...
type QueryTestResultsResponse_Group struct {
	...
	// QueryTestResultsRequest.predicate.invocation.inclusions was not set to
	// NONE.
	TestResult []*TestResult `protobuf:"bytes,2,rep,name=test_result,json=testResult,proto3" json:"test_result,omitempty"`
	//
	ApplicableExonertions []*TestExoneration `protobuf:"bytes,3,rep,name=applicable_exonertions,json=applicableExonertions,proto3" json:"applicable_exonertions,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}           `json:"-"`
	XXX_unrecognized      []byte             `json:"-"`
	XXX_sizecache         int32              `json:"-"`
}
...
func (m *QueryTestResultsResponse_Group) GetTestResult() []*TestResult {
	if m != nil {
		return m.TestResult
	}
	return nil
...
func (m *QueryTestResultsResponse_Group) GetApplicableExonertions() []*TestExoneration {
	if m != nil {
		return m.ApplicableExonertions
	}
	return nil
}
...
var fileDescriptor_b48732830a4fcfbd = []byte{
	...
	,
}
