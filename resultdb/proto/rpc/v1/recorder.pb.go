...
type CreateInvocationRequest struct {
	...
	// BigQueryExport indicates what BigQuery table(s) that results in this
	// invocation should export to, with optional filter on the results.
	BigQueryExports      []*BigQueryExport `protobuf:"bytes,4,rep,name=big_query_exports,json=bigQueryExports,proto3" json:"big_query_exports,omitempty"`
...
var fileDescriptor_16d7c422285c4f93 = []byte{
	...
	,
}
