...
type DeriveChromiumInvocationRequest_SwarmingTask struct {
	...
	//  test_id_prefix: test_id_prefix for each test suite. It could be
	//    * fully-qualified ninja target used to compile the test binary used in
	//      the task, e.g. "//chrome/test:browser_tests";
	//    * customized prefix, e.g.
	//      "//chrome/test:telemetry_gpu_integration_test/trace_test".
