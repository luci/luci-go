...
type Invocation_InclusionAttrs struct {
	...
	// inclusion is stabilized. In contrast, if B is active, then even if A is
	// finalized and sohuld be immutable, it includes an invocation that may
	// change because it wasn't finalized yet.
	// Such inclusion is not stabilized and will never be because A got
	// finalized before B. By default, QueryTestResult honors only stabilized
