...
// Filters artifacts based on the type of artifacts.
type BigQueryExport_Artifacts_Parent int32

const (
	// All artifacts satisfy this.
	BigQueryExport_Artifacts_ALL BigQueryExport_Artifacts_Parent = 0
	// Invocation level artifacts satisfy this.
	BigQueryExport_Artifacts_INVOCATION BigQueryExport_Artifacts_Parent = 1
	// Test result level artifacts satisfy this.
	BigQueryExport_Artifacts_TEST_RESULT BigQueryExport_Artifacts_Parent = 2
)

// Enum value maps for BigQueryExport_Artifacts_Parent.
var (
	BigQueryExport_Artifacts_Parent_name = map[int32]string{
		0: "ALL",
		1: "INVOCATION",
		2: "TEST_RESULT",
	}
	BigQueryExport_Artifacts_Parent_value = map[string]int32{
		"ALL":         0,
		"INVOCATION":  1,
		"TEST_RESULT": 2,
	}
...
func (x BigQueryExport_Artifacts_Parent) Enum() *BigQueryExport_Artifacts_Parent {
	p := new(BigQueryExport_Artifacts_Parent)
	*p = x
	return p
}

func (x BigQueryExport_Artifacts_Parent) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BigQueryExport_Artifacts_Parent) Descriptor() protoreflect.EnumDescriptor {
	return file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_enumTypes[1].Descriptor()
}

func (BigQueryExport_Artifacts_Parent) Type() protoreflect.EnumType {
	return &file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_enumTypes[1]
}

func (x BigQueryExport_Artifacts_Parent) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BigQueryExport_Artifacts_Parent.Descriptor instead.
func (BigQueryExport_Artifacts_Parent) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDescGZIP(), []int{1, 1, 0}
}
...
type BigQueryExport struct {
	...
	//	*BigQueryExport_Test
	//	*BigQueryExport_Artifacts_
	Result isBigQueryExport_Result `protobuf_oneof:"result"`
}
...
func (m *BigQueryExport) GetResult() isBigQueryExport_Result {
	if m != nil {
		return m.Result
	}
	return nil
...
func (x *BigQueryExport) GetTest() *BigQueryExport_TestResults {
	if x, ok := x.GetResult().(*BigQueryExport_Test); ok {
		return x.Test
	}
	return nil
}

func (x *BigQueryExport) GetArtifacts() *BigQueryExport_Artifacts {
	if x, ok := x.GetResult().(*BigQueryExport_Artifacts_); ok {
		return x.Artifacts
	}
	return nil
}

type isBigQueryExport_Result interface {
	isBigQueryExport_Result()
}

type BigQueryExport_Test struct {
	Test *BigQueryExport_TestResults `protobuf:"bytes,5,opt,name=test,proto3,oneof"`
}

type BigQueryExport_Artifacts_ struct {
	Artifacts *BigQueryExport_Artifacts `protobuf:"bytes,6,opt,name=artifacts,proto3,oneof"`
}

func (*BigQueryExport_Test) isBigQueryExport_Result() {}

func (*BigQueryExport_Artifacts_) isBigQueryExport_Result() {}
...
// Artifacts indicates that artifacts should be exported.
type BigQueryExport_Artifacts struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Parent BigQueryExport_Artifacts_Parent `protobuf:"varint,1,opt,name=parent,proto3,enum=luci.resultdb.v1.BigQueryExport_Artifacts_Parent" json:"parent,omitempty"`
	// Use predicate to query artifacts belong to specified test results that
	// should be exported to BigQuery table.
	// It only takes effect if parent is set to TEST_RESULT.
	Predicate *TestResultPredicate `protobuf:"bytes,2,opt,name=predicate,proto3" json:"predicate,omitempty"`
	// An artifact must have an id matching this regular expression entirely.
	ArtifactIdRegexp string `protobuf:"bytes,3,opt,name=artifact_id_regexp,json=artifactIdRegexp,proto3" json:"artifact_id_regexp,omitempty"`
}

func (x *BigQueryExport_Artifacts) Reset() {
	*x = BigQueryExport_Artifacts{}
	if protoimpl.UnsafeEnabled {
...
func (x *BigQueryExport_Artifacts) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BigQueryExport_Artifacts) ProtoMessage() {}

func (x *BigQueryExport_Artifacts) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BigQueryExport_Artifacts.ProtoReflect.Descriptor instead.
func (*BigQueryExport_Artifacts) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDescGZIP(), []int{1, 1}
}

func (x *BigQueryExport_Artifacts) GetParent() BigQueryExport_Artifacts_Parent {
	if x != nil {
		return x.Parent
	}
	return BigQueryExport_Artifacts_ALL
}

func (x *BigQueryExport_Artifacts) GetPredicate() *TestResultPredicate {
	if x != nil {
		return x.Predicate
	}
	return nil
...
func (x *BigQueryExport_Artifacts) GetArtifactIdRegexp() string {
	if x != nil {
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDesc = []byte{
	...
	0x04, 0x22, 0xa8, 0x05, 0x0a, 0x0e, 0x42, 0x69, 0x67, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45, 0x78,
	...
	,
	...
	0x74, 0x65, 0x1a, 0xfd, 0x01, 0x0a, 0x09, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73,
	0x12, 0x49, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	...
	,
	...
	0x6d, 0x69, 0x74, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x63, 0x6f, 0x6d,
	0x6d, 0x69, 0x74, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69,
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_goTypes = []interface{}{
	...
	(BigQueryExport_Artifacts_Parent)(0), // 1: luci.resultdb.v1.BigQueryExport.Artifacts.Parent
	(*Invocation)(nil),                   // 2: luci.resultdb.v1.Invocation
	(*BigQueryExport)(nil),               // 3: luci.resultdb.v1.BigQueryExport
	(*HistoryOptions)(nil),               // 4: luci.resultdb.v1.HistoryOptions
	(*BigQueryExport_TestResults)(nil),   // 5: luci.resultdb.v1.BigQueryExport.TestResults
	(*BigQueryExport_Artifacts)(nil),     // 6: luci.resultdb.v1.BigQueryExport.Artifacts
	(*timestamppb.Timestamp)(nil),        // 7: google.protobuf.Timestamp
	(*StringPair)(nil),                   // 8: luci.resultdb.v1.StringPair
	(*CommitPosition)(nil),               // 9: luci.resultdb.v1.CommitPosition
	(*TestResultPredicate)(nil),          // 10: luci.resultdb.v1.TestResultPredicate
}
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_depIdxs = []int32{
	...
	7,  // 1: luci.resultdb.v1.Invocation.create_time:type_name -> google.protobuf.Timestamp
	8,  // 2: luci.resultdb.v1.Invocation.tags:type_name -> luci.resultdb.v1.StringPair
	7,  // 3: luci.resultdb.v1.Invocation.finalize_time:type_name -> google.protobuf.Timestamp
	7,  // 4: luci.resultdb.v1.Invocation.deadline:type_name -> google.protobuf.Timestamp
	3,  // 5: luci.resultdb.v1.Invocation.bigquery_exports:type_name -> luci.resultdb.v1.BigQueryExport
	4,  // 6: luci.resultdb.v1.Invocation.history_options:type_name -> luci.resultdb.v1.HistoryOptions
	5,  // 7: luci.resultdb.v1.BigQueryExport.test_results:type_name -> luci.resultdb.v1.BigQueryExport.TestResults
	5,  // 8: luci.resultdb.v1.BigQueryExport.test:type_name -> luci.resultdb.v1.BigQueryExport.TestResults
	6,  // 9: luci.resultdb.v1.BigQueryExport.artifacts:type_name -> luci.resultdb.v1.BigQueryExport.Artifacts
	9,  // 10: luci.resultdb.v1.HistoryOptions.commit:type_name -> luci.resultdb.v1.CommitPosition
	10, // 11: luci.resultdb.v1.BigQueryExport.TestResults.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	1,  // 12: luci.resultdb.v1.BigQueryExport.Artifacts.parent:type_name -> luci.resultdb.v1.BigQueryExport.Artifacts.Parent
	10, // 13: luci.resultdb.v1.BigQueryExport.Artifacts.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
...
func file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BigQueryExport_Artifacts); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*BigQueryExport_Test)(nil),
		(*BigQueryExport_Artifacts_)(nil),
	}
	type x struct{}
