...
type Invocation struct {
	...
	// invocation.
	// At the moment the value is the same as the test_id_prefix passed to ResultSink.
	// TODO(crbug.com/1107678): In a pre-computation task find the longest common
	// test id prefix.
	CommonTestIdPrefix string `protobuf:"bytes,14,opt,name=common_test_id_prefix,json=commonTestIdPrefix,proto3" json:"common_test_id_prefix,omitempty"`
	// Union of all variants of test results directly included by the invocation.
	// At the moment the values are the same as the base variant passed to ResultSink.
	// TODO(crbug.com/1107678): In a pre-computation task find all the variant and
	// add them to the union.
	TestResultVariantUnion []*StringPair `protobuf:"bytes,15,rep,name=test_result_variant_union,json=testResultVariantUnion,proto3" json:"test_result_variant_union,omitempty"`
}
...
func (x *Invocation) GetCommonTestIdPrefix() string {
	if x != nil {
		return x.CommonTestIdPrefix
	}
	return ""
}

func (x *Invocation) GetTestResultVariantUnion() []*StringPair {
	if x != nil {
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x06, 0x0a, 0x0a, 0x49,
	...
	,
	...
	,
	...
	0x63, 0x61, 0x74, 0x65, 0x52, 0x09, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x1a,
	0x52, 0x0a, 0x0d, 0x54, 0x65, 0x78, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73,
	0x12, 0x41, 0x0a, 0x09, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20,
	...
	0x61, 0x74, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x22, 0x84, 0x01, 0x0a, 0x0e, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x4f, 0x70,
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_depIdxs = []int32{
	...
	7,  // 7: luci.resultdb.v1.Invocation.test_result_variant_union:type_name -> luci.resultdb.v1.StringPair
	4,  // 8: luci.resultdb.v1.BigQueryExport.test_results:type_name -> luci.resultdb.v1.BigQueryExport.TestResults
	5,  // 9: luci.resultdb.v1.BigQueryExport.text_artifacts:type_name -> luci.resultdb.v1.BigQueryExport.TextArtifacts
	8,  // 10: luci.resultdb.v1.HistoryOptions.commit:type_name -> luci.resultdb.v1.CommitPosition
	9,  // 11: luci.resultdb.v1.BigQueryExport.TestResults.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	10, // 12: luci.resultdb.v1.BigQueryExport.TextArtifacts.predicate:type_name -> luci.resultdb.v1.ArtifactPredicate
