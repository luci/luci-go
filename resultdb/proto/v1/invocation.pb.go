...
func (x *BigQueryExport) GetArtifacts() *BigQueryExport_Artifacts {
	if x, ok := x.GetResultType().(*BigQueryExport_Artifacts_); ok {
		return x.Artifacts
	}
	return nil
}
...
type BigQueryExport_TestResults_ struct {
	// The exported are test results.
	// TODO(crbug.com/1149736): rename this to test_results after the
	// test_results field above is removed.
...
func (*BigQueryExport_Artifacts_) isBigQueryExport_ResultType() {}
...
func (x *BigQueryExport_Artifacts) GetPredicate() *ArtifactPredicate {
	if x != nil {
		return x.Predicate
	}
	return nil
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDesc = []byte{
	...
	0x04, 0x22, 0xbb, 0x03, 0x0a, 0x0e, 0x42, 0x69, 0x67, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45, 0x78,
	...
	0x12, 0x4a, 0x0a, 0x09, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x69, 0x67, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45,
	0x78, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x48,
	0x00, 0x52, 0x09, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x1a, 0x52, 0x0a, 0x0b,
	...
	0x1a, 0x4e, 0x0a, 0x09, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x12, 0x41, 0x0a,
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_goTypes = []interface{}{
	...
	(*BigQueryExport_Artifacts)(nil),   // 5: luci.resultdb.v1.BigQueryExport.Artifacts
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_depIdxs = []int32{
	...
	5,  // 8: luci.resultdb.v1.BigQueryExport.artifacts:type_name -> luci.resultdb.v1.BigQueryExport.Artifacts
	...
	10, // 11: luci.resultdb.v1.BigQueryExport.Artifacts.predicate:type_name -> luci.resultdb.v1.ArtifactPredicate
