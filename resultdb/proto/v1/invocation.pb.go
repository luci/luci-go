...
// HistoryOptions indicates that the some of contents of this invocation  should
// be indexed by certain fields so that they can be queried by range/predicate.
type HistoryOptions struct {
	...
	// See above.
	TestResults *HistoryOptions_TestResultHistoryOptions `protobuf:"bytes,1,opt,name=test_results,json=testResults,proto3" json:"test_results,omitempty"`
}
...
func (x *HistoryOptions) GetTestResults() *HistoryOptions_TestResultHistoryOptions {
	if x != nil {
		return x.TestResults
	}
	return nil
...
// CommitPosition specifies the numerical position of the commit this invocation
// exists at, in a repository's commit log. More specifically, a ref's commit
// log.
...
// TestResultHistoryOptions specifies whether to index the test results
// contained in the invocation by timestamp or commit position so that they
// can be queried via GetTestResultHistory() RPC.
type HistoryOptions_TestResultHistoryOptions struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *HistoryOptions_TestResultHistoryOptions) Reset() {
	*x = HistoryOptions_TestResultHistoryOptions{}
	if protoimpl.UnsafeEnabled {
...
func (x *HistoryOptions_TestResultHistoryOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HistoryOptions_TestResultHistoryOptions) ProtoMessage() {}

func (x *HistoryOptions_TestResultHistoryOptions) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HistoryOptions_TestResultHistoryOptions.ProtoReflect.Descriptor instead.
func (*HistoryOptions_TestResultHistoryOptions) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDescGZIP(), []int{2, 0}
}

func (x *HistoryOptions_TestResultHistoryOptions) GetUseInvocationTimestamp() bool {
	if x != nil {
...
func (x *HistoryOptions_TestResultHistoryOptions) GetCommit() *CommitPosition {
	if x != nil {
		return x.Commit
	}
	return nil
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDesc = []byte{
	...
	,
	...
	0x6d, 0x6d, 0x69, 0x74, 0x22, 0x6c, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x50, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x01,
	...
	0x6f, 0x6e, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75,
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_goTypes = []interface{}{
	...
	(*HistoryOptions_TestResultHistoryOptions)(nil), // 6: luci.resultdb.v1.HistoryOptions.TestResultHistoryOptions
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_depIdxs = []int32{
	...
	6,  // 8: luci.resultdb.v1.HistoryOptions.test_results:type_name -> luci.resultdb.v1.HistoryOptions.TestResultHistoryOptions
	9,  // 9: luci.resultdb.v1.BigQueryExport.TestResults.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	4,  // 10: luci.resultdb.v1.HistoryOptions.TestResultHistoryOptions.commit:type_name -> luci.resultdb.v1.CommitPosition
...
func file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HistoryOptions_TestResultHistoryOptions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
