...
func (x *BigQueryExport) GetTest() *BigQueryExport_TestResults {
	if x, ok := x.GetResultType().(*BigQueryExport_Test); ok {
		return x.Test
	}
	return nil
}

func (x *BigQueryExport) GetArtifact() *BigQueryExport_Artifacts {
	if x, ok := x.GetResultType().(*BigQueryExport_Artifact); ok {
		return x.Artifact
	}
	return nil
}
...
type BigQueryExport_Artifact struct {
	Artifact *BigQueryExport_Artifacts `protobuf:"bytes,6,opt,name=artifact,proto3,oneof"`
}

func (*BigQueryExport_Test) isBigQueryExport_ResultType() {}

func (*BigQueryExport_Artifact) isBigQueryExport_ResultType() {}
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_rawDesc = []byte{
	...
	0x04, 0x22, 0xab, 0x05, 0x0a, 0x0e, 0x42, 0x69, 0x67, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45, 0x78,
	...
	,
	...
	0x1a, 0xfd, 0x01, 0x0a, 0x09, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x12, 0x49,
	0x0a, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x31,
	0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76,
	0x31, 0x2e, 0x42, 0x69, 0x67, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74,
	0x2e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x2e, 0x50, 0x61, 0x72, 0x65, 0x6e,
	0x74, 0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x43, 0x0a, 0x09, 0x70, 0x72, 0x65,
	...
	,
...
var file_go_chromium_org_luci_resultdb_proto_v1_invocation_proto_depIdxs = []int32{
	...
	6,  // 9: luci.resultdb.v1.BigQueryExport.artifact:type_name -> luci.resultdb.v1.BigQueryExport.Artifacts
