...
const file_go_chromium_org_luci_resultdb_proto_v1_failure_reason_proto_rawDesc = "" +
	"\n" +
	";go.chromium.org/luci/resultdb/proto/v1/failure_reason.proto\x12\x10luci.resultdb.v1\"\xef\x02\n" +
	"\rFailureReason\x128\n" +
	"\x04kind\x18\x04 \x01(\x0e2$.luci.resultdb.v1.FailureReason.KindR\x04kind\x122\n" +
	"\x15primary_error_message\x18\x01 \x01(\tR\x13primaryErrorMessage\x12=\n" +
	"\x06errors\x18\x02 \x03(\v2%.luci.resultdb.v1.FailureReason.ErrorR\x06errors\x124\n" +
