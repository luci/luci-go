...
type GetTestResultHistoryResponse_Order int32

const (
	// Intended to avoid a misleading default.
	GetTestResultHistoryResponse_ORDER_UNSPECIFIED GetTestResultHistoryResponse_Order = 0
	// Entries are sorted by invocation create time descending, then
	// test ID, then variant hash.
	GetTestResultHistoryResponse_INVOCATION_TIMESTAMP GetTestResultHistoryResponse_Order = 1
	// Entries are sorted by invocation's commit position, then  test ID,
	// then variant hash.
	GetTestResultHistoryResponse_COMMIT_POSITION GetTestResultHistoryResponse_Order = 2
)

// Enum value maps for GetTestResultHistoryResponse_Order.
var (
	GetTestResultHistoryResponse_Order_name = map[int32]string{
		0: "ORDER_UNSPECIFIED",
		1: "INVOCATION_TIMESTAMP",
		2: "COMMIT_POSITION",
	}
	GetTestResultHistoryResponse_Order_value = map[string]int32{
		"ORDER_UNSPECIFIED":    0,
		"INVOCATION_TIMESTAMP": 1,
		"COMMIT_POSITION":      2,
	}
)

func (x GetTestResultHistoryResponse_Order) Enum() *GetTestResultHistoryResponse_Order {
	p := new(GetTestResultHistoryResponse_Order)
	*p = x
	return p
}

func (x GetTestResultHistoryResponse_Order) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GetTestResultHistoryResponse_Order) Descriptor() protoreflect.EnumDescriptor {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_enumTypes[0].Descriptor()
}

func (GetTestResultHistoryResponse_Order) Type() protoreflect.EnumType {
	return &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_enumTypes[0]
}

func (x GetTestResultHistoryResponse_Order) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GetTestResultHistoryResponse_Order.Descriptor instead.
func (GetTestResultHistoryResponse_Order) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{1, 0}
}
...
type GetTestResultHistoryRequest struct {
	...
	// Specify the subset of test variants whose history we want to retrieve.
	...
	// The test results are sorted by commit position and/or timestamp in
	// the database, according to a field in the invocation that contains them.
	// If neither range option is given, the service will query both options and
	// return the results for the option with the most recent (by timestamp)
	// results.
	// Note that all results have a timestamp associated with them, even if they
	// also have a commit position.
	// If a given test variant changes from using only timestamped results to
	// results tagged (or viceversa) with commit position we want the response to
	// reflect this as soon as possible.
	//
	// Types that are assignable to Range:
	//	*GetTestResultHistoryRequest_CpRange
	//	*GetTestResultHistoryRequest_TimeRange_
	...
	// Which fields of the TestResult entries to populate.
...
func (x *GetTestResultHistoryRequest) GetCpRange() *GetTestResultHistoryRequest_CommitPositionRange {
...
func (x *GetTestResultHistoryRequest) GetTimeRange() *GetTestResultHistoryRequest_TimeRange {
	if x, ok := x.GetRange().(*GetTestResultHistoryRequest_TimeRange_); ok {
		return x.TimeRange
	}
	return nil
}
...
func (x *GetTestResultHistoryRequest) GetFields() *field_mask.FieldMask {
	if x != nil {
		return x.Fields
	}
	return nil
...
type GetTestResultHistoryRequest_CpRange struct {
	CpRange *GetTestResultHistoryRequest_CommitPositionRange `protobuf:"bytes,4,opt,name=cp_range,json=cpRange,proto3,oneof"`
}

type GetTestResultHistoryRequest_TimeRange_ struct {
	TimeRange *GetTestResultHistoryRequest_TimeRange `protobuf:"bytes,5,opt,name=time_range,json=timeRange,proto3,oneof"`
}

func (*GetTestResultHistoryRequest_CpRange) isGetTestResultHistoryRequest_Range() {}

func (*GetTestResultHistoryRequest_TimeRange_) isGetTestResultHistoryRequest_Range() {}
...
type GetTestResultHistoryResponse struct {
	...
	// The actual results, in descending order sorted first by sorting_field, then
	// by TestId, and then by VariantHash.
	Entries []*GetTestResultHistoryResponse_Entry `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`
	// The order of entries.
	Order GetTestResultHistoryResponse_Order `protobuf:"varint,2,opt,name=order,proto3,enum=luci.resultdb.v1.GetTestResultHistoryResponse_Order" json:"order,omitempty"`
...
func (x *GetTestResultHistoryResponse) GetOrder() GetTestResultHistoryResponse_Order {
	if x != nil {
		return x.Order
	}
	return GetTestResultHistoryResponse_ORDER_UNSPECIFIED
}
...
// A range of commit_positions for the results.
...
type GetTestResultHistoryRequest_CommitPositionRange struct {
	...
	// 'earliest' and 'latest' below only make sense in the context of a single
	// repository and ref.
	Host    string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	Project string `protobuf:"bytes,2,opt,name=project,proto3" json:"project,omitempty"`
	Ref     string `protobuf:"bytes,3,opt,name=ref,proto3" json:"ref,omitempty"`
	// If 0, the results will go as far back as possible.
	Earliest int64 `protobuf:"varint,4,opt,name=earliest,proto3" json:"earliest,omitempty"` // Incl.
	// If 0, the results will start with the most recent result.
	Latest int64 `protobuf:"varint,5,opt,name=latest,proto3" json:"latest,omitempty"` // Excl.
}

func (x *GetTestResultHistoryRequest_CommitPositionRange) Reset() {
	*x = GetTestResultHistoryRequest_CommitPositionRange{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTestResultHistoryRequest_CommitPositionRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTestResultHistoryRequest_CommitPositionRange) ProtoMessage() {}

func (x *GetTestResultHistoryRequest_CommitPositionRange) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTestResultHistoryRequest_CommitPositionRange.ProtoReflect.Descriptor instead.
func (*GetTestResultHistoryRequest_CommitPositionRange) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{0, 0}
}

func (x *GetTestResultHistoryRequest_CommitPositionRange) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *GetTestResultHistoryRequest_CommitPositionRange) GetProject() string {
	if x != nil {
		return x.Project
	}
	return ""
...
func (x *GetTestResultHistoryRequest_CommitPositionRange) GetRef() string {
	if x != nil {
		return x.Ref
	}
	return ""
...
func (x *GetTestResultHistoryRequest_CommitPositionRange) GetEarliest() int64 {
	if x != nil {
		return x.Earliest
	}
	return 0
...
func (x *GetTestResultHistoryRequest_CommitPositionRange) GetLatest() int64 {
	if x != nil {
		return x.Latest
	}
	return 0
...
// A range of timestamps for the results.
type GetTestResultHistoryRequest_TimeRange struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// If unset, the results will go as far back as possible.
	Earliest *timestamp.Timestamp `protobuf:"bytes,1,opt,name=earliest,proto3" json:"earliest,omitempty"` // Incl.
	// If unset, the results will start with the most recent result.
	Latest *timestamp.Timestamp `protobuf:"bytes,2,opt,name=latest,proto3" json:"latest,omitempty"` // Excl.
}

func (x *GetTestResultHistoryRequest_TimeRange) Reset() {
	*x = GetTestResultHistoryRequest_TimeRange{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTestResultHistoryRequest_TimeRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTestResultHistoryRequest_TimeRange) ProtoMessage() {}

func (x *GetTestResultHistoryRequest_TimeRange) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTestResultHistoryRequest_TimeRange.ProtoReflect.Descriptor instead.
func (*GetTestResultHistoryRequest_TimeRange) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{0, 1}
}

func (x *GetTestResultHistoryRequest_TimeRange) GetEarliest() *timestamp.Timestamp {
	if x != nil {
		return x.Earliest
	}
	return nil
...
func (x *GetTestResultHistoryRequest_TimeRange) GetLatest() *timestamp.Timestamp {
	if x != nil {
		return x.Latest
	}
	return nil
...
type GetTestResultHistoryResponse_Entry struct {
	...
	// Commit position of the invocation that contains the result.
...
func (x *GetTestResultHistoryResponse_Entry) GetCommitPosition() int64 {
	if x != nil {
...
func (x *GetTestResultHistoryResponse_Entry) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (*QueryArtifactsRequest_EdgeTypeSet) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{18, 0}
}
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDesc = []byte{
	...
	0x74, 0x64, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x76,
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x36, 0x67,
	0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d, 0x2e, 0x6f, 0x72, 0x67, 0x2f, 0x6c,
	0x75, 0x63, 0x69, 0x2f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x2e,
	...
	0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0xe2, 0x05, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c,
	...
	,
	...
	,
	...
	0x0a, 0x08, 0x65, 0x61, 0x72, 0x6c, 0x69, 0x65, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x65, 0x61, 0x72, 0x6c, 0x69, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x61,
	0x74, 0x65, 0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6c, 0x61, 0x74, 0x65,
	0x73, 0x74, 0x1a, 0x77, 0x0a, 0x09, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12,
	...
	0x61, 0x6d, 0x70, 0x52, 0x06, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x72,
	0x61, 0x6e, 0x67, 0x65, 0x22, 0xd4, 0x03, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4e, 0x0a, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65,
	...
	,
	...
	0x49, 0x4e, 0x56, 0x4f, 0x43, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x53,
	0x54, 0x41, 0x4d, 0x50, 0x10, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x43, 0x4f, 0x4d, 0x4d, 0x49, 0x54,
	0x5f, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x02, 0x22, 0x2f, 0x0a, 0x14, 0x47,
	...
	0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x2f, 0x0a, 0x14,
	...
	0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xb2, 0x01,
	0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x02, 0x52, 0x0a, 0x69, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a,
	...
	0x73, 0x6b, 0x22, 0x82, 0x01, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52,
	...
	0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x2f, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x54, 0x65,
	0x73, 0x74, 0x45, 0x78, 0x6f, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x7e, 0x0a, 0x1b, 0x4c, 0x69, 0x73, 0x74,
	...
	0x52, 0x0a, 0x69, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09,
	0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x67,
	0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70,
	0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x96, 0x01, 0x0a, 0x1c, 0x4c, 0x69, 0x73,
	...
	0x6e, 0x22, 0xb5, 0x02, 0x0a, 0x17, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x65, 0x73, 0x74, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x20, 0x0a,
	...
	0x43, 0x0a, 0x09, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01,
	...
	0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x52,
	0x08, 0x72, 0x65, 0x61, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x22, 0x83, 0x01, 0x0a, 0x18, 0x51, 0x75,
	...
	0x8b, 0x02, 0x0a, 0x1c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x65, 0x73, 0x74, 0x45, 0x78, 0x6f,
	...
	,
	...
	0x0a, 0x1d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x65, 0x73, 0x74, 0x45, 0x78, 0x6f, 0x6e, 0x65,
	...
	0x26, 0x0a, 0x0f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x65, 0x78, 0x74, 0x50, 0x61,
	0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x84, 0x01, 0x0a, 0x20, 0x51, 0x75, 0x65, 0x72,
	...
	,
	...
	0x22, 0x6f, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74,
	...
	0x6e, 0x22, 0x79, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63,
	...
	0x65, 0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xcd, 0x03, 0x0a,
	0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x52,
	...
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x56, 0x0a, 0x0c, 0x66, 0x6f, 0x6c, 0x6c,
	0x6f, 0x77, 0x5f, 0x65, 0x64, 0x67, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33,
	0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76,
	0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x45, 0x64, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65,
	0x53, 0x65, 0x74, 0x52, 0x0b, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x45, 0x64, 0x67, 0x65, 0x73,
	0x12, 0x59, 0x0a, 0x15, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f,
	...
	0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x52, 0x13, 0x74, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x3e, 0x0a, 0x0d, 0x6d,
	0x61, 0x78, 0x5f, 0x73, 0x74, 0x61, 0x6c, 0x65, 0x6e, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01,
	...
	0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x63, 0x0a, 0x0b, 0x45, 0x64, 0x67, 0x65, 0x54,
	...
	0x0b, 0x74, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x7a, 0x0a, 0x16,
	...
	0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x90, 0x0a, 0x0a, 0x08, 0x52, 0x65, 0x73,
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_goTypes = []interface{}{
	(GetTestResultHistoryResponse_Order)(0),                 // 0: luci.resultdb.v1.GetTestResultHistoryResponse.Order
	(*GetTestResultHistoryRequest)(nil),                     // 1: luci.resultdb.v1.GetTestResultHistoryRequest
	(*GetTestResultHistoryResponse)(nil),                    // 2: luci.resultdb.v1.GetTestResultHistoryResponse
	(*GetInvocationRequest)(nil),                            // 3: luci.resultdb.v1.GetInvocationRequest
	...
	(*GetTestResultHistoryRequest_CommitPositionRange)(nil), // 21: luci.resultdb.v1.GetTestResultHistoryRequest.CommitPositionRange
	(*GetTestResultHistoryRequest_TimeRange)(nil),           // 22: luci.resultdb.v1.GetTestResultHistoryRequest.TimeRange
	(*GetTestResultHistoryResponse_Entry)(nil),              // 23: luci.resultdb.v1.GetTestResultHistoryResponse.Entry
	(*QueryArtifactsRequest_EdgeTypeSet)(nil),               // 24: luci.resultdb.v1.QueryArtifactsRequest.EdgeTypeSet
	(*VariantPredicate)(nil),                                // 25: luci.resultdb.v1.VariantPredicate
	(*field_mask.FieldMask)(nil),                            // 26: google.protobuf.FieldMask
	(*TestResult)(nil),                                      // 27: luci.resultdb.v1.TestResult
	(*TestExoneration)(nil),                                 // 28: luci.resultdb.v1.TestExoneration
	(*TestResultPredicate)(nil),                             // 29: luci.resultdb.v1.TestResultPredicate
	(*duration.Duration)(nil),                               // 30: google.protobuf.Duration
	(*TestExonerationPredicate)(nil),                        // 31: luci.resultdb.v1.TestExonerationPredicate
	(*Artifact)(nil),                                        // 32: luci.resultdb.v1.Artifact
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_depIdxs = []int32{
	25, // 0: luci.resultdb.v1.GetTestResultHistoryRequest.variant_predicate:type_name -> luci.resultdb.v1.VariantPredicate
	21, // 1: luci.resultdb.v1.GetTestResultHistoryRequest.cp_range:type_name -> luci.resultdb.v1.GetTestResultHistoryRequest.CommitPositionRange
	22, // 2: luci.resultdb.v1.GetTestResultHistoryRequest.time_range:type_name -> luci.resultdb.v1.GetTestResultHistoryRequest.TimeRange
	26, // 3: luci.resultdb.v1.GetTestResultHistoryRequest.fields:type_name -> google.protobuf.FieldMask
	23, // 4: luci.resultdb.v1.GetTestResultHistoryResponse.entries:type_name -> luci.resultdb.v1.GetTestResultHistoryResponse.Entry
	0,  // 5: luci.resultdb.v1.GetTestResultHistoryResponse.order:type_name -> luci.resultdb.v1.GetTestResultHistoryResponse.Order
	26, // 6: luci.resultdb.v1.ListTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	27, // 7: luci.resultdb.v1.ListTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	28, // 8: luci.resultdb.v1.ListTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	29, // 9: luci.resultdb.v1.QueryTestResultsRequest.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	30, // 10: luci.resultdb.v1.QueryTestResultsRequest.max_staleness:type_name -> google.protobuf.Duration
	26, // 11: luci.resultdb.v1.QueryTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	27, // 12: luci.resultdb.v1.QueryTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	31, // 13: luci.resultdb.v1.QueryTestExonerationsRequest.predicate:type_name -> luci.resultdb.v1.TestExonerationPredicate
	30, // 14: luci.resultdb.v1.QueryTestExonerationsRequest.max_staleness:type_name -> google.protobuf.Duration
	28, // 15: luci.resultdb.v1.QueryTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	30, // 16: luci.resultdb.v1.QueryTestResultStatisticsRequest.max_staleness:type_name -> google.protobuf.Duration
	32, // 17: luci.resultdb.v1.ListArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	24, // 18: luci.resultdb.v1.QueryArtifactsRequest.follow_edges:type_name -> luci.resultdb.v1.QueryArtifactsRequest.EdgeTypeSet
	29, // 19: luci.resultdb.v1.QueryArtifactsRequest.test_result_predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	30, // 20: luci.resultdb.v1.QueryArtifactsRequest.max_staleness:type_name -> google.protobuf.Duration
	32, // 21: luci.resultdb.v1.QueryArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	33, // 22: luci.resultdb.v1.GetTestResultHistoryRequest.TimeRange.earliest:type_name -> google.protobuf.Timestamp
	33, // 23: luci.resultdb.v1.GetTestResultHistoryRequest.TimeRange.latest:type_name -> google.protobuf.Timestamp
	33, // 24: luci.resultdb.v1.GetTestResultHistoryResponse.Entry.timestamp:type_name -> google.protobuf.Timestamp
	27, // 25: luci.resultdb.v1.GetTestResultHistoryResponse.Entry.result:type_name -> luci.resultdb.v1.TestResult
	3,  // 26: luci.resultdb.v1.ResultDB.GetInvocation:input_type -> luci.resultdb.v1.GetInvocationRequest
	4,  // 27: luci.resultdb.v1.ResultDB.GetTestResult:input_type -> luci.resultdb.v1.GetTestResultRequest
	5,  // 28: luci.resultdb.v1.ResultDB.ListTestResults:input_type -> luci.resultdb.v1.ListTestResultsRequest
	7,  // 29: luci.resultdb.v1.ResultDB.GetTestExoneration:input_type -> luci.resultdb.v1.GetTestExonerationRequest
	8,  // 30: luci.resultdb.v1.ResultDB.ListTestExonerations:input_type -> luci.resultdb.v1.ListTestExonerationsRequest
	10, // 31: luci.resultdb.v1.ResultDB.QueryTestResults:input_type -> luci.resultdb.v1.QueryTestResultsRequest
	12, // 32: luci.resultdb.v1.ResultDB.QueryTestExonerations:input_type -> luci.resultdb.v1.QueryTestExonerationsRequest
	14, // 33: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:input_type -> luci.resultdb.v1.QueryTestResultStatisticsRequest
	16, // 34: luci.resultdb.v1.ResultDB.GetArtifact:input_type -> luci.resultdb.v1.GetArtifactRequest
	17, // 35: luci.resultdb.v1.ResultDB.ListArtifacts:input_type -> luci.resultdb.v1.ListArtifactsRequest
	19, // 36: luci.resultdb.v1.ResultDB.QueryArtifacts:input_type -> luci.resultdb.v1.QueryArtifactsRequest
	1,  // 37: luci.resultdb.v1.ResultDB.GetTestResultHistory:input_type -> luci.resultdb.v1.GetTestResultHistoryRequest
	34, // 38: luci.resultdb.v1.ResultDB.GetInvocation:output_type -> luci.resultdb.v1.Invocation
	27, // 39: luci.resultdb.v1.ResultDB.GetTestResult:output_type -> luci.resultdb.v1.TestResult
	6,  // 40: luci.resultdb.v1.ResultDB.ListTestResults:output_type -> luci.resultdb.v1.ListTestResultsResponse
	28, // 41: luci.resultdb.v1.ResultDB.GetTestExoneration:output_type -> luci.resultdb.v1.TestExoneration
	9,  // 42: luci.resultdb.v1.ResultDB.ListTestExonerations:output_type -> luci.resultdb.v1.ListTestExonerationsResponse
	11, // 43: luci.resultdb.v1.ResultDB.QueryTestResults:output_type -> luci.resultdb.v1.QueryTestResultsResponse
	13, // 44: luci.resultdb.v1.ResultDB.QueryTestExonerations:output_type -> luci.resultdb.v1.QueryTestExonerationsResponse
	15, // 45: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:output_type -> luci.resultdb.v1.QueryTestResultStatisticsResponse
	32, // 46: luci.resultdb.v1.ResultDB.GetArtifact:output_type -> luci.resultdb.v1.Artifact
	18, // 47: luci.resultdb.v1.ResultDB.ListArtifacts:output_type -> luci.resultdb.v1.ListArtifactsResponse
	20, // 48: luci.resultdb.v1.ResultDB.QueryArtifacts:output_type -> luci.resultdb.v1.QueryArtifactsResponse
	2,  // 49: luci.resultdb.v1.ResultDB.GetTestResultHistory:output_type -> luci.resultdb.v1.GetTestResultHistoryResponse
...
func file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTestResultHistoryRequest_CommitPositionRange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTestResultHistoryRequest_TimeRange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*GetTestResultHistoryRequest_CpRange)(nil),
		(*GetTestResultHistoryRequest_TimeRange_)(nil),
	}
	type x struct{}
