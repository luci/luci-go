...
type QueryArtifactsRequest struct {
	...
	Invocations []string `protobuf:"bytes,1,rep,name=invocations,proto3" json:"invocations,omitempty"`
	// The name of the root invocation to retrieve artifacts from, see RootInvocation.name.
	//
	// If set, the RPC will query artifacts of work units and test results recursively
	// under this root invocation.
	//
	// Either `parent` or `invocations` must be specified, not both.
...
func (x *QueryArtifactsRequest) GetParent() string {
	if x != nil {
		return x.Parent
	}
	return ""
...
func (x *CompareArtifactLinesRequest) GetArtifacts() []string {
	if x != nil {
		return x.Artifacts
	}
	return nil
...
type CompareArtifactLinesResponse struct {
	...
	UsedPassingArtifacts []string `protobuf:"bytes,3,rep,name=used_passing_artifacts,json=usedPassingArtifacts,proto3" json:"used_passing_artifacts,omitempty"`
...
// Deprecated: Marked as deprecated in go.chromium.org/luci/resultdb/proto/v1/resultdb.proto.
func (x *CompareArtifactLinesResponse) GetUsedPassingArtifacts() []string {
	if x != nil {
		return x.UsedPassingArtifacts
	}
	return nil
}

func (x *CompareArtifactLinesResponse) GetArtifacts() []string {
	if x != nil {
		return x.Artifacts
	}
	return nil
...
// of tests.
type BatchGetTestVerdictsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// duplicates.)
	Tests []*BatchGetTestVerdictsRequest_NominatedTest `protobuf:"bytes,2,rep,name=tests,proto3" json:"tests,omitempty"`
	// The set of test verdict fields to return.
	// The default is TEST_VERDICT_VIEW_BASIC.
	View TestVerdictView `protobuf:"varint,3,opt,name=view,proto3,enum=luci.resultdb.v1.TestVerdictView" json:"view,omitempty"`
}

func (x *BatchGetTestVerdictsRequest) Reset() {
	*x = BatchGetTestVerdictsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchGetTestVerdictsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchGetTestVerdictsRequest) ProtoMessage() {}

func (x *BatchGetTestVerdictsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchGetTestVerdictsRequest.ProtoReflect.Descriptor instead.
func (*BatchGetTestVerdictsRequest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{30}
}

func (x *BatchGetTestVerdictsRequest) GetParent() string {
	if x != nil {
		return x.Parent
	}
	return ""
...
func (x *BatchGetTestVerdictsRequest) GetTests() []*BatchGetTestVerdictsRequest_NominatedTest {
	if x != nil {
		return x.Tests
	}
	return nil
...
func (x *BatchGetTestVerdictsRequest) GetView() TestVerdictView {
	if x != nil {
		return x.View
	}
	return TestVerdictView_TEST_VERDICT_VIEW_UNSPECIFIED
}

// A response message for BatchGetTestVerdicts RPC.
type BatchGetTestVerdictsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BatchGetTestVerdictsResponse) Reset() {
	*x = BatchGetTestVerdictsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchGetTestVerdictsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchGetTestVerdictsResponse) ProtoMessage() {}

func (x *BatchGetTestVerdictsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchGetTestVerdictsResponse.ProtoReflect.Descriptor instead.
func (*BatchGetTestVerdictsResponse) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{31}
}

func (x *BatchGetTestVerdictsResponse) GetTestVerdicts() []*TestVerdict {
	if x != nil {
...
type QueryTestVerdictsRequest struct {
	...
	Predicate *TestVerdictPredicate `protobuf:"bytes,2,opt,name=predicate,proto3" json:"predicate,omitempty"`
...
func (*QueryTestVerdictsRequest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{53}
}

func (x *QueryTestVerdictsRequest) GetParent() string {
	if x != nil {
		return x.Parent
	}
	return ""
...
func (x *QueryTestVerdictsRequest) GetPredicate() *TestVerdictPredicate {
	if x != nil {
		return x.Predicate
	}
	return nil
...
func (x *QueryTestVerdictsRequest) GetOrderBy() string {
	if x != nil {
		return x.OrderBy
	}
	return ""
...
func (x *QueryTestVerdictsRequest) GetView() TestVerdictView {
	if x != nil {
		return x.View
	}
	return TestVerdictView_TEST_VERDICT_VIEW_UNSPECIFIED
...
func (x *QueryTestVerdictsResponse) Reset() {
	*x = QueryTestVerdictsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[54]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueryTestVerdictsResponse) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{54}
}
...
type BatchGetTestVerdictsRequest_NominatedTest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BatchGetTestVerdictsRequest_NominatedTest) Reset() {
	*x = BatchGetTestVerdictsRequest_NominatedTest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchGetTestVerdictsRequest_NominatedTest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchGetTestVerdictsRequest_NominatedTest) ProtoMessage() {}

func (x *BatchGetTestVerdictsRequest_NominatedTest) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[59]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchGetTestVerdictsRequest_NominatedTest.ProtoReflect.Descriptor instead.
func (*BatchGetTestVerdictsRequest_NominatedTest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{30, 0}
}

func (x *BatchGetTestVerdictsRequest_NominatedTest) GetTestIdStructured() *TestIdentifier {
	if x != nil {
		return x.TestIdStructured
	}
	return nil
...
func (x *BatchGetTestVerdictsRequest_NominatedTest) GetTestId() string {
	if x != nil {
		return x.TestId
	}
	return ""
...
func (x *BatchGetTestVerdictsRequest_NominatedTest) GetVariantHash() string {
	if x != nil {
		return x.VariantHash
	}
	return ""
...
func (x *QueryTestVariantArtifactGroupsResponse_MatchGroup) Reset() {
	*x = QueryTestVariantArtifactGroupsResponse_MatchGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[62]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *QueryInvocationVariantArtifactGroupsResponse_MatchGroup) Reset() {
	*x = QueryInvocationVariantArtifactGroupsResponse_MatchGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[63]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueryInvocationVariantArtifactGroupsResponse_MatchGroup) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{45, 0}
}
...
func (x *ArtifactMatchingContent_Match) Reset() {
	*x = ArtifactMatchingContent_Match{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[64]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ArtifactMatchingContent_Match) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDescGZIP(), []int{48, 0}
}
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x22, 0x89, 0x02, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x72, 0x74, 0x69,
	...
	0x09, 0x52, 0x0b, 0x69, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x16,
	0x0a, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x41, 0x0a, 0x09, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63,
	0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0
 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6d,
	0x70, 0x61, 0x72, 0x65, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x4c, 0x69, 0x6e, 0x65,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x38, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54,
	0x65, 0x73, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61,
	0x63, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x12, 0x86, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x65, 0x73, 0x74,
	0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73,
	...
	,
	...
	,
	...
	0x00, 0x12, 0x86, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x65, 0x73, 0x74, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x12,
	...
	0x6c, 0x74, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x33, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x65, 0x73, 0x74,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x50, 0x0a, 0x1b, 0x63, 0x6f,
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_goTypes = []interface{}{
	...
	(*BatchGetTestVerdictsRequest)(nil),                   // 31: luci.resultdb.v1.BatchGetTestVerdictsRequest
	(*BatchGetTestVerdictsResponse)(nil),                  // 32: luci.resultdb.v1.BatchGetTestVerdictsResponse
	(*QueryTestMetadataRequest)(nil),                      // 33: luci.resultdb.v1.QueryTestMetadataRequest
	(*QueryTestMetadataResponse)(nil),                     // 34: luci.resultdb.v1.QueryTestMetadataResponse
	(*QueryNewTestVariantsRequest)(nil),                   // 35: luci.resultdb.v1.QueryNewTestVariantsRequest
	(*QueryNewTestVariantsResponse)(nil),                  // 36: luci.resultdb.v1.QueryNewTestVariantsResponse
	(*GetInstructionRequest)(nil),                         // 37: luci.resultdb.v1.GetInstructionRequest
	(*QueryInstructionRequest)(nil),                       // 38: luci.resultdb.v1.QueryInstructionRequest
	(*QueryInstructionResponse)(nil),                      // 39: luci.resultdb.v1.QueryInstructionResponse
	(*InstructionDependencyChain)(nil),                    // 40: luci.resultdb.v1.InstructionDependencyChain
	(*QueryTestVariantArtifactGroupsRequest)(nil),         // 41: luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest
	(*QueryTestVariantArtifactGroupsResponse)(nil),        // 42: luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse
	(*QueryTestVariantArtifactsRequest)(nil),              // 43: luci.resultdb.v1.QueryTestVariantArtifactsRequest
	(*QueryTestVariantArtifactsResponse)(nil),             // 44: luci.resultdb.v1.QueryTestVariantArtifactsResponse
	(*QueryInvocationVariantArtifactGroupsRequest)(nil),   // 45: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsRequest
	(*QueryInvocationVariantArtifactGroupsResponse)(nil),  // 46: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse
	(*QueryInvocationVariantArtifactsRequest)(nil),        // 47: luci.resultdb.v1.QueryInvocationVariantArtifactsRequest
	(*QueryInvocationVariantArtifactsResponse)(nil),       // 48: luci.resultdb.v1.QueryInvocationVariantArtifactsResponse
	(*ArtifactMatchingContent)(nil),                       // 49: luci.resultdb.v1.ArtifactMatchingContent
	(*ArtifactContentMatcher)(nil),                        // 50: luci.resultdb.v1.ArtifactContentMatcher
	(*IDMatcher)(nil),                                     // 51: luci.resultdb.v1.IDMatcher
	(*QueryTestAggregationsRequest)(nil),                  // 52: luci.resultdb.v1.QueryTestAggregationsRequest
	(*QueryTestAggregationsResponse)(nil),                 // 53: luci.resultdb.v1.QueryTestAggregationsResponse
	(*QueryTestVerdictsRequest)(nil),                      // 54: luci.resultdb.v1.QueryTestVerdictsRequest
	(*QueryTestVerdictsResponse)(nil),                     // 55: luci.resultdb.v1.QueryTestVerdictsResponse
	(*CompareArtifactLinesResponse_FailureOnlyRange)(nil), // 56: luci.resultdb.v1.CompareArtifactLinesResponse.FailureOnlyRange
	nil, // 57: luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry
	(*BatchGetTestVariantsRequest_TestVariantIdentifier)(nil), // 58: luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier
	nil, // 59: luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry
	(*BatchGetTestVerdictsRequest_NominatedTest)(nil),               // 60: luci.resultdb.v1.BatchGetTestVerdictsRequest.NominatedTest
	(*QueryNewTestVariantsResponse_NewTestVariant)(nil),             // 61: luci.resultdb.v1.QueryNewTestVariantsResponse.NewTestVariant
	(*InstructionDependencyChain_Node)(nil),                         // 62: luci.resultdb.v1.InstructionDependencyChain.Node
	(*QueryTestVariantArtifactGroupsResponse_MatchGroup)(nil),       // 63: luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse.MatchGroup
	(*QueryInvocationVariantArtifactGroupsResponse_MatchGroup)(nil), // 64: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse.MatchGroup
	(*ArtifactMatchingContent_Match)(nil),                           // 65: luci.resultdb.v1.ArtifactMatchingContent.Match
	(*fieldmaskpb.FieldMask)(nil),                                   // 66: google.protobuf.FieldMask
	(*TestResult)(nil),                                              // 67: luci.resultdb.v1.TestResult
	(*TestExoneration)(nil),                                         // 68: luci.resultdb.v1.TestExoneration
	(*TestResultPredicate)(nil),                                     // 69: luci.resultdb.v1.TestResultPredicate
	(*TestExonerationPredicate)(nil),                                // 70: luci.resultdb.v1.TestExonerationPredicate
	(*Artifact)(nil),                                                // 71: luci.resultdb.v1.Artifact
	(*ArtifactPredicate)(nil),                                       // 72: luci.resultdb.v1.ArtifactPredicate
	(*ArtifactLine)(nil),                                            // 73: luci.resultdb.v1.ArtifactLine
	(*TestVariantPredicate)(nil),                                    // 74: luci.resultdb.v1.TestVariantPredicate
	(*TestVariant)(nil),                                             // 75: luci.resultdb.v1.TestVariant
	(*RunTestVerdict)(nil),                                          // 76: luci.resultdb.v1.RunTestVerdict
	(TestVerdictView)(0),                                            // 77: luci.resultdb.v1.TestVerdictView
	(*TestVerdict)(nil),                                             // 78: luci.resultdb.v1.TestVerdict
	(*TestMetadataPredicate)(nil),                                   // 79: luci.resultdb.v1.TestMetadataPredicate
	(*TestMetadataDetail)(nil),                                      // 80: luci.resultdb.v1.TestMetadataDetail
	(*Instruction)(nil),                                             // 81: luci.resultdb.v1.Instruction
	(InstructionTarget)(0),                                          // 82: luci.resultdb.v1.InstructionTarget
	(*timestamppb.Timestamp)(nil),                                   // 83: google.protobuf.Timestamp
	(TestStatus)(0),                                                 // 84: luci.resultdb.v1.TestStatus
	(TestResult_Status)(0),                                          // 85: luci.resultdb.v1.TestResult.Status
	(*TestAggregationPredicate)(nil),                                // 86: luci.resultdb.v1.TestAggregationPredicate
	(*TestAggregation)(nil),                                         // 87: luci.resultdb.v1.TestAggregation
	(*TestVerdictPredicate)(nil),                                    // 88: luci.resultdb.v1.TestVerdictPredicate
	(*Sources)(nil),                                                 // 89: luci.resultdb.v1.Sources
	(*TestIdentifier)(nil),                                          // 90: luci.resultdb.v1.TestIdentifier
	(*Variant)(nil),                                                 // 91: luci.resultdb.v1.Variant
	(*GetRootInvocationRequest)(nil),                                // 92: luci.resultdb.v1.GetRootInvocationRequest
	(*GetWorkUnitRequest)(nil),                                      // 93: luci.resultdb.v1.GetWorkUnitRequest
	(*BatchGetWorkUnitsRequest)(nil),                                // 94: luci.resultdb.v1.BatchGetWorkUnitsRequest
	(*QueryWorkUnitsRequest)(nil),                                   // 95: luci.resultdb.v1.QueryWorkUnitsRequest
	(*RootInvocation)(nil),                                          // 96: luci.resultdb.v1.RootInvocation
	(*WorkUnit)(nil),                                                // 97: luci.resultdb.v1.WorkUnit
	(*BatchGetWorkUnitsResponse)(nil),                               // 98: luci.resultdb.v1.BatchGetWorkUnitsResponse
	(*QueryWorkUnitsResponse)(nil),                                  // 99: luci.resultdb.v1.QueryWorkUnitsResponse
	(*Invocation)(nil),                                              // 100: luci.resultdb.v1.Invocation
}
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_depIdxs = []int32{
	66,  // 0: luci.resultdb.v1.ListTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	67,  // 1: luci.resultdb.v1.ListTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	68,  // 2: luci.resultdb.v1.ListTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	69,  // 3: luci.resultdb.v1.QueryTestResultsRequest.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	66,  // 4: luci.resultdb.v1.QueryTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	67,  // 5: luci.resultdb.v1.QueryTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	70,  // 6: luci.resultdb.v1.QueryTestExonerationsRequest.predicate:type_name -> luci.resultdb.v1.TestExonerationPredicate
	68,  // 7: luci.resultdb.v1.QueryTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	66,  // 8: luci.resultdb.v1.ListArtifactsRequest.read_mask:type_name -> google.protobuf.FieldMask
	71,  // 9: luci.resultdb.v1.ListArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	72,  // 10: luci.resultdb.v1.QueryArtifactsRequest.predicate:type_name -> luci.resultdb.v1.ArtifactPredicate
	66,  // 11: luci.resultdb.v1.QueryArtifactsRequest.read_mask:type_name -> google.protobuf.FieldMask
	71,  // 12: luci.resultdb.v1.QueryArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	73,  // 13: luci.resultdb.v1.ListArtifactLinesResponse.lines:type_name -> luci.resultdb.v1.ArtifactLine
	0,   // 14: luci.resultdb.v1.CompareArtifactLinesRequest.view:type_name -> luci.resultdb.v1.CompareArtifactLinesRequest.View
	56,  // 15: luci.resultdb.v1.CompareArtifactLinesResponse.failure_only_ranges:type_name -> luci.resultdb.v1.CompareArtifactLinesResponse.FailureOnlyRange
	74,  // 16: luci.resultdb.v1.QueryTestVariantsRequest.predicate:type_name -> luci.resultdb.v1.TestVariantPredicate
	66,  // 17: luci.resultdb.v1.QueryTestVariantsRequest.read_mask:type_name -> google.protobuf.FieldMask
	75,  // 18: luci.resultdb.v1.QueryTestVariantsResponse.test_variants:type_name -> luci.resultdb.v1.TestVariant
	57,  // 19: luci.resultdb.v1.QueryTestVariantsResponse.sources:type_name -> luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry
	76,  // 20: luci.resultdb.v1.QueryRunTestVerdictsResponse.run_test_verdicts:type_name -> luci.resultdb.v1.RunTestVerdict
	58,  // 21: luci.resultdb.v1.BatchGetTestVariantsRequest.test_variants:type_name -> luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier
	75,  // 22: luci.resultdb.v1.BatchGetTestVariantsResponse.test_variants:type_name -> luci.resultdb.v1.TestVariant
	59,  // 23: luci.resultdb.v1.BatchGetTestVariantsResponse.sources:type_name -> luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry
	60,  // 24: luci.resultdb.v1.BatchGetTestVerdictsRequest.tests:type_name -> luci.resultdb.v1.BatchGetTestVerdictsRequest.NominatedTest
	77,  // 25: luci.resultdb.v1.BatchGetTestVerdictsRequest.view:type_name -> luci.resultdb.v1.TestVerdictView
	78,  // 26: luci.resultdb.v1.BatchGetTestVerdictsResponse.test_verdicts:type_name -> luci.resultdb.v1.TestVerdict
	79,  // 27: luci.resultdb.v1.QueryTestMetadataRequest.predicate:type_name -> luci.resultdb.v1.TestMetadataPredicate
	80,  // 28: luci.resultdb.v1.QueryTestMetadataResponse.testMetadata:type_name -> luci.resultdb.v1.TestMetadataDetail
	61,  // 29: luci.resultdb.v1.QueryNewTestVariantsResponse.new_test_variants:type_name -> luci.resultdb.v1.QueryNewTestVariantsResponse.NewTestVariant
	81,  // 30: luci.resultdb.v1.QueryInstructionResponse.instruction:type_name -> luci.resultdb.v1.Instruction
	40,  // 31: luci.resultdb.v1.QueryInstructionResponse.dependency_chains:type_name -> luci.resultdb.v1.InstructionDependencyChain
	82,  // 32: luci.resultdb.v1.InstructionDependencyChain.target:type_name -> luci.resultdb.v1.InstructionTarget
	62,  // 33: luci.resultdb.v1.InstructionDependencyChain.nodes:type_name -> luci.resultdb.v1.InstructionDependencyChain.Node
	50,  // 34: luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest.search_string:type_name -> luci.resultdb.v1.ArtifactContentMatcher
	51,  // 35: luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest.test_id_matcher:type_name -> luci.resultdb.v1.IDMatcher
	51,  // 36: luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest.artifact_id_matcher:type_name -> luci.resultdb.v1.IDMatcher
	83,  // 37: luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest.start_time:type_name -> google.protobuf.Timestamp
	83,  // 38: luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest.end_time:type_name -> google.protobuf.Timestamp
	63,  // 39: luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse.groups:type_name -> luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse.MatchGroup
	50,  // 40: luci.resultdb.v1.QueryTestVariantArtifactsRequest.search_string:type_name -> luci.resultdb.v1.ArtifactContentMatcher
	83,  // 41: luci.resultdb.v1.QueryTestVariantArtifactsRequest.start_time:type_name -> google.protobuf.Timestamp
	83,  // 42: luci.resultdb.v1.QueryTestVariantArtifactsRequest.end_time:type_name -> google.protobuf.Timestamp
	49,  // 43: luci.resultdb.v1.QueryTestVariantArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.ArtifactMatchingContent
	50,  // 44: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsRequest.search_string:type_name -> luci.resultdb.v1.ArtifactContentMatcher
	51,  // 45: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsRequest.artifact_id_matcher:type_name -> luci.resultdb.v1.IDMatcher
	83,  // 46: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsRequest.start_time:type_name -> google.protobuf.Timestamp
	83,  // 47: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsRequest.end_time:type_name -> google.protobuf.Timestamp
	64,  // 48: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse.groups:type_name -> luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse.MatchGroup
	50,  // 49: luci.resultdb.v1.QueryInvocationVariantArtifactsRequest.search_string:type_name -> luci.resultdb.v1.ArtifactContentMatcher
	83,  // 50: luci.resultdb.v1.QueryInvocationVariantArtifactsRequest.start_time:type_name -> google.protobuf.Timestamp
	83,  // 51: luci.resultdb.v1.QueryInvocationVariantArtifactsRequest.end_time:type_name -> google.protobuf.Timestamp
	49,  // 52: luci.resultdb.v1.QueryInvocationVariantArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.ArtifactMatchingContent
	83,  // 53: luci.resultdb.v1.ArtifactMatchingContent.partition_time:type_name -> google.protobuf.Timestamp
	84,  // 54: luci.resultdb.v1.ArtifactMatchingContent.test_status:type_name -> luci.resultdb.v1.TestStatus
	85,  // 55: luci.resultdb.v1.ArtifactMatchingContent.test_status_v2:type_name -> luci.resultdb.v1.TestResult.Status
	65,  // 56: luci.resultdb.v1.ArtifactMatchingContent.matches:type_name -> luci.resultdb.v1.ArtifactMatchingContent.Match
	86,  // 57: luci.resultdb.v1.QueryTestAggregationsRequest.predicate:type_name -> luci.resultdb.v1.TestAggregationPredicate
	87,  // 58: luci.resultdb.v1.QueryTestAggregationsResponse.aggregations:type_name -> luci.resultdb.v1.TestAggregation
	88,  // 59: luci.resultdb.v1.QueryTestVerdictsRequest.predicate:type_name -> luci.resultdb.v1.TestVerdictPredicate
	77,  // 60: luci.resultdb.v1.QueryTestVerdictsRequest.view:type_name -> luci.resultdb.v1.TestVerdictView
	78,  // 61: luci.resultdb.v1.QueryTestVerdictsResponse.test_verdicts:type_name -> luci.resultdb.v1.TestVerdict
	89,  // 62: luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	90,  // 63: luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier.test_id_structured:type_name -> luci.resultdb.v1.TestIdentifier
	89,  // 64: luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	90,  // 65: luci.resultdb.v1.BatchGetTestVerdictsRequest.NominatedTest.test_id_structured:type_name -> luci.resultdb.v1.TestIdentifier
	91,  // 66: luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse.MatchGroup.variant:type_name -> luci.resultdb.v1.Variant
	49,  // 67: luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse.MatchGroup.artifacts:type_name -> luci.resultdb.v1.ArtifactMatchingContent
	91,  // 68: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse.MatchGroup.variant_union:type_name -> luci.resultdb.v1.Variant
	49,  // 69: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse.MatchGroup.artifacts:type_name -> luci.resultdb.v1.ArtifactMatchingContent
	92,  // 70: luci.resultdb.v1.ResultDB.GetRootInvocation:input_type -> luci.resultdb.v1.GetRootInvocationRequest
	93,  // 71: luci.resultdb.v1.ResultDB.GetWorkUnit:input_type -> luci.resultdb.v1.GetWorkUnitRequest
	94,  // 72: luci.resultdb.v1.ResultDB.BatchGetWorkUnits:input_type -> luci.resultdb.v1.BatchGetWorkUnitsRequest
	95,  // 73: luci.resultdb.v1.ResultDB.QueryWorkUnits:input_type -> luci.resultdb.v1.QueryWorkUnitsRequest
	4,   // 74: luci.resultdb.v1.ResultDB.GetTestResult:input_type -> luci.resultdb.v1.GetTestResultRequest
	5,   // 75: luci.resultdb.v1.ResultDB.ListTestResults:input_type -> luci.resultdb.v1.ListTestResultsRequest
	7,   // 76: luci.resultdb.v1.ResultDB.GetTestExoneration:input_type -> luci.resultdb.v1.GetTestExonerationRequest
	8,   // 77: luci.resultdb.v1.ResultDB.ListTestExonerations:input_type -> luci.resultdb.v1.ListTestExonerationsRequest
	10,  // 78: luci.resultdb.v1.ResultDB.QueryTestResults:input_type -> luci.resultdb.v1.QueryTestResultsRequest
	12,  // 79: luci.resultdb.v1.ResultDB.QueryTestExonerations:input_type -> luci.resultdb.v1.QueryTestExonerationsRequest
	35,  // 80: luci.resultdb.v1.ResultDB.QueryNewTestVariants:input_type -> luci.resultdb.v1.QueryNewTestVariantsRequest
	33,  // 81: luci.resultdb.v1.ResultDB.QueryTestMetadata:input_type -> luci.resultdb.v1.QueryTestMetadataRequest
	37,  // 82: luci.resultdb.v1.ResultDB.GetInstruction:input_type -> luci.resultdb.v1.GetInstructionRequest
	38,  // 83: luci.resultdb.v1.ResultDB.QueryInstruction:input_type -> luci.resultdb.v1.QueryInstructionRequest
	52,  // 84: luci.resultdb.v1.ResultDB.QueryTestAggregations:input_type -> luci.resultdb.v1.QueryTestAggregationsRequest
	54,  // 85: luci.resultdb.v1.ResultDB.QueryTestVerdicts:input_type -> luci.resultdb.v1.QueryTestVerdictsRequest
	31,  // 86: luci.resultdb.v1.ResultDB.BatchGetTestVerdicts:input_type -> luci.resultdb.v1.BatchGetTestVerdictsRequest
	...
	41,  // 92: luci.resultdb.v1.ResultDB.QueryTestVariantArtifactGroups:input_type -> luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest
	43,  // 93: luci.resultdb.v1.ResultDB.QueryTestVariantArtifacts:input_type -> luci.resultdb.v1.QueryTestVariantArtifactsRequest
	45,  // 94: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifactGroups:input_type -> luci.resultdb.v1.QueryInvocationVariantArtifactGroupsRequest
	47,  // 95: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifacts:input_type -> luci.resultdb.v1.QueryInvocationVariantArtifactsRequest
	1,   // 96: luci.resultdb.v1.ResultDB.GetInvocation:input_type -> luci.resultdb.v1.GetInvocationRequest
	2,   // 97: luci.resultdb.v1.ResultDB.QueryRootInvocationNames:input_type -> luci.resultdb.v1.QueryRootInvocationNamesRequest
	27,  // 98: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:input_type -> luci.resultdb.v1.QueryRunTestVerdictsRequest
	25,  // 99: luci.resultdb.v1.ResultDB.QueryTestVariants:input_type -> luci.resultdb.v1.QueryTestVariantsRequest
	29,  // 100: luci.resultdb.v1.ResultDB.BatchGetTestVariants:input_type -> luci.resultdb.v1.BatchGetTestVariantsRequest
	14,  // 101: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:input_type -> luci.resultdb.v1.QueryTestResultStatisticsRequest
	96,  // 102: luci.resultdb.v1.ResultDB.GetRootInvocation:output_type -> luci.resultdb.v1.RootInvocation
	97,  // 103: luci.resultdb.v1.ResultDB.GetWorkUnit:output_type -> luci.resultdb.v1.WorkUnit
	98,  // 104: luci.resultdb.v1.ResultDB.BatchGetWorkUnits:output_type -> luci.resultdb.v1.BatchGetWorkUnitsResponse
	99,  // 105: luci.resultdb.v1.ResultDB.QueryWorkUnits:output_type -> luci.resultdb.v1.QueryWorkUnitsResponse
	67,  // 106: luci.resultdb.v1.ResultDB.GetTestResult:output_type -> luci.resultdb.v1.TestResult
	6,   // 107: luci.resultdb.v1.ResultDB.ListTestResults:output_type -> luci.resultdb.v1.ListTestResultsResponse
	68,  // 108: luci.resultdb.v1.ResultDB.GetTestExoneration:output_type -> luci.resultdb.v1.TestExoneration
	9,   // 109: luci.resultdb.v1.ResultDB.ListTestExonerations:output_type -> luci.resultdb.v1.ListTestExonerationsResponse
	11,  // 110: luci.resultdb.v1.ResultDB.QueryTestResults:output_type -> luci.resultdb.v1.QueryTestResultsResponse
	13,  // 111: luci.resultdb.v1.ResultDB.QueryTestExonerations:output_type -> luci.resultdb.v1.QueryTestExonerationsResponse
	36,  // 112: luci.resultdb.v1.ResultDB.QueryNewTestVariants:output_type -> luci.resultdb.v1.QueryNewTestVariantsResponse
	34,  // 113: luci.resultdb.v1.ResultDB.QueryTestMetadata:output_type -> luci.resultdb.v1.QueryTestMetadataResponse
	81,  // 114: luci.resultdb.v1.ResultDB.GetInstruction:output_type -> luci.resultdb.v1.Instruction
	39,  // 115: luci.resultdb.v1.ResultDB.QueryInstruction:output_type -> luci.resultdb.v1.QueryInstructionResponse
	53,  // 116: luci.resultdb.v1.ResultDB.QueryTestAggregations:output_type -> luci.resultdb.v1.QueryTestAggregationsResponse
	55,  // 117: luci.resultdb.v1.ResultDB.QueryTestVerdicts:output_type -> luci.resultdb.v1.QueryTestVerdictsResponse
	32,  // 118: luci.resultdb.v1.ResultDB.BatchGetTestVerdicts:output_type -> luci.resultdb.v1.BatchGetTestVerdictsResponse
	71,  // 119: luci.resultdb.v1.ResultDB.GetArtifact:output_type -> luci.resultdb.v1.Artifact
	18,  // 120: luci.resultdb.v1.ResultDB.ListArtifacts:output_type -> luci.resultdb.v1.ListArtifactsResponse
	20,  // 121: luci.resultdb.v1.ResultDB.QueryArtifacts:output_type -> luci.resultdb.v1.QueryArtifactsResponse
	22,  // 122: luci.resultdb.v1.ResultDB.ListArtifactLines:output_type -> luci.resultdb.v1.ListArtifactLinesResponse
	24,  // 123: luci.resultdb.v1.ResultDB.CompareArtifactLines:output_type -> luci.resultdb.v1.CompareArtifactLinesResponse
	42,  // 124: luci.resultdb.v1.ResultDB.QueryTestVariantArtifactGroups:output_type -> luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse
	44,  // 125: luci.resultdb.v1.ResultDB.QueryTestVariantArtifacts:output_type -> luci.resultdb.v1.QueryTestVariantArtifactsResponse
	46,  // 126: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifactGroups:output_type -> luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse
	48,  // 127: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifacts:output_type -> luci.resultdb.v1.QueryInvocationVariantArtifactsResponse
	100, // 128: luci.resultdb.v1.ResultDB.GetInvocation:output_type -> luci.resultdb.v1.Invocation
	3,   // 129: luci.resultdb.v1.ResultDB.QueryRootInvocationNames:output_type -> luci.resultdb.v1.QueryRootInvocationNamesResponse
	28,  // 130: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:output_type -> luci.resultdb.v1.QueryRunTestVerdictsResponse
	26,  // 131: luci.resultdb.v1.ResultDB.QueryTestVariants:output_type -> luci.resultdb.v1.QueryTestVariantsResponse
	30,  // 132: luci.resultdb.v1.ResultDB.BatchGetTestVariants:output_type -> luci.resultdb.v1.BatchGetTestVariantsResponse
	15,  // 133: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:output_type -> luci.resultdb.v1.QueryTestResultStatisticsResponse
...
func file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchGetTestVerdictsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchGetTestVerdictsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[59].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchGetTestVerdictsRequest_NominatedTest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[62].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[63].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[64].Exporter = func(v interface{}, i int) interface{} {
	...
	file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[49].OneofWrappers = []interface{}{
		(*ArtifactContentMatcher_RegexContain)(nil),
		(*ArtifactContentMatcher_Contain)(nil),
	}
	file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes[50].OneofWrappers = []interface{}{
...
type ResultDBClient interface {
	...
	BatchGetTestVerdicts(ctx context.Context, in *BatchGetTestVerdictsRequest, opts ...grpc.CallOption) (*BatchGetTestVerdictsResponse, error)
...
func (c *resultDBPRPCClient) BatchGetTestVerdicts(ctx context.Context, in *BatchGetTestVerdictsRequest, opts ...grpc.CallOption) (*BatchGetTestVerdictsResponse, error) {
	out := new(BatchGetTestVerdictsResponse)
	err := c.client.Call(ctx, "luci.resultdb.v1.ResultDB", "BatchGetTestVerdicts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resultDBClient) BatchGetTestVerdicts(ctx context.Context, in *BatchGetTestVerdictsRequest, opts ...grpc.CallOption) (*BatchGetTestVerdictsResponse, error) {
	out := new(BatchGetTestVerdictsResponse)
	err := c.cc.Invoke(ctx, "/luci.resultdb.v1.ResultDB/BatchGetTestVerdicts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ResultDBServer interface {
	...
	// Retrieves specified test verdicts from a given root invocation.
	BatchGetTestVerdicts(context.Context, *BatchGetTestVerdictsRequest) (*BatchGetTestVerdictsResponse, error)
	// Retrieves an artifact.
...
func (*UnimplementedResultDBServer) BatchGetTestVerdicts(context.Context, *BatchGetTestVerdictsRequest) (*BatchGetTestVerdictsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchGetTestVerdicts not implemented")
}
...
func _ResultDB_BatchGetTestVerdicts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchGetTestVerdictsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResultDBServer).BatchGetTestVerdicts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/luci.resultdb.v1.ResultDB/BatchGetTestVerdicts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResultDBServer).BatchGetTestVerdicts(ctx, req.(*BatchGetTestVerdictsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ResultDB_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchGetTestVerdicts",
			Handler:    _ResultDB_BatchGetTestVerdicts_Handler,
		},
		{
