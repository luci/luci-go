...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0d, 0x6e, 0x65, 0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x94,
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_goTypes = []interface{}{
	...
	(*RootInvocation)(nil),                                          // 91: luci.resultdb.v1.RootInvocation
	(*WorkUnit)(nil),                                                // 92: luci.resultdb.v1.WorkUnit
	(*BatchGetWorkUnitsResponse)(nil),                               // 93: luci.resultdb.v1.BatchGetWorkUnitsResponse
	(*Invocation)(nil),                                              // 94: luci.resultdb.v1.Invocation
}
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_depIdxs = []int32{
	...
	91, // 95: luci.resultdb.v1.ResultDB.GetRootInvocation:output_type -> luci.resultdb.v1.RootInvocation
	92, // 96: luci.resultdb.v1.ResultDB.GetWorkUnit:output_type -> luci.resultdb.v1.WorkUnit
	93, // 97: luci.resultdb.v1.ResultDB.BatchGetWorkUnits:output_type -> luci.resultdb.v1.BatchGetWorkUnitsResponse
	94, // 98: luci.resultdb.v1.ResultDB.GetInvocation:output_type -> luci.resultdb.v1.Invocation
	3,  // 99: luci.resultdb.v1.ResultDB.QueryRootInvocationNames:output_type -> luci.resultdb.v1.QueryRootInvocationNamesResponse
	64, // 100: luci.resultdb.v1.ResultDB.GetTestResult:output_type -> luci.resultdb.v1.TestResult
	6,  // 101: luci.resultdb.v1.ResultDB.ListTestResults:output_type -> luci.resultdb.v1.ListTestResultsResponse
	65, // 102: luci.resultdb.v1.ResultDB.GetTestExoneration:output_type -> luci.resultdb.v1.TestExoneration
	9,  // 103: luci.resultdb.v1.ResultDB.ListTestExonerations:output_type -> luci.resultdb.v1.ListTestExonerationsResponse
	11, // 104: luci.resultdb.v1.ResultDB.QueryTestResults:output_type -> luci.resultdb.v1.QueryTestResultsResponse
	13, // 105: luci.resultdb.v1.ResultDB.QueryTestExonerations:output_type -> luci.resultdb.v1.QueryTestExonerationsResponse
	15, // 106: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:output_type -> luci.resultdb.v1.QueryTestResultStatisticsResponse
	34, // 107: luci.resultdb.v1.ResultDB.QueryNewTestVariants:output_type -> luci.resultdb.v1.QueryNewTestVariantsResponse
	28, // 108: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:output_type -> luci.resultdb.v1.QueryRunTestVerdictsResponse
	26, // 109: luci.resultdb.v1.ResultDB.QueryTestVariants:output_type -> luci.resultdb.v1.QueryTestVariantsResponse
	30, // 110: luci.resultdb.v1.ResultDB.BatchGetTestVariants:output_type -> luci.resultdb.v1.BatchGetTestVariantsResponse
	32, // 111: luci.resultdb.v1.ResultDB.QueryTestMetadata:output_type -> luci.resultdb.v1.QueryTestMetadataResponse
	76, // 112: luci.resultdb.v1.ResultDB.GetInstruction:output_type -> luci.resultdb.v1.Instruction
	37, // 113: luci.resultdb.v1.ResultDB.QueryInstruction:output_type -> luci.resultdb.v1.QueryInstructionResponse
	51, // 114: luci.resultdb.v1.ResultDB.QueryTestAggregations:output_type -> luci.resultdb.v1.QueryTestAggregationsResponse
	53, // 115: luci.resultdb.v1.ResultDB.QueryTestVerdicts:output_type -> luci.resultdb.v1.QueryTestVerdictsResponse
	68, // 116: luci.resultdb.v1.ResultDB.GetArtifact:output_type -> luci.resultdb.v1.Artifact
	18, // 117: luci.resultdb.v1.ResultDB.ListArtifacts:output_type -> luci.resultdb.v1.ListArtifactsResponse
	20, // 118: luci.resultdb.v1.ResultDB.QueryArtifacts:output_type -> luci.resultdb.v1.QueryArtifactsResponse
	22, // 119: luci.resultdb.v1.ResultDB.ListArtifactLines:output_type -> luci.resultdb.v1.ListArtifactLinesResponse
	24, // 120: luci.resultdb.v1.ResultDB.CompareArtifactLines:output_type -> luci.resultdb.v1.CompareArtifactLinesResponse
	40, // 121: luci.resultdb.v1.ResultDB.QueryTestVariantArtifactGroups:output_type -> luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse
	42, // 122: luci.resultdb.v1.ResultDB.QueryTestVariantArtifacts:output_type -> luci.resultdb.v1.QueryTestVariantArtifactsResponse
	44, // 123: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifactGroups:output_type -> luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse
	46, // 124: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifacts:output_type -> luci.resultdb.v1.QueryInvocationVariantArtifactsResponse
