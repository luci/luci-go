...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDesc = []byte{
	...
	0x32, 0xe7, 0x0f, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x44, 0x42, 0x12, 0x57, 0x0a,
	0x0d, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26,
	0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76,
	0x31, 0x2e, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x12, 0x57, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f,
	0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d, 0x2e, 0x6f, 0x72, 0x67, 0x2f, 0x6c, 0x75,
	0x63, 0x69, 0x2f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_goTypes = []interface{}{
	...
	(*QueryArtifactFailureOnlyLinesResponse_LineRange)(nil), // 32: luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse.LineRange
	nil, // 33: luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry
	(*BatchGetTestVariantsRequest_TestVariantIdentifier)(nil), // 34: luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier
	nil, // 35: luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry
	(*QueryNewTestVariantsResponse_NewTestVariant)(nil), // 36: luci.resultdb.v1.QueryNewTestVariantsResponse.NewTestVariant
	(*fieldmaskpb.FieldMask)(nil),                       // 37: google.protobuf.FieldMask
	(*TestResult)(nil),                                  // 38: luci.resultdb.v1.TestResult
	(*TestExoneration)(nil),                             // 39: luci.resultdb.v1.TestExoneration
	(*TestResultPredicate)(nil),                         // 40: luci.resultdb.v1.TestResultPredicate
	(*TestExonerationPredicate)(nil),                    // 41: luci.resultdb.v1.TestExonerationPredicate
	(*Artifact)(nil),                                    // 42: luci.resultdb.v1.Artifact
	(*ArtifactPredicate)(nil),                           // 43: luci.resultdb.v1.ArtifactPredicate
	(*ArtifactLine)(nil),                                // 44: luci.resultdb.v1.ArtifactLine
	(*TestVariantPredicate)(nil),                        // 45: luci.resultdb.v1.TestVariantPredicate
	(*TestVariant)(nil),                                 // 46: luci.resultdb.v1.TestVariant
	(*RunTestVerdict)(nil),                              // 47: luci.resultdb.v1.RunTestVerdict
	(*TestMetadataPredicate)(nil),                       // 48: luci.resultdb.v1.TestMetadataPredicate
	(*TestMetadataDetail)(nil),                          // 49: luci.resultdb.v1.TestMetadataDetail
	(*Sources)(nil),                                     // 50: luci.resultdb.v1.Sources
	(*Invocation)(nil),                                  // 51: luci.resultdb.v1.Invocation
}
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_depIdxs = []int32{
	37, // 0: luci.resultdb.v1.ListTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	38, // 1: luci.resultdb.v1.ListTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	39, // 2: luci.resultdb.v1.ListTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	40, // 3: luci.resultdb.v1.QueryTestResultsRequest.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	37, // 4: luci.resultdb.v1.QueryTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	38, // 5: luci.resultdb.v1.QueryTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	41, // 6: luci.resultdb.v1.QueryTestExonerationsRequest.predicate:type_name -> luci.resultdb.v1.TestExonerationPredicate
	39, // 7: luci.resultdb.v1.QueryTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	42, // 8: luci.resultdb.v1.ListArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	43, // 9: luci.resultdb.v1.QueryArtifactsRequest.predicate:type_name -> luci.resultdb.v1.ArtifactPredicate
	42, // 10: luci.resultdb.v1.QueryArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	44, // 11: luci.resultdb.v1.ListArtifactLinesResponse.lines:type_name -> luci.resultdb.v1.ArtifactLine
	32, // 12: luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse.failure_only_line_ranges:type_name -> luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse.LineRange
	45, // 13: luci.resultdb.v1.QueryTestVariantsRequest.predicate:type_name -> luci.resultdb.v1.TestVariantPredicate
	37, // 14: luci.resultdb.v1.QueryTestVariantsRequest.read_mask:type_name -> google.protobuf.FieldMask
	46, // 15: luci.resultdb.v1.QueryTestVariantsResponse.test_variants:type_name -> luci.resultdb.v1.TestVariant
	33, // 16: luci.resultdb.v1.QueryTestVariantsResponse.sources:type_name -> luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry
	47, // 17: luci.resultdb.v1.QueryRunTestVerdictsResponse.run_test_verdicts:type_name -> luci.resultdb.v1.RunTestVerdict
	34, // 18: luci.resultdb.v1.BatchGetTestVariantsRequest.test_variants:type_name -> luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier
	46, // 19: luci.resultdb.v1.BatchGetTestVariantsResponse.test_variants:type_name -> luci.resultdb.v1.TestVariant
	35, // 20: luci.resultdb.v1.BatchGetTestVariantsResponse.sources:type_name -> luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry
	48, // 21: luci.resultdb.v1.QueryTestMetadataRequest.predicate:type_name -> luci.resultdb.v1.TestMetadataPredicate
	49, // 22: luci.resultdb.v1.QueryTestMetadataResponse.testMetadata:type_name -> luci.resultdb.v1.TestMetadataDetail
	36, // 23: luci.resultdb.v1.QueryNewTestVariantsResponse.new_test_variants:type_name -> luci.resultdb.v1.QueryNewTestVariantsResponse.NewTestVariant
	50, // 24: luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	50, // 25: luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	...
	51, // 44: luci.resultdb.v1.ResultDB.GetInvocation:output_type -> luci.resultdb.v1.Invocation
	38, // 45: luci.resultdb.v1.ResultDB.GetTestResult:output_type -> luci.resultdb.v1.TestResult
	3,  // 46: luci.resultdb.v1.ResultDB.ListTestResults:output_type -> luci.resultdb.v1.ListTestResultsResponse
	39, // 47: luci.resultdb.v1.ResultDB.GetTestExoneration:output_type -> luci.resultdb.v1.TestExoneration
	6,  // 48: luci.resultdb.v1.ResultDB.ListTestExonerations:output_type -> luci.resultdb.v1.ListTestExonerationsResponse
	8,  // 49: luci.resultdb.v1.ResultDB.QueryTestResults:output_type -> luci.resultdb.v1.QueryTestResultsResponse
	10, // 50: luci.resultdb.v1.ResultDB.QueryTestExonerations:output_type -> luci.resultdb.v1.QueryTestExonerationsResponse
	12, // 51: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:output_type -> luci.resultdb.v1.QueryTestResultStatisticsResponse
	31, // 52: luci.resultdb.v1.ResultDB.QueryNewTestVariants:output_type -> luci.resultdb.v1.QueryNewTestVariantsResponse
	42, // 53: luci.resultdb.v1.ResultDB.GetArtifact:output_type -> luci.resultdb.v1.Artifact
	15, // 54: luci.resultdb.v1.ResultDB.ListArtifacts:output_type -> luci.resultdb.v1.ListArtifactsResponse
	17, // 55: luci.resultdb.v1.ResultDB.QueryArtifacts:output_type -> luci.resultdb.v1.QueryArtifactsResponse
	25, // 56: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:output_type -> luci.resultdb.v1.QueryRunTestVerdictsResponse
	19, // 57: luci.resultdb.v1.ResultDB.ListArtifactLines:output_type -> luci.resultdb.v1.ListArtifactLinesResponse
	21, // 58: luci.resultdb.v1.ResultDB.QueryArtifactFailureOnlyLines:output_type -> luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse
	23, // 59: luci.resultdb.v1.ResultDB.QueryTestVariants:output_type -> luci.resultdb.v1.QueryTestVariantsResponse
	27, // 60: luci.resultdb.v1.ResultDB.BatchGetTestVariants:output_type -> luci.resultdb.v1.BatchGetTestVariantsResponse
	29, // 61: luci.resultdb.v1.ResultDB.QueryTestMetadata:output_type -> luci.resultdb.v1.QueryTestMetadataResponse
