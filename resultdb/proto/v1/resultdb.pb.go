...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDesc = []byte{
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xb0, 0x11, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_goTypes = []interface{}{
	...
	(*QueryArtifactFailureOnlyLinesResponse_LineRange)(nil), // 36: luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse.LineRange
	nil, // 37: luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry
	(*BatchGetTestVariantsRequest_TestVariantIdentifier)(nil), // 38: luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier
	nil, // 39: luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry
	(*QueryNewTestVariantsResponse_NewTestVariant)(nil), // 40: luci.resultdb.v1.QueryNewTestVariantsResponse.NewTestVariant
	(*InstructionDependencyChain_Node)(nil),             // 41: luci.resultdb.v1.InstructionDependencyChain.Node
	(*fieldmaskpb.FieldMask)(nil),                       // 42: google.protobuf.FieldMask
	(*TestResult)(nil),                                  // 43: luci.resultdb.v1.TestResult
	(*TestExoneration)(nil),                             // 44: luci.resultdb.v1.TestExoneration
	(*TestResultPredicate)(nil),                         // 45: luci.resultdb.v1.TestResultPredicate
	(*TestExonerationPredicate)(nil),                    // 46: luci.resultdb.v1.TestExonerationPredicate
	(*Artifact)(nil),                                    // 47: luci.resultdb.v1.Artifact
	(*ArtifactPredicate)(nil),                           // 48: luci.resultdb.v1.ArtifactPredicate
	(*ArtifactLine)(nil),                                // 49: luci.resultdb.v1.ArtifactLine
	(*TestVariantPredicate)(nil),                        // 50: luci.resultdb.v1.TestVariantPredicate
	(*TestVariant)(nil),                                 // 51: luci.resultdb.v1.TestVariant
	(*RunTestVerdict)(nil),                              // 52: luci.resultdb.v1.RunTestVerdict
	(*TestMetadataPredicate)(nil),                       // 53: luci.resultdb.v1.TestMetadataPredicate
	(*TestMetadataDetail)(nil),                          // 54: luci.resultdb.v1.TestMetadataDetail
	(*Instruction)(nil),                                 // 55: luci.resultdb.v1.Instruction
	(InstructionTarget)(0),                              // 56: luci.resultdb.v1.InstructionTarget
	(*Sources)(nil),                                     // 57: luci.resultdb.v1.Sources
	(*Invocation)(nil),                                  // 58: luci.resultdb.v1.Invocation
}
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_depIdxs = []int32{
	42, // 0: luci.resultdb.v1.ListTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	43, // 1: luci.resultdb.v1.ListTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	44, // 2: luci.resultdb.v1.ListTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	45, // 3: luci.resultdb.v1.QueryTestResultsRequest.predicate:type_name -> luci.resultdb.v1.TestResultPredicate
	42, // 4: luci.resultdb.v1.QueryTestResultsRequest.read_mask:type_name -> google.protobuf.FieldMask
	43, // 5: luci.resultdb.v1.QueryTestResultsResponse.test_results:type_name -> luci.resultdb.v1.TestResult
	46, // 6: luci.resultdb.v1.QueryTestExonerationsRequest.predicate:type_name -> luci.resultdb.v1.TestExonerationPredicate
	44, // 7: luci.resultdb.v1.QueryTestExonerationsResponse.test_exonerations:type_name -> luci.resultdb.v1.TestExoneration
	47, // 8: luci.resultdb.v1.ListArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	48, // 9: luci.resultdb.v1.QueryArtifactsRequest.predicate:type_name -> luci.resultdb.v1.ArtifactPredicate
	47, // 10: luci.resultdb.v1.QueryArtifactsResponse.artifacts:type_name -> luci.resultdb.v1.Artifact
	49, // 11: luci.resultdb.v1.ListArtifactLinesResponse.lines:type_name -> luci.resultdb.v1.ArtifactLine
	36, // 12: luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse.failure_only_line_ranges:type_name -> luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse.LineRange
	50, // 13: luci.resultdb.v1.QueryTestVariantsRequest.predicate:type_name -> luci.resultdb.v1.TestVariantPredicate
	42, // 14: luci.resultdb.v1.QueryTestVariantsRequest.read_mask:type_name -> google.protobuf.FieldMask
	51, // 15: luci.resultdb.v1.QueryTestVariantsResponse.test_variants:type_name -> luci.resultdb.v1.TestVariant
	37, // 16: luci.resultdb.v1.QueryTestVariantsResponse.sources:type_name -> luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry
	52, // 17: luci.resultdb.v1.QueryRunTestVerdictsResponse.run_test_verdicts:type_name -> luci.resultdb.v1.RunTestVerdict
	38, // 18: luci.resultdb.v1.BatchGetTestVariantsRequest.test_variants:type_name -> luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier
	51, // 19: luci.resultdb.v1.BatchGetTestVariantsResponse.test_variants:type_name -> luci.resultdb.v1.TestVariant
	39, // 20: luci.resultdb.v1.BatchGetTestVariantsResponse.sources:type_name -> luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry
	53, // 21: luci.resultdb.v1.QueryTestMetadataRequest.predicate:type_name -> luci.resultdb.v1.TestMetadataPredicate
	54, // 22: luci.resultdb.v1.QueryTestMetadataResponse.testMetadata:type_name -> luci.resultdb.v1.TestMetadataDetail
	40, // 23: luci.resultdb.v1.QueryNewTestVariantsResponse.new_test_variants:type_name -> luci.resultdb.v1.QueryNewTestVariantsResponse.NewTestVariant
	55, // 24: luci.resultdb.v1.QueryInstructionResponse.instruction:type_name -> luci.resultdb.v1.Instruction
	35, // 25: luci.resultdb.v1.QueryInstructionResponse.dependency_chains:type_name -> luci.resultdb.v1.InstructionDependencyChain
	56, // 26: luci.resultdb.v1.InstructionDependencyChain.target:type_name -> luci.resultdb.v1.InstructionTarget
	41, // 27: luci.resultdb.v1.InstructionDependencyChain.nodes:type_name -> luci.resultdb.v1.InstructionDependencyChain.Node
	57, // 28: luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	57, // 29: luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	0,  // 30: luci.resultdb.v1.ResultDB.GetInvocation:input_type -> luci.resultdb.v1.GetInvocationRequest
	1,  // 31: luci.resultdb.v1.ResultDB.GetTestResult:input_type -> luci.resultdb.v1.GetTestResultRequest
	2,  // 32: luci.resultdb.v1.ResultDB.ListTestResults:input_type -> luci.resultdb.v1.ListTestResultsRequest
	4,  // 33: luci.resultdb.v1.ResultDB.GetTestExoneration:input_type -> luci.resultdb.v1.GetTestExonerationRequest
	5,  // 34: luci.resultdb.v1.ResultDB.ListTestExonerations:input_type -> luci.resultdb.v1.ListTestExonerationsRequest
	7,  // 35: luci.resultdb.v1.ResultDB.QueryTestResults:input_type -> luci.resultdb.v1.QueryTestResultsRequest
	9,  // 36: luci.resultdb.v1.ResultDB.QueryTestExonerations:input_type -> luci.resultdb.v1.QueryTestExonerationsRequest
	11, // 37: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:input_type -> luci.resultdb.v1.QueryTestResultStatisticsRequest
	30, // 38: luci.resultdb.v1.ResultDB.QueryNewTestVariants:input_type -> luci.resultdb.v1.QueryNewTestVariantsRequest
	13, // 39: luci.resultdb.v1.ResultDB.GetArtifact:input_type -> luci.resultdb.v1.GetArtifactRequest
	14, // 40: luci.resultdb.v1.ResultDB.ListArtifacts:input_type -> luci.resultdb.v1.ListArtifactsRequest
	16, // 41: luci.resultdb.v1.ResultDB.QueryArtifacts:input_type -> luci.resultdb.v1.QueryArtifactsRequest
	24, // 42: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:input_type -> luci.resultdb.v1.QueryRunTestVerdictsRequest
	18, // 43: luci.resultdb.v1.ResultDB.ListArtifactLines:input_type -> luci.resultdb.v1.ListArtifactLinesRequest
	20, // 44: luci.resultdb.v1.ResultDB.QueryArtifactFailureOnlyLines:input_type -> luci.resultdb.v1.QueryArtifactFailureOnlyLinesRequest
	22, // 45: luci.resultdb.v1.ResultDB.QueryTestVariants:input_type -> luci.resultdb.v1.QueryTestVariantsRequest
	26, // 46: luci.resultdb.v1.ResultDB.BatchGetTestVariants:input_type -> luci.resultdb.v1.BatchGetTestVariantsRequest
	28, // 47: luci.resultdb.v1.ResultDB.QueryTestMetadata:input_type -> luci.resultdb.v1.QueryTestMetadataRequest
	32, // 48: luci.resultdb.v1.ResultDB.GetInstruction:input_type -> luci.resultdb.v1.GetInstructionRequest
	33, // 49: luci.resultdb.v1.ResultDB.QueryInstruction:input_type -> luci.resultdb.v1.QueryInstructionRequest
	58, // 50: luci.resultdb.v1.ResultDB.GetInvocation:output_type -> luci.resultdb.v1.Invocation
	43, // 51: luci.resultdb.v1.ResultDB.GetTestResult:output_type -> luci.resultdb.v1.TestResult
	3,  // 52: luci.resultdb.v1.ResultDB.ListTestResults:output_type -> luci.resultdb.v1.ListTestResultsResponse
	44, // 53: luci.resultdb.v1.ResultDB.GetTestExoneration:output_type -> luci.resultdb.v1.TestExoneration
	6,  // 54: luci.resultdb.v1.ResultDB.ListTestExonerations:output_type -> luci.resultdb.v1.ListTestExonerationsResponse
	8,  // 55: luci.resultdb.v1.ResultDB.QueryTestResults:output_type -> luci.resultdb.v1.QueryTestResultsResponse
	10, // 56: luci.resultdb.v1.ResultDB.QueryTestExonerations:output_type -> luci.resultdb.v1.QueryTestExonerationsResponse
	12, // 57: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:output_type -> luci.resultdb.v1.QueryTestResultStatisticsResponse
	31, // 58: luci.resultdb.v1.ResultDB.QueryNewTestVariants:output_type -> luci.resultdb.v1.QueryNewTestVariantsResponse
	47, // 59: luci.resultdb.v1.ResultDB.GetArtifact:output_type -> luci.resultdb.v1.Artifact
	15, // 60: luci.resultdb.v1.ResultDB.ListArtifacts:output_type -> luci.resultdb.v1.ListArtifactsResponse
	17, // 61: luci.resultdb.v1.ResultDB.QueryArtifacts:output_type -> luci.resultdb.v1.QueryArtifactsResponse
	25, // 62: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:output_type -> luci.resultdb.v1.QueryRunTestVerdictsResponse
	19, // 63: luci.resultdb.v1.ResultDB.ListArtifactLines:output_type -> luci.resultdb.v1.ListArtifactLinesResponse
	21, // 64: luci.resultdb.v1.ResultDB.QueryArtifactFailureOnlyLines:output_type -> luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse
	23, // 65: luci.resultdb.v1.ResultDB.QueryTestVariants:output_type -> luci.resultdb.v1.QueryTestVariantsResponse
	27, // 66: luci.resultdb.v1.ResultDB.BatchGetTestVariants:output_type -> luci.resultdb.v1.BatchGetTestVariantsResponse
	29, // 67: luci.resultdb.v1.ResultDB.QueryTestMetadata:output_type -> luci.resultdb.v1.QueryTestMetadataResponse
	55, // 68: luci.resultdb.v1.ResultDB.GetInstruction:output_type -> luci.resultdb.v1.Instruction
	34, // 69: luci.resultdb.v1.ResultDB.QueryInstruction:output_type -> luci.resultdb.v1.QueryInstructionResponse
