...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_rawDesc = string([]byte{
	...
	0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x22, 0xb5, 0x02,
	...
	0x64, 0x65, 0x72, 0x42, 0x79, 0x22, 0xb2, 0x02, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54,
	...
	0x73, 0x12, 0x26, 0x0a, 0x0f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x65, 0x78, 0x74,
	0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x88, 0x19, 0x0a, 0x08, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x44, 0x42, 0x12, 0x57, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76,
	...
	0x73, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x4c, 0x69, 0x6e, 0x65, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x92, 0x01, 0x0a, 0x1d, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x46, 0x61, 0x69, 0x6c, 0x75,
	0x72, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x4c, 0x69, 0x6e, 0x65, 0x73, 0x12, 0x36, 0x2e, 0x6c, 0x75,
	0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x51,
	...
	0x65, 0x73, 0x74, 0x1a, 0x37, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c,
...
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_goTypes = []any{
	...
	(*Invocation)(nil),                                              // 87: luci.resultdb.v1.Invocation
}
var file_go_chromium_org_luci_resultdb_proto_v1_resultdb_proto_depIdxs = []int32{
	...
	79, // 49: luci.resultdb.v1.ArtifactMatchingContent.test_status_v2:type_name -> luci.resultdb.v1.TestResult.Status
	61, // 50: luci.resultdb.v1.ArtifactMatchingContent.matches:type_name -> luci.resultdb.v1.ArtifactMatchingContent.Match
	80, // 51: luci.resultdb.v1.QueryTestAggregationsRequest.aggregation_level:type_name -> luci.resultdb.v1.AggregationLevel
	81, // 52: luci.resultdb.v1.QueryTestAggregationsRequest.test_prefix_filter:type_name -> luci.resultdb.v1.TestIdentifierPrefix
	82, // 53: luci.resultdb.v1.QueryTestAggregationsResponse.aggregations:type_name -> luci.resultdb.v1.TestAggregation
	81, // 54: luci.resultdb.v1.QueryTestVerdictsRequest.test_prefix_filter:type_name -> luci.resultdb.v1.TestIdentifierPrefix
	83, // 55: luci.resultdb.v1.QueryTestVerdictsResponse.test_verdicts:type_name -> luci.resultdb.v1.TestVerdict
	84, // 56: luci.resultdb.v1.QueryTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	85, // 57: luci.resultdb.v1.BatchGetTestVariantsRequest.TestVariantIdentifier.test_id_structured:type_name -> luci.resultdb.v1.TestIdentifier
	84, // 58: luci.resultdb.v1.BatchGetTestVariantsResponse.SourcesEntry.value:type_name -> luci.resultdb.v1.Sources
	86, // 59: luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse.MatchGroup.variant:type_name -> luci.resultdb.v1.Variant
	46, // 60: luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse.MatchGroup.artifacts:type_name -> luci.resultdb.v1.ArtifactMatchingContent
	86, // 61: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse.MatchGroup.variant_union:type_name -> luci.resultdb.v1.Variant
	46, // 62: luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse.MatchGroup.artifacts:type_name -> luci.resultdb.v1.ArtifactMatchingContent
	0,  // 63: luci.resultdb.v1.ResultDB.GetInvocation:input_type -> luci.resultdb.v1.GetInvocationRequest
	1,  // 64: luci.resultdb.v1.ResultDB.QueryRootInvocationNames:input_type -> luci.resultdb.v1.QueryRootInvocationNamesRequest
	3,  // 65: luci.resultdb.v1.ResultDB.GetTestResult:input_type -> luci.resultdb.v1.GetTestResultRequest
	4,  // 66: luci.resultdb.v1.ResultDB.ListTestResults:input_type -> luci.resultdb.v1.ListTestResultsRequest
	6,  // 67: luci.resultdb.v1.ResultDB.GetTestExoneration:input_type -> luci.resultdb.v1.GetTestExonerationRequest
	7,  // 68: luci.resultdb.v1.ResultDB.ListTestExonerations:input_type -> luci.resultdb.v1.ListTestExonerationsRequest
	9,  // 69: luci.resultdb.v1.ResultDB.QueryTestResults:input_type -> luci.resultdb.v1.QueryTestResultsRequest
	11, // 70: luci.resultdb.v1.ResultDB.QueryTestExonerations:input_type -> luci.resultdb.v1.QueryTestExonerationsRequest
	13, // 71: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:input_type -> luci.resultdb.v1.QueryTestResultStatisticsRequest
	32, // 72: luci.resultdb.v1.ResultDB.QueryNewTestVariants:input_type -> luci.resultdb.v1.QueryNewTestVariantsRequest
	26, // 73: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:input_type -> luci.resultdb.v1.QueryRunTestVerdictsRequest
	24, // 74: luci.resultdb.v1.ResultDB.QueryTestVariants:input_type -> luci.resultdb.v1.QueryTestVariantsRequest
	28, // 75: luci.resultdb.v1.ResultDB.BatchGetTestVariants:input_type -> luci.resultdb.v1.BatchGetTestVariantsRequest
	30, // 76: luci.resultdb.v1.ResultDB.QueryTestMetadata:input_type -> luci.resultdb.v1.QueryTestMetadataRequest
	34, // 77: luci.resultdb.v1.ResultDB.GetInstruction:input_type -> luci.resultdb.v1.GetInstructionRequest
	35, // 78: luci.resultdb.v1.ResultDB.QueryInstruction:input_type -> luci.resultdb.v1.QueryInstructionRequest
	49, // 79: luci.resultdb.v1.ResultDB.QueryTestAggregations:input_type -> luci.resultdb.v1.QueryTestAggregationsRequest
	51, // 80: luci.resultdb.v1.ResultDB.QueryTestVerdicts:input_type -> luci.resultdb.v1.QueryTestVerdictsRequest
	15, // 81: luci.resultdb.v1.ResultDB.GetArtifact:input_type -> luci.resultdb.v1.GetArtifactRequest
	16, // 82: luci.resultdb.v1.ResultDB.ListArtifacts:input_type -> luci.resultdb.v1.ListArtifactsRequest
	18, // 83: luci.resultdb.v1.ResultDB.QueryArtifacts:input_type -> luci.resultdb.v1.QueryArtifactsRequest
	20, // 84: luci.resultdb.v1.ResultDB.ListArtifactLines:input_type -> luci.resultdb.v1.ListArtifactLinesRequest
	22, // 85: luci.resultdb.v1.ResultDB.QueryArtifactFailureOnlyLines:input_type -> luci.resultdb.v1.QueryArtifactFailureOnlyLinesRequest
	38, // 86: luci.resultdb.v1.ResultDB.QueryTestVariantArtifactGroups:input_type -> luci.resultdb.v1.QueryTestVariantArtifactGroupsRequest
	40, // 87: luci.resultdb.v1.ResultDB.QueryTestVariantArtifacts:input_type -> luci.resultdb.v1.QueryTestVariantArtifactsRequest
	42, // 88: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifactGroups:input_type -> luci.resultdb.v1.QueryInvocationVariantArtifactGroupsRequest
	44, // 89: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifacts:input_type -> luci.resultdb.v1.QueryInvocationVariantArtifactsRequest
	87, // 90: luci.resultdb.v1.ResultDB.GetInvocation:output_type -> luci.resultdb.v1.Invocation
	2,  // 91: luci.resultdb.v1.ResultDB.QueryRootInvocationNames:output_type -> luci.resultdb.v1.QueryRootInvocationNamesResponse
	63, // 92: luci.resultdb.v1.ResultDB.GetTestResult:output_type -> luci.resultdb.v1.TestResult
	5,  // 93: luci.resultdb.v1.ResultDB.ListTestResults:output_type -> luci.resultdb.v1.ListTestResultsResponse
	64, // 94: luci.resultdb.v1.ResultDB.GetTestExoneration:output_type -> luci.resultdb.v1.TestExoneration
	8,  // 95: luci.resultdb.v1.ResultDB.ListTestExonerations:output_type -> luci.resultdb.v1.ListTestExonerationsResponse
	10, // 96: luci.resultdb.v1.ResultDB.QueryTestResults:output_type -> luci.resultdb.v1.QueryTestResultsResponse
	12, // 97: luci.resultdb.v1.ResultDB.QueryTestExonerations:output_type -> luci.resultdb.v1.QueryTestExonerationsResponse
	14, // 98: luci.resultdb.v1.ResultDB.QueryTestResultStatistics:output_type -> luci.resultdb.v1.QueryTestResultStatisticsResponse
	33, // 99: luci.resultdb.v1.ResultDB.QueryNewTestVariants:output_type -> luci.resultdb.v1.QueryNewTestVariantsResponse
	27, // 100: luci.resultdb.v1.ResultDB.QueryRunTestVerdicts:output_type -> luci.resultdb.v1.QueryRunTestVerdictsResponse
	25, // 101: luci.resultdb.v1.ResultDB.QueryTestVariants:output_type -> luci.resultdb.v1.QueryTestVariantsResponse
	29, // 102: luci.resultdb.v1.ResultDB.BatchGetTestVariants:output_type -> luci.resultdb.v1.BatchGetTestVariantsResponse
	31, // 103: luci.resultdb.v1.ResultDB.QueryTestMetadata:output_type -> luci.resultdb.v1.QueryTestMetadataResponse
	75, // 104: luci.resultdb.v1.ResultDB.GetInstruction:output_type -> luci.resultdb.v1.Instruction
	36, // 105: luci.resultdb.v1.ResultDB.QueryInstruction:output_type -> luci.resultdb.v1.QueryInstructionResponse
	50, // 106: luci.resultdb.v1.ResultDB.QueryTestAggregations:output_type -> luci.resultdb.v1.QueryTestAggregationsResponse
	52, // 107: luci.resultdb.v1.ResultDB.QueryTestVerdicts:output_type -> luci.resultdb.v1.QueryTestVerdictsResponse
	67, // 108: luci.resultdb.v1.ResultDB.GetArtifact:output_type -> luci.resultdb.v1.Artifact
	17, // 109: luci.resultdb.v1.ResultDB.ListArtifacts:output_type -> luci.resultdb.v1.ListArtifactsResponse
	19, // 110: luci.resultdb.v1.ResultDB.QueryArtifacts:output_type -> luci.resultdb.v1.QueryArtifactsResponse
	21, // 111: luci.resultdb.v1.ResultDB.ListArtifactLines:output_type -> luci.resultdb.v1.ListArtifactLinesResponse
	23, // 112: luci.resultdb.v1.ResultDB.QueryArtifactFailureOnlyLines:output_type -> luci.resultdb.v1.QueryArtifactFailureOnlyLinesResponse
	39, // 113: luci.resultdb.v1.ResultDB.QueryTestVariantArtifactGroups:output_type -> luci.resultdb.v1.QueryTestVariantArtifactGroupsResponse
	41, // 114: luci.resultdb.v1.ResultDB.QueryTestVariantArtifacts:output_type -> luci.resultdb.v1.QueryTestVariantArtifactsResponse
	43, // 115: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifactGroups:output_type -> luci.resultdb.v1.QueryInvocationVariantArtifactGroupsResponse
	45, // 116: luci.resultdb.v1.ResultDB.QueryInvocationVariantArtifacts:output_type -> luci.resultdb.v1.QueryInvocationVariantArtifactsResponse
