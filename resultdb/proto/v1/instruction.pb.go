...
var file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_rawDesc = []byte{
	...
	0x54, 0x49, 0x4f, 0x4e, 0x10, 0x02, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72,
...
func file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_msgTypes[5].Exporter = func(v any, i int) any {
