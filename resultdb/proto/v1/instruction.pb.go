...
const file_go_chromium_org_luci_resultdb_proto_v1_instruction_proto_rawDesc = "" +
	"\n" +
	"8go.chromium.org/luci/resultdb/proto/v1/instruction.proto\x12\x10luci.resultdb.v1\"Q\n" +
	"\fInstructions\x12A\n" +
	"\finstructions\x18\x01 \x03(\v2\x1d.luci.resultdb.v1.InstructionR\finstructions\"\xc3\x02\n" +
	"\vInstruction\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x125\n" +
	"\x04type\x18\x02 \x01(\x0e2!.luci.resultdb.v1.InstructionTypeR\x04type\x12Z\n" +
	"\x15targeted_instructions\x18\x03 \x03(\v2%.luci.resultdb.v1.TargetedInstructionR\x14targetedInstructions\x12R\n" +
	"\x12instruction_filter\x18\x04 \x01(\v2#.luci.resultdb.v1.InstructionFilterR\x11instructionFilter\x12\x12\n" +
	"\x04name\x18\x05 \x01(\tR\x04name\x12)\n" +
	"\x10descriptive_name\x18\x06 \x01(\tR\x0fdescriptiveName\"~\n" +
	"\x11InstructionFilter\x12Z\n" +
	"\x0einvocation_ids\x18\x01 \x01(\v21.luci.resultdb.v1.InstructionFilterByInvocationIDH\x00R\rinvocationIdsB\r\n" +
	"\vfilter_type\"f\n" +
	"\x1fInstructionFilterByInvocationID\x12%\n" +
	"\x0einvocation_ids\x18\x01 \x03(\tR\rinvocationIds\x12\x1c\n" +
	"\trecursive\x18\x02 \x01(\bR\trecursive\"\xbb\x01\n" +
	"\x13TargetedInstruction\x12=\n" +
	"\atargets\x18\x01 \x03(\x0e2#.luci.resultdb.v1.InstructionTargetR\atargets\x12K\n" +
	"\fdependencies\x18\x02 \x03(\v2'.luci.resultdb.v1.InstructionDependencyR\fdependencies\x12\x18\n" +
	"\acontent\x18\x03 \x01(\tR\acontent\"c\n" +
	"\x15InstructionDependency\x12#\n" +
	...
	"\x17TEST_RESULT_INSTRUCTION\x10\x02BP\n" +
