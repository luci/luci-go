...
const file_go_chromium_org_luci_resultdb_proto_v1_common_proto_rawDesc = "" +
	"\n" +
	"3go.chromium.org/luci/resultdb/proto/v1/common.proto\x12\x10luci.resultdb.v1\"w\n" +
	"\aVariant\x124\n" +
	"\x03def\x18\x01 \x03(\v2\".luci.resultdb.v1.Variant.DefEntryR\x03def\x1a6\n" +
	"\bDefEntry\x12\x10\n" +
	...
	"\x0emodule_variant\x18\x03 \x01(\v2\x19.luci.resultdb.v1.VariantR\rmoduleVariant\x12.\n" +
	...
	"\tcase_name\x18\a \x01(\tR\bcaseName\"\x82\x01\n" +
	"\x14TestIdentifierPrefix\x128\n" +
	"\x05level\x18\x01 \x01(\x0e2\".luci.resultdb.v1.AggregationLevelR\x05level\x120\n" +
	"\x02id\x18\x02 \x01(\v2 .luci.resultdb.v1.TestIdentifierR\x02id\"\xca\x01\n" +
	"\x10ModuleIdentifier\x12\x1f\n" +
	"\vmodule_name\x18\x01 \x01(\tR\n" +
	"moduleName\x12#\n" +
	"\rmodule_scheme\x18\x02 \x01(\tR\fmoduleScheme\x12@\n" +
	"\x0emodule_variant\x18\x03 \x01(\v2\x19.luci.resultdb.v1.VariantR\rmoduleVariant\x12.\n" +
	"\x13module_variant_hash\x18\x04 \x01(\tR\x11moduleVariantHash\"\x8c\x01\n" +
	...
	"commitHash\x12\x1a\n" +
	"\bposition\x18\x05 \x01(\x03R\bposition\"p\n" +
	"\fGerritChange\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x18\n" +
	"\aproject\x18\x02 \x01(\tR\aproject\x12\x16\n" +
	"\x06change\x18\x03 \x01(\x03R\x06change\x12\x1a\n" +
	"\bpatchset\x18\x04 \x01(\x03R\bpatchset\"\xae\x01\n" +
	"\aSources\x12F\n" +
	"\x0egitiles_commit\x18\x01 \x01(\v2\x1f.luci.resultdb.v1.GitilesCommitR\rgitilesCommit\x12@\n" +
	"\vchangelists\x18\x02 \x03(\v2\x1e.luci.resultdb.v1.GerritChangeR\vchangelists\x12\x19\n" +
	"\bis_dirty\x18\x03 \x01(\bR\aisDirty\"l\n" +
	"\x0eCommitPosition\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x18\n" +
	"\aproject\x18\x02 \x01(\tR\aproject\x12\x10\n" +
	"\x03ref\x18\x03 \x01(\tR\x03ref\x12\x1a\n" +
	"\bposition\x18\x04 \x01(\x03R\bposition\"O\n" +
	"\tSourceRef\x128\n" +
	"\agitiles\x18\x01 \x01(\v2\x1c.luci.resultdb.v1.GitilesRefH\x00R\agitilesB\b\n" +
	"\x06system\"L\n" +
	"\n" +
	"GitilesRef\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x18\n" +
	"\aproject\x18\x02 \x01(\tR\aproject\x12\x10\n" +
	"\x03ref\x18\x03 \x01(\tR\x03ref*q\n" +
	...
	"\n" +
	"\x06COARSE\x10\x03\x12\b\n" +
	"\x04FINE\x10\x04\x12\b\n" +
	"\x04CASE\x10\x05*a\n" +
	"\fWorkUnitView\x12\x1e\n" +
	"\x1aWORK_UNIT_VIEW_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14WORK_UNIT_VIEW_BASIC\x10\x01\x12\x17\n" +
	"\x13WORK_UNIT_VIEW_FULL\x10\x02BP\n" +
