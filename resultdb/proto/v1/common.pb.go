...
type RootInvocationDefinition struct {
	...
	// 'run_target' for ATP.
	//
	// In the Recorder APIs, this field is required (although the contained `def`
	// may be left empty).
	Properties *RootInvocationDefinition_Properties `protobuf:"bytes,3,opt,name=properties,proto3" json:"properties,omitempty"`
	...
	// In the context of ResultDB Query RPCs accepting this type as a request filter,
	// this field may be specified as an alternative to setting properties.
...
func (x *RootInvocationDefinition) GetProperties() *RootInvocationDefinition_Properties {
	if x != nil {
		return x.Properties
	}
	return nil
...
type BuildDescriptor struct {
	...
	// The URL at which the build can be viewed.
	//
	// In case of AndroidBuildDescriptor, generated from data_realm, branch, build_target and build_id
	// fields using configuration in the ResultDB service configuration.
	// This field may be blank for builds that do not have a UI that allow viewing.
	//
	// Output only.
...
func (x *BuildDescriptor) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *AndroidBuildDescriptor) Reset() {
	*x = AndroidBuildDescriptor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AndroidBuildDescriptor) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_common_proto_rawDescGZIP(), []int{16}
}
...
// ProducerResource represents the identity of the resource that produced a
// root invocation or work unit, e.g. an ATP test run or swarming task.
//
// This structure is a deviation from https://google.aip.dev/122#full-resource-names
// owing to:
//   - the desire to capture the deployment of a system we are talking about (both
//     test and production deployments could talk to the same instance of ResultDB)
//   - the lack of good API service names for many services (https://google.aip.dev/9#api-service-name)
//     which was leading to API endpoints being substited contrary to AIP-122.
//     While endpoints makes it possible to distinguish dev and prod, it makes it
...
type ProducerResource struct {
	...
	// The name of the system that is producing the resource.
	//
	// For LUCI, this should be "buildbucket" or "swarming".
	// For Android, it is the scheduler like "atp", "ants-relay", "atest" or "bazel".
	//
	...
	//
	// Total length limited to 100 bytes. Required.
	DataRealm string `protobuf:"bytes,2,opt,name=data_realm,json=dataRealm,proto3" json:"data_realm,omitempty"`
	// The AIP-122 resource name of the producer resource.
	//
	// See: https://google.aip.dev/122
	//
	// The format is typically defined by the producing system. If the producing
...
func (x *ProducerResource) Reset() {
	*x = ProducerResource{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ProducerResource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProducerResource) ProtoMessage() {}

func (x *ProducerResource) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProducerResource.ProtoReflect.Descriptor instead.
func (*ProducerResource) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_common_proto_rawDescGZIP(), []int{17}
}

func (x *ProducerResource) GetSystem() string {
	if x != nil {
		return x.System
	}
	return ""
...
func (x *ProducerResource) GetDataRealm() string {
	if x != nil {
		return x.DataRealm
	}
	return ""
...
func (x *ProducerResource) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ProducerResource) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
// Represents a key-value map of properties that differentiate
// definitions with the same name and system.
type RootInvocationDefinition_Properties struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The key-value pairs. May be left empty.
	//
	// Keys must satisfy regex: ^[a-z][a-z0-9_]*(/[a-z][a-z0-9_]*)*$ and have a max length of 64 bytes.
	// Values must be valid UTF-8, in Unicode Normalization Form C, printable characters only, and have a
...
func (x *RootInvocationDefinition_Properties) Reset() {
	*x = RootInvocationDefinition_Properties{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RootInvocationDefinition_Properties) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RootInvocationDefinition_Properties) ProtoMessage() {}

func (x *RootInvocationDefinition_Properties) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RootInvocationDefinition_Properties.ProtoReflect.Descriptor instead.
func (*RootInvocationDefinition_Properties) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_common_proto_rawDescGZIP(), []int{14, 0}
}

func (x *RootInvocationDefinition_Properties) GetDef() map[string]string {
	if x != nil {
		return x.Def
	}
	return nil
...
var file_go_chromium_org_luci_resultdb_proto_v1_common_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x77, 0x0a, 0x07, 0x56, 0x61, 0x72, 0x69,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xa3, 0x02, 0x0a, 0x0e, 0x54, 0x65, 0x73, 0x74,
	0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x6d,
	0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0c, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x65,
	0x12, 0x40, 0x0a, 0x0e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x76, 0x61, 0x72, 0x69, 0x61,
	...
	,
	...
	0x52, 0x0d, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x12,
	0x2e, 0x0a, 0x13, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e,
	0x74, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x48, 0x61, 0x73, 0x68, 0x22,
	0x5f, 0x0a, 0x12, 0x46, 0x6c, 0x61, 0x74, 0x54, 0x65, 0x73, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74,
	...
	0x68, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x52, 0x07, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74,
	0x22, 0x8c, 0x01, 0x0a, 0x0d, 0x47, 0x69, 0x74, 0x69, 0x6c, 0x65, 0x73, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x65, 0x66, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x68, 0x61, 0x73,
	...
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22,
	0x70, 0x0a, 0x0c, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12,
	...
	,
	...
	0x74, 0x79, 0x42, 0x0e, 0x0a, 0x0c, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x73, 0x22, 0x6c, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x50, 0x6f, 0x73, 0x69,
	...
	0x63, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x22, 0x9c, 0x01, 0x0a, 0x09, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x66, 0x12, 0x38,
	...
	,
	...
	0x65, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x72, 0x65, 0x66, 0x22, 0x4b, 0x0a,
	...
	0x28, 0x09, 0x52, 0x06, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x22, 0xdf, 0x02, 0x0a, 0x18, 0x52,
	0x6f, 0x6f, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x66,
	0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65,
	...
	,
	...
	0x6e, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x50, 0x72, 0x6f, 0x70,
	0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x2e, 0x44, 0x65, 0x66, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	...
	,
	...
	,
	...
	,
...
var file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_go_chromium_org_luci_resultdb_proto_v1_common_proto_goTypes = []interface{}{
	...
	(*FlatTestIdentifier)(nil),                  // 8: luci.resultdb.v1.FlatTestIdentifier
	(*GitilesCommit)(nil),                       // 9: luci.resultdb.v1.GitilesCommit
	(*GerritChange)(nil),                        // 10: luci.resultdb.v1.GerritChange
	(*SubmittedAndroidBuild)(nil),               // 11: luci.resultdb.v1.SubmittedAndroidBuild
	(*Sources)(nil),                             // 12: luci.resultdb.v1.Sources
	(*CommitPosition)(nil),                      // 13: luci.resultdb.v1.CommitPosition
	(*SourceRef)(nil),                           // 14: luci.resultdb.v1.SourceRef
	(*GitilesRef)(nil),                          // 15: luci.resultdb.v1.GitilesRef
	(*AndroidBuildBranch)(nil),                  // 16: luci.resultdb.v1.AndroidBuildBranch
	(*RootInvocationDefinition)(nil),            // 17: luci.resultdb.v1.RootInvocationDefinition
	(*BuildDescriptor)(nil),                     // 18: luci.resultdb.v1.BuildDescriptor
	(*AndroidBuildDescriptor)(nil),              // 19: luci.resultdb.v1.AndroidBuildDescriptor
	(*ProducerResource)(nil),                    // 20: luci.resultdb.v1.ProducerResource
	nil,                                         // 21: luci.resultdb.v1.Variant.DefEntry
	(*RootInvocationDefinition_Properties)(nil), // 22: luci.resultdb.v1.RootInvocationDefinition.Properties
	nil, // 23: luci.resultdb.v1.RootInvocationDefinition.Properties.DefEntry
}
var file_go_chromium_org_luci_resultdb_proto_v1_common_proto_depIdxs = []int32{
	21, // 0: luci.resultdb.v1.Variant.def:type_name -> luci.resultdb.v1.Variant.DefEntry
	...
	9,  // 5: luci.resultdb.v1.Sources.gitiles_commit:type_name -> luci.resultdb.v1.GitilesCommit
	11, // 6: luci.resultdb.v1.Sources.submitted_android_build:type_name -> luci.resultdb.v1.SubmittedAndroidBuild
	10, // 7: luci.resultdb.v1.Sources.changelists:type_name -> luci.resultdb.v1.GerritChange
	15, // 8: luci.resultdb.v1.SourceRef.gitiles:type_name -> luci.resultdb.v1.GitilesRef
	16, // 9: luci.resultdb.v1.SourceRef.android_build:type_name -> luci.resultdb.v1.AndroidBuildBranch
	22, // 10: luci.resultdb.v1.RootInvocationDefinition.properties:type_name -> luci.resultdb.v1.RootInvocationDefinition.Properties
	19, // 11: luci.resultdb.v1.BuildDescriptor.android_build:type_name -> luci.resultdb.v1.AndroidBuildDescriptor
	23, // 12: luci.resultdb.v1.RootInvocationDefinition.Properties.def:type_name -> luci.resultdb.v1.RootInvocationDefinition.Properties.DefEntry
...
func file_go_chromium_org_luci_resultdb_proto_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FlatTestIdentifier); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProducerResource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RootInvocationDefinition_Properties); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*Sources_GitilesCommit)(nil),
		(*Sources_SubmittedAndroidBuild)(nil),
	}
	file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*SourceRef_Gitiles)(nil),
		(*SourceRef_AndroidBuild)(nil),
	}
	file_go_chromium_org_luci_resultdb_proto_v1_common_proto_msgTypes[15].OneofWrappers = []interface{}{
