...
const file_go_chromium_org_luci_resultdb_proto_v1_schema_proto_rawDesc = "" +
	"\n" +
	"3go.chromium.org/luci/resultdb/proto/v1/schema.proto\x12\x10luci.resultdb.v1\"&\n" +
	"\x10GetSchemaRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\xb3\x01\n" +
	"\x06Schema\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12?\n" +
	"\aschemes\x18\x02 \x03(\v2%.luci.resultdb.v1.Schema.SchemesEntryR\aschemes\x1aT\n" +
	"\fSchemesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12.\n" +
	"\x05value\x18\x02 \x01(\v2\x18.luci.resultdb.v1.SchemeR\x05value:\x028\x01\"&\n" +
	"\x10GetSchemeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\xe2\x02\n" +
	"\x06Scheme\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12.\n" +
	"\x13human_readable_name\x18\x03 \x01(\tR\x11humanReadableName\x126\n" +
	"\x06coarse\x18\x04 \x01(\v2\x1e.luci.resultdb.v1.Scheme.LevelR\x06coarse\x122\n" +
	"\x04fine\x18\x05 \x01(\v2\x1e.luci.resultdb.v1.Scheme.LevelR\x04fine\x122\n" +
	"\x04case\x18\x06 \x01(\v2\x1e.luci.resultdb.v1.Scheme.LevelR\x04case\x1ad\n" +
	"\x05Level\x12.\n" +
	"\x13human_readable_name\x18\x01 \x01(\tR\x11humanReadableName\x12+\n" +
	"\x11validation_regexp\x18\x02 \x01(\tR\x10validationRegexp2\x9d\x01\n" +
	"\aSchemas\x12E\n" +
	"\x03Get\x12\".luci.resultdb.v1.GetSchemaRequest\x1a\x18.luci.resultdb.v1.Schema\"\x00\x12K\n" +
	"\tGetScheme\x12\".luci.resultdb.v1.GetSchemeRequest\x1a\x18.luci.resultdb.v1.Scheme\"\x00BP\n" +
