...
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_rawDesc = []byte{
	...
	0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x22, 0xa3,
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x75, 0x67, 0x43, 0x6f, 0x6d,
	...
	0x62, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x73, 0x73, 0x75, 0x65, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x65,
	...
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e, 0x63,
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_goTypes = []interface{}{
	(*TestMetadata)(nil),          // 0: luci.resultdb.v1.TestMetadata
	(*TestLocation)(nil),          // 1: luci.resultdb.v1.TestLocation
	(*BugComponent)(nil),          // 2: luci.resultdb.v1.BugComponent
	(*IssueTrackerComponent)(nil), // 3: luci.resultdb.v1.IssueTrackerComponent
	(*MonorailComponent)(nil),     // 4: luci.resultdb.v1.MonorailComponent
}
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_depIdxs = []int32{
	1, // 0: luci.resultdb.v1.TestMetadata.location:type_name -> luci.resultdb.v1.TestLocation
	2, // 1: luci.resultdb.v1.TestMetadata.bug_component:type_name -> luci.resultdb.v1.BugComponent
	3, // 2: luci.resultdb.v1.BugComponent.issue_tracker:type_name -> luci.resultdb.v1.IssueTrackerComponent
	4, // 3: luci.resultdb.v1.BugComponent.monorail:type_name -> luci.resultdb.v1.MonorailComponent
...
func file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_init() {
	...
	file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_msgTypes[2].OneofWrappers = []interface{}{
