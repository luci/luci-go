...
const file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_rawDesc = "" +
	"\n" +
	":go.chromium.org/luci/resultdb/proto/v1/test_metadata.proto\x12\x10luci.resultdb.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a3go.chromium.org/luci/resultdb/proto/v1/common.proto\"\xfb\x01\n" +
	"\x12TestMetadataDetail\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12\x18\n" +
	"\aproject\x18\x02 \x01(\tR\aproject\x12\x17\n" +
	"\atest_id\x18\x03 \x01(\tR\x06testId\x12\x19\n" +
	"\bref_hash\x18\f \x01(\tR\arefHash\x12:\n" +
	"\n" +
	"source_ref\x18\x04 \x01(\v2\x1b.luci.resultdb.v1.SourceRefR\tsourceRef\x12B\n" +
	"\ftestMetadata\x18\x05 \x01(\v2\x1e.luci.resultdb.v1.TestMetadataR\ftestMetadata\"\xb7\x02\n" +
	...
	"\x11properties_schema\x18\x04 \x01(\tB\x02\x18\x01R\x10propertiesSchema\x127\n" +
	"\n" +
	"properties\x18\x05 \x01(\v2\x17.google.protobuf.StructR\n" +
	"properties\x12(\n" +
	"\x10previous_test_id\x18\x06 \x01(\tR\x0epreviousTestId\"S\n" +
	"\fTestLocation\x12\x12\n" +
	"\x04repo\x18\x01 \x01(\tR\x04repo\x12\x1b\n" +
	"\tfile_name\x18\x02 \x01(\tR\bfileName\x12\x12\n" +
	"\x04line\x18\x03 \x01(\x05R\x04line\"\xab\x01\n" +
	"\fBugComponent\x12N\n" +
	"\rissue_tracker\x18\x01 \x01(\v2'.luci.resultdb.v1.IssueTrackerComponentH\x00R\fissueTracker\x12A\n" +
	"\bmonorail\x18\x02 \x01(\v2#.luci.resultdb.v1.MonorailComponentH\x00R\bmonorailB\b\n" +
	"\x06system\":\n" +
