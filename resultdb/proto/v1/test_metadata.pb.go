...
type TestMetadata struct {
	...
	// Tags for the test. For example:
	// * monorail_component of the test;
	// * team_email of the team who's responsible to the test;
	// * os that the test code is specific to.
...
func (x *TestMetadata) GetTags() map[string]string {
	if x != nil {
		return x.Tags
	}
	return nil
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_rawDesc = []byte{
	...
	0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x22, 0xd5,
	...
	0x3c, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e,
	0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31,
	0x2e, 0x54, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x54, 0x61,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x53, 0x0a, 0x0c, 0x54, 0x65, 0x73, 0x74, 0x4c, 0x6f,
	...
	0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x6c, 0x69, 0x6e, 0x65, 0x42, 0x31, 0x5a, 0x2f, 0x67,
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_goTypes = []interface{}{
	...
	nil,                  // 2: luci.resultdb.v1.TestMetadata.TagsEntry
}
var file_go_chromium_org_luci_resultdb_proto_v1_test_metadata_proto_depIdxs = []int32{
	...
	2, // 1: luci.resultdb.v1.TestMetadata.tags:type_name -> luci.resultdb.v1.TestMetadata.TagsEntry
