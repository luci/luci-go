...
const file_go_chromium_org_luci_resultdb_proto_v1_predicate_proto_rawDesc = "" +
	"\n" +
	"6go.chromium.org/luci/resultdb/proto/v1/predicate.proto\x12\x10luci.resultdb.v1\x1a3go.chromium.org/luci/resultdb/proto/v1/common.proto\"\xe2\x02\n" +
	"\x13TestResultPredicate\x12$\n" +
	"\x0etest_id_regexp\x18\x01 \x01(\tR\ftestIdRegexp\x12<\n" +
	"\avariant\x18\x02 \x01(\v2\".luci.resultdb.v1.VariantPredicateR\avariant\x12P\n" +
	"\n" +
	"expectancy\x18\x03 \x01(\x0e20.luci.resultdb.v1.TestResultPredicate.ExpectancyR\n" +
	"expectancy\x12-\n" +
	"\x12exclude_exonerated\x18\x04 \x01(\bR\x11excludeExonerated\"f\n" +
	"\n" +
	"Expectancy\x12\a\n" +
	"\x03ALL\x10\x00\x12$\n" +
	" VARIANTS_WITH_UNEXPECTED_RESULTS\x10\x01\x12)\n" +
	"%VARIANTS_WITH_ONLY_UNEXPECTED_RESULTS\x10\x02\"~\n" +
	"\x18TestExonerationPredicate\x12$\n" +
	"\x0etest_id_regexp\x18\x01 \x01(\tR\ftestIdRegexp\x12<\n" +
	"\avariant\x18\x02 \x01(\v2\".luci.resultdb.v1.VariantPredicateR\avariant\"\x8d\x01\n" +
	"\x10VariantPredicate\x123\n" +
	"\x06equals\x18\x01 \x01(\v2\x19.luci.resultdb.v1.VariantH\x00R\x06equals\x127\n" +
	"\bcontains\x18\x02 \x01(\v2\x19.luci.resultdb.v1.VariantH\x00R\bcontainsB\v\n" +
	"\tpredicate\"\x85\x03\n" +
	"\x11ArtifactPredicate\x12R\n" +
	"\ffollow_edges\x18\x01 \x01(\v2/.luci.resultdb.v1.ArtifactPredicate.EdgeTypeSetR\vfollowEdges\x12Y\n" +
	"\x15test_result_predicate\x18\x02 \x01(\v2%.luci.resultdb.v1.TestResultPredicateR\x13testResultPredicate\x12.\n" +
	"\x13content_type_regexp\x18\x03 \x01(\tR\x11contentTypeRegexp\x12,\n" +
