...
type TestResult struct {
	...
	// Specifies how to present the test result in UI.
	Presentation *TestResultPresentation `protobuf:"bytes,13,opt,name=presentation,proto3" json:"presentation,omitempty"`
}
...
func (x *TestResult) GetPresentation() *TestResultPresentation {
	if x != nil {
...
// Describes how to present a test result in UI.
type TestResultPresentation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// An ordered list of categories that the test belongs to (not test result).
	// The elements form a hierarchy: test_category[i+1] is a sub-category of
	// test_category[i].
	//
	// Based on categories of different tests, UI builds as a tree of
	// categories and displays tests categories. For example, if tests report
	// categories ["a", "b"], ["a", "b", "c"] and ["x"], then the formed hierarchy
	// is
	// <root>
	//   a
	//     b
	...
	//   x
	//
	// Results of the same test SHOULD specify the same category, otherwise
	// UI might be make little sense.
	TestCategory []string `protobuf:"bytes,1,rep,name=test_category,json=testCategory,proto3" json:"test_category,omitempty"`
}

func (x *TestResultPresentation) Reset() {
	*x = TestResultPresentation{}
	if protoimpl.UnsafeEnabled {
...
func (x *TestResultPresentation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestResultPresentation) ProtoMessage() {}

func (x *TestResultPresentation) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TestResultPresentation.ProtoReflect.Descriptor instead.
func (*TestResultPresentation) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_rawDescGZIP(), []int{3}
}

func (x *TestResultPresentation) GetTestCategory() []string {
	if x != nil {
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x97, 0x05, 0x0a, 0x0a, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x75,
	...
	0x4c, 0x0a, 0x0c, 0x70, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x64, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x50, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x0c, 0x70, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x45, 0x0a,
	0x0c, 0x54, 0x65, 0x73, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a,
	...
	0x6e, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x6c, 0x69, 0x6e, 0x65, 0x4a, 0x04,
	0x08, 0x01, 0x10, 0x02, 0x22, 0x82, 0x02, 0x0a, 0x0f, 0x54, 0x65, 0x73, 0x74, 0x45, 0x78, 0x6f,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x33, 0x0a,
	...
	,
	...
	0x10, 0x02, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x52, 0x41, 0x53, 0x48, 0x10, 0x03, 0x12, 0x09, 0x0a,
	0x05, 0x41, 0x42, 0x4f, 0x52, 0x54, 0x10, 0x04, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x4b, 0x49, 0x50,
	0x10, 0x05, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75,
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_goTypes = []interface{}{
	...
	(*TestResultPresentation)(nil), // 4: luci.resultdb.v1.TestResultPresentation
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_depIdxs = []int32{
	...
	4, // 6: luci.resultdb.v1.TestResult.presentation:type_name -> luci.resultdb.v1.TestResultPresentation
	5, // 7: luci.resultdb.v1.TestExoneration.variant:type_name -> luci.resultdb.v1.Variant
...
func file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TestResultPresentation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
