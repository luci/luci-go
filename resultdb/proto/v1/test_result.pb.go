...
type TestExoneration struct {
	...
	// to test_id and variant below (which is supported only for legacy uploaders).
	TestVariantIdentifier *TestVariantIdentifier `protobuf:"bytes,9,opt,name=test_variant_identifier,json=testVariantIdentifier,proto3" json:"test_variant_identifier,omitempty"`
	// The flat test id, a unique identifier of the test in a LUCI project.
	// Regex: ^[[::print::]]{1,512}$
	//
	// This is the flat-form encoding of the test component of the structured test variant ID above.
...
func (x *TestExoneration) GetTestVariantIdentifier() *TestVariantIdentifier {
	if x != nil {
		return x.TestVariantIdentifier
	}
	return nil
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_rawDesc = string([]byte{
	...
	0x70, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x4a, 0x04, 0x08, 0x0b, 0x10, 0x0c, 0x22, 0xdc, 0x03,
	...
	0x06, 0xe0, 0x41, 0x03, 0xe0, 0x41, 0x05, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x64, 0x0a,
	0x17, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27,
	...
	0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x42, 0x03, 0xe0, 0x41, 0x05, 0x52, 0x15, 0x74, 0x65,
	0x73, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x07, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02,
...
var file_go_chromium_org_luci_resultdb_proto_v1_test_result_proto_depIdxs = []int32{
	...
	5,  // 10: luci.resultdb.v1.TestExoneration.test_variant_identifier:type_name -> luci.resultdb.v1.TestVariantIdentifier
