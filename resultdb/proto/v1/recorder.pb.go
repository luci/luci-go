...
const file_go_chromium_org_luci_resultdb_proto_v1_recorder_proto_rawDesc = "" +
	"\n" +
	"5go.chromium.org/luci/resultdb/proto/v1/recorder.proto\x12\x10luci.resultdb.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a5go.chromium.org/luci/resultdb/proto/v1/artifact.proto\x1a7go.chromium.org/luci/resultdb/proto/v1/invocation.proto\x1a<go.chromium.org/luci/resultdb/proto/v1/root_invocation.proto\x1a8go.chromium.org/luci/resultdb/proto/v1/test_result.proto\x1a6go.chromium.org/luci/resultdb/proto/v1/work_unit.proto\"\xfc\x01\n" +
	"\x1bCreateRootInvocationRequest\x121\n" +
	"\x12root_invocation_id\x18\x01 \x01(\tB\x03\xe0A\x02R\x10rootInvocationId\x12I\n" +
	"\x0froot_invocation\x18\x02 \x01(\v2 .luci.resultdb.v1.RootInvocationR\x0erootInvocation\x12@\n" +
	"\x0eroot_work_unit\x18\x03 \x01(\v2\x1a.luci.resultdb.v1.WorkUnitR\frootWorkUnit\x12\x1d\n" +
	"\n" +
	...
	"\x11FinalizationScope\x12\"\n" +
	"\x1eFINALIZATION_SCOPE_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16EXCLUDE_ROOT_WORK_UNIT\x10\x01\x12\x1a\n" +
	"\x16INCLUDE_ROOT_WORK_UNIT\x10\x02\"\xae\x01\n" +
	"\x15CreateWorkUnitRequest\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parent\x12%\n" +
	"\fwork_unit_id\x18\x02 \x01(\tB\x03\xe0A\x02R\n" +
	"workUnitId\x127\n" +
	"\twork_unit\x18\x03 \x01(\v2\x1a.luci.resultdb.v1.WorkUnitR\bworkUnit\x12\x1d\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tR\trequestId\"\x81\x01\n" +
	"\x1bBatchCreateWorkUnitsRequest\x12C\n" +
	"\brequests\x18\x01 \x03(\v2'.luci.resultdb.v1.CreateWorkUnitRequestR\brequests\x12\x1d\n" +
	"\n" +
	...
	"\x17FinalizeWorkUnitRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"f\n" +
	"\x1dBatchFinalizeWorkUnitsRequest\x12E\n" +
	"\brequests\x18\x01 \x03(\v2).luci.resultdb.v1.FinalizeWorkUnitRequestR\brequests\"[\n" +
	"\x1eBatchFinalizeWorkUnitsResponse\x129\n" +
	"\n" +
	"work_units\x18\x01 \x03(\v2\x1a.luci.resultdb.v1.WorkUnitR\tworkUnits\"U\n" +
	" DelegateWorkUnitInclusionRequest\x12\x1b\n" +
	"\twork_unit\x18\x01 \x01(\tR\bworkUnit\x12\x14\n" +
	"\x05realm\x18\x02 \x01(\tR\x05realm\"#\n" +
	"!DelegateWorkUnitInclusionResponse\"\xa0\x01\n" +
	"\x17CreateInvocationRequest\x12(\n" +
	"\rinvocation_id\x18\x01 \x01(\tB\x03\xe0A\x02R\finvocationId\x12<\n" +
	"\n" +
	"invocation\x18\x02 \x01(\v2\x1c.luci.resultdb.v1.InvocationR\n" +
	"invocation\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"\x85\x01\n" +
	"\x1dBatchCreateInvocationsRequest\x12E\n" +
	"\brequests\x18\x01 \x03(\v2).luci.resultdb.v1.CreateInvocationRequestR\brequests\x12\x1d\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tR\trequestId\"\x85\x01\n" +
	"\x1eBatchCreateInvocationsResponse\x12>\n" +
	"\vinvocations\x18\x01 \x03(\v2\x1c.luci.resultdb.v1.InvocationR\vinvocations\x12#\n" +
	"\rupdate_tokens\x18\x02 \x03(\tR\fupdateTokens\"\x99\x01\n" +
	"\x17UpdateInvocationRequest\x12A\n" +
	"\n" +
	"invocation\x18\x01 \x01(\v2\x1c.luci.resultdb.v1.InvocationB\x03\xe0A\x02R\n" +
	"invocation\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"4\n" +
	"\x19FinalizeInvocationRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"\xb2\x01\n" +
	" UpdateIncludedInvocationsRequest\x126\n" +
	"\x14including_invocation\x18\x01 \x01(\tB\x03\xe0A\x02R\x13includingInvocation\x12'\n" +
	"\x0fadd_invocations\x18\x02 \x03(\tR\x0eaddInvocations\x12-\n" +
	"\x12remove_invocations\x18\x03 \x03(\tR\x11removeInvocations\"r\n" +
	"\x1eMarkInvocationSubmittedRequest\x12,\n" +
	"\x0froot_invocation\x18\x02 \x01(\tB\x03\xe0A\x02R\x0erootInvocation\x12\"\n" +
	"\n" +
	"invocation\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"invocation\"\xbd\x01\n" +
	"\x17CreateTestResultRequest\x12\x1b\n" +
	"\x06parent\x18\x04 \x01(\tB\x03\xe0A\x02R\x06parent\x12\"\n" +
	"\n" +
	"invocation\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"invocation\x12B\n" +
	"\vtest_result\x18\x02 \x01(\v2\x1c.luci.resultdb.v1.TestResultB\x03\xe0A\x02R\n" +
	"testResult\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"\xc1\x01\n" +
	"\x1dBatchCreateTestResultsRequest\x12\x16\n" +
	"\x06parent\x18\x04 \x01(\tR\x06parent\x12\"\n" +
	"\n" +
	"invocation\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"invocation\x12E\n" +
	"\brequests\x18\x02 \x03(\v2).luci.resultdb.v1.CreateTestResultRequestR\brequests\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"a\n" +
	"\x1eBatchCreateTestResultsResponse\x12?\n" +
	"\ftest_results\x18\x01 \x03(\v2\x1c.luci.resultdb.v1.TestResultR\vtestResults\"\xd1\x01\n" +
	"\x1cCreateTestExonerationRequest\x12\x1b\n" +
	"\x06parent\x18\x04 \x01(\tB\x03\xe0A\x02R\x06parent\x12\"\n" +
	"\n" +
	"invocation\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"invocation\x12Q\n" +
	"\x10test_exoneration\x18\x02 \x01(\v2!.luci.resultdb.v1.TestExonerationB\x03\xe0A\x02R\x0ftestExoneration\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"\xcb\x01\n" +
	"\"BatchCreateTestExonerationsRequest\x12\x16\n" +
	"\x06parent\x18\x04 \x01(\tR\x06parent\x12\"\n" +
	"\n" +
	"invocation\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"invocation\x12J\n" +
	"\brequests\x18\x02 \x03(\v2..luci.resultdb.v1.CreateTestExonerationRequestR\brequests\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"u\n" +
	"#BatchCreateTestExonerationsResponse\x12N\n" +
	"\x11test_exonerations\x18\x01 \x03(\v2!.luci.resultdb.v1.TestExonerationR\x10testExonerations\"\x90\x01\n" +
	"\x15CreateArtifactRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x12;\n" +
	"\bartifact\x18\x02 \x01(\v2\x1a.luci.resultdb.v1.ArtifactB\x03\xe0A\x02R\bartifact\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"\x99\x01\n" +
	"\x1bBatchCreateArtifactsRequest\x12\x16\n" +
	"\x06parent\x18\x03 \x01(\tR\x06parent\x12C\n" +
	"\brequests\x18\x02 \x03(\v2'.luci.resultdb.v1.CreateArtifactRequestR\brequests\x12\x1d\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tR\trequestId\"X\n" +
	"\x1cBatchCreateArtifactsResponse\x128\n" +
	"\tartifacts\x18\x01 \x03(\v2\x1a.luci.resultdb.v1.ArtifactR\tartifacts2\xd4\x14\n" +
	"\bRecorder\x12w\n" +
	"\x14CreateRootInvocation\x12-.luci.resultdb.v1.CreateRootInvocationRequest\x1a..luci.resultdb.v1.CreateRootInvocationResponse\"\x00\x12i\n" +
	"\x14UpdateRootInvocation\x12-.luci.resultdb.v1.UpdateRootInvocationRequest\x1a .luci.resultdb.v1.RootInvocation\"\x00\x12c\n" +
	"\x11GetRootInvocation\x12*.luci.resultdb.v1.GetRootInvocationRequest\x1a .luci.resultdb.v1.RootInvocation\"\x00\x12m\n" +
	"\x16FinalizeRootInvocation\x12/.luci.resultdb.v1.FinalizeRootInvocationRequest\x1a .luci.resultdb.v1.RootInvocation\"\x00\x12W\n" +
	"\x0eCreateWorkUnit\x12'.luci.resultdb.v1.CreateWorkUnitRequest\x1a\x1a.luci.resultdb.v1.WorkUnit\"\x00\x12w\n" +
	"\x14BatchCreateWorkUnits\x12-.luci.resultdb.v1.BatchCreateWorkUnitsRequest\x1a..luci.resultdb.v1.BatchCreateWorkUnitsResponse\"\x00\x12W\n" +
	"\x0eUpdateWorkUnit\x12'.luci.resultdb.v1.UpdateWorkUnitRequest\x1a\x1a.luci.resultdb.v1.WorkUnit\"\x00\x12w\n" +
	"\x14BatchUpdateWorkUnits\x12-.luci.resultdb.v1.BatchUpdateWorkUnitsRequest\x1a..luci.resultdb.v1.BatchUpdateWorkUnitsResponse\"\x00\x12Q\n" +
