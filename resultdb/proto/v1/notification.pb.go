...
type TestResultsNotification struct {
	...
	// Details of the root invocation.
	RootInvocationMetadata *RootInvocationMetadata `protobuf:"bytes,5,opt,name=root_invocation_metadata,json=rootInvocationMetadata,proto3" json:"root_invocation_metadata,omitempty"`
}
...
func (x *TestResultsNotification) GetRootInvocationMetadata() *RootInvocationMetadata {
	if x != nil {
		return x.RootInvocationMetadata
	}
	return nil
}
...
type WorkUnitsNotification struct {
	...
	ResultdbHost string `protobuf:"bytes,2,opt,name=resultdb_host,json=resultdbHost,proto3" json:"resultdb_host,omitempty"`
	// Details of the root invocation.
	RootInvocationMetadata *RootInvocationMetadata `protobuf:"bytes,3,opt,name=root_invocation_metadata,json=rootInvocationMetadata,proto3" json:"root_invocation_metadata,omitempty"`
}
...
func (x *WorkUnitsNotification) GetRootInvocationMetadata() *RootInvocationMetadata {
	if x != nil {
		return x.RootInvocationMetadata
	}
	return nil
...
//
// Next id: 5.
type TestAggregationsNotification struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	TestAggregations []*TestAggregation `protobuf:"bytes,2,rep,name=test_aggregations,json=testAggregations,proto3" json:"test_aggregations,omitempty"`
	// The hostname of the luci.resultdb.v1.ResultDB service which can be used
	...
	AggregationLevel AggregationLevel `protobuf:"varint,4,opt,name=aggregation_level,json=aggregationLevel,proto3,enum=luci.resultdb.v1.AggregationLevel" json:"aggregation_level,omitempty"`
}

func (x *TestAggregationsNotification) Reset() {
	*x = TestAggregationsNotification{}
	if protoimpl.UnsafeEnabled {
...
func (x *TestAggregationsNotification) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestAggregationsNotification) ProtoMessage() {}

func (x *TestAggregationsNotification) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TestAggregationsNotification.ProtoReflect.Descriptor instead.
func (*TestAggregationsNotification) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_rawDescGZIP(), []int{5}
}

func (x *TestAggregationsNotification) GetRootInvocation() string {
	if x != nil {
		return x.RootInvocation
	}
	return ""
...
func (x *TestAggregationsNotification) GetTestAggregations() []*TestAggregation {
	if x != nil {
		return x.TestAggregations
	}
	return nil
}

func (x *TestAggregationsNotification) GetResultdbHost() string {
	if x != nil {
		return x.ResultdbHost
	}
	return ""
...
func (x *TestAggregationsNotification) GetAggregationLevel() AggregationLevel {
	if x != nil {
...
// If a work unit contains many test results, it may be split over many
// TestResultNotification messages.
//
// Next id: 4
type TestResultsNotification_TestResultsByWorkUnit struct {
	...
	// Details of the immediate parent work unit that the test results
	// belong to. The work unit here has a view of WORK_UNIT_VIEW_BASIC
	// (extended properties are excluded) to limit contribution to the
...
func (x *TestResultsNotification_TestResultsByWorkUnit) GetWorkUnit() *WorkUnit {
	if x != nil {
		return x.WorkUnit
	}
	return nil
...
type WorkUnitsNotification_WorkUnitDetails struct {
	...
	// In this notification payload, this field contains the fully calculated
	// and merged properties from all ancestors.
	MergedInheritedProperties *structpb.Struct `protobuf:"bytes,3,opt,name=merged_inherited_properties,json=mergedInheritedProperties,proto3" json:"merged_inherited_properties,omitempty"`
	// The work unit resource containing all standard fields.
	WorkUnit *WorkUnit `protobuf:"bytes,4,opt,name=work_unit,json=workUnit,proto3" json:"work_unit,omitempty"`
}

func (x *WorkUnitsNotification_WorkUnitDetails) Reset() {
	*x = WorkUnitsNotification_WorkUnitDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *WorkUnitsNotification_WorkUnitDetails) GetMergedInheritedProperties() *structpb.Struct {
	if x != nil {
...
func (x *WorkUnitsNotification_WorkUnitDetails) GetWorkUnit() *WorkUnit {
	if x != nil {
		return x.WorkUnit
	}
	return nil
...
var file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x33, 0x67, 0x6f,
	...
	0x6e, 0x69, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x3c, 0x67, 0x6f, 0x2e, 0x63, 0x68,
	...
	0x74, 0x65, 0x73, 0x74, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	0x6e, 0x4b, 0x65, 0x79, 0x12, 0x62, 0x0a, 0x18, 0x72, 0x6f, 0x6f, 0x74, 0x5f, 0x69, 0x6e, 0x76,
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65,
	...
	0x52, 0x16, 0x72, 0x6f, 0x6f, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x97, 0x01, 0x0a, 0x15, 0x54, 0x65, 0x73,
	0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x42, 0x79, 0x57, 0x6f, 0x72, 0x6b, 0x55, 0x6e,
	0x69, 0x74, 0x12, 0x3f, 0x0a, 0x0c, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x76, 0x65, 0x6c, 0x42, 0x50, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
...
var file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_goTypes = []interface{}{
	...
	(*TestAggregationsNotification)(nil),                  // 5: luci.resultdb.v1.TestAggregationsNotification
	(*TestResultsNotification_TestResultsByWorkUnit)(nil), // 6: luci.resultdb.v1.TestResultsNotification.TestResultsByWorkUnit
	(*WorkUnitsNotification_WorkUnitDetails)(nil),         // 7: luci.resultdb.v1.WorkUnitsNotification.WorkUnitDetails
	(*timestamppb.Timestamp)(nil),                         // 8: google.protobuf.Timestamp
	(*RootInvocation)(nil),                                // 9: luci.resultdb.v1.RootInvocation
	(*Sources)(nil),                                       // 10: luci.resultdb.v1.Sources
	(*RootInvocationMetadata)(nil),                        // 11: luci.resultdb.v1.RootInvocationMetadata
	(*TestAggregation)(nil),                               // 12: luci.resultdb.v1.TestAggregation
	(AggregationLevel)(0),                                 // 13: luci.resultdb.v1.AggregationLevel
	(*TestResult)(nil),                                    // 14: luci.resultdb.v1.TestResult
	(*WorkUnit)(nil),                                      // 15: luci.resultdb.v1.WorkUnit
	(*structpb.Struct)(nil),                               // 16: google.protobuf.Struct
}
var file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_depIdxs = []int32{
	8,  // 0: luci.resultdb.v1.InvocationFinalizedNotification.create_time:type_name -> google.protobuf.Timestamp
	9,  // 1: luci.resultdb.v1.RootInvocationFinalizedNotification.root_invocation:type_name -> luci.resultdb.v1.RootInvocation
	8,  // 2: luci.resultdb.v1.InvocationReadyForExportNotification.root_create_time:type_name -> google.protobuf.Timestamp
	10, // 3: luci.resultdb.v1.InvocationReadyForExportNotification.sources:type_name -> luci.resultdb.v1.Sources
	6,  // 4: luci.resultdb.v1.TestResultsNotification.test_results_by_work_unit:type_name -> luci.resultdb.v1.TestResultsNotification.TestResultsByWorkUnit
	11, // 5: luci.resultdb.v1.TestResultsNotification.root_invocation_metadata:type_name -> luci.resultdb.v1.RootInvocationMetadata
	7,  // 6: luci.resultdb.v1.WorkUnitsNotification.work_units:type_name -> luci.resultdb.v1.WorkUnitsNotification.WorkUnitDetails
	11, // 7: luci.resultdb.v1.WorkUnitsNotification.root_invocation_metadata:type_name -> luci.resultdb.v1.RootInvocationMetadata
	12, // 8: luci.resultdb.v1.TestAggregationsNotification.test_aggregations:type_name -> luci.resultdb.v1.TestAggregation
	13, // 9: luci.resultdb.v1.TestAggregationsNotification.aggregation_level:type_name -> luci.resultdb.v1.AggregationLevel
	14, // 10: luci.resultdb.v1.TestResultsNotification.TestResultsByWorkUnit.test_results:type_name -> luci.resultdb.v1.TestResult
	15, // 11: luci.resultdb.v1.TestResultsNotification.TestResultsByWorkUnit.work_unit:type_name -> luci.resultdb.v1.WorkUnit
	16, // 12: luci.resultdb.v1.WorkUnitsNotification.WorkUnitDetails.merged_inherited_properties:type_name -> google.protobuf.Struct
	15, // 13: luci.resultdb.v1.WorkUnitsNotification.WorkUnitDetails.work_unit:type_name -> luci.resultdb.v1.WorkUnit
...
func file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TestAggregationsNotification); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
