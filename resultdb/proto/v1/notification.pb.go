...
const file_go_chromium_org_luci_resultdb_proto_v1_notification_proto_rawDesc = "" +
	"\n" +
	"9go.chromium.org/luci/resultdb/proto/v1/notification.proto\x12\x10luci.resultdb.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a3go.chromium.org/luci/resultdb/proto/v1/common.proto\"\xdf\x01\n" +
	"\x1fInvocationFinalizedNotification\x12\x1e\n" +
	"\n" +
	"invocation\x18\x01 \x01(\tR\n" +
	"invocation\x12\x14\n" +
	"\x05realm\x18\x02 \x01(\tR\x05realm\x12$\n" +
	"\x0eis_export_root\x18\x03 \x01(\bR\fisExportRoot\x12#\n" +
	"\rresultdb_host\x18\x04 \x01(\tR\fresultdbHost\x12;\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\"\xee\x02\n" +
	"$InvocationReadyForExportNotification\x12#\n" +
	"\rresultdb_host\x18\x06 \x01(\tR\fresultdbHost\x12'\n" +
	"\x0froot_invocation\x18\x01 \x01(\tR\x0erootInvocation\x122\n" +
	"\x15root_invocation_realm\x18\x02 \x01(\tR\x13rootInvocationRealm\x12D\n" +
	"\x10root_create_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0erootCreateTime\x12\x1e\n" +
	"\n" +
	"invocation\x18\x03 \x01(\tR\n" +
	"invocation\x12)\n" +
	"\x10invocation_realm\x18\x04 \x01(\tR\x0finvocationRealm\x123\n" +
	"\asources\x18\x05 \x01(\v2\x19.luci.resultdb.v1.SourcesR\asourcesBP\n" +
