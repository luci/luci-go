...
func TestGetInvocation(t *testing.T) {
	Convey(`GetInvocation`, t, func() {
		...
		testutil.MustApply(ctx, testutil.InsertInvocation("including", pb.Invocation_ACTIVE, "", ct))
		...
		So(inv, ShouldResembleProto, &pb.Invocation{
			...
			Inclusions: map[string]*pb.Invocation_InclusionAttrs{
				"invocations/included_0": &pb.Invocation_InclusionAttrs{
					OverriddenBy: "invocations/included_1",
					Ready: false,
				},
				"invocations/included_1": &pb.Invocation_InclusionAttrs{
					OverriddenBy: "",
					Ready: true,
				},
			},
