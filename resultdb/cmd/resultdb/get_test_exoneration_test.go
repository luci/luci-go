...
func TestValidateGetTestExonerationRequest(t *testing.T) {
	...
	Convey(`ValidateGetTestExonerationRequest`, t, func() {
		Convey(`Valid`, func() {
			req := &pb.GetTestExonerationRequest{Name: "invocations/a/tests/ninja%2Ftest%2FBarTest.DoBaz/exonerations/id"}
...
func TestGetTestExoneration(t *testing.T) {
	Convey(`GetTestExoneration`, t, func() {
		...
		req := &pb.GetTestExonerationRequest{Name: "invocations/inv_0/tests/ninja%2Ftest%2FBarTest.DoBaz/exonerations/id"}
		tr, err := srv.GetTestExoneration(ctx, req)
		So(err, ShouldBeNil)
		So(tr, ShouldResembleProto, &pb.TestExoneration{
			Name:                "invocations/inv_0/tests/ninja%2Ftest%2FBarTest.DoBaz/exonerations/id",
			ExonerationId:       "id",
			TestPath:            "ninja/test/BarTest.DoBaz",
			Variant:             pbutil.Variant("k1", "v1", "k2", "v2"),
