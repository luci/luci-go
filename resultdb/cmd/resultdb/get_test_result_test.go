...
func TestValidateGetTestResultRequest(t *testing.T) {
	...
	Convey(`ValidateGetTestResultRequest`, t, func() {
		Convey(`Valid`, func() {
			req := &pb.GetTestResultRequest{Name: "invocations/a/tests/ninja%2Ftest%2FBarTest.DoBaz/results/result5"}
	...
	Convey(`GetTestResult`, t, func() {
		...
		testutil.MustApply(ctx,
			...
			span.InsertMap("TestResults", map[string]interface{}{
				"InvocationId":    invID,
				"TestPath":        "ninja/test/BarTest.DoBaz",
		...
		test(ctx, "invocations/inv_0/tests/ninja%2Ftest%2FBarTest.DoBaz/results/result_id_within_inv_0",
			&pb.TestResult{
				Name:     "invocations/inv_0/tests/ninja%2Ftest%2FBarTest.DoBaz/results/result_id_within_inv_0",
				TestPath: "ninja/test/BarTest.DoBaz",
				ResultId: "result_id_within_inv_0",
				Variant:  pbutil.Variant("k1", "v1", "k2", "v2"),
				Expected: false,
		...
		Convey(`works with expected result`, func() {
			...
			// Fetch back the TestResult.
			test(ctx, "invocations/inv_0/tests/ninja%2Ftest%2FBarTest.DoBaz/results/result_id_within_inv_1",
				&pb.TestResult{
					Name:     "invocations/inv_0/tests/ninja%2Ftest%2FBarTest.DoBaz/results/result_id_within_inv_1",
					TestPath: "ninja/test/BarTest.DoBaz",
					ResultId: "result_id_within_inv_1",
					Variant:  pbutil.Variant("k1", "v1", "k2", "v2"),
					Expected: true,
