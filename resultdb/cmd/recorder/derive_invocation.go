...
func batchInsertTestResults(ctx context.Context, inv *pb.Invocation, trs []*pb.TestResult, batchSize int) ([]string, error) {
	...
	for i, batch := range batches {
		...
		eg.Go(func() error {
			...
			muts = append(muts, insertOrUpdateInvocation(egCtx, batchInv, "", ""))
...
// batchTestResults batches the given TestResults under the given
// invocation, returning the remainder.
