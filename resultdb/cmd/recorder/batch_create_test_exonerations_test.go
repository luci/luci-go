...
func TestValidateBatchCreateTestExonerationsRequest(t *testing.T) {
	...
	Convey(`TestValidateBatchCreateTestExonerationsRequest`, t, func() {
		...
		Convey(`invalid sub-request`, func() {
			...
			So(err, ShouldErrLike, `request #0: test_exoneration: test_variant: test_path: does not match`)
		})
...
func TestBatchCreateTestExonerations(t *testing.T) {
	Convey(`TestBatchCreateTestExonerations`, t, func() {
		...
		Convey(`invalid request`, func() {
			...
			So(err, ShouldErrLike, `bad request: request #0: test_exoneration: test_variant: test_path: does not match`)
		...
		e2eTest := func(withRequestID bool) {
			...
			for i := range req.Requests {
				...
				So(actual.ExonerationId, ShouldStartWith, "6408fdc5c36df5df57957e7b230e4b48c55b06ce849303e855d52f1356f2980e:") // hash of the variant
				if withRequestID {
					So(actual.ExonerationId, ShouldEqual, "6408fdc5c36df5df57957e7b230e4b48c55b06ce849303e855d52f1356f2980e:d:fcc63e142b2aa8429cde3f4e799f05fa8f179e7c57165658e89305e3f6c647580383f4e48a73ed10a58e1d70246eaad194301f053dd453a7b1a078dc2f2d5ae7")
				}

				expected := proto.Clone(actual).(*pb.TestExoneration)
				proto.Merge(expected, &pb.TestExoneration{
					Name:          pbutil.TestExonerationName("inv", "a", actual.ExonerationId),
