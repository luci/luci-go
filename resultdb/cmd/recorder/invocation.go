...
func insertInvocation(ctx context.Context, inv *pb.Invocation, updateToken, createRequestID string, expectedResultsExpiration time.Duration) *spanner.Mutation {
	return span.InsertMap("Invocations", rowOfInvocation(ctx, inv, updateToken, createRequestID, expectedResultsExpiration))
}
