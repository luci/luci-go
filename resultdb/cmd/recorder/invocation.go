...
var expectedTestResultsExpirationDuration = flag.Int(
...
func rowOfInvocation(ctx context.Context, inv *pb.Invocation, updateToken, createRequestID string) map[string]interface{} {
	...
	row := map[string]interface{}{
		...
		"ExpectedTestResultsExpirationTime": createTime.Add(time.Duration(*expectedTestResultsExpirationDuration) * day),
