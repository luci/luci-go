...
// IndexedWith determines if the other invocation would be indexed with the
// same ordinal field values as this one.
func (h *Historical) IndexedWith(other *Historical) bool {
	return (h.IndexTimestamp.Seconds == other.IndexTimestamp.Seconds && h.IndexTimestamp.Nanos == other.IndexTimestamp.Nanos)
}
