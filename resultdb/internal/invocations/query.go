...
// MatchPredicate returns all invocations may contain test results matching the predicate.
func MatchPredicate(ctx context.Context, invIDs IDSet, predicate *pb.TestResultPredicate) (IDSet, error) {
	literalPrefix := ""
