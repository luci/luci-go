...
type Query struct {
	...
	// bufferSize is a hint for how many test results to query from Spanner
...
func (q *Query) List(ctx context.Context, pageToken ID) *spanutil.Iterator[*TestResultRow, ID] {
