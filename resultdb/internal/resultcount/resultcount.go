...
func IncrementTestResultCount(ctx context.Context, id invocations.ID, delta int64) error {
	...
	case err != nil:
		return err
	case rowCount == 0:
		insertTestResultCount(ctx, id, shardId, delta)
		return nil
	case rowCount != 1:
...
//	}
//}
func insertTestResultCount(ctx context.Context, id invocations.ID, shardId, delta int64) {
	span.BufferWrite(ctx, spanutil.InsertMap("TestResultCounts", map[string]interface{}{
		"InvocationId":    id,
		"ShardId":         shardId,
