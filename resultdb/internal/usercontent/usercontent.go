...
// RegisterUserContentHostFlag registers -user-content-host flag for the
// hostname to use and require for user content URLs.
func RegisterUserContentHostFlag(fs *flag.FlagSet) *string {
	return flag.String("user-content-host", "", text.Doc(`
		Use and require this host for all user content URLs.
	`))
}
