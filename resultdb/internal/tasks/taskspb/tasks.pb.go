...
type TryFinalizeInvocation struct {
	...
	State        v1.Invocation_State `protobuf:"varint,2,opt,name=state,proto3,enum=luci.resultdb.v1.Invocation_State" json:"state,omitempty"`
}
...
func (x *TryFinalizeInvocation) GetState() v1.Invocation_State {
	if x != nil {
		return x.State
	}
	return v1.Invocation_STATE_UNSPECIFIED
}
...
var file_go_chromium_org_luci_resultdb_internal_tasks_taskspb_tasks_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x76, 0x0a, 0x15, 0x54, 0x72, 0x79,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x72, 0x65,
...
var file_go_chromium_org_luci_resultdb_internal_tasks_taskspb_tasks_proto_goTypes = []interface{}{
	...
	(v1.Invocation_State)(0),      // 1: luci.resultdb.v1.Invocation.State
}
var file_go_chromium_org_luci_resultdb_internal_tasks_taskspb_tasks_proto_depIdxs = []int32{
	1, // 0: luci.resultdb.internal.tasks.TryFinalizeInvocation.state:type_name -> luci.resultdb.v1.Invocation.State
