...
// If the returned error is tagged with PermanentInvocationTaskErrTag,
// then the failed task is deleted.
...
type Dispatcher struct {
	// How often to query for tasks. Defaults to 5s.
	QueryInterval time.Duration

	// For how long to lease a task. Defaults to 10s.
...
// runOne leases, runs and deletes a task.
