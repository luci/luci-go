...
// fetchTestVariants returns test variants with unexpected results.
// If q.Predicate.NotExonerated is true, returned exonerated test variants are
// excluded.
...
// executeTestVariantQuery executes a query a set of test variants.
// It must return TestID and VariantHash columns.
