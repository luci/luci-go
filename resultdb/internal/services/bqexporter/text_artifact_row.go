...
func (b *bqExporter) downloadArtifactContent(ctx context.Context, a *artifacts.Artifact, exported, parent *pb.Invocation) (rows []rowInput, err error) {
	...
	err = ac.DownloadRBECASContent(ctx, b.rbecasClient, func(pr *io.PipeReader) error {
