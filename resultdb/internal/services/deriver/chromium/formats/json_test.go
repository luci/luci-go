		...
		assertTestResultsResemble(testResults, []*TestResult{
			// Test 1.
			{
				TestResult: &pb.TestResult{
					...
					Tags: pbutil.StringPairs(
						...
						"test_location", "//third_party/blink/web_tests/c1/c2/t1.html",
			...
			// Test 2.
			{
				TestResult: &pb.TestResult{
					...
					Tags: pbutil.StringPairs(
						"json_format_status", "PASS",
						"test_location", "//third_party/blink/web_tests/c1/c2/t2.html",
			...
			// Test 3
			{
				TestResult: &pb.TestResult{
					...
					Tags: pbutil.StringPairs(
						"json_format_status", "FAIL",
						"test_location", "//third_party/blink/web_tests/c2/t3.html",
			...
			// Test 4
			{
				TestResult: &pb.TestResult{
					...
					Tags: pbutil.StringPairs(
						"json_format_status", "PASS",
						"test_location", "//third_party/blink/web_tests/c2/t4.html",
			...
			// Test 5
			{
				TestResult: &pb.TestResult{
					...
					Tags: pbutil.StringPairs(
						...
						"test_location", "//third_party/blink/web_tests/c2/t5.html",
			...
			// Test 6
			{
				TestResult: &pb.TestResult{
					...
					Tags: pbutil.StringPairs(
						"json_format_status", "PASS",
						"test_location", "//third_party/blink/web_tests/c2/t6.html",
