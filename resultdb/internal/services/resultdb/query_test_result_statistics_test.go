...
func TestQueryTestResultStatistics(t *testing.T) {
	Convey(`QueryTestResultStatistics`, t, func() {
		...
		testutil.MustApply(ctx, resultcount.InitializeCounters(invocations.ID("x"))...)
		testutil.MustApply(ctx, resultcount.InitializeCounters(invocations.ID("a"))...)
		testutil.MustApply(ctx, resultcount.InitializeCounters(invocations.ID("b"))...)
		testutil.MustApply(ctx, resultcount.InitializeCounters(invocations.ID("c"))...)
		testutil.MustApply(ctx, resultcount.InitializeCounters(invocations.ID("d"))...)
