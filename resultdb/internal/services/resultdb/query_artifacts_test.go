	...
	Convey(`QueryArtifacts`, t, func() {
		...
		Convey(`Test ID regexp`, func() {
			MustApply(ctx,
				...
				InsertInvocation("inv2", pb.Invocation_ACTIVE, nil),
				InsertInvocationArtifact("inv0", "a", nil),
				InsertTestResultArtifact("inv0", "t00", "r", "a", nil),
				InsertTestResultArtifact("inv1", "t10", "r", "a", nil),
				InsertTestResultArtifact("inv1", "t11", "r", "a", nil),
				InsertTestResultArtifact("inv2", "t20", "r", "a", nil),
			)
