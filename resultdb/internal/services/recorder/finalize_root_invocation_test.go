...
func TestValidateFinalizeRootInvocationRequest(t *testing.T) {
	t.Parallel()
	ftt.Run("ValidateFinalizeRootInvocationRequest", t, func(t *ftt.Test) {
		req := &pb.FinalizeRootInvocationRequest{
			Name: "rootInvocations/u-my-root-id",
		}

		t.Run("valid", func(t *ftt.Test) {
			err := validateFinalizeRootInvocationRequest(req)
