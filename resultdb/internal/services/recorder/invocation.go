...
// GenerateInvocationToken is a helper function to generate an update token for a
// given invocation.
func GenerateInvocationToken(ctx context.Context, invID span.InvocationID) (string, error) {
	// Generate an update token for the given invocation id.
	// This should last as long as a build is allowed to run.
