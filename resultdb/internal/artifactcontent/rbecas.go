...
// Reader contains information about the artifact to be scanned.
type Reader struct {
...
func (r *Reader) DownloadRBECASContent(ctx context.Context, bs bytestream.ByteStreamClient, f func(*io.PipeReader) error) error {
