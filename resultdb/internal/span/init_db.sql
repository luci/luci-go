...
-- Digests that have been seen from a given Realm before.
-- Used control access to blobs against realms.
CREATE TABLE RBECASBlobs (
  ...
  Hash STRING(MAX) NOT NULL, -- e.g. "sha256:deadbeefdeadbeefdeadbeefdeadbeefdeadbeef"
  -- Content size.
