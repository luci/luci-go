...
func ResetInvocationTasks(ctx context.Context, txn *spanner.ReadWriteTransaction, id InvocationID, processAfter *tspb.Timestamp) error {
	...
	fmt.Println("Reset %d invocation tasks for invocation: %s", updatedRowCount, id)
