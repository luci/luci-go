...
func TestReadInvocationFull(t *testing.T) {
	Convey(`ReadInvocationFull`, t, func() {
		...
		testutil.MustApply(ctx,
			...
			testutil.InsertInvocation("included0", pb.Invocation_COMPLETED, "", now, nil),
			testutil.InsertInvocation("included1", pb.Invocation_COMPLETED, "", now, nil),
...
func TestQueryInvocations(t *testing.T) {
	Convey(`TestQueryInvocations`, t, func() {
		...
		testutil.MustApply(ctx,
			testutil.InsertInvocation("inv0", pb.Invocation_COMPLETED, "", now, nil),
			testutil.InsertInvocation("inv1", pb.Invocation_COMPLETED, "", now, nil),
			testutil.InsertInvocation("inv2", pb.Invocation_COMPLETED, "", now, nil),
		)
