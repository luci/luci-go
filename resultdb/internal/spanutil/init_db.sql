...
CREATE TABLE Invocations (
  ...
  -- If this invocation is to be queried by an ordinal range, such as a commit range,
  -- (e.g. results history query), set the following two fields for indexing.
  -- Otherwise, make them null.

  -- The numeric value to use, where higher values are more recent.
  Ordinal INT64,
  ...
  -- If this invocation is to queried by a time range, e.g. for test results
  -- history query, set this field for indexing.
...
CREATE NULL_FILTERED INDEX InvocationsByCreateTime
