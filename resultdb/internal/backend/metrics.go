...
func recordExpiredResultsDelayMetric(ctx context.Context) <-chan error {
	r := parallel.Runner{}
	return r.RunOne(func() error {
...
func recordOldestTaskMetric(ctx context.Context, typ tasks.Type) <-chan error {
	r := parallel.Runner{}
	return r.RunOne(func() error {
