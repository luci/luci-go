...
func invocationPbToInvocation(inv *pb.Invocation) Invocation {
	return Invocation{
...
func generateBQRow(exported, parent *pb.Invocation, tr *pb.TestResult, exonerated bool) *bigquery.StructSaver {
	trr := &TestResultRow{
		ExportedInvocation: invocationPbToInvocation(exported),
		ParentInvocation:   invocationPbToInvocation(parent),
		TestID:             tr.TestId,
