...
// TestExoneration is a struct for test exoneration related information.
...
type TestResultRow struct {
	...
	ExportedInvocation Invocation `bigquery:"exported_invocation"`

	// ContainingInvocation contains info of the result's immediate parent
	// invocation.
	ContainingInvocation Invocation `bigquery:"containing_invocation"`
