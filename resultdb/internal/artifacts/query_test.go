	...
	Convey(`Query`, t, func() {
		...
		Convey(`Populates fields correctly`, func() {
			testutil.MustApply(ctx,
				insertArtifact("inv1", "", "a", map[string]interface{}{
		...
		Convey(`Reads both invocation and test result artifacts`, func() {
			testutil.MustApply(ctx,
				insertArtifact("inv1", "", "a", nil),
				insertArtifact("inv1", "tr/t t/r", "a", nil),
			)
		...
		Convey(`Does not fetch artifacts of other invocations`, func() {
			testutil.MustApply(ctx,
				...
				insertArtifact("inv0", "", "a", nil),
				insertArtifact("inv1", "", "a", nil),
				insertArtifact("inv2", "", "a", nil),
			)
			actual := mustFetchNames(q)
		...
		Convey(`Test ID regexp`, func() {
			testutil.MustApply(ctx,
				insertArtifact("inv1", "", "a", nil),
				insertArtifact("inv1", "tr/t00/r", "a", nil),
				insertArtifact("inv1", "tr/t10/r", "a", nil),
				insertArtifact("inv1", "tr/t11/r", "a", nil),
				insertArtifact("inv1", "tr/t20/r", "a", nil),
			)
		...
		Convey(`Follow edges`, func() {
			testutil.MustApply(ctx,
				insertArtifact("inv1", "", "a0", nil),
				insertArtifact("inv1", "", "a1", nil),
				insertArtifact("inv1", "tr/t/r", "a0", nil),
				insertArtifact("inv1", "tr/t/r", "a1", nil),
			)
		...
		Convey(`Artifacts of interesting test results`, func() {
			testutil.MustApply(ctx,
				insertArtifact("inv1", "", "a", nil),
				insertArtifact("inv1", "tr/t0/0", "a", nil),
				insertArtifact("inv1", "tr/t1/0", "a", nil),
				insertArtifact("inv1", "tr/t1/1", "a", nil),
				insertArtifact("inv1", "tr/t1/1", "b", nil),
				insertArtifact("inv1", "tr/t2/0", "a", nil),
			)
		...
		Convey(`Variant equals`, func() {
			testutil.MustApply(ctx,
				...
				insertArtifact("inv1", "tr/t0/0", "a", nil),
				insertArtifact("inv1", "tr/t1/0", "a", nil),
				insertArtifact("inv1", "tr/t1/0", "b", nil),
				insertArtifact("inv1", "tr/t2/0", "a", nil),
			)
		...
		Convey(`Paging`, func() {
			testutil.MustApply(ctx,
				insertArtifact("inv1", "", "a0", nil),
				insertArtifact("inv1", "", "a1", nil),
				insertArtifact("inv1", "", "a2", nil),
				insertArtifact("inv1", "", "a3", nil),
				insertArtifact("inv1", "", "a4", nil),
			)
			...
			Convey(`Bad token`, func() {
				...
				_, _, err := q.Fetch(ctx, span.Client(ctx).Single())
