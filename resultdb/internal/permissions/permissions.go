...
func VerifyInvocation(ctx context.Context, permission realms.Permission, id invocations.ID) error {
	return VerifyBatch(ctx, permission, invocations.NewIDSet(id))
}
