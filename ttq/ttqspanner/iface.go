...
func New(c *cloudtasks.Client, sp *spanner.Client) *TTQ {
	// TODO(tandrii): implement.
	return &TTQ{impl: internal.Impl{DB: &db{client: sp}}}
}
...
func (t *TTQ) InstallRoutes(r *router.Router, pathPrefix string, opts ttq.SweepOptions, mw router.MiddlewareChain) {
	// TODO(tandrii): implement.
}

// Enqueue guarantees eventual creation of a task in Cloud Tasks if the current
// transaction completes succesfully.
//
