...
type PropertyConverter interface {
	// TODO(riannucci): Allow a convertible to return multiple values.  This is
...
// PropType return the PropertyType of the Property.
...
// IndexSetting says whether or not the datastore should create indices for
// this value.
