...
type WithProtoCompress struct {
	...
	Msg *testprotos.Msg `gae:",compress"`
}
	...
	},
	{
		...
		want: PropertyMap{
			"Msg": mpNI([]byte{
				...
				0x78, 0x01,      // zlib own header
				// compressed data
				4, 192, 33, 1, 0, 0, 0, 194, 48, 143, 166, 224, 250,
				151, 248, 118, 0, 0, 40, 0, 0, 255, 255, 82, 40, 7, 179,
			}),
		},
	},
	{
	...
	Convey("Test meta fields", t, func() {
		...
		Convey("protos get/set", func() {
			...
			So(getMGS(p).SetMeta("what", []byte{
				protoBinOptZlib,
				120, 156, 226, 98, 73, 76, 76, 76, 4, 4, 0, 0, 255, 255, 4, 32, 1, 147}),
				ShouldBeTrue)
