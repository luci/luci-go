...
var (
	...
	// have its expiration set to. It should be higher than maximum expected
	// duration of datastore operations.
	LockTimeSeconds = 120
...
type Cache interface {
	...
	PutLocks(ctx context.Context, keys []string) error
	...
	TryLockAndFetch(ctx context.Context, keys []string, nonce []byte) ([]CacheItem, error)
