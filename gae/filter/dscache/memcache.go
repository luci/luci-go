...
func (memcacheImpl) PutLocks(ctx context.Context, keys []string) error {
...
func (memcacheImpl) TryLockAndFetch(ctx context.Context, keys []string, nonce []byte) ([]CacheItem, error) {
