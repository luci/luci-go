...
// in an init function.
func genDiscoveryFile(c context.Context, target, descFile, packageName string) error {
	...
	for _, f := range desc.File {
		for _, s := range f.Service {
			serviceNames = append(serviceNames, fmt.Sprintf("%s.%s", packageName, s.GetName()))
		}
	}
