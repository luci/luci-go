...
func (c *schemaConverter) field(file *descriptor.FileDescriptorProto, field *descriptor.FieldDescriptorProto) (*bigquery.FieldSchema, error) {
	...
	case descriptor.FieldDescriptorProto_TYPE_MESSAGE:
		...
		case "google.protobuf.Struct":
			...
			// BigQuery tables.
			// From https://docs.google.com/document/d/1PccZ62hmF8QQHHa7GDF9NriCGS5mm-uL_NcXBp2UCDI/edit?ts=5a5390ac#
			//
			// We should avoid schemaless data in BigQuery.
