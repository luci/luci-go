...
func TestGet(t *testing.T) {
	...
	Convey(`Test srcman.Get`, t, func() {
		...
		demoData := &source_manifest.Manifest{
			Directories: map[string]*source_manifest.Manifest_Directory{
				"something": {
					GitCheckout: &source_manifest.Manifest_GitCheckout{
		...
		demo := &sourceManifest{ID: base128.EncodeToString(demoID)}
