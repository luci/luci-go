...
// handleLUCIBuildData renders the data of the build needed to render a buil
// page.
// TODO(weiweilin): once all the build page data fetching code are moved to
// ResultUI, delete this.
