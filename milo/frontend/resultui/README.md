# ResultUI
ResultUI is an attempt to rethink the [Milo](https://go/luci/milo.md) build page.
It aims to provide Chrome developers a convenient portal to debug a build.

## Main Features
* Test results page  
  Test results page gives a cleaner view of all the tests run by a task, including why their failed, the test configurations, and any artifacts produced.
