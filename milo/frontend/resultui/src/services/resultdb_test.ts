...
describe('createVariantPropGetter', () => {
  it('can create a status getter', async () => {
    const getter = createVariantPropGetter('status');
  ...
  it('can create a name getter', async () => {
    const getter = createVariantPropGetter('Name');
  ...
  it('can create a variant getter', async () => {
    const getter = createVariantPropGetter('v.variant_key');
