...
const SERVICE = 'buildbucket.v2.Builds';
...
export class Buildbucket {
  ...
  async getBuild(req: GetBuildRequest): Promise<Build> {
  ...
  async permittedActions(req: PermittedActionsRequest): Promise<PermittedActionsResponse> {
    return this.prpcClient.call(
      'access.Access',
      'PermittedActions',
      req,
