 ...
 *
 * Fields that are not intended to use in the frontend are excluded.
 */
...
/**
 * A helper class for querying Milo backend.
 */
export class Milo {
  ...
  async getBuildPageData(req: GetBuildPageDataRequest) {
    const res = await fetch(
      `/p/${req.builder.project}/builders/${req.builder.bucket}/${req.builder.builder}/${req.build_number}/data`,
