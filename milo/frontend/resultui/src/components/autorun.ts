...
/**
 * A simple element that re-renders the component automatically when its
 * observable dependencies are updated.
 *
...
export class AutorunElement extends MobxLitElement {
