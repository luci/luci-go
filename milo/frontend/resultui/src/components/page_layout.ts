  ...
  protected render() {
    return html`
      ...
      <a
        ...
        title="Send Feedback"
        target="_blank"
        href="https://bugs.chromium.org/p/chromium/issues/entry?template=Build%20Infrastructure&components=Infra%3EPlatform%3EMilo%3EResultUI&labels=Pri-2&comment=Please+enter+a+description+of+the+problem,+with+repro+steps+if+applicable"
      >
