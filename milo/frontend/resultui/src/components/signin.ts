import { css, customElement, html, LitElement, property, PropertyValues, svg } from 'lit-element';
 ...
 *
 * @property gAuth: gapi.auth2.GoogleAuth You must provide a GoogleAuth instance.
...
export class SignInElement extends LitElement {
  @property() gAuth!: gapi.auth2.GoogleAuth;
  ...
  protected update(changedProperties: PropertyValues) {
    if (changedProperties.has('gAuth')) {
