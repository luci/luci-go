      ...
      <div>
        ...
        <div id="body">
          ...
          <div id="content" style=${styleMap({display: this.expanded ? '' : 'none'})}>
            ...
            <tr-result-entry .testResult=${r} .expanded=${this.singleChild || !r.expected}></tr-result-entry>
            `)}
            ${repeat(this.variant!.exonerations, (e) => e.exonerationId, (e) => html`
            <tr-exoneration-entry .testExoneration=${e} .expanded=${this.singleChild}></tr-exoneration-entry>
            `)}
          </div>
        </div>
      </div>
