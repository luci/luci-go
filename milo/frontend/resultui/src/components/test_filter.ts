...
export class TestFilterElement extends MobxLitElement {
  ...
  @computed private get unexpectedTVCount() {
  ...
  @computed private get flakyTVCount() {
  ...
  @computed private get exoneratedTVCount() {
  ...
  @computed private get expectedTVCount() {
    ...
    return html`
      ...
      <div class="filter">
        ...
        <label for="unexpected" style="color: var(--failure-color);">
          Unexpected (${this.unexpectedTVCount})
        </label>
      </div class="filter">
      <div class="filter">
        <input
        ...
        >
        <label for="flaky" style="color: var(--warning-color);">Flaky (${this.flakyTVCount})</label>
      </div class="filter">
      <div class="filter">
        <input
          type="checkbox"
        ...
        >
        <label for="exonerated" style="color: var(--exonerated-color);">Exonerated (${this.exoneratedTVCount})</label>
      </div class="filter">
      <div class="filter">
        <input
          type="checkbox"
        ...
        >
      <label for="expected" style="color: var(--success-color);">Expected (${this.expectedTVCount})</label>
      </div class="filter">
    `;
  }
