...
export class TestFilterElement extends MobxLitElement {
  ...
  @computed private get testFilters() { return this.userConfigs.testFilters; }
    ...
    return html`
      ...
      <div class="filter">
        <input
          type="checkbox"
          id="expected"
          @change=${(v: MouseEvent) => this.testFilters.showExpected = (v.target as HTMLInputElement).checked} ?checked=${this.testFilters.showExpected}>
      ...
      <div class="filter">
        <input
          type="checkbox"
          id="exonerated"
          @change=${(v: MouseEvent) => this.testFilters.showExonerated = (v.target as HTMLInputElement).checked} ?checked=${this.testFilters.showExonerated}>
      ...
      <div class="filter">
        <input
          type="checkbox"
          id="flaky"
          @change=${(v: MouseEvent) => this.testFilters.showFlaky = (v.target as HTMLInputElement).checked} ?checked=${this.testFilters.showFlaky}>
