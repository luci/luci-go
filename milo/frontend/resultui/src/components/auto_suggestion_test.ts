...
import { AutoSuggestionElement, Suggestion } from './auto_suggestion';
...
describe('auto_suggestion_test', () => {
  let autoSuggestionEle: AutoSuggestionElement;
  let inputEle: HTMLInputElement;
  let suggestionSpy: SinonSpy<[Suggestion], void>;
  before(async () => {
    autoSuggestionEle = await fixture<AutoSuggestionElement>(html`
      <milo-auto-suggestion
          .value=${'search text'}
