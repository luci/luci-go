 ...
 *
 * @returns [results, isLastBatch]. isLastBatch can be used to tell whether
 * this is the last page without loading the next page.
 */
 ...
 *
 * @returns [exonerations, isLastBatch]. isLastBatch can be used to tell whether
 * this is the last page without loading the next page.
 */
 ...
 *
 * @returns [tests, isLastBatch]. isLastBatch can be used to tell whether
 * this is the last page without loading the next page.
 */
