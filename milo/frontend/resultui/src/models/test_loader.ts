...
export class TestLoader {
  ...
  @computed get firstPageLoaded() {
    return this.unfilteredNonExpectedVariants.length > 0 || this.loadedAllUnexpectedVariants;
  }
  @computed get firstPageIsEmpty() {
    return this.loadedAllUnexpectedVariants && this.unfilteredNonExpectedVariants.length === 0;
  }
