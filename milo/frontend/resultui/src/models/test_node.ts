...
export class TestNode {
  ...
  /**
   * Contains all tests belonging to this node and its decendants.
   ...
   * The tree is not grown until this.branchUnbranchedTests() is called.
  ...
  addTest(test: ReadonlyTest) {
    ...
    // Without this, nodes may be incorrectly elided when there's a testId that ends whith /\W/.
  ...
  /**
   * Converts all unbranched tests in this node into branches of this node.
   * Recursively calls this method on its desecendants if they are elided into this node.
   */
  @action
