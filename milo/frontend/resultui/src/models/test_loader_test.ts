...
import { streamTestExonerations, streamTestObjects, streamTestResults, streamTests, TestLoader } from './test_loader';
  ...
  describe('streamTestObject', () => {
    it('should merge result and exoneration streams sorted by test ID', async () => {
      ...
      const testObjects = [
        ...
        testExoneration1,
        testResult2,
        testExoneration2,  // when testId is the same, exonerations should come after results.
        testExoneration3,
        testResult3,
      ];
      ...
      let i = 0;
      for await (const testObject of streamTestObjects(tesultIter, exonerationIter)) {
