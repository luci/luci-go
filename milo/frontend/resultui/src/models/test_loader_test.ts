  ...
  describe('TestLoader', () => {
    ...
    beforeEach(() => {
      ...
      testLoader = new TestLoader(
        ...
        (async function*() {
          yield {value: [test1, test2], isLast: false};
          yield {value: [test3, test4], isLast: false};
          yield {value: [test5], isLast: true};
        })(),
      );
    });
  ...
  describe('streamTestResultBatches', () => {
    it('should stream test results from multiple pages', async () => {
      ...
      const expectedTestResultBatches = [
        {value: [testResult1, testResult2, testResult3, testResult4, testResult5], isLast: false},
        {value: [testResult6, testResult7], isLast: true},
      ];
      let i = 0;
  ...
  describe('streamTestExoneration', () => {
    it('should stream test exonerations from multiple pages', async () => {
      ...
      const expectedTestExonerationBatches = [
        {value: [testExoneration1, testExoneration2, testExoneration3], isLast: false},
        {value: [testExoneration4, testExoneration5], isLast: true},
      ];
      let i = 0;
  ...
  describe('streamTestBatches', () => {
    it('can group test results and exonerations into tests correctly', async () => {
      const resultIter = (async function*() {
        yield {value: [testResult1, testResult2, testResult3], isLast: false};
        yield {value: [testResult4, testResult5, testResult6], isLast: false};
        yield {value: [testResult7, testResult8], isLast: true};
      })();
      const exonerationIter = (async function*() {
        yield {value: [testExoneration1, testExoneration2, testExoneration3], isLast: false};
        yield {value: [testExoneration4, testExoneration5], isLast: true};
      })();
      const expectedTestBatches: ReadonlyTest[] = [];
      for await (const {value: tests} of streamTestBatches(resultIter, exonerationIter)) {
