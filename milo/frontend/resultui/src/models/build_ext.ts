...
export class BuildExt {
  ...
  @computed get pendingDuration(): Duration | null {
    return this.startTime ? this.startTime.diff(this.createTime): null;
  }

  @computed get executionDuration(): Duration | null {
    return this.endTime ? this.endTime.diff(this.startTime!) : null;
  }
}
