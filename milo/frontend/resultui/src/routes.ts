              ...
              children: [
                {
                  ...
                  action: async (_ctx, _cmd) => {
                    await import(/* webpackChunkName: "test_results_tab" */ './pages/invocation_page/test_results_tab');
                    const ele = document.createElement('tr-test-results-tab');
                    return ele;
                  },
                },
                {
                  path: '/details',
                  name: 'invocation-details-tab',
                  action: async (_ctx, cmd) => {
                    await import(/* webpackChunkName: "test_results_tab" */ './pages/invocation_page/invocation_details_tab');
