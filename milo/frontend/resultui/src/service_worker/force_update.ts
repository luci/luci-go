 ...
 * doesn't disconnect the clients. This means it could be difficult to discover
 * the way to receive bug fixes in the new version if the users are on a broken
 * release.
 *
