...
/**
 * Prefetches resources if the url matches certain condition.
 */
function prefetchResources(reqUrl: URL) {
  prefetchBuildResources(reqUrl);
  prefetchArtifactResources(reqUrl);
}

/**
 * Prefetches the build if the url matches certain condition.
 */
async function prefetchBuildResources(reqUrl: URL) {
...
/**
 * Prefetches the artifact if the url matches certain condition.
 */
async function prefetchArtifactResources(reqUrl: URL) {
