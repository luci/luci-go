...
async function getAuthState() {
  ...
  // used when there's a slight delay before the access token is actually used.
  return cachedAuthState && cachedAuthState.expiresAt > Date.now() + 10000 ? cachedAuthState : null;
}
