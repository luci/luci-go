...
import { streamTestExonerations, streamTestObjects, streamTestResults, streamTests, TestLoader } from '../models/test_loader';
...
export class InvocationPageElement extends MobxLitElement implements BeforeEnterObserver {
  ...
  private get testIter(): AsyncIterableIterator<ReadonlyTest> {
    ...
    return streamTests(streamTestObjects(
  ...
  protected render() {
    return html`
      ...
      `}
      <tr-test-nav-tree .root=${this.testLoader.node}></tr-test-nav-tree>
    `;
  }
