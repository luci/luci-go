...
/**
 * Renders an image diff artifact.
 * Also fetches and renders the expected and actual images.
 */
  ...
  protected render() {
    return html`
      ...
      <tr-status-bar
        ...
        .loading=${this.expectedArtifactRes.state === 'pending' || this.actualArtifactRes.state === 'pending' || this.diffArtifactRes.state === 'pending'}
      ></tr-status-bar>
