...
import { getBotLink, getURLForGerritChange, getURLForGitilesCommit, getURLForSwarmingTask, isStepInteresting } from '../../libs/build_utils';
...
export class OverviewTabElement extends MobxLitElement {
  ...
  private renderSteps() {
    ...
    const nonSucceededSteps = (bpd.steps || [])
      ...
      .filter(([step, _stepNum]) => isStepInteresting(step));
