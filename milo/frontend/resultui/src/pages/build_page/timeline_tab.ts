...
export class TimelineTabElement extends MobxLitElement {
  ...
  @observable.ref rendered: boolean = false;
  ...
  @computed
  get shouldRenderedTimeline() {
    return  this.buildState.buildPageData != null && this.rendered;
  }

  private renderTimeline() {
    var container = this.shadowRoot!.getElementById('timeline')!;

   function groupTemplater(group: any, _: any, __: any) {
      return `
        <div>
    ...
    timeline.on('select', function(props: any) {
  ...
  // updated is called when the DOM has been rendered.
  protected updated(_: any) {
    this.rendered = true;
  }
}
