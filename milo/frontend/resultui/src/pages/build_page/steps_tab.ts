...
export class StepsTabElement extends MobxLitElement {
  ...
  @computed private get noDisplayedStep() {
    if (this.userConfigs.showSucceededSteps) {
    ...
    return html`
        ...
        <div class="filters-container">
          ...
          <div class="filter">
            <input
              id="succeeded"
              type="checkbox"
              ?checked=${this.userConfigs.showSucceededSteps}
              @change=${(e: MouseEvent) => this.userConfigs.showSucceededSteps = (e.target as HTMLInputElement).checked}
            >
        ...
        <div class="filters-container">
          ...
          <div class="filter">
            <input
              ...
              type="checkbox"
              ?checked=${this.userConfigs.showDebugLogs}
              @change=${(e: MouseEvent) => this.userConfigs.showDebugLogs = (e.target as HTMLInputElement).checked}
            >
      ...
      <div id="main">
        ...
        <milo-build-step-entry
          style=${styleMap({'display': step.status !== BuildStatus.Success || this.userConfigs.showSucceededSteps ? '' : 'none'})}
        ...
        >
          ${this.userConfigs.showSucceededSteps ? 'No steps.' : 'All steps succeeded.'}
        </div>
