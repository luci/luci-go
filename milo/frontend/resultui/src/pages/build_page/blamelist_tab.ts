...
export class BlamelistTabElement extends MobxLitElement {
  ...
  @observable.ref private precedingCommit: GitCommit|null = null;
  ...
  @computed
  private get revisionRange(): string|null {
      return this.endOfPage ? this.precedingCommit!.id.substring(0, 12) + '..' + this.latestCommitId!.substring(0, 12) : null;
  }

  @computed
  private get blamelistSummary(): string {
  ...
  @computed get gitilesLink(): string|null {
