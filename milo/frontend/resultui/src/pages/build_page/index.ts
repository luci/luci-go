        ...
        : [
            {
              ...
              href: router.urlForName(
                this.configsStore.userConfigs.results.newLayout ? 'build-test-results-new' : 'build-test-results',
                params
              ),
            },
          ]),
        ...
        <table>
          ...
          <tr>
            ...
            <td style="padding-left: 5px;">
              <input
                type="checkbox"
                ?checked=${this.uncommittedConfigs.results.newLayout}
                @change=${() =>
                  (this.uncommittedConfigs.results.newLayout = !this.uncommittedConfigs.results.newLayout)}
              />
            </td>
          </tr>
