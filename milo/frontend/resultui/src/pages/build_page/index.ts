...
export class BuildPageElement extends MobxLitElement implements BeforeEnterObserver {
  ...
  // When buildIdParam is set, the page is visited via a short link.
  ...
  connectedCallback() {
    ...
    this.disposers.push(reaction(
      ...
      () => {
        ...
        if (this.buildIdParam) {
          this.buildState.buildNumOrId = 'b' + this.buildIdParam;
        } else {
    ...
    if (this.buildIdParam) {
      ...
      // Rendering related reactions are not needed.
      return;
    }
