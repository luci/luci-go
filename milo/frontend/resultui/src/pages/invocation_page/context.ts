...
import { IsLast, streamTestBatches, streamTestExonerationBatches, streamTestResultBatches, TestLoader } from '../../models/test_loader';
...
export class InvocationPageState {
  ...
  @computed
  private get testIter(): AsyncIterableIterator<IsLast<ReadonlyTest[]>> {
    if (!this.appState?.resultDb) {
