...
export class TestResultsTabElement extends MobxLitElement {
  ...
  @computed get displayedUnexpectedVariant() {
  ...
  @computed get displayedFlakyVariant() {
  ...
  @computed get displayedExoneratedVariant() {
  ...
  @computed get displayedExpectedVariant() {
  ...
  private get totalDisplayedVariantCount() {
    return this.displayedUnexpectedVariant.length +
      this.displayedFlakyVariant.length +
      this.displayedExoneratedVariant.length +
      this.displayedExpectedVariant.length;
  }
  ...
  private renderAllVariants() {
    return html`
      ${this.displayedUnexpectedVariant.length === 0 ? html`
      <div class="list-entry">No unexpected test results.</div>
      <hr class="divider">
      ` : html ``}
      ${this.renderIntegrationHint()}
      ${this.renderVariants(this.displayedUnexpectedVariant, true)}
      ${this.renderVariants(this.displayedFlakyVariant)}
      ${this.renderVariants(this.displayedExoneratedVariant)}
      ${this.renderVariants(this.displayedExpectedVariant)}
      ${this.renderLoadMore()}
    `;
  }
