  ...
  private renderIntegrationHint() {
    ...
    return this.configsStore.userConfigs.hints.showTestResultsHint && !state.testLoader.isLoading? html `
      <div class="list-entry">
        ...
        Known issues:
        <ul id="knownissues">
          <li>Test result tab is <a href="https://crbug.com/1114935">slow</a>.</li>
          <li>Sometimes all test failures <a href="https://crbug.com/1111683">are not displayed at first load <a>. You may need to click on "Load More" link.</li>
        </ul>
        <span
          id="hide-hint"
          @click=${() => {
