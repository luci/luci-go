  ...
  private renderAllVariants() {
    return html`
      ...
      ${this.renderVariants(
        ...
        this.invocationState.showUnexpectedVariant,
        (display) => this.invocationState.showUnexpectedVariant = display,
      ...
      ${this.renderVariants(
        ...
        this.invocationState.showFlakyVariant,
        (display) => this.invocationState.showFlakyVariant = display,
      ...
      ${this.renderVariants(
        ...
        this.invocationState.showExoneratedVariant,
        (display) => this.invocationState.showExoneratedVariant = display,
      ...
      ${this.renderVariants(
        ...
        this.invocationState.showExpectedVariant,
        (display) => this.invocationState.showExpectedVariant = display,
