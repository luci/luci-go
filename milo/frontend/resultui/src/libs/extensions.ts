...
declare global {
  interface Promise<T> {
     ...
     */
    toObservable(): IObservableValue<Tagged<'loading', null> | Tagged<'ok', T> | Tagged<'err', unknown>>;
  }
  /**
...
Promise.prototype.toObservable = function<T>(this: Promise<T>): IObservableValue<Tagged<'loading', null> | Tagged<'ok', T> | Tagged<'err', unknown>> {
  const ret = observable.box({tag: 'loading', v: null}, {deep: false}) as IObservableValue<Tagged<'loading', null> | Tagged<'ok', T> | Tagged<'err', unknown>>;
