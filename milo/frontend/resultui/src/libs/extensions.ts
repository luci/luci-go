...
declare global {
  interface Promise<T> {
     ...
     */
    toObservable(): IObservableValue<Tagged<'loading', null> | Tagged<'ok', T> | Tagged<'err', any>>;
  }
  /**
...
Promise.prototype.toObservable = function<T>(this: Promise<T>): IObservableValue<Tagged<'loading', null> | Tagged<'ok', T> | Tagged<'err', any>> {
  const ret = observable.box({tag: 'loading', v: null}, {deep: false}) as IObservableValue<Tagged<'loading', null> | Tagged<'ok', T> | Tagged<'err', any>>;
