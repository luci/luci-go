 ...
 * // Specify which context keys to consume. Params are type checked.
 * // Passing 'contextKey2' or 'contextKey3' will cause compilation error.
...
export function provideContext<K extends string, Ctx>(contextKey: K) {
  ...
  return function providerMixin<T extends LitElement & Record<K, Ctx>, C extends Constructor<T>>(cls: C) {
    ...
    // This can happens when applying the decorator multiple times.
