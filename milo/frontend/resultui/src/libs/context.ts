...
export function provider<Cls extends Constructor<LitElement>>(cls: Cls) {
  ...
  class Provider extends (cls as Constructor<LitElement>) {
    ...
    protected updated(changedProperties: PropertyValues) {
      ...
      // Subscribe events were fired in this.connectedCallback() and onCtxUpdate
      // callbacks were called immediately in the event handler.
...
/**
 * Marks a component as a content consumer.
 *
