...
class LazyRenderingElement extends LitElement implements RenderPlaceHolder {
  @provideNotifier notifier = new IntersectionNotifier({ root: this.parentElement });
...
describe('progressiveNotifier', () => {
  ...
  beforeEach(async () => {
    listView = await fixture<ProgressiveNotifierProviderElement>(html`
      <milo-progressive-rendering-notifier-provider-test style="height: 100px; overflow-y: auto;">
        ${new Array(100)
          .fill(0)
