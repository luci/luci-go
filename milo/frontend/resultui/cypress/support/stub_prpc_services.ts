...
function stubPrpcServices() {
  ...
  cy.stubRequests('https://cr-buildbucket-dev.appspot.com/prpc/**', 'buildbucket');
  cy.stubRequests('https://staging.results.api.cr.dev/prpc/**', 'resultdb');
  cy.stubRequests('https://localhost:8080/prpc/**', 'milo');
}
