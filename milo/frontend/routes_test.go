...
func buildbotBuilderTestData() []common.TestBundle {
	...
	sum := &ui.MiloBuild{
		Summary: ui.BuildComponent{Label: l},
		Trigger: &ui.Trigger{Commit: ui.Commit{Revision: ui.NewEmptyLink("deadbeef")}},
	}
		...
		},
		{
			...
			Data: templates.Args{
				"Builder": &ui.Builder{
					...
					CurrentBuilds:  []*ui.MiloBuild{sum},
					PendingBuilds:  []*ui.MiloBuild{sum},
					FinishedBuilds: []*ui.MiloBuild{sum},
				},
			},
		},
	}
