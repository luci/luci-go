...
func WithEmulationOptions(c context.Context, master, builder string, opt milo.EmulationOptions) context.Context {
	return WithEmulationOptionsProvider(c, func(m, b string) *milo.EmulationOptions {
...
// builder.
type EmulationOptionsProvider func(master, builder string) *milo.EmulationOptions
...
func WithEmulationOptionsProvider(c context.Context, provider EmulationOptionsProvider) context.Context {
	...
	if prev != nil {
		this := provider
		provider = func(master, builder string) *milo.EmulationOptions {
			if opt := this(master, builder); opt != nil {
				return opt
			}
...
func GetEmulationOptions(c context.Context, master, builder string) *milo.EmulationOptions {
	if p := c.Value(&emulationOptionsProviderKey); p != nil {
		return p.(EmulationOptionsProvider)(master, builder)
	}
	return nil
}
