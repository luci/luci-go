...
func attachRevisionInfo(c context.Context, b *buildbot.Build, bs *model.BuildSummary) error {
	funcs := map[string]func() (buildbucket.BuildSet, error){
