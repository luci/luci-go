...
func ImportMaster(c context.Context, master *buildbot.Master,
	...
	logging.Debugf(c, "Length of gzipped data: %d", len(entity.Data))
	// Limit for datastore_v3 is 1572864 bytes for the total datastore entity.
	if len(entity.Data) > 1024*1024 {
