...
func getLogDogAnnotationAddr(c context.Context, client *coordinator.Client, build *protocol.Build,
...
// name.
func mergeBuildIntoAnnotation(c context.Context, step *miloProto.Step, build *protocol.Build) error {
