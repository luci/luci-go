...
// clientFactory is a type that returns a buildbucket rpc client.
type clientFactory interface {
	getClient(c context.Context, host string, as auth.RPCAuthorityKind, opts ...auth.RPCOption) (buildbucketpb.BuildsClient, error)
}

type prodClientFactory struct{}

func (f prodClientFactory) getClient(c context.Context, host string, as auth.RPCAuthorityKind, opts ...auth.RPCOption) (buildbucketpb.BuildsClient, error) {
...
func WithProd(c context.Context) context.Context {
	return withClientFactory(c, &prodClientFactory{})
}
...
func buildbucketClient(c context.Context, host string, as auth.RPCAuthorityKind, opts ...auth.RPCOption) (buildbucketpb.BuildsClient, error) {
	...
	return factory.getClient(c, host, as, opts...)
}
