...
type mockClient struct {
	*buildbucketpb.MockBuildsClient
}

func (mc *mockClient) getClient(c context.Context, host string, as auth.RPCAuthorityKind, opts ...auth.RPCOption) (buildbucketpb.BuildsClient, error) {
	return mc.MockBuildsClient, nil
}
...
func newMockClient(c context.Context, t *testing.T) (context.Context, *gomock.Controller, *buildbucketpb.MockBuildsClient) {
	...
	return withClientFactory(c, &mockClient{client}), ctrl, client
}
