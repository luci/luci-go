...
type BuilderID struct {
	// Bucket is the name of the bucket the builder resides in.
	Bucket string

	// Builder is the name of the builder within the bucket.
	Builder string
}

func NewBuilderID(bucket, builder string) BuilderID {
	return BuilderID{
		Bucket:  bucket,
		Builder: builder,
	}
