...
// TODO(hinoka): BuildInfo requires this.  Remove this when buildbucket v2 is out.
...
func (b *BuildID) Get(c context.Context) (*ui.MiloBuild, error) {
	...
	// Add blame information.  If this fails, just add in a placeholder with an
	// error.
