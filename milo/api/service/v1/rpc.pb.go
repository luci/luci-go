...
type QueryBlamelistRequest struct {
	...
	// The output Gitiles commit of the build.
	// If output Gitiles commit isn't available, the caller can fallback to intput
	// Gitiles commit.
...
type QueryBlamelistPageToken struct {
	...
	// Hash of the original request, used to verify whether the parameters in the
	// new request match the original one.
	ReqHash string `protobuf:"bytes,1,opt,name=req_hash,json=reqHash,proto3" json:"req_hash,omitempty"`
...
func (x *QueryBlamelistPageToken) GetReqHash() string {
	if x != nil {
		return x.ReqHash
	}
	return ""
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5a, 0x0a, 0x17, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x42, 0x6c, 0x61, 0x6d, 0x65, 0x6c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x67,
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x19, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x5f, 0x68, 0x61,
	0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x65, 0x71, 0x48, 0x61, 0x73,
	0x68, 0x12, 0x24, 0x0a, 0x0e, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6e, 0x65, 0x78, 0x74, 0x43,
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49, 0x64, 0x32, 0x6d, 0x0a, 0x0c, 0x4d, 0x69, 0x6c, 0x6f, 0x49,
