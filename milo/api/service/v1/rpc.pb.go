...
type QueryBlamelistRequest struct {
	...
	//
	// When set to false (default), BuildSets will be used to find the closest
	// ancestor commit with an associated build.
	// When set to true, BlamelistPins will be used instead. Older builds may not
	// have blamelist pins populated.
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x82, 0x02, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x6c, 0x61, 0x6d, 0x65,
	...
	0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49, 0x64, 0x32, 0x6d, 0x0a, 0x0c, 0x4d, 0x69, 0x6c,
	...
	0x2f, 0x6d, 0x69, 0x6c, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2f, 0x76, 0x31, 0x3b, 0x6d, 0x69, 0x6c, 0x6f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_goTypes = []interface{}{
	...
	(*proto.GitilesCommit)(nil),     // 3: buildbucket.v2.GitilesCommit
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_depIdxs = []int32{
	...
	5, // 3: luci.milo.v1.QueryBlamelistResponse.preceding_commit:type_name -> git.Commit
	0, // 4: luci.milo.v1.MiloInternal.QueryBlamelist:input_type -> luci.milo.v1.QueryBlamelistRequest
	1, // 5: luci.milo.v1.MiloInternal.QueryBlamelist:output_type -> luci.milo.v1.QueryBlamelistResponse
