...
// A request message for `GetAuthState` RPC.
...
type GetAuthStateResponse struct {
	...
	// Identity string of the user (anonymous:anonymous if the user is not logged
	// in).
...
func (x *GetAuthStateResponse) GetIdentity() string {
	if x != nil {
		return x.Identity
	}
	return ""
...
func (x *GetAuthStateResponse) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *GetAuthStateResponse) GetPicture() string {
	if x != nil {
		return x.Picture
	}
	return ""
...
func (x *GetAuthStateResponse) GetAccessToken() string {
	if x != nil {
...
func (x *GetAuthStateResponse) GetAccessTokenExpiry() *timestamppb.Timestamp {
	if x != nil {
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x34, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f,
	...
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x33, 0x67,
	...
	0x6f, 0x72, 0x67, 0x2f, 0x6c, 0x75, 0x63, 0x69, 0x2f, 0x6d, 0x69, 0x6c, 0x6f, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x15, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x41, 0x75, 0x74,
	0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xd1, 0x01,
	0x0a, 0x14, 0x47, 0x65, 0x74, 0x41, 0x75, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	0x74, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x18, 0x05, 0x20, 0x01,
	...
	0x79, 0x22, 0x82, 0x02, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x6c, 0x61, 0x6d, 0x65,
	...
	0x65, 0x6e, 0x12, 0x32, 0x0a, 0x15, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x5f, 0x70, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x5f, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x13, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x53,
	0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x9f, 0x01, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x42, 0x6c, 0x61, 0x6d, 0x65, 0x6c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x25, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03,
	...
	,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x57, 0x0a, 0x0c, 0x47,
	0x65, 0x74, 0x41, 0x75, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x21, 0x2e, 0x6c, 0x75,
	0x63, 0x69, 0x2e, 0x6d, 0x69, 0x6c, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x75,
	0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22,
	0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x6d, 0x69, 0x6c, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65,
	0x74, 0x41, 0x75, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x00, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x6f,
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_goTypes = []interface{}{
	(*GetAuthStateRequest)(nil),     // 0: luci.milo.v1.GetAuthStateRequest
	(*GetAuthStateResponse)(nil),    // 1: luci.milo.v1.GetAuthStateResponse
	...
	(*GetProjectCfgRequest)(nil),    // 5: luci.milo.v1.GetProjectCfgRequest
	(*timestamppb.Timestamp)(nil),   // 6: google.protobuf.Timestamp
	(*proto.GitilesCommit)(nil),     // 7: buildbucket.v2.GitilesCommit
	(*proto.BuilderID)(nil),         // 8: buildbucket.v2.BuilderID
	(*git.Commit)(nil),              // 9: git.Commit
	(*config.Project)(nil),          // 10: milo.Project
}
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_depIdxs = []int32{
	6,  // 0: luci.milo.v1.GetAuthStateResponse.access_token_expiry:type_name -> google.protobuf.Timestamp
	7,  // 1: luci.milo.v1.QueryBlamelistRequest.gitiles_commit:type_name -> buildbucket.v2.GitilesCommit
	8,  // 2: luci.milo.v1.QueryBlamelistRequest.builder:type_name -> buildbucket.v2.BuilderID
	9,  // 3: luci.milo.v1.QueryBlamelistResponse.commits:type_name -> git.Commit
	9,  // 4: luci.milo.v1.QueryBlamelistResponse.preceding_commit:type_name -> git.Commit
	2,  // 5: luci.milo.v1.MiloInternal.QueryBlamelist:input_type -> luci.milo.v1.QueryBlamelistRequest
	0,  // 6: luci.milo.v1.MiloInternal.GetAuthState:input_type -> luci.milo.v1.GetAuthStateRequest
	5,  // 7: luci.milo.v1.MiloInternal.GetProjectCfg:input_type -> luci.milo.v1.GetProjectCfgRequest
	3,  // 8: luci.milo.v1.MiloInternal.QueryBlamelist:output_type -> luci.milo.v1.QueryBlamelistResponse
	1,  // 9: luci.milo.v1.MiloInternal.GetAuthState:output_type -> luci.milo.v1.GetAuthStateResponse
	10, // 10: luci.milo.v1.MiloInternal.GetProjectCfg:output_type -> milo.Project
...
func file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAuthStateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type MiloInternalClient interface {
	...
	// anonymous user.
	GetAuthState(ctx context.Context, in *GetAuthStateRequest, opts ...grpc.CallOption) (*GetAuthStateResponse, error)
...
func (c *miloInternalPRPCClient) GetAuthState(ctx context.Context, in *GetAuthStateRequest, opts ...grpc.CallOption) (*GetAuthStateResponse, error) {
	out := new(GetAuthStateResponse)
	err := c.client.Call(ctx, "luci.milo.v1.MiloInternal", "GetAuthState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *miloInternalClient) GetAuthState(ctx context.Context, in *GetAuthStateRequest, opts ...grpc.CallOption) (*GetAuthStateResponse, error) {
	out := new(GetAuthStateResponse)
	err := c.cc.Invoke(ctx, "/luci.milo.v1.MiloInternal/GetAuthState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MiloInternalServer interface {
	...
	// Return the current user if user is logged in. Otherwise, return an
	// anonymous user.
	GetAuthState(context.Context, *GetAuthStateRequest) (*GetAuthStateResponse, error)
	// Gets the project config.
	//
	// Return the config of the project.
...
func (*UnimplementedMiloInternalServer) GetAuthState(context.Context, *GetAuthStateRequest) (*GetAuthStateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAuthState not implemented")
}
...
func _MiloInternal_GetAuthState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAuthStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MiloInternalServer).GetAuthState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/luci.milo.v1.MiloInternal/GetAuthState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MiloInternalServer).GetAuthState(ctx, req.(*GetAuthStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MiloInternal_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MiloInternal_GetAuthState_Handler,
		},
		{
