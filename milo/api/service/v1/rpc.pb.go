...
type QueryBlamelistRequest struct {
	...
	// A page token, received from a previous `QueryBlamelist` call.
	// Provide this to retrieve the subsequent page.
	//
	// When paginating, all other parameters provided to `QueryBlamelist` must
...
type QueryBlamelistResponse struct {
	...
	// The commits from the blamelist of the build.
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x65, 0x0a, 0x04, 0x4d,
	0x69, 0x6c, 0x6f, 0x12, 0x5d, 0x0a, 0x0e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x6c, 0x61, 0x6d,
...
var file_go_chromium_org_luci_milo_api_service_v1_rpc_proto_depIdxs = []int32{
	2, // 0: luci.milo.v1.QueryBlamelistRequest.gitiles_commit:type_name -> buildbucket.v2.GitilesCommit
	3, // 1: luci.milo.v1.QueryBlamelistRequest.builder:type_name -> buildbucket.v2.BuilderID
	4, // 2: luci.milo.v1.QueryBlamelistResponse.commits:type_name -> git.Commit
	0, // 3: luci.milo.v1.Milo.QueryBlamelist:input_type -> luci.milo.v1.QueryBlamelistRequest
	1, // 4: luci.milo.v1.Milo.QueryBlamelist:output_type -> luci.milo.v1.QueryBlamelistResponse
...
// MiloClient is the client API for Milo service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type MiloClient interface {
...
type miloPRPCClient struct {
	client *prpc.Client
}

func NewMiloPRPCClient(client *prpc.Client) MiloClient {
	return &miloPRPCClient{client}
}

func (c *miloPRPCClient) QueryBlamelist(ctx context.Context, in *QueryBlamelistRequest, opts ...grpc.CallOption) (*QueryBlamelistResponse, error) {
	out := new(QueryBlamelistResponse)
	err := c.client.Call(ctx, "luci.milo.v1.Milo", "QueryBlamelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func NewMiloClient(cc grpc.ClientConnInterface) MiloClient {
	return &miloClient{cc}
}

func (c *miloClient) QueryBlamelist(ctx context.Context, in *QueryBlamelistRequest, opts ...grpc.CallOption) (*QueryBlamelistResponse, error) {
	out := new(QueryBlamelistResponse)
	err := c.cc.Invoke(ctx, "/luci.milo.v1.Milo/QueryBlamelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// MiloServer is the server API for Milo service.
type MiloServer interface {
	// Retrieves blamelist of a build.
	//
	// The blamelist of a build is defined as [end_commit, start_commit),
	// where end_commit is the last commit of the build,
...
// UnimplementedMiloServer can be embedded to have forward compatible implementations.
type UnimplementedMiloServer struct {
}

func (*UnimplementedMiloServer) QueryBlamelist(context.Context, *QueryBlamelistRequest) (*QueryBlamelistResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryBlamelist not implemented")
}

func RegisterMiloServer(s prpc.Registrar, srv MiloServer) {
	s.RegisterService(&_Milo_serviceDesc, srv)
}

func _Milo_QueryBlamelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryBlamelistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MiloServer).QueryBlamelist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/luci.milo.v1.Milo/QueryBlamelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MiloServer).QueryBlamelist(ctx, req.(*QueryBlamelistRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Milo_serviceDesc = grpc.ServiceDesc{
	ServiceName: "luci.milo.v1.Milo",
	HandlerType: (*MiloServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "QueryBlamelist",
			Handler:    _Milo_QueryBlamelist_Handler,
		},
	},
