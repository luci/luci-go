...
// ExternalConsole allows users to include consoles from other projects.
// When listing consoles on the project page, external consoles will be listed
// amongst native consoles, sorted by console ID.
type ExternalConsole struct {
	// Id is the reference to the console in this project. The console will be
	// visible at the following URL: /p/<Project>/g/<ID>/console.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
