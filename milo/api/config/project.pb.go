...
func (*Project) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{0}
}
...
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{1}
}
...
func (*Oncall) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{2}
}
...
func (*LinkGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{3}
}
...
func (*ConsoleSummaryGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{4}
}
...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{5}
}
...
type Console struct {
	...
	// Refs are the refs to pull commits from when displaying the console. Users
	// can specify a regular expression to match several refs using "regexp:"
	// prefix, but the regular expression should have a literal prefix with at
	// least two slashes present, e.g. "refs/release-\d+/foobar" is not allowed,
	// because the literal prefix "refs/release-" only contains one slash. The
	// regexp should not start with ^ or end with $ as they will be added
	// automatically. Eg. refs/heads/master, regexp:refs/branch-heads/\d+.\d+
...
func (*Console) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{6}
}
...
func (*Builder) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_d65671aaefb37721, []int{7}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/milo/api/config/project.proto", fileDescriptor_project_d65671aaefb37721)
}

var fileDescriptor_project_d65671aaefb37721 = []byte{
