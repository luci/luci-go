...
// BuildBugTemplate defines how to make a custom feedback link to use on
// build pages to file a Monorail bug. The intention is for this to be used
// to insert a bug into a triage queue. The summary and description fields
// of these links are interpolated with values specific to the build.
