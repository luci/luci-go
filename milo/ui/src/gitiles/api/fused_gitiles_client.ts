 ...
 * position.
 */
export type PositionLogRequest = LogRequest & {
  /**
...
function createBaseLogRequest(): PositionLogRequest {
  return {
    project: '',
    ref: '',
    position: '',
...
export const PositionLogRequest = {
  fromPartial(object: DeepPartial<PositionLogRequest>): PositionLogRequest {
...
export class FusedGitilesClientImpl {
   ...
   */
  async Log(request: PositionLogRequest): Promise<LogResponse> {
    if (request.committish) {
      return this.miloClient.ProxyGitilesLog({
        ...
        // `PositionLogRequest`.
        request: LogRequest.fromPartial(request),
      });
    }
    ...
    return this.miloClient.ProxyGitilesLog({
      host: this.rpc.host,
      request: LogRequest.fromPartial({
        ...request,
