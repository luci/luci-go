...
import { SelectedChip_OLD as SelectedChip } from './selected_chip_OLD';
...
export const SearchBar_OLD = forwardRef<
  HTMLInputElement,
  SearchBarProps<unknown>
      ...
      <SelectedChip
        dropdownContent={(
          ...
          switch (option.type) {
            ...
            default:
              throw new Error(`Type ${option.type} not supported by SearchBar`);
          }
        }}
        enableSearchInput={
          option.type !== 'date' &&
