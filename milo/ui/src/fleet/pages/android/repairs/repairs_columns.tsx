  ...
  peak_usage: {
    ...
    Cell: (x) => (
      ...
      >
        ...
        {(x.cell.getValue() as number) >= 0 && x.row.original.total_devices && (
          <Typography variant="caption" sx={{ color: colors.grey[500] }}>
            (
            {
              ...
              ((x.cell.getValue() as number) / x.row.original.total_devices <= 1
                ? (x.cell.getValue() as number) / x.row.original.total_devices
                : 1
