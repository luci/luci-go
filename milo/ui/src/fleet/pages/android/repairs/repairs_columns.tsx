...
export const getRepairsColumns = (
  columnIds: string[],
): MRT_ColumnDef<Row>[] => {
  const columnsMap: Record<string, MRT_ColumnDef<Row>> = {
    priority: {
  ...
  return columnIds.map((id) => columnsMap[id]).filter(Boolean);
};
