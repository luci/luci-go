...
export enum COMMON_MESSAGES {
  ...
  CHART_CONFIG_CHANGED = 'The chart configuration has changed. Please click on a point to view invocation details.',
  CLEAR_ALL_FILTERS = 'Clear all filters',
  CLEAR_CLIPBOARD = 'Clear copied filters',
  CLICK_POINT_TO_VIEW_SAMPLES = 'Click the point to view invocation details',
  CLOSE = 'Close',
  COLOR = 'Color',
  COLUMN = 'Column',
  COPY = 'COPY',
  ...
  HOURS = 'hours',
  HOUR_ONE = 'hour',
  INVOCATION_DETAILS = 'Invocation Details',
  LAST = 'Last',
  LOAD_MORE = 'Load More',
  LOADING = 'Loading...',
