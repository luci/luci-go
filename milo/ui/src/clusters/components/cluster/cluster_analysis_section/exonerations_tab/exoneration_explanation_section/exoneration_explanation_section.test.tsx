...
describe('Test ExonerationExplanationSection', () => {
  it('shows statistics related to test flakiness', async () => {
    ...
    expect(
      await screen.findByTestId('flaky_criteria_met_chip'),
    ).toHaveTextContent('Not met');
    ...
    expect(
      await screen.findByTestId('failure_criteria_met_chip'),
    ).toHaveTextContent('Not met');
