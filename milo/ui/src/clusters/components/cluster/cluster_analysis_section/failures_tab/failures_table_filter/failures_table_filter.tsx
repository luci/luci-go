          ...
          <FormControl fullWidth data-testid="failure_filter">
            ...
            <Select
              ...
              renderValue={(value) => (
                <strong>
                  Only{' '}
                  {metrics.find((m) => m.metricId === value)?.humanReadableName}
                </strong>
              )}
            >
        ...
        <Grid item xs={6}>
          <FormControl fullWidth data-testid="group_by">
            ...
            <Select
              ...
              value={selectedVariantGroups.filter((key) =>
                variantGroups.some((vg) => vg.key === key),
              )}
            ...
            >
              {variantGroups.map((variantGroup) => (
                <MenuItem key={variantGroup.key} value={variantGroup.key}>
