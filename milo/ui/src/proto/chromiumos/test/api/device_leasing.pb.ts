...
export const VMRequirements = {
  encode(message: VMRequirements, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.gceImage !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VMRequirements {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          message.gceDiskSize = longToString(reader.int64() as Long);
          continue;
        case 12:
          if (tag !== 98) {
            break;
...
export const HardwareRequirements = {
  encode(message: HardwareRequirements, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.schedulableLabels).forEach(([key, value]) => {
      HardwareRequirements_SchedulableLabelsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
    return writer;
  },
...
export const HardwareRequirements_LabelValues = {
  encode(message: HardwareRequirements_LabelValues, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): HardwareRequirements_LabelValues {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const HardwareRequirements_SchedulableLabelsEntry = {
  encode(message: HardwareRequirements_SchedulableLabelsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      HardwareRequirements_LabelValues.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): HardwareRequirements_SchedulableLabelsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExtendLeaseRequest = {
  encode(message: ExtendLeaseRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.leaseId !== "") {
      writer.uint32(10).string(message.leaseId);
    }
    if (message.extendDuration !== undefined) {
      Duration.encode(message.extendDuration, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExtendLeaseRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExtendLeaseResponse = {
  encode(message: ExtendLeaseResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.leaseId !== "") {
      writer.uint32(10).string(message.leaseId);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExtendLeaseResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
