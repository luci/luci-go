...
export const Device = {
  encode(message: Device, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.hardwareReqs !== undefined) {
      HardwareRequirements.encode(message.hardwareReqs, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
...
export const DeviceAddress = {
  encode(message: DeviceAddress, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.host !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeviceAddress {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeviceLeaseRecord = {
  encode(message: DeviceLeaseRecord, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    ...
    if (message.leasedTime !== undefined) {
      Timestamp.encode(toTimestamp(message.leasedTime), writer.uint32(50).fork()).ldelim();
    }
    if (message.releasedTime !== undefined) {
      Timestamp.encode(toTimestamp(message.releasedTime), writer.uint32(58).fork()).ldelim();
    }
    ...
    if (message.lastUpdatedTime !== undefined) {
      Timestamp.encode(toTimestamp(message.lastUpdatedTime), writer.uint32(74).fork()).ldelim();
    }
    Object.entries(message.requestParameters).forEach(([key, value]) => {
      DeviceLeaseRecord_RequestParametersEntry.encode({ key: key as any, value }, writer.uint32(82).fork()).ldelim();
    });
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): DeviceLeaseRecord {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeviceLeaseRecord_RequestParametersEntry = {
  encode(message: DeviceLeaseRecord_RequestParametersEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeviceLeaseRecord_RequestParametersEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LeaseDeviceRequest = {
  encode(message: LeaseDeviceRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.idempotencyKey !== "") {
    ...
    if (message.leaseDuration !== undefined) {
      Duration.encode(message.leaseDuration, writer.uint32(34).fork()).ldelim();
    }
    if (message.vmHostReqs !== undefined) {
      VMRequirements.encode(message.vmHostReqs, writer.uint32(42).fork()).ldelim();
    }
    if (message.hardwareDeviceReqs !== undefined) {
      HardwareRequirements.encode(message.hardwareDeviceReqs, writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): LeaseDeviceRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LeaseDeviceResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LeaseDeviceResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ReleaseDeviceRequest = {
  encode(message: ReleaseDeviceRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.leaseId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ReleaseDeviceRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ReleaseDeviceResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ReleaseDeviceResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
