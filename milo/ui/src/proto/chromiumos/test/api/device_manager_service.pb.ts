...
export interface DeviceLeaseRecord_UserPayloadEntry {
  readonly key: string;
  readonly value: string;
}
...
export interface ListDeviceLeasesRequest {
  /** i.e. DUT name, e.g. chromeos8-rowX-rackY-hostZ. */
  readonly deviceId?:
    | string
    | undefined;
  /** i.e. Asset ID, e.g. C1234567. */
  readonly dutId?:
    | string
    | undefined;
  /**
...
export interface ListDeviceLeasesResponse {
  /** List of lease records to be returned. */
  readonly leaseRecords: readonly DeviceLeaseRecord[];
  /**
   * A token, which can be sent as `page_token` to retrieve the next page. If
   * this field is omitted, there are no subsequent pages.
   */
...
export const DeviceLeaseRecord: MessageFns<DeviceLeaseRecord> = {
  encode(message: DeviceLeaseRecord, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.userPayload).forEach(([key, value]) => {
      DeviceLeaseRecord_UserPayloadEntry.encode({ key: key as any, value }, writer.uint32(98).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          const entry12 = DeviceLeaseRecord_UserPayloadEntry.decode(reader, reader.uint32());
          if (entry12.value !== undefined) {
            message.userPayload[entry12.key] = entry12.value;
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): DeviceLeaseRecord {
    return {
      ...
      requestParameters: isObject(object.requestParameters)
        ...
        : {},
      userPayload: isObject(object.userPayload)
        ? Object.entries(object.userPayload).reduce<{ [key: string]: string }>((acc, [key, value]) => {
          acc[key] = String(value);
          return acc;
        }, {})
        : {},
  ...
  toJSON(message: DeviceLeaseRecord): unknown {
    ...
    if (message.userPayload) {
      const entries = Object.entries(message.userPayload);
      if (entries.length > 0) {
        obj.userPayload = {};
        entries.forEach(([k, v]) => {
          obj.userPayload[k] = v;
  ...
  fromPartial(object: DeepPartial<DeviceLeaseRecord>): DeviceLeaseRecord {
    ...
    message.userPayload = Object.entries(object.userPayload ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
function createBaseDeviceLeaseRecord_UserPayloadEntry(): DeviceLeaseRecord_UserPayloadEntry {
  return { key: "", value: "" };
}

export const DeviceLeaseRecord_UserPayloadEntry: MessageFns<DeviceLeaseRecord_UserPayloadEntry> = {
  encode(message: DeviceLeaseRecord_UserPayloadEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeviceLeaseRecord_UserPayloadEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeviceLeaseRecord_UserPayloadEntry() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DeviceLeaseRecord_UserPayloadEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: DeviceLeaseRecord_UserPayloadEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<DeviceLeaseRecord_UserPayloadEntry>): DeviceLeaseRecord_UserPayloadEntry {
    return DeviceLeaseRecord_UserPayloadEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DeviceLeaseRecord_UserPayloadEntry>): DeviceLeaseRecord_UserPayloadEntry {
    const message = createBaseDeviceLeaseRecord_UserPayloadEntry() as any;
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          const entry7 = LeaseDeviceRequest_UserPayloadEntry.decode(reader, reader.uint32());
          if (entry7.value !== undefined) {
            message.userPayload[entry7.key] = entry7.value;
          }
          continue;
        }
      }
...
function createBaseLeaseDeviceRequest_UserPayloadEntry(): LeaseDeviceRequest_UserPayloadEntry {
  return { key: "", value: "" };
}

export const LeaseDeviceRequest_UserPayloadEntry: MessageFns<LeaseDeviceRequest_UserPayloadEntry> = {
  encode(message: LeaseDeviceRequest_UserPayloadEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LeaseDeviceRequest_UserPayloadEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLeaseDeviceRequest_UserPayloadEntry() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): LeaseDeviceRequest_UserPayloadEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: LeaseDeviceRequest_UserPayloadEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<LeaseDeviceRequest_UserPayloadEntry>): LeaseDeviceRequest_UserPayloadEntry {
    return LeaseDeviceRequest_UserPayloadEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<LeaseDeviceRequest_UserPayloadEntry>): LeaseDeviceRequest_UserPayloadEntry {
    const message = createBaseLeaseDeviceRequest_UserPayloadEntry() as any;
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
function createBaseListDeviceLeasesRequest(): ListDeviceLeasesRequest {
  return { deviceId: undefined, dutId: undefined, pageSize: 0, pageToken: "" };
}

export const ListDeviceLeasesRequest: MessageFns<ListDeviceLeasesRequest> = {
  encode(message: ListDeviceLeasesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.deviceId !== undefined) {
      writer.uint32(10).string(message.deviceId);
    }
    if (message.dutId !== undefined) {
      writer.uint32(18).string(message.dutId);
    }
    if (message.pageSize !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListDeviceLeasesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListDeviceLeasesRequest() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ListDeviceLeasesRequest {
    return {
      deviceId: isSet(object.deviceId) ? globalThis.String(object.deviceId) : undefined,
      dutId: isSet(object.dutId) ? globalThis.String(object.dutId) : undefined,
      pageSize: isSet(object.pageSize) ? globalThis.Number(object.pageSize) : 0,
      pageToken: isSet(object.pageToken) ? globalThis.String(object.pageToken) : "",
    };
  },

  toJSON(message: ListDeviceLeasesRequest): unknown {
    const obj: any = {};
    if (message.deviceId !== undefined) {
      obj.deviceId = message.deviceId;
    }
  ...
  create(base?: DeepPartial<ListDeviceLeasesRequest>): ListDeviceLeasesRequest {
    return ListDeviceLeasesRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListDeviceLeasesRequest>): ListDeviceLeasesRequest {
    const message = createBaseListDeviceLeasesRequest() as any;
    message.deviceId = object.deviceId ?? undefined;
    message.dutId = object.dutId ?? undefined;
    message.pageSize = object.pageSize ?? 0;
    message.pageToken = object.pageToken ?? "";
    return message;
  },
...
function createBaseListDeviceLeasesResponse(): ListDeviceLeasesResponse {
  return { leaseRecords: [], nextPageToken: "" };
}

export const ListDeviceLeasesResponse: MessageFns<ListDeviceLeasesResponse> = {
  encode(message: ListDeviceLeasesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.leaseRecords) {
      DeviceLeaseRecord.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListDeviceLeasesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListDeviceLeasesResponse() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.leaseRecords.push(DeviceLeaseRecord.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): ListDeviceLeasesResponse {
    return {
      leaseRecords: globalThis.Array.isArray(object?.leaseRecords)
        ? object.leaseRecords.map((e: any) => DeviceLeaseRecord.fromJSON(e))
        : [],
      nextPageToken: isSet(object.nextPageToken) ? globalThis.String(object.nextPageToken) : "",
    };
  },

  toJSON(message: ListDeviceLeasesResponse): unknown {
    const obj: any = {};
    if (message.leaseRecords?.length) {
      obj.leaseRecords = message.leaseRecords.map((e) => DeviceLeaseRecord.toJSON(e));
    }
    if (message.nextPageToken !== "") {
      obj.nextPageToken = message.nextPageToken;
    }
  ...
  create(base?: DeepPartial<ListDeviceLeasesResponse>): ListDeviceLeasesResponse {
    return ListDeviceLeasesResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListDeviceLeasesResponse>): ListDeviceLeasesResponse {
    const message = createBaseListDeviceLeasesResponse() as any;
    message.leaseRecords = object.leaseRecords?.map((e) => DeviceLeaseRecord.fromPartial(e)) || [];
    message.nextPageToken = object.nextPageToken ?? "";
    return message;
  },
};
...
export interface DeviceLeaseService {
  ...
  ListDeviceLeases(request: ListDeviceLeasesRequest): Promise<ListDeviceLeasesResponse>;
}
...
export class DeviceLeaseServiceClientImpl implements DeviceLeaseService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.ListDeviceLeases = this.ListDeviceLeases.bind(this);
  }
  LeaseDevice(request: LeaseDeviceRequest): Promise<LeaseDeviceResponse> {
  ...
  ListDeviceLeases(request: ListDeviceLeasesRequest): Promise<ListDeviceLeasesResponse> {
    const data = ListDeviceLeasesRequest.toJSON(request);
    const promise = this.rpc.request(this.service, "ListDeviceLeases", data);
    return promise.then((data) => ListDeviceLeasesResponse.fromJSON(data));
  }
}
