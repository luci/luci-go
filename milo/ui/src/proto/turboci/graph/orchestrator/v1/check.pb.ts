...
export interface Check_Result {
   ...
   */
  readonly attemptState?: StageAttemptState | undefined;
}
...
export const Check_Result: MessageFns<Check_Result> = {
  encode(message: Check_Result, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.attemptState !== undefined) {
      writer.uint32(48).int32(message.attemptState);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.attemptState = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  toJSON(message: Check_Result): unknown {
    ...
    if (message.attemptState !== undefined) {
      obj.attemptState = stageAttemptStateToJSON(message.attemptState);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Check_Result>): Check_Result {
    ...
    message.finalizedAt = (object.finalizedAt !== undefined && object.finalizedAt !== null)
      ...
      : undefined;
    message.attemptState = object.attemptState ?? undefined;
    return message;
  },
};
