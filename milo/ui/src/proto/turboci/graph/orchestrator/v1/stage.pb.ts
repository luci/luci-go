...
import {
  ...
  stageConcludedReasonFromJSON,
  stageConcludedReasonToJSON,
 ...
 * Attempt).
 */
export interface StageAttemptCurrentState {
  /**
...
export const Stage_Attempt: MessageFns<Stage_Attempt> = {
  encode(message: Stage_Attempt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.lastHeartbeat !== undefined) {
      Revision.encode(message.lastHeartbeat, writer.uint32(82).fork()).join();
    }
    if (message.state !== undefined) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.lastHeartbeat = Revision.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 24) {
  ...
  toJSON(message: Stage_Attempt): unknown {
    ...
    if (message.lastHeartbeat !== undefined) {
      obj.lastHeartbeat = Revision.toJSON(message.lastHeartbeat);
    }
    if (message.state !== undefined) {
  ...
  fromPartial(object: DeepPartial<Stage_Attempt>): Stage_Attempt {
    ...
    message.version = (object.version !== undefined && object.version !== null)
      ? Revision.fromPartial(object.version)
      : undefined;
    message.lastHeartbeat = (object.lastHeartbeat !== undefined && object.lastHeartbeat !== null)
      ? Revision.fromPartial(object.lastHeartbeat)
      : undefined;
    message.state = object.state ?? undefined;
...
export const StageAttemptCurrentState: MessageFns<StageAttemptCurrentState> = {
  encode(message: StageAttemptCurrentState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== undefined) {
      writer.uint32(8).int32(message.state);
    }
    if (message.version !== undefined) {
    ...
    if (message.updateStateBy !== undefined) {
      Timestamp.encode(toTimestamp(message.updateStateBy), writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StageAttemptCurrentState {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStageAttemptCurrentState() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.updateStateBy = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): StageAttemptCurrentState {
    return {
      state: isSet(object.state) ? stageAttemptStateFromJSON(object.state) : undefined,
      version: isSet(object.version) ? Revision.fromJSON(object.version) : undefined,
  ...
  toJSON(message: StageAttemptCurrentState): unknown {
    const obj: any = {};
    if (message.state !== undefined) {
      obj.state = stageAttemptStateToJSON(message.state);
    }
    ...
    if (message.updateStateBy !== undefined) {
      obj.updateStateBy = message.updateStateBy;
    }
    if (message.heartbeatBy !== undefined) {
  ...
  create(base?: DeepPartial<StageAttemptCurrentState>): StageAttemptCurrentState {
    return StageAttemptCurrentState.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<StageAttemptCurrentState>): StageAttemptCurrentState {
    const message = createBaseStageAttemptCurrentState() as any;
    message.state = object.state ?? undefined;
    message.version = (object.version !== undefined && object.version !== null)
      ? Revision.fromPartial(object.version)
