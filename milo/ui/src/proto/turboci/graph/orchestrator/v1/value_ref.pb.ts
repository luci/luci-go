...
export interface ValueRef {
  ...
  readonly inline?:
    ...
    | undefined;
  /**
   * If set, the reason the ValueData corresponding to this ValueRef's data was
  ...
  readonly omitReason?:
    ...
    | undefined;
  /**
   * Tags for this ValueRef as generated by the actor which wrote this ValueRef.
   *
   * These will be sorted and unique by `key`.
   *
   * Contained `values` will be sorted, unique and deduplicated by `data`,
   * retaining the widest-observed scope per `value`.
   */
...
export const ValueRef: MessageFns<ValueRef> = {
  encode(message: ValueRef, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.tags) {
      Tag.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
