...
import { Heartbeat } from "../models/heartbeat.pb";
...
export interface ChromeOsRecoveryData_DutData {
  ...
  /** The hardware related identifiers for android_desktop device. */
...
export interface BrowserDeviceData {
  ...
  readonly vm: VM | undefined;
  readonly stateRecord: StateRecord | undefined;
}
...
export const SendHeartbeatRequest: MessageFns<SendHeartbeatRequest> = {
  encode(_: SendHeartbeatRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SendHeartbeatRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSendHeartbeatRequest() as any;
  ...
  fromJSON(_: any): SendHeartbeatRequest {
    return {};
  },

  toJSON(_: SendHeartbeatRequest): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial(_: DeepPartial<SendHeartbeatRequest>): SendHeartbeatRequest {
    const message = createBaseSendHeartbeatRequest() as any;
    return message;
  },
};
...
export const ChromeOsRecoveryData_DutData: MessageFns<ChromeOsRecoveryData_DutData> = {
  encode(message: ChromeOsRecoveryData_DutData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hardwareDescriptorId !== "") {
      writer.uint32(58).string(message.hardwareDescriptorId);
    }
    if (message.mfgSkuId !== "") {
      writer.uint32(66).string(message.mfgSkuId);
    }
    return writer;
  },
...
function createBaseBrowserDeviceData(): BrowserDeviceData {
  return { host: undefined, vm: undefined, stateRecord: undefined };
}
...
export const BrowserDeviceData: MessageFns<BrowserDeviceData> = {
  encode(message: BrowserDeviceData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stateRecord !== undefined) {
      StateRecord.encode(message.stateRecord, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.stateRecord = StateRecord.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): BrowserDeviceData {
    return {
      host: isSet(object.host) ? MachineLSE.fromJSON(object.host) : undefined,
      vm: isSet(object.vm) ? VM.fromJSON(object.vm) : undefined,
      stateRecord: isSet(object.stateRecord) ? StateRecord.fromJSON(object.stateRecord) : undefined,
    };
  },
  ...
  toJSON(message: BrowserDeviceData): unknown {
    ...
    if (message.stateRecord !== undefined) {
      obj.stateRecord = StateRecord.toJSON(message.stateRecord);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<BrowserDeviceData>): BrowserDeviceData {
    ...
    message.host = (object.host !== undefined && object.host !== null)
      ...
      : undefined;
    message.vm = (object.vm !== undefined && object.vm !== null) ? VM.fromPartial(object.vm) : undefined;
    message.stateRecord = (object.stateRecord !== undefined && object.stateRecord !== null)
      ? StateRecord.fromPartial(object.stateRecord)
      : undefined;
    return message;
  },
};
...
export interface Fleet {
  ...
  /**
   * SendHeartbeat forces a heartbeat to be sent to pubsub.  This command is
   * intended to be called from a local command on a dev machine to force the
   * creation of a heartbeat event in a pubsub which will then be consumed by
   * the fleet console.
   */
  SendHeartbeat(request: SendHeartbeatRequest): Promise<Heartbeat>;
}
...
export class FleetClientImpl implements Fleet {
  ...
  SendHeartbeat(request: SendHeartbeatRequest): Promise<Heartbeat> {
    const data = SendHeartbeatRequest.toJSON(request);
    const promise = this.rpc.request(this.service, "SendHeartbeat", data);
    return promise.then((data) => Heartbeat.fromJSON(data));
  }
}
