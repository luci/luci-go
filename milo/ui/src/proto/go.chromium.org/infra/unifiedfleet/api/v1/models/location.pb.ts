...
export enum Zone {
  ...
  ZONE_MTV96 = 13,
  /**
   * ZONE_MTV97 - DEPRECATED "mtv97" // US-MTV-1950 // 1-144
   *
   * @deprecated
   */
  ZONE_MTV97 = 14,
  ...
  ZONE_SFP_84 = 98,
  /** ZONE_IAD65_BROWSER - "iad65_browser" // Zone for datacenter site IAD65 */
  ZONE_IAD65_BROWSER = 99,
  /**
   * ZONE_AT1 - ATC
   *
   * @deprecated
  ...
  ZONE_FL1 = 105,
  ZONE_FL2 = 106,
  /** ZONE_SFP_87 - "sfp_87" // Zone for SfP assets for partner // Testhaus ID:87; */
  ZONE_SFP_87 = 107,
  /**
   * ZONE_SFP_91 - ZONE_SFP_88 - intentionally skipped
   * ZONE_SFP_89 - intentionally skipped
   * ZONE_SFP_90 - intentionally skipped
   */
  ZONE_SFP_91 = 108,
  ...
  /** ZONE_SFP_97 - "sfp_97" // Zone for SfP assets for partner // Testhaus ID:97; */
  ZONE_SFP_97 = 111,
  /** ZONE_SFP_98 - "sfp_98" // Zone for SfP assets for partner // Testhaus ID:98; */
  ZONE_SFP_98 = 112,
  /** ZONE_SFP_101 - "sfp_101" // Zone for SfP assets for partner // Testhaus ID:101; */
  ZONE_SFP_101 = 113,
  /** ZONE_SFO32_ATC - "sfo32_atc" // US-SVL-CRSM1265 */
  ZONE_SFO32_ATC = 114,
  /** ZONE_SFO32_ACS - "sfo32_acs" // US-SVL-CRSM1265 */
  ZONE_SFO32_ACS = 115,
  /** ZONE_SFO32_WEAR - "sfo32_wear" // US-SVL-CRSM1265 */
  ZONE_SFO32_WEAR = 116,
  /** ZONE_SFO32_AUTO - "sfo32_auto" // US-SVL-CRSM1265 */
  ZONE_SFO32_AUTO = 117,
  /** ZONE_SFO32_TV - "sfo32_tv" // US-SVL-CRSM1265 */
  ZONE_SFO32_TV = 118,
  /** ZONE_SFO32_XR - "sfo32_xr" // US-SVL-CRSM1265 */
  ZONE_SFO32_XR = 119,
...
export function zoneFromJSON(object: any): Zone {
  switch (object) {
    ...
    case 99:
    case "ZONE_IAD65_BROWSER":
      return Zone.ZONE_IAD65_BROWSER;
    case 100:
    case "ZONE_AT1":
      return Zone.ZONE_AT1;
    case 101:
    case "ZONE_AT2":
      return Zone.ZONE_AT2;
    case 102:
    case "ZONE_AT3":
      return Zone.ZONE_AT3;
    case 103:
    case "ZONE_AT4":
      return Zone.ZONE_AT4;
    case 104:
    case "ZONE_AT5":
      return Zone.ZONE_AT5;
    case 105:
    case "ZONE_FL1":
      return Zone.ZONE_FL1;
    case 106:
    case "ZONE_FL2":
      return Zone.ZONE_FL2;
    case 107:
    case "ZONE_SFP_87":
      return Zone.ZONE_SFP_87;
    case 108:
    case "ZONE_SFP_91":
      return Zone.ZONE_SFP_91;
    case 109:
    case "ZONE_SFP_93":
    ...
    case 111:
    case "ZONE_SFP_97":
      return Zone.ZONE_SFP_97;
    case 112:
    case "ZONE_SFP_98":
      return Zone.ZONE_SFP_98;
    case 113:
    case "ZONE_SFP_101":
      return Zone.ZONE_SFP_101;
    case 114:
    case "ZONE_SFO32_ATC":
      return Zone.ZONE_SFO32_ATC;
    case 115:
    case "ZONE_SFO32_ACS":
      return Zone.ZONE_SFO32_ACS;
    case 116:
    case "ZONE_SFO32_WEAR":
      return Zone.ZONE_SFO32_WEAR;
    case 117:
    case "ZONE_SFO32_AUTO":
      return Zone.ZONE_SFO32_AUTO;
    case 118:
    case "ZONE_SFO32_TV":
      return Zone.ZONE_SFO32_TV;
    case 119:
    case "ZONE_SFO32_XR":
      return Zone.ZONE_SFO32_XR;
    case 120:
    case "ZONE_SFP_104":
...
export function zoneToJSON(object: Zone): string {
  switch (object) {
    ...
    case Zone.ZONE_SFP_84:
      return "ZONE_SFP_84";
    case Zone.ZONE_IAD65_BROWSER:
      return "ZONE_IAD65_BROWSER";
    case Zone.ZONE_AT1:
      return "ZONE_AT1";
    case Zone.ZONE_AT2:
      return "ZONE_AT2";
    ...
    case Zone.ZONE_FL2:
      return "ZONE_FL2";
    case Zone.ZONE_SFP_87:
      return "ZONE_SFP_87";
    case Zone.ZONE_SFP_91:
      return "ZONE_SFP_91";
    case Zone.ZONE_SFP_93:
      return "ZONE_SFP_93";
    case Zone.ZONE_ATL97_BROWSER:
      return "ZONE_ATL97_BROWSER";
    case Zone.ZONE_SFP_97:
      return "ZONE_SFP_97";
    case Zone.ZONE_SFP_98:
      return "ZONE_SFP_98";
    case Zone.ZONE_SFP_101:
      return "ZONE_SFP_101";
    case Zone.ZONE_SFO32_ATC:
      return "ZONE_SFO32_ATC";
    case Zone.ZONE_SFO32_ACS:
      return "ZONE_SFO32_ACS";
    case Zone.ZONE_SFO32_WEAR:
      return "ZONE_SFO32_WEAR";
    case Zone.ZONE_SFO32_AUTO:
      return "ZONE_SFO32_AUTO";
    case Zone.ZONE_SFO32_TV:
      return "ZONE_SFO32_TV";
    case Zone.ZONE_SFO32_XR:
...
export const Location: MessageFns<Location> = {
  encode(message: Location, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.lab !== 0) {
      writer.uint32(104).int32(message.lab);
    }
    if (message.city !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.lab = reader.int32() as any;
          continue;
        }
        case 14: {
          if (tag !== 114) {
