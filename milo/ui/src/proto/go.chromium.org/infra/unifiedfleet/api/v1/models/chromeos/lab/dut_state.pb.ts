...
export interface DutState {
  ...
  /** State for PASIT */
  readonly pasitState: PeripheralState;
...
export function dutState_GscChipFromJSON(object: any): DutState_GscChip {
  switch (object) {
    case 0:
    case "GSC_CHIP_UNKNOWN":
      return DutState_GscChip.GSC_CHIP_UNKNOWN;
    case 1:
    case "GSC_CHIP_H1":
      return DutState_GscChip.GSC_CHIP_H1;
    case 2:
    case "GSC_CHIP_DT":
      return DutState_GscChip.GSC_CHIP_DT;
    case 3:
    case "GSC_CHIP_NT":
      return DutState_GscChip.GSC_CHIP_NT;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum DutState_GscChip");
  }
}

export function dutState_GscChipToJSON(object: DutState_GscChip): string {
  switch (object) {
    case DutState_GscChip.GSC_CHIP_UNKNOWN:
      return "GSC_CHIP_UNKNOWN";
    case DutState_GscChip.GSC_CHIP_H1:
      return "GSC_CHIP_H1";
    case DutState_GscChip.GSC_CHIP_DT:
      return "GSC_CHIP_DT";
    case DutState_GscChip.GSC_CHIP_NT:
      return "GSC_CHIP_NT";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum DutState_GscChip");
  }
...
export const DutState: MessageFns<DutState> = {
  encode(message: DutState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.pasitState !== 0) {
      writer.uint32(288).int32(message.pasitState);
    }
