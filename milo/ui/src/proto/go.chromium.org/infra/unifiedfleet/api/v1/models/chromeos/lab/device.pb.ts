...
export interface DeviceUnderTest {
  ...
  /** Provide DUT/ATE labserver affinity */
  readonly ateHost: string;
  /**
   ...
   */
  readonly osRestriction: DeviceUnderTest_OSRestriction;
}
...
export enum DeviceUnderTest_OSRestriction {
  /** OSR_ANY - No restrictions by default. */
  OSR_ANY = 0,
  OSR_CHROMEOS_ONLY = 1,
  OSR_ANDROID_ONLY = 2,
}

export function deviceUnderTest_OSRestrictionFromJSON(object: any): DeviceUnderTest_OSRestriction {
  switch (object) {
    case 0:
    case "OSR_ANY":
      return DeviceUnderTest_OSRestriction.OSR_ANY;
    case 1:
    case "OSR_CHROMEOS_ONLY":
      return DeviceUnderTest_OSRestriction.OSR_CHROMEOS_ONLY;
    case 2:
    case "OSR_ANDROID_ONLY":
      return DeviceUnderTest_OSRestriction.OSR_ANDROID_ONLY;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum DeviceUnderTest_OSRestriction");
  }
}

export function deviceUnderTest_OSRestrictionToJSON(object: DeviceUnderTest_OSRestriction): string {
  switch (object) {
    case DeviceUnderTest_OSRestriction.OSR_ANY:
      return "OSR_ANY";
    case DeviceUnderTest_OSRestriction.OSR_CHROMEOS_ONLY:
      return "OSR_CHROMEOS_ONLY";
    case DeviceUnderTest_OSRestriction.OSR_ANDROID_ONLY:
      return "OSR_ANDROID_ONLY";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum DeviceUnderTest_OSRestriction");
  }
}
...
/** Devboard Type. */
export enum Devboard_DevboardType {
  DEVBOARD_TYPE_H1 = 0,
  DEVBOARD_TYPE_DT = 1,
  DEVBOARD_TYPE_NT = 2,
}

export function devboard_DevboardTypeFromJSON(object: any): Devboard_DevboardType {
  switch (object) {
    case 0:
    case "DEVBOARD_TYPE_H1":
      return Devboard_DevboardType.DEVBOARD_TYPE_H1;
    case 1:
    case "DEVBOARD_TYPE_DT":
      return Devboard_DevboardType.DEVBOARD_TYPE_DT;
    case 2:
    case "DEVBOARD_TYPE_NT":
      return Devboard_DevboardType.DEVBOARD_TYPE_NT;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum Devboard_DevboardType");
  }
}

export function devboard_DevboardTypeToJSON(object: Devboard_DevboardType): string {
  switch (object) {
    case Devboard_DevboardType.DEVBOARD_TYPE_H1:
      return "DEVBOARD_TYPE_H1";
    case Devboard_DevboardType.DEVBOARD_TYPE_DT:
      return "DEVBOARD_TYPE_DT";
    case Devboard_DevboardType.DEVBOARD_TYPE_NT:
      return "DEVBOARD_TYPE_NT";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum Devboard_DevboardType");
  }
}
...
export const DeviceUnderTest: MessageFns<DeviceUnderTest> = {
  encode(message: DeviceUnderTest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.ateHost !== "") {
      writer.uint32(106).string(message.ateHost);
    }
    if (message.osRestriction !== 0) {
      writer.uint32(112).int32(message.osRestriction);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.osRestriction = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DeviceUnderTest {
    return {
      ...
      ateHost: isSet(object.ateHost) ? globalThis.String(object.ateHost) : "",
      osRestriction: isSet(object.osRestriction) ? deviceUnderTest_OSRestrictionFromJSON(object.osRestriction) : 0,
    };
  },
  ...
  toJSON(message: DeviceUnderTest): unknown {
    ...
    if (message.ateHost !== "") {
      obj.ateHost = message.ateHost;
    }
    if (message.osRestriction !== 0) {
      obj.osRestriction = deviceUnderTest_OSRestrictionToJSON(message.osRestriction);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<DeviceUnderTest>): DeviceUnderTest {
    ...
    message.ateHost = object.ateHost ?? "";
    message.osRestriction = object.osRestriction ?? 0;
    return message;
  },
};
