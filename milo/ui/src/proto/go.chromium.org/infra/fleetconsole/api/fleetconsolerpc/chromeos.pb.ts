...
export interface ClaimRepairTaskResponse {
  readonly repairQueueItem: RepairQueueItem | undefined;
}

export interface UnclaimRepairTaskRequest {
  readonly taskId: string;
}

export interface UnclaimRepairTaskResponse {
  readonly repairQueueItem: RepairQueueItem | undefined;
}
...
export const RepairQueueItem: MessageFns<RepairQueueItem> = {
  encode(message: RepairQueueItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.claimedBy !== undefined) {
      writer.uint32(50).string(message.claimedBy);
    }
