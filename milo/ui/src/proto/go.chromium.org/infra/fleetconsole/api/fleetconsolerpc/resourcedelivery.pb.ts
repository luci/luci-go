...
export interface GetProductCatalogFilterValuesResponse {
  ...
  readonly scopedDescriptiveName: readonly ProductCatalogFilterValue[];
}
...
export interface GetGceProductCatalogFilterValuesResponse {
  ...
  readonly scopedProductType: readonly ProductCatalogFilterValue[];
  readonly scopedDescriptiveName: readonly ProductCatalogFilterValue[];
  readonly scopedCpuNumPerVm: readonly ProductCatalogFilterValue[];
  readonly scopedMemoryGbPerVm: readonly ProductCatalogFilterValue[];
}
...
export const GetProductCatalogFilterValuesResponse: MessageFns<GetProductCatalogFilterValuesResponse> = {
  encode(message: GetProductCatalogFilterValuesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.scopedDescriptiveName) {
      ProductCatalogFilterValue.encode(v!, writer.uint32(130).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 16: {
          ...
          message.scopedDescriptiveName.push(ProductCatalogFilterValue.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetProductCatalogFilterValuesResponse {
    return {
      ...
      scopedProductType: globalThis.Array.isArray(object?.scopedProductType)
        ...
        : [],
      scopedDescriptiveName: globalThis.Array.isArray(object?.scopedDescriptiveName)
        ? object.scopedDescriptiveName.map((e: any) => ProductCatalogFilterValue.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GetProductCatalogFilterValuesResponse): unknown {
    ...
    if (message.scopedDescriptiveName?.length) {
      obj.scopedDescriptiveName = message.scopedDescriptiveName.map((e) => ProductCatalogFilterValue.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GetProductCatalogFilterValuesResponse>): GetProductCatalogFilterValuesResponse {
    ...
    message.scopedDescriptiveName =
      object.scopedDescriptiveName?.map((e) => ProductCatalogFilterValue.fromPartial(e)) || [];
    return message;
  },
};
...
export const GetGceProductCatalogFilterValuesResponse: MessageFns<GetGceProductCatalogFilterValuesResponse> = {
  encode(message: GetGceProductCatalogFilterValuesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.scopedCpuNumPerVm) {
      ProductCatalogFilterValue.encode(v!, writer.uint32(98).fork()).join();
    }
    for (const v of message.scopedMemoryGbPerVm) {
      ProductCatalogFilterValue.encode(v!, writer.uint32(106).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          message.scopedCpuNumPerVm.push(ProductCatalogFilterValue.decode(reader, reader.uint32()));
          continue;
        }
        case 13: {
          if (tag !== 106) {
          ...
          message.scopedMemoryGbPerVm.push(ProductCatalogFilterValue.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetGceProductCatalogFilterValuesResponse {
    return {
      ...
      scopedDescriptiveName: globalThis.Array.isArray(object?.scopedDescriptiveName)
        ? object.scopedDescriptiveName.map((e: any) => ProductCatalogFilterValue.fromJSON(e))
        : [],
      scopedCpuNumPerVm: globalThis.Array.isArray(object?.scopedCpuNumPerVm)
        ? object.scopedCpuNumPerVm.map((e: any) => ProductCatalogFilterValue.fromJSON(e))
        : [],
      scopedMemoryGbPerVm: globalThis.Array.isArray(object?.scopedMemoryGbPerVm)
        ? object.scopedMemoryGbPerVm.map((e: any) => ProductCatalogFilterValue.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GetGceProductCatalogFilterValuesResponse): unknown {
    ...
    if (message.scopedCpuNumPerVm?.length) {
      obj.scopedCpuNumPerVm = message.scopedCpuNumPerVm.map((e) => ProductCatalogFilterValue.toJSON(e));
    }
    if (message.scopedMemoryGbPerVm?.length) {
      obj.scopedMemoryGbPerVm = message.scopedMemoryGbPerVm.map((e) => ProductCatalogFilterValue.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GetGceProductCatalogFilterValuesResponse>): GetGceProductCatalogFilterValuesResponse {
    ...
    message.scopedDescriptiveName =
      object.scopedDescriptiveName?.map((e) => ProductCatalogFilterValue.fromPartial(e)) || [];
    message.scopedCpuNumPerVm = object.scopedCpuNumPerVm?.map((e) => ProductCatalogFilterValue.fromPartial(e)) || [];
    message.scopedMemoryGbPerVm = object.scopedMemoryGbPerVm?.map((e) => ProductCatalogFilterValue.fromPartial(e)) ||
      [];
    return message;
  },
};
