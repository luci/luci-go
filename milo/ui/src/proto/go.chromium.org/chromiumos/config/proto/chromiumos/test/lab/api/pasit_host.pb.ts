...
export const PasitHost = {
  encode(message: PasitHost, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
      writer.uint32(10).string(message.hostname);
    }
    for (const v of message.devices) {
      PasitHost_Device.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    for (const v of message.connections) {
      PasitHost_Connection.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PasitHost {
...
export const PasitHost_Connection = {
  encode(message: PasitHost_Connection, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PasitHost_Connection {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasitHost_Device = {
  encode(message: PasitHost_Device, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
    ...
    if (message.powerSupply !== undefined) {
      PasitHost_Device_PowerSupply.encode(message.powerSupply, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PasitHost_Device {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasitHost_Device_PowerSupply = {
  encode(message: PasitHost_Device_PowerSupply, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PasitHost_Device_PowerSupply {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
