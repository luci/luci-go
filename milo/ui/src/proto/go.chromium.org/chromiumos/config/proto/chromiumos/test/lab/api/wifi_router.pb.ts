...
export const WifiRouterConfig = {
  encode(message: WifiRouterConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.openwrt).forEach(([key, value]) => {
      WifiRouterConfig_OpenwrtEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WifiRouterConfig {
...
export const WifiRouterConfig_OpenwrtEntry = {
  encode(message: WifiRouterConfig_OpenwrtEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      OpenWrtWifiRouterDeviceConfig.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WifiRouterConfig_OpenwrtEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const OpenWrtWifiRouterDeviceConfig = {
  encode(message: OpenWrtWifiRouterDeviceConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.images) {
      OpenWrtWifiRouterDeviceConfig_OpenWrtOSImage.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): OpenWrtWifiRouterDeviceConfig {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const OpenWrtWifiRouterDeviceConfig_OpenWrtOSImage = {
  encode(message: OpenWrtWifiRouterDeviceConfig_OpenWrtOSImage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OpenWrtWifiRouterDeviceConfig_OpenWrtOSImage {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CrosOpenWrtImageBuildInfo = {
  encode(message: CrosOpenWrtImageBuildInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.imageUuid !== "") {
      writer.uint32(10).string(message.imageUuid);
    }
    ...
    if (message.osRelease !== undefined) {
      CrosOpenWrtImageBuildInfo_OSRelease.encode(message.osRelease, writer.uint32(26).fork()).ldelim();
    }
    ...
    if (message.buildTime !== undefined) {
      Timestamp.encode(toTimestamp(message.buildTime), writer.uint32(50).fork()).ldelim();
    }
    ...
    Object.entries(message.customPackages).forEach(([key, value]) => {
      CrosOpenWrtImageBuildInfo_CustomPackagesEntry.encode({ key: key as any, value }, writer.uint32(74).fork())
        .ldelim();
    });
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CrosOpenWrtImageBuildInfo {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CrosOpenWrtImageBuildInfo_StandardBuildConfig = {
  encode(message: CrosOpenWrtImageBuildInfo_StandardBuildConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CrosOpenWrtImageBuildInfo_StandardBuildConfig {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CrosOpenWrtImageBuildInfo_OSRelease = {
  encode(message: CrosOpenWrtImageBuildInfo_OSRelease, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.version !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CrosOpenWrtImageBuildInfo_OSRelease {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CrosOpenWrtImageBuildInfo_CustomIncludedFilesEntry = {
  encode(
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CrosOpenWrtImageBuildInfo_CustomIncludedFilesEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CrosOpenWrtImageBuildInfo_CustomPackagesEntry = {
  encode(message: CrosOpenWrtImageBuildInfo_CustomPackagesEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CrosOpenWrtImageBuildInfo_CustomPackagesEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
