...
export const QueryTestVariantBranchRequest = {
  encode(message: QueryTestVariantBranchRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.project !== "") {
    ...
    if (message.ref !== undefined) {
      SourceRef.encode(message.ref, writer.uint32(26).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryTestVariantBranchRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTestVariantBranchResponse = {
  encode(message: QueryTestVariantBranchResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryTestVariantBranchResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
