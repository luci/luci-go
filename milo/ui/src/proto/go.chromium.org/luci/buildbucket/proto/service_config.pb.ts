...
export const SettingsCfg = {
  encode(message: SettingsCfg, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.swarming !== undefined) {
      SwarmingSettings.encode(message.swarming, writer.uint32(10).fork()).ldelim();
    }
    if (message.logdog !== undefined) {
      LogDogSettings.encode(message.logdog, writer.uint32(18).fork()).ldelim();
    }
    if (message.resultdb !== undefined) {
      ResultDBSettings.encode(message.resultdb, writer.uint32(34).fork()).ldelim();
    }
    if (message.experiment !== undefined) {
      ExperimentSettings.encode(message.experiment, writer.uint32(42).fork()).ldelim();
    }
    if (message.cipd !== undefined) {
      CipdSettings.encode(message.cipd, writer.uint32(50).fork()).ldelim();
    }
    for (const v of message.knownPublicGerritHosts) {
      writer.uint32(26).string(v!);
    }
    for (const v of message.backends) {
      BackendSetting.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    Object.entries(message.swarmingBackends).forEach(([key, value]) => {
      SettingsCfg_SwarmingBackendsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).ldelim();
    });
    for (const v of message.customMetrics) {
      CustomMetric.encode(v!, writer.uint32(74).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SettingsCfg {
...
export const SettingsCfg_SwarmingBackendsEntry = {
  encode(message: SettingsCfg_SwarmingBackendsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SettingsCfg_SwarmingBackendsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BackendSetting = {
  encode(message: BackendSetting, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.target !== "") {
    ...
    if (message.buildSyncSetting !== undefined) {
      BackendSetting_BuildSyncSetting.encode(message.buildSyncSetting, writer.uint32(34).fork()).ldelim();
    }
    if (message.fullMode !== undefined) {
      BackendSetting_FullMode.encode(message.fullMode, writer.uint32(42).fork()).ldelim();
    }
    if (message.liteMode !== undefined) {
      BackendSetting_LiteMode.encode(message.liteMode, writer.uint32(50).fork()).ldelim();
    }
    if (message.taskCreatingTimeout !== undefined) {
      Duration.encode(message.taskCreatingTimeout, writer.uint32(58).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): BackendSetting {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BackendSetting_BuildSyncSetting = {
  encode(message: BackendSetting_BuildSyncSetting, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.shards !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BackendSetting_BuildSyncSetting {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BackendSetting_FullMode = {
  encode(message: BackendSetting_FullMode, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pubsubId !== "") {
      writer.uint32(10).string(message.pubsubId);
    }
    if (message.buildSyncSetting !== undefined) {
      BackendSetting_BuildSyncSetting.encode(message.buildSyncSetting, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BackendSetting_FullMode {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BackendSetting_LiteMode = {
  encode(_: BackendSetting_LiteMode, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): BackendSetting_LiteMode {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SwarmingSettings = {
  encode(message: SwarmingSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.miloHostname !== "") {
      writer.uint32(18).string(message.miloHostname);
    }
    for (const v of message.globalCaches) {
      BuilderConfig_CacheEntry.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    for (const v of message.userPackages) {
      SwarmingSettings_Package.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    if (message.bbagentPackage !== undefined) {
      SwarmingSettings_Package.encode(message.bbagentPackage, writer.uint32(66).fork()).ldelim();
    }
    if (message.kitchenPackage !== undefined) {
      SwarmingSettings_Package.encode(message.kitchenPackage, writer.uint32(58).fork()).ldelim();
    }
    for (const v of message.alternativeAgentPackages) {
      SwarmingSettings_Package.encode(v!, writer.uint32(74).fork()).ldelim();
    }
    for (const v of message.bbagentUtilityPackages) {
      SwarmingSettings_Package.encode(v!, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SwarmingSettings {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SwarmingSettings_Package = {
  encode(message: SwarmingSettings_Package, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.builders !== undefined) {
      BuilderPredicate.encode(message.builders, writer.uint32(34).fork()).ldelim();
    }
    if (message.subdir !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SwarmingSettings_Package {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LogDogSettings = {
  encode(message: LogDogSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LogDogSettings {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExperimentSettings = {
  encode(message: ExperimentSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.experiments) {
      ExperimentSettings_Experiment.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ExperimentSettings {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExperimentSettings_Experiment = {
  encode(message: ExperimentSettings_Experiment, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExperimentSettings_Experiment {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BuilderPredicate = {
  encode(message: BuilderPredicate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BuilderPredicate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ResultDBSettings = {
  encode(message: ResultDBSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
      writer.uint32(10).string(message.hostname);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ResultDBSettings {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CipdSettings = {
  encode(message: CipdSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.server !== "") {
      writer.uint32(10).string(message.server);
    }
    if (message.source !== undefined) {
      CipdSettings_Source.encode(message.source, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CipdSettings {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CipdSettings_Source = {
  encode(message: CipdSettings_Source, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.packageName !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CipdSettings_Source {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CustomMetric = {
  encode(message: CustomMetric, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CustomMetric {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
