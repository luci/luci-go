...
export const TestResult = {
  encode(message: TestResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.artifacts).forEach(([key, value]) => {
      TestResult_ArtifactsEntry.encode({ key: key as any, value }, writer.uint32(74).fork()).ldelim();
    });
...
export const TestResult_ArtifactsEntry = {
  encode(message: TestResult_ArtifactsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TestResult_ArtifactsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestResultFile = {
  encode(message: TestResultFile, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.path !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TestResultFile {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
