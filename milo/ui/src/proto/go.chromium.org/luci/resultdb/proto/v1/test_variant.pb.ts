...
export const RunTestVerdict = {
  encode(message: RunTestVerdict, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.testId !== "") {
      writer.uint32(10).string(message.testId);
    }
    if (message.variant !== undefined) {
    ...
    for (const v of message.results) {
      TestResultBundle.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    if (message.testMetadata !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RunTestVerdict {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
