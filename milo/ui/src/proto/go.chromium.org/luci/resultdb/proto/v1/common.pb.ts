 ...
 */
export interface TestIdentifierBase {
...
function createBaseTestIdentifierBase(): TestIdentifierBase {
  return { moduleName: "", moduleScheme: "", coarseName: "", fineName: "", caseName: "" };
}

export const TestIdentifierBase: MessageFns<TestIdentifierBase> = {
  encode(message: TestIdentifierBase, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.moduleName !== "") {
      writer.uint32(10).string(message.moduleName);
    }
    if (message.moduleScheme !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TestIdentifierBase {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTestIdentifierBase() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): TestIdentifierBase {
    return {
      moduleName: isSet(object.moduleName) ? globalThis.String(object.moduleName) : "",
      moduleScheme: isSet(object.moduleScheme) ? globalThis.String(object.moduleScheme) : "",
      coarseName: isSet(object.coarseName) ? globalThis.String(object.coarseName) : "",
  ...
  toJSON(message: TestIdentifierBase): unknown {
    const obj: any = {};
    if (message.moduleName !== "") {
      obj.moduleName = message.moduleName;
    }
  ...
  create(base?: DeepPartial<TestIdentifierBase>): TestIdentifierBase {
    return TestIdentifierBase.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TestIdentifierBase>): TestIdentifierBase {
    const message = createBaseTestIdentifierBase() as any;
    message.moduleName = object.moduleName ?? "";
    message.moduleScheme = object.moduleScheme ?? "";
    message.coarseName = object.coarseName ?? "";
