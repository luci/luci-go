...
export interface RootInvocationDefinition {
  /**
   ...
   */
  readonly properties:
    | RootInvocationDefinition_Properties
    | undefined;
  /**
 ...
 */
export interface RootInvocationDefinition_Properties {
  /**
...
export interface RootInvocationDefinition_Properties_DefEntry {
  readonly key: string;
  readonly value: string;
}
...
export interface BuildDescriptor {
   ...
   * such as those based on buildbucket builds or GCS folders.
   */
  readonly androidBuild?:
    | AndroidBuildDescriptor
    | undefined;
  /**
 ...
 */
export interface AndroidBuildDescriptor {
  /**
   * The Android Build API data realm.
   *
   * This is usually `prod`. For a list of available data realms, see
...
function createBaseRootInvocationDefinition(): RootInvocationDefinition {
  return { system: "", name: "", properties: undefined, propertiesHash: "" };
}

export const RootInvocationDefinition: MessageFns<RootInvocationDefinition> = {
  encode(message: RootInvocationDefinition, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.system !== "") {
    ...
    if (message.properties !== undefined) {
      RootInvocationDefinition_Properties.encode(message.properties, writer.uint32(26).fork()).join();
    }
    if (message.propertiesHash !== "") {
      writer.uint32(34).string(message.propertiesHash);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RootInvocationDefinition {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRootInvocationDefinition() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.properties = RootInvocationDefinition_Properties.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.propertiesHash = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RootInvocationDefinition {
    return {
      system: isSet(object.system) ? globalThis.String(object.system) : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      properties: isSet(object.properties)
        ? RootInvocationDefinition_Properties.fromJSON(object.properties)
        : undefined,
      propertiesHash: isSet(object.propertiesHash) ? globalThis.String(object.propertiesHash) : "",
    };
  },

  toJSON(message: RootInvocationDefinition): unknown {
    const obj: any = {};
    if (message.system !== "") {
    ...
    if (message.properties !== undefined) {
      obj.properties = RootInvocationDefinition_Properties.toJSON(message.properties);
    }
    if (message.propertiesHash !== "") {
      obj.propertiesHash = message.propertiesHash;
    }
    return obj;
  },

  create(base?: DeepPartial<RootInvocationDefinition>): RootInvocationDefinition {
    return RootInvocationDefinition.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RootInvocationDefinition>): RootInvocationDefinition {
    const message = createBaseRootInvocationDefinition() as any;
    message.system = object.system ?? "";
    message.name = object.name ?? "";
    message.properties = (object.properties !== undefined && object.properties !== null)
      ? RootInvocationDefinition_Properties.fromPartial(object.properties)
      : undefined;
    message.propertiesHash = object.propertiesHash ?? "";
    return message;
  },
};

function createBaseRootInvocationDefinition_Properties(): RootInvocationDefinition_Properties {
  return { def: {} };
}

export const RootInvocationDefinition_Properties: MessageFns<RootInvocationDefinition_Properties> = {
  encode(message: RootInvocationDefinition_Properties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    Object.entries(message.def).forEach(([key, value]) => {
      RootInvocationDefinition_Properties_DefEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RootInvocationDefinition_Properties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRootInvocationDefinition_Properties() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          const entry1 = RootInvocationDefinition_Properties_DefEntry.decode(reader, reader.uint32());
          if (entry1.value !== undefined) {
            message.def[entry1.key] = entry1.value;
          }
          continue;
  ...
  fromJSON(object: any): RootInvocationDefinition_Properties {
    return {
      def: isObject(object.def)
        ? Object.entries(object.def).reduce<{ [key: string]: string }>((acc, [key, value]) => {
          acc[key] = String(value);
  ...
  toJSON(message: RootInvocationDefinition_Properties): unknown {
    const obj: any = {};
    if (message.def) {
      const entries = Object.entries(message.def);
      if (entries.length > 0) {
  ...
  create(base?: DeepPartial<RootInvocationDefinition_Properties>): RootInvocationDefinition_Properties {
    return RootInvocationDefinition_Properties.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RootInvocationDefinition_Properties>): RootInvocationDefinition_Properties {
    const message = createBaseRootInvocationDefinition_Properties() as any;
    message.def = Object.entries(object.def ?? {}).reduce<{ [key: string]: string }>((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = globalThis.String(value);
...
function createBaseRootInvocationDefinition_Properties_DefEntry(): RootInvocationDefinition_Properties_DefEntry {
  return { key: "", value: "" };
}

export const RootInvocationDefinition_Properties_DefEntry: MessageFns<RootInvocationDefinition_Properties_DefEntry> = {
  encode(
    message: RootInvocationDefinition_Properties_DefEntry,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RootInvocationDefinition_Properties_DefEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRootInvocationDefinition_Properties_DefEntry() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): RootInvocationDefinition_Properties_DefEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: RootInvocationDefinition_Properties_DefEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(
    base?: DeepPartial<RootInvocationDefinition_Properties_DefEntry>,
  ): RootInvocationDefinition_Properties_DefEntry {
    return RootInvocationDefinition_Properties_DefEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<RootInvocationDefinition_Properties_DefEntry>,
  ): RootInvocationDefinition_Properties_DefEntry {
    const message = createBaseRootInvocationDefinition_Properties_DefEntry() as any;
    message.key = object.key ?? "";
    message.value = object.value ?? "";
...
function createBaseBuildDescriptor(): BuildDescriptor {
  return { androidBuild: undefined, url: "" };
}

export const BuildDescriptor: MessageFns<BuildDescriptor> = {
  encode(message: BuildDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.androidBuild !== undefined) {
      AndroidBuildDescriptor.encode(message.androidBuild, writer.uint32(10).fork()).join();
    }
    if (message.url !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BuildDescriptor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBuildDescriptor() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.androidBuild = AndroidBuildDescriptor.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): BuildDescriptor {
    return {
      androidBuild: isSet(object.androidBuild) ? AndroidBuildDescriptor.fromJSON(object.androidBuild) : undefined,
      url: isSet(object.url) ? globalThis.String(object.url) : "",
    };
  },

  toJSON(message: BuildDescriptor): unknown {
    const obj: any = {};
    if (message.androidBuild !== undefined) {
      obj.androidBuild = AndroidBuildDescriptor.toJSON(message.androidBuild);
    }
    if (message.url !== "") {
      obj.url = message.url;
    }
  ...
  create(base?: DeepPartial<BuildDescriptor>): BuildDescriptor {
    return BuildDescriptor.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BuildDescriptor>): BuildDescriptor {
    const message = createBaseBuildDescriptor() as any;
    message.androidBuild = (object.androidBuild !== undefined && object.androidBuild !== null)
      ? AndroidBuildDescriptor.fromPartial(object.androidBuild)
      : undefined;
...
function createBaseAndroidBuildDescriptor(): AndroidBuildDescriptor {
  return { dataRealm: "", branch: "", buildTarget: "", buildId: "" };
}

export const AndroidBuildDescriptor: MessageFns<AndroidBuildDescriptor> = {
  encode(message: AndroidBuildDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dataRealm !== "") {
      writer.uint32(10).string(message.dataRealm);
    }
    if (message.branch !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AndroidBuildDescriptor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAndroidBuildDescriptor() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AndroidBuildDescriptor {
    return {
      dataRealm: isSet(object.dataRealm) ? globalThis.String(object.dataRealm) : "",
      branch: isSet(object.branch) ? globalThis.String(object.branch) : "",
  ...
  toJSON(message: AndroidBuildDescriptor): unknown {
    const obj: any = {};
    if (message.dataRealm !== "") {
      obj.dataRealm = message.dataRealm;
    }
  ...
  create(base?: DeepPartial<AndroidBuildDescriptor>): AndroidBuildDescriptor {
    return AndroidBuildDescriptor.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AndroidBuildDescriptor>): AndroidBuildDescriptor {
    const message = createBaseAndroidBuildDescriptor() as any;
    message.dataRealm = object.dataRealm ?? "";
    message.branch = object.branch ?? "";
...
export const ProducerResource: MessageFns<ProducerResource> = {
  encode(message: ProducerResource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.system !== "") {
      writer.uint32(10).string(message.system);
    }
    if (message.dataRealm !== "") {
      writer.uint32(18).string(message.dataRealm);
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProducerResource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseProducerResource() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ProducerResource {
    return {
      system: isSet(object.system) ? globalThis.String(object.system) : "",
      dataRealm: isSet(object.dataRealm) ? globalThis.String(object.dataRealm) : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
  ...
  toJSON(message: ProducerResource): unknown {
    const obj: any = {};
    if (message.system !== "") {
      obj.system = message.system;
    }
  ...
  create(base?: DeepPartial<ProducerResource>): ProducerResource {
    return ProducerResource.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ProducerResource>): ProducerResource {
    const message = createBaseProducerResource() as any;
    message.system = object.system ?? "";
    message.dataRealm = object.dataRealm ?? "";
    message.name = object.name ?? "";
