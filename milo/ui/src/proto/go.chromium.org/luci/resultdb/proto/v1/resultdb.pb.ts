...
import {
  ...
  BatchGetWorkUnitsResponse,
  GetWorkUnitRequest,
  QueryWorkUnitsRequest,
  QueryWorkUnitsResponse,
  WorkUnit,
} from "./work_unit.pb";
...
export enum CompareArtifactLinesRequest_View {
  /** VIEW_UNSPECIFIED - The server will default to the RANGES_ONLY view. */
  VIEW_UNSPECIFIED = 0,
  /**
   * RANGES_ONLY - Includes only the line and byte ranges, without the line content.
   * This is the most efficient view if you only need the locations
   * of the failure-only lines.
   */
  RANGES_ONLY = 1,
  /**
   * RANGES_WITH_CONTENT - Includes the full content of the failure-only lines in addition to
   * the line and byte ranges.
   */
  RANGES_WITH_CONTENT = 2,
}

export function compareArtifactLinesRequest_ViewFromJSON(object: any): CompareArtifactLinesRequest_View {
  switch (object) {
    case 0:
    case "VIEW_UNSPECIFIED":
      return CompareArtifactLinesRequest_View.VIEW_UNSPECIFIED;
    case 1:
    case "RANGES_ONLY":
      return CompareArtifactLinesRequest_View.RANGES_ONLY;
    case 2:
    case "RANGES_WITH_CONTENT":
      return CompareArtifactLinesRequest_View.RANGES_WITH_CONTENT;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum CompareArtifactLinesRequest_View");
  }
}

export function compareArtifactLinesRequest_ViewToJSON(object: CompareArtifactLinesRequest_View): string {
  switch (object) {
    case CompareArtifactLinesRequest_View.VIEW_UNSPECIFIED:
      return "VIEW_UNSPECIFIED";
    case CompareArtifactLinesRequest_View.RANGES_ONLY:
      return "RANGES_ONLY";
    case CompareArtifactLinesRequest_View.RANGES_WITH_CONTENT:
      return "RANGES_WITH_CONTENT";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum CompareArtifactLinesRequest_View");
  }
}
 ...
 */
export interface CompareArtifactLinesResponse_FailureOnlyRange {
...
function createBaseQueryArtifactsRequest(): QueryArtifactsRequest {
  return { invocations: [], parent: "", predicate: undefined, pageSize: 0, pageToken: "", readMask: undefined };
}
...
export const CompareArtifactLinesRequest: MessageFns<CompareArtifactLinesRequest> = {
  encode(message: CompareArtifactLinesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CompareArtifactLinesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CompareArtifactLinesRequest {
    return {
  ...
  toJSON(message: CompareArtifactLinesRequest): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create(base?: DeepPartial<CompareArtifactLinesRequest>): CompareArtifactLinesRequest {
    return CompareArtifactLinesRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CompareArtifactLinesRequest>): CompareArtifactLinesRequest {
    const message = createBaseCompareArtifactLinesRequest() as any;
    message.name = object.name ?? "";
...
export const CompareArtifactLinesResponse: MessageFns<CompareArtifactLinesResponse> = {
  encode(message: CompareArtifactLinesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.failureOnlyRanges) {
      CompareArtifactLinesResponse_FailureOnlyRange.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CompareArtifactLinesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCompareArtifactLinesResponse() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.failureOnlyRanges.push(CompareArtifactLinesResponse_FailureOnlyRange.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): CompareArtifactLinesResponse {
    return {
      failureOnlyRanges: globalThis.Array.isArray(object?.failureOnlyRanges)
  ...
  toJSON(message: CompareArtifactLinesResponse): unknown {
    const obj: any = {};
    if (message.failureOnlyRanges?.length) {
      obj.failureOnlyRanges = message.failureOnlyRanges.map((e) =>
        CompareArtifactLinesResponse_FailureOnlyRange.toJSON(e)
      );
    }
    if (message.nextPageToken !== "") {
      obj.nextPageToken = message.nextPageToken;
  ...
  create(base?: DeepPartial<CompareArtifactLinesResponse>): CompareArtifactLinesResponse {
    return CompareArtifactLinesResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CompareArtifactLinesResponse>): CompareArtifactLinesResponse {
    const message = createBaseCompareArtifactLinesResponse() as any;
...
function createBaseCompareArtifactLinesResponse_FailureOnlyRange(): CompareArtifactLinesResponse_FailureOnlyRange {
  return { startLine: 0, endLine: 0, startByte: "0", endByte: "0", lines: [] };
}

export const CompareArtifactLinesResponse_FailureOnlyRange: MessageFns<CompareArtifactLinesResponse_FailureOnlyRange> =
  {
    encode(
      message: CompareArtifactLinesResponse_FailureOnlyRange,
      ...
      if (message.endLine !== 0) {
        writer.uint32(16).int32(message.endLine);
      }
      if (message.startByte !== "0") {
        writer.uint32(24).int64(message.startByte);
      }
      if (message.endByte !== "0") {
        writer.uint32(32).int64(message.endByte);
      }
      for (const v of message.lines) {
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): CompareArtifactLinesResponse_FailureOnlyRange {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseCompareArtifactLinesResponse_FailureOnlyRange() as any;
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 3: {
            ...
            message.startByte = reader.int64().toString();
            continue;
          }
          case 4: {
            if (tag !== 32) {
            ...
            message.endByte = reader.int64().toString();
            continue;
          }
          case 5: {
            if (tag !== 42) {
    ...
    fromJSON(object: any): CompareArtifactLinesResponse_FailureOnlyRange {
      return {
        ...
        startByte: isSet(object.startByte) ? globalThis.String(object.startByte) : "0",
        endByte: isSet(object.endByte) ? globalThis.String(object.endByte) : "0",
        lines: globalThis.Array.isArray(object?.lines) ? object.lines.map((e: any) => globalThis.String(e)) : [],
      };
    },

    toJSON(message: CompareArtifactLinesResponse_FailureOnlyRange): unknown {
      const obj: any = {};
      if (message.startLine !== 0) {
      ...
      if (message.startByte !== "0") {
        obj.startByte = message.startByte;
      }
      if (message.endByte !== "0") {
        obj.endByte = message.endByte;
      }
      if (message.lines?.length) {
    ...
    create(
      base?: DeepPartial<CompareArtifactLinesResponse_FailureOnlyRange>,
    ): CompareArtifactLinesResponse_FailureOnlyRange {
      return CompareArtifactLinesResponse_FailureOnlyRange.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<CompareArtifactLinesResponse_FailureOnlyRange>,
    ): CompareArtifactLinesResponse_FailureOnlyRange {
      const message = createBaseCompareArtifactLinesResponse_FailureOnlyRange() as any;
...
function createBaseBatchGetTestVariantsRequest_TestVariantIdentifier(): BatchGetTestVariantsRequest_TestVariantIdentifier {
  return { testIdStructured: undefined, testId: "", variantHash: "" };
}
...
> = {
  encode(
    ...
    if (message.testIdStructured !== undefined) {
      TestIdentifier.encode(message.testIdStructured, writer.uint32(26).fork()).join();
    }
    if (message.testId !== "") {
...
function createBaseArtifactMatchingContent(): ArtifactMatchingContent {
  return { name: "", partitionTime: undefined, testStatus: 0, testStatusV2: 0, snippet: "", matches: [] };
}
...
export const ArtifactMatchingContent: MessageFns<ArtifactMatchingContent> = {
  encode(message: ArtifactMatchingContent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.testStatusV2 !== 0) {
      writer.uint32(48).int32(message.testStatusV2);
    }
    if (message.snippet !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.testStatusV2 = reader.int32() as any;
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): ArtifactMatchingContent {
    return {
      ...
      testStatusV2: isSet(object.testStatusV2) ? testResult_StatusFromJSON(object.testStatusV2) : 0,
  ...
  toJSON(message: ArtifactMatchingContent): unknown {
    ...
    if (message.testStatusV2 !== 0) {
      obj.testStatusV2 = testResult_StatusToJSON(message.testStatusV2);
    }
    if (message.snippet !== "") {
  ...
  fromPartial(object: DeepPartial<ArtifactMatchingContent>): ArtifactMatchingContent {
    ...
    message.testStatusV2 = object.testStatusV2 ?? 0;
...
export const QueryTestAggregationsRequest: MessageFns<QueryTestAggregationsRequest> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTestAggregationsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryTestAggregationsRequest>): QueryTestAggregationsRequest {
    return QueryTestAggregationsRequest.fromPartial(base ?? {});
  },
...
function createBaseQueryTestAggregationsResponse(): QueryTestAggregationsResponse {
  return { aggregations: [], nextPageToken: "" };
}

export const QueryTestAggregationsResponse: MessageFns<QueryTestAggregationsResponse> = {
  encode(message: QueryTestAggregationsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.aggregations) {
      TestAggregation.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTestAggregationsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryTestAggregationsResponse() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.aggregations.push(TestAggregation.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): QueryTestAggregationsResponse {
    return {
      aggregations: globalThis.Array.isArray(object?.aggregations)
        ? object.aggregations.map((e: any) => TestAggregation.fromJSON(e))
        : [],
      nextPageToken: isSet(object.nextPageToken) ? globalThis.String(object.nextPageToken) : "",
    };
  },

  toJSON(message: QueryTestAggregationsResponse): unknown {
    const obj: any = {};
    if (message.aggregations?.length) {
      obj.aggregations = message.aggregations.map((e) => TestAggregation.toJSON(e));
    }
    if (message.nextPageToken !== "") {
      obj.nextPageToken = message.nextPageToken;
    }
  ...
  create(base?: DeepPartial<QueryTestAggregationsResponse>): QueryTestAggregationsResponse {
    return QueryTestAggregationsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryTestAggregationsResponse>): QueryTestAggregationsResponse {
    const message = createBaseQueryTestAggregationsResponse() as any;
    message.aggregations = object.aggregations?.map((e) => TestAggregation.fromPartial(e)) || [];
    message.nextPageToken = object.nextPageToken ?? "";
    return message;
  },
};
...
export const QueryTestVerdictsRequest: MessageFns<QueryTestVerdictsRequest> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTestVerdictsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryTestVerdictsRequest>): QueryTestVerdictsRequest {
    return QueryTestVerdictsRequest.fromPartial(base ?? {});
  },
...
function createBaseQueryTestVerdictsResponse(): QueryTestVerdictsResponse {
  return { testVerdicts: [], nextPageToken: "" };
}

export const QueryTestVerdictsResponse: MessageFns<QueryTestVerdictsResponse> = {
  encode(message: QueryTestVerdictsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTestVerdictsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryTestVerdictsResponse() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryTestVerdictsResponse {
    return {
  ...
  toJSON(message: QueryTestVerdictsResponse): unknown {
    const obj: any = {};
  ...
  create(base?: DeepPartial<QueryTestVerdictsResponse>): QueryTestVerdictsResponse {
    return QueryTestVerdictsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryTestVerdictsResponse>): QueryTestVerdictsResponse {
    const message = createBaseQueryTestVerdictsResponse() as any;
...
export interface ResultDB {
  ...
  GetWorkUnit(request: GetWorkUnitRequest): Promise<WorkUnit>;
...
export class ResultDBClientImpl implements ResultDB {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.rpc = rpc;
    this.GetRootInvocation = this.GetRootInvocation.bind(this);
    ...
    this.CompareArtifactLines = this.CompareArtifactLines.bind(this);
  ...
  GetRootInvocation(request: GetRootInvocationRequest): Promise<RootInvocation> {
    ...
    const promise = this.rpc.request(this.service, "GetRootInvocation", data);
    return promise.then((data) => RootInvocation.fromJSON(data));
  }

  GetWorkUnit(request: GetWorkUnitRequest): Promise<WorkUnit> {
    const data = GetWorkUnitRequest.toJSON(request);
    const promise = this.rpc.request(this.service, "GetWorkUnit", data);
    return promise.then((data) => WorkUnit.fromJSON(data));
  }

  BatchGetWorkUnits(request: BatchGetWorkUnitsRequest): Promise<BatchGetWorkUnitsResponse> {
    const data = BatchGetWorkUnitsRequest.toJSON(request);
    const promise = this.rpc.request(this.service, "BatchGetWorkUnits", data);
    return promise.then((data) => BatchGetWorkUnitsResponse.fromJSON(data));
  }
  ...
  QueryTestAggregations(request: QueryTestAggregationsRequest): Promise<QueryTestAggregationsResponse> {
    const data = QueryTestAggregationsRequest.toJSON(request);
    const promise = this.rpc.request(this.service, "QueryTestAggregations", data);
    return promise.then((data) => QueryTestAggregationsResponse.fromJSON(data));
  }
  ...
  CompareArtifactLines(request: CompareArtifactLinesRequest): Promise<CompareArtifactLinesResponse> {
    const data = CompareArtifactLinesRequest.toJSON(request);
    const promise = this.rpc.request(this.service, "CompareArtifactLines", data);
    return promise.then((data) => CompareArtifactLinesResponse.fromJSON(data));
  }
