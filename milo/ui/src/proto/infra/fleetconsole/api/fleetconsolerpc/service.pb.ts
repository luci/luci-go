...
export interface DeviceSpec {
  ...
  readonly labels: { [key: string]: DeviceSpec_LabelValues };
}

export interface DeviceSpec_LabelValues {
  readonly values: readonly string[];
}

export interface DeviceSpec_LabelsEntry {
  readonly key: string;
  readonly value: DeviceSpec_LabelValues | undefined;
}
...
export const DeviceSpec: MessageFns<DeviceSpec> = {
  ...
  fromJSON(object: any): DeviceSpec {
    return {
      labels: isObject(object.labels)
        ? Object.entries(object.labels).reduce<{ [key: string]: DeviceSpec_LabelValues }>((acc, [key, value]) => {
          acc[key] = DeviceSpec_LabelValues.fromJSON(value);
          return acc;
        }, {})
        : {},
    };
  ...
  toJSON(message: DeviceSpec): unknown {
    ...
    if (message.labels) {
      ...
      if (entries.length > 0) {
        obj.labels = {};
        entries.forEach(([k, v]) => {
          obj.labels[k] = DeviceSpec_LabelValues.toJSON(v);
        });
      }
    }
    return obj;
  ...
  fromPartial(object: DeepPartial<DeviceSpec>): DeviceSpec {
    const message = createBaseDeviceSpec() as any;
    message.labels = Object.entries(object.labels ?? {}).reduce<{ [key: string]: DeviceSpec_LabelValues }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = DeviceSpec_LabelValues.fromPartial(value);
        }
        return acc;
      },
      {},
...
function createBaseDeviceSpec_LabelValues(): DeviceSpec_LabelValues {
  return { values: [] };
}

export const DeviceSpec_LabelValues: MessageFns<DeviceSpec_LabelValues> = {
  encode(message: DeviceSpec_LabelValues, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeviceSpec_LabelValues {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeviceSpec_LabelValues() as any;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DeviceSpec_LabelValues {
    return {
      values: globalThis.Array.isArray(object?.values) ? object.values.map((e: any) => globalThis.String(e)) : [],
    };
  },

  toJSON(message: DeviceSpec_LabelValues): unknown {
    const obj: any = {};
  ...
  create(base?: DeepPartial<DeviceSpec_LabelValues>): DeviceSpec_LabelValues {
    return DeviceSpec_LabelValues.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DeviceSpec_LabelValues>): DeviceSpec_LabelValues {
    const message = createBaseDeviceSpec_LabelValues() as any;
...
export const DeviceSpec_LabelsEntry: MessageFns<DeviceSpec_LabelsEntry> = {
  encode(message: DeviceSpec_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.value !== undefined) {
      DeviceSpec_LabelValues.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.value = DeviceSpec_LabelValues.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DeviceSpec_LabelsEntry {
    return {
      ...
      value: isSet(object.value) ? DeviceSpec_LabelValues.fromJSON(object.value) : undefined,
    };
  },
  ...
  toJSON(message: DeviceSpec_LabelsEntry): unknown {
    ...
    if (message.value !== undefined) {
      obj.value = DeviceSpec_LabelValues.toJSON(message.value);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<DeviceSpec_LabelsEntry>): DeviceSpec_LabelsEntry {
    ...
    message.value = (object.value !== undefined && object.value !== null)
      ? DeviceSpec_LabelValues.fromPartial(object.value)
      : undefined;
    return message;
  },
};
