...
export const RedirectRequest = {
  encode(message: RedirectRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.query !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RedirectRequest {
...
export const RedirectResponse = {
  encode(message: RedirectResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.gitHash !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RedirectResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const NumberingRequest = {
  encode(message: NumberingRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.host !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): NumberingRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const NumberingResponse = {
  encode(message: NumberingResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.gitHash !== "") {
      writer.uint32(10).string(message.gitHash);
    }
    if (message.positionNumber !== "0") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): NumberingResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
