...
export const Device = {
  encode(message: Device, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.dut !== undefined) {
      DeviceUnderTest.encode(message.dut, writer.uint32(10).fork()).ldelim();
    }
    if (message.servoHost !== undefined) {
      ServoHostDevice.encode(message.servoHost, writer.uint32(18).fork()).ldelim();
    }
    if (message.chameleon !== undefined) {
      ChameleonDevice.encode(message.chameleon, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
...
export const DeviceUnderTest = {
  encode(message: DeviceUnderTest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.common !== undefined) {
      CommonDeviceSpecs.encode(message.common, writer.uint32(10).fork()).ldelim();
    }
    if (message.removalReason !== undefined) {
      RemovalReason.encode(message.removalReason, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): DeviceUnderTest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ServoHostDevice = {
  encode(message: ServoHostDevice, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.common !== undefined) {
      CommonDeviceSpecs.encode(message.common, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ServoHostDevice {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChameleonDevice = {
  encode(message: ChameleonDevice, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.common !== undefined) {
      CommonDeviceSpecs.encode(message.common, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChameleonDevice {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CommonDeviceSpecs = {
  encode(message: CommonDeviceSpecs, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.attributes) {
      KeyValue.encode(v!, writer.uint32(74).fork()).ldelim();
    }
    for (const v of message.deviceLocks) {
      DeviceLock.encode(v!, writer.uint32(50).fork()).ldelim();
    }
    ...
    if (message.labels !== undefined) {
      SchedulableLabels.encode(message.labels, writer.uint32(66).fork()).ldelim();
    }
    if (message.location !== undefined) {
      Location.encode(message.location, writer.uint32(42).fork()).ldelim();
    }
    if (message.ownerShard !== undefined) {
      Shard.encode(message.ownerShard, writer.uint32(58).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CommonDeviceSpecs {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemovalReason = {
  encode(message: RemovalReason, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RemovalReason {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Location = {
  encode(message: Location, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.lab !== undefined) {
      PhysicalLab.encode(message.lab, writer.uint32(10).fork()).ldelim();
    }
    if (message.row !== 0) {
...
export const PhysicalLab = {
  encode(message: PhysicalLab, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PhysicalLab {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeviceLock = {
  encode(message: DeviceLock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.beginTime !== undefined) {
      Timestamp.encode(message.beginTime, writer.uint32(34).fork()).ldelim();
    }
    if (message.expireTime !== undefined) {
      Timestamp.encode(message.expireTime, writer.uint32(42).fork()).ldelim();
    }
    if (message.lockId !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeviceLock {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchedulableLabels = {
  encode(message: SchedulableLabels, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.capabilities !== undefined) {
      HardwareCapabilities.encode(message.capabilities, writer.uint32(42).fork()).ldelim();
    }
    ...
    if (message.testCoverageHints !== undefined) {
      TestCoverageHints.encode(message.testCoverageHints, writer.uint32(146).fork()).ldelim();
    }
    if (message.uselessSwitch !== undefined && message.uselessSwitch !== false) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SchedulableLabels {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const HardwareCapabilities = {
  encode(message: HardwareCapabilities, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): HardwareCapabilities {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Peripherals = {
  encode(message: Peripherals, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.servoTopology !== undefined) {
      ServoTopology.encode(message.servoTopology, writer.uint32(194).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Peripherals {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ServoTopology = {
  encode(message: ServoTopology, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.main !== undefined) {
      ServoTopologyItem.encode(message.main, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.children) {
      ServoTopologyItem.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ServoTopology {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ServoTopologyItem = {
  encode(message: ServoTopologyItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ServoTopologyItem {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TestCoverageHints = {
  encode(message: TestCoverageHints, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TestCoverageHints {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ModemInfo = {
  encode(message: ModemInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.type !== undefined && message.type !== 0) {
      writer.uint32(8).int32(message.type);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ModemInfo {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SIMInfo = {
  encode(message: SIMInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.profileInfo) {
      SIMProfileInfo.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SIMInfo {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SIMProfileInfo = {
  encode(message: SIMProfileInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SIMProfileInfo {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
