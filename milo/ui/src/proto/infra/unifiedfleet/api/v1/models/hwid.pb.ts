...
export const GetDutLabelResponse = {
  encode(message: GetDutLabelResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.dutLabel !== undefined) {
      DutLabel.encode(message.dutLabel, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): GetDutLabelResponse {
...
export const DutLabel = {
  encode(message: DutLabel, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.possibleLabels) {
      writer.uint32(10).string(v!);
    }
    for (const v of message.labels) {
      DutLabel_Label.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): DutLabel {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DutLabel_Label = {
  encode(message: DutLabel_Label, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DutLabel_Label {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const HwidData = {
  encode(message: HwidData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sku !== "") {
    ...
    if (message.dutLabel !== undefined) {
      DutLabel.encode(message.dutLabel, writer.uint32(34).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): HwidData {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
