...
export const Servo = {
  encode(message: Servo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.servoTopology !== undefined) {
      ServoTopology.encode(message.servoTopology, writer.uint32(66).fork()).ldelim();
    }
    ...
    if (message.usbDrive !== undefined) {
      UsbDrive.encode(message.usbDrive, writer.uint32(98).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): Servo {
