...
//   protoc               v5.26.1
// source: infra/unifiedfleet/api/v1/models/ownership.proto
...
export const OwnershipData = {
  encode(message: OwnershipData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OwnershipData {
