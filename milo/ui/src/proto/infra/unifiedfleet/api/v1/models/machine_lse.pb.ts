...
export const MachineLSE = {
  encode(message: MachineLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
    ...
    if (message.chromeBrowserMachineLse !== undefined) {
      ChromeBrowserMachineLSE.encode(message.chromeBrowserMachineLse, writer.uint32(34).fork()).ldelim();
    }
    if (message.chromeosMachineLse !== undefined) {
      ChromeOSMachineLSE.encode(message.chromeosMachineLse, writer.uint32(42).fork()).ldelim();
    }
    if (message.attachedDeviceLse !== undefined) {
      AttachedDeviceLSE.encode(message.attachedDeviceLse, writer.uint32(162).fork()).ldelim();
    }
    ...
    if (message.ownership !== undefined) {
      OwnershipData.encode(message.ownership, writer.uint32(178).fork()).ldelim();
    }
    ...
    if (message.wifiSecret !== undefined) {
      Secret.encode(message.wifiSecret, writer.uint32(210).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MachineLSE {
...
export const ChromeBrowserMachineLSE = {
  encode(message: ChromeBrowserMachineLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.osVersion !== undefined) {
      OSVersion.encode(message.osVersion, writer.uint32(26).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeBrowserMachineLSE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VM = {
  encode(message: VM, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.osVersion !== undefined) {
      OSVersion.encode(message.osVersion, writer.uint32(18).fork()).ldelim();
    }
    ...
    if (message.ownership !== undefined) {
      OwnershipData.encode(message.ownership, writer.uint32(130).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VM {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 18:
          ...
          message.memory = longToString(reader.int64() as Long);
          continue;
        case 19:
          if (tag !== 152) {
            break;
          ...
          message.storage = longToString(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const OSVersion = {
  encode(message: OSVersion, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.value !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OSVersion {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSMachineLSE = {
  encode(message: ChromeOSMachineLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.dut !== undefined) {
      ChromeOSDeviceLSE.encode(message.dut, writer.uint32(10).fork()).ldelim();
    }
    if (message.server !== undefined) {
      ChromeOSServerLSE.encode(message.server, writer.uint32(18).fork()).ldelim();
    }
    if (message.deviceLse !== undefined) {
      ChromeOSDeviceLSE.encode(message.deviceLse, writer.uint32(26).fork()).ldelim();
    }
    if (message.serverLse !== undefined) {
      ChromeOSServerLSE.encode(message.serverLse, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSMachineLSE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSDeviceLSE = {
  encode(message: ChromeOSDeviceLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.config !== undefined) {
      DeviceUnderTest.encode(message.config, writer.uint32(10).fork()).ldelim();
    }
    if (message.rpmInterface !== undefined) {
      RPMInterface.encode(message.rpmInterface, writer.uint32(18).fork()).ldelim();
    }
    if (message.networkDeviceInterface !== undefined) {
      SwitchInterface.encode(message.networkDeviceInterface, writer.uint32(26).fork()).ldelim();
    }
    if (message.dut !== undefined) {
      DeviceUnderTest.encode(message.dut, writer.uint32(34).fork()).ldelim();
    }
    if (message.labstation !== undefined) {
      Labstation.encode(message.labstation, writer.uint32(42).fork()).ldelim();
    }
    if (message.devboard !== undefined) {
      Devboard.encode(message.devboard, writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSDeviceLSE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DutMeta = {
  encode(message: DutMeta, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DutMeta {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LabMeta = {
  encode(message: LabMeta, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.chromeosDeviceId !== "") {
      writer.uint32(10).string(message.chromeosDeviceId);
    }
    if (message.hostname !== "") {
    ...
    if (message.servoTopology !== undefined) {
      ServoTopology.encode(message.servoTopology, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): LabMeta {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSDeviceData = {
  encode(message: ChromeOSDeviceData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.deviceConfig !== undefined) {
      Config.encode(message.deviceConfig, writer.uint32(26).fork()).ldelim();
    }
    if (message.manufacturingConfig !== undefined) {
      ManufacturingConfig.encode(message.manufacturingConfig, writer.uint32(34).fork()).ldelim();
    }
    if (message.hwidData !== undefined) {
      HwidData.encode(message.hwidData, writer.uint32(42).fork()).ldelim();
    }
    if (message.dutState !== undefined) {
      DutState.encode(message.dutState, writer.uint32(50).fork()).ldelim();
    }
    if (message.dutV1 !== undefined) {
      DeviceUnderTest1.encode(message.dutV1, writer.uint32(58).fork()).ldelim();
    }
    Object.entries(message.schedulableLabels).forEach(([key, value]) => {
      ChromeOSDeviceData_SchedulableLabelsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).ldelim();
    });
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSDeviceData {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSDeviceData_SchedulableLabelsEntry = {
  encode(message: ChromeOSDeviceData_SchedulableLabelsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      SchedulableLabelValues.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSDeviceData_SchedulableLabelsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchedulableLabelValues = {
  encode(message: SchedulableLabelValues, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SchedulableLabelValues {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSServerLSE = {
  encode(message: ChromeOSServerLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSServerLSE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AttachedDeviceLSE = {
  encode(message: AttachedDeviceLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.osVersion !== undefined) {
      OSVersion.encode(message.osVersion, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AttachedDeviceLSE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
