...
export const Rack = {
  encode(message: Rack, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
    ...
    if (message.chromeBrowserRack !== undefined) {
      ChromeBrowserRack.encode(message.chromeBrowserRack, writer.uint32(34).fork()).ldelim();
    }
    if (message.chromeosRack !== undefined) {
      ChromeOSRack.encode(message.chromeosRack, writer.uint32(42).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Rack {
...
export const ChromeBrowserRack = {
  encode(message: ChromeBrowserRack, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.rpmObjects) {
      RPM.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    for (const v of message.kvmObjects) {
      KVM.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    for (const v of message.switchObjects) {
      Switch.encode(v!, writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeBrowserRack {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSRack = {
  encode(message: ChromeOSRack, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.switchObjects) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSRack {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
