...
export const ManufacturingConfig = {
  encode(message: ManufacturingConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.manufacturingId !== undefined) {
      ConfigID.encode(message.manufacturingId, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ManufacturingConfig {
...
export const ManufacturingConfigList = {
  encode(message: ManufacturingConfigList, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.value) {
      ManufacturingConfig.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ManufacturingConfigList {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
