...
export const ChromeOSDevice = {
  encode(message: ChromeOSDevice, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.manufacturingId !== undefined) {
      ConfigID.encode(message.manufacturingId, writer.uint32(26).fork()).ldelim();
    }
    if (message.deviceConfigId !== undefined) {
      ConfigId.encode(message.deviceConfigId, writer.uint32(34).fork()).ldelim();
    }
    if (message.dut !== undefined) {
      DeviceUnderTest.encode(message.dut, writer.uint32(42).fork()).ldelim();
    }
    if (message.labstation !== undefined) {
      Labstation.encode(message.labstation, writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSDevice {
...
export const DeviceUnderTest = {
  encode(message: DeviceUnderTest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.peripherals !== undefined) {
      Peripherals.encode(message.peripherals, writer.uint32(18).fork()).ldelim();
    }
    ...
    for (const v of message.licenses) {
      License.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    if (message.modeminfo !== undefined) {
      ModemInfo.encode(message.modeminfo, writer.uint32(50).fork()).ldelim();
    }
    for (const v of message.siminfo) {
      SIMInfo.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    Object.entries(message.roVpdMap).forEach(([key, value]) => {
      DeviceUnderTest_RoVpdMapEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).ldelim();
    });
...
export const DeviceUnderTest_RoVpdMapEntry = {
  encode(message: DeviceUnderTest_RoVpdMapEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeviceUnderTest_RoVpdMapEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Labstation = {
  encode(message: Labstation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
      writer.uint32(10).string(message.hostname);
    }
    for (const v of message.servos) {
      Servo.encode(v!, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Labstation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
