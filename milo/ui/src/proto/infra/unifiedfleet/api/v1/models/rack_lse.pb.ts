...
export const RackLSE = {
  encode(message: RackLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
    ...
    if (message.chromeBrowserRackLse !== undefined) {
      ChromeBrowserRackLSE.encode(message.chromeBrowserRackLse, writer.uint32(26).fork()).ldelim();
    }
    if (message.chromeosRackLse !== undefined) {
      ChromeOSRackLSE.encode(message.chromeosRackLse, writer.uint32(34).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RackLSE {
...
export const ChromeBrowserRackLSE = {
  encode(message: ChromeBrowserRackLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeBrowserRackLSE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSRackLSE = {
  encode(message: ChromeOSRackLSE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSRackLSE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
