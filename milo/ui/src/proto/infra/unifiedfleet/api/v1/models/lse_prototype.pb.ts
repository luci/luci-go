...
export const RackLSEPrototype = {
  encode(message: RackLSEPrototype, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    for (const v of message.peripheralRequirements) {
      PeripheralRequirement.encode(v!, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RackLSEPrototype {
...
export const MachineLSEPrototype = {
  encode(message: MachineLSEPrototype, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    for (const v of message.peripheralRequirements) {
    ...
    for (const v of message.virtualRequirements) {
      VirtualRequirement.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    for (const v of message.tags) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MachineLSEPrototype {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PeripheralRequirement = {
  encode(message: PeripheralRequirement, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PeripheralRequirement {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VirtualRequirement = {
  encode(message: VirtualRequirement, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VirtualRequirement {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
