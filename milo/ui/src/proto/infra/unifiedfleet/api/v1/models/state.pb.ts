...
function createBaseStateRecord(): StateRecord {
  return { resourceName: "", state: 0, user: "", ticket: "", description: "", updateTime: undefined };
}

export const StateRecord = {
  encode(message: StateRecord, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StateRecord {
