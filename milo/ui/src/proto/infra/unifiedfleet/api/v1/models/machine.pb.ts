...
export const Machine = {
  encode(message: Machine, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.chromeBrowserMachine !== undefined) {
      ChromeBrowserMachine.encode(message.chromeBrowserMachine, writer.uint32(34).fork()).ldelim();
    }
    if (message.chromeosMachine !== undefined) {
      ChromeOSMachine.encode(message.chromeosMachine, writer.uint32(42).fork()).ldelim();
    }
    if (message.attachedDevice !== undefined) {
      AttachedDevice.encode(message.attachedDevice, writer.uint32(90).fork()).ldelim();
    }
    if (message.devboard !== undefined) {
      Devboard.encode(message.devboard, writer.uint32(106).fork()).ldelim();
    }
    ...
    if (message.ownership !== undefined) {
      OwnershipData.encode(message.ownership, writer.uint32(114).fork()).ldelim();
    }
    return writer;
  },
...
export const ChromeBrowserMachine = {
  encode(message: ChromeBrowserMachine, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.kvmInterface !== undefined) {
      KVMInterface.encode(message.kvmInterface, writer.uint32(34).fork()).ldelim();
    }
    if (message.rpmInterface !== undefined) {
      RPMInterface.encode(message.rpmInterface, writer.uint32(42).fork()).ldelim();
    }
    ...
    for (const v of message.nicObjects) {
      Nic.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    if (message.dracObject !== undefined) {
      Drac.encode(message.dracObject, writer.uint32(98).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeBrowserMachine {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChromeOSMachine = {
  encode(message: ChromeOSMachine, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChromeOSMachine {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AttachedDevice = {
  encode(message: AttachedDevice, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AttachedDevice {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Devboard = {
  encode(message: Devboard, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.andreiboard !== undefined) {
      Andreiboard.encode(message.andreiboard, writer.uint32(10).fork()).ldelim();
    }
    if (message.icetower !== undefined) {
      Icetower.encode(message.icetower, writer.uint32(18).fork()).ldelim();
    }
    if (message.dragonclaw !== undefined) {
      Dragonclaw.encode(message.dragonclaw, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): Devboard {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Andreiboard = {
  encode(message: Andreiboard, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Andreiboard {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Icetower = {
  encode(message: Icetower, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Icetower {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Dragonclaw = {
  encode(message: Dragonclaw, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.fingerprintId !== "") {
      writer.uint32(10).string(message.fingerprintId);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Dragonclaw {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
