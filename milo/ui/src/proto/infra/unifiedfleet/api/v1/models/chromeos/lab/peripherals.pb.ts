...
import { PasitHost } from "../../../../../../../go.chromium.org/chromiumos/config/proto/chromiumos/test/lab/api/pasit_host.pb";
import {
...
export const Peripherals = {
  encode(message: Peripherals, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.servo !== undefined) {
      Servo.encode(message.servo, writer.uint32(10).fork()).ldelim();
    }
    if (message.chameleon !== undefined) {
      Chameleon.encode(message.chameleon, writer.uint32(18).fork()).ldelim();
    }
    if (message.rpm !== undefined) {
      OSRPM.encode(message.rpm, writer.uint32(26).fork()).ldelim();
    }
    for (const v of message.connectedCamera) {
      Camera.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    if (message.audio !== undefined) {
      Audio.encode(message.audio, writer.uint32(42).fork()).ldelim();
    }
    if (message.wifi !== undefined) {
      Wifi.encode(message.wifi, writer.uint32(50).fork()).ldelim();
    }
    if (message.touch !== undefined) {
      Touch.encode(message.touch, writer.uint32(58).fork()).ldelim();
    }
    if (message.carrier !== "") {
    ...
    for (const v of message.cable) {
      Cable.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    if (message.cameraboxInfo !== undefined) {
      Camerabox.encode(message.cameraboxInfo, writer.uint32(98).fork()).ldelim();
    }
    ...
    for (const v of message.bluetoothPeers) {
      BluetoothPeer.encode(v!, writer.uint32(130).fork()).ldelim();
    }
    if (message.humanMotionRobot !== undefined) {
      HumanMotionRobot.encode(message.humanMotionRobot, writer.uint32(146).fork()).ldelim();
    }
    if (message.audioLatencyToolkit !== undefined) {
      AudioLatencyToolkit.encode(message.audioLatencyToolkit, writer.uint32(154).fork()).ldelim();
    }
    if (message.dolos !== undefined) {
      Dolos.encode(message.dolos, writer.uint32(162).fork()).ldelim();
    }
    if (message.pasitHost2 !== undefined) {
      PasitHost.encode(message.pasitHost2, writer.uint32(194).fork()).ldelim();
    }
    if (message.amtManager !== undefined) {
      AMTManager.encode(message.amtManager, writer.uint32(202).fork()).ldelim();
    }
    return writer;
  },
...
export const Wifi = {
  encode(message: Wifi, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.wifiRouters) {
      WifiRouter.encode(v!, writer.uint32(34).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Wifi {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WifiRouter = {
  encode(message: WifiRouter, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
    ...
    if (message.rpm !== undefined) {
      OSRPM.encode(message.rpm, writer.uint32(42).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WifiRouter {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Touch = {
  encode(message: Touch, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Touch {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Camerabox = {
  encode(message: Camerabox, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.facing !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Camerabox {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RaspberryPi = {
  encode(message: RaspberryPi, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
      writer.uint32(10).string(message.hostname);
    }
    if (message.state !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RaspberryPi {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BluetoothPeer = {
  encode(message: BluetoothPeer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.raspberryPi !== undefined) {
      RaspberryPi.encode(message.raspberryPi, writer.uint32(10).fork()).ldelim();
    }
    if (message.rpm !== undefined) {
      OSRPM.encode(message.rpm, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): BluetoothPeer {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseHumanMotionRobot(): HumanMotionRobot {
  return { hostname: "", hmrModel: "", gatewayHostname: "", rpm: undefined };
}

export const HumanMotionRobot = {
  encode(message: HumanMotionRobot, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
      writer.uint32(10).string(message.hostname);
    }
    if (message.hmrModel !== "") {
    ...
    if (message.rpm !== undefined) {
      OSRPM.encode(message.rpm, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): HumanMotionRobot {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AudioLatencyToolkit = {
  encode(message: AudioLatencyToolkit, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.version !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AudioLatencyToolkit {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AMTManager = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AMTManager {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
