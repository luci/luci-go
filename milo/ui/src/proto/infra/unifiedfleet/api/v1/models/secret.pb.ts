...
export const DefaultWifi = {
  encode(message: DefaultWifi, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.wifiSecret !== undefined) {
      Secret.encode(message.wifiSecret, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): DefaultWifi {
