...
export const AssetInfo = {
  encode(message: AssetInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.assetTag !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AssetInfo {
...
export const AssetInfoRequest = {
  encode(message: AssetInfoRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AssetInfoRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AssetInfoResponse = {
  encode(message: AssetInfoResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.requestStatus !== 0) {
      writer.uint32(8).int32(message.requestStatus);
    }
    for (const v of message.assets) {
      AssetInfo.encode(v!, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AssetInfoResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
