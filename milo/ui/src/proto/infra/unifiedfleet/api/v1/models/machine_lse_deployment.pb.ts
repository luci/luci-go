...
export const MachineLSEDeployment = {
  encode(message: MachineLSEDeployment, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hostname !== "") {
    ...
    for (const v of message.configsToPush) {
      Payload.encode(v!, writer.uint32(34).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MachineLSEDeployment {
