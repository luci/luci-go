...
export const ConfigId = {
  encode(message: ConfigId, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.platformId !== undefined) {
      PlatformId.encode(message.platformId, writer.uint32(10).fork()).ldelim();
    }
    if (message.modelId !== undefined) {
      ModelId.encode(message.modelId, writer.uint32(18).fork()).ldelim();
    }
    if (message.variantId !== undefined) {
      VariantId.encode(message.variantId, writer.uint32(26).fork()).ldelim();
    }
    if (message.brandId !== undefined) {
      BrandId.encode(message.brandId, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
