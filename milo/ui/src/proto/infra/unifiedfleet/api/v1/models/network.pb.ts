    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 15:
          ...
          message.reservedIpNum = longToString(reader.int64() as Long);
          continue;
        case 16:
          if (tag !== 128) {
            break;
          ...
          message.allocatedIpNum = longToString(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const DHCPConfig = {
  encode(message: DHCPConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.macAddress !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DHCPConfig {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AllDHCPConfigs = {
  encode(message: AllDHCPConfigs, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AllDHCPConfigs {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const IP = {
  encode(message: IP, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): IP {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
