...
export interface PrpcServiceClientOptions<S> {
  /**
 ...
 * ```
 */
export function usePrpcServiceClient<S extends object>(
  opts: PrpcServiceClientOptions<S>,
) {
  const { host, insecure, ClientImpl } = opts;
