...
func TestConfigValidation(t *testing.T) {
	...
	Convey("Validation works", t, func() {
		...
		So(load(
			...
			&ACLs{
				hosts: map[string]*hostACLs{
					"first.googlesource.com": &hostACLs{
						itemACLs: itemACLs{
							definedIn: 0,
							readers:   []string{"user:user@example.com"},
						},
					},
					"second.googlesource.com": &hostACLs{
					...
					"third.googlesource.com": &hostACLs{
						itemACLs: itemACLs{definedIn: -1},
						projects: map[string]*itemACLs{
							"/z": &itemACLs{
								definedIn: 0,
