...
// GitTransport returns an HTTP transport to be used for the given host.
//
...
func GitTransport(c context.Context, host string) (transport http.RoundTripper, authenticated bool, err error) {
