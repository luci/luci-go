...
type BuildSummary struct {
	...
	// consoles holds the consoles returned by GetAllConsoles. It is populated by
	// AddManifestKeysFromBuildSet, does not get written to the datastore, and is
	// used to update the console strings list in the respective BuilderSummary.
