...
func (agent *Agent) handle(ctx context.Context, instruction *machine.ComponentsMachineProviderRpcMessagesPollResponse) error {
	...
	instructionsHandled.Add(ctx, 1, agent.server, instruction.Instruction.SwarmingServer)
	instructionsHandledTime.Add(ctx, duration, agent.server, instruction.Instruction.SwarmingServer)
