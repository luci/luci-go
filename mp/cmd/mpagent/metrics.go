...
var (
	instructionsHandled = metric.NewCounter(
		"machine_provider/agent/instructions/handled",
	...
	instructionsHandledTime = metric.NewCumulativeDistribution(
		"machine_provider/agent/instructions/handled/time",
