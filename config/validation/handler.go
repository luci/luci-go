...
// the process-global validation rules defined via Rules variable.
//
...
func InstallHandlers(r *router.Router, base router.MiddlewareChain) {
	InstallHandlersWithRules(r, base, &Rules)
}

// InstallHandlersWithRules is like InstallHandlers, but allows you to specify
// your own RuleSet instead of using the default process-wide one.
func InstallHandlersWithRules(r *router.Router, base router.MiddlewareChain, rules *RuleSet) {
