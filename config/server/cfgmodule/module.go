...
type ModuleOptions struct {
	...
	// Rules is a rule set to use for config validation.
	//
	// If nil, the module uses global &validation.Rules.
	//
	// The module registers following vars in the rule set during
	// the initialization:
