...
type Meta struct {
	...
	//
	// If project doens't exist, empty.
	// Otherwise, contains at least group.
...
// GetConfigGroups loads all ConfigGroups from datastore.
//
...
// Doesn't check whether validity or existince of the given LUCI project.
