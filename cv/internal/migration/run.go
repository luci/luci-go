...
// makeGerritSetReviewRequest creates request to post a comemnt to Gerrit at
// CQDaemon's request.
func makeGerritSetReviewRequest(r *run.Run, ci *gerritpb.ChangeInfo, msg string, sendEmail bool) *gerritpb.SetReviewRequest {
