...
//     to 13 digits. See the defintion of CreateTime in the doc of `CreateTime`
//     in Run entity.
...
type Run struct {
	...
	//
	// For API triggered Run, the CreateTime is when CV receives the request.
	// For non-API triggered Run, the CreateTime is the timestamp of the vote
	// on a Gerrit CL that triggers this Run.
