...
type GobWatchMapProject struct {
	...
	// LUCI project name.
	//
	// This may be used when querying for entities to update or remove in the
	// update operation. This needs to be a separate property assuming that a
	// query filtering on just ID wouldn't work.
	Project string
	...
	RefRegexpInclude []string
	RefRegexpExclude []string
