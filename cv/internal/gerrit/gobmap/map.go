...
// Each GobWatchMap contains config groups for a particular LUCI project and
...
type GobWatchMap struct {
	...
	// The ID of this GobWatchMap. This may be "project/host/repo".
	ID string `gae:"$id"`
	...
	// A string "<host>/<repo>".
	//
	// Host is the Gerrit host and repo is the Gerrit project, e.g.
	// "chromium-review.googlesource.com/chromium/src". The schema of the
	// Gerrit host is not included; it is always assumed to be https.
	HostRepo string
