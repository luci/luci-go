...
// UpdateCL fetches lastest info from Gerrit.
//
...
type fetcher struct {
	...
	result *clpb.Snapshot
}

func (f *fetcher) do(ctx context.Context) (*clpb.Snapshot, error) {
	f.result = &clpb.Snapshot{Kind: &clpb.Snapshot_Gerrit{Gerrit: &clpb.Gerrit{}}}
