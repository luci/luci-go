...
// TODO(tandrii); delete this file with fetcherlegacy struct.
...
// fetcherlegacy efficiently computes new snapshot by fetching data from Gerrit.
//
...
func (f *fetcherlegacy) update(ctx context.Context, clidHint common.CLID) (err error) {
...
func (f *fetcherlegacy) updateCLEntity(cl *changelist.CL) error {
...
func (f *fetcherlegacy) fetchPostChangeInfo(ctx context.Context, ci *gerritpb.ChangeInfo) error {
...
func (f *fetcherlegacy) fetchChangeInfo(ctx context.Context, opts ...gerritpb.QueryOption) (*gerritpb.ChangeInfo, error) {
...
func (f *fetcherlegacy) setCertainNoAccess(ctx context.Context) error {
	now := clock.Now(ctx)
	noAccessAt := now
...
func (f *fetcherlegacy) setLikelyNoAccess(ctx context.Context) error {
	now := clock.Now(ctx)
...
func (f *fetcherlegacy) setNoAccessAt(now, noAccessAt time.Time) {
...
func (f *fetcherlegacy) recheckAccessLater(ctx context.Context, delay time.Duration) error {
	t := &RefreshGerritCL{
		LuciProject: f.luciProject,
		Host:        f.host,
		Change:      f.change,
...
func (f *fetcherlegacy) fetchRelated(ctx context.Context) error {
...
func (f *fetcherlegacy) setGitDeps(ctx context.Context, related []*gerritpb.GetRelatedChangesResponse_ChangeAndCommit) {
...
func (f *fetcherlegacy) matchCurrentAmongRelated(
...
func (f *fetcherlegacy) countRelatedWhichAreParents(this *gerritpb.GetRelatedChangesResponse_ChangeAndCommit, byRevision map[string][]*gerritpb.GetRelatedChangesResponse_ChangeAndCommit) int {
	cnt := 0
...
func (f *fetcherlegacy) fetchFiles(ctx context.Context) error {
	return f.gFactory.MakeMirrorIterator(ctx).RetryIfStale(func(opt grpc.CallOption) error {
...
func (f *fetcherlegacy) setSoftDeps() error {
...
func (f *fetcherlegacy) resolveDeps(ctx context.Context) error {
...
func (f *fetcherlegacy) depsToExternalIDs() (map[changelist.ExternalID]changelist.DepKind, error) {
...
func (f *fetcherlegacy) isStale(ctx context.Context, externalUpdateTime *timestamppb.Timestamp) bool {
...
func (f *fetcherlegacy) isHostWatched(ctx context.Context) (bool, error) {
...
func (f *fetcherlegacy) gerritProjectIfKnown() string {
...
func (f *fetcherlegacy) clidIfKnown() common.CLID {
	if f.priorCL != nil {
		return f.priorCL.ID
	}
	return 0
...
func (f *fetcherlegacy) priorSnapshot() *changelist.Snapshot {
	if f.priorCL != nil {
...
func (f *fetcherlegacy) priorNoAccessTime() time.Time {
	if f.priorCL == nil {
		return time.Time{}
	}
...
func (f *fetcherlegacy) mustHaveCurrentRevision() string {
...
func (f *fetcherlegacy) String() string {
	if f.priorCL == nil {
