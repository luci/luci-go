...
// Client must be implementable by production GerritClient.
var _ = gerritpb.GerritClient(nil).(Client)

var clientCtxKey = "go.chromiu.org/luci/cv/internal/gerrit.Client"
