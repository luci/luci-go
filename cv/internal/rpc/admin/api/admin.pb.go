...
const file_go_chromium_org_luci_cv_internal_rpc_admin_api_admin_proto_rawDesc = "" +
	"\n" +
	":go.chromium.org/luci/cv/internal/rpc/admin/api/admin.proto\x12\x19cv.internal.rpc.admin.api\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a>go.chromium.org/luci/server/dsmapper/dsmapperpb/messages.proto\x1a9go.chromium.org/luci/cv/internal/changelist/storage.proto\x1a6go.chromium.org/luci/cv/internal/changelist/task.proto\x1aEgo.chromium.org/luci/cv/internal/configs/prjcfg/refresher/tasks.proto\x1a<go.chromium.org/luci/cv/internal/gerrit/poller/storage.proto\x1a9go.chromium.org/luci/cv/internal/gerrit/poller/task.proto\x1a>go.chromium.org/luci/cv/internal/prjmanager/prjpb/events.proto\x1a?go.chromium.org/luci/cv/internal/prjmanager/prjpb/storage.proto\x1a=go.chromium.org/luci/cv/internal/prjmanager/prjpb/tasks.proto\x1a3go.chromium.org/luci/cv/internal/run/bq/tasks.proto\x1a9go.chromium.org/luci/cv/internal/run/eventpb/events.proto\x1a8go.chromium.org/luci/cv/internal/run/eventpb/tasks.proto\x1a2go.chromium.org/luci/cv/internal/run/storage.proto\x1a7go.chromium.org/luci/server/quota/quotapb/service.proto\"-\n" +
	"\x11GetProjectRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\"\x8d\x01\n" +
	"\x12GetProjectResponse\x12:\n" +
	"\x05state\x18\x02 \x01(\v2$.cv.internal.prjmanager.prjpb.PStateR\x05state\x12;\n" +
	"\x06events\x18\x03 \x03(\v2#.cv.internal.prjmanager.prjpb.EventR\x06events\"\xb3\x01\n" +
	"\x15GetProjectLogsRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12\x18\n" +
	"\aproject\x18\x03 \x01(\tR\aproject\x12!\n" +
	"\feversion_min\x18\x04 \x01(\x03R\veversionMin\x12!\n" +
	"\feversion_max\x18\x05 \x01(\x03R\veversionMax\"S\n" +
	"\x16GetProjectLogsResponse\x129\n" +
	"\x04logs\x18\x01 \x03(\v2%.cv.internal.rpc.admin.api.ProjectLogR\x04logs\"\xe5\x01\n" +
	"\n" +
	"ProjectLog\x12\x1a\n" +
	"\beversion\x18\x01 \x01(\x03R\beversion\x12:\n" +
	"\x05state\x18\x02 \x01(\v2$.cv.internal.prjmanager.prjpb.PStateR\x05state\x12;\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12B\n" +
	"\areasons\x18\x04 \x01(\v2(.cv.internal.prjmanager.prjpb.LogReasonsR\areasons\"!\n" +
	"\rGetRunRequest\x12\x10\n" +
	"\x03run\x18\x01 \x01(\tR\x03run\"\xba\t\n" +
	"\x0eGetRunResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\beversion\x18\x02 \x01(\x03R\beversion\x12\x12\n" +
	"\x04mode\x18\x03 \x01(\tR\x04mode\x12/\n" +
	"\x06status\x18\x04 \x01(\x0e2\x17.cv.internal.run.StatusR\x06status\x12;\n" +
	...
	"\n" +
	"created_by\x18\x18 \x01(\tR\tcreatedBy\x12\x1b\n" +
	"\tbilled_to\x18\x19 \x01(\tR\bbilledTo\x12&\n" +
	"\x0fconfig_group_id\x18\n" +
	" \x01(\tR\rconfigGroupId\x12>\n" +
	"\x03cls\x18\x17 \x03(\v2,.cv.internal.rpc.admin.api.GetRunResponse.CLR\x03cls\x122\n" +
	"\aoptions\x18\x10 \x01(\v2\x18.cv.internal.run.OptionsR\aoptions\x121\n" +
	"\x14cancellation_reasons\x18\x16 \x03(\tR\x13cancellationReasons\x122\n" +
	"\atryjobs\x18\x11 \x01(\v2\x18.cv.internal.run.TryjobsR\atryjobs\x12I\n" +
	"\x10ongoing_long_ops\x18\x15 \x01(\v2\x1f.cv.internal.run.OngoingLongOpsR\x0eongoingLongOps\x12;\n" +
	"\n" +
	"submission\x18\f \x01(\v2\x1b.cv.internal.run.SubmissionR\n" +
	"submission\x12H\n" +
	"\x12latest_cls_refresh\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\x10latestClsRefresh\x12:\n" +
	"\vlog_entries\x18\x13 \x03(\v2\x19.cv.internal.run.LogEntryR\n" +
	"logEntries\x126\n" +
	"\x06events\x18\x14 \x03(\v2\x1e.cv.internal.run.eventpb.EventR\x06events\x1a\xa3\x01\n" +
	"\x02CL\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1f\n" +
	"\vexternal_id\x18\x02 \x01(\tR\n" +
	"externalId\x128\n" +
	"\x06detail\x18\x03 \x01(\v2 .cv.internal.changelist.SnapshotR\x06detail\x122\n" +
	"\atrigger\x18\x04 \x01(\v2\x18.cv.internal.run.TriggerR\atriggerJ\x04\b\v\x10\fJ\x04\b\x0f\x10\x10\"^\n" +
	"\fGetCLRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1f\n" +
	"\vexternal_id\x18\x02 \x01(\tR\n" +
	"externalId\x12\x1d\n" +
	"\n" +
	"gerrit_url\x18\x03 \x01(\tR\tgerritUrl\"\x8f\x03\n" +
	"\rGetCLResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1a\n" +
	"\beversion\x18\x02 \x01(\x03R\beversion\x12\x1f\n" +
	"\vexternal_id\x18\x03 \x01(\tR\n" +
	"externalId\x12;\n" +
	"\vupdate_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12<\n" +
	"\bsnapshot\x18\x04 \x01(\v2 .cv.internal.changelist.SnapshotR\bsnapshot\x12U\n" +
	"\x11applicable_config\x18\x05 \x01(\v2(.cv.internal.changelist.ApplicableConfigR\x10applicableConfig\x126\n" +
	"\x06access\x18\x06 \x01(\v2\x1e.cv.internal.changelist.AccessR\x06access\x12'\n" +
	"\x0fincomplete_runs\x18\a \x03(\tR\x0eincompleteRuns\",\n" +
	"\x10GetPollerRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\"\xf2\x01\n" +
	"\x11GetPollerResponse\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12\x1a\n" +
	"\beversion\x18\x02 \x01(\x03R\beversion\x12;\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12\x1f\n" +
	"\vconfig_hash\x18\x04 \x01(\tR\n" +
	"configHash\x12I\n" +
	"\fquery_states\x18\x05 \x01(\v2&.cv.internal.gerrit.poller.QueryStatesR\vqueryStates\"L\n" +
	"\x1aDeleteProjectEventsRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\"\xb4\x01\n" +
	"\x1bDeleteProjectEventsResponse\x12Z\n" +
	"\x06events\x18\x01 \x03(\v2B.cv.internal.rpc.admin.api.DeleteProjectEventsResponse.EventsEntryR\x06events\x1a9\n" +
	"\vEventsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"4\n" +
	"\x18RefreshProjectCLsRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\"\xc1\x01\n" +
	"\x19RefreshProjectCLsResponse\x12e\n" +
	"\vcl_versions\x18\x01 \x03(\v2D.cv.internal.rpc.admin.api.RefreshProjectCLsResponse.ClVersionsEntryR\n" +
	"clVersions\x1a=\n" +
	"\x0fClVersionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"n\n" +
	"\x17SendProjectEventRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x129\n" +
	"\x05event\x18\x02 \x01(\v2#.cv.internal.prjmanager.prjpb.EventR\x05event\"]\n" +
	"\x13SendRunEventRequest\x12\x10\n" +
	"\x03run\x18\x01 \x01(\tR\x03run\x124\n" +
	"\x05event\x18\x02 \x01(\v2\x1e.cv.internal.run.eventpb.EventR\x05event\"\xe7\x01\n" +
	"\x11SearchRunsRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12\x18\n" +
	"\aproject\x18\x03 \x01(\tR\aproject\x12/\n" +
	"\x06status\x18\x04 \x01(\x0e2\x17.cv.internal.run.StatusR\x06status\x127\n" +
	"\x02cl\x18\x05 \x01(\v2'.cv.internal.rpc.admin.api.GetCLRequestR\x02cl\x12\x12\n" +
	"\x04mode\x18\x06 \x01(\tR\x04mode\"u\n" +
	"\fRunsResponse\x12=\n" +
	"\x04runs\x18\x01 \x03(\v2).cv.internal.rpc.admin.api.GetRunResponseR\x04runs\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xc0\b\n" +
	"\x13ScheduleTaskRequest\x12A\n" +
	"\tupdate_cl\x18\r \x01(\v2$.cv.internal.changelist.UpdateCLTaskR\bupdateCl\x12Q\n" +
	"\x0fbatch_update_cl\x18\x0e \x01(\v2).cv.internal.changelist.BatchUpdateCLTaskR\rbatchUpdateCl\x12[\n" +
	"\x13batch_on_cl_updated\x18\x0f \x01(\v2,.cv.internal.changelist.BatchOnCLUpdatedTaskR\x10batchOnClUpdated\x12t\n" +
	"\x16refresh_project_config\x18\x01 \x01(\v2>.cv.internal.configs.prjcfg.refresher.RefreshProjectConfigTaskR\x14refreshProjectConfig\x12J\n" +
	"\vpoll_gerrit\x18\x02 \x01(\v2).cv.internal.gerrit.poller.PollGerritTaskR\n" +
	"pollGerrit\x12V\n" +
	"\x0emanage_project\x18\x05 \x01(\v2/.cv.internal.prjmanager.prjpb.ManageProjectTaskR\rmanageProject\x12c\n" +
	"\x13kick_manage_project\x18\x06 \x01(\v23.cv.internal.prjmanager.prjpb.KickManageProjectTaskR\x11kickManageProject\x12D\n" +
	"\bpurge_cl\x18\a \x01(\v2).cv.internal.prjmanager.prjpb.PurgeCLTaskR\apurgeCl\x12N\n" +
	"\x10export_run_to_bq\x18\b \x01(\v2%.cv.internal.run.bq.ExportRunToBQTaskR\rexportRunToBq\x12E\n" +
	"\n" +
	"manage_run\x18\t \x01(\v2&.cv.internal.run.eventpb.ManageRunTaskR\tmanageRun\x12R\n" +
	"\x0fkick_manage_run\x18\n" +
	" \x01(\v2*.cv.internal.run.eventpb.KickManageRunTaskR\rkickManageRun\x12Y\n" +
	"\x12manage_run_long_op\x18\f \x01(\v2,.cv.internal.run.eventpb.ManageRunLongOpTaskR\x0fmanageRunLongOp\x12+\n" +
	"\x11deduplication_key\x18\v \x01(\tR\x10deduplicationKey\")\n" +
	"\x13DSMLaunchJobRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x1a\n" +
	"\bDSMJobID\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"O\n" +
	"\x06DSMJob\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x121\n" +
	"\x04info\x18\x02 \x01(\v2\x1d.luci.server.dsmapper.JobInfoR\x04info2\xad\r\n" +
	"\x05Admin\x12i\n" +
	"\n" +
	"GetProject\x12,.cv.internal.rpc.admin.api.GetProjectRequest\x1a-.cv.internal.rpc.admin.api.GetProjectResponse\x12u\n" +
	"\x0eGetProjectLogs\x120.cv.internal.rpc.admin.api.GetProjectLogsRequest\x1a1.cv.internal.rpc.admin.api.GetProjectLogsResponse\x12]\n" +
	"\x06GetRun\x12(.cv.internal.rpc.admin.api.GetRunRequest\x1a).cv.internal.rpc.admin.api.GetRunResponse\x12Z\n" +
	"\x05GetCL\x12'.cv.internal.rpc.admin.api.GetCLRequest\x1a(.cv.internal.rpc.admin.api.GetCLResponse\x12f\n" +
	"\tGetPoller\x12+.cv.internal.rpc.admin.api.GetPollerRequest\x1a,.cv.internal.rpc.admin.api.GetPollerResponse\x12c\n" +
	"\n" +
	"SearchRuns\x12,.cv.internal.rpc.admin.api.SearchRunsRequest\x1a'.cv.internal.rpc.admin.api.RunsResponse\x12c\n" +
	"\fDSMLaunchJob\x12..cv.internal.rpc.admin.api.DSMLaunchJobRequest\x1a#.cv.internal.rpc.admin.api.DSMJobID\x12S\n" +
	"\tDSMGetJob\x12#.cv.internal.rpc.admin.api.DSMJobID\x1a!.cv.internal.rpc.admin.api.DSMJob\x12J\n" +
	"\vDSMAbortJob\x12#.cv.internal.rpc.admin.api.DSMJobID\x1a\x16.google.protobuf.Empty\x12~\n" +
	"\x11RefreshProjectCLs\x123.cv.internal.rpc.admin.api.RefreshProjectCLsRequest\x1a4.cv.internal.rpc.admin.api.RefreshProjectCLsResponse\x12\x84\x01\n" +
	"\x13DeleteProjectEvents\x125.cv.internal.rpc.admin.api.DeleteProjectEventsRequest\x1a6.cv.internal.rpc.admin.api.DeleteProjectEventsResponse\x12^\n" +
	"\x10SendProjectEvent\x122.cv.internal.rpc.admin.api.SendProjectEventRequest\x1a\x16.google.protobuf.Empty\x12V\n" +
	"\fSendRunEvent\x12..cv.internal.rpc.admin.api.SendRunEventRequest\x1a\x16.google.protobuf.Empty\x12V\n" +
	"\fScheduleTask\x12..cv.internal.rpc.admin.api.ScheduleTaskRequest\x1a\x16.google.protobuf.Empty\x12\x91\x01\n" +
	"\x10GetQuotaAccounts\x12=.go.chromium.org.luci.server.quota.quotapb.GetAccountsRequest\x1a>.go.chromium.org.luci.server.quota.quotapb.GetAccountsResponse\x12\x88\x01\n" +
	"\rApplyQuotaOps\x12:.go.chromium.org.luci.server.quota.quotapb.ApplyOpsRequest\x1a;.go.chromium.org.luci.server.quota.quotapb.ApplyOpsResponseB8Z6go.chromium.org/luci/cv/internal/rpc/admin/api;adminpbb\x06proto3"
