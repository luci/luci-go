...
// Package treetest provides fake tree
package treetest
...
type Fake struct {
	...
	// mu protects reading/writing data in this fake Tree.
	mu sync.RWMutex
}

// NewFake returns a open fake Tree.
func NewFake(ctx context.Context) *Fake {
	return &Fake{
		TreeStatus: tree.Status{
			State: tree.Open,
...
// ModifyState changes the state of given tree.
...
// Install installs the fake Tree into context.
