...
var metricListingOldestAgeS = metric.NewCumulativeDistribution(
	"cv/internal/eventbox/listing/oldest",
	"Age of the oldest listed event.",
	&types.MetricMetadata{Units: types.Seconds},
	// Bucketer for 1s..1w range.
	//
	// $ python3 -c "print(((10**0.058)**100)/7/24/60/60)"
	// 1.0432495775135517
	distribution.GeometricBucketer(math.Pow(10, 0.058), 100),
	field.String("recipient"),
)

var metricListingSizes = metric.NewCumulativeDistribution(
	"cv/internal/eventbox/listing/sizes",
	"Number of incoming events listed before transacting on a recipient.",
	nil,
