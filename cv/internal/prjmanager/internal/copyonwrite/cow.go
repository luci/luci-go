...
// SortedSlice is a sorted COWSlice.
...
// * special DeleteMe, if this object should be deleted from COWSlice;
...
//
// If given COWSlice implements COWSortedSlice, assumes and preserves its sorted
// order.
//
