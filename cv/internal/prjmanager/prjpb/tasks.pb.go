...
// TriggeringCLsTask starts a task to trigger CLs.
//
// Queue: "trigger-project-cls"
type TriggeringCLsTask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// LUCI project of the CL
	LuciProject string `protobuf:"bytes,1,opt,name=luci_project,json=luciProject,proto3" json:"luci_project,omitempty"`
	// CLs to trigger.
	TriggeringCls []*TriggeringCL `protobuf:"bytes,2,rep,name=triggering_cls,json=triggeringCls,proto3" json:"triggering_cls,omitempty"`
}

func (x *TriggeringCLsTask) Reset() {
	*x = TriggeringCLsTask{}
	if protoimpl.UnsafeEnabled {
...
func (x *TriggeringCLsTask) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggeringCLsTask) ProtoMessage() {}

func (x *TriggeringCLsTask) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggeringCLsTask.ProtoReflect.Descriptor instead.
func (*TriggeringCLsTask) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDescGZIP(), []int{3}
}

func (x *TriggeringCLsTask) GetLuciProject() string {
	if x != nil {
		return x.LuciProject
	}
	return ""
...
func (x *TriggeringCLsTask) GetTriggeringCls() []*TriggeringCL {
	if x != nil {
...
func (*TriggeringCLDepsTask) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDescGZIP(), []int{4}
}
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDesc = []byte{
	...
	0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x89, 0x01, 0x0a, 0x11,
	0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x43, 0x4c, 0x73, 0x54, 0x61, 0x73,
	0x6b, 0x12, 0x21, 0x0a, 0x0c, 0x6c, 0x75, 0x63, 0x69, 0x5f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6c, 0x75, 0x63, 0x69, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x12, 0x51, 0x0a, 0x0e, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x69,
	0x6e, 0x67, 0x5f, 0x63, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x63,
	...
	0x72, 0x69, 0x6e, 0x67, 0x43, 0x6c, 0x73, 0x22, 0x97, 0x01, 0x0a, 0x14, 0x54, 0x72, 0x69, 0x67,
	0x67, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x43, 0x4c, 0x44, 0x65, 0x70, 0x73, 0x54, 0x61, 0x73, 0x6b,
	...
	0x65, 0x63, 0x74, 0x12, 0x5c, 0x0a, 0x12, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x69, 0x6e,
	0x67, 0x5f, 0x63, 0x6c, 0x5f, 0x64, 0x65, 0x70, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x2e, 0x2e, 0x63, 0x76, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x70, 0x72,
	0x6a, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6a, 0x70, 0x62, 0x2e, 0x54,
	0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x43, 0x4c, 0x44, 0x65, 0x70, 0x73, 0x52,
	0x10, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x43, 0x6c, 0x44, 0x65, 0x70,
	0x73, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d,
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_goTypes = []interface{}{
	...
	(*TriggeringCLsTask)(nil),     // 3: cv.internal.prjmanager.prjpb.TriggeringCLsTask
	(*TriggeringCLDepsTask)(nil),  // 4: cv.internal.prjmanager.prjpb.TriggeringCLDepsTask
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
	(*PurgingCL)(nil),             // 6: cv.internal.prjmanager.prjpb.PurgingCL
	(*PurgeReason)(nil),           // 7: cv.internal.prjmanager.prjpb.PurgeReason
	(*TriggeringCL)(nil),          // 8: cv.internal.prjmanager.prjpb.TriggeringCL
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_depIdxs = []int32{
	5, // 0: cv.internal.prjmanager.prjpb.ManageProjectTask.eta:type_name -> google.protobuf.Timestamp
	5, // 1: cv.internal.prjmanager.prjpb.KickManageProjectTask.eta:type_name -> google.protobuf.Timestamp
	6, // 2: cv.internal.prjmanager.prjpb.PurgeCLTask.purging_cl:type_name -> cv.internal.prjmanager.prjpb.PurgingCL
	7, // 3: cv.internal.prjmanager.prjpb.PurgeCLTask.purge_reasons:type_name -> cv.internal.prjmanager.prjpb.PurgeReason
	8, // 4: cv.internal.prjmanager.prjpb.TriggeringCLsTask.triggering_cls:type_name -> cv.internal.prjmanager.prjpb.TriggeringCL
	9, // 5: cv.internal.prjmanager.prjpb.TriggeringCLDepsTask.triggering_cl_deps:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLDeps
...
func file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggeringCLsTask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
