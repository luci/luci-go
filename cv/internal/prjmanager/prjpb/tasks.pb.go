...
const file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDesc = "" +
	"\n" +
	"=go.chromium.org/luci/cv/internal/prjmanager/prjpb/tasks.proto\x12\x1ccv.internal.prjmanager.prjpb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a?go.chromium.org/luci/cv/internal/prjmanager/prjpb/storage.proto\"d\n" +
	"\x11ManageProjectTask\x12!\n" +
	"\fluci_project\x18\x01 \x01(\tR\vluciProject\x12,\n" +
	"\x03eta\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x03eta\"h\n" +
	"\x15KickManageProjectTask\x12!\n" +
	"\fluci_project\x18\x01 \x01(\tR\vluciProject\x12,\n" +
	"\x03eta\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x03eta\"\xf9\x01\n" +
	"\vPurgeCLTask\x12!\n" +
	"\fluci_project\x18\x01 \x01(\tR\vluciProject\x12F\n" +
	"\n" +
	"purging_cl\x18\x02 \x01(\v2'.cv.internal.prjmanager.prjpb.PurgingCLR\tpurgingCl\x12N\n" +
	"\rpurge_reasons\x18\a \x03(\v2).cv.internal.prjmanager.prjpb.PurgeReasonR\fpurgeReasons\x12#\n" +
	"\rconfig_groups\x18\x06 \x03(\tR\fconfigGroupsJ\x04\b\x03\x10\x04J\x04\b\x05\x10\x06\"\x97\x01\n" +
	"\x14TriggeringCLDepsTask\x12!\n" +
	"\fluci_project\x18\x01 \x01(\tR\vluciProject\x12\\\n" +
	"\x12triggering_cl_deps\x18\x02 \x01(\v2..cv.internal.prjmanager.prjpb.TriggeringCLDepsR\x10triggeringClDepsB9Z7go.chromium.org/luci/cv/internal/prjmanager/prjpb;prjpbb\x06proto3"

var (
	file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDescOnce sync.Once
	file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDesc), len(file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDesc)))
	})
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_goTypes = []any{
...
func file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDesc), len(file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_tasks_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
