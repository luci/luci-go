...
// Validate checks the field values on TriggeringCL with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *TriggeringCL) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TriggeringCL with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in TriggeringCLMultiError, or
// nil if none found.
func (m *TriggeringCL) ValidateAll() error {
	return m.validate(true)
}

func (m *TriggeringCL) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TriggeringCLValidationError{
					field:  "Deadline",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return TriggeringCLValidationError{
				field:  "Deadline",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return TriggeringCLMultiError(errors)
	}

	return nil
}

// TriggeringCLMultiError is an error wrapping multiple validation errors
// returned by TriggeringCL.ValidateAll() if the designated constraints aren't met.
type TriggeringCLMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TriggeringCLMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TriggeringCLMultiError) AllErrors() []error { return m }

// TriggeringCLValidationError is the validation error returned by
// TriggeringCL.Validate if the designated constraints aren't met.
type TriggeringCLValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TriggeringCLValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TriggeringCLValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TriggeringCLValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TriggeringCLValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TriggeringCLValidationError) ErrorName() string { return "TriggeringCLValidationError" }

// Error satisfies the builtin error interface
func (e TriggeringCLValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = TriggeringCLValidationError{}
