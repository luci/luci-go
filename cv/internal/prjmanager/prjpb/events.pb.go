...
// Deprecated: Marked as deprecated in go.chromium.org/luci/cv/internal/prjmanager/prjpb/events.proto.
func (x *Event) GetTriggeringClsCompleted() *TriggeringCLsCompleted {
	if x, ok := x.GetEvent().(*Event_TriggeringClsCompleted); ok {
		return x.TriggeringClsCompleted
	}
	return nil
}
...
type Event_TriggeringClsCompleted struct {
	// Deprecated: Marked as deprecated in go.chromium.org/luci/cv/internal/prjmanager/prjpb/events.proto.
	TriggeringClsCompleted *TriggeringCLsCompleted `protobuf:"bytes,8,opt,name=triggering_cls_completed,json=triggeringClsCompleted,proto3,oneof"`
}
...
func (*Event_TriggeringClsCompleted) isEvent_Event() {}
...
// TriggeringCLsCompleted is sent to PM when a TriggeringCLsTask is completed.
type TriggeringCLsCompleted struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Succeeded []*TriggeringCLsCompleted_OpResult `protobuf:"bytes,1,rep,name=succeeded,proto3" json:"succeeded,omitempty"`
	Failed    []*TriggeringCLsCompleted_OpResult `protobuf:"bytes,2,rep,name=failed,proto3" json:"failed,omitempty"`
	Skipped   []*TriggeringCLsCompleted_OpResult `protobuf:"bytes,3,rep,name=skipped,proto3" json:"skipped,omitempty"`
}

func (x *TriggeringCLsCompleted) Reset() {
	*x = TriggeringCLsCompleted{}
	if protoimpl.UnsafeEnabled {
...
func (x *TriggeringCLsCompleted) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggeringCLsCompleted) ProtoMessage() {}

func (x *TriggeringCLsCompleted) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggeringCLsCompleted.ProtoReflect.Descriptor instead.
func (*TriggeringCLsCompleted) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_rawDescGZIP(), []int{6}
}

func (x *TriggeringCLsCompleted) GetSucceeded() []*TriggeringCLsCompleted_OpResult {
	if x != nil {
		return x.Succeeded
	}
	return nil
...
func (x *TriggeringCLsCompleted) GetFailed() []*TriggeringCLsCompleted_OpResult {
	if x != nil {
		return x.Failed
	}
	return nil
...
func (x *TriggeringCLsCompleted) GetSkipped() []*TriggeringCLsCompleted_OpResult {
	if x != nil {
		return x.Skipped
	}
	return nil
...
func (x *TriggeringCLDepsCompleted) Reset() {
	*x = TriggeringCLDepsCompleted{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TriggeringCLDepsCompleted) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_rawDescGZIP(), []int{7}
}
...
type TriggeringCLsCompleted_OpResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Operation ID
	OperationId string `protobuf:"bytes,1,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty"`
	// ID of the CL where the CQ trigger is originated.
	OriginClid int64 `protobuf:"varint,2,opt,name=origin_clid,json=originClid,proto3" json:"origin_clid,omitempty"`
	// Provide the reason of the Op failure, if the Op was failed.
	Reason *changelist.CLError_TriggerDeps `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`
}

func (x *TriggeringCLsCompleted_OpResult) Reset() {
	*x = TriggeringCLsCompleted_OpResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TriggeringCLsCompleted_OpResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggeringCLsCompleted_OpResult) ProtoMessage() {}

func (x *TriggeringCLsCompleted_OpResult) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggeringCLsCompleted_OpResult.ProtoReflect.Descriptor instead.
func (*TriggeringCLsCompleted_OpResult) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_rawDescGZIP(), []int{6, 0}
}

func (x *TriggeringCLsCompleted_OpResult) GetOperationId() string {
	if x != nil {
		return x.OperationId
	}
	return ""
...
func (x *TriggeringCLsCompleted_OpResult) GetOriginClid() int64 {
	if x != nil {
		return x.OriginClid
	}
	return 0
...
func (x *TriggeringCLsCompleted_OpResult) GetReason() *changelist.CLError_TriggerDeps {
	if x != nil {
		return x.Reason
	}
	return nil
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x05,
	...
	,
	...
	0x47, 0x0a, 0x0e, 0x50, 0x75, 0x72, 0x67, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65,
	...
	,
	...
	0x12, 0x1f, 0x0a, 0x0b, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x5f, 0x63, 0x6c, 0x69, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x43, 0x6c, 0x69,
	0x64, 0x12, 0x43, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x6f, 0x72, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x44, 0x65, 0x70, 0x73, 0x52, 0x06,
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xdb, 0x01, 0x0a, 0x19, 0x54, 0x72, 0x69, 0x67, 0x67,
	0x65, 0x72, 0x69, 0x6e, 0x67, 0x43, 0x4c, 0x44, 0x65, 0x70, 0x73, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	...
	,
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_goTypes = []interface{}{
	...
	(*TriggeringCLsCompleted)(nil),          // 6: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted
	(*TriggeringCLDepsCompleted)(nil),       // 7: cv.internal.prjmanager.prjpb.TriggeringCLDepsCompleted
	(*TriggeringCLsCompleted_OpResult)(nil), // 8: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	(*changelist.CLUpdatedEvents)(nil),      // 9: cv.internal.changelist.CLUpdatedEvents
	(run.Status)(0),                         // 10: cv.internal.run.Status
	(*changelist.CLError_TriggerDeps)(nil),  // 11: cv.internal.changelist.CLError.TriggerDeps
}
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_depIdxs = []int32{
	...
	9,  // 2: cv.internal.prjmanager.prjpb.Event.cls_updated:type_name -> cv.internal.changelist.CLUpdatedEvents
	...
	6,  // 6: cv.internal.prjmanager.prjpb.Event.triggering_cls_completed:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLsCompleted
	7,  // 7: cv.internal.prjmanager.prjpb.Event.triggering_cl_deps_completed:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLDepsCompleted
	10, // 8: cv.internal.prjmanager.prjpb.RunFinished.status:type_name -> cv.internal.run.Status
	8,  // 9: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.succeeded:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	8,  // 10: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.failed:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	8,  // 11: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.skipped:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	11, // 12: cv.internal.prjmanager.prjpb.TriggeringCLDepsCompleted.failed:type_name -> cv.internal.changelist.CLError.TriggerDeps
	11, // 13: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult.reason:type_name -> cv.internal.changelist.CLError.TriggerDeps
...
func file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggeringCLsCompleted); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggeringCLsCompleted_OpResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Event_TriggeringClsCompleted)(nil),
