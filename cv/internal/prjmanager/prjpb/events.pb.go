...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x04,
	...
	0x75, 0x72, 0x67, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x70, 0x0a,
	...
	0x6c, 0x65, 0x74, 0x65, 0x64, 0x48, 0x00, 0x52, 0x16, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	0x69, 0x6e, 0x67, 0x43, 0x6c, 0x73, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x42,
	...
	0x6f, 0x6e, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75,
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_goTypes = []interface{}{
	...
	(*TriggeringCLsCompleted_OpResult)(nil), // 7: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	(*changelist.CLUpdatedEvents)(nil),      // 8: cv.internal.changelist.CLUpdatedEvents
	(run.Status)(0),                         // 9: cv.internal.run.Status
	(*changelist.CLError_TriggerDeps)(nil),  // 10: cv.internal.changelist.CLError.TriggerDeps
}
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_events_proto_depIdxs = []int32{
	...
	8,  // 2: cv.internal.prjmanager.prjpb.Event.cls_updated:type_name -> cv.internal.changelist.CLUpdatedEvents
	...
	9,  // 7: cv.internal.prjmanager.prjpb.RunFinished.status:type_name -> cv.internal.run.Status
	7,  // 8: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.succeeded:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	7,  // 9: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.failed:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	7,  // 10: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.skipped:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult
	10, // 11: cv.internal.prjmanager.prjpb.TriggeringCLsCompleted.OpResult.reason:type_name -> cv.internal.changelist.CLError.TriggerDeps
