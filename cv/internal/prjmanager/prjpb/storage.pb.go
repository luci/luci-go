...
const file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_rawDesc = "" +
	"\n" +
	"?go.chromium.org/luci/cv/internal/prjmanager/prjpb/storage.proto\x12\x1ccv.internal.prjmanager.prjpb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a9go.chromium.org/luci/cv/internal/changelist/storage.proto\x1a5go.chromium.org/luci/cv/internal/gerrit/storage.proto\x1a2go.chromium.org/luci/cv/internal/run/storage.proto\"\x9e\x05\n" +
	"\x06PState\x12!\n" +
	"\fluci_project\x18\x01 \x01(\tR\vluciProject\x12<\n" +
	"\x06status\x18\x02 \x01(\x0e2$.cv.internal.prjmanager.prjpb.StatusR\x06status\x12\x1f\n" +
	"\vconfig_hash\x18\x03 \x01(\tR\n" +
	"configHash\x12,\n" +
	"\x12config_group_names\x18\x04 \x03(\tR\x10configGroupNames\x125\n" +
	"\x04pcls\x18\v \x03(\v2!.cv.internal.prjmanager.prjpb.PCLR\x04pcls\x12G\n" +
	"\n" +
	"components\x18\f \x03(\v2'.cv.internal.prjmanager.prjpb.ComponentR\n" +
	"components\x12H\n" +
	"\vpurging_cls\x18\r \x03(\v2'.cv.internal.prjmanager.prjpb.PurgingCLR\n" +
	"purgingCls\x12\\\n" +
	"\x12triggering_cl_deps\x18\x0f \x03(\v2..cv.internal.prjmanager.prjpb.TriggeringCLDepsR\x10triggeringClDeps\x121\n" +
	"\x14repartition_required\x18\x15 \x01(\bR\x13repartitionRequired\x12G\n" +
	"\rcreated_pruns\x18\x16 \x03(\v2\".cv.internal.prjmanager.prjpb.PRunR\fcreatedPruns\x12@\n" +
	"\x0enext_eval_time\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampR\fnextEvalTime\"O\n" +
	"\n" +
	"LogReasons\x12A\n" +
	"\areasons\x18\x01 \x03(\x0e2'.cv.internal.prjmanager.prjpb.LogReasonR\areasons\"\x8c\x05\n" +
	"\x03PCL\x12\x12\n" +
	"\x04clid\x18\x01 \x01(\x03R\x04clid\x12\x1a\n" +
	"\beversion\x18\x02 \x01(\x03R\beversion\x12@\n" +
	"\x06status\x18\x03 \x01(\x0e2(.cv.internal.prjmanager.prjpb.PCL.StatusR\x06status\x120\n" +
	"\x14config_group_indexes\x18\x04 \x03(\x05R\x12configGroupIndexes\x12/\n" +
	"\x04deps\x18\v \x03(\v2\x1b.cv.internal.changelist.DepR\x04deps\x125\n" +
	"\btriggers\x18\x10 \x01(\v2\x19.cv.internal.run.TriggersR\btriggers\x12\x1c\n" +
	"\tsubmitted\x18\r \x01(\bR\tsubmitted\x12 \n" +
	"\vsubmittable\x18\x13 \x01(\bR\vsubmittable\x12;\n" +
	"\x06errors\x18\x0f \x03(\v2\x1f.cv.internal.changelist.CLErrorB\x02\x18\x01R\x06errors\x12N\n" +
	"\rpurge_reasons\x18\x11 \x03(\v2).cv.internal.prjmanager.prjpb.PurgeReasonR\fpurgeReasons\x12E\n" +
	"\boutdated\x18\x12 \x01(\v2).cv.internal.changelist.Snapshot.OutdatedR\boutdated\"Y\n" +
	"\x06Status\x12\x1a\n" +
	"\x16PCL_STATUS_UNSPECIFIED\x10\x00\x12\x06\n" +
	"\x02OK\x10\x00\x12\v\n" +
	"\aUNKNOWN\x10\x01\x12\r\n" +
	"\tUNWATCHED\x10\x02\x12\v\n" +
	"\aDELETED\x10\x03\x1a\x02\x10\x01J\x04\b\f\x10\rJ\x04\b\x0e\x10\x0f\"]\n" +
	"\x04PRun\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05clids\x18\x02 \x03(\x03R\x05clids\x12\x12\n" +
	"\x04mode\x18\x03 \x01(\tR\x04mode\x12\x1b\n" +
	"\troot_clid\x18\x04 \x01(\x03R\brootClid\"\xc5\x01\n" +
	"\tComponent\x12\x14\n" +
	"\x05clids\x18\x01 \x03(\x03R\x05clids\x12?\n" +
	"\rdecision_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\fdecisionTime\x128\n" +
	"\x05pruns\x18\x03 \x03(\v2\".cv.internal.prjmanager.prjpb.PRunR\x05pruns\x12'\n" +
	"\x0ftriage_required\x18\v \x01(\bR\x0etriageRequired\"\xc5\x03\n" +
	"\tPurgingCL\x12\x12\n" +
	...
	"\btriggers\x18\x04 \x01(\v2\x19.cv.internal.run.TriggersH\x00R\btriggers\x120\n" +
	"\x13all_active_triggers\x18\x05 \x01(\bH\x00R\x11allActiveTriggers\x12X\n" +
	"\fnotification\x18\x06 \x01(\v24.cv.internal.prjmanager.prjpb.PurgingCL.NotificationR\fnotification\x1ax\n" +
	"\fNotification\x120\n" +
	"\x06notify\x18\x01 \x03(\x0e2\x18.cv.internal.gerrit.WhomR\x06notify\x126\n" +
	"\tattention\x18\x02 \x03(\x0e2\x18.cv.internal.gerrit.WhomR\tattentionB\n" +
	"\n" +
	"\bapply_to\"\x8b\x02\n" +
	"\x10TriggeringCLDeps\x12\x1f\n" +
	"\vorigin_clid\x18\x01 \x01(\x03R\n" +
	"originClid\x12\x1b\n" +
	"\tdep_clids\x18\x02 \x03(\x03R\bdepClids\x12!\n" +
	"\foperation_id\x18\x03 \x01(\tR\voperationId\x126\n" +
	"\bdeadline\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\bdeadline\x122\n" +
	"\atrigger\x18\x05 \x01(\v2\x18.cv.internal.run.TriggerR\atrigger\x12*\n" +
	"\x11config_group_name\x18\x06 \x01(\tR\x0fconfigGroupName\"\xc0\x01\n" +
	"\vPurgeReason\x12:\n" +
	"\bcl_error\x18\x01 \x01(\v2\x1f.cv.internal.changelist.CLErrorR\aclError\x127\n" +
	"\btriggers\x18\x02 \x01(\v2\x19.cv.internal.run.TriggersH\x00R\btriggers\x120\n" +
	"\x13all_active_triggers\x18\x03 \x01(\bH\x00R\x11allActiveTriggersB\n" +
	"\n" +
	"\bapply_to*H\n" +
	"\x06Status\x12\x16\n" +
	...
	"\aSTOPPED\x10\x03*l\n" +
	"\tLogReason\x12\x1a\n" +
	"\x16LOG_REASON_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fFYI_PERIODIC\x10\x01\x12\x12\n" +
	"\x0eSTATUS_CHANGED\x10\x02\x12\x12\n" +
	"\x0eCONFIG_CHANGED\x10\x03\x12\t\n" +
	"\x05DEBUG\x10\x04B9Z7go.chromium.org/luci/cv/internal/prjmanager/prjpb;prjpbb\x06proto3"
