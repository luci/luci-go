...
type PState struct {
	...
	// TriggeringCLs are CLs currently being triggered.
	//
	// They are tracked in PState to avoid creating duplicate triggering tasks.
	// A TriggeringCL is kept in PState until the triggering process stops.
	//
	// Sorted by CL ID.
	//
	// Deprecated: Marked as deprecated in go.chromium.org/luci/cv/internal/prjmanager/prjpb/storage.proto.
	TriggeringCls []*TriggeringCL `protobuf:"bytes,14,rep,name=triggering_cls,json=triggeringCls,proto3" json:"triggering_cls,omitempty"`
...
// Deprecated: Marked as deprecated in go.chromium.org/luci/cv/internal/prjmanager/prjpb/storage.proto.
func (x *PState) GetTriggeringCls() []*TriggeringCL {
	if x != nil {
		return x.TriggeringCls
	}
	return nil
}
...
func (x *PurgingCL) GetTriggers() *run.Triggers {
	if x, ok := x.GetApplyTo().(*PurgingCL_Triggers); ok {
		return x.Triggers
	}
	return nil
}
...
func (x *PurgingCL) GetAllActiveTriggers() bool {
	if x, ok := x.GetApplyTo().(*PurgingCL_AllActiveTriggers); ok {
...
// TriggeringCL represents CQ trigger of a CL.
//
// The triggering process is initiated to the deps of a given CL, if
// - the given CL received a CQ vote,
// - the dependencies do not have the CQ vote yet.
//
// These tasks are tracked in PM state to deduplicate TQ tasks for
// the same dep.
type TriggeringCL struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ID of the CL to trigger.
	Clid int64 `protobuf:"varint,1,opt,name=clid,proto3" json:"clid,omitempty"`
	// ID of the CL where this CQ trigger is originated.
	//
	// If this task is to trigger a dep CL from a child CQ vote, then
	// this field tells the ID of the child CL.
	OriginClid int64 `protobuf:"varint,2,opt,name=origin_clid,json=originClid,proto3" json:"origin_clid,omitempty"`
	// Operation ID uniquely identifies the TriggeringCL operation within
	// the project.
	OperationId string `protobuf:"bytes,3,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty"`
	// Deadline is obeyed by the TQ task handler.
	//
	// TQ task SHOULD NOT modify a CL (e.g., via Gerrit RPCs) beyond this point.
	// If PM doesn't receive TriggerCompleted event before this deadline + grace
	// period, PM will consider the task expired and the task will be removed from
	// PState, so that the deps will be re-triaged and PM may schedule another
	// TQ task for the triggering operation for the CL.
	Deadline *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=deadline,proto3" json:"deadline,omitempty"`
	// trigger is the trigger information of the original CL.
	Trigger *run.Trigger `protobuf:"bytes,5,opt,name=trigger,proto3" json:"trigger,omitempty"`
}

func (x *TriggeringCL) Reset() {
	*x = TriggeringCL{}
	if protoimpl.UnsafeEnabled {
...
func (x *TriggeringCL) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggeringCL) ProtoMessage() {}

func (x *TriggeringCL) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggeringCL.ProtoReflect.Descriptor instead.
func (*TriggeringCL) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_rawDescGZIP(), []int{6}
}

func (x *TriggeringCL) GetClid() int64 {
	if x != nil {
		return x.Clid
	}
	return 0
...
func (x *TriggeringCL) GetOriginClid() int64 {
	if x != nil {
		return x.OriginClid
	}
	return 0
...
func (x *TriggeringCL) GetOperationId() string {
	if x != nil {
		return x.OperationId
	}
	return ""
...
func (x *TriggeringCL) GetDeadline() *timestamppb.Timestamp {
	if x != nil {
		return x.Deadline
	}
	return nil
...
func (x *TriggeringCL) GetTrigger() *run.Trigger {
	if x != nil {
		return x.Trigger
	}
	return nil
...
func (*PurgeReason) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_rawDescGZIP(), []int{8}
}
...
func (x *PurgeReason) GetTriggers() *run.Triggers {
	if x, ok := x.GetApplyTo().(*PurgeReason_Triggers); ok {
		return x.Triggers
	}
	return nil
}
...
func (x *PurgeReason) GetAllActiveTriggers() bool {
	if x, ok := x.GetApplyTo().(*PurgeReason_AllActiveTriggers); ok {
		return x.AllActiveTriggers
	}
	return false
}
...
func (x *PurgingCL_Notification) Reset() {
	*x = PurgingCL_Notification{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf5, 0x05, 0x0a, 0x06, 0x50, 0x53, 0x74, 0x61, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6e, 0x65, 0x12, 0x37, 0x0a, 0x08, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x76, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x73,
	0x48, 0x00, 0x52, 0x08, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x73, 0x12, 0x30, 0x0a, 0x13,
	0x61, 0x6c, 0x6c, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x74, 0x72, 0x69, 0x67, 0x67,
	0x65, 0x72, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x11, 0x61, 0x6c, 0x6c,
	0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x73, 0x12, 0x58,
	...
	,
	...
	,
	...
	0x65, 0x12, 0x32, 0x0a, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01,
	...
	,
	...
	,
...
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_goTypes = []interface{}{
	...
	(*TriggeringCL)(nil),                 // 9: cv.internal.prjmanager.prjpb.TriggeringCL
	(*TriggeringCLDeps)(nil),             // 10: cv.internal.prjmanager.prjpb.TriggeringCLDeps
	(*PurgeReason)(nil),                  // 11: cv.internal.prjmanager.prjpb.PurgeReason
	(*PurgingCL_Notification)(nil),       // 12: cv.internal.prjmanager.prjpb.PurgingCL.Notification
	(*timestamppb.Timestamp)(nil),        // 13: google.protobuf.Timestamp
	(*changelist.Dep)(nil),               // 14: cv.internal.changelist.Dep
	(*run.Triggers)(nil),                 // 15: cv.internal.run.Triggers
	(*changelist.CLError)(nil),           // 16: cv.internal.changelist.CLError
	(*changelist.Snapshot_Outdated)(nil), // 17: cv.internal.changelist.Snapshot.Outdated
	(*run.Trigger)(nil),                  // 18: cv.internal.run.Trigger
	(gerrit.Whom)(0),                     // 19: cv.internal.gerrit.Whom
}
var file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_depIdxs = []int32{
	...
	9,  // 4: cv.internal.prjmanager.prjpb.PState.triggering_cls:type_name -> cv.internal.prjmanager.prjpb.TriggeringCL
	10, // 5: cv.internal.prjmanager.prjpb.PState.triggering_cl_deps:type_name -> cv.internal.prjmanager.prjpb.TriggeringCLDeps
	6,  // 6: cv.internal.prjmanager.prjpb.PState.created_pruns:type_name -> cv.internal.prjmanager.prjpb.PRun
	13, // 7: cv.internal.prjmanager.prjpb.PState.next_eval_time:type_name -> google.protobuf.Timestamp
	1,  // 8: cv.internal.prjmanager.prjpb.LogReasons.reasons:type_name -> cv.internal.prjmanager.prjpb.LogReason
	2,  // 9: cv.internal.prjmanager.prjpb.PCL.status:type_name -> cv.internal.prjmanager.prjpb.PCL.Status
	14, // 10: cv.internal.prjmanager.prjpb.PCL.deps:type_name -> cv.internal.changelist.Dep
	15, // 11: cv.internal.prjmanager.prjpb.PCL.triggers:type_name -> cv.internal.run.Triggers
	16, // 12: cv.internal.prjmanager.prjpb.PCL.errors:type_name -> cv.internal.changelist.CLError
	11, // 13: cv.internal.prjmanager.prjpb.PCL.purge_reasons:type_name -> cv.internal.prjmanager.prjpb.PurgeReason
	17, // 14: cv.internal.prjmanager.prjpb.PCL.outdated:type_name -> cv.internal.changelist.Snapshot.Outdated
	13, // 15: cv.internal.prjmanager.prjpb.Component.decision_time:type_name -> google.protobuf.Timestamp
	6,  // 16: cv.internal.prjmanager.prjpb.Component.pruns:type_name -> cv.internal.prjmanager.prjpb.PRun
	13, // 17: cv.internal.prjmanager.prjpb.PurgingCL.deadline:type_name -> google.protobuf.Timestamp
	15, // 18: cv.internal.prjmanager.prjpb.PurgingCL.triggers:type_name -> cv.internal.run.Triggers
	12, // 19: cv.internal.prjmanager.prjpb.PurgingCL.notification:type_name -> cv.internal.prjmanager.prjpb.PurgingCL.Notification
	13, // 20: cv.internal.prjmanager.prjpb.TriggeringCL.deadline:type_name -> google.protobuf.Timestamp
	18, // 21: cv.internal.prjmanager.prjpb.TriggeringCL.trigger:type_name -> cv.internal.run.Trigger
	13, // 22: cv.internal.prjmanager.prjpb.TriggeringCLDeps.deadline:type_name -> google.protobuf.Timestamp
	18, // 23: cv.internal.prjmanager.prjpb.TriggeringCLDeps.trigger:type_name -> cv.internal.run.Trigger
	16, // 24: cv.internal.prjmanager.prjpb.PurgeReason.cl_error:type_name -> cv.internal.changelist.CLError
	15, // 25: cv.internal.prjmanager.prjpb.PurgeReason.triggers:type_name -> cv.internal.run.Triggers
	19, // 26: cv.internal.prjmanager.prjpb.PurgingCL.Notification.notify:type_name -> cv.internal.gerrit.Whom
	19, // 27: cv.internal.prjmanager.prjpb.PurgingCL.Notification.attention:type_name -> cv.internal.gerrit.Whom
...
func file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggeringCL); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggeringCLDeps); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PurgeReason); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PurgingCL_Notification); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*PurgingCL_Triggers)(nil),
		(*PurgingCL_AllActiveTriggers)(nil),
	}
	file_go_chromium_org_luci_cv_internal_prjmanager_prjpb_storage_proto_msgTypes[8].OneofWrappers = []interface{}{
