		...
		Convey("OnRunsFinished", func() {
					...
					Components: []*prjpb.Component{
						{
							Clids: []int64{101},
							Pruns: nil,  // removed
							ReevalRequired: true, // marked dirty
						},
			...
			Convey("stops PM iff all runs finished", func() {
				...
				So(s2.PB, ShouldResembleProto, &prjpb.PState{
					...
					Pcls:             s1.PB.GetPcls(),
					Components: []*prjpb.Component{
						{Clids: []int64{101}, ReevalRequired: true},
						s1.PB.GetComponents()[1], // unchanged.
					},
					CreatedPruns:    nil, // removed
					RepartitionRequired: true,
		...
		Convey("With existing", func() {
			...
			s1 := &State{PB: &prjpb.PState{
				...
				Components: []*prjpb.Component{
					...
					{Clids: []int64{1}},
					{Clids: []int64{2}, ReevalRequired: true},
					{Clids: []int64{3}},
				},
			}}
			pb := backupPB(s1)
			...
			Convey("Expires and removed", func() {
				...
				pb.Components = []*prjpb.Component{
					pb.Components[0],
					{Clids: []int64{1}, ReevalRequired: true},
					pb.Components[2],
					{Clids: []int64{3}, ReevalRequired: true},
				}
				So(s2.PB, ShouldResembleProto, pb)
			})
	...
	Convey("repartition works", t, func() {
		...
		Convey("Components splitting works", func() {
			Convey("Crossing-over 12, 34 => 13, 24", func() {
				...
				So(state.PB, ShouldResembleProto, &prjpb.PState{
					Pcls: orig.Pcls,
					Components: []*prjpb.Component{
						{Clids: []int64{1, 3}, ReevalRequired: true},
						{Clids: []int64{2, 4}, ReevalRequired: true},
					},
				})
			})
		...
		Convey("Does all at once", func() {
			...
			So(state.PB, ShouldResembleProto, &prjpb.PState{
				...
				Components: []*prjpb.Component{
					{Clids: []int64{1, 2}, ReevalRequired: true, Pruns: []*prjpb.PRun{{Clids: []int64{1}, Id: "1"}}},
					{Clids: []int64{4, 5}, ReevalRequired: true, Pruns: []*prjpb.PRun{
						{Clids: []int64{4}, Id: "4"},
						{Clids: []int64{4, 5}, Id: "45"},
						{Clids: []int64{5}, Id: "5"},
					}},
					{Clids: []int64{6}, ReevalRequired: true, Pruns: []*prjpb.PRun{{Clids: []int64{6}, Id: "6"}}},
				},
			})
		})
	})
