...
// RunStarted tells ProjectManager that a run has been created.
func RunStarted(ctx context.Context, runID common.RunID) error {
...
// runStartedInternal is same as RunStarted but sent by ProjectManager to itself
// within a Run creation transaction.
//
// Unlike RunStarted, this only creates an event and doesn't create a task.
...
func runStartedInternal(ctx context.Context, runID common.RunID) error {
