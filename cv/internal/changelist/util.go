...
// IsOnlyProject returns true iff ApplicableConfig contains only the given
// project, regardless of the number of applicable config groups it may contain.
func (a *ApplicableConfig) IsOnlyProject(luciProject string) bool {
	switch {
	case a == nil:
		return false
...
// ContainsProject returns true whether ApplicableConfig contains the given
// project, possibly among other projects.
func (a *ApplicableConfig) ContainsProject(luciProject string) bool {
