...
func (x *CLError) GetOwnerEmailMalformed() bool {
	if x != nil {
		if x, ok := x.Kind.(*CLError_OwnerEmailMalformed); ok {
			return x.OwnerEmailMalformed
		}
	}
	return false
}
...
type CLError_OwnerEmailMalformed struct {
	OwnerEmailMalformed bool `protobuf:"varint,12,opt,name=owner_email_malformed,json=ownerEmailMalformed,proto3,oneof"`
}
...
func (*CLError_OwnerEmailMalformed) isCLError_Kind() {}
...
const file_go_chromium_org_luci_cv_internal_changelist_storage_proto_rawDesc = "" +
	"\n" +
	"9go.chromium.org/luci/cv/internal/changelist/storage.proto\x12\x16cv.internal.changelist\x1a\x1fgoogle/protobuf/timestamp.proto\x1a5go.chromium.org/luci/common/proto/gerrit/gerrit.proto\"\x8e\x04\n" +
	"\bSnapshot\x12L\n" +
	"\x14external_update_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x12externalUpdateTime\x12!\n" +
	"\fluci_project\x18\x02 \x01(\tR\vluciProject\x12/\n" +
	"\x04deps\x18\x03 \x03(\v2\x1b.cv.internal.changelist.DepR\x04deps\x12\x1a\n" +
	"\bpatchset\x18\x04 \x01(\x05R\bpatchset\x126\n" +
	"\x17min_equivalent_patchset\x18\x05 \x01(\x05R\x15minEquivalentPatchset\x127\n" +
	"\x06errors\x18\x06 \x03(\v2\x1f.cv.internal.changelist.CLErrorR\x06errors\x12E\n" +
	"\boutdated\x18\a \x01(\v2).cv.internal.changelist.Snapshot.OutdatedR\boutdated\x12>\n" +
	"\bmetadata\x18\b \x03(\v2\".cv.internal.changelist.StringPairR\bmetadata\x128\n" +
	"\x06gerrit\x18\v \x01(\v2\x1e.cv.internal.changelist.GerritH\x00R\x06gerrit\x1a\n" +
	"\n" +
	"\bOutdatedB\x06\n" +
	"\x04kind\"N\n" +
	"\x03Dep\x12\x12\n" +
	"\x04clid\x18\x01 \x01(\x03R\x04clid\x123\n" +
	"\x04kind\x18\x02 \x01(\x0e2\x1f.cv.internal.changelist.DepKindR\x04kind\"\xdf\x01\n" +
	"\x06Gerrit\x12\x12\n" +
	"\x04host\x18\x05 \x01(\tR\x04host\x12&\n" +
	"\x04info\x18\x01 \x01(\v2\x12.gerrit.ChangeInfoR\x04info\x12\x14\n" +
	"\x05files\x18\x02 \x03(\tR\x05files\x12?\n" +
	"\bgit_deps\x18\x03 \x03(\v2$.cv.internal.changelist.GerritGitDepR\agitDeps\x12B\n" +
	"\tsoft_deps\x18\x04 \x03(\v2%.cv.internal.changelist.GerritSoftDepR\bsoftDeps\"D\n" +
	"\fGerritGitDep\x12\x16\n" +
	"\x06change\x18\x01 \x01(\x03R\x06change\x12\x1c\n" +
	"\timmediate\x18\x02 \x01(\bR\timmediate\";\n" +
	"\rGerritSoftDep\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x16\n" +
	"\x06change\x18\x02 \x01(\x03R\x06change\"\xa9\x01\n" +
	"\x10ApplicableConfig\x12L\n" +
	"\bprojects\x18\x02 \x03(\v20.cv.internal.changelist.ApplicableConfig.ProjectR\bprojects\x1aG\n" +
	"\aProject\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12(\n" +
	"\x10config_group_ids\x18\x02 \x03(\tR\x0econfigGroupIds\"\xe4\x02\n" +
	"\x06Access\x12L\n" +
	"\n" +
	"by_project\x18\x01 \x03(\v2-.cv.internal.changelist.Access.ByProjectEntryR\tbyProject\x1a\xa5\x01\n" +
	"\aProject\x12\x1b\n" +
	"\tno_access\x18\x01 \x01(\bR\bnoAccess\x12;\n" +
	"\vupdate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12@\n" +
	"\x0eno_access_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\fnoAccessTime\x1ad\n" +
	"\x0eByProjectEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12<\n" +
	"\x05value\x18\x02 \x01(\v2&.cv.internal.changelist.Access.ProjectR\x05value:\x028\x01\"\x86\x0e\n" +
	"\aCLError\x12,\n" +
	"\x11owner_lacks_email\x18\x01 \x01(\bH\x00R\x0fownerLacksEmail\x12}\n" +
	"\x1dwatched_by_many_config_groups\x18\x02 \x01(\v29.cv.internal.changelist.CLError.WatchedByManyConfigGroupsH\x00R\x19watchedByManyConfigGroups\x12p\n" +
	"\x18watched_by_many_projects\x18\b \x01(\v25.cv.internal.changelist.CLError.WatchedByManyProjectsH\x00R\x15watchedByManyProjects\x12P\n" +
	"\finvalid_deps\x18\x03 \x01(\v2+.cv.internal.changelist.CLError.InvalidDepsH\x00R\vinvalidDeps\x12+\n" +
	"\x10unsupported_mode\x18\x04 \x01(\tH\x00R\x0funsupportedMode\x12&\n" +
	"\x0eself_cq_depend\x18\x05 \x01(\bH\x00R\fselfCqDepend\x128\n" +
	"\x17corrupt_gerrit_metadata\x18\x06 \x01(\tH\x00R\x15corruptGerritMetadata\x12V\n" +
	"\x0ereused_trigger\x18\a \x01(\v2-.cv.internal.changelist.CLError.ReusedTriggerH\x00R\rreusedTrigger\x12'\n" +
	"\x0ecommit_blocked\x18\t \x01(\bH\x00R\rcommitBlocked\x12P\n" +
	"\ftrigger_deps\x18\n" +
	" \x01(\v2+.cv.internal.changelist.CLError.TriggerDepsH\x00R\vtriggerDeps\x12&\n" +
	"\x0edep_run_failed\x18\v \x01(\x03H\x00R\fdepRunFailed\x124\n" +
	"\x15owner_email_malformed\x18\f \x01(\bH\x00R\x13ownerEmailMalformed\x1a@\n" +
	"\x19WatchedByManyConfigGroups\x12#\n" +
	"\rconfig_groups\x18\x01 \x03(\tR\fconfigGroups\x1a3\n" +
	"\x15WatchedByManyProjects\x12\x1a\n" +
	"\bprojects\x18\x01 \x03(\tR\bprojects\x1a\x9d\x04\n" +
	"\vInvalidDeps\x129\n" +
	"\tunwatched\x18\x01 \x03(\v2\x1b.cv.internal.changelist.DepR\tunwatched\x12I\n" +
	"\x12wrong_config_group\x18\x02 \x03(\v2\x1b.cv.internal.changelist.DepR\x10wrongConfigGroup\x12E\n" +
	"\x10single_full_deps\x18\x03 \x03(\v2\x1b.cv.internal.changelist.DepR\x0esingleFullDeps\x12R\n" +
	"\x16combinable_untriggered\x18\x04 \x03(\v2\x1b.cv.internal.changelist.DepR\x15combinableUntriggered\x12Y\n" +
	"\x1acombinable_mismatched_mode\x18\x05 \x03(\v2\x1b.cv.internal.changelist.DepR\x18combinableMismatchedMode\x12N\n" +
	"\btoo_many\x18\x06 \x01(\v23.cv.internal.changelist.CLError.InvalidDeps.TooManyR\atooMany\x1aB\n" +
	"\aTooMany\x12\x16\n" +
	"\x06actual\x18\x01 \x01(\x05R\x06actual\x12\x1f\n" +
	"\vmax_allowed\x18\x02 \x01(\x05R\n" +
	"maxAllowed\x1a!\n" +
	"\rReusedTrigger\x12\x10\n" +
	"\x03run\x18\x01 \x01(\tR\x03run\x1a\x87\x02\n" +
	"\vTriggerDeps\x12i\n" +
	"\x11permission_denied\x18\x01 \x03(\v2<.cv.internal.changelist.CLError.TriggerDeps.PermissionDeniedR\x10permissionDenied\x12\x1b\n" +
	"\tnot_found\x18\x02 \x03(\x03R\bnotFound\x122\n" +
	"\x15internal_gerrit_error\x18\x03 \x03(\x03R\x13internalGerritError\x1a<\n" +
	"\x10PermissionDenied\x12\x12\n" +
	"\x04clid\x18\x01 \x01(\x03R\x04clid\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05emailB\x06\n" +
	"\x04kind\"@\n" +
	"\x0eCLUpdatedEvent\x12\x12\n" +
	"\x04clid\x18\x01 \x01(\x03R\x04clid\x12\x1a\n" +
	"\beversion\x18\x02 \x01(\x03R\beversion\"Q\n" +
	"\x0fCLUpdatedEvents\x12>\n" +
	"\x06events\x18\x01 \x03(\v2&.cv.internal.changelist.CLUpdatedEventR\x06events\"4\n" +
	"\n" +
	"StringPair\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value*7\n" +
	"\aDepKind\x12\x18\n" +
	"\x14DEP_KIND_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04HARD\x10\x01\x12\b\n" +
	"\x04SOFT\x10\x02B-Z+go.chromium.org/luci/cv/internal/changelistb\x06proto3"
...
func file_go_chromium_org_luci_cv_internal_changelist_storage_proto_init() {
	...
	file_go_chromium_org_luci_cv_internal_changelist_storage_proto_msgTypes[7].OneofWrappers = []any{
		...
		(*CLError_OwnerEmailMalformed)(nil),
	}
	type x struct{}
