...
//  * misconfiguration, whereby two projects or 2 different configs within the
//    same project watch the same CL.
...
type ApplicableConfig_Project struct {
	...
	// ID of the specific ConfigGroup version.
	//
	// The referenced version may no longer be available to datastore,
	// commonly happening if CL didn't was active for a long time.
