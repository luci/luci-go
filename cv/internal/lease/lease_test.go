...
func TestLease(t *testing.T) {
	...
	Convey("Validate", t, func() {
		var l *Lease
		Convey("Errors when lease is nil", func() {
			So(l.validate(), ShouldErrLike, "lease is nil")
		})
		Convey("Errors when AssetID is invalid", func() {
			l = &Lease{AssetID: "bad_asset_id", Leasee: "leasee"}
			So(l.validate(), ShouldErrLike, `invalid AssetID: "bad_asset_id"`)
		})
		Convey("empty leasee", func() {
			l = &Lease{AssetID: "foo/1"}
			So(l.validate(), ShouldErrLike, "empty leasee")
		})
	})
