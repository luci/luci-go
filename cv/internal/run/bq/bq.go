...
func SendRun(ctx context.Context, id common.RunID) error {
	...
	// name. TODO(crbug.com/1173168): Change the destination table name after
...
// mergeAttempts merges the CV Attempt and CQDaemon Attempt.
//
...
func mergeAttempts(a, cqda *cvbqpb.Attempt) *cvbqpb.Attempt {
