...
// AssertNotifiedForCLUpdate asserts Run has received CLUpdated event for
// given CLID + EVersion.
func AssertNotifiedForCLUpdate(ctx context.Context, runID common.RunID, clid common.CLID, eversion int) {
