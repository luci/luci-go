...
func (m *OngoingLongOps_Op) validate(all bool) error {
	...
	case *OngoingLongOps_Op_CancelTriggers:
		if v == nil {
			err := OngoingLongOps_OpValidationError{
				field:  "Work",
				reason: "oneof value cannot be a typed-nil",
...
// Validate checks the field values on OngoingLongOps_Op_TriggersCancellation
// with the rules defined in the proto definition for this message. If any
// rules are violated, the first error encountered is returned, or nil if
// there are no violations.
func (m *OngoingLongOps_Op_TriggersCancellation) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on
// OngoingLongOps_Op_TriggersCancellation with the rules defined in the proto
// definition for this message. If any rules are violated, the result is a
// list of violation errors wrapped in
// OngoingLongOps_Op_TriggersCancellationMultiError, or nil if none found.
func (m *OngoingLongOps_Op_TriggersCancellation) ValidateAll() error {
	return m.validate(true)
}

func (m *OngoingLongOps_Op_TriggersCancellation) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetRequests() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, OngoingLongOps_Op_TriggersCancellationValidationError{
			...
			if err := v.Validate(); err != nil {
				return OngoingLongOps_Op_TriggersCancellationValidationError{
					field:  fmt.Sprintf("Requests[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return OngoingLongOps_Op_TriggersCancellationMultiError(errors)
	}

	return nil
}

// OngoingLongOps_Op_TriggersCancellationMultiError is an error wrapping
// multiple validation errors returned by
// OngoingLongOps_Op_TriggersCancellation.ValidateAll() if the designated
// constraints aren't met.
type OngoingLongOps_Op_TriggersCancellationMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m OngoingLongOps_Op_TriggersCancellationMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m OngoingLongOps_Op_TriggersCancellationMultiError) AllErrors() []error { return m }

// OngoingLongOps_Op_TriggersCancellationValidationError is the validation
// error returned by OngoingLongOps_Op_TriggersCancellation.Validate if the
// designated constraints aren't met.
type OngoingLongOps_Op_TriggersCancellationValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e OngoingLongOps_Op_TriggersCancellationValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OngoingLongOps_Op_TriggersCancellationValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OngoingLongOps_Op_TriggersCancellationValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OngoingLongOps_Op_TriggersCancellationValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OngoingLongOps_Op_TriggersCancellationValidationError) ErrorName() string {
	return "OngoingLongOps_Op_TriggersCancellationValidationError"
}

// Error satisfies the builtin error interface
func (e OngoingLongOps_Op_TriggersCancellationValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sOngoingLongOps_Op_TriggersCancellation.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = OngoingLongOps_Op_TriggersCancellationValidationError{}
...
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *OngoingLongOps_Op_TriggersCancellation_Request) Validate() error {
	return m.validate(false)
}
...
// OngoingLongOps_Op_TriggersCancellation_RequestMultiError, or nil if none found.
func (m *OngoingLongOps_Op_TriggersCancellation_Request) ValidateAll() error {
	return m.validate(true)
}

func (m *OngoingLongOps_Op_TriggersCancellation_Request) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return OngoingLongOps_Op_TriggersCancellation_RequestMultiError(errors)
	}

	return nil
}

// OngoingLongOps_Op_TriggersCancellation_RequestMultiError is an error
// wrapping multiple validation errors returned by
// OngoingLongOps_Op_TriggersCancellation_Request.ValidateAll() if the
// designated constraints aren't met.
type OngoingLongOps_Op_TriggersCancellation_RequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m OngoingLongOps_Op_TriggersCancellation_RequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m OngoingLongOps_Op_TriggersCancellation_RequestMultiError) AllErrors() []error { return m }

// OngoingLongOps_Op_TriggersCancellation_RequestValidationError is the
// validation error returned by
// OngoingLongOps_Op_TriggersCancellation_Request.Validate if the designated
// constraints aren't met.
type OngoingLongOps_Op_TriggersCancellation_RequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e OngoingLongOps_Op_TriggersCancellation_RequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OngoingLongOps_Op_TriggersCancellation_RequestValidationError) Reason() string {
	return e.reason
}

// Cause function returns cause value.
func (e OngoingLongOps_Op_TriggersCancellation_RequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OngoingLongOps_Op_TriggersCancellation_RequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OngoingLongOps_Op_TriggersCancellation_RequestValidationError) ErrorName() string {
	return "OngoingLongOps_Op_TriggersCancellation_RequestValidationError"
}

// Error satisfies the builtin error interface
func (e OngoingLongOps_Op_TriggersCancellation_RequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sOngoingLongOps_Op_TriggersCancellation_Request.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = OngoingLongOps_Op_TriggersCancellation_RequestValidationError{}
