...
func (m *LongOpCompleted) validate(all bool) error {
	...
	case *LongOpCompleted_CancelTriggers_:
		if v == nil {
			err := LongOpCompletedValidationError{
				field:  "Result",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetCancelTriggers()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, LongOpCompletedValidationError{
						field:  "CancelTriggers",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetCancelTriggers()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return LongOpCompletedValidationError{
					field:  "CancelTriggers",
					reason: "embedded message failed validation",
...
// Validate checks the field values on LongOpCompleted_CancelTriggers with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *LongOpCompleted_CancelTriggers) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LongOpCompleted_CancelTriggers with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// LongOpCompleted_CancelTriggersMultiError, or nil if none found.
func (m *LongOpCompleted_CancelTriggers) ValidateAll() error {
	return m.validate(true)
}

func (m *LongOpCompleted_CancelTriggers) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetResults() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, LongOpCompleted_CancelTriggersValidationError{
			...
			if err := v.Validate(); err != nil {
				return LongOpCompleted_CancelTriggersValidationError{
					field:  fmt.Sprintf("Results[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return LongOpCompleted_CancelTriggersMultiError(errors)
	}

	return nil
}

// LongOpCompleted_CancelTriggersMultiError is an error wrapping multiple
// validation errors returned by LongOpCompleted_CancelTriggers.ValidateAll()
// if the designated constraints aren't met.
type LongOpCompleted_CancelTriggersMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LongOpCompleted_CancelTriggersMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LongOpCompleted_CancelTriggersMultiError) AllErrors() []error { return m }

// LongOpCompleted_CancelTriggersValidationError is the validation error
// returned by LongOpCompleted_CancelTriggers.Validate if the designated
// constraints aren't met.
type LongOpCompleted_CancelTriggersValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LongOpCompleted_CancelTriggersValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LongOpCompleted_CancelTriggersValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LongOpCompleted_CancelTriggersValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LongOpCompleted_CancelTriggersValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LongOpCompleted_CancelTriggersValidationError) ErrorName() string {
	return "LongOpCompleted_CancelTriggersValidationError"
}

// Error satisfies the builtin error interface
func (e LongOpCompleted_CancelTriggersValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sLongOpCompleted_CancelTriggers.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = LongOpCompleted_CancelTriggersValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = LongOpCompleted_CancelTriggersValidationError{}
...
// Validate checks the field values on LongOpCompleted_CancelTriggers_Result
// with the rules defined in the proto definition for this message. If any
// rules are violated, the first error encountered is returned, or nil if
// there are no violations.
func (m *LongOpCompleted_CancelTriggers_Result) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LongOpCompleted_CancelTriggers_Result
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// LongOpCompleted_CancelTriggers_ResultMultiError, or nil if none found.
func (m *LongOpCompleted_CancelTriggers_Result) ValidateAll() error {
	return m.validate(true)
}

func (m *LongOpCompleted_CancelTriggers_Result) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	case *LongOpCompleted_CancelTriggers_Result_SuccessInfo:
		if v == nil {
			err := LongOpCompleted_CancelTriggers_ResultValidationError{
				field:  "Detail",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, LongOpCompleted_CancelTriggers_ResultValidationError{
						field:  "SuccessInfo",
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return LongOpCompleted_CancelTriggers_ResultValidationError{
					field:  "SuccessInfo",
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	case *LongOpCompleted_CancelTriggers_Result_FailureInfo:
		if v == nil {
			err := LongOpCompleted_CancelTriggers_ResultValidationError{
				field:  "Detail",
				reason: "oneof value cannot be a typed-nil",
	...
	if len(errors) > 0 {
		return LongOpCompleted_CancelTriggers_ResultMultiError(errors)
	}

	return nil
}

// LongOpCompleted_CancelTriggers_ResultMultiError is an error wrapping
// multiple validation errors returned by
// LongOpCompleted_CancelTriggers_Result.ValidateAll() if the designated
// constraints aren't met.
type LongOpCompleted_CancelTriggers_ResultMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LongOpCompleted_CancelTriggers_ResultMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LongOpCompleted_CancelTriggers_ResultMultiError) AllErrors() []error { return m }

// LongOpCompleted_CancelTriggers_ResultValidationError is the validation error
// returned by LongOpCompleted_CancelTriggers_Result.Validate if the
// designated constraints aren't met.
type LongOpCompleted_CancelTriggers_ResultValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LongOpCompleted_CancelTriggers_ResultValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LongOpCompleted_CancelTriggers_ResultValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LongOpCompleted_CancelTriggers_ResultValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LongOpCompleted_CancelTriggers_ResultValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LongOpCompleted_CancelTriggers_ResultValidationError) ErrorName() string {
	return "LongOpCompleted_CancelTriggers_ResultValidationError"
}

// Error satisfies the builtin error interface
func (e LongOpCompleted_CancelTriggers_ResultValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sLongOpCompleted_CancelTriggers_Result.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = LongOpCompleted_CancelTriggers_ResultValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = LongOpCompleted_CancelTriggers_ResultValidationError{}

// Validate checks the field values on
// LongOpCompleted_CancelTriggers_Result_Success with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *LongOpCompleted_CancelTriggers_Result_Success) Validate() error {
	return m.validate(false)
}
...
// LongOpCompleted_CancelTriggers_Result_SuccessMultiError, or nil if none found.
func (m *LongOpCompleted_CancelTriggers_Result_Success) ValidateAll() error {
	return m.validate(true)
}

func (m *LongOpCompleted_CancelTriggers_Result_Success) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, LongOpCompleted_CancelTriggers_Result_SuccessValidationError{
					field:  "CancelledAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return LongOpCompleted_CancelTriggers_Result_SuccessValidationError{
				field:  "CancelledAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return LongOpCompleted_CancelTriggers_Result_SuccessMultiError(errors)
	}

	return nil
}

// LongOpCompleted_CancelTriggers_Result_SuccessMultiError is an error wrapping
// multiple validation errors returned by
// LongOpCompleted_CancelTriggers_Result_Success.ValidateAll() if the
// designated constraints aren't met.
type LongOpCompleted_CancelTriggers_Result_SuccessMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LongOpCompleted_CancelTriggers_Result_SuccessMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LongOpCompleted_CancelTriggers_Result_SuccessMultiError) AllErrors() []error { return m }

// LongOpCompleted_CancelTriggers_Result_SuccessValidationError is the
// validation error returned by
// LongOpCompleted_CancelTriggers_Result_Success.Validate if the designated
// constraints aren't met.
type LongOpCompleted_CancelTriggers_Result_SuccessValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LongOpCompleted_CancelTriggers_Result_SuccessValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LongOpCompleted_CancelTriggers_Result_SuccessValidationError) Reason() string {
	return e.reason
}

// Cause function returns cause value.
func (e LongOpCompleted_CancelTriggers_Result_SuccessValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LongOpCompleted_CancelTriggers_Result_SuccessValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LongOpCompleted_CancelTriggers_Result_SuccessValidationError) ErrorName() string {
	return "LongOpCompleted_CancelTriggers_Result_SuccessValidationError"
}

// Error satisfies the builtin error interface
func (e LongOpCompleted_CancelTriggers_Result_SuccessValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sLongOpCompleted_CancelTriggers_Result_Success.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = LongOpCompleted_CancelTriggers_Result_SuccessValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = LongOpCompleted_CancelTriggers_Result_SuccessValidationError{}

// Validate checks the field values on
// LongOpCompleted_CancelTriggers_Result_Failure with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *LongOpCompleted_CancelTriggers_Result_Failure) Validate() error {
	return m.validate(false)
}
...
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in
// LongOpCompleted_CancelTriggers_Result_FailureMultiError, or nil if none found.
func (m *LongOpCompleted_CancelTriggers_Result_Failure) ValidateAll() error {
	return m.validate(true)
}

func (m *LongOpCompleted_CancelTriggers_Result_Failure) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return LongOpCompleted_CancelTriggers_Result_FailureMultiError(errors)
	}

	return nil
}

// LongOpCompleted_CancelTriggers_Result_FailureMultiError is an error wrapping
// multiple validation errors returned by
// LongOpCompleted_CancelTriggers_Result_Failure.ValidateAll() if the
// designated constraints aren't met.
type LongOpCompleted_CancelTriggers_Result_FailureMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LongOpCompleted_CancelTriggers_Result_FailureMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LongOpCompleted_CancelTriggers_Result_FailureMultiError) AllErrors() []error { return m }

// LongOpCompleted_CancelTriggers_Result_FailureValidationError is the
// validation error returned by
// LongOpCompleted_CancelTriggers_Result_Failure.Validate if the designated
// constraints aren't met.
type LongOpCompleted_CancelTriggers_Result_FailureValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LongOpCompleted_CancelTriggers_Result_FailureValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LongOpCompleted_CancelTriggers_Result_FailureValidationError) Reason() string {
	return e.reason
}

// Cause function returns cause value.
func (e LongOpCompleted_CancelTriggers_Result_FailureValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LongOpCompleted_CancelTriggers_Result_FailureValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LongOpCompleted_CancelTriggers_Result_FailureValidationError) ErrorName() string {
	return "LongOpCompleted_CancelTriggers_Result_FailureValidationError"
}

// Error satisfies the builtin error interface
func (e LongOpCompleted_CancelTriggers_Result_FailureValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sLongOpCompleted_CancelTriggers_Result_Failure.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = LongOpCompleted_CancelTriggers_Result_FailureValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = LongOpCompleted_CancelTriggers_Result_FailureValidationError{}
