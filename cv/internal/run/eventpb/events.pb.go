...
type SubmissionCompleted_ClFailures struct {
	...
	//
	// Currently, CLs are submitted serially and submitter returns immediately
	// if any of the CL submission fails. Therefore, `cl_failures` contains at
	// most one CL. However, once CV supports parallel CL submission, submitter
	// may report multiple CL submission failures during the parallel execution.
	ClFailures *SubmissionCompleted_CLSubmissionFailures `protobuf:"bytes,2,opt,name=cl_failures,json=clFailures,proto3,oneof"`
}
...
var file_go_chromium_org_luci_cv_internal_run_eventpb_events_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x64, 0x22, 0x8c, 0x03, 0x0a, 0x13, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x5b, 0x0a, 0x0b, 0x63, 0x6c, 0x5f, 0x66, 0x61, 0x69, 0x6c,
	0x75, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x63, 0x76, 0x2e,
	...
	,
...
var file_go_chromium_org_luci_cv_internal_run_eventpb_events_proto_depIdxs = []int32{
	...
	13, // 12: cv.run.eventpb.SubmissionCompleted.cl_failures:type_name -> cv.run.eventpb.SubmissionCompleted.CLSubmissionFailures
	12, // 13: cv.run.eventpb.SubmissionCompleted.CLSubmissionFailures.failures:type_name -> cv.run.eventpb.SubmissionCompleted.CLSubmissionFailure
