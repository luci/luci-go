...
type SubmissionCompleted struct {
	...
	// Result of this attempt to submit.
	...
	// Reason for permanent failure to be sent to CV user.
	//
	// only set when result == FAILED_PERMANENT
	FatalMessage string `protobuf:"bytes,3,opt,name=fatal_message,json=fatalMessage,proto3" json:"fatal_message,omitempty"`
	// True if submitter fails to release the submit queue.
	SubmitQueueNotReleased bool `protobuf:"varint,4,opt,name=submit_queue_not_released,json=submitQueueNotReleased,proto3" json:"submit_queue_not_released,omitempty"`
}
...
func (x *SubmissionCompleted) GetAttempt() int32 {
	if x != nil {
		return x.Attempt
	}
	return 0
...
func (x *SubmissionCompleted) GetFatalMessage() string {
	if x != nil {
		return x.FatalMessage
	}
	return ""
}

func (x *SubmissionCompleted) GetSubmitQueueNotReleased() bool {
	if x != nil {
		return x.SubmitQueueNotReleased
	}
	return false
}
...
var file_go_chromium_org_luci_cv_internal_run_eventpb_events_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0xc9, 0x01, 0x0a, 0x13, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x12, 0x14, 0x0a, 0x10, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x5f, 0x54, 0x52, 0x41, 0x4e, 0x53,
	0x49, 0x45, 0x4e, 0x54, 0x10, 0x02, 0x12, 0x17, 0x0a, 0x13, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44,
	...
	0x45, 0x4e, 0x54, 0x10, 0x04, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f,
...
var file_go_chromium_org_luci_cv_internal_run_eventpb_events_proto_depIdxs = []int32{
	...
	11, // 9: cv.run.eventpb.Event.process_after:type_name -> google.protobuf.Timestamp
