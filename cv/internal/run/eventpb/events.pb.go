...
type SubmissionCompleted_ClFailures struct {
	...
	// if any of the CL submission fails. Therefore, `cl_failures` should
	// only contain one CL. However, once CV supports parallel CL submission,
	// submitter may report multiple CL submission failures during the parallel
	// execution.
