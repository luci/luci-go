...
const file_go_chromium_org_luci_cv_internal_run_eventpb_tasks_proto_rawDesc = "" +
	"\n" +
	"8go.chromium.org/luci/cv/internal/run/eventpb/tasks.proto\x12\x17cv.internal.run.eventpb\x1a\x1fgoogle/protobuf/timestamp.proto\"&\n" +
	"\rManageRunTask\x12\x15\n" +
	"\x06run_id\x18\x01 \x01(\tR\x05runId\"X\n" +
	"\x11KickManageRunTask\x12\x15\n" +
	"\x06run_id\x18\x01 \x01(\tR\x05runId\x12,\n" +
	"\x03eta\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x03eta\"O\n" +
	"\x13ManageRunLongOpTask\x12\x15\n" +
	"\x06run_id\x18\x01 \x01(\tR\x05runId\x12!\n" +
	"\foperation_id\x18\x02 \x01(\tR\voperationIdB6Z4go.chromium.org/luci/cv/internal/run/eventpb;eventpbb\x06proto3"
