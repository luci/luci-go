...
const file_go_chromium_org_luci_cv_internal_run_eventpb_submission_proto_rawDesc = "" +
	"\n" +
	"=go.chromium.org/luci/cv/internal/run/eventpb/submission.proto\x12\x17cv.internal.run.eventpb\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfb\x03\n" +
	"\x13SubmissionCompleted\x12A\n" +
	"\x06result\x18\x01 \x01(\x0e2).cv.internal.run.eventpb.SubmissionResultR\x06result\x12R\n" +
	"\x17queue_release_timestamp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x15queueReleaseTimestamp\x12\x1a\n" +
	"\atimeout\x18\x03 \x01(\bH\x00R\atimeout\x12d\n" +
	"\vcl_failures\x18\x04 \x01(\v2A.cv.internal.run.eventpb.SubmissionCompleted.CLSubmissionFailuresH\x00R\n" +
	"clFailures\x1aC\n" +
	"\x13CLSubmissionFailure\x12\x12\n" +
	"\x04clid\x18\x01 \x01(\x03R\x04clid\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x1at\n" +
	"\x14CLSubmissionFailures\x12\\\n" +
	"\bfailures\x18\x01 \x03(\v2@.cv.internal.run.eventpb.SubmissionCompleted.CLSubmissionFailureR\bfailuresB\x10\n" +
	"\x0efailure_reason*p\n" +
	"\x10SubmissionResult\x12!\n" +
	"\x1dSUBMISSION_RESULT_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tSUCCEEDED\x10\x01\x12\x14\n" +
	"\x10FAILED_TRANSIENT\x10\x02\x12\x14\n" +
	"\x10FAILED_PERMANENT\x10\x03B6Z4go.chromium.org/luci/cv/internal/run/eventpb;eventpbb\x06proto3"
