...
func (rm *runManager) GetState(ctx context.Context) (eventbox.State, eventbox.EVersion, error) {
...
// isn't saved.
func (rm *runManager) GetEVersion(ctx context.Context) (eventbox.EVersion, error) {
	panic("not implemented")
}
