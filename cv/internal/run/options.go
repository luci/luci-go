...
// ExtractOptions computes the Run.Meta from 1 CL description.
...
func MergeOptions(a, b *Options) *Options {
	...
	return &Options{
		AvoidCancelingTryjobs:  a.AvoidCancelingTryjobs || b.AvoidCancelingTryjobs,
		DisableFullRun:         a.DisableFullRun || b.DisableFullRun,
