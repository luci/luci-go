...
const (
	...
	// Run is finalizing.
	//
	// A Run can't be cancelled while finalizing. A run must transit to a
	...
	Status_ENDED_MASK Status = 8
	// Run ends successfully.
	Status_SUCCEEDED Status = 24 // 16 | ENDED
	// Run ends unsuccessfully.
	Status_FAILED Status = 40 // 32 | ENDED
	// Run is cancelled.
	Status_CANCELLED Status = 72 // 64 | ENDED
)
...
var file_go_chromium_org_luci_cv_internal_run_storage_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x63, 0x76, 0x2e, 0x72, 0x75, 0x6e, 0x2a, 0x84, 0x01, 0x0a,
	...
	0x45, 0x44, 0x5f, 0x4d, 0x41, 0x53, 0x4b, 0x10, 0x08, 0x12, 0x0d, 0x0a, 0x09, 0x53, 0x55, 0x43,
	0x43, 0x45, 0x45, 0x44, 0x45, 0x44, 0x10, 0x18, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x41, 0x49, 0x4c,
	0x45, 0x44, 0x10, 0x28, 0x12, 0x0d, 0x0a, 0x09, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x4c, 0x45,
	0x44, 0x10, 0x48, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69,
