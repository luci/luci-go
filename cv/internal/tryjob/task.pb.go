...
type CancelStaleTryjobsTask struct {
	...
	// running at.
	PreviousMinEquivPatchset int64 `protobuf:"varint,2,opt,name=previous_min_equiv_patchset,json=previousMinEquivPatchset,proto3" json:"previous_min_equiv_patchset,omitempty"`
	// current_min_equiv_patchset is the patchset at or after which the
	// associated tryjobs are no longer considered stale.
	CurrentMinEquivPatchset int64 `protobuf:"varint,3,opt,name=current_min_equiv_patchset,json=currentMinEquivPatchset,proto3" json:"current_min_equiv_patchset,omitempty"`
}
...
func (x *CancelStaleTryjobsTask) GetPreviousMinEquivPatchset() int64 {
	if x != nil {
...
func (x *CancelStaleTryjobsTask) GetCurrentMinEquivPatchset() int64 {
	if x != nil {
...
var file_go_chromium_org_luci_cv_internal_tryjob_task_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x18, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x4d, 0x69, 0x6e, 0x45, 0x71,
	...
	0x5f, 0x70, 0x61, 0x74, 0x63, 0x68, 0x73, 0x65, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x17, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x4d, 0x69, 0x6e, 0x45, 0x71, 0x75, 0x69, 0x76,
	0x50, 0x61, 0x74, 0x63, 0x68, 0x73, 0x65, 0x74, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x6f, 0x2e, 0x63,
...
var file_go_chromium_org_luci_cv_internal_tryjob_task_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_go_chromium_org_luci_cv_internal_tryjob_task_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_internal_tryjob_task_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CancelStaleTryjobsTask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
