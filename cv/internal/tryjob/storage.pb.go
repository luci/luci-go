...
func file_go_chromium_org_luci_cv_internal_tryjob_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_internal_tryjob_storage_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_cv_internal_tryjob_storage_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
