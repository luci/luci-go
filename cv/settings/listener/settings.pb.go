...
type Settings_ReceiverSettings struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Settings_ReceiverSettings) Reset() {
	*x = Settings_ReceiverSettings{}
	if protoimpl.UnsafeEnabled {
...
func (x *Settings_ReceiverSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Settings_ReceiverSettings) ProtoMessage() {}

func (x *Settings_ReceiverSettings) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_settings_listener_settings_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Settings_ReceiverSettings.ProtoReflect.Descriptor instead.
func (*Settings_ReceiverSettings) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_settings_listener_settings_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Settings_ReceiverSettings) GetNumGoroutines() uint64 {
	if x != nil {
...
func (x *Settings_ReceiverSettings) GetMaxOutstandingMessages() int64 {
	if x != nil {
...
type Settings_GerritSubscription struct {
	...
	ReceiverSettings *Settings_ReceiverSettings `protobuf:"bytes,3,opt,name=receiver_settings,json=receiverSettings,proto3" json:"receiver_settings,omitempty"`
}
...
func (x *Settings_GerritSubscription) GetReceiverSettings() *Settings_ReceiverSettings {
	if x != nil {
...
var file_go_chromium_org_luci_cv_settings_listener_settings_proto_rawDesc = []byte{
	...
	,
	...
	,
}
...
var file_go_chromium_org_luci_cv_settings_listener_settings_proto_goTypes = []interface{}{
	(*Settings)(nil),                    // 0: listener.Settings
	(*Settings_ReceiverSettings)(nil),   // 1: listener.Settings.ReceiverSettings
	(*Settings_GerritSubscription)(nil), // 2: listener.Settings.GerritSubscription
}
var file_go_chromium_org_luci_cv_settings_listener_settings_proto_depIdxs = []int32{
	2, // 0: listener.Settings.gerrit_subscriptions:type_name -> listener.Settings.GerritSubscription
	1, // 1: listener.Settings.GerritSubscription.receiver_settings:type_name -> listener.Settings.ReceiverSettings
...
func file_go_chromium_org_luci_cv_settings_listener_settings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_settings_listener_settings_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Settings_ReceiverSettings); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
