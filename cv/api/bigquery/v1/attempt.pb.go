...
func file_go_chromium_org_luci_cv_api_bigquery_v1_attempt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_cv_api_bigquery_v1_attempt_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cv_api_bigquery_v1_attempt_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cv_api_bigquery_v1_attempt_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Build); i {
			case 0:
				return &v.state
			case 1:
