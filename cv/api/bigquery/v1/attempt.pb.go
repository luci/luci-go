...
const file_go_chromium_org_luci_cv_api_bigquery_v1_attempt_proto_rawDesc = "" +
	"\n" +
	"5go.chromium.org/luci/cv/api/bigquery/v1/attempt.proto\x12\bbigquery\x1a\x1fgoogle/protobuf/timestamp.proto\"\x94\x05\n" +
	"\aAttempt\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12!\n" +
	"\fluci_project\x18\x02 \x01(\tR\vluciProject\x12\x15\n" +
	"\x06run_id\x18\x0e \x01(\tR\x05runId\x12!\n" +
	"\fconfig_group\x18\v \x01(\tR\vconfigGroup\x12 \n" +
	"\fcl_group_key\x18\x03 \x01(\tR\n" +
	"clGroupKey\x125\n" +
	"\x17equivalent_cl_group_key\x18\x04 \x01(\tR\x14equivalentClGroupKey\x129\n" +
	"\n" +
	"start_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12F\n" +
	"\x11actual_start_time\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\x0factualStartTime\x125\n" +
	"\bend_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12=\n" +
	"\x0egerrit_changes\x18\a \x03(\v2\x16.bigquery.GerritChangeR\rgerritChanges\x12'\n" +
	"\x06builds\x18\b \x03(\v2\x0f.bigquery.BuildR\x06builds\x12/\n" +
	"\x06status\x18\t \x01(\x0e2\x17.bigquery.AttemptStatusR\x06status\x128\n" +
	"\tsubstatus\x18\n" +
	" \x01(\x0e2\x1a.bigquery.AttemptSubstatusR\tsubstatus\x124\n" +
	"\x16has_custom_requirement\x18\f \x01(\bR\x14hasCustomRequirement\"\xea\x03\n" +
	...
	"\x1cearliest_equivalent_patchset\x18\x05 \x01(\x03R\x1aearliestEquivalentPatchset\x12=\n" +
	"\ftrigger_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vtriggerTime\x12\"\n" +
	"\x04mode\x18\a \x01(\x0e2\x0e.bigquery.ModeR\x04mode\x12H\n" +
	"\rsubmit_status\x18\b \x01(\x0e2#.bigquery.GerritChange.SubmitStatusR\fsubmitStatus\x12 \n" +
	"\fis_owner_bot\x18\n" +
	" \x01(\bR\n" +
	"isOwnerBot\"a\n" +
	"\fSubmitStatus\x12\x1d\n" +
	"\x19SUBMIT_STATUS_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aPENDING\x10\x01\x12\v\n" +
	"\aUNKNOWN\x10\x02\x12\v\n" +
	"\aFAILURE\x10\x03\x12\v\n" +
	"\aSUCCESS\x10\x04J\x04\b\t\x10\n" +
	"\"\xc7\x01\n" +
	"\x05Build\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12.\n" +
	"\x06origin\x18\x03 \x01(\x0e2\x16.bigquery.Build.OriginR\x06origin\x12\x1a\n" +
	"\bcritical\x18\x04 \x01(\bR\bcritical\"N\n" +
	"\x06Origin\x12\x16\n" +
	"\x12ORIGIN_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fNOT_REUSABLE\x10\x01\x12\x0e\n" +
	"\n" +
	...
	"\bFULL_RUN\x10\x02\"\x04\b\x03\x10\x03*v\n" +
	"\rAttemptStatus\x12\x1e\n" +
	"\x1aATTEMPT_STATUS_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aSTARTED\x10\x01\x12\v\n" +
	"\aSUCCESS\x10\x02\x12\v\n" +
	"\aABORTED\x10\x03\x12\v\n" +
	"\aFAILURE\x10\x04\x12\x11\n" +
	"\rINFRA_FAILURE\x10\x05*\xe4\x01\n" +
	"\x10AttemptSubstatus\x12!\n" +
	"\x1dATTEMPT_SUBSTATUS_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fNO_SUBSTATUS\x10\x01\x12\x12\n" +
	"\x0eFAILED_TRYJOBS\x10\x02\x12\x0f\n" +
	"\vFAILED_LINT\x10\x03\x12\x0e\n" +
	"\n" +
	"UNAPPROVED\x10\x04\x12\x15\n" +
	"\x11PERMISSION_DENIED\x10\x05\x12\x1a\n" +
	"\x16UNSATISFIED_DEPENDENCY\x10\x06\x12\x11\n" +
	"\rMANUAL_CANCEL\x10\a\x12 \n" +
	"\x1cBUILDBUCKET_MISCONFIGURATION\x10\bB2Z0go.chromium.org/luci/cv/api/bigquery/v1;bigqueryb\x06proto3"
