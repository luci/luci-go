...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_depIdxs = []int32{
	...
	20, // 8: cv.config.SubmitOptions.burst_delay:type_name -> google.protobuf.Duration
	20, // 9: cv.config.CombineCLs.stabilization_delay:type_name -> google.protobuf.Duration
