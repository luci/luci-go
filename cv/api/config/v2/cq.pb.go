...
func (Verifiers_GerritCQAbility_CQAction) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 0, 0}
}
...
type ConfigGroup struct {
	...
	// Additional run modes supported besides standard DRY_RUN and FULL_RUN.
	//
	// Order matters.
	AdditonalModes []*Mode `protobuf:"bytes,7,rep,name=additonal_modes,json=additonalModes,proto3" json:"additonal_modes,omitempty"`
}
...
func (x *ConfigGroup) GetAdditonalModes() []*Mode {
	if x != nil {
		return x.AdditonalModes
	}
	return nil
}
...
type Mode struct {
	...
	// The conditions that triggers this mode.
	//
	// Connected by AND.
	TriggeringConditions []*TriggeringCondition `protobuf:"bytes,2,rep,name=triggering_conditions,json=triggeringConditions,proto3" json:"triggering_conditions,omitempty"`
}
...
func (x *Mode) GetTriggeringConditions() []*TriggeringCondition {
	if x != nil {
		return x.TriggeringConditions
	}
	return nil
}
...
type TriggeringCondition struct {
	...
	//	*TriggeringCondition_Vote_
	Condition isTriggeringCondition_Condition `protobuf_oneof:"condition"`
}

func (x *TriggeringCondition) Reset() {
	*x = TriggeringCondition{}
	if protoimpl.UnsafeEnabled {
...
func (x *TriggeringCondition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggeringCondition) ProtoMessage() {}

func (x *TriggeringCondition) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_api_config_v2_cq_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggeringCondition.ProtoReflect.Descriptor instead.
func (*TriggeringCondition) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{4}
}

func (m *TriggeringCondition) GetCondition() isTriggeringCondition_Condition {
	if m != nil {
		return m.Condition
	}
	return nil
...
func (x *TriggeringCondition) GetVote() *TriggeringCondition_Vote {
	if x, ok := x.GetCondition().(*TriggeringCondition_Vote_); ok {
		return x.Vote
	}
	return nil
}

type isTriggeringCondition_Condition interface {
	isTriggeringCondition_Condition()
}

type TriggeringCondition_Vote_ struct {
	Vote *TriggeringCondition_Vote `protobuf:"bytes,1,opt,name=vote,proto3,oneof"`
}

func (*TriggeringCondition_Vote_) isTriggeringCondition_Condition() {}
...
// Vote status
type TriggeringCondition_Vote struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TriggeringCondition_Vote) Reset() {
	*x = TriggeringCondition_Vote{}
	if protoimpl.UnsafeEnabled {
...
func (x *TriggeringCondition_Vote) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggeringCondition_Vote) ProtoMessage() {}

func (x *TriggeringCondition_Vote) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_api_config_v2_cq_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggeringCondition_Vote.ProtoReflect.Descriptor instead.
func (*TriggeringCondition_Vote) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{4, 0}
}

func (x *TriggeringCondition_Vote) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *TriggeringCondition_Vote) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (*Verifiers_GerritCQAbility) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 0}
}
...
func (*Verifiers_TreeStatus) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 1}
}
...
func (*Verifiers_Tryjob) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 2}
}
...
func (*Verifiers_CQLinter) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 3}
}
...
func (*Verifiers_Fake) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 4}
}
...
func (*Verifiers_Tryjob_Builder) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 2, 0}
}
...
func (*Verifiers_Tryjob_EquivalentBuilder) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 2, 1}
}
...
func (*Verifiers_Tryjob_IncludableBuilder) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 2, 2}
}
...
func (*Verifiers_Tryjob_RetryConfig) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDescGZIP(), []int{6, 2, 3}
}
...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDesc = []byte{
	...
	0x74, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x22, 0xff, 0x03, 0x0a, 0x0b, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	,
	...
	,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x63, 0x71, 0x2e, 0x63, 0x6f, 0x6e, 0x66,
	...
	0x74, 0x54, 0x6f, 0x12, 0x27, 0x0a, 0x0f, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x72, 0x65, 0x67, 0x65, 0x78, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x6c, 0x6f,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x67, 0x65, 0x78, 0x70, 0x12, 0x36, 0x0a, 0x17,
	0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x67, 0x65, 0x78, 0x70, 0x5f,
	0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x15, 0x6c,
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x67, 0x65, 0x78, 0x70, 0x45, 0x78, 0x63,
	0x6c, 0x75, 0x64, 0x65, 0x12, 0x32, 0x0a, 0x15, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x77, 0x68,
	...
	0x69, 0x73, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x1a, 0x7b, 0x0a, 0x11, 0x45, 0x71, 0x75, 0x69,
	...
	0x79, 0x2a, 0x24, 0x0a, 0x06, 0x54, 0x6f, 0x67, 0x67, 0x6c, 0x65, 0x12, 0x09, 0x0a, 0x05, 0x55,
	0x4e, 0x53, 0x45, 0x54, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x59, 0x45, 0x53, 0x10, 0x01, 0x12,
	0x06, 0x0a, 0x02, 0x4e, 0x4f, 0x10, 0x02, 0x2a, 0x5d, 0x0a, 0x0c, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	...
	0x43, 0x54, 0x45, 0x44, 0x10, 0x02, 0x42, 0x75, 0x5a, 0x2c, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0xa2, 0xfe, 0x23, 0x43, 0x0a, 0x41, 0x68, 0x74, 0x74, 0x70,
...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_goTypes = []interface{}{
	...
	(*TriggeringCondition)(nil),                // 7: cq.config.TriggeringCondition
	(*CombineCLs)(nil),                         // 8: cq.config.CombineCLs
	(*Verifiers)(nil),                          // 9: cq.config.Verifiers
	(*ConfigGroup_Gerrit)(nil),                 // 10: cq.config.ConfigGroup.Gerrit
	(*ConfigGroup_Gerrit_Project)(nil),         // 11: cq.config.ConfigGroup.Gerrit.Project
	(*TriggeringCondition_Vote)(nil),           // 12: cq.config.TriggeringCondition.Vote
	(*Verifiers_GerritCQAbility)(nil),          // 13: cq.config.Verifiers.GerritCQAbility
	(*Verifiers_TreeStatus)(nil),               // 14: cq.config.Verifiers.TreeStatus
	(*Verifiers_Tryjob)(nil),                   // 15: cq.config.Verifiers.Tryjob
	(*Verifiers_CQLinter)(nil),                 // 16: cq.config.Verifiers.CQLinter
	(*Verifiers_Fake)(nil),                     // 17: cq.config.Verifiers.Fake
	(*Verifiers_Tryjob_Builder)(nil),           // 18: cq.config.Verifiers.Tryjob.Builder
	(*Verifiers_Tryjob_EquivalentBuilder)(nil), // 19: cq.config.Verifiers.Tryjob.EquivalentBuilder
	(*Verifiers_Tryjob_IncludableBuilder)(nil), // 20: cq.config.Verifiers.Tryjob.IncludableBuilder
	(*Verifiers_Tryjob_RetryConfig)(nil),       // 21: cq.config.Verifiers.Tryjob.RetryConfig
...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_depIdxs = []int32{
	...
	22, // 3: cq.config.SubmitOptions.burst_delay:type_name -> google.protobuf.Duration
	10, // 4: cq.config.ConfigGroup.gerrit:type_name -> cq.config.ConfigGroup.Gerrit
	8,  // 5: cq.config.ConfigGroup.combine_cls:type_name -> cq.config.CombineCLs
	9,  // 6: cq.config.ConfigGroup.verifiers:type_name -> cq.config.Verifiers
	0,  // 7: cq.config.ConfigGroup.fallback:type_name -> cq.config.Toggle
	6,  // 8: cq.config.ConfigGroup.additonal_modes:type_name -> cq.config.Mode
	7,  // 9: cq.config.Mode.triggering_conditions:type_name -> cq.config.TriggeringCondition
	12, // 10: cq.config.TriggeringCondition.vote:type_name -> cq.config.TriggeringCondition.Vote
	22, // 11: cq.config.CombineCLs.stabilization_delay:type_name -> google.protobuf.Duration
	13, // 12: cq.config.Verifiers.gerrit_cq_ability:type_name -> cq.config.Verifiers.GerritCQAbility
	14, // 13: cq.config.Verifiers.tree_status:type_name -> cq.config.Verifiers.TreeStatus
	15, // 14: cq.config.Verifiers.tryjob:type_name -> cq.config.Verifiers.Tryjob
	16, // 15: cq.config.Verifiers.cqlinter:type_name -> cq.config.Verifiers.CQLinter
	17, // 16: cq.config.Verifiers.fake:type_name -> cq.config.Verifiers.Fake
	11, // 17: cq.config.ConfigGroup.Gerrit.projects:type_name -> cq.config.ConfigGroup.Gerrit.Project
	2,  // 18: cq.config.Verifiers.GerritCQAbility.allow_owner_if_submittable:type_name -> cq.config.Verifiers.GerritCQAbility.CQAction
	18, // 19: cq.config.Verifiers.Tryjob.builders:type_name -> cq.config.Verifiers.Tryjob.Builder
	21, // 20: cq.config.Verifiers.Tryjob.retry_config:type_name -> cq.config.Verifiers.Tryjob.RetryConfig
	0,  // 21: cq.config.Verifiers.Tryjob.cancel_stale_tryjobs:type_name -> cq.config.Toggle
	1,  // 22: cq.config.Verifiers.Tryjob.Builder.result_visibility:type_name -> cq.config.CommentLevel
	0,  // 23: cq.config.Verifiers.Tryjob.Builder.cancel_stale:type_name -> cq.config.Toggle
	19, // 24: cq.config.Verifiers.Tryjob.Builder.equivalent_to:type_name -> cq.config.Verifiers.Tryjob.EquivalentBuilder
...
func file_go_chromium_org_luci_cv_api_config_v2_cq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_api_config_v2_cq_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggeringCondition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cv_api_config_v2_cq_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TriggeringCondition_Vote); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_cv_api_config_v2_cq_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*TriggeringCondition_Vote_)(nil),
	}
	type x struct{}
