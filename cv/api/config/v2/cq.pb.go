...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x63, 0x71, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x32, 0x15, 0x2e, 0x63, 0x71, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x6f, 0x6d,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x71, 0x2e, 0x63, 0x6f, 0x6e, 0x66,
	...
	0x61, 0x63, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x63, 0x71, 0x2e, 0x63,
	...
	0x32, 0x0f, 0x2e, 0x63, 0x71, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4d, 0x6f, 0x64,
	...
	0x0b, 0x32, 0x25, 0x2e, 0x63, 0x71, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x6f,
	...
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x2a, 0x5d,
	...
	0x4f, 0x10, 0x02, 0x42, 0x75, 0x5a, 0x2c, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69,
...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_goTypes = []interface{}{
	(CommentLevel)(0),                          // 0: cq.config.CommentLevel
	(Toggle)(0),                                // 1: cq.config.Toggle
	(Verifiers_GerritCQAbility_CQAction)(0),    // 2: cq.config.Verifiers.GerritCQAbility.CQAction
	(*Config)(nil),                             // 3: cq.config.Config
	(*ConfigGroup)(nil),                        // 4: cq.config.ConfigGroup
	(*SubmitOptions)(nil),                      // 5: cq.config.SubmitOptions
...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_depIdxs = []int32{
	5,  // 0: cq.config.Config.submit_options:type_name -> cq.config.SubmitOptions
	4,  // 1: cq.config.Config.config_groups:type_name -> cq.config.ConfigGroup
	1,  // 2: cq.config.Config.project_scoped_account:type_name -> cq.config.Toggle
	9,  // 3: cq.config.ConfigGroup.gerrit:type_name -> cq.config.ConfigGroup.Gerrit
	7,  // 4: cq.config.ConfigGroup.combine_cls:type_name -> cq.config.CombineCLs
	8,  // 5: cq.config.ConfigGroup.verifiers:type_name -> cq.config.Verifiers
	1,  // 6: cq.config.ConfigGroup.fallback:type_name -> cq.config.Toggle
	6,  // 7: cq.config.ConfigGroup.additional_modes:type_name -> cq.config.Mode
	20, // 8: cq.config.SubmitOptions.burst_delay:type_name -> google.protobuf.Duration
	...
	1,  // 19: cq.config.Verifiers.Tryjob.cancel_stale_tryjobs:type_name -> cq.config.Toggle
	0,  // 20: cq.config.Verifiers.Tryjob.Builder.result_visibility:type_name -> cq.config.CommentLevel
	1,  // 21: cq.config.Verifiers.Tryjob.Builder.cancel_stale:type_name -> cq.config.Toggle
