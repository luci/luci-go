...
type ConfigGroup struct {
	...
	// mode that its triggering conditions are all fulfilled. If none of the
	// modes works, CQ will fallback to standard DRY_RUN or FULL_RUN.
...
// Mode defines a CQ Run mode and how it is triggered.
//
...
type Mode struct {
	...
	//
	// As of 03/2021, only `QUICK_DRY_RUN` is allowed.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Required. The value of Commit-Queue label that MUST be set to in order
	// to trigger a CQ Run in this mode.
	//
	// Must be either 1 or 2.
	CqLabelValue int32 `protobuf:"varint,2,opt,name=cq_label_value,json=cqLabelValue,proto3" json:"cq_label_value,omitempty"`
	// Required. The Gerrit label that MUST be set to trigger the CQ Run
	// in this mode.
	...
	// Required. The value of the Gerrit label that MUST be set to in order
	// to trigger a CQ Run in this mode.
...
var file_go_chromium_org_luci_cv_api_config_v2_cq_proto_rawDesc = []byte{
	...
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x22, 0x97, 0x0f, 0x0a, 0x09,
	...
	0x1a, 0x8d, 0x09, 0x0a, 0x06, 0x54, 0x72, 0x79, 0x6a, 0x6f, 0x62, 0x12, 0x3f, 0x0a, 0x08, 0x62,
	...
	0x73, 0x1a, 0xa8, 0x04, 0x0a, 0x07, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a,
	...
	0x69, 0x74, 0x65, 0x6c, 0x69, 0x73, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x1a, 0x7b, 0x0a, 0x11,
	...
	0x64, 0x65, 0x6c, 0x61, 0x79, 0x2a, 0x24, 0x0a, 0x06, 0x54, 0x6f, 0x67, 0x67, 0x6c, 0x65, 0x12,
	0x09, 0x0a, 0x05, 0x55, 0x4e, 0x53, 0x45, 0x54, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x59, 0x45,
	0x53, 0x10, 0x01, 0x12, 0x06, 0x0a, 0x02, 0x4e, 0x4f, 0x10, 0x02, 0x2a, 0x5d, 0x0a, 0x0c, 0x43,
	...
	0x53, 0x54, 0x52, 0x49, 0x43, 0x54, 0x45, 0x44, 0x10, 0x02, 0x42, 0x75, 0x5a, 0x2c, 0x67, 0x6f,
