...
type UserQuotaConfig_Payer int32

const (
	// CL owner pays the charged amount.
	UserQuotaConfig_PAYER_CL_OWNER UserQuotaConfig_Payer = 0
	// Run triggerer, who is the first voter with a CQ label for the Run,
	// pays the charged amount.
	UserQuotaConfig_PAYER_RUN_TRIGGERER UserQuotaConfig_Payer = 1
)

// Enum value maps for UserQuotaConfig_Payer.
var (
	UserQuotaConfig_Payer_name = map[int32]string{
		0: "PAYER_CL_OWNER",
		1: "PAYER_RUN_TRIGGERER",
	}
	UserQuotaConfig_Payer_value = map[string]int32{
		"PAYER_CL_OWNER":      0,
		"PAYER_RUN_TRIGGERER": 1,
	}
)

func (x UserQuotaConfig_Payer) Enum() *UserQuotaConfig_Payer {
	p := new(UserQuotaConfig_Payer)
	*p = x
	return p
}

func (x UserQuotaConfig_Payer) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UserQuotaConfig_Payer) Descriptor() protoreflect.EnumDescriptor {
	return file_go_chromium_org_luci_cv_api_config_v2_config_proto_enumTypes[3].Descriptor()
}

func (UserQuotaConfig_Payer) Type() protoreflect.EnumType {
	return &file_go_chromium_org_luci_cv_api_config_v2_config_proto_enumTypes[3]
}

func (x UserQuotaConfig_Payer) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UserQuotaConfig_Payer.Descriptor instead.
func (UserQuotaConfig_Payer) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_config_proto_rawDescGZIP(), []int{7, 0}
}
...
type ConfigGroup struct {
	...
	UserQuotaConfig *UserQuotaConfig `protobuf:"bytes,8,opt,name=user_quota_config,json=userQuotaConfig,proto3" json:"user_quota_config,omitempty"`
}
...
func (x *ConfigGroup) GetUserQuotaConfig() *UserQuotaConfig {
	if x != nil {
		return x.UserQuotaConfig
	}
	return nil
}
...
type QuotaPolicy struct {
	...
	//	*QuotaPolicy_User
	//	*QuotaPolicy_CriaGroup
	ApplyTo isQuotaPolicy_ApplyTo `protobuf_oneof:"apply_to"`
	// Maximum number of active Runs allowed at any given moment.
	//
	// Active Run is a Run that has started but not ended yet.
	MaxActiveRuns int32 `protobuf:"varint,3,opt,name=max_active_runs,json=maxActiveRuns,proto3" json:"max_active_runs,omitempty"`
	...
	MaxActiveTryjobs int32 `protobuf:"varint,4,opt,name=max_active_tryjobs,json=maxActiveTryjobs,proto3" json:"max_active_tryjobs,omitempty"`
}
...
func (m *QuotaPolicy) GetApplyTo() isQuotaPolicy_ApplyTo {
	if m != nil {
		return m.ApplyTo
	}
	return nil
...
func (x *QuotaPolicy) GetUser() string {
	if x, ok := x.GetApplyTo().(*QuotaPolicy_User); ok {
		return x.User
	}
	return ""
}

func (x *QuotaPolicy) GetCriaGroup() string {
	if x, ok := x.GetApplyTo().(*QuotaPolicy_CriaGroup); ok {
		return x.CriaGroup
	}
	return ""
}

func (x *QuotaPolicy) GetMaxActiveRuns() int32 {
	if x != nil {
...
func (x *QuotaPolicy) GetMaxActiveTryjobs() int32 {
	if x != nil {
		return x.MaxActiveTryjobs
	}
	return 0
}

type isQuotaPolicy_ApplyTo interface {
	isQuotaPolicy_ApplyTo()
}

type QuotaPolicy_User struct {
	// Email of the Gerrit user to apply the quota policy to.
	User string `protobuf:"bytes,1,opt,name=user,proto3,oneof"`
}

type QuotaPolicy_CriaGroup struct {
	// CrIA group to apply the quota policy to.
	CriaGroup string `protobuf:"bytes,2,opt,name=cria_group,json=criaGroup,proto3,oneof"`
}

func (*QuotaPolicy_User) isQuotaPolicy_ApplyTo() {}

func (*QuotaPolicy_CriaGroup) isQuotaPolicy_ApplyTo() {}
...
type UserQuotaConfig struct {
	...
	Policies        []*QuotaPolicy        `protobuf:"bytes,2,rep,name=policies,proto3" json:"policies,omitempty"`
	Payer           UserQuotaConfig_Payer `protobuf:"varint,3,opt,name=payer,proto3,enum=cv.config.UserQuotaConfig_Payer" json:"payer,omitempty"`
	IncludeOptional bool                  `protobuf:"varint,4,opt,name=include_optional,json=includeOptional,proto3" json:"include_optional,omitempty"`
}

func (x *UserQuotaConfig) Reset() {
	*x = UserQuotaConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserQuotaConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserQuotaConfig) ProtoMessage() {}

func (x *UserQuotaConfig) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_api_config_v2_config_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserQuotaConfig.ProtoReflect.Descriptor instead.
func (*UserQuotaConfig) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_config_v2_config_proto_rawDescGZIP(), []int{7}
}

func (x *UserQuotaConfig) GetPolicies() []*QuotaPolicy {
	if x != nil {
		return x.Policies
	}
	return nil
...
func (x *UserQuotaConfig) GetPayer() UserQuotaConfig_Payer {
	if x != nil {
		return x.Payer
	}
	return UserQuotaConfig_PAYER_CL_OWNER
}

func (x *UserQuotaConfig) GetIncludeOptional() bool {
	if x != nil {
...
var file_go_chromium_org_luci_cv_api_config_v2_config_proto_rawDesc = []byte{
	...
	,
	...
	0x0a, 0x72, 0x65, 0x66, 0x5f, 0x72, 0x65, 0x67, 0x65, 0x78, 0x70, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x09, 0x72, 0x65, 0x66, 0x52, 0x65, 0x67, 0x65, 0x78, 0x70, 0x12, 0x2c, 0x0a, 0x12,
	0x72, 0x65, 0x66, 0x5f, 0x72, 0x65, 0x67, 0x65, 0x78, 0x70, 0x5f, 0x65, 0x78, 0x63, 0x6c, 0x75,
	0x64, 0x65, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x72, 0x65, 0x66, 0x52, 0x65, 0x67,
	0x65, 0x78, 0x70, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x08, 0x52, 0x07, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x4a, 0x04, 0x08, 0x0c,
	...
	,
	...
	0x75, 0x65, 0x2e, 0x63, 0x66, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_go_chromium_org_luci_cv_api_config_v2_config_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_go_chromium_org_luci_cv_api_config_v2_config_proto_goTypes = []interface{}{
	...
	(UserQuotaConfig_Payer)(0),                      // 3: cv.config.UserQuotaConfig.Payer
	...
	(*QuotaPolicy)(nil),                             // 10: cv.config.QuotaPolicy
	(*UserQuotaConfig)(nil),                         // 11: cv.config.UserQuotaConfig
	(*ConfigGroup_Gerrit)(nil),                      // 12: cv.config.ConfigGroup.Gerrit
	(*ConfigGroup_Gerrit_Project)(nil),              // 13: cv.config.ConfigGroup.Gerrit.Project
	(*Verifiers_GerritCQAbility)(nil),               // 14: cv.config.Verifiers.GerritCQAbility
	(*Verifiers_TreeStatus)(nil),                    // 15: cv.config.Verifiers.TreeStatus
	(*Verifiers_Tryjob)(nil),                        // 16: cv.config.Verifiers.Tryjob
	(*Verifiers_CQLinter)(nil),                      // 17: cv.config.Verifiers.CQLinter
	(*Verifiers_Fake)(nil),                          // 18: cv.config.Verifiers.Fake
	(*Verifiers_Tryjob_Builder)(nil),                // 19: cv.config.Verifiers.Tryjob.Builder
	(*Verifiers_Tryjob_EquivalentBuilder)(nil),      // 20: cv.config.Verifiers.Tryjob.EquivalentBuilder
	(*Verifiers_Tryjob_IncludableBuilder)(nil),      // 21: cv.config.Verifiers.Tryjob.IncludableBuilder
	(*Verifiers_Tryjob_RetryConfig)(nil),            // 22: cv.config.Verifiers.Tryjob.RetryConfig
	(*Verifiers_Tryjob_Builder_LocationFilter)(nil), // 23: cv.config.Verifiers.Tryjob.Builder.LocationFilter
...
var file_go_chromium_org_luci_cv_api_config_v2_config_proto_depIdxs = []int32{
	...
	12, // 3: cv.config.ConfigGroup.gerrit:type_name -> cv.config.ConfigGroup.Gerrit
	8,  // 4: cv.config.ConfigGroup.combine_cls:type_name -> cv.config.CombineCLs
	9,  // 5: cv.config.ConfigGroup.verifiers:type_name -> cv.config.Verifiers
	1,  // 6: cv.config.ConfigGroup.fallback:type_name -> cv.config.Toggle
	7,  // 7: cv.config.ConfigGroup.additional_modes:type_name -> cv.config.Mode
	11, // 8: cv.config.ConfigGroup.user_quota_config:type_name -> cv.config.UserQuotaConfig
	24, // 9: cv.config.SubmitOptions.burst_delay:type_name -> google.protobuf.Duration
	24, // 10: cv.config.CombineCLs.stabilization_delay:type_name -> google.protobuf.Duration
	14, // 11: cv.config.Verifiers.gerrit_cq_ability:type_name -> cv.config.Verifiers.GerritCQAbility
	15, // 12: cv.config.Verifiers.tree_status:type_name -> cv.config.Verifiers.TreeStatus
	16, // 13: cv.config.Verifiers.tryjob:type_name -> cv.config.Verifiers.Tryjob
	17, // 14: cv.config.Verifiers.cqlinter:type_name -> cv.config.Verifiers.CQLinter
	18, // 15: cv.config.Verifiers.fake:type_name -> cv.config.Verifiers.Fake
	10, // 16: cv.config.UserQuotaConfig.policies:type_name -> cv.config.QuotaPolicy
	3,  // 17: cv.config.UserQuotaConfig.payer:type_name -> cv.config.UserQuotaConfig.Payer
	13, // 18: cv.config.ConfigGroup.Gerrit.projects:type_name -> cv.config.ConfigGroup.Gerrit.Project
	2,  // 19: cv.config.Verifiers.GerritCQAbility.allow_owner_if_submittable:type_name -> cv.config.Verifiers.GerritCQAbility.CQAction
	19, // 20: cv.config.Verifiers.Tryjob.builders:type_name -> cv.config.Verifiers.Tryjob.Builder
	22, // 21: cv.config.Verifiers.Tryjob.retry_config:type_name -> cv.config.Verifiers.Tryjob.RetryConfig
	1,  // 22: cv.config.Verifiers.Tryjob.cancel_stale_tryjobs:type_name -> cv.config.Toggle
	0,  // 23: cv.config.Verifiers.Tryjob.Builder.result_visibility:type_name -> cv.config.CommentLevel
	1,  // 24: cv.config.Verifiers.Tryjob.Builder.cancel_stale:type_name -> cv.config.Toggle
	20, // 25: cv.config.Verifiers.Tryjob.Builder.equivalent_to:type_name -> cv.config.Verifiers.Tryjob.EquivalentBuilder
	23, // 26: cv.config.Verifiers.Tryjob.Builder.location_filters:type_name -> cv.config.Verifiers.Tryjob.Builder.LocationFilter
...
func file_go_chromium_org_luci_cv_api_config_v2_config_proto_init() {
	...
	file_go_chromium_org_luci_cv_api_config_v2_config_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*QuotaPolicy_User)(nil),
		(*QuotaPolicy_CriaGroup)(nil),
	}
	type x struct{}
