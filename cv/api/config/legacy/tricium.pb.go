...
const (
	...
	DataType_FILES            DataType = 2
	DataType_RESULTS          DataType = 3
)
...
type Function struct {
	...
	Type Function_Type `protobuf:"varint,1,opt,name=type,proto3,enum=legacy.tricium.Function_Type" json:"type,omitempty"`
	...
	// GIT_FILE_DETAILS.
	Needs DataType `protobuf:"varint,3,opt,name=needs,proto3,enum=legacy.tricium.DataType" json:"needs,omitempty"`
	// Data provided by this analyzer.
	//
	// This field is required.
	// After migration to recipe-based analyzers, this should always be
	// RESULTS.
	Provides DataType `protobuf:"varint,4,opt,name=provides,proto3,enum=legacy.tricium.DataType" json:"provides,omitempty"`
...
type Impl struct {
	...
	ProvidesForPlatform Platform `protobuf:"varint,1,opt,name=provides_for_platform,json=providesForPlatform,proto3,enum=legacy.tricium.Platform" json:"provides_for_platform,omitempty"`
	...
	RuntimePlatform Platform `protobuf:"varint,2,opt,name=runtime_platform,json=runtimePlatform,proto3,enum=legacy.tricium.Platform" json:"runtime_platform,omitempty"`
...
type Selection struct {
	...
	Platform Platform `protobuf:"varint,2,opt,name=platform,proto3,enum=legacy.tricium.Platform" json:"platform,omitempty"`
}
...
var file_go_chromium_org_luci_cv_api_config_legacy_tricium_proto_rawDesc = []byte{
	...
	0x69, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x6c, 0x65, 0x67, 0x61, 0x63,
	0x79, 0x2e, 0x74, 0x72, 0x69, 0x63, 0x69, 0x75, 0x6d, 0x22, 0xde, 0x01, 0x0a, 0x0d, 0x50, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x36, 0x0a, 0x09, 0x66,
	0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18,
	...
	0x6f, 0x6e, 0x73, 0x12, 0x39, 0x0a, 0x0a, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79,
	0x2e, 0x74, 0x72, 0x69, 0x63, 0x69, 0x75, 0x6d, 0x2e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x0a, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x31,
	0x0a, 0x05, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2e, 0x74, 0x72, 0x69, 0x63, 0x69, 0x75, 0x6d, 0x2e, 0x52,
	0x65, 0x70, 0x6f, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x05, 0x72, 0x65, 0x70, 0x6f,
	...
	0x69, 0x63, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa6, 0x02, 0x0a, 0x08, 0x46,
	0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2e, 0x74,
	0x72, 0x69, 0x63, 0x69, 0x75, 0x6d, 0x2e, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
	...
	,
	...
	0x69, 0x6c, 0x64, 0x65, 0x72, 0x22, 0x5d, 0x0a, 0x09, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x34,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x67, 0x69, 0x74, 0x55, 0x72, 0x6c, 0x2a, 0x42, 0x0a, 0x08, 0x44,
	...
	,
}
...
var file_go_chromium_org_luci_cv_api_config_legacy_tricium_proto_goTypes = []interface{}{
	(DataType)(0),                     // 0: legacy.tricium.DataType
	(Platform)(0),                     // 1: legacy.tricium.Platform
	(Function_Type)(0),                // 2: legacy.tricium.Function.Type
	(*ProjectConfig)(nil),             // 3: legacy.tricium.ProjectConfig
	(*Function)(nil),                  // 4: legacy.tricium.Function
	(*Impl)(nil),                      // 5: legacy.tricium.Impl
	(*Recipe)(nil),                    // 6: legacy.tricium.Recipe
	(*Selection)(nil),                 // 7: legacy.tricium.Selection
	(*RepoDetails)(nil),               // 8: legacy.tricium.RepoDetails
	(*RepoDetails_GerritProject)(nil), // 9: legacy.tricium.RepoDetails.GerritProject
}
var file_go_chromium_org_luci_cv_api_config_legacy_tricium_proto_depIdxs = []int32{
	4,  // 0: legacy.tricium.ProjectConfig.functions:type_name -> legacy.tricium.Function
	7,  // 1: legacy.tricium.ProjectConfig.selections:type_name -> legacy.tricium.Selection
	8,  // 2: legacy.tricium.ProjectConfig.repos:type_name -> legacy.tricium.RepoDetails
	2,  // 3: legacy.tricium.Function.type:type_name -> legacy.tricium.Function.Type
	0,  // 4: legacy.tricium.Function.needs:type_name -> legacy.tricium.DataType
	0,  // 5: legacy.tricium.Function.provides:type_name -> legacy.tricium.DataType
	5,  // 6: legacy.tricium.Function.impls:type_name -> legacy.tricium.Impl
	1,  // 7: legacy.tricium.Impl.provides_for_platform:type_name -> legacy.tricium.Platform
	1,  // 8: legacy.tricium.Impl.runtime_platform:type_name -> legacy.tricium.Platform
	6,  // 9: legacy.tricium.Impl.recipe:type_name -> legacy.tricium.Recipe
	1,  // 10: legacy.tricium.Selection.platform:type_name -> legacy.tricium.Platform
	9,  // 11: legacy.tricium.RepoDetails.gerrit_project:type_name -> legacy.tricium.RepoDetails.GerritProject
