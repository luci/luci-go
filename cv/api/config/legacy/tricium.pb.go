...
type Function struct {
	...
	// The type of this function. Should always be ANALYZER. Required.
	//
	...
	// Data needed by this analyzer. Should always be GIT_FILE_DETAILS. Required.
	Needs DataType `protobuf:"varint,3,opt,name=needs,proto3,enum=cv.legacy.tricium.DataType" json:"needs,omitempty"`
	// Data provided by this analyzer. Should always be RESULTS. Required.
