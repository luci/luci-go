...
var file_go_chromium_org_luci_cv_api_v1_run_proto_rawDesc = []byte{
...
var (
	...
	file_go_chromium_org_luci_cv_api_v1_run_proto_rawDescData = file_go_chromium_org_luci_cv_api_v1_run_proto_rawDesc
)
...
func file_go_chromium_org_luci_cv_api_v1_run_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_cv_api_v1_run_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_cv_api_v1_run_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_cv_api_v1_run_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_cv_api_v1_run_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_cv_api_v1_run_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_cv_api_v1_run_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Run); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_cv_api_v1_run_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_cv_api_v1_run_proto_rawDesc = nil
