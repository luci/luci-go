...
const file_go_chromium_org_luci_cv_api_v1_run_proto_rawDesc = "" +
	"\n" +
	"(go.chromium.org/luci/cv/api/v1/run.proto\x12\x05cv.v1\"\xff\x01\n" +
	"\x03Run\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12)\n" +
	"\x06status\x18\x02 \x01(\x0e2\x11.cv.v1.Run.StatusR\x06status\x12\x1a\n" +
	"\beversion\x18\x03 \x01(\x03R\beversion\"\xa0\x01\n" +
	"\x06Status\x12\x16\n" +
	...
	"\n" +
	"\x06FAILED\x10B\x12\r\n" +
	"\tCANCELLED\x10CB%Z#go.chromium.org/luci/cv/api/v1;cvpbb\x06proto3"
