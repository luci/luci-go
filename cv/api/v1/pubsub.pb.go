...
const file_go_chromium_org_luci_cv_api_v1_pubsub_proto_rawDesc = "" +
	"\n" +
	"+go.chromium.org/luci/cv/api/v1/pubsub.proto\x12\x05cv.v1\x1a(go.chromium.org/luci/cv/api/v1/run.proto\"~\n" +
	"\tPubSubRun\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12)\n" +
	"\x06status\x18\x02 \x01(\x0e2\x11.cv.v1.Run.StatusR\x06status\x12\x1a\n" +
	"\beversion\x18\x03 \x01(\x03R\beversion\x12\x1a\n" +
	"\bhostname\x18\x04 \x01(\tR\bhostnameB%Z#go.chromium.org/luci/cv/api/v1;cvpbb\x06proto3"
