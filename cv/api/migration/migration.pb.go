...
func (x *ReportRunsRequest) GetProject() string {
	if x != nil {
		return x.Project
	}
	return ""
...
type FinishedRunRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FinishedRunRequest) Reset() {
	*x = FinishedRunRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *FinishedRunRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FinishedRunRequest) ProtoMessage() {}

func (x *FinishedRunRequest) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_api_migration_migration_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FinishedRunRequest.ProtoReflect.Descriptor instead.
func (*FinishedRunRequest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_migration_migration_proto_rawDescGZIP(), []int{2}
}

func (x *FinishedRunRequest) GetRun() *ReportedRun {
	if x != nil {
		return x.Run
	}
	return nil
...
func (x *FinishedRunRequest) GetProject() string {
	if x != nil {
		return x.Project
	}
	return ""
...
var file_go_chromium_org_luci_cv_api_migration_migration_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x59, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74,
	...
	0x6e, 0x52, 0x04, 0x72, 0x75, 0x6e, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x22, 0x3a, 0x0a, 0x0b, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x52, 0x75, 0x6e,
	...
	0x65, 0x6d, 0x70, 0x74, 0x52, 0x07, 0x61, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x22, 0x58, 0x0a,
	0x12, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x52, 0x75, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x28, 0x0a, 0x03, 0x72, 0x75, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x16, 0x2e, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x65, 0x64, 0x52, 0x75, 0x6e, 0x52, 0x03, 0x72, 0x75, 0x6e, 0x12, 0x18, 0x0a,
	0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x32, 0x9b, 0x01, 0x0a, 0x09, 0x4d, 0x69, 0x67, 0x72,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x4a, 0x0a, 0x11, 0x52, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x52, 0x75, 0x6e, 0x12, 0x1d,
	0x2e, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x46, 0x69, 0x6e, 0x69, 0x73,
...
var file_go_chromium_org_luci_cv_api_migration_migration_proto_goTypes = []interface{}{
	...
	(*FinishedRunRequest)(nil), // 2: migration.FinishedRunRequest
...
var file_go_chromium_org_luci_cv_api_migration_migration_proto_depIdxs = []int32{
	...
	1, // 2: migration.FinishedRunRequest.run:type_name -> migration.ReportedRun
	0, // 3: migration.Migration.ReportRuns:input_type -> migration.ReportRunsRequest
	2, // 4: migration.Migration.ReportFinishedRun:input_type -> migration.FinishedRunRequest
...
func file_go_chromium_org_luci_cv_api_migration_migration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_api_migration_migration_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FinishedRunRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type MigrationClient interface {
	...
	ReportFinishedRun(ctx context.Context, in *FinishedRunRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *migrationPRPCClient) ReportFinishedRun(ctx context.Context, in *FinishedRunRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *migrationClient) ReportFinishedRun(ctx context.Context, in *FinishedRunRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type MigrationServer interface {
	...
	// ReportFinishedRun notifies CV of the Run CQDaemon has just finalized.
	ReportFinishedRun(context.Context, *FinishedRunRequest) (*empty.Empty, error)
}
...
func (*UnimplementedMigrationServer) ReportFinishedRun(context.Context, *FinishedRunRequest) (*empty.Empty, error) {
...
func _Migration_ReportFinishedRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MigrationServer).ReportFinishedRun(ctx, req.(*FinishedRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}
