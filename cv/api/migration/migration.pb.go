...
type FetchActiveRunsRequest struct {
	...
	LuciProjects string `protobuf:"bytes,1,opt,name=luci_projects,json=luciProjects,proto3" json:"luci_projects,omitempty"`
}
...
var file_go_chromium_org_luci_cv_api_migration_migration_proto_rawDesc = []byte{
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6c, 0x75,
