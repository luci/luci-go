...
type MigrationClient interface {
	...
	//
	PostUniqueGerritComment(ctx context.Context, in *PostUniqueGerritCommentRequest, opts ...grpc.CallOption) (*PostUniqueGerritCommentResponse, error)
...
func (c *migrationClient) PostUniqueGerritComment(ctx context.Context, in *PostUniqueGerritCommentRequest, opts ...grpc.CallOption) (*PostUniqueGerritCommentResponse, error) {
	out := new(PostUniqueGerritCommentResponse)
	err := c.cc.Invoke(ctx, "/migration.Migration/PostUniqueGerritComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MigrationServer interface {
	...
	//    failing entire attempt.
	//
	PostUniqueGerritComment(context.Context, *PostUniqueGerritCommentRequest) (*PostUniqueGerritCommentResponse, error)
	// ReportUsedNetrc notifies CV of the legacy .netrc credentials used by
	// CQDaemon.
...
func (UnimplementedMigrationServer) PostUniqueGerritComment(context.Context, *PostUniqueGerritCommentRequest) (*PostUniqueGerritCommentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostUniqueGerritComment not implemented")
}
...
func _Migration_PostUniqueGerritComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostUniqueGerritCommentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MigrationServer).PostUniqueGerritComment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/migration.Migration/PostUniqueGerritComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MigrationServer).PostUniqueGerritComment(ctx, req.(*PostUniqueGerritCommentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Migration_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PostUniqueGerritComment",
			Handler:    _Migration_PostUniqueGerritComment_Handler,
		},
		{
