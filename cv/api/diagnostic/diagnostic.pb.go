...
var file_go_chromium_org_luci_cv_api_diagnostic_diagnostic_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0x97, 0x01, 0x0a, 0x0a, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63,
	...
	0x74, 0x43, 0x4c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x35, 0x5a, 0x33, 0x67,
...
var file_go_chromium_org_luci_cv_api_diagnostic_diagnostic_proto_goTypes = []interface{}{
	...
	(*prjpb.PState)(nil),                // 4: cv.prjmanager.prjpb.PState
	(*prjpb.Event)(nil),                 // 5: cv.prjmanager.prjpb.Event
	(*changelist.Snapshot)(nil),         // 6: cv.changelist.Snapshot
	(*changelist.ApplicableConfig)(nil), // 7: cv.changelist.ApplicableConfig
	(*changelist.DependentMeta)(nil),    // 8: cv.changelist.DependentMeta
}
var file_go_chromium_org_luci_cv_api_diagnostic_diagnostic_proto_depIdxs = []int32{
	4, // 0: diagnostic.GetProjectResponse.state:type_name -> cv.prjmanager.prjpb.PState
	5, // 1: diagnostic.GetProjectResponse.events:type_name -> cv.prjmanager.prjpb.Event
	6, // 2: diagnostic.GetCLResponse.snapshot:type_name -> cv.changelist.Snapshot
	7, // 3: diagnostic.GetCLResponse.applicable_config:type_name -> cv.changelist.ApplicableConfig
	8, // 4: diagnostic.GetCLResponse.dependent_meta:type_name -> cv.changelist.DependentMeta
	0, // 5: diagnostic.Diagnostic.GetProject:input_type -> diagnostic.GetProjectRequest
	2, // 6: diagnostic.Diagnostic.GetCL:input_type -> diagnostic.GetCLRequest
	1, // 7: diagnostic.Diagnostic.GetProject:output_type -> diagnostic.GetProjectResponse
	3, // 8: diagnostic.Diagnostic.GetCL:output_type -> diagnostic.GetCLResponse
