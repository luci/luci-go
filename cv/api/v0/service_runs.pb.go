...
var (
	...
	file_go_chromium_org_luci_cv_api_v0_service_runs_proto_rawDescData = file_go_chromium_org_luci_cv_api_v0_service_runs_proto_rawDesc
)
...
func file_go_chromium_org_luci_cv_api_v0_service_runs_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_cv_api_v0_service_runs_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_cv_api_v0_service_runs_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_cv_api_v0_service_runs_proto_rawDescData)
	})
...
func file_go_chromium_org_luci_cv_api_v0_service_runs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_cv_api_v0_service_runs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cv_api_v0_service_runs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cv_api_v0_service_runs_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cv_api_v0_service_runs_proto_msgTypes[3].Exporter = func(v any, i int) any {
