...
const file_go_chromium_org_luci_cv_api_v0_run_proto_rawDesc = "" +
	"\n" +
	"(go.chromium.org/luci/cv/api/v0/run.proto\x12\x05cv.v0\x1a\x1fgoogle/protobuf/timestamp.proto\x1a+go.chromium.org/luci/cv/api/v0/tryjob.proto\"\x90\a\n" +
	"\x03Run\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12)\n" +
	"\x06status\x18\x02 \x01(\x0e2\x11.cv.v0.Run.StatusR\x06status\x12\x1a\n" +
	"\beversion\x18\x03 \x01(\x03R\beversion\x12\x12\n" +
	...
	"\n" +
	"created_by\x18\r \x01(\tR\tcreatedBy\x12\x1b\n" +
	"\tbilled_to\x18\x0f \x01(\tR\bbilledTo\x12%\n" +
	"\x03cls\x18\n" +
	" \x03(\v2\x13.cv.v0.GerritChangeR\x03cls\x12+\n" +
	"\atryjobs\x18\v \x03(\v2\r.cv.v0.TryjobB\x02\x18\x01R\atryjobs\x12F\n" +
	"\x12tryjob_invocations\x18\x0e \x03(\v2\x17.cv.v0.TryjobInvocationR\x11tryjobInvocations\x125\n" +
	"\n" +
	"submission\x18\f \x01(\v2\x15.cv.v0.Run.SubmissionR\n" +
	"submission\x1aj\n" +
	"\n" +
	"Submission\x120\n" +
	"\x14submitted_cl_indexes\x18\x02 \x03(\x05R\x12submittedClIndexes\x12*\n" +
	"\x11failed_cl_indexes\x18\x03 \x03(\x05R\x0ffailedClIndexes\"\xa0\x01\n" +
	"\x06Status\x12\x16\n" +
	...
	"\bpatchset\x18\x03 \x01(\x05R\bpatchsetB%Z#go.chromium.org/luci/cv/api/v0;cvpbb\x06proto3"
