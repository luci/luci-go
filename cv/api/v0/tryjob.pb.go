...
func (Tryjob_Result_Status) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_v0_tryjob_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
type Tryjob struct {
	...
	Definition *Tryjob_Definition `protobuf:"bytes,1,opt,name=definition,proto3" json:"definition,omitempty"`
	// Status of the Tryjob.
	Status Tryjob_Status `protobuf:"varint,5,opt,name=status,proto3,enum=cv.v0.Tryjob_Status" json:"status,omitempty"`
	// Result of the tryjob.
	Result *Tryjob_Result `protobuf:"bytes,7,opt,name=result,proto3" json:"result,omitempty"`
}
...
func (x *Tryjob) GetDefinition() *Tryjob_Definition {
	if x != nil {
		return x.Definition
	}
	return nil
...
type Tryjob_Definition struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Backend:
	//	*Tryjob_Definition_Buildbucket_
	Backend isTryjob_Definition_Backend `protobuf_oneof:"backend"`
}

func (x *Tryjob_Definition) Reset() {
	*x = Tryjob_Definition{}
	if protoimpl.UnsafeEnabled {
...
func (x *Tryjob_Definition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Tryjob_Definition) ProtoMessage() {}

func (x *Tryjob_Definition) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_api_v0_tryjob_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Tryjob_Definition.ProtoReflect.Descriptor instead.
func (*Tryjob_Definition) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_v0_tryjob_proto_rawDescGZIP(), []int{0, 0}
}

func (m *Tryjob_Definition) GetBackend() isTryjob_Definition_Backend {
	if m != nil {
		return m.Backend
	}
	return nil
...
func (x *Tryjob_Definition) GetBuildbucket() *Tryjob_Definition_Buildbucket {
	if x, ok := x.GetBackend().(*Tryjob_Definition_Buildbucket_); ok {
		return x.Buildbucket
	}
	return nil
}

type isTryjob_Definition_Backend interface {
	isTryjob_Definition_Backend()
}

type Tryjob_Definition_Buildbucket_ struct {
	// For buildbucket, it's just a builder.
	Buildbucket *Tryjob_Definition_Buildbucket `protobuf:"bytes,1,opt,name=buildbucket,proto3,oneof"`
}

func (*Tryjob_Definition_Buildbucket_) isTryjob_Definition_Backend() {}
...
func (*Tryjob_Result) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_v0_tryjob_proto_rawDescGZIP(), []int{0, 1}
}
...
type Tryjob_Definition_Buildbucket struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Tryjob_Definition_Buildbucket) Reset() {
	*x = Tryjob_Definition_Buildbucket{}
	if protoimpl.UnsafeEnabled {
...
func (x *Tryjob_Definition_Buildbucket) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Tryjob_Definition_Buildbucket) ProtoMessage() {}

func (x *Tryjob_Definition_Buildbucket) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cv_api_v0_tryjob_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Tryjob_Definition_Buildbucket.ProtoReflect.Descriptor instead.
func (*Tryjob_Definition_Buildbucket) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cv_api_v0_tryjob_proto_rawDescGZIP(), []int{0, 0, 0}
}

func (x *Tryjob_Definition_Buildbucket) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *Tryjob_Definition_Buildbucket) GetBuilder() *proto.BuilderID {
	if x != nil {
		return x.Builder
	}
	return nil
...
var file_go_chromium_org_luci_cv_api_v0_tryjob_proto_rawDesc = []byte{
	...
	0x76, 0x2e, 0x76, 0x30, 0x1a, 0x34, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75,
	...
	0x98, 0x06, 0x0a, 0x06, 0x54, 0x72, 0x79, 0x6a, 0x6f, 0x62, 0x12, 0x38, 0x0a, 0x0a, 0x64, 0x65,
	0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18,
	0x2e, 0x63, 0x76, 0x2e, 0x76, 0x30, 0x2e, 0x54, 0x72, 0x79, 0x6a, 0x6f, 0x62, 0x2e, 0x44, 0x65,
	0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0a, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05,
	...
	0x75, 0x73, 0x12, 0x2c, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x07, 0x20, 0x01,
	...
	0x1a, 0xb9, 0x01, 0x0a, 0x0a, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x48, 0x0a, 0x0b, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x63, 0x76, 0x2e, 0x76, 0x30, 0x2e, 0x54, 0x72, 0x79,
	0x6a, 0x6f, 0x62, 0x2e, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x42,
	0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x62, 0x75,
	0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x1a, 0x56, 0x0a, 0x0b, 0x42, 0x75, 0x69,
	...
	0x72, 0x42, 0x09, 0x0a, 0x07, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x1a, 0xd2, 0x02, 0x0a,
	0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x33, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x63, 0x76, 0x2e, 0x76, 0x30, 0x2e,
	0x54, 0x72, 0x79, 0x6a, 0x6f, 0x62, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2e, 0x53, 0x74,
	...
	0x0b, 0x32, 0x20, 0x2e, 0x63, 0x76, 0x2e, 0x76, 0x30, 0x2e, 0x54, 0x72, 0x79, 0x6a, 0x6f, 0x62,
	...
	0x64, 0x22, 0x67, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x12, 0x53,
	...
	0x52, 0x49, 0x47, 0x47, 0x45, 0x52, 0x45, 0x44, 0x10, 0x05, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x6f,
...
var file_go_chromium_org_luci_cv_api_v0_tryjob_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_go_chromium_org_luci_cv_api_v0_tryjob_proto_goTypes = []interface{}{
	...
	(*Tryjob_Definition)(nil),             // 3: cv.v0.Tryjob.Definition
	(*Tryjob_Result)(nil),                 // 4: cv.v0.Tryjob.Result
	(*Tryjob_Definition_Buildbucket)(nil), // 5: cv.v0.Tryjob.Definition.Buildbucket
	(*Tryjob_Result_Buildbucket)(nil),     // 6: cv.v0.Tryjob.Result.Buildbucket
	(*proto.BuilderID)(nil),               // 7: buildbucket.v2.BuilderID
	(proto.Status)(0),                     // 8: buildbucket.v2.Status
}
var file_go_chromium_org_luci_cv_api_v0_tryjob_proto_depIdxs = []int32{
	3, // 0: cv.v0.Tryjob.definition:type_name -> cv.v0.Tryjob.Definition
	0, // 1: cv.v0.Tryjob.status:type_name -> cv.v0.Tryjob.Status
	4, // 2: cv.v0.Tryjob.result:type_name -> cv.v0.Tryjob.Result
	5, // 3: cv.v0.Tryjob.Definition.buildbucket:type_name -> cv.v0.Tryjob.Definition.Buildbucket
	1, // 4: cv.v0.Tryjob.Result.status:type_name -> cv.v0.Tryjob.Result.Status
	6, // 5: cv.v0.Tryjob.Result.buildbucket:type_name -> cv.v0.Tryjob.Result.Buildbucket
	7, // 6: cv.v0.Tryjob.Definition.Buildbucket.builder:type_name -> buildbucket.v2.BuilderID
	8, // 7: cv.v0.Tryjob.Result.Buildbucket.status:type_name -> buildbucket.v2.Status
...
func file_go_chromium_org_luci_cv_api_v0_tryjob_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cv_api_v0_tryjob_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tryjob_Definition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cv_api_v0_tryjob_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tryjob_Definition_Buildbucket); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_cv_api_v0_tryjob_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Tryjob_Definition_Buildbucket_)(nil),
	}
	file_go_chromium_org_luci_cv_api_v0_tryjob_proto_msgTypes[2].OneofWrappers = []interface{}{
