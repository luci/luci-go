...
type Output struct {
	...
	//
	// For example, with 2 Reuse blocks
	//   {kind_regexp: "fullrun" deny: true}
	//   {kind_regexp: ".+run"   deny: false}
	// the reuse is allowed for "dryrun" but not allowed to "fullrun" and "custom"
...
type Output_Reuse struct {
	...
	// Regular expression for kinds of Runs for which this Reuse block applies.
	// Required.
	//
	// Implicitly wrapped with $...^.
	// The matching is done against lowercased Run name.
	//
	// For example,
	//   ".+" will match all kinds of Runs,
	//   "dryrun" and "fullrun" will match only Dry and Full runs, respectively.
	KindRegexp string `protobuf:"bytes,1,opt,name=kind_regexp,json=kindRegexp,proto3" json:"kind_regexp,omitempty"`
	// If deny is true, then reuse of this build in the future Runs of the
	// matched kind is not allowed.
	//
...
var file_go_chromium_org_luci_cv_api_recipe_v1_cq_proto_rawDesc = []byte{
	...
	0x70, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0xae, 0x02, 0x0a, 0x06, 0x4f, 0x75, 0x74, 0x70, 0x75,
	...
	,
}
