...
const file_go_chromium_org_luci_cv_api_recipe_v1_cq_proto_rawDesc = "" +
	"\n" +
	".go.chromium.org/luci/cv/api/recipe/v1/cq.proto\x12\tcq.recipe\"\xbe\x01\n" +
	"\x05Input\x12\x16\n" +
	"\x06active\x18\x01 \x01(\bR\x06active\x12\x17\n" +
	"\adry_run\x18\x02 \x01(\bR\x06dryRun\x12\"\n" +
	"\fexperimental\x18\x03 \x01(\bR\fexperimental\x12\x1b\n" +
	"\ttop_level\x18\x04 \x01(\bR\btopLevel\x12\x19\n" +
	"\brun_mode\x18\x05 \x01(\tR\arunMode\x12(\n" +
	"\x10owner_is_googler\x18\x14 \x01(\bR\x0eownerIsGoogler\"\xa9\x03\n" +
	"\x06Output\x12.\n" +
	"\x13triggered_build_ids\x18\x01 \x03(\x03R\x11triggeredBuildIds\x12-\n" +
	"\x05retry\x18\x02 \x01(\x0e2\x17.cq.recipe.Output.RetryR\x05retry\x121\n" +
	"\x05reuse\x18\x03 \x03(\v2\x17.cq.recipe.Output.ReuseB\x02\x18\x01R\x05reuse\x12?\n" +
	"\vreusability\x18\x04 \x01(\v2\x1d.cq.recipe.Output.ReusabilityR\vreusability\x1a<\n" +
	"\x05Reuse\x12\x1f\n" +
	"\vmode_regexp\x18\x01 \x01(\tR\n" +
	"modeRegexp\x12\x12\n" +
	"\x04deny\x18\x02 \x01(\bR\x04deny\x1a4\n" +
	"\vReusability\x12%\n" +
	"\x0emode_allowlist\x18\x04 \x03(\tR\rmodeAllowlist\"X\n" +
	"\x05Retry\x12\x1c\n" +
	"\x18OUTPUT_RETRY_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14OUTPUT_RETRY_ALLOWED\x10\x01\x12\x17\n" +
	"\x13OUTPUT_RETRY_DENIED\x10\x02B.Z,go.chromium.org/luci/cv/api/recipe/v1;recipeb\x06proto3"
