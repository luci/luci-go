...
func startFakeBuildbucketBuildService() (addr net.Addr, shutdown func(), startBuild func() int64, getBuild func(int64) *bbpb.Build) {
...
func runBbagent(addr net.Addr, base *bbpb.Build, tc bbagentTestCase) (int, *ldMemory.Output) {
	...
	logging.Infof(ctx, "starting mainImpl (target: %s)", tc.name)
