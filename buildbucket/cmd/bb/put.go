...
Example:
	bb put -cl https://chromium-review.googlesource.com/c/chromium/src/+/1535172/20 infra/try/linux-rel infra/try/mac-rel

Creates linux-rel and mac-rel builds in chromium/try bucket for the CL.
`,
		...
		req.Requests = append(req.Requests, &buildbucketpb.BatchRequest_Request{
			Request: &buildbucketpb.BatchRequest_Request_ScheduleBuild{
				ScheduleBuild: &buildbucketpb.ScheduleBuildRequest{
					RequestId: strconv.FormatInt(rand.Int63(), 64),
					Builder:   builder,
				},
			},
		})
