...
Examples:
	...
	# Create linux-rel tryjob for a CL.
	bb put -cl https://chromium-review.googlesource.com/c/infra/luci/luci-go/+/1539021/1 infra/try/linux-rel

	# Schedule two builds.
	bb put chromium/ci/{linux-rel,mac-rel}
`,
