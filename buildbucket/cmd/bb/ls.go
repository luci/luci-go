...
func (r *lsRun) Run(a subcommands.Application, args []string, env subcommands.Env) int {
	...
	req, err := r.parseBatchRequest(args)
	if err != nil {
...
// parseBatchRequest converts flags and arguments to a batched SearchBuilds
// requests.
func (r *lsRun) parseBatchRequest(args []string) (*buildbucketpb.BatchRequest, error) {
