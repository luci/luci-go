...
// either Ref or Id.
//
// If confirmRef is true, commit.Ref needs to be confirmed.
func parseCommit(s string) (commit *buildbucketpb.GitilesCommit, confirmRef bool, err error) {
	...
	default:
		// The user has specified something with prefix "refs/", but not
		// "refs/heads/". She must know what she is doing.
	}
	return
}
