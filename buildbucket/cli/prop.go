...
// PropertiesFlag implements a flag that can read property values into s.
//
...
//
// Panics if s is nil.
// String() of the return value panics if marshaling of s to JSON fails.
