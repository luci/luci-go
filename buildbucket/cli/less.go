...
// Wait waits for less to exit and returns the exit code.
...
// startLess starts less and returns.
// Does not accept context because killing less breaks the
