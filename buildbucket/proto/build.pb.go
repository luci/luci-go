...
type Build struct {
	...
	//
	// If set, overrides the default `grace_period` set in build config.
...
var file_go_chromium_org_luci_buildbucket_proto_build_proto_rawDesc = []byte{
	...
	0x6e, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d,
	0x2e, 0x6f, 0x72, 0x67, 0x2f, 0x6c, 0x75, 0x63, 0x69, 0x2f, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62,
...
var file_go_chromium_org_luci_buildbucket_proto_build_proto_depIdxs = []int32{
	...
	18, // 16: buildbucket.v2.Build.grace_period:type_name -> google.protobuf.Duration
	...
	19, // 22: buildbucket.v2.Build.Input.properties:type_name -> google.protobuf.Struct
	20, // 23: buildbucket.v2.Build.Input.gitiles_commit:type_name -> buildbucket.v2.GitilesCommit
	21, // 24: buildbucket.v2.Build.Input.gerrit_changes:type_name -> buildbucket.v2.GerritChange
	19, // 25: buildbucket.v2.Build.Output.properties:type_name -> google.protobuf.Struct
	20, // 26: buildbucket.v2.Build.Output.gitiles_commit:type_name -> buildbucket.v2.GitilesCommit
	22, // 27: buildbucket.v2.Build.Output.logs:type_name -> buildbucket.v2.Log
	19, // 28: buildbucket.v2.BuildInfra.Buildbucket.requested_properties:type_name -> google.protobuf.Struct
	23, // 29: buildbucket.v2.BuildInfra.Buildbucket.requested_dimensions:type_name -> buildbucket.v2.RequestedDimension
	23, // 30: buildbucket.v2.BuildInfra.Swarming.task_dimensions:type_name -> buildbucket.v2.RequestedDimension
	16, // 31: buildbucket.v2.BuildInfra.Swarming.bot_dimensions:type_name -> buildbucket.v2.StringPair
	9,  // 32: buildbucket.v2.BuildInfra.Swarming.caches:type_name -> buildbucket.v2.BuildInfra.Swarming.CacheEntry
	24, // 33: buildbucket.v2.BuildInfra.Swarming.containment:type_name -> swarming.v1.Containment
	18, // 34: buildbucket.v2.BuildInfra.Swarming.CacheEntry.wait_for_warm_cache:type_name -> google.protobuf.Duration
