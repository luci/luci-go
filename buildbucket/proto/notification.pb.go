...
type PubSubCallBack struct {
	...
	// Buildbucket build
	Build *BuildsV2PubSub `protobuf:"bytes,1,opt,name=build,proto3" json:"build,omitempty"`
...
func (x *PubSubCallBack) GetBuild() *BuildsV2PubSub {
	if x != nil {
		return x.Build
	}
	return nil
...
var file_go_chromium_org_luci_buildbucket_proto_notification_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x63, 0x0a, 0x0e, 0x50, 0x75, 0x62, 0x53, 0x75,
	0x62, 0x43, 0x61, 0x6c, 0x6c, 0x42, 0x61, 0x63, 0x6b, 0x12, 0x34, 0x0a, 0x05, 0x62, 0x75, 0x69,
	0x6c, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64,
	0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x73,
	0x56, 0x32, 0x50, 0x75, 0x62, 0x53, 0x75, 0x62, 0x52, 0x05, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x12,
...
var file_go_chromium_org_luci_buildbucket_proto_notification_proto_depIdxs = []int32{
	...
	1, // 2: buildbucket.v2.PubSubCallBack.build:type_name -> buildbucket.v2.BuildsV2PubSub
