...
func (*SettingsCfg) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_config_fc3847e8231cd6ed, []int{0}
}
...
func (dst *SettingsCfg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SettingsCfg.Merge(dst, src)
}
...
func (*SwarmingSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_config_fc3847e8231cd6ed, []int{1}
}
...
func (dst *SwarmingSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SwarmingSettings.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/config/service_config.proto", fileDescriptor_service_config_fc3847e8231cd6ed)
}

var fileDescriptor_service_config_fc3847e8231cd6ed = []byte{
