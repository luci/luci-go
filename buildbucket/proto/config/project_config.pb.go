...
//   server endpoint.
// - $LOGDOG_NAMESPACE: a prefix of LogDog stream name.
//   The executable MAY request streams with this prefix from the stream
//   server at $LOGDOG_STREAM_SERVER_PATH.
//   For example, for $LOGDOG_NAMESPACE=u, the executable MAY request
//   "u/step/x/stdout".
...
//   See also CacheEntry.
//
// The executable MUST write "$LOGDOG_NAMESPACE/build.proto" stream of the
// LogDog Butler at $LOGDOG_STREAM_SERVER_PATH.
// It MUST be a binary-encoded Build datagram, with content type
...
// "$build.proto".
// It MUST point to a LogDog datagram stream with binary-encoded Build
// messages and content type
// "application/luci+proto; message=buildbucket.v2.Build".
