...
type BuilderPredicate struct {
	...
	// AND-connected list of regular expressions to match REQUESTED swarming
	// dimensions in the form "key:value". Note that many builders intentionally
	// under-specify some dimensions (like os), for example, specifying
	// "os:Windows" instead of "os:Windows-10".
	//
	// Each regex is wrapped in ^ and $ automatically.
	//
	// Example:
	//
	//    # All windows builders
	//    dim_regex: "os:Windows.*"
	//
	// Defaults to matching all builders.
	DimRegex []string `protobuf:"bytes,3,rep,name=dim_regex,json=dimRegex,proto3" json:"dim_regex,omitempty"`
	// Like dim_regex field, but OR-connected, and negation. Negation always wins.
	//
	// ANY matching dim_regex_exclude overrides a full set of matching
	// dim_regex's.
	DimRegexExclude      []string `protobuf:"bytes,4,rep,name=dim_regex_exclude,json=dimRegexExclude,proto3" json:"dim_regex_exclude,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *BuilderPredicate) GetDimRegex() []string {
	if m != nil {
		return m.DimRegex
	}
	return nil
...
func (m *BuilderPredicate) GetDimRegexExclude() []string {
	if m != nil {
		return m.DimRegexExclude
	}
	return nil
}
...
var fileDescriptor_4e08a93b642b6ff2 = []byte{
	...
	,
}
