...
func file_go_chromium_org_luci_buildbucket_proto_backend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_buildbucket_proto_backend_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
	...
	file_go_chromium_org_luci_buildbucket_proto_backend_proto_msgTypes[12].OneofWrappers = []interface{}{
