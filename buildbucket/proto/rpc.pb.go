...
func (*GetBuildRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{0}
}
...
func (*SearchBuildsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{1}
}
...
func (*SearchBuildsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{2}
}
...
func (*BatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{3}
}
...
func (*BatchRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{3, 0}
}
...
func (*BatchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{4}
}
...
func (*BatchResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{4, 0}
}
...
func (*UpdateBuildRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{5}
}
...
type ScheduleBuildRequest struct {
	...
	// template build.
	//
	// input.properties and input.dimensions are merged on top of the properties
	// and dimensions in the referenced build // using the logic described in
	// "input" field comments.
	//
	// Mutually exclusive with either builder.
	TemplateBuildId int64 `protobuf:"varint,3,opt,name=template_build_id,json=templateBuildId,proto3" json:"template_build_id,omitempty"`
	// If specified, overrides Build.infra.buildbucket.canary value.
	Canary Trinary `protobuf:"varint,4,opt,name=canary,proto3,enum=buildbucket.v2.Trinary" json:"canary,omitempty"`
	// If specified, overrides Build.input.experimental.
	...
	// A config-defined property cannot be removed, but its value can be
	// replaced with null.
	//
	...
	//
	// A set of entries with same key defines a new or replaces an existing
...
func (*ScheduleBuildRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{6}
}
...
func (dst *ScheduleBuildRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ScheduleBuildRequest.Merge(dst, src)
}
...
func (*BuildPredicate) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{7}
}
...
func (*BuildRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_d7e01d30d8e733aa, []int{8}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/rpc.proto", fileDescriptor_rpc_d7e01d30d8e733aa)
}

var fileDescriptor_rpc_d7e01d30d8e733aa = []byte{
	...
	,
}
