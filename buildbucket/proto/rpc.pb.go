...
func (*GetBuildRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{0}
}
...
func (*SearchBuildsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{1}
}
...
func (*SearchBuildsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{2}
}
...
func (*BatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{3}
}
...
func (*BatchRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{3, 0}
}
...
func (*BatchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{4}
}
...
func (*BatchResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{4, 0}
}
...
type BuildPredicate struct {
	...
	Build                *BuildRange `protobuf:"bytes,9,opt,name=build" json:"build,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (*BuildPredicate) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{5}
}
...
type BuildRange struct {
	...
	StartBuildId int64 `protobuf:"varint,1,opt,name=start_build_id,json=startBuildId" json:"start_build_id,omitempty"`
	// Exclusive upper boundary. Optional.
	EndBuildId           int64    `protobuf:"varint,2,opt,name=end_build_id,json=endBuildId" json:"end_build_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*BuildRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_36ed11e71f5fc857, []int{6}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/rpc.proto", fileDescriptor_rpc_36ed11e71f5fc857)
}

var fileDescriptor_rpc_36ed11e71f5fc857 = []byte{
	...
	,
}
