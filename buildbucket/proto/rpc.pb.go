...
type CancelBuildsRequest struct {
	...
	// predicate.builder.project is required, unless you are an admin.
	// predicate.status MUST be SCHEDULED or STARTED.
	Predicate            *BuildPredicate `protobuf:"bytes,3,opt,name=predicate,proto3" json:"predicate,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *CancelBuildsRequest) GetId() int64 {
	if m != nil {
		return m.Id
	}
	return 0
...
var fileDescriptor_6551d9ae29a9e5a9 = []byte{
	...
	,
}
