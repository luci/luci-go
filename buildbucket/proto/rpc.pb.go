...
type BuildsClient interface {
	...
	//
	// If any of the ScheduleBuild requests fails with PERMISSION_DENIED,
	// the RPC-level error code is PERMISSION_DENIED.
	// Otherwise the RPC-level error code is OK.
