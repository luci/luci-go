...
func (*GetBuildRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_e455bed7af9e20e8, []int{0}
}
...
func (*SearchBuildsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_e455bed7af9e20e8, []int{1}
}
...
func (*SearchBuildsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_e455bed7af9e20e8, []int{2}
}
...
func (*BuildPredicate) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_e455bed7af9e20e8, []int{3}
}
...
type BuildsClient interface {
	...
	// * bucket names are full, without stripping the "luci.<project>." prefix,
	//   for example, "master.chromium".
	// * if a v2 Build field does not make sense in V1, it is unset/empty.
	// * step support is not implemented for non-LUCI builds.
	// Note that it does not support getting a buildbot build by number.
	...
	//   }
	// }
	// will look for builds in "master.chromium" LUCI bucket.
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/rpc.proto", fileDescriptor_rpc_e455bed7af9e20e8)
}

var fileDescriptor_rpc_e455bed7af9e20e8 = []byte{
