...
const file_go_chromium_org_luci_buildbucket_proto_token_proto_rawDesc = "" +
	"\n" +
	"2go.chromium.org/luci/buildbucket/proto/token.proto\x12\x0ebuildbucket.v2\"\xdd\x01\n" +
	"\tTokenBody\x12\x19\n" +
	"\bbuild_id\x18\x01 \x01(\x03R\abuildId\x12;\n" +
	"\apurpose\x18\x02 \x01(\x0e2!.buildbucket.v2.TokenBody.PurposeR\apurpose\x12\x14\n" +
	"\x05state\x18\x03 \x01(\fR\x05state\"b\n" +
	"\aPurpose\x12\x17\n" +
	"\x13PURPOSE_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05BUILD\x10\x01\x12\f\n" +
	"\x04TASK\x10\x02\x1a\x02\b\x01\x12\x0f\n" +
	"\vSTART_BUILD\x10\x03\x12\x14\n" +
	"\x10START_BUILD_TASK\x10\x04\"\xbc\x01\n" +
	"\rTokenEnvelope\x12?\n" +
	"\aversion\x18\x01 \x01(\x0e2%.buildbucket.v2.TokenEnvelope.VersionR\aversion\x12\x18\n" +
	"\apayload\x18\x02 \x01(\fR\apayload\"P\n" +
	"\aVersion\x12\x17\n" +
	"\x13VERSION_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19UNENCRYPTED_PASSWORD_LIKE\x10\x01\x12\r\n" +
	"\tENCRYPTED\x10\x02B6Z4go.chromium.org/luci/buildbucket/proto;buildbucketpbb\x06proto3"
