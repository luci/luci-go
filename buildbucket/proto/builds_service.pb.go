...
var file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x19, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74,
	0x2e, 0x76, 0x32, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x52, 0x04, 0x6d,
	0x61, 0x73, 0x6b, 0x22, 0xea, 0x02, 0x0a, 0x09, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4d, 0x61, 0x73,
	...
	0x6e, 0x64, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x32, 0xa7, 0x04, 0x0a, 0x06, 0x42, 0x75,
	...
	0x69, 0x6c, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x62, 0x75, 0x69,
	0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x42, 0x75, 0x69, 0x6c,
	0x64, 0x22, 0x00, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69,
...
var file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_depIdxs = []int32{
	...
	29, // 40: buildbucket.v2.BuildMask.step_status:type_name -> buildbucket.v2.Status
	16, // 41: buildbucket.v2.BuildPredicate.builder:type_name -> buildbucket.v2.BuilderID
	29, // 42: buildbucket.v2.BuildPredicate.status:type_name -> buildbucket.v2.Status
	22, // 43: buildbucket.v2.BuildPredicate.gerrit_changes:type_name -> buildbucket.v2.GerritChange
	21, // 44: buildbucket.v2.BuildPredicate.output_gitiles_commit:type_name -> buildbucket.v2.GitilesCommit
	23, // 45: buildbucket.v2.BuildPredicate.tags:type_name -> buildbucket.v2.StringPair
	30, // 46: buildbucket.v2.BuildPredicate.create_time:type_name -> buildbucket.v2.TimeRange
	11, // 47: buildbucket.v2.BuildPredicate.build:type_name -> buildbucket.v2.BuildRange
	19, // 48: buildbucket.v2.BuildPredicate.canary:type_name -> buildbucket.v2.Trinary
	0,  // 49: buildbucket.v2.BatchRequest.Request.get_build:type_name -> buildbucket.v2.GetBuildRequest
	1,  // 50: buildbucket.v2.BatchRequest.Request.search_builds:type_name -> buildbucket.v2.SearchBuildsRequest
	6,  // 51: buildbucket.v2.BatchRequest.Request.schedule_build:type_name -> buildbucket.v2.ScheduleBuildRequest
	7,  // 52: buildbucket.v2.BatchRequest.Request.cancel_build:type_name -> buildbucket.v2.CancelBuildRequest
	18, // 53: buildbucket.v2.BatchResponse.Response.get_build:type_name -> buildbucket.v2.Build
	2,  // 54: buildbucket.v2.BatchResponse.Response.search_builds:type_name -> buildbucket.v2.SearchBuildsResponse
	18, // 55: buildbucket.v2.BatchResponse.Response.schedule_build:type_name -> buildbucket.v2.Build
	18, // 56: buildbucket.v2.BatchResponse.Response.cancel_build:type_name -> buildbucket.v2.Build
	31, // 57: buildbucket.v2.BatchResponse.Response.error:type_name -> google.rpc.Status
	0,  // 58: buildbucket.v2.Builds.GetBuild:input_type -> buildbucket.v2.GetBuildRequest
	1,  // 59: buildbucket.v2.Builds.SearchBuilds:input_type -> buildbucket.v2.SearchBuildsRequest
	5,  // 60: buildbucket.v2.Builds.UpdateBuild:input_type -> buildbucket.v2.UpdateBuildRequest
	6,  // 61: buildbucket.v2.Builds.ScheduleBuild:input_type -> buildbucket.v2.ScheduleBuildRequest
	7,  // 62: buildbucket.v2.Builds.CancelBuild:input_type -> buildbucket.v2.CancelBuildRequest
	3,  // 63: buildbucket.v2.Builds.Batch:input_type -> buildbucket.v2.BatchRequest
	8,  // 64: buildbucket.v2.Builds.CreateBuild:input_type -> buildbucket.v2.CreateBuildRequest
	18, // 65: buildbucket.v2.Builds.GetBuild:output_type -> buildbucket.v2.Build
	2,  // 66: buildbucket.v2.Builds.SearchBuilds:output_type -> buildbucket.v2.SearchBuildsResponse
	18, // 67: buildbucket.v2.Builds.UpdateBuild:output_type -> buildbucket.v2.Build
	18, // 68: buildbucket.v2.Builds.ScheduleBuild:output_type -> buildbucket.v2.Build
	18, // 69: buildbucket.v2.Builds.CancelBuild:output_type -> buildbucket.v2.Build
	4,  // 70: buildbucket.v2.Builds.Batch:output_type -> buildbucket.v2.BatchResponse
	18, // 71: buildbucket.v2.Builds.CreateBuild:output_type -> buildbucket.v2.Build
