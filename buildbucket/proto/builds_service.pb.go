...
// A request message for StartBuildTask RPC.
type StartBuildTaskRequest struct {
	...
	BuildId int64 `protobuf:"varint,2,opt,name=build_id,json=buildId,proto3" json:"build_id,omitempty"`
	// Task to be started and potentially registered to the build.
	// Task.Id is required.
	// Task.Link is required.
	// Task.Status is required.
	// Task.UpdateId is required.
	Task *Task `protobuf:"bytes,3,opt,name=task,proto3" json:"task,omitempty"`
}

func (x *StartBuildTaskRequest) Reset() {
	*x = StartBuildTaskRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartBuildTaskRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartBuildTaskRequest) ProtoMessage() {}

func (x *StartBuildTaskRequest) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartBuildTaskRequest.ProtoReflect.Descriptor instead.
func (*StartBuildTaskRequest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_rawDescGZIP(), []int{16}
}

func (x *StartBuildTaskRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *StartBuildTaskRequest) GetBuildId() int64 {
	if x != nil {
		return x.BuildId
	}
	return 0
...
func (x *StartBuildTaskRequest) GetTask() *Task {
	if x != nil {
		return x.Task
	}
	return nil
...
// A response message for StartBuildTask RPC.
type StartBuildTaskResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Secrets contains key material for clients to call StartBuild.
	Secrets *BuildSecrets `protobuf:"bytes,1,opt,name=secrets,proto3" json:"secrets,omitempty"`
	// The pubsub topic that the backend will use to send
	// BuildTaskUpdate messages to buildbucket. It is set by buildbucket using
	// service_config and the current buildbucket host.
	// If the backend has ServiceConfig.BackendSetting.SupportsTaskUpdates set to
	// false, then this field will always be nil.
	PubsubTopic string `protobuf:"bytes,2,opt,name=pubsub_topic,json=pubsubTopic,proto3" json:"pubsub_topic,omitempty"`
}

func (x *StartBuildTaskResponse) Reset() {
	*x = StartBuildTaskResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartBuildTaskResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartBuildTaskResponse) ProtoMessage() {}

func (x *StartBuildTaskResponse) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartBuildTaskResponse.ProtoReflect.Descriptor instead.
func (*StartBuildTaskResponse) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_rawDescGZIP(), []int{17}
}

func (x *StartBuildTaskResponse) GetSecrets() *BuildSecrets {
	if x != nil {
		return x.Secrets
	}
	return nil
...
func (x *StartBuildTaskResponse) GetPubsubTopic() string {
	if x != nil {
...
var file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_rawDesc = []byte{
	...
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x35, 0x67,
	...
	0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65,
	0x74, 0x2e, 0x76, 0x32, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x52, 0x04,
	0x6d, 0x61, 0x73, 0x6b, 0x22, 0xbd, 0x0c, 0x0a, 0x14, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	0x49, 0x6e, 0x70, 0x75, 0x74, 0x1a, 0x3e, 0x0a, 0x10, 0x45, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d,
	...
	0x52, 0x75, 0x6e, 0x49, 0x64, 0x1a, 0x0d, 0x0a, 0x0b, 0x53, 0x68, 0x61, 0x64, 0x6f, 0x77, 0x49,
	0x6e, 0x70, 0x75, 0x74, 0x22, 0xb6, 0x01, 0x0a, 0x12, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x42,
	0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x73,
	...
	0x72, 0x6b, 0x64, 0x6f, 0x77, 0x6e, 0x12, 0x36, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73,
	...
	,
	...
	0x12, 0x59, 0x0a, 0x0b, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63,
	0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x79, 0x6e, 0x74, 0x68, 0x65, 0x73, 0x69, 0x7a,
	0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x45, 0x78,
	...
	0x6c, 0x64, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b,
	0x49, 0x64, 0x22, 0x6f, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x72, 0x74, 0x42, 0x75, 0x69, 0x6c, 0x64,
	...
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x12, 0x2c, 0x0a, 0x12, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f,
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x10, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x22, 0x7f, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x33, 0x0a, 0x07,
	...
	0x72, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65,
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x4e, 0x75,
	0x6d, 0x62, 0x65, 0x72, 0x22, 0xea, 0x02, 0x0a, 0x09, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4d, 0x61,
	0x73, 0x6b, 0x12, 0x32, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x52, 0x06,
	0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x12, 0x41, 0x0a, 0x10, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x5f,
	...
	,
	...
	0x73, 0x22, 0x90, 0x05, 0x0a, 0x0e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x50, 0x72, 0x65, 0x64, 0x69,
	0x63, 0x61, 0x74, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63,
	0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x49, 0x44,
	0x52, 0x07, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x06, 0x73, 0x74, 0x61,
	...
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x43, 0x0a, 0x0e, 0x67, 0x65, 0x72,
	0x72, 0x69, 0x74, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	...
	0x0d, 0x67, 0x65, 0x72, 0x72, 0x69, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x12, 0x51,
	0x0a, 0x15, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x67, 0x69, 0x74, 0x69, 0x6c, 0x65, 0x73,
	0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e,
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x47,
	0x69, 0x74, 0x69, 0x6c, 0x65, 0x73, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x52, 0x13, 0x6f, 0x75,
	0x74, 0x70, 0x75, 0x74, 0x47, 0x69, 0x74, 0x69, 0x6c, 0x65, 0x73, 0x43, 0x6f, 0x6d, 0x6d, 0x69,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x00, 0x12, 0x61, 0x0a, 0x0e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x42, 0x75, 0x69, 0x6c,
	0x64, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x25, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63,
	0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x42, 0x75, 0x69, 0x6c,
	0x64, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x62,
	0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x74,
	0x61, 0x72, 0x74, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73, 0x70,
...
var file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_goTypes = []interface{}{
	...
	(*StartBuildTaskRequest)(nil),            // 16: buildbucket.v2.StartBuildTaskRequest
	(*StartBuildTaskResponse)(nil),           // 17: buildbucket.v2.StartBuildTaskResponse
	...
	(*BuildSecrets)(nil),                     // 40: buildbucket.v2.BuildSecrets
...
var file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_depIdxs = []int32{
	...
	39, // 55: buildbucket.v2.StartBuildTaskRequest.task:type_name -> buildbucket.v2.Task
	40, // 56: buildbucket.v2.StartBuildTaskResponse.secrets:type_name -> buildbucket.v2.BuildSecrets
	0,  // 57: buildbucket.v2.BatchRequest.Request.get_build:type_name -> buildbucket.v2.GetBuildRequest
	1,  // 58: buildbucket.v2.BatchRequest.Request.search_builds:type_name -> buildbucket.v2.SearchBuildsRequest
	6,  // 59: buildbucket.v2.BatchRequest.Request.schedule_build:type_name -> buildbucket.v2.ScheduleBuildRequest
	7,  // 60: buildbucket.v2.BatchRequest.Request.cancel_build:type_name -> buildbucket.v2.CancelBuildRequest
	12, // 61: buildbucket.v2.BatchRequest.Request.get_build_status:type_name -> buildbucket.v2.GetBuildStatusRequest
	26, // 62: buildbucket.v2.BatchResponse.Response.get_build:type_name -> buildbucket.v2.Build
	2,  // 63: buildbucket.v2.BatchResponse.Response.search_builds:type_name -> buildbucket.v2.SearchBuildsResponse
	26, // 64: buildbucket.v2.BatchResponse.Response.schedule_build:type_name -> buildbucket.v2.Build
	26, // 65: buildbucket.v2.BatchResponse.Response.cancel_build:type_name -> buildbucket.v2.Build
	26, // 66: buildbucket.v2.BatchResponse.Response.get_build_status:type_name -> buildbucket.v2.Build
	41, // 67: buildbucket.v2.BatchResponse.Response.error:type_name -> google.rpc.Status
	0,  // 68: buildbucket.v2.Builds.GetBuild:input_type -> buildbucket.v2.GetBuildRequest
	1,  // 69: buildbucket.v2.Builds.SearchBuilds:input_type -> buildbucket.v2.SearchBuildsRequest
	5,  // 70: buildbucket.v2.Builds.UpdateBuild:input_type -> buildbucket.v2.UpdateBuildRequest
	6,  // 71: buildbucket.v2.Builds.ScheduleBuild:input_type -> buildbucket.v2.ScheduleBuildRequest
	7,  // 72: buildbucket.v2.Builds.CancelBuild:input_type -> buildbucket.v2.CancelBuildRequest
	3,  // 73: buildbucket.v2.Builds.Batch:input_type -> buildbucket.v2.BatchRequest
	8,  // 74: buildbucket.v2.Builds.CreateBuild:input_type -> buildbucket.v2.CreateBuildRequest
	9,  // 75: buildbucket.v2.Builds.SynthesizeBuild:input_type -> buildbucket.v2.SynthesizeBuildRequest
	12, // 76: buildbucket.v2.Builds.GetBuildStatus:input_type -> buildbucket.v2.GetBuildStatusRequest
	10, // 77: buildbucket.v2.Builds.StartBuild:input_type -> buildbucket.v2.StartBuildRequest
	16, // 78: buildbucket.v2.Builds.StartBuildTask:input_type -> buildbucket.v2.StartBuildTaskRequest
	...
	17, // 89: buildbucket.v2.Builds.StartBuildTask:output_type -> buildbucket.v2.StartBuildTaskResponse
...
func file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartBuildTaskRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartBuildTaskResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type BuildsClient interface {
	...
	// A backend is requred to call StartBuildTask since the StartBuildToken is
	// returned in StartBuildTaskResponse. StartBuildTask can be called as soon as
	// the backend has received the StartBuildTaskToken (from RunTaskRequest).
	//
	// StartBuildTask starts a TaskBackend task and registers it to the build it
	// runs if the task returned by RunTaskResponse has not been registered yet.
	// The task in StartBuildTaskRequest.Task and RunTaskResponse.Task must be
	// identical.
	//
	// RPC metadata must include "x-buildbucket-token" key with a
	// START_BUILD_TASK token generated by the server when it called RunTask
	// on the backend.
	StartBuildTask(ctx context.Context, in *StartBuildTaskRequest, opts ...grpc.CallOption) (*StartBuildTaskResponse, error)
}
...
func (c *buildsPRPCClient) StartBuildTask(ctx context.Context, in *StartBuildTaskRequest, opts ...grpc.CallOption) (*StartBuildTaskResponse, error) {
	out := new(StartBuildTaskResponse)
	err := c.client.Call(ctx, "buildbucket.v2.Builds", "StartBuildTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildsClient) StartBuildTask(ctx context.Context, in *StartBuildTaskRequest, opts ...grpc.CallOption) (*StartBuildTaskResponse, error) {
	out := new(StartBuildTaskResponse)
	err := c.cc.Invoke(ctx, "/buildbucket.v2.Builds/StartBuildTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BuildsServer interface {
	...
	// START_BUILD_TASK token generated by the server when it called RunTask
	// on the backend.
	StartBuildTask(context.Context, *StartBuildTaskRequest) (*StartBuildTaskResponse, error)
}
...
func (*UnimplementedBuildsServer) StartBuildTask(context.Context, *StartBuildTaskRequest) (*StartBuildTaskResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method StartBuildTask not implemented")
}
...
func _Builds_StartBuildTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartBuildTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BuildsServer).StartBuildTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/buildbucket.v2.Builds/StartBuildTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BuildsServer).StartBuildTask(ctx, req.(*StartBuildTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Builds_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StartBuildTask",
			Handler:    _Builds_StartBuildTask_Handler,
		},
	},
