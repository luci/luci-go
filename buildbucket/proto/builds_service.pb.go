...
type ScheduleBuildRequest struct {
	...
	// If set, overrides the default `execution_timeout_secs` set in build config.
	// Only supports seconds precision for now.
...
var file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x64, 0x73, 0x22, 0xd1, 0x09, 0x0a, 0x14, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	0x6e, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x3e, 0x0a, 0x10, 0x45, 0x78, 0x70, 0x65,
	...
	0x65, 0x6e, 0x74, 0x52, 0x75, 0x6e, 0x49, 0x64, 0x22, 0x83, 0x01, 0x0a, 0x12, 0x43, 0x61, 0x6e,
	...
	0x72, 0x79, 0x4d, 0x61, 0x72, 0x6b, 0x64, 0x6f, 0x77, 0x6e, 0x12, 0x32, 0x0a, 0x06, 0x66, 0x69,
	0x65, 0x6c, 0x64, 0x73, 0x18, 0x64, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x65,
	0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0xd0,
	0x04, 0x0a, 0x0e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74,
	...
	0x73, 0x22, 0x54, 0x0a, 0x0a, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12,
...
var file_go_chromium_org_luci_buildbucket_proto_builds_service_proto_depIdxs = []int32{
	...
	15, // 26: buildbucket.v2.CancelBuildRequest.fields:type_name -> google.protobuf.FieldMask
	14, // 27: buildbucket.v2.BuildPredicate.builder:type_name -> buildbucket.v2.BuilderID
	26, // 28: buildbucket.v2.BuildPredicate.status:type_name -> buildbucket.v2.Status
	20, // 29: buildbucket.v2.BuildPredicate.gerrit_changes:type_name -> buildbucket.v2.GerritChange
	19, // 30: buildbucket.v2.BuildPredicate.output_gitiles_commit:type_name -> buildbucket.v2.GitilesCommit
	21, // 31: buildbucket.v2.BuildPredicate.tags:type_name -> buildbucket.v2.StringPair
	27, // 32: buildbucket.v2.BuildPredicate.create_time:type_name -> buildbucket.v2.TimeRange
	9,  // 33: buildbucket.v2.BuildPredicate.build:type_name -> buildbucket.v2.BuildRange
	17, // 34: buildbucket.v2.BuildPredicate.canary:type_name -> buildbucket.v2.Trinary
	0,  // 35: buildbucket.v2.BatchRequest.Request.get_build:type_name -> buildbucket.v2.GetBuildRequest
	1,  // 36: buildbucket.v2.BatchRequest.Request.search_builds:type_name -> buildbucket.v2.SearchBuildsRequest
	6,  // 37: buildbucket.v2.BatchRequest.Request.schedule_build:type_name -> buildbucket.v2.ScheduleBuildRequest
	7,  // 38: buildbucket.v2.BatchRequest.Request.cancel_build:type_name -> buildbucket.v2.CancelBuildRequest
	16, // 39: buildbucket.v2.BatchResponse.Response.get_build:type_name -> buildbucket.v2.Build
	2,  // 40: buildbucket.v2.BatchResponse.Response.search_builds:type_name -> buildbucket.v2.SearchBuildsResponse
	16, // 41: buildbucket.v2.BatchResponse.Response.schedule_build:type_name -> buildbucket.v2.Build
	16, // 42: buildbucket.v2.BatchResponse.Response.cancel_build:type_name -> buildbucket.v2.Build
	28, // 43: buildbucket.v2.BatchResponse.Response.error:type_name -> google.rpc.Status
	0,  // 44: buildbucket.v2.Builds.GetBuild:input_type -> buildbucket.v2.GetBuildRequest
	1,  // 45: buildbucket.v2.Builds.SearchBuilds:input_type -> buildbucket.v2.SearchBuildsRequest
	5,  // 46: buildbucket.v2.Builds.UpdateBuild:input_type -> buildbucket.v2.UpdateBuildRequest
	6,  // 47: buildbucket.v2.Builds.ScheduleBuild:input_type -> buildbucket.v2.ScheduleBuildRequest
	7,  // 48: buildbucket.v2.Builds.CancelBuild:input_type -> buildbucket.v2.CancelBuildRequest
	3,  // 49: buildbucket.v2.Builds.Batch:input_type -> buildbucket.v2.BatchRequest
	16, // 50: buildbucket.v2.Builds.GetBuild:output_type -> buildbucket.v2.Build
	2,  // 51: buildbucket.v2.Builds.SearchBuilds:output_type -> buildbucket.v2.SearchBuildsResponse
	16, // 52: buildbucket.v2.Builds.UpdateBuild:output_type -> buildbucket.v2.Build
	16, // 53: buildbucket.v2.Builds.ScheduleBuild:output_type -> buildbucket.v2.Build
	16, // 54: buildbucket.v2.Builds.CancelBuild:output_type -> buildbucket.v2.Build
	4,  // 55: buildbucket.v2.Builds.Batch:output_type -> buildbucket.v2.BatchResponse
...
type BuildsClient interface {
	...
	// predicate is a CL.
	// Cannot search in a buildbot bucket or builder via predicate.builder field.
