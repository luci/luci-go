...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_rawDesc = []byte{
	...
	0x0b, 0x22, 0xb3, 0x01, 0x0a, 0x08, 0x53, 0x77, 0x61, 0x72, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x30,
	...
	0x03, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0x90, 0x01, 0x0a, 0x06, 0x42, 0x75, 0x63, 0x6b,
	...
	0x65, 0x74, 0x2e, 0x41, 0x63, 0x6c, 0x52, 0x04, 0x61, 0x63, 0x6c, 0x73, 0x12, 0x19, 0x0a, 0x08,
	0x61, 0x63, 0x6c, 0x5f, 0x73, 0x65, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07,
	0x61, 0x63, 0x6c, 0x53, 0x65, 0x74, 0x73, 0x12, 0x31, 0x0a, 0x08, 0x73, 0x77, 0x61, 0x72, 0x6d,
	0x69, 0x6e, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x62, 0x75, 0x69, 0x6c,
	0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x53, 0x77, 0x61, 0x72, 0x6d, 0x69, 0x6e, 0x67,
	0x52, 0x08, 0x73, 0x77, 0x61, 0x72, 0x6d, 0x69, 0x6e, 0x67, 0x22, 0x75, 0x0a, 0x0e, 0x42, 0x75,
	...
	0x65, 0x74, 0x52, 0x07, 0x61, 0x63, 0x6c, 0x53, 0x65, 0x74, 0x73, 0x4a, 0x04, 0x08, 0x03, 0x10,
	0x04, 0x2a, 0x24, 0x0a, 0x06, 0x54, 0x6f, 0x67, 0x67, 0x6c, 0x65, 0x12, 0x09, 0x0a, 0x05, 0x55,
...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_depIdxs = []int32{
	...
	4,  // 16: buildbucket.Swarming.builders:type_name -> buildbucket.Builder
	16, // 17: buildbucket.Swarming.task_template_canary_percentage:type_name -> google.protobuf.UInt32Value
	2,  // 18: buildbucket.Bucket.acls:type_name -> buildbucket.Acl
	5,  // 19: buildbucket.Bucket.swarming:type_name -> buildbucket.Swarming
	6,  // 20: buildbucket.BuildbucketCfg.buckets:type_name -> buildbucket.Bucket
	3,  // 21: buildbucket.BuildbucketCfg.acl_sets:type_name -> buildbucket.AclSet
	17, // 22: buildbucket.Builder.ResultDB.bq_exports:type_name -> luci.resultdb.v1.BigQueryExport
	18, // 23: buildbucket.Builder.ResultDB.history_options:type_name -> luci.resultdb.v1.HistoryOptions
