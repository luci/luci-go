...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_rawDesc = []byte{
	...
	0x06, 0x57, 0x52, 0x49, 0x54, 0x45, 0x52, 0x10, 0x02, 0x22, 0xd9, 0x11, 0x0a, 0x0d, 0x42, 0x75,
	...
	0x38, 0x01, 0x1a, 0x57, 0x0a, 0x18, 0x53, 0x68, 0x61, 0x64, 0x6f, 0x77, 0x42, 0x75, 0x69, 0x6c,
	0x64, 0x65, 0x72, 0x41, 0x64, 0x6a, 0x75, 0x73, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x27,
	...
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6f, 0x6c, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6f, 0x6c, 0x4a, 0x04, 0x08, 0x08, 0x10,
...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_depIdxs = []int32{
	...
	3,  // 16: buildbucket.Swarming.builders:type_name -> buildbucket.BuilderConfig
	20, // 17: buildbucket.Swarming.task_template_canary_percentage:type_name -> google.protobuf.UInt32Value
	2,  // 18: buildbucket.Bucket.acls:type_name -> buildbucket.Acl
	4,  // 19: buildbucket.Bucket.swarming:type_name -> buildbucket.Swarming
	13, // 20: buildbucket.Bucket.constraints:type_name -> buildbucket.Bucket.Constraints
	14, // 21: buildbucket.Bucket.dynamic_builder_template:type_name -> buildbucket.Bucket.DynamicBuilderTemplate
	5,  // 22: buildbucket.BuildbucketCfg.buckets:type_name -> buildbucket.Bucket
	16, // 23: buildbucket.BuildbucketCfg.common_config:type_name -> buildbucket.BuildbucketCfg.CommonConfig
	21, // 24: buildbucket.BuilderConfig.ResultDB.bq_exports:type_name -> luci.resultdb.v1.BigQueryExport
	22, // 25: buildbucket.BuilderConfig.ResultDB.history_options:type_name -> luci.resultdb.v1.HistoryOptions
	23, // 26: buildbucket.BuildbucketCfg.Topic.compression:type_name -> buildbucket.v2.Compression
	15, // 27: buildbucket.BuildbucketCfg.CommonConfig.builds_notification_topics:type_name -> buildbucket.BuildbucketCfg.Topic
