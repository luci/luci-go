...
// Prerequisite reading in Build.CacheEntry message in build.proto.
//
...
type Builder_CacheEntry struct {
	...
	// See also Build.CacheEntry.name in build.proto.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Relative path where the cache in mapped into. Required.
	// See also Build.CacheEntry.path in build.proto.
	...
	// See also Build.CacheEntry.wait_for_warm_cache in build.proto.
