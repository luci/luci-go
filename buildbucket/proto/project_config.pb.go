...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_rawDesc = []byte{
	...
	0x06, 0x57, 0x52, 0x49, 0x54, 0x45, 0x52, 0x10, 0x02, 0x22, 0x90, 0x12, 0x0a, 0x0d, 0x42, 0x75,
	...
	0x65, 0x74, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x1a, 0x85, 0x01, 0x0a, 0x0a, 0x43, 0x61, 0x63,
	...
	0x6f, 0x6c, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x4a, 0x04, 0x08, 0x0b, 0x10, 0x0c, 0x4a, 0x04,
...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_goTypes = []interface{}{
	...
	(*Bucket_DynamicBuilderTemplate)(nil),          // 14: buildbucket.Bucket.DynamicBuilderTemplate
	(*BuildbucketCfg_Topic)(nil),                   // 15: buildbucket.BuildbucketCfg.Topic
	(*BuildbucketCfg_CommonConfig)(nil),            // 16: buildbucket.BuildbucketCfg.CommonConfig
	...
	(*v1.BigQueryExport)(nil),                      // 21: luci.resultdb.v1.BigQueryExport
	(*v1.HistoryOptions)(nil),                      // 22: luci.resultdb.v1.HistoryOptions
	(Compression)(0),                               // 23: buildbucket.v2.Compression
}
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_depIdxs = []int32{
	...
	17, // 4: buildbucket.BuilderConfig.exe:type_name -> buildbucket.v2.Executable
	18, // 5: buildbucket.BuilderConfig.grace_period:type_name -> google.protobuf.Duration
	19, // 6: buildbucket.BuilderConfig.wait_for_capacity:type_name -> buildbucket.v2.Trinary
	...
	20, // 11: buildbucket.BuilderConfig.task_template_canary_percentage:type_name -> google.protobuf.UInt32Value
	11, // 12: buildbucket.BuilderConfig.experiments:type_name -> buildbucket.BuilderConfig.ExperimentsEntry
	19, // 13: buildbucket.BuilderConfig.critical:type_name -> buildbucket.v2.Trinary
	...
	19, // 16: buildbucket.BuilderConfig.retriable:type_name -> buildbucket.v2.Trinary
	3,  // 17: buildbucket.Swarming.builders:type_name -> buildbucket.BuilderConfig
	20, // 18: buildbucket.Swarming.task_template_canary_percentage:type_name -> google.protobuf.UInt32Value
	2,  // 19: buildbucket.Bucket.acls:type_name -> buildbucket.Acl
	4,  // 20: buildbucket.Bucket.swarming:type_name -> buildbucket.Swarming
	13, // 21: buildbucket.Bucket.constraints:type_name -> buildbucket.Bucket.Constraints
	14, // 22: buildbucket.Bucket.dynamic_builder_template:type_name -> buildbucket.Bucket.DynamicBuilderTemplate
	5,  // 23: buildbucket.BuildbucketCfg.buckets:type_name -> buildbucket.Bucket
	16, // 24: buildbucket.BuildbucketCfg.common_config:type_name -> buildbucket.BuildbucketCfg.CommonConfig
	21, // 25: buildbucket.BuilderConfig.ResultDB.bq_exports:type_name -> luci.resultdb.v1.BigQueryExport
	22, // 26: buildbucket.BuilderConfig.ResultDB.history_options:type_name -> luci.resultdb.v1.HistoryOptions
	23, // 27: buildbucket.BuildbucketCfg.Topic.compression:type_name -> buildbucket.v2.Compression
	15, // 28: buildbucket.BuildbucketCfg.CommonConfig.builds_notification_topics:type_name -> buildbucket.BuildbucketCfg.Topic
