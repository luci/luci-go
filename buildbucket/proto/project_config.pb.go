...
type Builder struct {
	...
	// Deprecated; Synonym of canary_percentage. If both are set,
	// canary_percentage is used without evaluating this.
	...
	// Percentage of builds that should use canary_options.
	//
	// A value from 0 to 100.
	//
	// If omitted, a global server-defined default percentage is used.
	CanaryPercentage *wrappers.UInt32Value `protobuf:"bytes,27,opt,name=canary_percentage,json=canaryPercentage,proto3" json:"canary_percentage,omitempty"`
	// If the build is selected for canary, apply these options.
	//
	// See CanaryOptions for details.
	CanaryOptions *CanaryOptions `protobuf:"bytes,28,opt,name=canary_options,json=canaryOptions,proto3" json:"canary_options,omitempty"`
...
func (m *Builder) GetCanaryPercentage() *wrappers.UInt32Value {
	if m != nil {
...
func (m *Builder) GetCanaryOptions() *CanaryOptions {
	if m != nil {
		return m.CanaryOptions
	}
	return nil
}
...
func (m *Builder) GetResultdb() *Builder_ResultDB {
	if m != nil {
		return m.Resultdb
	}
	return nil
...
func (m *Builder_ResultDB) Reset()         { *m = Builder_ResultDB{} }
func (m *Builder_ResultDB) String() string { return proto.CompactTextString(m) }
func (*Builder_ResultDB) ProtoMessage()    {}
func (*Builder_ResultDB) Descriptor() ([]byte, []int) {
	return fileDescriptor_b55b0c6e36fe7713, []int{2, 2}
}

func (m *Builder_ResultDB) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Builder_ResultDB.Unmarshal(m, b)
}
func (m *Builder_ResultDB) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Builder_ResultDB.Marshal(b, m, deterministic)
}
func (m *Builder_ResultDB) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Builder_ResultDB.Merge(m, src)
}
func (m *Builder_ResultDB) XXX_Size() int {
	return xxx_messageInfo_Builder_ResultDB.Size(m)
}
func (m *Builder_ResultDB) XXX_DiscardUnknown() {
	xxx_messageInfo_Builder_ResultDB.DiscardUnknown(m)
}

var xxx_messageInfo_Builder_ResultDB proto.InternalMessageInfo

func (m *Builder_ResultDB) GetEnable() bool {
	if m != nil {
		return m.Enable
	}
	return false
...
func (m *Builder_ResultDB) GetBqExports() []*v1.BigQueryExport {
	if m != nil {
		return m.BqExports
	}
	return nil
...
// Canary selection works as follows:
//
// When a build is created it is assigned a 'canary' status from the following
// sources, in order of precedence:
//   * The ScheduleBuildRequest.canary field
//   * A random boolean with a probability of either:
//     * The Builder's configured canary_percentage (if set), OR
//     * The global canary chance (currently 10%).
//
// Once a build is assigned canary=true, the following options apply as
// documented.
type CanaryOptions struct {
	// If UNSET or YES, this canary build will use the 'canary_version' channel of
	// all packages listed in buildbucket's settings.cfg. This includes versions
	// of packages like 'python', 'git', 'vpython', etc.
	//
	// If NO, then this canary build will use the stable channel of those
	// packages.
	SwarmingPackages Trinary `protobuf:"varint,1,opt,name=swarming_packages,json=swarmingPackages,proto3,enum=buildbucket.v2.Trinary" json:"swarming_packages,omitempty"`
	// Has no effect if 'Builder.exe.cmd' is set.
	//
	// If YES, this canary build will use the the new luciexe protocol
	// (i.e. go.chromium.org/luci/luciexe).
	//
	// If NO, this canary build will use the old kitchen protocol.
	//
	// If UNSET, this canary build will use the current global default (currently
	// kitchen, but this will change over the course of 2020Q2).
	UseBbagent           Trinary  `protobuf:"varint,2,opt,name=use_bbagent,json=useBbagent,proto3,enum=buildbucket.v2.Trinary" json:"use_bbagent,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *CanaryOptions) Reset()         { *m = CanaryOptions{} }
func (m *CanaryOptions) String() string { return proto.CompactTextString(m) }
func (*CanaryOptions) ProtoMessage()    {}
func (*CanaryOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_b55b0c6e36fe7713, []int{3}
}

func (m *CanaryOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CanaryOptions.Unmarshal(m, b)
}
func (m *CanaryOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CanaryOptions.Marshal(b, m, deterministic)
}
func (m *CanaryOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CanaryOptions.Merge(m, src)
}
func (m *CanaryOptions) XXX_Size() int {
	return xxx_messageInfo_CanaryOptions.Size(m)
}
func (m *CanaryOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_CanaryOptions.DiscardUnknown(m)
}

var xxx_messageInfo_CanaryOptions proto.InternalMessageInfo

func (m *CanaryOptions) GetSwarmingPackages() Trinary {
	if m != nil {
		return m.SwarmingPackages
	}
	return Trinary_UNSET
}

func (m *CanaryOptions) GetUseBbagent() Trinary {
	if m != nil {
		return m.UseBbagent
	}
	return Trinary_UNSET
...
func (*BuildbucketCfg) Descriptor() ([]byte, []int) {
	return fileDescriptor_b55b0c6e36fe7713, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*Builder_ResultDB)(nil), "buildbucket.Builder.ResultDB")
	proto.RegisterType((*CanaryOptions)(nil), "buildbucket.CanaryOptions")
...
var fileDescriptor_b55b0c6e36fe7713 = []byte{
	...
	,
}
