...
type Builder struct {
	...
	// DEPRECATED
	//
	// If YES, sets the "luci.buildbucket.non_production" experiment to 100% for
	// builds on this builder.
	//
	// This is useful for inherently experimental builds that use production
	// recipes, but should not affect production resources (e.g. should not upload
	// to official output locations).
	//
	// This maps to the "recipe_engine/runtime".is_experimental boolean in
	// recipes.
	...
	// DEPRECATED
	//
	// Set the "luci.buildbucket.canary_software" experiment instead.
	//
	...
	// apply to builds from this builder.
	//
	...
	// targets. For example, prefer the experiment named "use_mysoftware_v2"
	// rather than "next_gen".
	//
	...
	// its own experiment. However in practice we don't usually have more than one
	// piece of software in canary at the same time. If we were designing this
	// today, we would likely lean towards individual package control.
	//
	// "luci.buildbucket.non_production"  (default 0%)
	...
	//
	// You SHOULD program your builds to respond to this expirement.
	//
	// Maps to the "recipe_engine/runtime".is_experimental flag in recipes.
	//
	// "luci.buildbucket.use_bbagent"  (default 0%)
	// Builds with this experiment will use the new 'luciexe' based protocol,
	// rather than the deprecated '@@@annotation@@@' protocol.
	Experiments map[string]uint32 `protobuf:"bytes,27,rep,name=experiments,proto3" json:"experiments,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
func (x *Builder) GetLuciMigrationHost() string {
	if x != nil {
		return x.LuciMigrationHost
	}
	return ""
}
...
func (x *Builder) GetExperiments() map[string]uint32 {
	if x != nil {
...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x70, 0x63, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x76,
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x01,
	0x0a, 0x03, 0x41, 0x63, 0x6c, 0x12, 0x29, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65,
	0x74, 0x2e, 0x41, 0x63, 0x6c, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65,
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x12, 0x47, 0x0a, 0x0b, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69,
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x1b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x62, 0x75,
	0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65,
	0x72, 0x2e, 0x45, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x52, 0x0b, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12,
	0x33, 0x0a, 0x08, 0x63, 0x72, 0x69, 0x74, 0x69, 0x63, 0x61, 0x6c, 0x18, 0x19, 0x20, 0x01, 0x28,
	...
	0x69, 0x63, 0x61, 0x6c, 0x12, 0x39, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62,
	0x18, 0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75,
	0x63, 0x6b, 0x65, 0x74, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x44, 0x42, 0x52, 0x08, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x64, 0x62, 0x1a,
	...
	0x04, 0x08, 0x01, 0x10, 0x02, 0x1a, 0x67, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x44,
	0x42, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x43, 0x0a, 0x0a, 0x62, 0x71, 0x5f,
	...
	,
	...
	0x1d, 0x0a, 0x0a, 0x75, 0x72, 0x6c, 0x5f, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x75, 0x72, 0x6c, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x3f,
	0x0a, 0x10, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x5f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c,
	0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64,
	0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x52, 0x0f,
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x12,
	0x30, 0x0a, 0x08, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	...
	,
	...
	,
	...
	0x63, 0x6b, 0x65, 0x74, 0x70, 0x62, 0xa2, 0xfe, 0x23, 0x42, 0x0a, 0x40, 0x68, 0x74, 0x74, 0x70,
	...
	0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x63, 0x66, 0x67, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_goTypes = []interface{}{
	...
	(*v1.BigQueryExport)(nil),    // 15: luci.resultdb.rpc.v1.BigQueryExport
}
var file_go_chromium_org_luci_buildbucket_proto_project_config_proto_depIdxs = []int32{
	...
	8,  // 4: buildbucket.Builder.caches:type_name -> buildbucket.Builder.CacheEntry
	0,  // 5: buildbucket.Builder.build_numbers:type_name -> buildbucket.Toggle
	0,  // 6: buildbucket.Builder.auto_builder_dimension:type_name -> buildbucket.Toggle
	0,  // 7: buildbucket.Builder.experimental:type_name -> buildbucket.Toggle
	13, // 8: buildbucket.Builder.task_template_canary_percentage:type_name -> google.protobuf.UInt32Value
	11, // 9: buildbucket.Builder.experiments:type_name -> buildbucket.Builder.ExperimentsEntry
	14, // 10: buildbucket.Builder.critical:type_name -> buildbucket.v2.Trinary
	10, // 11: buildbucket.Builder.resultdb:type_name -> buildbucket.Builder.ResultDB
	4,  // 12: buildbucket.Swarming.builder_defaults:type_name -> buildbucket.Builder
	4,  // 13: buildbucket.Swarming.builders:type_name -> buildbucket.Builder
	13, // 14: buildbucket.Swarming.task_template_canary_percentage:type_name -> google.protobuf.UInt32Value
	2,  // 15: buildbucket.Bucket.acls:type_name -> buildbucket.Acl
	5,  // 16: buildbucket.Bucket.swarming:type_name -> buildbucket.Swarming
	6,  // 17: buildbucket.BuildbucketCfg.buckets:type_name -> buildbucket.Bucket
	3,  // 18: buildbucket.BuildbucketCfg.acl_sets:type_name -> buildbucket.AclSet
	4,  // 19: buildbucket.BuildbucketCfg.builder_mixins:type_name -> buildbucket.Builder
	15, // 20: buildbucket.Builder.ResultDB.bq_exports:type_name -> luci.resultdb.rpc.v1.BigQueryExport
