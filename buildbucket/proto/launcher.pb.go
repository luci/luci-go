...
func (*BuildSecrets) Descriptor() ([]byte, []int) {
	return fileDescriptor_launcher_671e4bc8a7aac8c7, []int{0}
}
...
func (dst *BuildSecrets) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BuildSecrets.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/launcher.proto", fileDescriptor_launcher_671e4bc8a7aac8c7)
}

var fileDescriptor_launcher_671e4bc8a7aac8c7 = []byte{
