...
type RunnerArgs struct {
	...
	// Git auth is used for all hosts that reply with HTTP 401 or 403 to a request
	// without credentials AND on all hosts mentioned here.
	// Not specifying a host here means requests to public hosts are sent
	// anonymously and may hit Git quota very fast.
