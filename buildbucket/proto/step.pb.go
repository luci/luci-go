...
type Step_MergeBuild struct {
	...
	// ['a', 'b'] path.
	//
	// It is STRONGLY RECOMMENDED not to merge into [""] - This creates
	// composability issues and increases the liklihood of unintentional
...
func file_go_chromium_org_luci_buildbucket_proto_step_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_buildbucket_proto_step_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Step); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_buildbucket_proto_step_proto_msgTypes[1].Exporter = func(v any, i int) any {
