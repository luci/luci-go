...
func (*Step) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_8f0285536a610a2b, []int{0}
}
...
func (*Step_Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_8f0285536a610a2b, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/step.proto", fileDescriptor_step_8f0285536a610a2b)
}

var fileDescriptor_step_8f0285536a610a2b = []byte{
