...
type Step struct {
	...
	// children,
	// where parent-child relationship is defined by name (see its comment)
	// and "better" is defined by the following order, from good to bad:
	//   SUCCESS
	//   FAILURE
	//   INFRA_FAILURE
	// Note that this defines "better" relationship only for some statuses.
...
func (*Step) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_d8b618f32bdc20c7, []int{0}
}
...
func (*Step_Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_d8b618f32bdc20c7, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/step.proto", fileDescriptor_step_d8b618f32bdc20c7)
}

var fileDescriptor_step_d8b618f32bdc20c7 = []byte{
