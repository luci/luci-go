...
type Step struct {
	...
	// children,
	// where parent-child relationship is defined by name
	// (see its comment)
...
func (*Step) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_da7497e8a4d2c5c7, []int{0}
}
...
func (*Step_Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_da7497e8a4d2c5c7, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/step.proto", fileDescriptor_step_da7497e8a4d2c5c7)
}

var fileDescriptor_step_da7497e8a4d2c5c7 = []byte{
