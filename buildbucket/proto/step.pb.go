...
type Step struct {
	...
	//
	// MUST NOT be after start_time of the parent.
...
func (*Step) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_3625f0b0cd34f7c2, []int{0}
}
...
func (*Step_Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_3625f0b0cd34f7c2, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/step.proto", fileDescriptor_step_3625f0b0cd34f7c2)
}

var fileDescriptor_step_3625f0b0cd34f7c2 = []byte{
