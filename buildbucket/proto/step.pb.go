...
func (*Step) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_8c3054b458309010, []int{0}
}
...
func (*Step_Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_8c3054b458309010, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/step.proto", fileDescriptor_step_8c3054b458309010)
}

var fileDescriptor_step_8c3054b458309010 = []byte{
