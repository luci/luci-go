...
func (*Step) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_ae7a7021b6c1135e, []int{0}
}
...
func (*Step_Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_step_ae7a7021b6c1135e, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/step.proto", fileDescriptor_step_ae7a7021b6c1135e)
}

var fileDescriptor_step_ae7a7021b6c1135e = []byte{
