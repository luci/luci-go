...
func (Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_cc14af2dbdfa55b4, []int{0}
}
...
func (Trinary) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_cc14af2dbdfa55b4, []int{1}
}
...
type GitilesCommit struct {
	...
	// Monotonically increasing number that defines a total order of commits
	// on the ref. Requires ref.
	// Normally commit position is defined by go/git-numberer, a Gerrit plugin.
...
func (m *GitilesCommit) GetPosition() int32 {
	if m != nil {
		return m.Position
	}
	return 0
...
func (*StringPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_cc14af2dbdfa55b4, []int{2}
}
...
func (*TimeRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_cc14af2dbdfa55b4, []int{3}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/common.proto", fileDescriptor_common_cc14af2dbdfa55b4)
}

var fileDescriptor_common_cc14af2dbdfa55b4 = []byte{
	...
	0x28, 0x9c, 0xce, 0xc4, 0x98, 0x75, 0xc8, 0x33, 0x4f, 0xaf, 0x01, 0xa8, 0x92, 0xbc, 0xc8, 0xee,
	...
	0xb5, 0x78, 0xf5, 0x3b, 0x00, 0x00, 0xff, 0xff, 0x97, 0x78, 0x5a, 0x0b, 0xfb, 0x02, 0x00, 0x00,
}
