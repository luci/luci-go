...
type Executable struct {
	...
	// BBAgentArgs.payload_path), so to invoke the binary called "foo" in the root
	// of the package, it is just "foo". On Windows, this will automatically look
	// first for "foo.exe" followed by "foo.bat". Similarly, "subdir/foo" would
	// expect the foo binary to live in the top level "subdir" within the CIPD
	// package.
	//
