...
type Executable struct {
	...
	// BuildInfra.BBAgent.payload_path), if cipd_package is specified, so "foo"
	// would invoke the binary called "foo" in the root of the package.
	// On Windows, this will automatically look first for ".exe" and ".bat"
	// variants. Similarly, "subdir/foo" would look for "foo" in "subdir" of
	// the CIPD package.
	//
	// If isolate_payload is specified instead of cipd_package and cipd_version,
	// cmd[0] should be relative to isolate_payload instead.
	//
	...
	//
	// At the time of led launch, this will be merged with
	...
	//
	// Mutually exclusive to cipd_package and cipd_version.
	IsolatePayload *api.CASTree `protobuf:"bytes,4,opt,name=isolate_payload,json=isolatePayload,proto3" json:"isolate_payload,omitempty"`
	...
	FinalBuildProtoPath string `protobuf:"bytes,5,opt,name=final_build_proto_path,json=finalBuildProtoPath,proto3" json:"final_build_proto_path,omitempty"`
}
...
func (x *Executable) GetIsolatePayload() *api.CASTree {
	if x != nil {
		return x.IsolatePayload
	}
	return nil
}

func (x *Executable) GetFinalBuildProtoPath() string {
	if x != nil {
...
var file_go_chromium_org_luci_buildbucket_proto_common_proto_rawDesc = []byte{
	...
	0x72, 0x6d, 0x69, 0x6e, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x73, 0x77, 0x61, 0x72, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd8,
	0x01, 0x0a, 0x0a, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x21, 0x0a,
	...
	,
	...
	,
	...
	0x63, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61,
	0x74, 0x63, 0x68, 0x73, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61,
	0x74, 0x63, 0x68, 0x73, 0x65, 0x74, 0x22, 0x7b, 0x0a, 0x0d, 0x47, 0x69, 0x74, 0x69, 0x6c, 0x65,
	0x73, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x66, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x72, 0x65, 0x66, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x22, 0x34, 0x0a, 0x0a, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x50, 0x61, 0x69,
	0x72, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x7d, 0x0a, 0x09, 0x54, 0x69, 0x6d,
	...
	0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x77, 0x0a, 0x12, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x65, 0x64, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x10,
	0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x61,
	...
	0x6e, 0x2a, 0x87, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x12,
	...
	,
...
var file_go_chromium_org_luci_buildbucket_proto_common_proto_goTypes = []interface{}{
	...
	(*api.CASTree)(nil),                      // 12: swarming.v1.CASTree
...
var file_go_chromium_org_luci_buildbucket_proto_common_proto_depIdxs = []int32{
	12, // 0: buildbucket.v2.Executable.isolate_payload:type_name -> swarming.v1.CASTree
	10, // 1: buildbucket.v2.StatusDetails.resource_exhaustion:type_name -> buildbucket.v2.StatusDetails.ResourceExhaustion
	11, // 2: buildbucket.v2.StatusDetails.timeout:type_name -> buildbucket.v2.StatusDetails.Timeout
	13, // 3: buildbucket.v2.TimeRange.start_time:type_name -> google.protobuf.Timestamp
	13, // 4: buildbucket.v2.TimeRange.end_time:type_name -> google.protobuf.Timestamp
	14, // 5: buildbucket.v2.RequestedDimension.expiration:type_name -> google.protobuf.Duration
