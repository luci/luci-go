...
func (Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_f9e8fd3e9efcb079, []int{0}
}
...
func (Trinary) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_f9e8fd3e9efcb079, []int{1}
}
...
type GitilesCommit struct {
	...
	// defined by go/git-numberer, a Gerrit plugin.
...
func (*StringPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f9e8fd3e9efcb079, []int{2}
}
...
func (*TimeRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f9e8fd3e9efcb079, []int{3}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/buildbucket/proto/common.proto", fileDescriptor_common_f9e8fd3e9efcb079)
}

var fileDescriptor_common_f9e8fd3e9efcb079 = []byte{
