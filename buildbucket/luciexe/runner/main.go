...
func (w *workdir) prep(base string) error {
	...
	var err error
	if w.authDir, err = mkAbs("auth-configs"); err != nil {
		return err
	}
	if w.logdogDir, err = mkAbs("logdog"); err != nil {
		return err
	}
	if w.luciCtxDir, err = mkAbs("luci-context"); err != nil {
		return err
	}
	if w.userDir, err = mkAbs("u"); err != nil {
		return err
	}
	if w.userTempDir, err = mkAbs("ut"); err != nil {
		return err
	}
