...
func (r *runner) Run(ctx context.Context, args *pb.ExecutorArgs) (*pb.Build, error) {
...
func (r *runner) runUserExecutable(ctx context.Context, args *pb.ExecutorArgs, userAuth *authctx.Context, logdogServ *logdogServer, logdogNamespace string) (err error) {
	ctx, cancel := context.WithCancel(ctx)
	defer cancel()
...
func (r *runner) setupUserEnv(ctx context.Context, args *pb.ExecutorArgs, userAuth *authctx.Context, logdogServ *logdogServer, logdogNamespace string) (environ.Env, error) {
	ret := environ.System()
...
func (r *runner) startLogDog(ctx context.Context, args *pb.ExecutorArgs, systemAuth *authctx.Context, listener *buildListener) (*logdogServer, error) {
