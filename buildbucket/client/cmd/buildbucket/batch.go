...
func cmdBatch(defaultAuthOpts auth.Options) *subcommands.Command {
	return &subcommands.Command{
		UsageLine: `batch`,
		ShortDesc: "calls buildbucket.v2.Batch",
		LongDesc: `Calls buildbucket.v2.Batch.
Standard input must be buildbucket.v2.BatchRequest in JSONPB format.
Standard output will be buildbucket.v2.BatchResponse in JSONPB format.
