...
func (b *Build) Save(withMeta bool) (datastore.PropertyMap, error) {
	b.BucketID = fmt.Sprintf("%s/%s", b.Proto.Builder.Project, b.Proto.Builder.Bucket)
	b.BuilderID = fmt.Sprintf("%s/%s/%s", b.Proto.Builder.Project, b.Proto.Builder.Bucket, b.Proto.Builder.Builder)
