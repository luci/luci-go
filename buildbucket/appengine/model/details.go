...
// dsStruct is a wrapper around _struct.Struct.
...
// FromProperty deserializes _struct.Struct protos from the datastore.
// Implements datastore.PropertyConverter.
func (s *dsStruct) FromProperty(p datastore.Property) error {
	return proto.Unmarshal(p.Value().([]byte), s)
}

// ToProperty serializes _struct.Struct protos to datastore format.
// Implements datastore.PropertyConverter.
