...
var (
	...
	updatableFieldPaths = map[string](func(req *pb.UpdateBuildRequest) error){
		...
		"build.status":                validateBuildStatus,
		// no validation for status_details
		"build.status_details":   noop, // no validation required
		"build.steps":            noop,
		"build.summary_markdown": noop,
		"build.tags":             validateBuildTags,
	}
...
func validateBuildStatus(req *pb.UpdateBuildRequest) error {
...
func validateBuildTags(req *pb.UpdateBuildRequest) error {
