...
func TestBatch(t *testing.T) {
	...
	Convey("Batch", t, func() {
		...
		Convey("exceed max read reqs amount", func() {
			...
			So(err, ShouldErrLike, "The maximum allowed read request amount in Batch is 1000.")
		})
		...
		Convey("exceed max write reqs amount", func() {
			...
			_, err := srv.Batch(ctx, req)
			So(err, ShouldErrLike, "The maximum allowed write request amount in Batch is 200.")
		})
	})
}
