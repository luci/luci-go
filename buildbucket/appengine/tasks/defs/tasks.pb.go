...
type BuildsV2PubSub struct {
	...
	// Large build fields are stripped from the above build field and put into
	// here with compression.
	BuildLargeFields *BuildsV2PubSub_BuildLargeFields `protobuf:"bytes,2,opt,name=build_large_fields,json=buildLargeFields,proto3" json:"build_large_fields,omitempty"`
}
...
func (x *BuildsV2PubSub) GetBuildLargeFields() *BuildsV2PubSub_BuildLargeFields {
	if x != nil {
...
type BuildsV2PubSub_BuildLargeFields struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Compressed bytes in proto binary format of build.input.properties field.
	InputProperties []byte `protobuf:"bytes,1,opt,name=input_properties,json=inputProperties,proto3" json:"input_properties,omitempty"`
	// Compressed bytes in proto binary format of build.output.properties field.
	OutputProperties []byte `protobuf:"bytes,2,opt,name=output_properties,json=outputProperties,proto3" json:"output_properties,omitempty"`
	// Compressed bytes in proto binary format of build.steps field.
	Steps []byte `protobuf:"bytes,3,opt,name=steps,proto3" json:"steps,omitempty"`
}

func (x *BuildsV2PubSub_BuildLargeFields) Reset() {
	*x = BuildsV2PubSub_BuildLargeFields{}
	if protoimpl.UnsafeEnabled {
...
func (x *BuildsV2PubSub_BuildLargeFields) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildsV2PubSub_BuildLargeFields) ProtoMessage() {}

func (x *BuildsV2PubSub_BuildLargeFields) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildsV2PubSub_BuildLargeFields.ProtoReflect.Descriptor instead.
func (*BuildsV2PubSub_BuildLargeFields) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_rawDescGZIP(), []int{10, 0}
}

func (x *BuildsV2PubSub_BuildLargeFields) GetInputProperties() []byte {
	if x != nil {
...
func (x *BuildsV2PubSub_BuildLargeFields) GetOutputProperties() []byte {
	if x != nil {
...
func (x *BuildsV2PubSub_BuildLargeFields) GetSteps() []byte {
	if x != nil {
		return x.Steps
	}
	return nil
...
var file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_rawDesc = []byte{
	...
	0x19, 0x0a, 0x08, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x07, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x22, 0x99, 0x02, 0x0a, 0x0e, 0x42,
	...
	,
...
var file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_goTypes = []interface{}{
	...
	(*BuildsV2PubSub_BuildLargeFields)(nil), // 11: taskdefs.BuildsV2PubSub.BuildLargeFields
...
var file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_depIdxs = []int32{
	...
	11, // 1: taskdefs.BuildsV2PubSub.build_large_fields:type_name -> taskdefs.BuildsV2PubSub.BuildLargeFields
...
func file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BuildsV2PubSub_BuildLargeFields); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
