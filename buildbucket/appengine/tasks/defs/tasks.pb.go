...
var file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_goTypes = []any{
	...
	(*proto.BuildbucketCfg_Topic)(nil), // 16: buildbucket.BuildbucketCfg.Topic
...
var file_go_chromium_org_luci_buildbucket_appengine_tasks_defs_tasks_proto_depIdxs = []int32{
	15, // 0: taskdefs.CreateBackendBuildTask.DequeueTime:type_name -> google.protobuf.Timestamp
	16, // 1: taskdefs.NotifyPubSubGo.topic:type_name -> buildbucket.BuildbucketCfg.Topic
	17, // 2: taskdefs.PushPendingBuildTask.builder_id:type_name -> buildbucket.v2.BuilderID
	17, // 3: taskdefs.PopPendingBuildTask.builder_id:type_name -> buildbucket.v2.BuilderID
