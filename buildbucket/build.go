...
const (
	// NoCanaryPreference specifies that either prod or canary version of build
	// infrastructure can be used for this build.
	NoCanaryPreference CanaryPreference = iota
	// Prod specifies that the prod version of build infrastructure
	// is preferred for this build.
	Prod
...
type Build struct {
	...
	// TODO: move identity package to //common/auth/identity
...
//	} `json:"files"`
//
//	// TODO: maybe add the rest of the fields
//	// https://chromium.googlesource.com/chromium/tools/build/+/master/scripts/master/buildbucket/README.md#build-parameters
//}
...
func ParseBuild(raw *buildbucket.ApiCommonBuildMessage) (*Build, error) {
	...
	if err := parseJSON(raw.ResultDetailsJson, &b.Output); err != nil {
...
// Message converts b to a build creation request.
func (b *Build) Message() (*buildbucket.ApiPutRequestMessage, error) {
