...
func GetByAddress(c context.Context, client *buildbucket.Service, address string) (*Build, error) {
	msg, err := GetMessageByAddress(c, client, address)
	if err != nil {
		return nil, err
	}
...
// GetMessageByAddress fetches a build message by its address.
// Returns (nil, nil) if build is not found.
func GetMessageByAddress(c context.Context, client *buildbucket.Service, address string) (*buildbucket.ApiCommonBuildMessage, error) {
