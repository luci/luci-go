...
// gitConfigTempl is a template for .gitconfig file generated by bootstrapper.
//
...
var gitConfigTempl = template.Must(template.New(".gitconfig").Parse(`# Autogenerated by LUCI.
...
// gitConfig is used to setup .gitconfig used by bootstrapper subprocesses.
//
