...
func TestBuildSet(t *testing.T) {
	...
	Convey("Gerrit", t, func() {
		Convey("ParseBuildSet", func() {
			...
			So(actual, ShouldResemble, &bp.GerritChange{
		...
		Convey("BuildSet", func() {
			bs := GerritBuildSet(&bp.GerritChange{
				Host:     "chromium-review.googlesource.com",
				Change:   678507,
				Patchset: 3,
			})
	...
	Convey("Gitiles", t, func() {
		Convey("ParseBuildSet", func() {
			...
			So(actual, ShouldResemble, &bp.GitilesCommit{
		...
		Convey("BuildSet", func() {
			bs := GitilesBuildSet(&bp.GitilesCommit{
				Host:    "chromium.googlesource.com",
				Project: "infra/luci/luci-go",
				Id:      "b7a757f457487cd5cfe2dae83f65c5bc10e288b7",
			})
...
func TestStringPairs(t *testing.T) {
	...
	Convey("StringPairs", t, func() {
		...
		pairs := StringPairs(m)
		So(pairs, ShouldResembleProto, []*bp.StringPair{
			{Key: "a", Value: "1"},
			{Key: "a", Value: "2"},
			{Key: "b", Value: "1"},
		})
