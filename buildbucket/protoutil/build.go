...
func RunDuration(b *bp.Build) (duration time.Duration, ok bool) {
...
func SchedulingDuration(b *bp.Build) (duration time.Duration, ok bool) {
...
func Tags(b *bp.Build) strpair.Map {
