...
//
//    Skylark value (scalars, lists, tuples, dicts containing only skylark
//    values) and returns a string with its compact JSON serialization.
//    """
package interpreter
