...
func (m *Message) SetField(name string, val skylark.Value) error {
	...
	// Do the type checking, but do not actually assign anything, since at this
	// point we do not yet have Go values to assign to, everything is represented
	// by Skylark values stored in 'fields'.
