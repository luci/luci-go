...
// LoadModule loads a protobuf module, returning a dict with single struct item
// named after the package. It has all message constructors defined inside.
func LoadModule(name string) (skylark.StringDict, error) {
