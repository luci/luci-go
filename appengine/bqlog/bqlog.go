...
//
// This package is DEPRECATED since it depends on Pull Task Queues which are
// deprecated and not available from the GAE second-gen runtime or from
// Kubernetes.
//
// The suggested replacement is go.chromium.org/luci/server/tq PubSub tasks,
// plus a PubSub push subscription with a handler that simply inserts rows into
// BigQuery.
package bqlog
