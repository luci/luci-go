...
//
// This package is DEPRECATED. It depends on GAE Memcache API which is not
// available outside of the GAE first-gen runtime.
//
// There's currently no direct replacement, but one can be written on top of
