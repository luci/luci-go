...
type Tree struct {
	...
	// The first project in this list is the primary project, in the sense that:
	//  1. Its "<project>:@project" realm will be used to check for ACL for the tree,
	//     if the flag "use_default_acls" is unset.
	//  2. If the tree is access without a LUCI project context, the primary project
	//     will be displayed at the top left of LUCI UI.
	//
	// Note: A project can have at most 1 tree attached to it.
	...
	//
	// If this flag is set, the ACLs will be checked against the "<primary_project>:@project" realm.
...
var file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDesc = []byte{
	...
	,
...
var (
	...
	file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDescData = file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDesc
)
...
func file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDescData)
	})
...
func file_go_chromium_org_luci_tree_status_proto_config_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_tree_status_proto_config_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_tree_status_proto_config_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Tree); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_tree_status_proto_config_config_proto_rawDesc = nil
