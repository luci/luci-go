...
type QueryTreesResponse struct {
	...
	// Currently we only return at most one tree, as each project is attached to at most one tree.
	// We make this a repeated field for future compatibility, where we may want
	// to support more than one tree for a project.
...
var file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDesc = []byte{
	...
	,
...
var (
	...
	file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDescData = file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDesc
)
...
func file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDescData)
	})
	return file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDescData
}

var file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_goTypes = []any{
	(*QueryTreesRequest)(nil),  // 0: luci.tree_status.v1.QueryTreesRequest
	(*QueryTreesResponse)(nil), // 1: luci.tree_status.v1.QueryTreesResponse
	(*Tree)(nil),               // 2: luci.tree_status.v1.Tree
}
var file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_depIdxs = []int32{
	2, // 0: luci.tree_status.v1.QueryTreesResponse.trees:type_name -> luci.tree_status.v1.Tree
	0, // 1: luci.tree_status.v1.Trees.QueryTrees:input_type -> luci.tree_status.v1.QueryTreesRequest
	1, // 2: luci.tree_status.v1.Trees.QueryTrees:output_type -> luci.tree_status.v1.QueryTreesResponse
...
func file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*QueryTreesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*QueryTreesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Tree); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDesc = nil
