...
const file_go_chromium_org_luci_tree_status_proto_v1_trees_proto_rawDesc = "" +
	"\n" +
	"5go.chromium.org/luci/tree_status/proto/v1/trees.proto\x12\x13luci.tree_status.v1\"$\n" +
	"\x0eGetTreeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"-\n" +
	"\x11QueryTreesRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\"E\n" +
	"\x12QueryTreesResponse\x12/\n" +
	"\x05trees\x18\x01 \x03(\v2\x19.luci.tree_status.v1.TreeR\x05trees\"6\n" +
	"\x04Tree\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bprojects\x18\x02 \x03(\tR\bprojects2\xb5\x01\n" +
	"\x05Trees\x12K\n" +
	"\aGetTree\x12#.luci.tree_status.v1.GetTreeRequest\x1a\x19.luci.tree_status.v1.Tree\"\x00\x12_\n" +
	"\n" +
	"QueryTrees\x12&.luci.tree_status.v1.QueryTreesRequest\x1a'.luci.tree_status.v1.QueryTreesResponse\"\x00B+Z)go.chromium.org/luci/tree_status/proto/v1b\x06proto3"
