...
luci.project(
    ...
    tricium = "tricium-dev.appspot.com",
    acls = [
        acl.entry(
            roles = [
...
luci.cq_group(
    ...
    verifiers = [
        ...
        luci.cq_tryjob_verifier(
            ...
            owner_whitelist = ["project-contributer"],
...
#         location_regexp: ".+/[+]/.+\\.py"
#         location_regexp: ".+/[+]/.+\\.go"
#         owner_whitelist_group: "project-contributer"
...
#     git_url: "https://example.googlesource.com"
#   }
#   whitelisted_group: "project-contributer"
# }
# repos {
#   gerrit_project {
#     host: "example-review.googlesource.com"
