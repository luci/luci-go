...
// If the kind of the first key components start with '@' and its ID is not
// empty, if will be prefixed as '<id>:'.
func (n *Node) String() string {
	...
	// Deal with namespaced keys. They root kind (last visited) has form "@...".
	pfx := ""
