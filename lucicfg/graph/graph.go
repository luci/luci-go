...
func (g *Graph) Children(parent *Key, kind, orderBy string) ([]*Node, error) {
	return g.sortedListing(parent, "parent", kind, orderBy, func(n *Node) []*Node {
...
func (g *Graph) Parents(child *Key, kind, orderBy string) ([]*Node, error) {
	return g.sortedListing(child, "child", kind, orderBy, func(n *Node) []*Node {
		return n.listParents()
	})
}
