...
//
// Returns [typ1(id1), typ2(id2), ...]. Must not be parsed, only for logging.
...
// KeySet is a set of all keys ever defined in a program.
//
...
//
// Assumes strings don't have zero bytes.
