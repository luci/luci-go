...
const expectedInitStar = `init.star = *ast.Namespace at init.star:2:1 {
  ...
  pub1 = *ast.Namespace at init.star:5:1 {
    sym = *ast.Function _func at another.star:2:1
    const = *ast.Var const at init.star:7:5
    broken1 = <broken>
    broken2 = <broken>
    broken3 = <broken>
  }
  ...
  pub3 = *ast.Function pub3 at init.star:14:1
...
func TestLoader(t *testing.T) {
	...
	Convey("Works", t, func() {
		...
		s1 := Lookup(Lookup(init, "pub1"), "sym")
		s2 := Lookup(Lookup(third, "exported"), "func")
