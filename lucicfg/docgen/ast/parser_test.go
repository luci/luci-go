...
func TestParseModule(t *testing.T) {
	...
	Convey("Works", t, func() {
		...
		Convey("Docstrings extraction", func() {
			So(mod.Docstring, ShouldEqual, "Module doc string.\n\nMultiline.\n")
			So(
				mod.NodeByName("func1").(*Function).Docstring, ShouldEqual,
				"Doc string.\n\n  Multiline.\n  ",
			)
		})
		...
		Convey("Spans extraction", func() {
			...
			So(l.Line, ShouldEqual, 17)
			So(l.Col, ShouldEqual, 1)
			So(r.Line, ShouldEqual, 21)
			So(r.Col, ShouldEqual, 6)
		})
