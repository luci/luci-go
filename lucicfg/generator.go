...
const textProtoHeader = `# Auto-generated by lucicfg.
...
func Generate(ctx context.Context, in Inputs) (*State, error) {
	...
	// Executing LUCI.star (with all its dependencies) populated State and
	...
	cfgs, err := genCtx.configSet.asTextProto(textProtoHeader)
	if err != nil {
		return nil, err
	}
