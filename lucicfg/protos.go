...
var publicProtos = map[string]struct {
	...
	//
	// load("@proto//luci/lucicfg/external/crostesting/source_tree_test_config.proto", source_tree_test_config_pb="crostesting")
	"luci/lucicfg/external/crostesting/source_tree_test_config.proto": {
		"crostesting",
