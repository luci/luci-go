...
// Mapping from proto module path on the Starlark side to its proto package name
// and path withing luci-go repository.
//
// Go proto location can be changed without altering Starlark API. Proto package
// name is still important and should not be changed. It is here mostly for
// documentation purpose.
//
// There's also a test that asserts real proto packages (per generated *.pb2.go)
// match what's is specified here.
