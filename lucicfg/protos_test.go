...
func TestProtoDocHeader(t *testing.T) {
	t.Parallel()

	Convey("Works", t, func() {
		So(protoDocHeader(&testproto.Msg{}), ShouldResemble, []string{
			"For the schema of this file, see Msg message:",
			"  https://example.com/proto-doc",
		})
		So(protoDocHeader(&empty.Empty{}), ShouldBeNil)
	})
}
