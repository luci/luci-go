...
// Generate executes the Starlark script and assembles final values for meta
// config.
//
// It is common part of subcommands that generate configs.
//
...
// Starlark and the config populated via CLI flags, passed as 'flags').
func GenerateConfigs(ctx context.Context, inputFile string, meta, flags *lucicfg.Meta) (lucicfg.ConfigSet, error) {
	...
	logging.Debugf(ctx, "Generating configs...")
