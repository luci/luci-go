...
var knownTypes = []struct {
	...
	{"luci-notify", "notify.ProjectConfig", normNotifyCfg},
...
func normBuildbucketCfg(ctx context.Context, m proto.Message) (proto.Message, error) {
...
func normNotifyCfg(ctx context.Context, m proto.Message) (proto.Message, error) {
