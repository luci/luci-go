...
func TestGenerate(t *testing.T) {
	...
	Convey("Generators work", t, func() {
		state, err := exec(`
load("@proto//test.proto", "testproto")
def gen(ctx):
	ctx.config_set['test.cfg'] = testproto.Msg(i=123)
core.generator(impl = gen)
`)
		So(err, ShouldBeNil)
		So(state.Configs, ShouldResemble, map[string]string{
			"test.cfg": `# Auto-generated by lucicfg.
