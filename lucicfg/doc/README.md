...
| acl.BUILDBUCKET_OWNER |project, bucket |groups, users |Have full access to the bucket (should be used rarely). |
...
| acl.SCHEDULER_OWNER |project, bucket |groups, users |Have full access to jobs, including ability to abort them. |
