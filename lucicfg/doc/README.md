...
It is passed to `acls` fields of [core.project(...)](#core.project) and [core.bucket(...)](#core.bucket) rules.

Specifying an empty ACL binding is allowed. It is ignored everywhere. Useful
for things like:
...
* **roles**: a single role or a list of roles to assign.
