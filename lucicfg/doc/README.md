...
* **result_visibility**: can be used to restrict the visibility of the results in comments on Gerrit. Valid values are `cq.FULL_VISIBILITY` and `cq.RESTRICTED_VISIBILITY` constants.
