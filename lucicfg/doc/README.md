...
* **retry_config**: one of `cq.RETRY_*` enum values that defines how CQ should retry failed builds. See [CQ](#cq_doc) for more info. Default is `cq.RETRY_TRANSIENT_FAILURES`.
