...
```python
luci.cq(submit_max_burst = None, submit_burst_delay = None, draining_start_time = None)
```
...
projects, launches presubmit jobs whenever a CL is marked as ready for commit,
and commits the CL if it passes all presubmit checks.
