...
* **experiments**: a dict with experiments to include or exclude. Keys are strings, and values are ints that represent the percentage of
builders that use the experiments.
