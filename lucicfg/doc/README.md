...
* **name**: a name of this view, will show up in URLs.  Note that names of [luci.list_view(...)](#luci.list_view) and [luci.console_view(...)](#luci.console_view) are in the same namespace i.e. defining a list view with same name as some console view (and vice versa) causes an error. Required.
...
* **name**: a name of this console, will show up in URLs. Note that names of [luci.console_view(...)](#luci.console_view) and [luci.list_view(...)](#luci.list_view) are in the same namespace i.e. defining a console view with same name as some list view (and vice versa) causes an error. Required.
