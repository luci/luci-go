...
### resultdb.test_presentation_to_dict {#resultdb.test_presentation_to_dict}

```python
resultdb.test_presentation_to_dict(config = None)
```
...
#### Arguments {#resultdb.test_presentation_to_dict-args}

* **config**: a test_presentation.config to be converted to a dictonary.


#### Returns  {#resultdb.test_presentation_to_dict-returns}
