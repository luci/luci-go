...
```python
resultdb.history_options(index_results_by_timestamp = None)
```
...
* **index_results_by_timestamp**: bool, indicates whether the build's test results will be indexed by their creation timestamp for the purposes of retrieving the history of a given set of tests/variants.
