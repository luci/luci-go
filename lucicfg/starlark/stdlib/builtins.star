...
load("@stdlib//internal/luci/rules/builder_health_notifier.star", _builder_health_notifier = "builder_health_notifier")
...
luci = struct(
    ...
    builder_health_notifier = _builder_health_notifier,
