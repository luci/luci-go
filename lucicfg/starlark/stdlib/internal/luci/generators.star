...
def gen_notify_cfg(ctx):
  ...
  # for deriving repositories associated with builders.
  #
  # TODO(vadimsh): Cache this somewhere. A very similar calculation is done by
  # scheduler.cfg generator. There's currently no mechanism to carry chunks of
  # state between different luci.generator(...) implementations.
