...
def _cq_tryjob_verifier(
  ...
  Args:
    ...
    result_visibility: can be used to restrict the visibility of the tryjob
        ...
        `cq.TRYJOB_RESULT_COMMENT_LEVEL_FULL` and
        `cq.TRYJOB_RESULT_COMMENT_LEVEL_RESTRICTED` constants. Default is to
        give full visibility: builder name and full summary markdown are
        including in the Gerrit comment.
  ...
  graph.add_node(key, props = {
      ...
      # Don't use cq.TRYJOB_RESULT_COMMENT_LEVEL_UNSET to not spam the cfg
      # files.
