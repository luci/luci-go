...
def _cq(
    ...
    Args:
      ...
      draining_start_time: **Temporarily not supported, see
        https://crbug.com/1208569**. If present, the CQ will refrain from
        processing any CLs, on which CQ was triggered after the specified time.
        This is an UTC RFC3339 string representing the time, e.g.
        `2017-12-23T15:47:58Z` and Z is mandatory.
