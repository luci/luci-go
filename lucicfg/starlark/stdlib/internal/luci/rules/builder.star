...
def _builder(
  ...
  Args:
    ...
    resultdb_settings: buildbucket_pb.Builder.ResultDB, A configuration that
        defines if Buildbucket:ResultDB integration should be enabled for this
        builder and which results to export to BigQuery, and to which project,
        dataset, and table.
