...
def _logdog(ctx, *, gs_bucket = None, cloud_logging_project = None, use_global_logdog_account = False):
    ...
    Args:
      ...
      use_global_logdog_account: If True, the global logdog service account
       will be used to export logs to the Cloud Logging project. If False,
       the project account will be used.
    """
    key = keys.logdog()
