...
def _notifier(
  ...
  Args:
    ...
    notified_by: builders to receive status change notifications from. This
        relation can also be defined via `notifies` filed in luci.builder(...).
  """
