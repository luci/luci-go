...
def gitiles_poller(
  ...
  It watches a set of git refs and triggers builders if either:
      ...
      * A ref belonging to the watched has just been created.
  ...
  Args:
    ...
    triggers: names of builders to triggers whenever the poller detect new git
        commits on the watched ref set.
  """
