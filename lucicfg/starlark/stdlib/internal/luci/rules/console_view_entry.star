...
"""Defines luci.console_view_entry(...) rule."""
...
def _console_view_entry(
    ...
    Args:
      ...
      category: a string of the form `term1|term2|...` that describes the
          ...
          ancestors will have their column headers merged. In expanded view,
          each leaf category or builder under a non-leaf category will have it's
          own column. The recommendation for maximum densification is not to mix
