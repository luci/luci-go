...
def _history_options(*, index_results_by_timestamp=False):
  """Defines a history indexing configuration.

  Args:
    index_results_by_timestamp: bool, indicates whether the build's test
      results will be indexed by their creation timestamp for the purposes of
      retrieving the history of a given set of tests/variants.
  
  Returns:
    A populated resultdb_pb.HistoryOptions() proto.
  """
  return resultdb_pb.HistoryOptions(
    use_invocation_timestamp=index_results_by_timestamp,
  )
