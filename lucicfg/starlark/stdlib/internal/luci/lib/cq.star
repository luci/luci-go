    ...
    ***
    ...
    Args:
      ...
      refs_exclude: a list of regular expressions that define the set of refs
        to exclude from watching. Emtpy by default.
    ...
    refs_exclude = validate.list("refs_exclude", refs_exclude)
    for r in refs_exclude:
        validate.string("refs_exclude", r)

    return _refset_ctor(
        __repo = repo,
        __refs = refs or ["refs/heads/master"],
        __refs_exclude = refs_exclude or [],
        __kind = "gob",
