...
# `result_visibility` field of luci.cq_group(...):
...
cq = struct(
    ...
    TRYJOB_RESULT_COMMENT_LEVEL_FULL = cq_pb.TRYJOB_RESULT_COMMENT_LEVEL_FULL,
    TRYJOB_RESULT_COMMENT_LEVEL_RESTRICTED = cq_pb.TRYJOB_RESULT_COMMENT_LEVEL_RESTRICTED,
)
