...
################################################################################
## Helpers for defining milo views (lists or console).


def _view_add_view(key, props):
  """Adds a *_view node, ensuring it doesn't clashes with some other view.
