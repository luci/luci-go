...
const file_go_chromium_org_luci_lucicfg_lockfilepb_lockfile_proto_rawDesc = "" +
	"\n" +
	"6go.chromium.org/luci/lucicfg/lockfilepb/lockfile.proto\x12\alucicfg\x1a/go.chromium.org/luci/common/proto/options.proto\"\xf7\x02\n" +
	"\bLockfile\x12\x1e\n" +
	"\alucicfg\x18\x01 \x01(\tB\x04\xb0\xfe#\x01R\alucicfg\x125\n" +
	"\bpackages\x18\x02 \x03(\v2\x19.lucicfg.Lockfile.PackageR\bpackages\x1a\x93\x02\n" +
	"\aPackage\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x128\n" +
	"\x06source\x18\x02 \x01(\v2 .lucicfg.Lockfile.Package.SourceR\x06source\x12\x12\n" +
	"\x04deps\x18\x03 \x03(\tR\x04deps\x12\x18\n" +
	"\alucicfg\x18\x04 \x01(\tR\alucicfg\x12\x1c\n" +
	"\tresources\x18\x05 \x03(\tR\tresources\x12 \n" +
	"\ventrypoints\x18\x06 \x03(\tR\ventrypoints\x1aL\n" +
	"\x06Source\x12\x12\n" +
	"\x04repo\x18\x01 \x01(\tR\x04repo\x12\x1a\n" +
	"\brevision\x18\x02 \x01(\tR\brevision\x12\x12\n" +
	"\x04path\x18\x03 \x01(\tR\x04pathB)Z'go.chromium.org/luci/lucicfg/lockfilepbb\x06proto3"
