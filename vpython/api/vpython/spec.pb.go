...
func file_go_chromium_org_luci_vpython_api_vpython_spec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_vpython_api_vpython_spec_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Spec); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_vpython_api_vpython_spec_proto_msgTypes[1].Exporter = func(v any, i int) any {
