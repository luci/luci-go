...
var file_go_chromium_org_luci_server_dsmapper_internal_tasks_tasks_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_server_dsmapper_internal_tasks_tasks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_server_dsmapper_internal_tasks_tasks_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_server_dsmapper_internal_tasks_tasks_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_server_dsmapper_internal_tasks_tasks_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_server_dsmapper_internal_tasks_tasks_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_server_dsmapper_internal_tasks_tasks_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
