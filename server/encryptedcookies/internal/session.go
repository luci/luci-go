...
const (
	...
	//
	// If a sessions TTL (time till next NextRefresh) is longer than this, we
	...
	//
	// If a sessions TTL (time till next NextRefresh) is smaller than this, we
	// *must* refresh it.
	//
	...
	// refreshExpMean is a parameters of the exponential distribution for
