...
// generally add additionally functionality on top of the raw Spanner client
// that other LUCI packages assume to be present. Using the Spanner client
// directly may violate such assumptions leading to undefined behavior when
// multiple packages are mixed.
