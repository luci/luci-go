...
type Submitter interface {
	// SubmitTask submits a task, returning a gRPC status.
	//
	...
	//
	// `msg` is the original task payload. It is non-nil only when SubmitTask
	...
	SubmitTask(ctx context.Context, req *taskspb.CreateTaskRequest, msg proto.Message) error
}
...
// SubmitTask creates a task, returning a gRPC status.
func (s *CloudSubmitter) SubmitTask(ctx context.Context, req *taskspb.CreateTaskRequest, _ proto.Message) error {
