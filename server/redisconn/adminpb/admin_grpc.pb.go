...
type AdminClient interface {
	...
	FlushAll(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *adminClient) FlushAll(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type AdminServer interface {
	...
	//
	// Issues "FLUSHALL ASYNC" command.
	FlushAll(context.Context, *empty.Empty) (*empty.Empty, error)
...
func (UnimplementedAdminServer) FlushAll(context.Context, *empty.Empty) (*empty.Empty, error) {
...
func _Admin_FlushAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).FlushAll(ctx, req.(*empty.Empty))
	}
