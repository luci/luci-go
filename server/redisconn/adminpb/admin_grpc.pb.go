...
type AdminClient interface {
	...
	FlushAll(ctx context.Context, in *FlushAllRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *adminClient) FlushAll(ctx context.Context, in *FlushAllRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type AdminServer interface {
	...
	//
	// Issues "FLUSHALL" command, optionally with "ASYNC" argument.
	FlushAll(context.Context, *FlushAllRequest) (*empty.Empty, error)
...
func (UnimplementedAdminServer) FlushAll(context.Context, *FlushAllRequest) (*empty.Empty, error) {
