...
// Snippet returns the cached analytics snippet from ctx,
// which was generated by Initialize() to call into either Google's older
// library "analytics.js" or the newer "gtag.js", depending on the analytics ID
// passed in the command line. I.e. for IDs in the format "UA-XXXXXX" the
// snippet will be like the one documented in:
// https://developers.google.com/analytics/devguides/collection/analyticsjs#the_google_analytics_tag,
// and if in the format "G-XXXXX" the snippet will be of this other type:
// https://developers.google.com/analytics/devguides/collection/gtagjs#install_the_global_site_tag.
//
// If the analytics ID is missing or empty, this will return an empty template,
