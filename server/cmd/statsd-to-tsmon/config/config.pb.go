...
func file_go_chromium_org_luci_server_cmd_statsd_to_tsmon_config_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_server_cmd_statsd_to_tsmon_config_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_server_cmd_statsd_to_tsmon_config_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Metric); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_server_cmd_statsd_to_tsmon_config_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
