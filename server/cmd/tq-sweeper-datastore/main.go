...
// Executable tq-sweeper-datastore runs an inproc sweeping driver that scans
// DataStore database for TQ transactional tasks reminders.
//
// It should run as a single replica per DataStore DB. It is OK if it temporarily
