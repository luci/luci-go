...
func TestBundler(t *testing.T) {
	...
	Convey("With bundler", t, func() {
		...
		counter := func(m types.Metric, fieldVals ...interface{}) int64 {
		...
		Convey("Gives up draining on cancel", func() {
			...
			// Exact numbers are too brittle to depend on.
			So(counter(metricErrorsCounter, "project.dataset.durations", "INTERNAL"), ShouldBeGreaterThan, 0)
			So(counter(metricErrorsCounter, "project.dataset.timestamps", "INTERNAL"), ShouldBeGreaterThan, 0)
		})
