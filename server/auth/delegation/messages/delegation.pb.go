...
var file_go_chromium_org_luci_server_auth_delegation_messages_delegation_proto_rawDesc = []byte{
	...
	0x54, 0x4f, 0x4b, 0x45, 0x4e, 0x10, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_go_chromium_org_luci_server_auth_delegation_messages_delegation_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_server_auth_delegation_messages_delegation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_server_auth_delegation_messages_delegation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_server_auth_delegation_messages_delegation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
