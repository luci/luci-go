...
// for testing request handlers, thus all other DB methods are hardcoded to do
// some default behavior sufficient to for fake requests to pass authentication.
