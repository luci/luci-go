...
import (
	...
	"go.chromium.org/luci/server/auth/permission"
...
func (db UnconfiguredDB) HasPermission(ctx context.Context, id identity.Identity, perm *permission.Permission, realms []string) (bool, error) {
