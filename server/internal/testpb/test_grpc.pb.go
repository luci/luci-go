...
func (c *testClient) ServerStream(ctx context.Context, in *Request, opts ...grpc.CallOption) (Test_ServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Test_ServiceDesc.Streams[0], Test_ServerStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testClient) ClientStream(ctx context.Context, opts ...grpc.CallOption) (Test_ClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Test_ServiceDesc.Streams[1], Test_ClientStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testClient) ClientServerStream(ctx context.Context, opts ...grpc.CallOption) (Test_ClientServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Test_ServiceDesc.Streams[2], Test_ClientServerStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
