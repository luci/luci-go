...
// IsZero returns true if h is uninitialized.
func (h LRUHandle) IsZero() bool { return h.h == 0 }
...
func RegisterLRUCache(capacity int) LRUHandle {
	...
	return LRUHandle{h: len(registeredCaches)}
}
...
// IsZero returns true if h is uninitialized.
func (h SlotHandle) IsZero() bool { return h.h == 0 }
