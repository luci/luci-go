...
// WithProcessCache initializes context-bound process cache and adds it to the
// Context.
//
...
// ProcessCache adds a in-memory cache to the Context. If no process cache is
// installed, this may return nil.
