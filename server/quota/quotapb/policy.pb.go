...
func file_go_chromium_org_luci_server_quota_quotapb_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_server_quota_quotapb_policy_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Policy); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_server_quota_quotapb_policy_proto_msgTypes[1].Exporter = func(v any, i int) any {
