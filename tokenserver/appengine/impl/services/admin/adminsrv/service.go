...
func NewServer() *AdminServer {
	...
	return &AdminServer{
		...
		CreateProjectScopedServiceAccountRPC: serviceaccounts.CreateProjectScopedServiceAccountRPC{
			...
			GcpProjectResolver:   projectscope.DefaultGcpProjectResolver,
			CreateServiceAccount: projectscope.NewServiceAccountCreator(projectscope.DefaultGcpProjectResolver),
		},
