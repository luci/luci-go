...
type ScopedIdentityManager interface {
	GetOrCreate(c context.Context, service, project string, onCreate func(identity *ScopedIdentity) (bool, error)) (*ScopedIdentity, bool, error)
...
func (s *persistentIdentityManager) GetOrCreate(c context.Context, service, project string, onCreate func(identity *ScopedIdentity) (bool, error)) (*ScopedIdentity, bool, error) {
	identity := NewScopedIdentity(service, project)
