...
type ProjectIdentityManager interface {
	...
	Create(c context.Context, project, email string) (*ProjectIdentity, error)
...
func (s *persistentIdentityManager) Create(c context.Context, project, email string) (*ProjectIdentity, error) {
