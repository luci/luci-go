...
const (
	// Entity which is being created in the storage already exists.
	ErrorAlreadyExists = iota

	// Entity that was queried does not exist in the storage.
	ErrorNotFound = iota
)
...
var scopedIdentities ScopedIdentityManager = newScopedIdentities()
