...
const (
	...
	// encodedProjectLength resembles the maximum number of characters to which the luci project will
	// be encoded in the generated account id.
	encodedProjectLength = 10

	// AccountIDDelimiter is the delimiter between account id and domain part of the service account email.
	AccountIDDelimiter = "@"
)
