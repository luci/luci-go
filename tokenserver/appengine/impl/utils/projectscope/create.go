...
var DefaultServicAccountCreator = NewServiceAccountCreator(DefaultGcpProjectResolver)

func NewServiceAccountCreator(resolver GcpProjectResolver) ServiceAccountCreator {
	return func(ctx context.Context, identity *ScopedIdentity) (*iam.ServiceAccount, bool, error) {
		...
		gcpProject, err := resolver.Resolve(identity.Service)
		if err != nil {
			return nil, false, err
		}
