...
func (r *MintServiceOAuthTokenRPC) resolveServiceAccountIdentity(c context.Context, service, project string) (*projectscope.ScopedIdentity, bool, error) {
	identity, err := r.Storage.GetOrCreate(c, service, project, nil)
...
func (r *MintServiceOAuthTokenRPC) MintServiceOAuthToken(c context.Context, req *minter.MintServiceOAuthTokenRequest) (*minter.MintServiceOAuthTokenResponse, error) {
	...
	scopedIdentity, _, err := r.resolveServiceAccountIdentity(c, string(callerId), req.LuciProject)
