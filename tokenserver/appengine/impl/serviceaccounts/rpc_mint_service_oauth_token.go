...
func (r *MintServiceOAuthTokenRPC) resolveServiceAccountIdentity(c context.Context, service, project string) (*projectscope.ScopedIdentity, error) {
	return r.Storage.GetOrCreate(c, service, project)
}
...
func (r *MintServiceOAuthTokenRPC) MintServiceOAuthToken(c context.Context, req *minter.MintServiceOAuthTokenRequest) (*minter.MintServiceOAuthTokenResponse, error) {
	...
	scopedIdentity, err := r.resolveServiceAccountIdentity(c, string(callerId), req.LuciProject)
