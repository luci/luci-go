...
// ImportConfigs refetches project_scoped_service_accounts.cfg and updates the datastore copy.
//
// Called from cron.
...
// makeRule converts ServiceAccountRule into Rule.
//
...
func makeRule(c context.Context, ruleProto *admin.ServiceConfig, rev string) (*Rule, error) {
	...
	return &Rule{
		CloudProjectID: ruleProto.CloudProjectId,
		Rule:           ruleProto,
		Revision:       rev,
	}, nil
}
