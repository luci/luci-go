...
func loadConfig(ctx context.Context, text string) error {
	...
	rc := NewRulesCache()
	return rc.importIdentities(ctx, policy.ConfigBundle{projectsCfg: cfg}, "fake-revision")
}
