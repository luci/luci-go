...
func testServiceAccountCreator(ctx context.Context, gcpProject string, identity *projectscope.ScopedIdentity, client projectscope.ServiceAccountClient) (*iam.ServiceAccount, error) {
	...
	return nil, fmt.Errorf("unable to create service account")
}
