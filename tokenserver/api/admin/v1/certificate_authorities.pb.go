...
type CRLStatus struct {
	...
	LastUpdateTime    *timestamp.Timestamp `protobuf:"bytes,1,opt,name=last_update_time,json=lastUpdateTime,proto3" json:"last_update_time,omitempty"`           // time when CRL was generated by the CA
	LastFetchTime     *timestamp.Timestamp `protobuf:"bytes,2,opt,name=last_fetch_time,json=lastFetchTime,proto3" json:"last_fetch_time,omitempty"`              // time when CRL was fetched
...
func (x *CRLStatus) GetLastUpdateTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *CRLStatus) GetLastFetchTime() *timestamp.Timestamp {
	if x != nil {
...
var file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x07, 0x5a, 0x05, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDescOnce sync.Once
	file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDescData = file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDesc
)
...
func file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FetchCRLRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FetchCRLResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListCAsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsRevokedCertRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsRevokedCertResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckCertificateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckCertificateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CRLStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_go_chromium_org_luci_tokenserver_api_admin_v1_certificate_authorities_proto_rawDesc = nil
...
func (*UnimplementedCertificateAuthoritiesServer) ListCAs(context.Context, *empty.Empty) (*ListCAsResponse, error) {
