...
type CreateProjectScopedServiceAccountRequest struct {
	...
	// OverrideAccountId is used override the auto generated account.
	//
	// In some situations this might be required to avoid conflicting names.
	OverrideAccountId    string   `protobuf:"bytes,3,opt,name=override_account_id,json=overrideAccountId,proto3" json:"override_account_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *CreateProjectScopedServiceAccountRequest) GetOverrideAccountId() string {
	if m != nil {
		return m.OverrideAccountId
	}
	return ""
}
...
var fileDescriptor_303c2e4773396ed5 = []byte{
	...
	,
}
