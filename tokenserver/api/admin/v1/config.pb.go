...
type ServiceAccountsProjectMapping struct {
	// LUCI project and all accounts that belong to it.
	Project              []*ServiceAccountsProjectMapping_Project `protobuf:"bytes,1,rep,name=project,proto3" json:"project,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                 `json:"-"`
	XXX_unrecognized     []byte                                   `json:"-"`
	XXX_sizecache        int32                                    `json:"-"`
}
...
func (m *ServiceAccountsProjectMapping) GetProject() []*ServiceAccountsProjectMapping_Project {
	if m != nil {
		return m.Project
	}
	return nil
...
type ServiceAccountsProjectMapping_Project struct {
	// Name of a LUCI project.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Emails of service accounts that allowed to be used by this project.
...
func (m *ServiceAccountsProjectMapping_Project) Reset()         { *m = ServiceAccountsProjectMapping_Project{} }
func (m *ServiceAccountsProjectMapping_Project) String() string { return proto.CompactTextString(m) }
func (*ServiceAccountsProjectMapping_Project) ProtoMessage()    {}
func (*ServiceAccountsProjectMapping_Project) Descriptor() ([]byte, []int) {
	return fileDescriptor_aeb7d66bba60fd47, []int{8, 0}
}

func (m *ServiceAccountsProjectMapping_Project) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ServiceAccountsProjectMapping_Project.Unmarshal(m, b)
}
func (m *ServiceAccountsProjectMapping_Project) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ServiceAccountsProjectMapping_Project.Marshal(b, m, deterministic)
}
func (m *ServiceAccountsProjectMapping_Project) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceAccountsProjectMapping_Project.Merge(m, src)
}
func (m *ServiceAccountsProjectMapping_Project) XXX_Size() int {
	return xxx_messageInfo_ServiceAccountsProjectMapping_Project.Size(m)
}
func (m *ServiceAccountsProjectMapping_Project) XXX_DiscardUnknown() {
	xxx_messageInfo_ServiceAccountsProjectMapping_Project.DiscardUnknown(m)
}

var xxx_messageInfo_ServiceAccountsProjectMapping_Project proto.InternalMessageInfo

func (m *ServiceAccountsProjectMapping_Project) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ServiceAccountsProjectMapping_Project) GetServiceAccount() []string {
	if m != nil {
		return m.ServiceAccount
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ServiceAccountsProjectMapping_Project)(nil), "tokenserver.admin.ServiceAccountsProjectMapping.Project")
}
...
var fileDescriptor_aeb7d66bba60fd47 = []byte{
	...
	,
}
