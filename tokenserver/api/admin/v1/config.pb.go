...
type CertificateAuthorityConfig struct {
	...
	// KnownServices describes parameters to use for each particular service.
	KnownServices        []*ServiceConfig `protobuf:"bytes,8,rep,name=known_services,json=knownServices,proto3" json:"known_services,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *CertificateAuthorityConfig) GetKnownServices() []*ServiceConfig {
	if m != nil {
		return m.KnownServices
	}
	return nil
}
...
func (m *ServiceConfig) GetCloudProject() string {
	if m != nil {
...
var fileDescriptor_aeb7d66bba60fd47 = []byte{
	...
	,
}
