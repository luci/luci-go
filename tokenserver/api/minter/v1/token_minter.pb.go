...
func (x *MachineTokenRequest) GetIssuedAt() *timestamp.Timestamp {
	if x != nil {
		return x.IssuedAt
	}
	return nil
...
type LuciMachineToken struct {
	...
	Expiry       *timestamp.Timestamp `protobuf:"bytes,2,opt,name=expiry,proto3" json:"expiry,omitempty"`                                 // when the token expires
}
...
func (x *LuciMachineToken) GetExpiry() *timestamp.Timestamp {
	if x != nil {
		return x.Expiry
	}
	return nil
...
type MintOAuthTokenGrantResponse struct {
	...
	Expiry     *timestamp.Timestamp `protobuf:"bytes,2,opt,name=expiry,proto3" json:"expiry,omitempty"`                           // when this token expires
	// Identifier of the service and its version that produced the token.
	//
	// Has the form "<app-id>/<module-version>". This is _not_ part of the token.
	// Used only for logging and monitoring.
...
func (x *MintOAuthTokenGrantResponse) GetExpiry() *timestamp.Timestamp {
	if x != nil {
		return x.Expiry
	}
	return nil
...
func (x *MintOAuthTokenViaGrantResponse) GetExpiry() *timestamp.Timestamp {
	if x != nil {
		return x.Expiry
	}
	return nil
...
func (x *MintProjectTokenResponse) GetExpiry() *timestamp.Timestamp {
	if x != nil {
		return x.Expiry
	}
	return nil
...
func (x *MintServiceAccountTokenResponse) GetExpiry() *timestamp.Timestamp {
	if x != nil {
		return x.Expiry
	}
	return nil
...
var file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x08, 0x5a, 0x06, 0x6d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
