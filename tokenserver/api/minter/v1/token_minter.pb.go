...
func (x *MachineTokenResponse) GetTokenType() isMachineTokenResponse_TokenType {
	if x != nil {
		return x.TokenType
	}
	return nil
...
func (x *MachineTokenResponse) GetLuciMachineToken() *LuciMachineToken {
	if x != nil {
		if x, ok := x.TokenType.(*MachineTokenResponse_LuciMachineToken); ok {
...
var file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDesc), len(file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDesc)))
	})
...
func file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDesc), len(file_go_chromium_org_luci_tokenserver_api_minter_v1_token_minter_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
