...
type BotConfig struct {
	...
	RbeEffectiveBotId string `protobuf:"bytes,7,opt,name=rbe_effective_bot_id,json=rbeEffectiveBotId,proto3" json:"rbe_effective_bot_id,omitempty"`
	// Dimension key to derive effective_bot_id when communicating with RBE.
	RbeEffectiveBotIdDimension string `protobuf:"bytes,8,opt,name=rbe_effective_bot_id_dimension,json=rbeEffectiveBotIdDimension,proto3" json:"rbe_effective_bot_id_dimension,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *BotConfig) GetRbeEffectiveBotId() string {
	if x != nil {
		return x.RbeEffectiveBotId
	}
	return ""
}

func (x *BotConfig) GetRbeEffectiveBotIdDimension() string {
	if x != nil {
		return x.RbeEffectiveBotIdDimension
	}
	return ""
}
...
const file_go_chromium_org_luci_swarming_proto_internals_session_proto_rawDesc = "" +
	"\n" +
	";go.chromium.org/luci/swarming/proto/internals/session.proto\x12\x1aswarming.internals.session\x1a\x1fgoogle/protobuf/timestamp.proto\x1a5go.chromium.org/luci/swarming/proto/config/bots.proto\"\xca\x02\n" +
	"\fSessionToken\x12V\n" +
	"\vhmac_tagged\x18\x01 \x01(\v23.swarming.internals.session.SessionToken.HmacTaggedH\x00R\n" +
	"hmacTagged\x12_\n" +
	"\x0eaead_encrypted\x18\x02 \x01(\v26.swarming.internals.session.SessionToken.AeadEncryptedH\x00R\raeadEncrypted\x1aG\n" +
	"\n" +
	"HmacTagged\x12\x18\n" +
	"\asession\x18\x01 \x01(\fR\asession\x12\x1f\n" +
	"\vhmac_sha256\x18\x02 \x01(\fR\n" +
	"hmacSha256\x1a0\n" +
	"\rAeadEncrypted\x12\x1f\n" +
	...
	"\x06expiry\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x06expiry\x12D\n" +
	"\n" +
	"debug_info\x18\x04 \x01(\v2%.swarming.internals.session.DebugInfoR\tdebugInfo\x12D\n" +
	"\n" +
	"bot_config\x18\x05 \x01(\v2%.swarming.internals.session.BotConfigR\tbotConfig\x122\n" +
	"\x15handshake_config_hash\x18\x06 \x01(\fR\x13handshakeConfigHash\x12+\n" +
	"\x12rbe_bot_session_id\x18\a \x01(\tR\x0frbeBotSessionId\x12D\n" +
	"\x10last_seen_config\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x0elastSeenConfig\"\xb6\x03\n" +
	"\tBotConfig\x122\n" +
	"\x06expiry\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x06expiry\x12D\n" +
	"\n" +
	"debug_info\x18\x02 \x01(\v2%.swarming.internals.session.DebugInfoR\tdebugInfo\x123\n" +
	"\bbot_auth\x18\x03 \x03(\v2\x18.swarming.config.BotAuthR\abotAuth\x124\n" +
	"\x16system_service_account\x18\x04 \x01(\tR\x14systemServiceAccount\x12,\n" +
	"\x12logs_cloud_project\x18\x05 \x01(\tR\x10logsCloudProject\x12!\n" +
	"\frbe_instance\x18\x06 \x01(\tR\vrbeInstance\x12/\n" +
	"\x14rbe_effective_bot_id\x18\a \x01(\tR\x11rbeEffectiveBotId\x12B\n" +
	"\x1erbe_effective_bot_id_dimension\x18\b \x01(\tR\x1arbeEffectiveBotIdDimension\"\x8b\x01\n" +
	"\tDebugInfo\x124\n" +
	"\acreated\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\acreated\x12)\n" +
	"\x10swarming_version\x18\x02 \x01(\tR\x0fswarmingVersion\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestIdB;Z9go.chromium.org/luci/swarming/proto/internals;internalspbb\x06proto3"
