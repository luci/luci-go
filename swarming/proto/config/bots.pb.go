...
//   - IP + require_luci_machine_token_secure: requires both to pass.
...
type BotAuth_LuciMachineToken struct {
	...
	//
	// If non-empty, the token's CA ID must match one of these values.
	CaId          []int64 `protobuf:"varint,1,rep,packed,name=ca_id,json=caId,proto3" json:"ca_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BotAuth_LuciMachineToken) Reset() {
	*x = BotAuth_LuciMachineToken{}
	mi := &file_go_chromium_org_luci_swarming_proto_config_bots_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BotAuth_LuciMachineToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BotAuth_LuciMachineToken) ProtoMessage() {}

func (x *BotAuth_LuciMachineToken) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_swarming_proto_config_bots_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BotAuth_LuciMachineToken.ProtoReflect.Descriptor instead.
func (*BotAuth_LuciMachineToken) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_swarming_proto_config_bots_proto_rawDescGZIP(), []int{2, 1}
}

func (x *BotAuth_LuciMachineToken) GetCaId() []int64 {
	if x != nil {
		return x.CaId
	}
	return nil
...
const file_go_chromium_org_luci_swarming_proto_config_bots_proto_rawDesc = "" +
	"\n" +
	"5go.chromium.org/luci/swarming/proto/config/bots.proto\x12\x0fswarming.config\x1a/go.chromium.org/luci/common/proto/options.proto\"p\n" +
	"\aBotsCfg\x12-\n" +
	"\x12trusted_dimensions\x18\x01 \x03(\tR\x11trustedDimensions\x126\n" +
	"\tbot_group\x18\x02 \x03(\v2\x19.swarming.config.BotGroupR\bbotGroup\"\xa2\x05\n" +
	"\bBotGroup\x12\x15\n" +
	"\x06bot_id\x18\x01 \x03(\tR\x05botId\x12\"\n" +
	"\rbot_id_prefix\x18\x02 \x03(\tR\vbotIdPrefix\x12,\n" +
	"\x04auth\x18\x14 \x03(\v2\x18.swarming.config.BotAuthR\x04auth\x12\x16\n" +
	"\x06owners\x18\x15 \x03(\tR\x06owners\x12\x1e\n" +
	"\n" +
	"dimensions\x18\x16 \x03(\tR\n" +
	"dimensions\x12*\n" +
	"\x11bot_config_script\x18\x17 \x01(\tR\x0fbotConfigScript\x121\n" +
	"\x15bot_config_script_rev\x18\x1a \x01(\tR\x12botConfigScriptRev\x129\n" +
	"\x19bot_config_script_content\x18\x19 \x01(\fR\x16botConfigScriptContent\x124\n" +
	"\x16system_service_account\x18\x18 \x01(\tR\x14systemServiceAccount\x12,\n" +
	"\x12logs_cloud_project\x18\x1b \x01(\tR\x10logsCloudProject\x12K\n" +
	"\rrbe_migration\x18\x1c \x01(\v2&.swarming.config.BotGroup.RBEMigrationR\frbeMigration\x1a\xa3\x01\n" +
	"\fRBEMigration\x12(\n" +
	"\x10rbe_mode_percent\x18\x01 \x01(\x05R\x0erbeModePercent\x12\"\n" +
...
var file_go_chromium_org_luci_swarming_proto_config_bots_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_go_chromium_org_luci_swarming_proto_config_bots_proto_goTypes = []any{
	...
	(*BotAuth_LuciMachineToken)(nil), // 5: swarming.config.BotAuth.LuciMachineToken
}
