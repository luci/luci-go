...
const file_go_chromium_org_luci_swarming_proto_config_bots_proto_rawDesc = "" +
	...
	"hybridModeJ\x04\b\x03\x10\x04\"\xb5\x02\n" +
	"\aBotAuth\x12\"\n" +
	"\rlog_if_failed\x18\x05 \x01(\bR\vlogIfFailed\x12;\n" +
	"\x1arequire_luci_machine_token\x18\x01 \x01(\bR\x17requireLuciMachineToken\x126\n" +
	...
	"\x03GCE\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aprojectBu\xa2\xfe#<\n" +
