...
type ExternalSchedulerConfig struct {
	...
	DisablePercent int32 `protobuf:"varint,9,opt,name=disable_percent,json=disablePercent,proto3" json:"disable_percent,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ExternalSchedulerConfig) GetDisablePercent() int32 {
	if x != nil {
...
const file_go_chromium_org_luci_swarming_proto_config_pools_proto_rawDesc = "" +
	"\n" +
	"6go.chromium.org/luci/swarming/proto/config/pools.proto\x12\x0fswarming.config\x1a7go.chromium.org/luci/swarming/proto/config/config.proto\x1a7go.chromium.org/luci/swarming/proto/config/realms.proto\x1a/go.chromium.org/luci/common/proto/options.proto\"\x88\x03\n" +
	"\bPoolsCfg\x12)\n" +
	"\x04pool\x18\x01 \x03(\v2\x15.swarming.config.PoolR\x04pool\x12]\n" +
	"\x19default_external_services\x18\x06 \x01(\v2!.swarming.config.ExternalServicesR\x17defaultExternalServices\x12B\n" +
	"\rtask_template\x18\x03 \x03(\v2\x1d.swarming.config.TaskTemplateR\ftaskTemplate\x12a\n" +
	"\x18task_template_deployment\x18\x04 \x03(\v2'.swarming.config.TaskTemplateDeploymentR\x16taskTemplateDeployment\x12E\n" +
	"\x0ebot_monitoring\x18\x05 \x03(\v2\x1e.swarming.config.BotMonitoringR\rbotMonitoringJ\x04\b\x02\x10\x03\"\xbb\v\n" +
	"\x04Pool\x12\x12\n" +
	"\x04name\x18\x01 \x03(\tR\x04name\x12\x16\n" +
	"\x06owners\x18\x02 \x03(\tR\x06owners\x12;\n" +
	"\n" +
	"schedulers\x18\x03 \x01(\v2\x1b.swarming.config.SchedulersR\n" +
	"schedulers\x12:\n" +
	"\x18task_template_deployment\x18\x06 \x01(\tH\x00R\x16taskTemplateDeployment\x12p\n" +
	"\x1ftask_template_deployment_inline\x18\a \x01(\v2'.swarming.config.TaskTemplateDeploymentH\x00R\x1ctaskTemplateDeploymentInline\x12%\n" +
	"\x0ebot_monitoring\x18\b \x01(\tR\rbotMonitoring\x12Y\n" +
	"\x13external_schedulers\x18\t \x03(\v2(.swarming.config.ExternalSchedulerConfigR\x12externalSchedulers\x12\x14\n" +
	"\x05realm\x18\n" +
	" \x01(\tR\x05realm\x12^\n" +
	"\x1aenforced_realm_permissions\x18\v \x03(\x0e2 .swarming.config.RealmPermissionR\x18enforcedRealmPermissions\x12,\n" +
	"\x12default_task_realm\x18\f \x01(\tR\x10defaultTaskRealm\x12G\n" +
	"\rrbe_migration\x18\r \x01(\v2\".swarming.config.Pool.RBEMigrationR\frbeMigration\x12\\\n" +
	"\x14scheduling_algorithm\x18\x0e \x01(\x0e2).swarming.config.Pool.SchedulingAlgorithmR\x13schedulingAlgorithm\x12<\n" +
	"\x1ainformational_dimension_re\x18\x0f \x03(\tR\x18informationalDimensionRe\x1a\xbb\x03\n" +
	"\fRBEMigration\x12!\n" +
	"\frbe_instance\x18\x01 \x01(\tR\vrbeInstance\x12(\n" +
	"\x10rbe_mode_percent\x18\x02 \x01(\x05R\x0erbeModePercent\x12d\n" +
	"\x13bot_mode_allocation\x18\x03 \x03(\v24.swarming.config.Pool.RBEMigration.BotModeAllocationR\x11botModeAllocation\x12;\n" +
	"\x1aeffective_bot_id_dimension\x18\x04 \x01(\tR\x17effectiveBotIdDimension\x1a\xba\x01\n" +
	"\x11BotModeAllocation\x12P\n" +
	"\x04mode\x18\x01 \x01(\x0e2<.swarming.config.Pool.RBEMigration.BotModeAllocation.BotModeR\x04mode\x12\x18\n" +
	"\apercent\x18\x02 \x01(\x05R\apercent\"9\n" +
	"\aBotMode\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\f\n" +
	"\bSWARMING\x10\x01\x12\n" +
	"\n" +
	...
	"\x19SCHEDULING_ALGORITHM_LIFO\x10\x02B\x18\n" +
	"\x16task_deployment_schemeJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06R\x17allowed_service_accountR\x1dallowed_service_account_group\"\x89\x01\n" +
	"\n" +
	"Schedulers\x12\x12\n" +
	"\x04user\x18\x01 \x03(\tR\x04user\x12\x14\n" +
	"\x05group\x18\x02 \x03(\tR\x05group\x12Q\n" +
	"\x12trusted_delegation\x18\x03 \x03(\v2\".swarming.config.TrustedDelegationR\x11trustedDelegation\"\x9b\x01\n" +
	"\x11TrustedDelegation\x12\x17\n" +
	"\apeer_id\x18\x01 \x01(\tR\x06peerId\x12P\n" +
	"\x0erequire_any_of\x18\x02 \x01(\v2*.swarming.config.TrustedDelegation.TagListR\frequireAnyOf\x1a\x1b\n" +
	"\aTagList\x12\x10\n" +
	"\x03tag\x18\x01 \x03(\tR\x03tag\"\xdf\x03\n" +
	"\fTaskTemplate\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\ainclude\x18\x02 \x03(\tR\ainclude\x12>\n" +
	"\x05cache\x18\x03 \x03(\v2(.swarming.config.TaskTemplate.CacheEntryR\x05cache\x12L\n" +
	"\fcipd_package\x18\x04 \x03(\v2).swarming.config.TaskTemplate.CipdPackageR\vcipdPackage\x123\n" +
	"\x03env\x18\x05 \x03(\v2!.swarming.config.TaskTemplate.EnvR\x03env\x1a4\n" +
	"\n" +
	"CacheEntry\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04path\x1aM\n" +
	"\vCipdPackage\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x10\n" +
	"\x03pkg\x18\x02 \x01(\tR\x03pkg\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x1aY\n" +
	"\x03Env\x12\x10\n" +
	"\x03var\x18\x01 \x01(\tR\x03var\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x16\n" +
	"\x06prefix\x18\x03 \x03(\tR\x06prefix\x12\x12\n" +
	"\x04soft\x18\x04 \x01(\bR\x04soft\"\xbb\x01\n" +
	"\x16TaskTemplateDeployment\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x121\n" +
	"\x04prod\x18\x02 \x01(\v2\x1d.swarming.config.TaskTemplateR\x04prod\x125\n" +
	"\x06canary\x18\x03 \x01(\v2\x1d.swarming.config.TaskTemplateR\x06canary\x12#\n" +
	"\rcanary_chance\x18\x04 \x01(\x05R\fcanaryChance\"H\n" +
	"\rBotMonitoring\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12#\n" +
	"\rdimension_key\x18\x02 \x03(\tR\fdimensionKey\"\xd4\x02\n" +
	"\x17ExternalSchedulerConfig\x12\x18\n" +
	...
	"\x13fallback_when_empty\x18\x05 \x01(\bB\x02\x18\x01R\x11fallbackWhenEmpty\x12%\n" +
	"\x0eall_dimensions\x18\x06 \x03(\tR\rallDimensions\x12%\n" +
	"\x0eany_dimensions\x18\a \x03(\tR\ranyDimensions\x12*\n" +
	"\x11allow_es_fallback\x18\b \x01(\bR\x0fallowEsFallback\x12'\n" +
	"\x0fdisable_percent\x18\t \x01(\x05R\x0edisablePercent\"\xcf\x01\n" +
	"\x10ExternalServices\x12:\n" +
	"\x04cipd\x18\x02 \x01(\v2&.swarming.config.ExternalServices.CIPDR\x04cipd\x1ay\n" +
	"\x04CIPD\x12\x16\n" +
	"\x06server\x18\x01 \x01(\tR\x06server\x12C\n" +
	"\x0eclient_package\x18\x03 \x01(\v2\x1c.swarming.config.CipdPackageR\rclientPackageJ\x04\b\x02\x10\x03R\x0eclient_versionJ\x04\b\x01\x10\x02Bv\xa2\xfe#=\n" +
	";https://config.luci.app/schemas/services/swarming:pools.cfgZ3go.chromium.org/luci/swarming/proto/config;configpbb\x06proto3"
