...
const file_go_chromium_org_luci_swarming_proto_config_realms_proto_rawDesc = "" +
	"\n" +
	"7go.chromium.org/luci/swarming/proto/config/realms.proto\x12\x0fswarming.config*\xda\x03\n" +
	...
	" REALM_PERMISSION_POOLS_LIST_BOTS\x10\a\x12(\n" +
	"$REALM_PERMISSION_POOLS_TERMINATE_BOT\x10\b\x12%\n" +
	...
	"\x12!\n" +
	"\x1dREALM_PERMISSION_TASKS_CANCEL\x10\vB5Z3go.chromium.org/luci/swarming/proto/config;configpbb\x06proto3"
