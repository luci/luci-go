...
func file_go_chromium_org_luci_swarming_proto_config_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_swarming_proto_config_config_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_swarming_proto_config_config_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
