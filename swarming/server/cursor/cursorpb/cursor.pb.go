...
func (x *Cursor) GetOpaqueCursor() *OpaqueCursor {
	if x, ok := x.GetPayload().(*Cursor_OpaqueCursor); ok {
...
func (x *Cursor) GetBotsCursor() *BotsCursor {
	if x, ok := x.GetPayload().(*Cursor_BotsCursor); ok {
		return x.BotsCursor
	}
	return nil
}
...
func (x *Cursor) GetTasksCursor() *TasksCursor {
	if x, ok := x.GetPayload().(*Cursor_TasksCursor); ok {
...
//
// Task listing can be ordered by e.g. task completion timestamp. The cursor
// thus encodes not only the last seen task ID, but also the last seen timestamp
// (it is theoretically possible many tasks have the same timestamp, so we
// need to return both pieces of data).
type TasksCursor struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The last returned task ID.
	LastTaskId string `protobuf:"bytes,1,opt,name=last_task_id,json=lastTaskId,proto3" json:"last_task_id,omitempty"`
}
...
func (x *TasksCursor) GetLastTaskId() string {
	if x != nil {
		return x.LastTaskId
	}
	return ""
...
var file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDesc = []byte{
	...
	,
...
var (
	...
	file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDescData = file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDesc
)
...
func file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Cursor); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OpaqueCursor); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BotsCursor); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TasksCursor); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_swarming_server_cursor_cursorpb_cursor_proto_rawDesc = nil
