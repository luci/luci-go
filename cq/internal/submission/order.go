...
// their dependencies. Dependency cycle is borken by arbitrarily but
// deterministically braking soft requirement dependencies and approximately
// minimizing the number of broken dependencies.
//
// Returns error if duplicate CLs are provided or the hard requirement
// dependencies solely can form a cycle (This is not possible within current
...
func compute(cls []CL) ([]CL, int, error) {
	...
	// visit returns whether cycle was detected and can't be yet resolved.
