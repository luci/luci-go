...
type Input struct {
	...
	//
	// The CLs are ordered s.t. appling them in this order minimizes number of CLs
	...
	// off arbitrarily, meaning both [A1, A2] and [A2, A1] orders are valid.
	//
	// TODO(tandrii): consider disallowing such loops in CQ.
