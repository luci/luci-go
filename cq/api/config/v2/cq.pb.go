...
// Determines how visible the results of a build for this builder is in Gerrit.
...
const (
	...
	BuildResultVisibility_Visible BuildResultVisibility = 0
	// The CQ reports a generic "Build failed: https://ci.chromium.org/b/1234"
	// with no summary markdown.
	BuildResultVisibility_Restricted BuildResultVisibility = 1
)
...
type Verifiers_Tryjob_Builder struct {
	...
	// Determines how visible the results of a build for this builder is in
	// Gerrit for this try job.
	Visibility BuildResultVisibility `protobuf:"varint,10,opt,name=visibility,proto3,enum=cq.config.BuildResultVisibility" json:"visibility,omitempty"`
...
func (m *Verifiers_Tryjob_Builder) GetVisibility() BuildResultVisibility {
	if m != nil {
		return m.Visibility
	}
	return BuildResultVisibility_Visible
}
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
