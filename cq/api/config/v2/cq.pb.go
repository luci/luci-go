...
// in CL description except those in already in `builders` or
// `includeable_builders`.
type Verifiers_Tryjob struct {
	...
	// Builders which may be added via `CQ-Include-Trybots:` in CL description.
	// If not included in CL description, CQ won't trigger or require these
	// builders.
	//
	// Must not overlap with those in `builders`.
	IncludableBuilders []*Verifiers_Tryjob_IncludableBuilder `protobuf:"bytes,4,rep,name=includable_builders,json=includableBuilders,proto3" json:"includable_builders,omitempty"`
...
func (m *Verifiers_Tryjob) GetIncludableBuilders() []*Verifiers_Tryjob_IncludableBuilder {
	if m != nil {
		return m.IncludableBuilders
	}
	return nil
}
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
