...
const (
	...
	// Full run implies ability to trigger dry run as well.
	Verifiers_GerritCQAbility_FULL_RUN Verifiers_GerritCQAbility_CQAction = 2
)
...
type Verifiers_GerritCQAbility struct {
	...
	// Allow CL owner to trigger CQ dry or full run on their own CL,
	// even if not a member of `committer_list` or `dry_run_access_list`.
	// Defaults to not such allowance.
	//
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
