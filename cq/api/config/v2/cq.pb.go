...
type BuildResultVisibility int32

const (
	BuildResultVisibility_BuildResultVisibility_UNSET BuildResultVisibility = 0
	...
	BuildResultVisibility_Full BuildResultVisibility = 1
	// The CQ reports a generic "Build failed: https://ci.chromium.org/b/1234"
	// with no summary markdown.
	BuildResultVisibility_Restricted BuildResultVisibility = 2
)

var BuildResultVisibility_name = map[int32]string{
	0: "BuildResultVisibility_UNSET",
	1: "Full",
	2: "Restricted",
}

var BuildResultVisibility_value = map[string]int32{
	"BuildResultVisibility_UNSET": 0,
	"Full":                        1,
	"Restricted":                  2,
}

func (x BuildResultVisibility) String() string {
	return proto.EnumName(BuildResultVisibility_name, int32(x))
}

func (BuildResultVisibility) EnumDescriptor() ([]byte, []int) {
...
type Verifiers_Tryjob_Builder struct {
	...
	ResultVisibility BuildResultVisibility `protobuf:"varint,10,opt,name=result_visibility,json=resultVisibility,proto3,enum=cq.config.BuildResultVisibility" json:"result_visibility,omitempty"`
...
func (m *Verifiers_Tryjob_Builder) GetResultVisibility() BuildResultVisibility {
	if m != nil {
		return m.ResultVisibility
	}
	return BuildResultVisibility_BuildResultVisibility_UNSET
}
...
func init() {
	...
	proto.RegisterEnum("cq.config.BuildResultVisibility", BuildResultVisibility_name, BuildResultVisibility_value)
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
