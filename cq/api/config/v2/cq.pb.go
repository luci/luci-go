...
const (
	TryJobResultCommentLevel_TRY_JOB_RESULT_COMMENT_LEVEL_UNSET TryJobResultCommentLevel = 0
	...
	TryJobResultCommentLevel_FULL_VISIBILITY TryJobResultCommentLevel = 1
	// The CQ reports a generic "Build failed: https://ci.chromium.org/b/1234"
	// with no summary markdown.
	TryJobResultCommentLevel_RESTRICTED_VISIBILITY TryJobResultCommentLevel = 2
)

var TryJobResultCommentLevel_name = map[int32]string{
	0: "TRY_JOB_RESULT_COMMENT_LEVEL_UNSET",
	1: "FULL_VISIBILITY",
	2: "RESTRICTED_VISIBILITY",
}

var TryJobResultCommentLevel_value = map[string]int32{
	"TRY_JOB_RESULT_COMMENT_LEVEL_UNSET": 0,
	"FULL_VISIBILITY":                    1,
...
func (m *Verifiers_Tryjob_Builder) GetResultVisibility() TryJobResultCommentLevel {
	...
	return TryJobResultCommentLevel_TRY_JOB_RESULT_COMMENT_LEVEL_UNSET
}
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
