...
type Verifiers_Tryjob_Builder struct {
	...
	// If set, this builder will only trigger when the CL owner is listed here.
	Owners               []string `protobuf:"bytes,8,rep,name=owners,proto3" json:"owners,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Verifiers_Tryjob_Builder) GetOwners() []string {
	if m != nil {
		return m.Owners
	}
	return nil
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
