...
type Verifiers_Tryjob struct {
	...
	//
	// TODO(937080): CQ won't allow adding any builder not in this list via
	// `CQ-Include-Trybots:` in CL description.
...
type Verifiers_Tryjob_Builder struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// If true, this builder won't be triggered by CQ **unless** it's specified
	// via `Cq-Include-Trybots:` (and its variants) in CL description.
	//
	// All builders specified with and without this option may be included via
	// `Cq-Include-Trybots`.
	OnlyViaClDescription bool `protobuf:"varint,9,opt,name=only_via_cl_description,json=onlyViaClDescription,proto3" json:"only_via_cl_description,omitempty"`
...
func (m *Verifiers_Tryjob_Builder) GetOnlyViaClDescription() bool {
	if m != nil {
		return m.OnlyViaClDescription
	}
	return false
}
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
