...
type ConfigGroup struct {
	...
	// Optional. If specified, CQ will consider sets dependent CLs to test and
...
// to require CQ to test & submit all CLs in a cyle at the same time, never
// alone.
//
// A user must vote on CQ label on **each CL** individually. Since it can't be
// instanteneous, `stabilization_delay` conrols how much CQ waits for all CQ+1/2
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
