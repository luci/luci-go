...
type TryjobResultCommentLevel int32

const (
	// Currently default to full visibility.
	TryjobResultCommentLevel_TRYJOB_RESULT_COMMENT_LEVEL_UNSET TryjobResultCommentLevel = 0
	...
	TryjobResultCommentLevel_TRYJOB_RESULT_COMMENT_LEVEL_FULL TryjobResultCommentLevel = 1
	// The CQ reports a generic "Build failed: https://ci.chromium.org/b/1234"
	// with no summary markdown.
	TryjobResultCommentLevel_TRYJOB_RESULT_COMMENT_LEVEL_RESTRICTED TryjobResultCommentLevel = 2
)

var TryjobResultCommentLevel_name = map[int32]string{
	0: "TRYJOB_RESULT_COMMENT_LEVEL_UNSET",
	1: "TRYJOB_RESULT_COMMENT_LEVEL_FULL",
	2: "TRYJOB_RESULT_COMMENT_LEVEL_RESTRICTED",
}

var TryjobResultCommentLevel_value = map[string]int32{
	"TRYJOB_RESULT_COMMENT_LEVEL_UNSET":      0,
	"TRYJOB_RESULT_COMMENT_LEVEL_FULL":       1,
	"TRYJOB_RESULT_COMMENT_LEVEL_RESTRICTED": 2,
}

func (x TryjobResultCommentLevel) String() string {
	return proto.EnumName(TryjobResultCommentLevel_name, int32(x))
}

func (TryjobResultCommentLevel) EnumDescriptor() ([]byte, []int) {
...
type Verifiers_Tryjob_Builder struct {
	...
	//
	// This doesn't affect the buildbucket plugin (green/red chips).
	ResultVisibility TryjobResultCommentLevel `protobuf:"varint,10,opt,name=result_visibility,json=resultVisibility,proto3,enum=cq.config.TryjobResultCommentLevel" json:"result_visibility,omitempty"`
...
func (m *Verifiers_Tryjob_Builder) GetResultVisibility() TryjobResultCommentLevel {
	if m != nil {
		return m.ResultVisibility
	}
	return TryjobResultCommentLevel_TRYJOB_RESULT_COMMENT_LEVEL_UNSET
}
...
func init() {
	...
	proto.RegisterEnum("cq.config.TryjobResultCommentLevel", TryjobResultCommentLevel_name, TryjobResultCommentLevel_value)
...
var fileDescriptor_59a2f489dbd601ec = []byte{
	...
	,
}
