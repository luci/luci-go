...
func (s *Subprocess) Wait() (build *bbpb.Build, err error) {
	// No matter what, we want to close stdout/stderr; if none of the other return
	// values have set `err`, it will be set to the result of closing
	// stdout/stderr.
	defer func() {
