...
// changes.
//
// This callback will be called as most as frequently as `rate` allows, up to
...
// silently in the background, and as soon as the callback returns, it will be
// invoked again with the current Build state.
