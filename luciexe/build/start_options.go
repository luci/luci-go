...
// changes.
//
// This callback will be called as frequently as rate allows, up to once per
// Build change, and is called with a copy of Build. Only one outstanding
// invocation of this callback can occur at once.
func OptSend(rate.Limit, func(*bbpb.Build) error) StartOption {
	panic("not implemented")
}
