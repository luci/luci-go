...
// message from stdin until EOF. It CAN expect the status of the initial Build
// message to be `STARTED` and following fields to be empty (ensured by the
// invoker as well). The Host Application or invoker MAY fill in other fields
