...
func SinkBuildUpdates(ctx context.Context, initial *bbpb.Build, sink func(*bbpb.Build)) (nc context.Context, build *Build) {
...
// DetachBuildSink allows you to take full, manual, control over manipulating
