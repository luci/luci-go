...
type Step struct {
	...
	SourceManifests map[string]*srcman.ManifestLink `protobuf:"bytes,25,rep,name=source_manifests,json=sourceManifests,proto3" json:"source_manifests,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *AnnotationLink) GetValue() isAnnotationLink_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *AnnotationLink) GetUrl() string {
	if x != nil {
		if x, ok := x.Value.(*AnnotationLink_Url); ok {
			return x.Url
		}
	}
	return ""
...
func (x *AnnotationLink) GetLogdogStream() *LogdogStream {
	if x != nil {
		if x, ok := x.Value.(*AnnotationLink_LogdogStream); ok {
...
func (x *AnnotationLink) GetIsolateObject() *IsolateObject {
	if x != nil {
		if x, ok := x.Value.(*AnnotationLink_IsolateObject); ok {
...
func (x *AnnotationLink) GetDmLink() *DMLink {
	if x != nil {
		if x, ok := x.Value.(*AnnotationLink_DmLink); ok {
			return x.DmLink
		}
	}
	return nil
...
type Step_Command struct {
	...
	Environ       map[string]string `protobuf:"bytes,3,rep,name=environ,proto3" json:"environ,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Step_Substep) GetSubstep() isStep_Substep_Substep {
	if x != nil {
		return x.Substep
	}
	return nil
...
func (x *Step_Substep) GetStep() *Step {
	if x != nil {
		if x, ok := x.Substep.(*Step_Substep_Step); ok {
			return x.Step
		}
	}
	return nil
...
func (x *Step_Substep) GetAnnotationStream() *LogdogStream {
	if x != nil {
		if x, ok := x.Substep.(*Step_Substep_AnnotationStream); ok {
...
var file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDesc), len(file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDesc)))
	})
...
func file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDesc), len(file_go_chromium_org_luci_luciexe_legacy_annotee_proto_annotations_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
