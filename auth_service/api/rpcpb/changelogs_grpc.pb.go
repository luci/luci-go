...
func (c *changeLogsClient) ListChangeLogs(ctx context.Context, in *ListChangeLogsRequest, opts ...grpc.CallOption) (*ListChangeLogsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChangeLogs_ListChangeLogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedChangeLogsServer must be embedded to have
...
func (UnimplementedChangeLogsServer) testEmbeddedByValue()                    {}
...
func RegisterChangeLogsServer(s grpc.ServiceRegistrar, srv ChangeLogsServer) {
	// If the following call pancis, it indicates UnimplementedChangeLogsServer was
