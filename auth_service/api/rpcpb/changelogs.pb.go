...
type AuthDBChange struct {
	...
	ProjectsRevOld string `protobuf:"bytes,33,opt,name=projects_rev_old,json=projectsRevOld,proto3" json:"projects_rev_old,omitempty"`
	ProjectsRevNew string `protobuf:"bytes,34,opt,name=projects_rev_new,json=projectsRevNew,proto3" json:"projects_rev_new,omitempty"`
...
func (x *AuthDBChange) GetProjectsRevOld() string {
	if x != nil {
		return x.ProjectsRevOld
	}
	return ""
}

func (x *AuthDBChange) GetProjectsRevNew() string {
	if x != nil {
		return x.ProjectsRevNew
	}
	return ""
}
...
const file_go_chromium_org_luci_auth_service_api_rpcpb_changelogs_proto_rawDesc = "" +
	...
	"\x10projects_rev_old\x18! \x01(\tR\x0eprojectsRevOld\x12(\n" +
	"\x10projects_rev_new\x18\" \x01(\tR\x0eprojectsRevNew\x12!\n" +
