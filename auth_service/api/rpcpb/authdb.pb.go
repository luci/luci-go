...
var file_go_chromium_org_luci_auth_service_api_rpcpb_authdb_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_auth_service_api_rpcpb_authdb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_auth_service_api_rpcpb_authdb_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_auth_service_api_rpcpb_authdb_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
