...
// NoopTrigger is used by tests to represent test triggers.
...
// GitilesTrigger is used by trigger sources that watch Gitiles.
//
// Such triggers are emitted whenever repository state changes.
