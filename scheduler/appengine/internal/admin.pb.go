...
func (*InternalJobState) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_fbc55201b62d1442, []int{0}
}
...
func (*InternalJobState_CronState) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_fbc55201b62d1442, []int{0, 0}
}
...
type AdminClient interface {
	...
	//
	// Usable when debugging internal issues.
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/scheduler/appengine/internal/admin.proto", fileDescriptor_admin_fbc55201b62d1442)
}

var fileDescriptor_admin_fbc55201b62d1442 = []byte{
