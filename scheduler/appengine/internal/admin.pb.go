...
func (x *DebugJobState) GetLastTriage() *timestamp.Timestamp {
	if x != nil {
		return x.LastTriage
	}
	return nil
...
func (x *DebugJobState_CronState) GetLastRewind() *timestamp.Timestamp {
	if x != nil {
		return x.LastRewind
	}
	return nil
...
func (x *DebugJobState_CronState) GetLastTickWhen() *timestamp.Timestamp {
	if x != nil {
...
var file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDesc = []byte{
	...
	0x75, 0x67, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x69, 0x6e,
...
var (
	...
	file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDescData = file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDesc
)
...
func file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DebugJobState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DebugManagerState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DebugJobState_CronState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_scheduler_appengine_internal_admin_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
