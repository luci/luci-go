...
// AbortInvocationTask aborts a pending or running invocation.
//
// It is enqueued transactionally inside AbortInvocation handler.
//
// Queue: "aborts".
type AbortInvocationTask struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	JobId         string                 `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`
	InvId         int64                  `protobuf:"varint,2,opt,name=inv_id,json=invId,proto3" json:"inv_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *AbortInvocationTask) Reset() {
	*x = AbortInvocationTask{}
	mi := &file_go_chromium_org_luci_scheduler_appengine_internal_tq_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AbortInvocationTask) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AbortInvocationTask) ProtoMessage() {}

func (x *AbortInvocationTask) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_scheduler_appengine_internal_tq_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AbortInvocationTask.ProtoReflect.Descriptor instead.
func (*AbortInvocationTask) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_scheduler_appengine_internal_tq_proto_rawDescGZIP(), []int{11}
}

func (x *AbortInvocationTask) GetJobId() string {
	if x != nil {
		return x.JobId
	}
	return ""
...
func (x *AbortInvocationTask) GetInvId() int64 {
	if x != nil {
		return x.InvId
	}
	return 0
...
const file_go_chromium_org_luci_scheduler_appengine_internal_tq_proto_rawDesc = "" +
	"\n" +
	":go.chromium.org/luci/scheduler/appengine/internal/tq.proto\x12\vinternal.tq\x1a>go.chromium.org/luci/scheduler/appengine/internal/timers.proto\x1a@go.chromium.org/luci/scheduler/appengine/internal/triggers.proto\"6\n" +
	"\x15ReadProjectConfigTask\x12\x1d\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tR\tprojectId\"D\n" +
	"\x14LaunchInvocationTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x15\n" +
	"\x06inv_id\x18\x02 \x01(\x03R\x05invId\"U\n" +
	"\x1aLaunchInvocationsBatchTask\x127\n" +
	"\x05tasks\x18\x01 \x03(\v2!.internal.tq.LaunchInvocationTaskR\x05tasks\"+\n" +
	"\x12TriageJobStateTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\"'\n" +
	"\x0eKickTriageTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\"\x83\x01\n" +
	"\x16InvocationFinishedTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x15\n" +
	"\x06inv_id\x18\x02 \x01(\x03R\x05invId\x12;\n" +
	"\btriggers\x18\x03 \x01(\v2\x1f.internal.tq.FanOutTriggersTaskR\btriggers\"e\n" +
	"\x12FanOutTriggersTask\x12\x17\n" +
	"\ajob_ids\x18\x01 \x03(\tR\x06jobIds\x126\n" +
	"\btriggers\x18\x02 \x03(\v2\x1a.internal.triggers.TriggerR\btriggers\"d\n" +
	"\x13EnqueueTriggersTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x126\n" +
	"\btriggers\x18\x02 \x03(\v2\x1a.internal.triggers.TriggerR\btriggers\"r\n" +
	"\x12ScheduleTimersTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x15\n" +
	"\x06inv_id\x18\x02 \x01(\x03R\x05invId\x12.\n" +
	"\x06timers\x18\x03 \x03(\v2\x16.internal.timers.TimerR\x06timers\"g\n" +
	"\tTimerTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x15\n" +
	"\x06inv_id\x18\x02 \x01(\x03R\x05invId\x12,\n" +
	"\x05timer\x18\x03 \x01(\v2\x16.internal.timers.TimerR\x05timer\"D\n" +
	"\fCronTickTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x1d\n" +
	"\n" +
	"tick_nonce\x18\x02 \x01(\x03R\ttickNonce\"C\n" +
	"\x13AbortInvocationTask\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x15\n" +
	"\x06inv_id\x18\x02 \x01(\x03R\x05invIdB3Z1go.chromium.org/luci/scheduler/appengine/internalb\x06proto3"
...
var file_go_chromium_org_luci_scheduler_appengine_internal_tq_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_go_chromium_org_luci_scheduler_appengine_internal_tq_proto_goTypes = []any{
	...
	(*AbortInvocationTask)(nil),        // 11: internal.tq.AbortInvocationTask
	(*Trigger)(nil),                    // 12: internal.triggers.Trigger
	(*Timer)(nil),                      // 13: internal.timers.Timer
}
var file_go_chromium_org_luci_scheduler_appengine_internal_tq_proto_depIdxs = []int32{
	...
	12, // 2: internal.tq.FanOutTriggersTask.triggers:type_name -> internal.triggers.Trigger
	12, // 3: internal.tq.EnqueueTriggersTask.triggers:type_name -> internal.triggers.Trigger
	13, // 4: internal.tq.ScheduleTimersTask.timers:type_name -> internal.timers.Timer
	13, // 5: internal.tq.TimerTask.timer:type_name -> internal.timers.Timer
