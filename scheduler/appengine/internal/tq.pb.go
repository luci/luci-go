...
//
// It is enqueued transactionally when the job changes state (e.g. appears for
// the first time) or from previous cron ticks. Results in a cron state machine
// change, which decided what to do next.
//
// Queue: "crons".
