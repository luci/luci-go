...
func (x *Timer) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *Timer) GetEta() *timestamp.Timestamp {
	if x != nil {
		return x.Eta
	}
	return nil
...
var file_go_chromium_org_luci_scheduler_appengine_internal_timers_proto_rawDesc = []byte{
	...
	0x54, 0x69, 0x6d, 0x65, 0x72, 0x52, 0x06, 0x74, 0x69, 0x6d, 0x65, 0x72, 0x73, 0x42, 0x0a, 0x5a,
