...
func (x *Trigger) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
var file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x42, 0x0a, 0x5a, 0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDescOnce sync.Once
	file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDescData = file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDesc
)
...
func file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Trigger_Cron)(nil),
		(*Trigger_Webui)(nil),
		(*Trigger_Noop)(nil),
		(*Trigger_Gitiles)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_scheduler_appengine_internal_triggers_proto_rawDesc = nil
