...
type Acl struct {
	...
	Role Acl_Role `protobuf:"varint,1,opt,name=role,enum=luci.scheduler.config.Acl_Role" json:"role,omitempty"`
...
type TriggeringPolicy struct {
	...
	Kind TriggeringPolicy_Kind `protobuf:"varint,1,opt,name=kind,enum=luci.scheduler.config.TriggeringPolicy_Kind" json:"kind,omitempty"`
...
func init() {
	proto.RegisterType((*ProjectConfig)(nil), "luci.scheduler.config.ProjectConfig")
	proto.RegisterType((*Acl)(nil), "luci.scheduler.config.Acl")
	proto.RegisterType((*AclSet)(nil), "luci.scheduler.config.AclSet")
	proto.RegisterType((*TriggeringPolicy)(nil), "luci.scheduler.config.TriggeringPolicy")
	proto.RegisterType((*Job)(nil), "luci.scheduler.config.Job")
	proto.RegisterType((*Trigger)(nil), "luci.scheduler.config.Trigger")
	proto.RegisterType((*NoopTask)(nil), "luci.scheduler.config.NoopTask")
	proto.RegisterType((*GitilesTask)(nil), "luci.scheduler.config.GitilesTask")
	proto.RegisterType((*UrlFetchTask)(nil), "luci.scheduler.config.UrlFetchTask")
	proto.RegisterType((*BuildbucketTask)(nil), "luci.scheduler.config.BuildbucketTask")
	proto.RegisterType((*TaskDefWrapper)(nil), "luci.scheduler.config.TaskDefWrapper")
	proto.RegisterEnum("luci.scheduler.config.Acl_Role", Acl_Role_name, Acl_Role_value)
	proto.RegisterEnum("luci.scheduler.config.TriggeringPolicy_Kind", TriggeringPolicy_Kind_name, TriggeringPolicy_Kind_value)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
