...
type GitilesTask struct {
	...
	// Names of other jobs which should be triggered upon changes in refs.
	// Upon triggering, if job isn't running, it'll be scheduled for immediate
	// execution. If job is already running, a new invocation will be scheduled
	// immediately upon current one completion.
	//
	// The jobs to trigger can be of any kind, but only BuildbucketTask will
	// make use of triggering info such as new ref's revision.
	JobsToTrigger []string `protobuf:"bytes,3,rep,name=jobs_to_trigger,json=jobsToTrigger" json:"jobs_to_trigger,omitempty"`
}
...
func (m *GitilesTask) GetJobsToTrigger() []string {
	if m != nil {
		return m.JobsToTrigger
	}
	return nil
}
...
var fileDescriptor0 = []byte{
	...
	,
}
