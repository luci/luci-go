...
func (m TaskManager) LaunchTask(c context.Context, ctl task.Controller) error {
	...
	refs.pruneKnown(ctl)
	m.emitTriggersRefAtATime(c, ctl, cfg.Repo, refs)
	...
	ctl.DebugLog("%d changed refs processed", refs.changed)
...
func (m TaskManager) emitTriggersRefAtATime(c context.Context, ctl task.Controller, repo string, refs *refsState) {
