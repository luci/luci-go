...
//
// ACLs are enforced with the following implication: if caller lacks READER
// access to Jobs, methods behave as if Jobs do not exist.
//
...
//
// Returns ErrNoSuchJob otherwise (based on ACLs).
