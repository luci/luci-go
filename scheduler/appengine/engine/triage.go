...
//
// It "atomically" pops pending triggers/events, producing invocations or other
// events along the way.
//
// The body of this method may be retried multiple times (when transaction is
// retried)!
...
//
// Called withing a transaction. Mutates job. Returns an open dsset.PopOp that
