...
// Empty is true if both 'Items' and 'Garbage' are empty
func (l *Listing) Empty() bool {
	return len(l.Items) == 0 && len(l.Garbage) == 0
}
...
//
// The set of tombstones to cleanup can be passed to 'CleanupGarbage', and
