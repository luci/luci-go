...
// requestFromTriggers examines zero or mote triggers and derives a request for
// new invocation based on them.
//
// Currently picks the values from most recent triggers and disregards
// properties of the rest of time.
