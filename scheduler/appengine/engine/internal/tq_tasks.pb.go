...
func (*TickLaterTask) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*StartInvocationTask) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/scheduler/appengine/engine/internal/tq_tasks.proto", fileDescriptor1)
}
