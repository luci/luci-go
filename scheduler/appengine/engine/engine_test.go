...
func TestFullFlow(t *testing.T) {
	Convey("full flow", t, func() {
		...
		So(getSentMetric(c, metricInvocationsCompleted, "abc/1", "SUCCEEDED"), ShouldEqual, 1)
...
func TestRecordOverrun(t *testing.T) {
	Convey("RecordOverrun works", t, func(ctx C) {
		...
		So(getSentMetric(c, metricInvocationsCompleted, "abc/1", "OVERRUN"), ShouldEqual, 1)
		So(getSentMetric(c, metricInvocationsDurations, "abc/1", "OVERRUN"), ShouldNotBeNil)
	})
}
...
func TestAborts(t *testing.T) {
	Convey("with mock invocation", t, func() {
		...
		Convey("AbortInvocation works", func() {
			...
			So(getSentMetric(c, metricInvocationsCompleted, jobID, "ABORTED"), ShouldEqual, 1)
...
func TestAddTimer(t *testing.T) {
	Convey("with mock job", t, func() {
		...
		Convey("AddTimer works", func() {
			...
			So(getSentMetric(c, metricInvocationsCompleted, jobID, "SUCCEEDED"), ShouldEqual, 1)
