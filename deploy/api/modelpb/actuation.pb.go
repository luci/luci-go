...
type ActuatorInfo struct {
	...
	Buildbucket string `protobuf:"bytes,1,opt,name=buildbucket,proto3" json:"buildbucket,omitempty"`
	// Buildbucket builder running the actuation, as "project/bucket/name".
	BuildbucketBuilder string `protobuf:"bytes,2,opt,name=buildbucket_builder,json=buildbucketBuilder,proto3" json:"buildbucket_builder,omitempty"`
	// Buildbucket build ID of the build running the actuation.
	BuildbucketBuild int64 `protobuf:"varint,3,opt,name=buildbucket_build,json=buildbucketBuild,proto3" json:"buildbucket_build,omitempty"`
	...
	SchedulerJob string `protobuf:"bytes,5,opt,name=scheduler_job,json=schedulerJob,proto3" json:"scheduler_job,omitempty"`
	// Scheduler invocation ID that triggered the build.
	SchedulerInvocation int64 `protobuf:"varint,6,opt,name=scheduler_invocation,json=schedulerInvocation,proto3" json:"scheduler_invocation,omitempty"`
}
...
var file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x0a, 0x09, 0x41, 0x4e, 0x54, 0x49, 0x53, 0x54, 0x4f, 0x4d, 0x50, 0x10, 0x02, 0x22, 0x45, 0x0a,
	...
	0x45, 0x44, 0x10, 0x03, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d,
...
var (
	...
	file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDescData = file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDesc
)
...
func file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDescData)
	})
	return file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDescData
}

var file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_goTypes = []interface{}{
	...
	(*Actuation)(nil),             // 3: deploy.model.Actuation
	(*ActuatorInfo)(nil),          // 4: deploy.model.ActuatorInfo
	(*ActuationTrigger)(nil),      // 5: deploy.model.ActuationTrigger
	(*ActuationLock)(nil),         // 6: deploy.model.ActuationLock
	(*Deployment)(nil),            // 7: deploy.model.Deployment
...
var file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_depIdxs = []int32{
	...
	7,  // 1: deploy.model.Actuation.deployment:type_name -> deploy.model.Deployment
	4,  // 2: deploy.model.Actuation.actuator:type_name -> deploy.model.ActuatorInfo
	5,  // 3: deploy.model.Actuation.triggers:type_name -> deploy.model.ActuationTrigger
	8,  // 4: deploy.model.Actuation.created:type_name -> google.protobuf.Timestamp
	8,  // 5: deploy.model.Actuation.finished:type_name -> google.protobuf.Timestamp
	8,  // 6: deploy.model.Actuation.expiry:type_name -> google.protobuf.Timestamp
	9,  // 7: deploy.model.Actuation.status:type_name -> google.rpc.Status
	...
	8,  // 10: deploy.model.ActuationLock.created:type_name -> google.protobuf.Timestamp
	8,  // 11: deploy.model.ActuationLock.removed:type_name -> google.protobuf.Timestamp
	8,  // 12: deploy.model.ActuationLock.expiry:type_name -> google.protobuf.Timestamp
...
func file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Actuation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActuationTrigger); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActuationLock); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_rawDesc = nil
