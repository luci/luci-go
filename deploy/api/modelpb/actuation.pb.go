...
func file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_deploy_api_modelpb_actuation_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActuationDecisions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
