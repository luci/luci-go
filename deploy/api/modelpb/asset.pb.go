...
func (AppengineState_Service_TrafficSplitting) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 0, 0}
}
...
func (AppengineState_CapturedState_DatabaseType) EnumDescriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 2, 0}
}
...
type Asset struct {
	...
	Config *AssetConfig `protobuf:"bytes,4,opt,name=config,proto3" json:"config,omitempty"`
	...
	IntendedState *AssetState `protobuf:"bytes,5,opt,name=intended_state,json=intendedState,proto3" json:"intended_state,omitempty"`
	// The actual state of the asset as reported by the actuator most recently.
	//
	// Matches some real observed state of the asset, regardless how this state
	// came to be.
	//
	// Has its `state` oneof populated according to the asset kind using
	...
	ReportedState *AssetState `protobuf:"bytes,6,opt,name=reported_state,json=reportedState,proto3" json:"reported_state,omitempty"`
	...
	ActuatedState *AssetState `protobuf:"bytes,7,opt,name=actuated_state,json=actuatedState,proto3" json:"actuated_state,omitempty"`
	...
	// protection.
	PostActuationStatus *status.Status `protobuf:"bytes,8,opt,name=post_actuation_status,json=postActuationStatus,proto3" json:"post_actuation_status,omitempty"`
}
...
type AppengineState_Service struct {
	...
	TrafficAllocation map[string]int32 `protobuf:"bytes,4,rep,name=traffic_allocation,json=trafficAllocation,proto3" json:"traffic_allocation,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (*AppengineState_Service) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 0}
}
...
func (*AppengineState_IntendedState) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 1}
}
...
func (*AppengineState_CapturedState) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 2}
}
...
type AppengineState_Service_Version_IntendedState struct {
	...
	LuciVars map[string]string `protobuf:"bytes,3,rep,name=luci_vars,json=luciVars,proto3" json:"luci_vars,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *AppengineState_Service_Version_IntendedState) Reset() {
	*x = AppengineState_Service_Version_IntendedState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AppengineState_Service_Version_IntendedState) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 0, 0, 0}
}
...
func (*AppengineState_Service_Version_CapturedState) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 0, 0, 1}
}
...
func (x *AppengineState_IntendedState_DeployableYaml) Reset() {
	*x = AppengineState_IntendedState_DeployableYaml{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AppengineState_IntendedState_DeployableYaml) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDescGZIP(), []int{3, 1, 0}
}
...
var file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdb, 0x03, 0x0a, 0x05, 0x41, 0x73, 0x73,
	...
	0x44, 0x65, 0x63, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20,
	...
	0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x06,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x13, 0x0a, 0x0f, 0x43, 0x4c, 0x4f, 0x55, 0x44, 0x5f, 0x44, 0x41, 0x54, 0x41, 0x53, 0x54, 0x4f,
	0x52, 0x45, 0x10, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x43, 0x4c, 0x4f, 0x55, 0x44, 0x5f, 0x46, 0x49,
	0x52, 0x45, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x10, 0x02, 0x12, 0x21, 0x0a, 0x1d, 0x43, 0x4c, 0x4f,
	0x55, 0x44, 0x5f, 0x44, 0x41, 0x54, 0x41, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x5f, 0x43, 0x4f, 0x4d,
	0x50, 0x41, 0x54, 0x49, 0x42, 0x49, 0x4c, 0x49, 0x54, 0x59, 0x10, 0x03, 0x42, 0x29, 0x5a, 0x27,
	0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d, 0x2e, 0x6f, 0x72, 0x67, 0x2f,
	0x6c, 0x75, 0x63, 0x69, 0x2f, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
var file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_goTypes = []interface{}{
	...
	(*AssetConfig)(nil),                    // 3: deploy.model.AssetConfig
	(*AssetState)(nil),                     // 4: deploy.model.AssetState
	(*AppengineState)(nil),                 // 5: deploy.model.AppengineState
	(*AppengineState_Service)(nil),         // 6: deploy.model.AppengineState.Service
	(*AppengineState_IntendedState)(nil),   // 7: deploy.model.AppengineState.IntendedState
	(*AppengineState_CapturedState)(nil),   // 8: deploy.model.AppengineState.CapturedState
	(*AppengineState_Service_Version)(nil), // 9: deploy.model.AppengineState.Service.Version
	nil,                                    // 10: deploy.model.AppengineState.Service.TrafficAllocationEntry
	(*AppengineState_Service_Version_IntendedState)(nil), // 11: deploy.model.AppengineState.Service.Version.IntendedState
	(*AppengineState_Service_Version_CapturedState)(nil), // 12: deploy.model.AppengineState.Service.Version.CapturedState
	nil, // 13: deploy.model.AppengineState.Service.Version.IntendedState.LuciVarsEntry
	(*AppengineState_IntendedState_DeployableYaml)(nil), // 14: deploy.model.AppengineState.IntendedState.DeployableYaml
	(*Actuation)(nil),             // 15: deploy.model.Actuation
	(*ActuationDecision)(nil),     // 16: deploy.model.ActuationDecision
	(*status.Status)(nil),         // 17: google.rpc.Status
	(*timestamppb.Timestamp)(nil), // 18: google.protobuf.Timestamp
	(*Deployment)(nil),            // 19: deploy.model.Deployment
	(*ActuatorInfo)(nil),          // 20: deploy.model.ActuatorInfo
	(*ArtifactID)(nil),            // 21: deploy.model.ArtifactID
}
var file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_depIdxs = []int32{
	15, // 0: deploy.model.Asset.last_actuation:type_name -> deploy.model.Actuation
	16, // 1: deploy.model.Asset.last_decision:type_name -> deploy.model.ActuationDecision
	3,  // 2: deploy.model.Asset.config:type_name -> deploy.model.AssetConfig
	4,  // 3: deploy.model.Asset.intended_state:type_name -> deploy.model.AssetState
	4,  // 4: deploy.model.Asset.reported_state:type_name -> deploy.model.AssetState
	4,  // 5: deploy.model.Asset.actuated_state:type_name -> deploy.model.AssetState
	17, // 6: deploy.model.Asset.post_actuation_status:type_name -> google.rpc.Status
	18, // 7: deploy.model.AssetState.timestamp:type_name -> google.protobuf.Timestamp
	19, // 8: deploy.model.AssetState.deployment:type_name -> deploy.model.Deployment
	20, // 9: deploy.model.AssetState.actuator:type_name -> deploy.model.ActuatorInfo
	17, // 10: deploy.model.AssetState.status:type_name -> google.rpc.Status
	5,  // 11: deploy.model.AssetState.appengine:type_name -> deploy.model.AppengineState
	6,  // 12: deploy.model.AppengineState.services:type_name -> deploy.model.AppengineState.Service
	7,  // 13: deploy.model.AppengineState.intended_state:type_name -> deploy.model.AppengineState.IntendedState
	8,  // 14: deploy.model.AppengineState.captured_state:type_name -> deploy.model.AppengineState.CapturedState
	9,  // 15: deploy.model.AppengineState.Service.versions:type_name -> deploy.model.AppengineState.Service.Version
	0,  // 16: deploy.model.AppengineState.Service.traffic_splitting:type_name -> deploy.model.AppengineState.Service.TrafficSplitting
	10, // 17: deploy.model.AppengineState.Service.traffic_allocation:type_name -> deploy.model.AppengineState.Service.TrafficAllocationEntry
	14, // 18: deploy.model.AppengineState.IntendedState.deployable_yamls:type_name -> deploy.model.AppengineState.IntendedState.DeployableYaml
	1,  // 19: deploy.model.AppengineState.CapturedState.database_type:type_name -> deploy.model.AppengineState.CapturedState.DatabaseType
	11, // 20: deploy.model.AppengineState.Service.Version.intended_state:type_name -> deploy.model.AppengineState.Service.Version.IntendedState
	12, // 21: deploy.model.AppengineState.Service.Version.captured_state:type_name -> deploy.model.AppengineState.Service.Version.CapturedState
	21, // 22: deploy.model.AppengineState.Service.Version.IntendedState.artifact:type_name -> deploy.model.ArtifactID
	13, // 23: deploy.model.AppengineState.Service.Version.IntendedState.luci_vars:type_name -> deploy.model.AppengineState.Service.Version.IntendedState.LuciVarsEntry
	18, // 24: deploy.model.AppengineState.Service.Version.CapturedState.create_time:type_name -> google.protobuf.Timestamp
	21, // 25: deploy.model.AppengineState.IntendedState.DeployableYaml.artifact:type_name -> deploy.model.ArtifactID
...
func file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppengineState_Service); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppengineState_IntendedState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppengineState_CapturedState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppengineState_Service_Version); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppengineState_Service_Version_IntendedState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppengineState_Service_Version_CapturedState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_deploy_api_modelpb_asset_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppengineState_IntendedState_DeployableYaml); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
