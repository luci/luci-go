...
module.exports = {
    ...
    /**
     * The test env is JSDom as it enables us to use `window` and other browser specific variables.
     */
    ...
    /**
     * This allows components to import styling files without failing the jest build.
     */
    moduleNameMapper: {
