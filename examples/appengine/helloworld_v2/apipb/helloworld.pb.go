...
var file_go_chromium_org_luci_examples_appengine_helloworld_v2_apipb_helloworld_proto_rawDesc = string([]byte{
...
var file_go_chromium_org_luci_examples_appengine_helloworld_v2_apipb_helloworld_proto_goTypes = []any{
...
func file_go_chromium_org_luci_examples_appengine_helloworld_v2_apipb_helloworld_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_examples_appengine_helloworld_v2_apipb_helloworld_proto_rawDesc), len(file_go_chromium_org_luci_examples_appengine_helloworld_v2_apipb_helloworld_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
