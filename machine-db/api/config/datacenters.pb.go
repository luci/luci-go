...
func (x *Switch) GetState() common.State {
	if x != nil {
		return x.State
	}
...
type KVM struct {
	...
	State common.State `protobuf:"varint,7,opt,name=state,proto3,enum=common.State" json:"state,omitempty"`
}
...
func (x *Rack) GetState() common.State {
	if x != nil {
		return x.State
	}
	return common.State_STATE_UNSPECIFIED
...
var file_go_chromium_org_luci_machine_db_api_config_v1_datacenters_proto_rawDesc = []byte{
	...
	0x2d, 0x64, 0x62, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x62, 0x06,
