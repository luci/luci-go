...
func (*VLAN) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*ListVLANsRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*ListVLANsResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/machine-db/api/crimson/v1/vlans.proto", fileDescriptor10)
}
