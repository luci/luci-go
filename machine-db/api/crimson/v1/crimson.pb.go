...
type CrimsonClient interface {
	...
	// Lists IP addresses in the database.
...
func (c *crimsonPRPCClient) ListIPs(ctx context.Context, in *ListIPsRequest, opts ...grpc.CallOption) (*ListIPsResponse, error) {
	out := new(ListIPsResponse)
	err := c.client.Call(ctx, "crimson.Crimson", "ListIPs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crimsonClient) ListIPs(ctx context.Context, in *ListIPsRequest, opts ...grpc.CallOption) (*ListIPsResponse, error) {
	out := new(ListIPsResponse)
	err := grpc.Invoke(ctx, "/crimson.Crimson/ListIPs", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Crimson_ListIPs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListIPsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CrimsonServer).ListIPs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crimson.Crimson/ListIPs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrimsonServer).ListIPs(ctx, req.(*ListIPsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Crimson_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListIPs",
			Handler:    _Crimson_ListIPs_Handler,
		},
		{
			MethodName: "ListOSes",
...
var fileDescriptor0 = []byte{
	...
	,
}
