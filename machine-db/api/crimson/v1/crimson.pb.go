...
It is generated from these files:
	...
	go.chromium.org/luci/machine-db/api/crimson/v1/errors.proto
...
func (c *crimsonPRPCClient) AddMachine(ctx context.Context, in *AddMachineRequest, opts ...grpc.CallOption) (*AddMachineResponse, error) {
	out := new(AddMachineResponse)
	err := c.client.Call(ctx, "crimson.Crimson", "AddMachine", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crimsonPRPCClient) GetMachines(ctx context.Context, in *GetMachinesRequest, opts ...grpc.CallOption) (*GetMachinesResponse, error) {
	out := new(GetMachinesResponse)
	err := c.client.Call(ctx, "crimson.Crimson", "GetMachines", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crimsonClient) AddMachine(ctx context.Context, in *AddMachineRequest, opts ...grpc.CallOption) (*AddMachineResponse, error) {
	out := new(AddMachineResponse)
	err := grpc.Invoke(ctx, "/crimson.Crimson/AddMachine", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crimsonClient) GetMachines(ctx context.Context, in *GetMachinesRequest, opts ...grpc.CallOption) (*GetMachinesResponse, error) {
	out := new(GetMachinesResponse)
	err := grpc.Invoke(ctx, "/crimson.Crimson/GetMachines", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Crimson_AddMachine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddMachineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CrimsonServer).AddMachine(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crimson.Crimson/AddMachine",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrimsonServer).AddMachine(ctx, req.(*AddMachineRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Crimson_GetMachines_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMachinesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CrimsonServer).GetMachines(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crimson.Crimson/GetMachines",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrimsonServer).GetMachines(ctx, req.(*GetMachinesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Crimson_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Crimson_AddMachine_Handler,
		},
		{
			MethodName: "GetMachines",
			Handler:    _Crimson_GetMachines_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
