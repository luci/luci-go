...
It is generated from these files:
	...
	go.chromium.org/luci/machine-db/api/crimson/v1/vm_slots.proto
...
func (c *crimsonClient) UpdateDRAC(ctx context.Context, in *UpdateDRACRequest, opts ...grpc.CallOption) (*DRAC, error) {
	out := new(DRAC)
	err := grpc.Invoke(ctx, "/crimson.Crimson/UpdateDRAC", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crimsonClient) FindVMSlots(ctx context.Context, in *FindVMSlotsRequest, opts ...grpc.CallOption) (*FindVMSlotsResponse, error) {
	out := new(FindVMSlotsResponse)
	err := grpc.Invoke(ctx, "/crimson.Crimson/FindVMSlots", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	,
}
