...
func (*UnimplementedCrimsonServer) DeleteMachine(context.Context, *DeleteMachineRequest) (*empty.Empty, error) {
...
func (*UnimplementedCrimsonServer) DeleteNIC(context.Context, *DeleteNICRequest) (*empty.Empty, error) {
...
func (*UnimplementedCrimsonServer) DeleteHost(context.Context, *DeleteHostRequest) (*empty.Empty, error) {
