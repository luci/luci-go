...
func (*Rack) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*ListRacksRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*ListRacksResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/machine-db/api/crimson/v1/racks.proto", fileDescriptor10)
}
