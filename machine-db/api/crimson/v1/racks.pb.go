...
func (*Rack) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*ListRacksRequest) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*ListRacksResponse) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/machine-db/api/crimson/v1/racks.proto", fileDescriptor7)
}
