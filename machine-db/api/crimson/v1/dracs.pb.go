...
type DRAC struct {
	// The name of this DRAC on the network. With machine, uniquely identifies this DRAC.
	// Must be unique per VLAN.
	Name string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// The machine this DRAC belongs to. With name, uniquely identifies this DRAC.
