...
func (x *PhysicalHost) GetState() common.State {
	if x != nil {
		return x.State
	}
...
type ListPhysicalHostsRequest struct {
	...
	States []common.State `protobuf:"varint,6,rep,packed,name=states,proto3,enum=common.State" json:"states,omitempty"`
...
func (x *ListPhysicalHostsRequest) GetStates() []common.State {
	if x != nil {
		return x.States
	}
	return nil
...
var file_go_chromium_org_luci_machine_db_api_crimson_v1_physical_hosts_proto_rawDesc = []byte{
	...
	0x73, 0x6b, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75,
