...
type Machine struct {
	...
	State common.State `protobuf:"varint,8,opt,name=state,proto3,enum=common.State" json:"state,omitempty"`
...
func (x *Machine) GetState() common.State {
	if x != nil {
		return x.State
	}
...
type ListMachinesRequest struct {
	...
	States []common.State `protobuf:"varint,4,rep,packed,name=states,proto3,enum=common.State" json:"states,omitempty"`
...
func (x *ListMachinesRequest) GetStates() []common.State {
	if x != nil {
		return x.States
	}
	return nil
...
var file_go_chromium_org_luci_machine_db_api_crimson_v1_machines_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72,
	...
	0x69, 0x6d, 0x73, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
