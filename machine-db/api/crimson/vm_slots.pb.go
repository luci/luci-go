...
func (x *FindVMSlotsRequest) GetStates() []common.State {
	if x != nil {
		return x.States
	}
	return nil
...
var file_go_chromium_org_luci_machine_db_api_crimson_v1_vm_slots_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x05, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x6f, 0x2e, 0x63,
