...
-- Required fields and foreign key contraints are not enforced by this schema.
-- The Machine Database will enforce these contraints as well as validating field values.
