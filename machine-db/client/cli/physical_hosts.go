...
import (
	...
	"go.chromium.org/luci/common/flag/int32flag"
...
func (c *AddPhysicalHostCmd) Run(app subcommands.Application, args []string, env subcommands.Env) int {
	...
	c.host.VmSlots = c.vmSlots.Get().(int32)
...
func addPhysicalHostCmd() *subcommands.Command {
	return &subcommands.Command{
		...
		CommandRun: func() subcommands.CommandRun {
			...
			cmd.Flags.Var(&cmd.vmSlots, "slots", "The number of VMs which can be deployed on this host.")
