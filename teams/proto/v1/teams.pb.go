...
var file_go_chromium_org_luci_teams_proto_v1_teams_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_teams_proto_v1_teams_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_teams_proto_v1_teams_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_teams_proto_v1_teams_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Team); i {
			case 0:
				return &v.state
			case 1:
