...
//
// It knows how to run all *.star tests from some particular directory, addding
...
type Options struct {
	...
	// Executor runs single starlark test file 'path', given verbatim as 'body'.
	//
	// If nil, RunStarlarkTests will simply use starlark.ExecFile.
