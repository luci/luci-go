...
//
// This is Starlark => Proto converter. If you want to do a light type check
// only, use prepProtoSingular instead.
...
func prepProtoSingular(fd protoreflect.FieldDescriptor, v starlark.Value) (instantiator, error) {
	...
	case protoreflect.BoolKind:
		// We require bool fields to be explicitly assigned True or False.
	...
	case protoreflect.EnumKind:
		// Enums in proto are secretly signed int32.
