...
//
// Uses a slightly modified vendored copy of "google.goland.org/protobuf"
// internally. It's expected that once "google.goland.org/protobuf" is
// officially released, starlarkprotov2 switch to using the release version.
//
...
//    * Message types are instantiated through proto.loader().
