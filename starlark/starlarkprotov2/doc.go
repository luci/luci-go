...
//
// Notice that rule 2 is exactly similar to the aliasing rule for messages. This
// is where "think of them as 'message List<T>' messages" point of view comes
// into play.
//
...
//    m1.int32s = list(m1.int64s)  # works now (by making a copy)
//
