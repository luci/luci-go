...
// Exec'ing modules
//
// The new built-in function 'exec' can be used to execute a module for its side
...
// be available in the global scope of all modules. Predeclared symbols and
// '@stdlib//builtins.star' module explained above, are the primary mechanisms
// of making Interpreter do something useful.
package interpreter
