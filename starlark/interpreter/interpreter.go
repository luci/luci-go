...
// may define more symbols or override already defined ones. Whatever symbols
// not starting with '_' end up in the global dict of '@stdlib//init.star'
// module will become available as global symbols in all modules.
