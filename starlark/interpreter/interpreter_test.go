...
func TestInterpreter(t *testing.T) {
	...
	Convey("Exec cycle", t, func() {
		...
		So(err, ShouldErrLike, "cannot load //exec1.star: cannot load //exec2.star: cannot load //exec1.star: cycle while executing")
	})
	...
	Convey("Trying to exec loaded module", t, func() {
		...
		So(err, ShouldErrLike, "cannot load //mod.star: the module has been loaded before and therefore is not executable")
	})
