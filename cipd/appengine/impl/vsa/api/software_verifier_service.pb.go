...
const (
	...
	// The verification is requested by an enforced client.
	// * This is production traffic, and may be used for future policy testing
	// and automation;
	// * Allowed verification will be reported to SCILo; Rejected verification
	// will NOT be reported to SCILo, since the artifact will not be allowed to
	// propagate in the software supply chain.
	//
	// NOTE: This implies fail-closed -- when unable to get a response from the
	// BCID backend, consider it as a rejection.
	VerificationContext_VERIFY_FOR_ENFORCEMENT VerificationContext_VerificationPurpose = 0
...
const file_go_chromium_org_luci_cipd_appengine_impl_vsa_api_software_verifier_service_proto_rawDesc = "" +
	"\n" +
	"Pgo.chromium.org/luci/cipd/appengine/impl/vsa/api/software_verifier_service.proto\x12\rcipd.impl.vsa\"\xe8\x03\n" +
	"\x13VerificationContext\x12i\n" +
	"\x14verification_purpose\x18\x01 \x01(\x0e26.cipd.impl.vsa.VerificationContext.VerificationPurposeR\x13verificationPurpose\x124\n" +
	"\x16enforcement_point_name\x18\x02 \x01(\tR\x14enforcementPointName\x12a\n" +
	"\x10occurrence_stage\x18\x03 \x01(\x0e26.cipd.impl.vsa.VerificationContext.OccurrenceStageTypeR\x0foccurrenceStage\"l\n" +
	"\x13VerificationPurpose\x12\v\n" +
	"\aDEFAULT\x10\x00\x12\x1a\n" +
	"\x16VERIFY_FOR_ENFORCEMENT\x10\x00\x12\x16\n" +
	"\x12VERIFY_FOR_LOGGING\x10\x03\x1a\x02\x10\x01\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02\"\x04\b\x04\x10\x04\"_\n" +
	"\x13OccurrenceStageType\x12%\n" +
	"!OCCURRENCE_STAGE_TYPE_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vAS_VERIFIED\x10\x03\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02\"\x04\b\x04\x10\x04\"\xd0\x02\n" +
	"\fArtifactInfo\x12\"\n" +
	"\fattestations\x18\x03 \x03(\tR\fattestations\x12L\n" +
	"\tartifacts\x18\x05 \x03(\v2..cipd.impl.vsa.ArtifactInfo.ArtifactDescriptorR\tartifacts\x1a\xbb\x01\n" +
	"\x12ArtifactDescriptor\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12U\n" +
	"\adigests\x18\x02 \x03(\v2;.cipd.impl.vsa.ArtifactInfo.ArtifactDescriptor.DigestsEntryR\adigests\x1a:\n" +
	"\fDigestsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x01\x10\x02J\x04\b\x02\x10\x03J\x04\b\x04\x10\x05\"\xcd\x01\n" +
	"\x1dVerifySoftwareArtifactRequest\x12,\n" +
	"\x12resource_to_verify\x18\x01 \x01(\tR\x10resourceToVerify\x12@\n" +
	"\rartifact_info\x18\x02 \x01(\v2\x1b.cipd.impl.vsa.ArtifactInfoR\fartifactInfo\x12<\n" +
	"\acontext\x18\x03 \x01(\v2\".cipd.impl.vsa.VerificationContextR\acontext\"\x9a\x01\n" +
	"\x1eVerifySoftwareArtifactResponse\x12\x18\n" +
	"\aallowed\x18\x01 \x01(\bR\aallowed\x12+\n" +
	"\x11rejection_message\x18\x02 \x01(\tR\x10rejectionMessage\x121\n" +
	"\x14verification_summary\x18\x03 \x01(\tR\x13verificationSummaryB2Z0go.chromium.org/luci/cipd/appengine/impl/vsa/apib\x06proto3"
