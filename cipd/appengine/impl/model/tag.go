...
//
// Tags exist as separate entities (as opposite to being a repeated property
...
// more.
func checkExistingTags(c context.Context, inst *Instance, tags []string) (exist []*Tag, miss []*Tag, err error) {
