...
//
// It checks ACLs. 'GetFetchURL' and 'BeginUpload' are allowed only to service
// administrators (to debug issues with CAS), and 'FinishUpload' is allowed to
// anyone, since this is how clients actually finish uploads initiated by the
// Repository service on their behalf.
