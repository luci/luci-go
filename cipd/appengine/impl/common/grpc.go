...
// GrpcfyAndLogErr converts an annotated luci error to a gRPC error and logs
...
// if it already Internal. There's nothing interesting to log in this case.
func GrpcfyAndLogErr(c context.Context, err error) error {
	if err == nil {
		return nil
	}
