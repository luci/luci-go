...
func TestMetadataStore(t *testing.T) {
	...
	Convey("directDescendants works", t, func() {
		s := MetadataStore{}
		populateMD(&s, []string{
			"", "a", "ab", "a/b", "a/b/c",
			"b", "b/c/d/e", "b/c/d/f",
		...
		// Note: unlike public methods, directDescendants uses normalized prefixes
		// that have leading and trailing '/'.
		So(s.directDescendants("/"), ShouldResemble, []string{"/a/", "/ab/", "/b/"})
		So(s.directDescendants("/a/"), ShouldResemble, []string{"/a/b/"})
		So(s.directDescendants("/a/b/"), ShouldResemble, []string{"/a/b/c/"})
		So(s.directDescendants("/a/b/c/"), ShouldResemble, []string(nil))
		So(s.directDescendants("/b/"), ShouldResemble, []string{"/b/c/d/e/", "/b/c/d/f/"})
	})
