...
func (impl *repoImpl) GetPrefixMetadata(c context.Context, r *api.Prefix) (resp *api.PrefixMetadata, err error) {
...
func (impl *repoImpl) GetInheritedPrefixMetadata(c context.Context, r *api.Prefix) (resp *api.InheritedPrefixMetadata, err error) {
	defer func() { err = common.GRPCifyAndLogErr(c, err) }()
