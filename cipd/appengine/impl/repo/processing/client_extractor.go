...
//
// Client's SHA1 is still need to for older clients and bootstrap scripts
...
func (r *ClientExtractorResult) SHA1() string {
	...
	case r.ClientBinary.HashAlgo == "SHA1": // for older entries predating SHA256
...
func (e *ClientExtractor) Run(ctx context.Context, inst *model.Instance, pkg *PackageReader) (res Result, err error) {
	...
	// the package instance it is in. This avoid some confusion.
