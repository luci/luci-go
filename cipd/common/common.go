...
// ValidatePrefixMetadata validates and normalizes the prefix metadata proto.
//
// Updates r.Prefix in-place by stripping trailing '/'. Skips r.Fingerprint,
// r.UpdateTime and r.UpdateUser, since they are always overridden on the server
// side.
func ValidatePrefixMetadata(m *api.PrefixMetadata) error {
	var err error
