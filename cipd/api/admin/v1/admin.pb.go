...
func file_go_chromium_org_luci_cipd_api_admin_v1_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_cipd_api_admin_v1_admin_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cipd_api_admin_v1_admin_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*JobID); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_cipd_api_admin_v1_admin_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cipd_api_admin_v1_admin_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_cipd_api_admin_v1_admin_proto_msgTypes[4].Exporter = func(v any, i int) any {
