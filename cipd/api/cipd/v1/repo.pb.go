...
func (Role) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{0}
}
...
func (RegistrationStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{1}
}
...
func (*PrefixMetadata_ACL) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{1, 0}
}
...
func (*InheritedPrefixMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{2}
}
...
type RolesInPrefix struct {
	// Unordered set or roles the caller has in the requested prefix.
	Roles                []*RolesInPrefix_RoleInPrefix `protobuf:"bytes,1,rep,name=roles" json:"roles,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}

func (m *RolesInPrefix) Reset()         { *m = RolesInPrefix{} }
func (m *RolesInPrefix) String() string { return proto.CompactTextString(m) }
func (*RolesInPrefix) ProtoMessage()    {}
func (*RolesInPrefix) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{3}
}
func (m *RolesInPrefix) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RolesInPrefix.Unmarshal(m, b)
}
func (m *RolesInPrefix) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RolesInPrefix.Marshal(b, m, deterministic)
}
func (dst *RolesInPrefix) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RolesInPrefix.Merge(dst, src)
}
func (m *RolesInPrefix) XXX_Size() int {
	return xxx_messageInfo_RolesInPrefix.Size(m)
}
func (m *RolesInPrefix) XXX_DiscardUnknown() {
	xxx_messageInfo_RolesInPrefix.DiscardUnknown(m)
}

var xxx_messageInfo_RolesInPrefix proto.InternalMessageInfo

func (m *RolesInPrefix) GetRoles() []*RolesInPrefix_RoleInPrefix {
	if m != nil {
		return m.Roles
	}
	return nil
...
type RolesInPrefix_RoleInPrefix struct {
	Role                 Role     `protobuf:"varint,1,opt,name=role,enum=cipd.Role" json:"role,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *RolesInPrefix_RoleInPrefix) Reset()         { *m = RolesInPrefix_RoleInPrefix{} }
func (m *RolesInPrefix_RoleInPrefix) String() string { return proto.CompactTextString(m) }
func (*RolesInPrefix_RoleInPrefix) ProtoMessage()    {}
func (*RolesInPrefix_RoleInPrefix) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{3, 0}
}
func (m *RolesInPrefix_RoleInPrefix) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RolesInPrefix_RoleInPrefix.Unmarshal(m, b)
}
func (m *RolesInPrefix_RoleInPrefix) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RolesInPrefix_RoleInPrefix.Marshal(b, m, deterministic)
}
func (dst *RolesInPrefix_RoleInPrefix) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RolesInPrefix_RoleInPrefix.Merge(dst, src)
}
func (m *RolesInPrefix_RoleInPrefix) XXX_Size() int {
	return xxx_messageInfo_RolesInPrefix_RoleInPrefix.Size(m)
}
func (m *RolesInPrefix_RoleInPrefix) XXX_DiscardUnknown() {
	xxx_messageInfo_RolesInPrefix_RoleInPrefix.DiscardUnknown(m)
}

var xxx_messageInfo_RolesInPrefix_RoleInPrefix proto.InternalMessageInfo

func (m *RolesInPrefix_RoleInPrefix) GetRole() Role {
	if m != nil {
		return m.Role
	}
	return Role_ROLE_UNSPECIFIED
...
func (*Instance) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{4}
}
...
func (*RegisterInstanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_108bc2ba026ea8c3, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*RolesInPrefix)(nil), "cipd.RolesInPrefix")
	proto.RegisterType((*RolesInPrefix_RoleInPrefix)(nil), "cipd.RolesInPrefix.RoleInPrefix")
...
type RepositoryClient interface {
	...
	GetRolesInPrefix(ctx context.Context, in *PrefixRequest, opts ...grpc.CallOption) (*RolesInPrefix, error)
...
func (c *repositoryPRPCClient) GetRolesInPrefix(ctx context.Context, in *PrefixRequest, opts ...grpc.CallOption) (*RolesInPrefix, error) {
	out := new(RolesInPrefix)
...
func (c *repositoryClient) GetRolesInPrefix(ctx context.Context, in *PrefixRequest, opts ...grpc.CallOption) (*RolesInPrefix, error) {
	out := new(RolesInPrefix)
...
type RepositoryServer interface {
	...
	// Returns empty set of roles if the caller has no permissions to access the
	// prefix at all or such prefix doesn't exist.
	GetRolesInPrefix(context.Context, *PrefixRequest) (*RolesInPrefix, error)
	// Registers a package instance in the repository (if it was uploaded to the
	// storage already and wasn't registered yet) or initiates a new upload
	// operation.
	//
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/cipd/api/cipd/v1/repo.proto", fileDescriptor_repo_108bc2ba026ea8c3)
}

var fileDescriptor_repo_108bc2ba026ea8c3 = []byte{
	// 745 bytes of a gzipped FileDescriptorProto
	,
}
