...
func (Role) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{0}
}
...
func (RegistrationStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{1}
}

type Processor_State int32

const (
	Processor_STATE_UNDEFINED Processor_State = 0
...
func (Processor_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{19, 0}
}
...
func (*PrefixMetadata_ACL) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{1, 0}
}
...
func (*InheritedPrefixMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{2}
}
...
func (*RolesInPrefixResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{3}
}
...
func (*RolesInPrefixResponse_RoleInPrefix) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{3, 0}
}
...
func (*ListPrefixRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{4}
}
...
func (*ListPrefixResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{5}
}
...
func (*PackageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{6}
}
...
func (*Instance) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{7}
}
...
func (*RegisterInstanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{8}
}
...
func (*ListInstancesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{9}
}
...
func (*ListInstancesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{10}
}
...
func (*Ref) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{11}
}
...
func (*DeleteRefRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{12}
}
...
func (*ListRefsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{13}
}
...
func (*ListRefsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{14}
}
...
func (*Tag) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{15}
}
...
func (*AttachTagsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{16}
}
...
func (*DetachTagsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{17}
}
...
func (*ResolveVersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{18}
}
...
func (*Processor) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{19}
}
...
func (m *Processor) GetState() Processor_State {
	...
	return Processor_STATE_UNDEFINED
}
...
type DescribeInstanceRequest struct {
	...
	DescribeRefs bool `protobuf:"varint,2,opt,name=describe_refs,json=describeRefs" json:"describe_refs,omitempty"`
	// Whether the response should include "tags" field.
	DescribeTags bool `protobuf:"varint,3,opt,name=describe_tags,json=describeTags" json:"describe_tags,omitempty"`
	// Whether the response should include "processors" field.
	DescribeProcessors   bool     `protobuf:"varint,4,opt,name=describe_processors,json=describeProcessors" json:"describe_processors,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*DescribeInstanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{20}
}
...
func (m *DescribeInstanceRequest) GetInstance() *Instance {
	if m != nil {
		return m.Instance
	}
	return nil
...
type DescribeInstanceResponse struct {
	...
	// Tags attached to the instance, sorted them by the tag key first, and then
...
func (*DescribeInstanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_642e4025bca48d61, []int{21}
}
...
type RepositoryClient interface {
	...
	GetInstanceURL(ctx context.Context, in *Instance, opts ...grpc.CallOption) (*ObjectURL, error)
	// Returns information about a package instance.
	//
	// Depending on fields set in the request, returns details such as when it was
	// registered and by whom, refs pointing to it, tags attached to it, state of
	// all processors that handled it (if any).
	//
	// May also be used as a simple instance presence check, if all describe_*
	// fields in the request are false
	//
	// Returns:
	//   PERMISSION_DENIED if the caller is not a READER for the prefix.
	//   INVALID_ARGUMENT if the request is malformed.
...
func (c *repositoryPRPCClient) GetInstanceURL(ctx context.Context, in *Instance, opts ...grpc.CallOption) (*ObjectURL, error) {
	out := new(ObjectURL)
...
func (c *repositoryClient) GetInstanceURL(ctx context.Context, in *Instance, opts ...grpc.CallOption) (*ObjectURL, error) {
	out := new(ObjectURL)
...
type RepositoryServer interface {
	...
	//   INVALID_ARGUMENT if the request is malformed.
	//   NOT_FOUND if there's no such instance.
	GetInstanceURL(context.Context, *Instance) (*ObjectURL, error)
	// Returns information about a package instance.
	//
	// Depending on fields set in the request, returns details such as when it was
	// registered and by whom, refs pointing to it, tags attached to it, state of
...
func _Repository_GetInstanceURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServer).GetInstanceURL(ctx, req.(*Instance))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/cipd/api/cipd/v1/repo.proto", fileDescriptor_repo_642e4025bca48d61)
}

var fileDescriptor_repo_642e4025bca48d61 = []byte{
	...
	,
}
