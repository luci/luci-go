...
func (Role) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{0}
}
...
func (RegistrationStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{1}
}
...
func (*PrefixMetadata_ACL) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{1, 0}
}
...
func (*InheritedPrefixMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{2}
}
...
func (*RolesInPrefixResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{3}
}
...
func (*RolesInPrefixResponse_RoleInPrefix) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{3, 0}
}
...
func (*ListPrefixRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{4}
}
...
func (*ListPrefixResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{5}
}
...
func (*PackageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{6}
}
...
func (*Instance) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{7}
}
...
func (*RegisterInstanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{8}
}
...
func (*ListInstancesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{9}
}
...
func (*ListInstancesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{10}
}
...
type Ref struct {
	// Name of the ref, e.g. "latest". Required by all calls.
	Name string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// Name of the package where the ref is defined. Required by all calls.
	Package string `protobuf:"bytes,2,opt,name=package" json:"package,omitempty"`
	// A package instance the ref is pointing to. Must be unset for DeleteRef.
...
func (*Ref) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{11}
}
...
func (*ListRefsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{12}
}
...
func (*ListRefsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repo_4ba70843e461e426, []int{13}
}
...
type RepositoryClient interface {
	...
	// Removes a ref.
	//
	// Only 'name' and 'package' fields of the request are used. Not a failure if
	// there's no such ref.
	//
	// Returns:
	//   PERMISSION_DENIED if the caller is not a WRITER for the prefix.
	//   INVALID_ARGUMENT if the ref or package name is invalid or Ref.instance is
	//       provided (it should be unset for now).
	//   NOT_FOUND if the package doesn't exist.
	DeleteRef(ctx context.Context, in *Ref, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *repositoryPRPCClient) DeleteRef(ctx context.Context, in *Ref, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *repositoryClient) DeleteRef(ctx context.Context, in *Ref, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type RepositoryServer interface {
	...
	//       provided (it should be unset for now).
	//   NOT_FOUND if the package doesn't exist.
	DeleteRef(context.Context, *Ref) (*empty.Empty, error)
	// Lists refs defined in a package, most recently modified first.
	//
	// Returns:
	//   PERMISSION_DENIED if the caller is not a READER for the prefix.
...
func _Repository_DeleteRef_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServer).DeleteRef(ctx, req.(*Ref))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/cipd/api/cipd/v1/repo.proto", fileDescriptor_repo_4ba70843e461e426)
}

var fileDescriptor_repo_4ba70843e461e426 = []byte{
	...
	,
}
