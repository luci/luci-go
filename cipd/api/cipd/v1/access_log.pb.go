...
type AccessLogEntry struct {
	...
	CallIdentity     string   `protobuf:"bytes,8,opt,name=call_identity,json=callIdentity,proto3" json:"call_identity,omitempty"`                 // identity used to authorize the call
	PeerIdentity     string   `protobuf:"bytes,9,opt,name=peer_identity,json=peerIdentity,proto3" json:"peer_identity,omitempty"`                 // identity of a service that made the RPC
	PeerIp           string   `protobuf:"bytes,10,opt,name=peer_ip,json=peerIp,proto3" json:"peer_ip,omitempty"`                                  // IP address of the caller
	UserAgent        string   `protobuf:"bytes,11,opt,name=user_agent,json=userAgent,proto3" json:"user_agent,omitempty"`                         // value of "User-Agent" header
	ServiceVersion   string   `protobuf:"bytes,12,opt,name=service_version,json=serviceVersion,proto3" json:"service_version,omitempty"`          // GAE app and version that handled the request
	ProcessId        string   `protobuf:"bytes,13,opt,name=process_id,json=processId,proto3" json:"process_id,omitempty"`                         // identifier of the concrete backend process
	RequestId        string   `protobuf:"bytes,14,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`                         // Cloud Trace ID of the request
	AuthDbRev        int64    `protobuf:"varint,15,opt,name=auth_db_rev,json=authDbRev,proto3" json:"auth_db_rev,omitempty"`                      // AuthDB revision used to authorize the call
	ResponseCode     string   `protobuf:"bytes,16,opt,name=response_code,json=responseCode,proto3" json:"response_code,omitempty"`                // canonical gRPC response code (e.g. "OK")
	ResponseErr      string   `protobuf:"bytes,17,opt,name=response_err,json=responseErr,proto3" json:"response_err,omitempty"`                   // the response error message if any
	ResponseTimeUsec int64    `protobuf:"varint,18,opt,name=response_time_usec,json=responseTimeUsec,proto3" json:"response_time_usec,omitempty"` // time spent handling the request in microseconds
}
...
var file_go_chromium_org_luci_cipd_api_cipd_v1_access_log_proto_rawDesc = []byte{
	...
	0xd6, 0x04, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f, 0x67, 0x45, 0x6e, 0x74,
	...
	,
	...
	0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73,
	...
	,
