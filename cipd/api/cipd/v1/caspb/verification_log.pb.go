...
const file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDesc = "" +
	...
	"\tTIMESTAMPR\tsubmitted\x12)\n" +
	"\astarted\x18\a \x01(\x03B\x0f\xe2\xbc$\v\n" +
	"\tTIMESTAMPR\astarted\x12+\n" +
	"\bfinished\x18\b \x01(\x03B\x0f\xe2\xbc$\v\n" +
	"\tTIMESTAMPR\bfinished\x12'\n" +
	"\x0fservice_version\x18\t \x01(\tR\x0eserviceVersion\x12\x1d\n" +
	"\n" +
	"process_id\x18\n" +
	" \x01(\tR\tprocessId\x12\x19\n" +
...
var (
	...
	file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDesc), len(file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDesc)))
	})
...
var file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_goTypes = []any{
...
func file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDesc), len(file_go_chromium_org_luci_cipd_api_cipd_v1_verification_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
