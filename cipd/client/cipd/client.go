...
type Client interface {
	...
	// ListInstances enumerates instances of a package sorted by creation time.
	//
	// Most recently created instances come first. Returns an object that can be
	// used to fetch the listing, page by page.
