...
//
// It accepts either files or directories. It attempts to os.Remove(...) first.
// If it fails, it moves the path to a trash directory, where it eventually will
// be deleted. Note that either way we do O(1) number of syscalls.
//
// Returns:
