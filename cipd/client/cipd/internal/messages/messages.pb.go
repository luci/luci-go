...
// VersionCache stores a mapping (service, package name, tag) -> instance ID to
...
type VersionCache struct {
	...
	Entries     []*VersionCache_Entry     `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`
	FileEntries []*VersionCache_FileEntry `protobuf:"bytes,2,rep,name=file_entries,json=fileEntries,proto3" json:"file_entries,omitempty"`
	// Note: ref_entries are NOT currently sorted by `captured`, but if we ever
	// allow caching refs in the non-offline case, it may be a good idea to start
	// doing so.
	RefEntries []*VersionCache_RefEntry `protobuf:"bytes,3,rep,name=ref_entries,json=refEntries,proto3" json:"ref_entries,omitempty"`
}

func (x *VersionCache) Reset() {
	*x = VersionCache{}
	if protoimpl.UnsafeEnabled {
...
func (x *VersionCache) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VersionCache) ProtoMessage() {}

func (x *VersionCache) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VersionCache.ProtoReflect.Descriptor instead.
func (*VersionCache) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescGZIP(), []int{1}
}

func (x *VersionCache) GetEntries() []*VersionCache_Entry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *VersionCache) GetFileEntries() []*VersionCache_FileEntry {
	if x != nil {
...
func (x *VersionCache) GetRefEntries() []*VersionCache_RefEntry {
	if x != nil {
		return x.RefEntries
	}
	return nil
...
type VersionCache_Entry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *VersionCache_Entry) Reset() {
	*x = VersionCache_Entry{}
	if protoimpl.UnsafeEnabled {
...
func (x *VersionCache_Entry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VersionCache_Entry) ProtoMessage() {}

func (x *VersionCache_Entry) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VersionCache_Entry.ProtoReflect.Descriptor instead.
func (*VersionCache_Entry) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescGZIP(), []int{1, 0}
}

func (x *VersionCache_Entry) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *VersionCache_Entry) GetPackage() string {
	if x != nil {
		return x.Package
	}
	return ""
...
func (x *VersionCache_Entry) GetTag() string {
	if x != nil {
		return x.Tag
	}
	return ""
...
func (x *VersionCache_Entry) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
type VersionCache_FileEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *VersionCache_FileEntry) Reset() {
	*x = VersionCache_FileEntry{}
	if protoimpl.UnsafeEnabled {
...
func (x *VersionCache_FileEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VersionCache_FileEntry) ProtoMessage() {}

func (x *VersionCache_FileEntry) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VersionCache_FileEntry.ProtoReflect.Descriptor instead.
func (*VersionCache_FileEntry) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescGZIP(), []int{1, 1}
}

func (x *VersionCache_FileEntry) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *VersionCache_FileEntry) GetPackage() string {
	if x != nil {
		return x.Package
	}
	return ""
...
func (x *VersionCache_FileEntry) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *VersionCache_FileEntry) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
func (x *VersionCache_FileEntry) GetObjectRef() string {
	if x != nil {
		return x.ObjectRef
	}
	return ""
...
type VersionCache_RefEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	InstanceId string                 `protobuf:"bytes,3,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"` // the instance ID it resolves to
	Captured   *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=captured,proto3" json:"captured,omitempty"`                       // the time at which this ref was captured
}

func (x *VersionCache_RefEntry) Reset() {
	*x = VersionCache_RefEntry{}
	if protoimpl.UnsafeEnabled {
...
func (x *VersionCache_RefEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VersionCache_RefEntry) ProtoMessage() {}

func (x *VersionCache_RefEntry) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VersionCache_RefEntry.ProtoReflect.Descriptor instead.
func (*VersionCache_RefEntry) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescGZIP(), []int{1, 2}
}

func (x *VersionCache_RefEntry) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *VersionCache_RefEntry) GetPackage() string {
	if x != nil {
		return x.Package
	}
	return ""
...
func (x *VersionCache_RefEntry) GetRef() string {
	if x != nil {
		return x.Ref
	}
	return ""
...
func (x *VersionCache_RefEntry) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *VersionCache_RefEntry) GetCaptured() *timestamppb.Timestamp {
	if x != nil {
		return x.Captured
	}
	return nil
...
func (x *InstanceCache_Entry) Reset() {
	*x = InstanceCache_Entry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
...
var file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_goTypes = []interface{}{
	...
	(*VersionCache)(nil),           // 1: messages.VersionCache
	(*InstanceCache)(nil),          // 2: messages.InstanceCache
	(*VersionCache_Entry)(nil),     // 3: messages.VersionCache.Entry
	(*VersionCache_FileEntry)(nil), // 4: messages.VersionCache.FileEntry
	(*VersionCache_RefEntry)(nil),  // 5: messages.VersionCache.RefEntry
	(*InstanceCache_Entry)(nil),    // 6: messages.InstanceCache.Entry
	nil,                            // 7: messages.InstanceCache.EntriesEntry
	(*timestamppb.Timestamp)(nil),  // 8: google.protobuf.Timestamp
}
var file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_depIdxs = []int32{
	3, // 0: messages.VersionCache.entries:type_name -> messages.VersionCache.Entry
	4, // 1: messages.VersionCache.file_entries:type_name -> messages.VersionCache.FileEntry
	5, // 2: messages.VersionCache.ref_entries:type_name -> messages.VersionCache.RefEntry
	7, // 3: messages.InstanceCache.entries:type_name -> messages.InstanceCache.EntriesEntry
	8, // 4: messages.InstanceCache.last_synced:type_name -> google.protobuf.Timestamp
	8, // 5: messages.VersionCache.RefEntry.captured:type_name -> google.protobuf.Timestamp
	8, // 6: messages.InstanceCache.Entry.last_access:type_name -> google.protobuf.Timestamp
	6, // 7: messages.InstanceCache.EntriesEntry.value:type_name -> messages.InstanceCache.Entry
...
func file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VersionCache_Entry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VersionCache_FileEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VersionCache_RefEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
