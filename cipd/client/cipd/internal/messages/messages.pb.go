...
type InstanceCache struct {
	...
	Entries map[string]*InstanceCache_Entry `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDesc), len(file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDesc)))
	})
...
var file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_goTypes = []any{
...
func file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDesc), len(file_go_chromium_org_luci_cipd_client_cipd_internal_messages_messages_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
