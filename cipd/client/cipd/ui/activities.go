...
type ActivityGroup interface {
	...
	NewActivity(ctx context.Context, order int, kind string) Activity
...
func NewActivity(ctx context.Context, g ActivityGroup, order int, kind string) context.Context {
	a := g.NewActivity(ctx, order, kind)
