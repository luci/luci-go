...
func NewActivity(ctx context.Context, group *ActivityGroup, kind string) context.Context {
...
//
// Such activity should not be receiving any updates anymore. The UI will stop
// rendering it.
