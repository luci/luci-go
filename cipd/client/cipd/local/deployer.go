...
const (
	...
	// there.
	//
	// Note that it will not check file's content or flags. Only its presence.
...
//
// ToRedeploy is populated only when using a paranoid mode.
...
type Deployer interface {
	...
	//
	// Depending on value of paranoia will also verify that package's files are
	// correctly installed into the site root and will return a list of files
	// that needs to be redeployed.
