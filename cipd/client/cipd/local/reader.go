...
const (
	...
	// file using given hash algo, and use it as new instance ID.
...
type OpenInstanceOpts struct {
	...
	// ErrHashMismatch. HashAlgo is ignored in this case and should be unset.
	//
	...
	// as instance ID of the new PackageInstance object. InstanceID is ignored
	// in this case and should be empty.
	VerificationMode VerificationMode

	// InstanceID encodes the expected hash of the instance file.
	//
	// May be empty. See comment for VerificationMode for more details.
	InstanceID string
