...
type Admission struct {
	...
	Instance      *caspb.ObjectRef       `protobuf:"bytes,4,opt,name=instance,proto3" json:"instance,omitempty"`                          // a concrete package instance being installed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Admission) GetInstance() *caspb.ObjectRef {
	if x != nil {
		return x.Instance
	}
	return nil
...
const file_go_chromium_org_luci_cipd_client_cipd_plugin_protocol_admission_proto_rawDesc = "" +
	"\n" +
	"Ego.chromium.org/luci/cipd/client/cipd/plugin/protocol/admission.proto\x12\vcipd.plugin\x1a\x17google/rpc/status.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a/go.chromium.org/luci/cipd/api/cipd/v1/cas.proto\"i\n" +
	"\x15ListAdmissionsRequest\x12)\n" +
	"\x10protocol_version\x18\x01 \x01(\x05R\x0fprotocolVersion\x12%\n" +
	"\x0eplugin_version\x18\x02 \x01(\tR\rpluginVersion\"\x96\x01\n" +
	"\tAdmission\x12!\n" +
	"\fadmission_id\x18\x01 \x01(\tR\vadmissionId\x12\x1f\n" +
	"\vservice_url\x18\x02 \x01(\tR\n" +
	"serviceUrl\x12\x18\n" +
	"\apackage\x18\x03 \x01(\tR\apackage\x12+\n" +
	"\binstance\x18\x04 \x01(\v2\x0f.cipd.ObjectRefR\binstance\"h\n" +
	"\x17ResolveAdmissionRequest\x12!\n" +
	"\fadmission_id\x18\x01 \x01(\tR\vadmissionId\x12*\n" +
	"\x06status\x18\x02 \x01(\v2\x12.google.rpc.StatusR\x06status2\xae\x01\n" +
	"\n" +
	"Admissions\x12N\n" +
	"\x0eListAdmissions\x12\".cipd.plugin.ListAdmissionsRequest\x1a\x16.cipd.plugin.Admission0\x01\x12P\n" +
	"\x10ResolveAdmission\x12$.cipd.plugin.ResolveAdmissionRequest\x1a\x16.google.protobuf.EmptyB7Z5go.chromium.org/luci/cipd/client/cipd/plugin/protocolb\x06proto3"
...
var file_go_chromium_org_luci_cipd_client_cipd_plugin_protocol_admission_proto_goTypes = []any{
	...
	(*caspb.ObjectRef)(nil),         // 3: cipd.ObjectRef
