...
func TestClientDigestsFile(t *testing.T) {
	...
	Convey("Serialization", t, func() {
		...
		So(buf.String(), ShouldEqual, strings.Join([]string{
			...
			`#   cipd selfupdate -version-file "cipd_client_version" -generate-digests`,
			`# For the CIPD client version:`,
			`#   tag:val`,
			`# Do not modify manually. All changes will be overwritten.`,
			`# To change, modify "cipd_client_version" and regenerated this file.`,
			``,
