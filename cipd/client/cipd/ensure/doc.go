...
//   - `$ResolvedVersions <filename>` is path (either relative to the ensure
//     file or absolute) to a file that contains "frozen" instance IDs (hashes)
//     of all packages for all verified platforms, resolved at the time this
//     file was generated by `cipd ensure-file-resolve`. The CIPD client will
//     use these instance IDs (instead of contacting the backend) when
//     installing packages in `cipd ensure`. Using this file allow to
//     cryptographically bind the intended state of the deployment to a git
//     commit, since all hashes of all packages become part of the commit
//     object. Use this if you want to reduce trust in the CIPD backend.
//
//
// Package Definitions
//
