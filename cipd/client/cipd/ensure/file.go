...
func ParseFile(r io.Reader) (*File, error) {
	...
	for scanner.Scan() {
		...
		default:
			...
			}, common.DefaultPackageNameExpander())
...
func (f *File) Resolve(rslv VersionResolver) (*ResolvedFile, error) {
	return f.ResolveWith(rslv, common.DefaultPackageNameExpander())
}
...
func (f *File) ResolveWith(rslv VersionResolver, expander common.PackageNameExpander) (*ResolvedFile, error) {
	ret := &ResolvedFile{}
