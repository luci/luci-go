...
func runProxyImpl(ctx context.Context, unixSocket string, policy *proxypb.Policy, httpClient *http.Client, readOnlyCacheDir string) (*proxyserver.ProxyStats, error) {
