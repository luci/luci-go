...
var (
	initialExePath, initialExePathErr = rationalizeInitialExePath(os.Executable())
...
func rationalizeInitialExePath(initialExePath string, initialExePathErr error) (string, error) {
	...
	return initialExePath, initialExePathErr
}
