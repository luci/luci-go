...
type ReportArtifactDigestResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The attestation for the artifact returned from the spike.
	Attestation   []byte `protobuf:"bytes,1,opt,name=attestation,proto3" json:"attestation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReportArtifactDigestResponse) Reset() {
	*x = ReportArtifactDigestResponse{}
	mi := &file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReportArtifactDigestResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportArtifactDigestResponse) ProtoMessage() {}

func (x *ReportArtifactDigestResponse) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportArtifactDigestResponse.ProtoReflect.Descriptor instead.
func (*ReportArtifactDigestResponse) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_rawDescGZIP(), []int{7}
}

func (x *ReportArtifactDigestResponse) GetAttestation() []byte {
	if x != nil {
...
func (*ReportPIDRequest) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_rawDescGZIP(), []int{11}
}
...
func (x *ClientInfo_Swarming) Reset() {
	*x = ClientInfo_Swarming{}
	mi := &file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_rawDesc = "" +
	...
	"\rsbom_subjects\x18\x03 \x03(\tR\fsbomSubjects\"@\n" +
	"\x1cReportArtifactDigestResponse\x12 \n" +
	"\vattestation\x18\x01 \x01(\fR\vattestation\"V\n" +
	...
	"\tReportPID\x12&.provenance.snooperpb.ReportPIDRequest\x1a\x16.google.protobuf.Empty\x12}\n" +
	"\x14ReportArtifactDigest\x121.provenance.snooperpb.ReportArtifactDigestRequest\x1a2.provenance.snooperpb.ReportArtifactDigestResponseB<Z:go.chromium.org/luci/provenance/api/snooperpb/v1;snooperpbb\x06proto3"
...
var file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_goTypes = []any{
	...
	(*ReportArtifactDigestResponse)(nil), // 8: provenance.snooperpb.ReportArtifactDigestResponse
	(*ReportCipdRequest)(nil),            // 9: provenance.snooperpb.ReportCipdRequest
	(*ReportGitRequest)(nil),             // 10: provenance.snooperpb.ReportGitRequest
	(*ReportGcsRequest)(nil),             // 11: provenance.snooperpb.ReportGcsRequest
	(*ReportPIDRequest)(nil),             // 12: provenance.snooperpb.ReportPIDRequest
	(*Artifact_CIPD)(nil),                // 13: provenance.snooperpb.Artifact.CIPD
	(*ClientInfo_Swarming)(nil),          // 14: provenance.snooperpb.ClientInfo.Swarming
	(*repopb.Tag)(nil),                   // 15: cipd.Tag
	(*repopb.Ref)(nil),                   // 16: cipd.Ref
	(*timestamppb.Timestamp)(nil),        // 17: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                // 18: google.protobuf.Empty
}
var file_go_chromium_org_luci_provenance_api_snooperpb_v1_report_proto_depIdxs = []int32{
	13, // 0: provenance.snooperpb.Artifact.cipd:type_name -> provenance.snooperpb.Artifact.CIPD
	15, // 1: provenance.snooperpb.CipdReport.tags:type_name -> cipd.Tag
	16, // 2: provenance.snooperpb.CipdReport.refs:type_name -> cipd.Ref
	17, // 3: provenance.snooperpb.CipdReport.event_ts:type_name -> google.protobuf.Timestamp
	17, // 4: provenance.snooperpb.GcsReport.event_ts:type_name -> google.protobuf.Timestamp
	17, // 5: provenance.snooperpb.GitReport.event_ts:type_name -> google.protobuf.Timestamp
	0,  // 6: provenance.snooperpb.ReportTaskStageRequest.task_stage:type_name -> provenance.snooperpb.TaskStage
	17, // 7: provenance.snooperpb.ReportTaskStageRequest.timestamp:type_name -> google.protobuf.Timestamp
	6,  // 8: provenance.snooperpb.ReportTaskStageRequest.client_info:type_name -> provenance.snooperpb.ClientInfo
	14, // 9: provenance.snooperpb.ClientInfo.swarming:type_name -> provenance.snooperpb.ClientInfo.Swarming
	...
	9,  // 14: provenance.snooperpb.SelfReport.ReportCipd:input_type -> provenance.snooperpb.ReportCipdRequest
	10, // 15: provenance.snooperpb.SelfReport.ReportGit:input_type -> provenance.snooperpb.ReportGitRequest
	11, // 16: provenance.snooperpb.SelfReport.ReportGcs:input_type -> provenance.snooperpb.ReportGcsRequest
	5,  // 17: provenance.snooperpb.SelfReport.ReportTaskStage:input_type -> provenance.snooperpb.ReportTaskStageRequest
	12, // 18: provenance.snooperpb.SelfReport.ReportPID:input_type -> provenance.snooperpb.ReportPIDRequest
	7,  // 19: provenance.snooperpb.SelfReport.ReportArtifactDigest:input_type -> provenance.snooperpb.ReportArtifactDigestRequest
	18, // 20: provenance.snooperpb.SelfReport.ReportCipd:output_type -> google.protobuf.Empty
	18, // 21: provenance.snooperpb.SelfReport.ReportGit:output_type -> google.protobuf.Empty
	18, // 22: provenance.snooperpb.SelfReport.ReportGcs:output_type -> google.protobuf.Empty
	18, // 23: provenance.snooperpb.SelfReport.ReportTaskStage:output_type -> google.protobuf.Empty
	18, // 24: provenance.snooperpb.SelfReport.ReportPID:output_type -> google.protobuf.Empty
	8,  // 25: provenance.snooperpb.SelfReport.ReportArtifactDigest:output_type -> provenance.snooperpb.ReportArtifactDigestResponse
