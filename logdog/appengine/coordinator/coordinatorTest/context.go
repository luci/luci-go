...
func Install(useRealIndex bool) (context.Context, *Environment) {
	...
	// Capture the context while it doesn't have a lot of other stuff yet to
	// use it for Sync. We don't it to simulate a sync done from the cron, the
	// context doesn't have a lot of stuff there.
	syncCtx := c
