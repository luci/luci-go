...
// ScheduleArchiveTask schedules an archive task for a log stream.
func (b *server) ScheduleArchiveTask(c context.Context, req *logdog.ArchiveDispatchTask) (*empty.Empty, error) {
