...
// LogStreamFetcher fetches LogStream and LogPrefix metadata and checks ACLs.
type LogStreamFetcher struct {
...
// inside.
func (f *LogStreamFetcher) FetchWithACLCheck(ctx context.Context) error {
