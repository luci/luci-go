	...
	Convey(`With a testing configuration`, t, func() {
		...
		Convey(`Match Streams`, func() {
			streams := []*coordinator.LogStream{
				&coordinator.LogStream{Name: "foo/bar/baz"},
				&coordinator.LogStream{Name: "foo/bar/stdout"},
				&coordinator.LogStream{Name: "foo/baz"},
				&coordinator.LogStream{Name: "stdout"},
				&coordinator.LogStream{Name: "stderr"},
			}
