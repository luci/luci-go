...
func TestHelperFunction(t *testing.T) {
	...
	Convey(`linkify changes URLs to HTML links`, t, func() {
		...
		Convey(`with single simple URLs`, func() {
			...
			So(linkify("https://example.com"), ShouldEqual,
		...
		Convey(`with single URLs with escaping required`, func() {
		...
		Convey(`with multiple URLs`, func() {
			So(linkify("x http://x.com http://y.com y"), ShouldEqual,
				`x <a href="http://x.com">http://x.com</a> <a href="http://y.com">http://y.com</a> y`)
		})
		...
		Convey(`lineTemplate uses linkify`, func() {
			...
			So(w.String(), ShouldContainSubstring, `See <a href="https://crbug.com/1167332">https://crbug.com/1167332</a>`)
		})
