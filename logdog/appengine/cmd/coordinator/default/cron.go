...
// doShardedQueryStat launches a batch of queries, at different shard indicies.
...
// cronStatsNSHander gathers metrics about a metric and namespace within logdog.
