...
//
// This is implemented this way so that the Logs service can be made
// discoverable without actually hosting an implementation of that service.
// The actual implementation is hosted in the "logs" GAE service, and RPCs
// directed at this dummy service are automatically routed to the "logs" service
// through "dispatch.yaml".
var dummyLogsService = &logsPb.DecoratedLogs{
	Service: nil, // No backing implementation.
