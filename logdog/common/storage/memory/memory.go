...
// GetSignedURLs only returns an error in this implementation.
func (s *Storage) GetSignedURLs(c context.Context, u *coordinator.URLSigningRequest) (*coordinator.URLSigningResponse, error) {
	return nil, errors.New("GetSignedURLs is unsupported on memory implementation")
}
