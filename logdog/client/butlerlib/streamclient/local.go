...
// Butler is a decoupled interface which corresponds to the client's
// requirements for go.chromium.org/luci/logdog/client/butler.
...
// NewLocal makes a loopback Client attached to a Butler instance.
//
...
func NewLocal(b Butler, namespace types.StreamName) *Client {
