...
It is generated from these files:
	go.chromium.org/luci/logdog/api/config/svcconfig/archival.proto
	...
	go.chromium.org/luci/logdog/api/config/svcconfig/storage.proto
	go.chromium.org/luci/logdog/api/config/svcconfig/transport.proto
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/logdog/api/config/svcconfig/archival.proto", fileDescriptor0)
}
