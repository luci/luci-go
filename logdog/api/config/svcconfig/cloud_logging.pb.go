...
var file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDesc = string([]byte{
	...
	0x67, 0x22, 0x36, 0x0a, 0x12, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x4c, 0x6f, 0x67, 0x67, 0x69, 0x6e,
	...
	0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x6f, 0x2e,
...
var (
	...
	file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDesc), len(file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDesc)))
	})
...
var file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_goTypes = []any{
...
func file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDesc), len(file_go_chromium_org_luci_logdog_api_config_svcconfig_cloud_logging_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
