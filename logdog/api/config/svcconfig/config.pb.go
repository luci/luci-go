...
type Archivist struct {
	...
	// The number of archival tasks to lease from the taskqueue per one cycle.
	//
	// TaskQueue has a limit of 10qps for leasing tasks, so the batch size must
	// be set to:
	// lease_batch_size * 10 > (max expected stream creation QPS)
	//
	// In 2020, max stream QPS is approximately 1000 QPS
	LeaseBatchSize int32 `protobuf:"varint,4,opt,name=lease_batch_size,json=leaseBatchSize,proto3" json:"lease_batch_size,omitempty"`
	// The amount of time to to lease the batch of tasks for.
	//
	// We need:
	// (time to process avg stream) * lease_batch_size < lease_time
	//
	// As of 2020, 90th percentile process time per stream is ~5s, 95th
	// percentile of the loop time is 25m.
	LeaseTime *durationpb.Duration `protobuf:"bytes,5,opt,name=lease_time,json=leaseTime,proto3" json:"lease_time,omitempty"`
	// The maximum number of archival tasks to process concurrently.
	//
	// 0 means "unlimited".
...
func (x *Archivist) GetLeaseBatchSize() int32 {
	if x != nil {
		return x.LeaseBatchSize
	}
	return 0
}

func (x *Archivist) GetLeaseTime() *durationpb.Duration {
	if x != nil {
		return x.LeaseTime
	}
	return nil
...
func (x *Archivist) GetMaxConcurrentTasks() int32 {
	if x != nil {
...
var file_go_chromium_org_luci_logdog_api_config_svcconfig_config_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x09, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x69, 0x73, 0x74, 0x22, 0xa3, 0x02, 0x0a,
	...
	,
	...
	,
...
var file_go_chromium_org_luci_logdog_api_config_svcconfig_config_proto_depIdxs = []int32{
	...
	6, // 6: svcconfig.Collector.state_cache_expiration:type_name -> google.protobuf.Duration
	7, // 7: svcconfig.Archivist.archive_index_config:type_name -> svcconfig.ArchiveIndexConfig
	6, // 8: svcconfig.Archivist.lease_time:type_name -> google.protobuf.Duration
