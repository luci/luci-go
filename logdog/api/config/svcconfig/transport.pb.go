...
func file_go_chromium_org_luci_logdog_api_config_svcconfig_transport_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_logdog_api_config_svcconfig_transport_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_logdog_api_config_svcconfig_transport_proto_msgTypes[1].Exporter = func(v any, i int) any {
