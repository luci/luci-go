...
type QueryRequest struct {
	...
	//
	// Only paths of the forms:
	//
	//   full/path/prefix/+/**
	//   full/path/prefix/+/partial/stream/**
	//   full/path/prefix/+/partial/stream/**/name/suffix
	//   full/path/prefix/+/**/name/suffix
	//   full/path/prefix/+/full/stream/name
	//
	// Are permitted.
	Path string `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty"`
