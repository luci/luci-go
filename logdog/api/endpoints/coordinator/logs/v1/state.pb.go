...
const file_go_chromium_org_luci_logdog_api_endpoints_coordinator_logs_v1_state_proto_rawDesc = "" +
	"\n" +
	"Igo.chromium.org/luci/logdog/api/endpoints/coordinator/logs/v1/state.proto\x12\x06logdog\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x03\n" +
	"\x0eLogStreamState\x12#\n" +
	"\rproto_version\x18\x01 \x01(\tR\fprotoVersion\x124\n" +
	"\acreated\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\acreated\x12%\n" +
	"\x0eterminal_index\x18\x03 \x01(\x03R\rterminalIndex\x12<\n" +
	"\aarchive\x18\x04 \x01(\v2\".logdog.LogStreamState.ArchiveInfoR\aarchive\x12\x16\n" +
	"\x06purged\x18\x05 \x01(\bR\x06purged\x1a\xa8\x01\n" +
	"\vArchiveInfo\x12\x1b\n" +
	"\tindex_url\x18\x01 \x01(\tR\bindexUrl\x12\x1d\n" +
	"\n" +
	"stream_url\x18\x02 \x01(\tR\tstreamUrl\x12\x19\n" +
	"\bdata_url\x18\x03 \x01(\tR\adataUrl\x12\x1a\n" +
	"\bcomplete\x18\x04 \x01(\bR\bcomplete\x12&\n" +
	"\x0flog_entry_count\x18\x05 \x01(\x03R\rlogEntryCountBFZDgo.chromium.org/luci/logdog/api/endpoints/coordinator/logs/v1;logdogb\x06proto3"
