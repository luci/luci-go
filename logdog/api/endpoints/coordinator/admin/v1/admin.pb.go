...
It is generated from these files:
	go.chromium.org/luci/logdog/api/endpoints/coordinator/admin/v1/admin.proto
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/logdog/api/endpoints/coordinator/admin/v1/admin.proto", fileDescriptor0)
}
