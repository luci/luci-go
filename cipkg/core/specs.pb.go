...
func file_go_chromium_org_luci_cipkg_core_specs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_go_chromium_org_luci_cipkg_core_specs_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_go_chromium_org_luci_cipkg_core_specs_proto_msgTypes[5].OneofWrappers = []interface{}{
