...
type Derivation struct {
	...
	// host.
	// NOTE: ${out} is not included here but will be presented during execution.
...
var file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDesc = []byte{
...
var (
	...
	file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDescData = file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDesc
)
...
func file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_cipkg_core_derivation_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_cipkg_core_derivation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_cipkg_core_derivation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDesc = nil
