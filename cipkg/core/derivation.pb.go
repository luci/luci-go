...
const file_go_chromium_org_luci_cipkg_core_derivation_proto_rawDesc = "" +
	"\n" +
	"0go.chromium.org/luci/cipkg/core/derivation.proto\"\x9d\x01\n" +
	"\n" +
	"Derivation\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bplatform\x18\x02 \x01(\tR\bplatform\x12\x12\n" +
	"\x04args\x18\x03 \x03(\tR\x04args\x12\x10\n" +
	"\x03env\x18\x04 \x03(\tR\x03env\x12\x16\n" +
	"\x06inputs\x18\x05 \x03(\tR\x06inputs\x12!\n" +
	"\ffixed_output\x18\x06 \x01(\tR\vfixedOutputB!Z\x1fgo.chromium.org/luci/cipkg/coreb\x06proto3"
