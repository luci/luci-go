...
type SingleRerun struct {
	...
	// Index of the commit to rerun within the blamelist, if this is an nthsection rerun.
	// We need to use a string instead of an int here because 0 is a possible value
	// and 0 value will get lost due to the "omitempty" flag in the generated proto.
...
var file_go_chromium_org_luci_bisection_proto_gofindit_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x92, 0x03, 0x0a, 0x0b, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x52, 0x65, 0x72, 0x75,
	...
	0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x6c, 0x0a, 0x0b, 0x52, 0x65, 0x72, 0x75, 0x6e, 0x52,
