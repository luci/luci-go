...
func file_go_chromium_org_luci_bisection_proto_v1_botupdates_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_bisection_proto_v1_botupdates_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_bisection_proto_v1_botupdates_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
