...
const file_go_chromium_org_luci_bisection_proto_v1_common_proto_rawDesc = "" +
	"\n" +
	"4go.chromium.org/luci/bisection/proto/v1/common.proto\x12\x11luci.bisection.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a3go.chromium.org/luci/buildbucket/proto/common.proto\"u\n" +
	"\vRerunResult\x12A\n" +
	"\frerun_status\x18\x01 \x01(\x0e2\x1e.luci.bisection.v1.RerunStatusR\vrerunStatus\x12#\n" +
	...
	"\x11last_updated_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x0flastUpdatedTime\x125\n" +
	"\bend_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12\x12\n" +
	"\x04bbid\x18\x04 \x01(\x03R\x04bbid\x12\x17\n" +
	"\atask_id\x18\x05 \x01(\tR\x06taskId\x12\x15\n" +
	"\x06bot_id\x18\x06 \x01(\tR\x05botId\x12A\n" +
	"\frerun_result\x18\a \x01(\v2\x1e.luci.bisection.v1.RerunResultR\vrerunResult\x125\n" +
	"\x06commit\x18\b \x01(\v2\x1d.buildbucket.v2.GitilesCommitR\x06commit\x12\x14\n" +
	"\x05index\x18\t \x01(\tR\x05index\x12\x12\n" +
	"\x04type\x18\n" +
	" \x01(\tR\x04type\"\xbc\x01\n" +
	"\x1aSuspectVerificationDetails\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12C\n" +
	"\rsuspect_rerun\x18\x02 \x01(\v2\x1e.luci.bisection.v1.SingleRerunR\fsuspectRerun\x12A\n" +
	"\fparent_rerun\x18\x03 \x01(\v2\x1e.luci.bisection.v1.SingleRerunR\vparentRerun\"x\n" +
	"\aVariant\x125\n" +
	"\x03def\x18\x01 \x03(\v2#.luci.bisection.v1.Variant.DefEntryR\x03def\x1a6\n" +
	"\bDefEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"P\n" +
	"\tSourceRef\x129\n" +
	"\agitiles\x18\x01 \x01(\v2\x1d.luci.bisection.v1.GitilesRefH\x00R\agitilesB\b\n" +
	"\x06system\"L\n" +
	"\n" +
	"GitilesRef\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x18\n" +
	"\aproject\x18\x02 \x01(\tR\aproject\x12\x10\n" +
	"\x03ref\x18\x03 \x01(\tR\x03ref\"J\n" +
	"\n" +
	"Dimensions\x12<\n" +
	"\n" +
	"dimensions\x18\x01 \x03(\v2\x1c.luci.bisection.v1.DimensionR\n" +
	"dimensions\"3\n" +
	"\tDimension\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value*\xb5\x01\n" +
	"\x0eAnalysisStatus\x12\x1f\n" +
	"\x1bANALYSIS_STATUS_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aCREATED\x10\x01\x12\v\n" +
	"\aRUNNING\x10\x02\x12\t\n" +
	"\x05FOUND\x10\x03\x12\f\n" +
	"\bNOTFOUND\x10\x04\x12\t\n" +
	"\x05ERROR\x10\x05\x12\x10\n" +
	"\fSUSPECTFOUND\x10\x06\x12\x0f\n" +
	"\vUNSUPPORTED\x10\a\x12\f\n" +
	"\bDISABLED\x10\b\x12\x13\n" +
	"\x0fINSUFFICENTDATA\x10\t*\xd4\x01\n" +
	"\vRerunStatus\x12\x1c\n" +
	...
	"\x15RERUN_STATUS_CANCELED\x10\x05\x12\x1d\n" +
	"\x19RERUN_STATUS_TEST_SKIPPED\x10\x06*j\n" +
	...
	"\x19ANALYSIS_TYPE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18COMPILE_FAILURE_ANALYSIS\x10\x01\x12\x19\n" +
	"\x15TEST_FAILURE_ANALYSIS\x10\x02*\xe6\x01\n" +
	"\x19SuspectVerificationStatus\x12+\n" +
	"'SUSPECT_VERIFICATION_STATUS_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"UNVERIFIED\x10\x01\x12\x1a\n" +
	"\x16VERIFICATION_SCHEDULED\x10\x02\x12\x16\n" +
	"\x12UNDER_VERIFICATION\x10\x03\x12\x15\n" +
	"\x11CONFIRMED_CULPRIT\x10\x04\x12\x0e\n" +
	"\n" +
	"VINDICATED\x10\x05\x12\x16\n" +
	"\x12VERIFICATION_ERROR\x10\x06\x12\x19\n" +
	"\x15VERIFICATION_CANCELED\x10\a*\x8b\x01\n" +
	...
	"\bEXPECTED\x102B5Z3go.chromium.org/luci/bisection/proto/v1;bisectionpbb\x06proto3"
