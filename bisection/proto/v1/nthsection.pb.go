...
const file_go_chromium_org_luci_bisection_proto_v1_nthsection_proto_rawDesc = "" +
	"\n" +
	"8go.chromium.org/luci/bisection/proto/v1/nthsection.proto\x12\x11luci.bisection.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a4go.chromium.org/luci/bisection/proto/v1/common.proto\x1a3go.chromium.org/luci/buildbucket/proto/common.proto\"\xe7\x04\n" +
	"\x18NthSectionAnalysisResult\x129\n" +
	"\x06status\x18\x01 \x01(\x0e2!.luci.bisection.v1.AnalysisStatusR\x06status\x129\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12F\n" +
	"\x11last_updated_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x0flastUpdatedTime\x125\n" +
	"\bend_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12\x1a\n" +
	"\bverified\x18\x05 \x01(\bR\bverified\x12a\n" +
	"\x1bremaining_nth_section_range\x18\x06 \x01(\v2\".luci.bisection.v1.RegressionRangeR\x18remainingNthSectionRange\x12#\n" +
	"\rerror_message\x18\a \x01(\tR\ferrorMessage\x126\n" +
	"\x06reruns\x18\b \x03(\v2\x1e.luci.bisection.v1.SingleRerunR\x06reruns\x12:\n" +
	"\tblameList\x18\t \x01(\v2\x1c.luci.bisection.v1.BlameListR\tblameList\x12>\n" +
	"\asuspect\x18\n" +
	" \x01(\v2$.luci.bisection.v1.NthSectionSuspectR\asuspect\"\xa3\x01\n" +
	"\tBlameList\x12B\n" +
	"\acommits\x18\x01 \x03(\v2(.luci.bisection.v1.BlameListSingleCommitR\acommits\x12R\n" +
	"\x10last_pass_commit\x18\x02 \x01(\v2(.luci.bisection.v1.BlameListSingleCommitR\x0elastPassCommit\"\xc8\x01\n" +
	"\x15BlameListSingleCommit\x12\x16\n" +
	"\x06commit\x18\x01 \x01(\tR\x06commit\x12\x1c\n" +
	...
	"\vcommit_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"commitTime\"\xb2\x02\n" +
	"\x11NthSectionSuspect\x12D\n" +
	"\x0egitiles_commit\x18\x01 \x01(\v2\x1d.buildbucket.v2.GitilesCommitR\rgitilesCommit\x12\x1c\n" +
	"\treviewUrl\x18\x02 \x01(\tR\treviewUrl\x12 \n" +
	"\vreviewTitle\x18\x03 \x01(\tR\vreviewTitle\x12`\n" +
	"\x14verification_details\x18\x04 \x01(\v2-.luci.bisection.v1.SuspectVerificationDetailsR\x13verificationDetails\x125\n" +
	"\x06commit\x18\x05 \x01(\v2\x1d.buildbucket.v2.GitilesCommitR\x06commit\"\xc3\x01\n" +
	"\x0fRegressionRange\x12>\n" +
	"\vlast_passed\x18\x01 \x01(\v2\x1d.buildbucket.v2.GitilesCommitR\n" +
	"lastPassed\x12@\n" +
	"\ffirst_failed\x18\x02 \x01(\v2\x1d.buildbucket.v2.GitilesCommitR\vfirstFailed\x12.\n" +
	"\x13number_of_revisions\x18\x03 \x01(\x05R\x11numberOfRevisionsB5Z3go.chromium.org/luci/bisection/proto/v1;bisectionpbb\x06proto3"
