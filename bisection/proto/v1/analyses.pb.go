...
func (x *ListAnalysesRequest) GetProject() string {
	if x != nil {
		return x.Project
	}
	return ""
...
const file_go_chromium_org_luci_bisection_proto_v1_analyses_proto_rawDesc = "" +
	...
	"\banalyses\x18\x01 \x03(\v2\x1b.luci.bisection.v1.AnalysisR\banalyses\"p\n" +
	"\x13ListAnalysesRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12\x1d\n" +
	"\aproject\x18\x03 \x01(\tB\x03\xe0A\x02R\aproject\"w\n" +
