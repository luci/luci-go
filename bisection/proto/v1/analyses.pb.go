...
type Analysis struct {
	...
	// Indicates if actions have been taken for the analysis.
	HasTakenActions bool `protobuf:"varint,16,opt,name=has_taken_actions,json=hasTakenActions,proto3" json:"has_taken_actions,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Analysis) GetHasTakenActions() bool {
	if x != nil {
		return x.HasTakenActions
	}
	return false
}
...
const file_go_chromium_org_luci_bisection_proto_v1_analyses_proto_rawDesc = "" +
	...
	"analysisId\x125\n" +
	"\bbug_info\x18\x02 \x03(\v2\x1a.luci.bisection.v1.BugInfoR\abugInfo\"\xef\a\n" +
	"\bAnalysis\x12\x1f\n" +
	...
	"\rgen_ai_result\x18\x0f \x01(\v2&.luci.bisection.v1.GenAiAnalysisResultR\vgenAiResult\x12*\n" +
	"\x11has_taken_actions\x18\x10 \x01(\bR\x0fhasTakenActions\"L\n" +
