...
type GenAiSuspect struct {
	...
	SubCommit     string `protobuf:"bytes,8,opt,name=sub_commit,json=subCommit,proto3" json:"sub_commit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GenAiSuspect) GetConfidenceScore() int32 {
	if x != nil {
...
func (x *GenAiSuspect) GetSubCommit() string {
	if x != nil {
		return x.SubCommit
	}
	return ""
...
const file_go_chromium_org_luci_bisection_proto_v1_genai_proto_rawDesc = "" +
	...
	"\bend_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\xf3\x02\n" +
	"\fGenAiSuspect\x125\n" +
	...
	"\x10confidence_score\x18\a \x01(\x05R\x0fconfidenceScore\x12\x1d\n" +
	"\n" +
	"sub_commit\x18\b \x01(\tR\tsubCommitB5Z3go.chromium.org/luci/bisection/proto/v1;bisectionpbb\x06proto3"
