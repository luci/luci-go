...
var file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDesc = string([]byte{
	...
	0x67, 0x22, 0x08, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x36, 0x5a, 0x34, 0x67,
...
var (
	...
	file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDesc), len(file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDesc)))
	})
	return file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDescData
}

var file_go_chromium_org_luci_bisection_proto_config_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_go_chromium_org_luci_bisection_proto_config_config_proto_goTypes = []any{
...
func file_go_chromium_org_luci_bisection_proto_config_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDesc), len(file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
