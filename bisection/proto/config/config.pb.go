...
const file_go_chromium_org_luci_bisection_proto_config_config_proto_rawDesc = "" +
	"\n" +
	"8go.chromium.org/luci/bisection/proto/config/config.proto\x12\x15luci.bisection.config\"\b\n" +
	"\x06ConfigB6Z4go.chromium.org/luci/bisection/proto/config;configpbb\x06proto3"
