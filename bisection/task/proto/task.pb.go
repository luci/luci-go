...
func (x *TestFailureCulpritVerificationTask) GetSuspectId() int64 {
	if x != nil {
		return x.SuspectId
	}
	return 0
...
func (x *TestFailureCulpritVerificationTask) GetParentKey() string {
	if x != nil {
		return x.ParentKey
	}
	return ""
...
const file_go_chromium_org_luci_bisection_task_proto_task_proto_rawDesc = "" +
	"\n" +
	"4go.chromium.org/luci/bisection/task/proto/task.proto\x12\x05proto\x1a4go.chromium.org/luci/bisection/proto/v1/common.proto\".\n" +
	"\x18FailedBuildIngestionTask\x12\x12\n" +
	"\x04bbid\x18\x01 \x01(\x03R\x04bbid\"S\n" +
	"\x11RevertCulpritTask\x12\x1f\n" +
	...
	"analysisId\x12\x1d\n" +
	"\n" +
	"suspect_id\x18\x02 \x01(\x03R\tsuspectId\x12\x1d\n" +
	"\n" +
	"parent_key\x18\x03 \x01(\tR\tparentKey\"\x81\x01\n" +
	"\x18TestFailureDetectionTask\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12K\n" +
	"\x12dimension_excludes\x18\x02 \x03(\v2\x1c.luci.bisection.v1.DimensionR\x11dimensionExcludes\";\n" +
	"\x18TestFailureBisectionTask\x12\x1f\n" +
	"\vanalysis_id\x18\x01 \x01(\x03R\n" +
	"analysisId\"\x83\x01\n" +
	"\"TestFailureCulpritVerificationTask\x12\x1f\n" +
	"\vanalysis_id\x18\x01 \x01(\x03R\n" +
	"analysisId\x12\x1d\n" +
	"\n" +
	"suspect_id\x18\x02 \x01(\x03R\tsuspectId\x12\x1d\n" +
