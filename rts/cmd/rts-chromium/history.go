...
func cmdPresubmitHistory(authOpt *auth.Options, defaultCacheDir string) *subcommands.Command {
	return &subcommands.Command{
		...
		CommandRun: func() subcommands.CommandRun {
			...
			`))
			r.Flags.StringVar(&r.cacheDir, "cache-dir", defaultCacheDir, "Path to the cache dir")
			r.Flags.IntVar(&r.gerritQPSLimit, "gerrit-qps-limit", defaultGerritQPSLimit, "Max Gerrit QPS")
			return r
		},
	}
}
