...
func cmdEval() *subcommands.Command {
	return &subcommands.Command{
		UsageLine: `eval`,
		ShortDesc: "evaluate the RTS algorithm for Chromium",
		LongDesc: text.Doc(`
			Evaluate the RTS algorithm.
		`),
...
func (r *evalRun) algo(ctx context.Context, in eval.Input) (out eval.Output, err error) {
