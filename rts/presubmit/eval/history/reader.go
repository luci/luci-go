...
// Reader deserializes historic facts from an io.Reader.
type Reader struct {
	buf    []byte
	closer io.Closer
	rio    recordio.Reader
...
// Returns io.EOF if there is no another record.
...
// Close flushes everything and closes the underlying io.Reader.
