...
func (e *Eval) evaluateSafety(ctx context.Context, res *Result) error {
	...
	var mu sync.Mutex
	err := e.processHistory(ctx, e.Rejections, func(ctx context.Context) error {
...
func (e *Eval) evaluateEfficiency(ctx context.Context, res *Result) error {
	...
	err := e.processHistory(ctx, e.Durations, func(ctx context.Context) error {
...
// processHistory plays back history in player and invokes f e.Concurrency
// times.
func (e *Eval) processHistory(ctx context.Context, player *history.Player, f func(ctx context.Context) error) error {
	eg, ctx := errgroup.WithContext(ctx)
	defer eg.Wait()

	// Play back the history.
	eg.Go(func() error {
		err := player.PlaybackDurations(ctx)
