...
type Eval struct {
	...
	// If a test's distance is <= MaxDistance, then it is executed.
	//
	...
	// For example, if MinRank is 5, then tests ranked as #1, #2, .. #5
	// are executed, regardless of MaxDistance.
...
func (e *Eval) shouldRun(s TestSelection) bool {
