...
type Output struct {
	// TestVariantSelections are selections for Input.TestVariants, in the same
	// order. When Algorithm() is called, TestVariantSelections is pre-initialized
...
// TestSelection is output of an RTS algorithm for a particular test.
type TestSelection struct {
	...
	// Rank is one-based rank of a test relative to all known tests, wrt distance.
