...
type GerritChange struct {
	...
	// Gerrit host, e.g. "chromium.googlesource.com".
	Host string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	// Gerrit project, e.g. "chromium/src".
	// It is reqiured.
	Project string `protobuf:"bytes,2,opt,name=project,proto3" json:"project,omitempty"`
	// Change number, e.g. 123 for the CL
	// https://chromium.googlesource.com/c/123
...
func (x *GerritPatchset) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
type Test struct {
	...
	// The name of the file where the test is defined.
...
// A single historical record, an entry.
type Record struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
type Record_Rejection struct {
	// A record of a code change rejection due to test failures.
...
var file_go_chromium_org_luci_rts_presubmit_eval_proto_eval_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x69, 0x0a, 0x0e, 0x47, 0x65, 0x72, 0x72, 0x69, 0x74, 0x50, 0x61, 0x74, 0x63, 0x68,
	...
	0x61, 0x6e, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x33, 0x0a, 0x04,
	...
	0x65, 0x22, 0x56, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x44, 0x0a, 0x09, 0x72,
