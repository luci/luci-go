...
const rejectedPatchSetsSQL = `
	WITH
		...
		failed_test_variants AS (
			...
			-- TODO(crbug.com/1112125): consider doing this filtering after joining
			-- grouping by patchsets.
	...
	SELECT
		STRUCT(STRUCT(host as Host, change as Number) AS Change, patchset as Patchset) Patchset,
