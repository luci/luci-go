...
//
// The distance value of the row R is the minimal positive distance threshold
// required to achieve ChangeRecall score of (R+1)/100.0 on the training set,
// while ignoring rank threshold.
// For example, ThresholdGrid[94][0].Value.Distance achieves 95% ChangeRecall
// on the training set.
//
// Similarly, rank value of the column C is the minimal positive rank threshold
// required to achieve ChangeRecall score of (C+1)/100.0 on to the training set,
