			...
			So(g.root, ShouldResemble, node{
				...
				children: map[string]*node{
					"a": {
						...
						edges:              []edge{{to: g.node("//b"), probSumMultiplied: probSumMultiplier}},
					},
					"b": {
						name:               "//b",
						probSumDenominator: 1,
						edges:              []edge{{to: g.node("//a"), probSumMultiplied: probSumMultiplier}},
					},
				},
			})
				...
				So(g.root, ShouldResemble, node{
					...
					children: map[string]*node{
						...
						"b": {
							...
							edges: []edge{
								{to: g.node("//a"), probSumMultiplied: probSumMultiplier},
								{to: g.node("//c/d"), probSumMultiplied: probSumMultiplier},
							},
						},
						"c": {
							name: "//c",
				...
				So(g.root, ShouldResemble, node{
					...
					children: map[string]*node{
						"a": {
							name:               "//a",
							probSumDenominator: 2,
							edges:              []edge{{to: g.node("//b"), probSumMultiplied: 2 * probSumMultiplier}},
						},
						"b": {
							name:               "//b",
							probSumDenominator: 2,
							edges:              []edge{{to: g.node("//a"), probSumMultiplied: 2 * probSumMultiplier}},
						},
					},
				})
				...
				So(g.root, ShouldResemble, node{
					...
					children: map[string]*node{
						...
						"b": {
							...
							edges: []edge{
								{to: g.node("//a"), probSumMultiplied: probSumMultiplier},
								{to: g.node("//c"), probSumMultiplied: probSumMultiplier},
							},
						},
						"c": {
							name:               "//c",
