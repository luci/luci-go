			...
			So(g.root, ShouldResemble, node{
				...
				children: map[string]*node{
					"a": {
						name:    "//a",
						commits: 1,
						edges:   []edge{{to: g.node("//b"), sumOfProb: 1}},
					},
					"b": {
						name:    "//b",
						commits: 1,
						edges:   []edge{{to: g.node("//a"), sumOfProb: 1}},
					},
				},
			})
				...
				So(g.root, ShouldResemble, node{
					...
					children: map[string]*node{
						...
						"b": {
							...
							commits: 2,
							edges: []edge{
								{to: g.node("//a"), sumOfProb: 1},
								{to: g.node("//c/d"), sumOfProb: 1},
							},
						},
						"c": {
							name: "//c",
				...
				So(g.root, ShouldResemble, node{
					...
					children: map[string]*node{
						"a": {
							name:    "//a",
							commits: 2,
							edges:   []edge{{to: g.node("//b"), sumOfProb: 2}},
						},
						"b": {
							name:    "//b",
							commits: 2,
							edges:   []edge{{to: g.node("//a"), sumOfProb: 2}},
						},
					},
				})
				...
				So(g.root, ShouldResemble, node{
					...
					children: map[string]*node{
						...
						"b": {
							...
							edges: []edge{
								{to: g.node("//a"), sumOfProb: 1},
								{to: g.node("//c"), sumOfProb: math.NaN()},
							},
						},
						"c": {
							name:    "//c",
							commits: 1,
							edges:   []edge{{to: g.node("//b"), sumOfProb: math.NaN()}},
						},
					},
				})
			})
