...
// EvalStrategy implements eval.Strategy.
// It can be used to evaluate data quality of the graph.
//
// This function is not designed to be called directly the evaluation framework
// directly. Instead it should be wrapped with another strategy function that
// validates the input. For example, this function does not check
