...
// The weight of edge (A, B) represents how much B is relevant to A.
// Such graph provides relevance between any two files, and can order files by
// relevance from/to a given file.
//
...
//   - distance: a value from 0.0 to +inf, where 0.0 means extremely relevant
//     and +inf means not relevant at all.
//
// One metric can be computed from another:
//
//   Distance := -log_2(Relevance)
