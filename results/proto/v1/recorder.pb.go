...
type OverrideInclusionRequest struct {
	...
	OverridenIncludedInvocation string `protobuf:"bytes,2,opt,name=overriden_included_invocation,json=overridenIncludedInvocation,proto3" json:"overriden_included_invocation,omitempty"`
...
func (m *OverrideInclusionRequest) GetOverridenIncludedInvocation() string {
	if m != nil {
		return m.OverridenIncludedInvocation
	}
	return ""
}
...
type OverrideInclusionResponse struct {
	// The overriden inclusion.
	// For example, the inclusion of a died swarming task.
	OverridenInclusion *Inclusion `protobuf:"bytes,1,opt,name=overriden_inclusion,json=overridenInclusion,proto3" json:"overriden_inclusion,omitempty"`
	// The inclusion that has overriden the other inclusion.
...
func (m *OverrideInclusionResponse) GetOverridenInclusion() *Inclusion {
	if m != nil {
		return m.OverridenInclusion
	}
	return nil
}
...
var fileDescriptor_7445f3675a5ef248 = []byte{
	...
	,
}
