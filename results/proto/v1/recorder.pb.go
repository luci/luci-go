...
type UpdateInvocationRequest struct {
	...
	//
	// If the invocation is finalized on the server, FAILED_PRECONDITION is
	// returned.
...
type RecorderClient interface {
	...
	// The request specified the invocation id and its contents.
	// The invocation can be created finalized.
	//
