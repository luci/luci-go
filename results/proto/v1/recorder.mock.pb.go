...
func (m *MockRecorderClient) UpdateInvocation(ctx context.Context, in *UpdateInvocationRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// UpdateInclusion mocks base method
func (m *MockRecorderClient) UpdateInclusion(ctx context.Context, in *UpdateInclusionRequest, opts ...grpc.CallOption) (*Inclusion, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "UpdateInclusion", varargs...)
	ret0, _ := ret[0].(*Inclusion)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateInclusion indicates an expected call of UpdateInclusion
func (mr *MockRecorderClientMockRecorder) UpdateInclusion(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateInclusion", reflect.TypeOf((*MockRecorderClient)(nil).UpdateInclusion), varargs...)
}
...
// UpdateInvocation mocks base method
func (m *MockRecorderServer) UpdateInvocation(arg0 context.Context, arg1 *UpdateInvocationRequest) (*empty.Empty, error) {
	m.ctrl.T.Helper()
...
// UpdateInclusion mocks base method
func (m *MockRecorderServer) UpdateInclusion(arg0 context.Context, arg1 *UpdateInclusionRequest) (*Inclusion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateInclusion", arg0, arg1)
	ret0, _ := ret[0].(*Inclusion)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// UpdateInclusion indicates an expected call of UpdateInclusion
func (mr *MockRecorderServerMockRecorder) UpdateInclusion(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateInclusion", reflect.TypeOf((*MockRecorderServer)(nil).UpdateInclusion), arg0, arg1)
}
