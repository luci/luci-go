...
// source: go.chromium.org/luci/results/proto/v1/test_result.proto
...
func (TestStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ac6376104a1b4cd4, []int{0}
}
...
type TestResult struct {
	// Resource name.
	// Format: "invocations/{invocation}/testResults/{result}".
	// OUTPUT_ONLY.
	//
	// Impl detail: {result} encodes a tuple (test_path, spanner_level_result_id)
...
func (*Artifact) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac6376104a1b4cd4, []int{1}
}
...
func (*TestVariant) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac6376104a1b4cd4, []int{2}
}
...
type TestExoneration struct {
	...
	// Format: invocations/{invocation}/testExonerations/{exoneration}.
	// Output-only.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
...
func (*TestExoneration) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac6376104a1b4cd4, []int{3}
}
...
func init() {
	proto.RegisterFile("go.chromium.org/luci/results/proto/v1/test_result.proto", fileDescriptor_ac6376104a1b4cd4)
}

var fileDescriptor_ac6376104a1b4cd4 = []byte{
	// 631 bytes of a gzipped FileDescriptorProto
	,
}
