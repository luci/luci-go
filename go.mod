...
require (
	...
	go.chromium.org/turboci/proto/go v0.0.0-20260420211755-2aa307f971ef
	...
	google.golang.org/genproto/googleapis/bytestream v0.0.0-20260406210006-6f92a3bedf2d
