...
func (*UnimplementedDepsServer) ActivateExecution(context.Context, *ActivateExecutionReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ActivateExecution not implemented")
}
func (*UnimplementedDepsServer) FinishAttempt(context.Context, *FinishAttemptReq) (*empty.Empty, error) {
