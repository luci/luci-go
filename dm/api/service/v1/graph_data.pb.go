...
func (x *JsonResult) GetExpiration() *timestamp.Timestamp {
	if x != nil {
		return x.Expiration
	}
	return nil
...
func (x *Quest_Data) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *Quest_Desc_Meta_Timeouts) GetStart() *duration.Duration {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *Quest_Desc_Meta_Timeouts) GetRun() *duration.Duration {
	if x != nil {
		return x.Run
	}
	return nil
...
func (x *Quest_Desc_Meta_Timeouts) GetStop() *duration.Duration {
	if x != nil {
		return x.Stop
	}
	return nil
...
func (x *Attempt_Data) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *Attempt_Data) GetModified() *timestamp.Timestamp {
	if x != nil {
		return x.Modified
	}
	return nil
...
func (x *Execution_Data) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *Execution_Data) GetModified() *timestamp.Timestamp {
	if x != nil {
		return x.Modified
	}
	return nil
...
var file_go_chromium_org_luci_dm_api_service_v1_graph_data_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x62, 0x06, 0x70,
