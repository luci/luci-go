...
var file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDesc), len(file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDesc)))
	})
...
func file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDesc), len(file_go_chromium_org_luci_analysis_proto_v1_issue_tracking_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
