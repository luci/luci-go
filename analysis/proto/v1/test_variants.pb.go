...
const file_go_chromium_org_luci_analysis_proto_v1_test_variants_proto_rawDesc = "" +
	"\n" +
	":go.chromium.org/luci/analysis/proto/v1/test_variants.proto\x12\x10luci.analysis.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a3go.chromium.org/luci/analysis/proto/v1/common.proto\x1a4go.chromium.org/luci/analysis/proto/v1/sources.proto\"\xa5\x02\n" +
	"\"QueryTestVariantFailureRateRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12e\n" +
	"\rtest_variants\x18\x02 \x03(\v2@.luci.analysis.v1.QueryTestVariantFailureRateRequest.TestVariantR\ftestVariants\x1a~\n" +
	"\vTestVariant\x12\x17\n" +
	"\atest_id\x18\x01 \x01(\tR\x06testId\x123\n" +
	"\avariant\x18\x02 \x01(\v2\x19.luci.analysis.v1.VariantR\avariant\x12!\n" +
	"\fvariant_hash\x18\x03 \x01(\tR\vvariantHash\"\xfc\x02\n" +
	"#QueryTestVariantFailureRateResponse\x12\\\n" +
	"\tintervals\x18\x01 \x03(\v2>.luci.analysis.v1.QueryTestVariantFailureRateResponse.IntervalR\tintervals\x12U\n" +
	"\rtest_variants\x18\x02 \x03(\v20.luci.analysis.v1.TestVariantFailureRateAnalysisR\ftestVariants\x1a\x9f\x01\n" +
	"\bInterval\x12!\n" +
	"\finterval_age\x18\x01 \x01(\x05R\vintervalAge\x129\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\x96\t\n" +
	"\x1eTestVariantFailureRateAnalysis\x12\x17\n" +
	"\atest_id\x18\x01 \x01(\tR\x06testId\x123\n" +
	"\avariant\x18\x02 \x01(\v2\x19.luci.analysis.v1.VariantR\avariant\x12!\n" +
	"\fvariant_hash\x18\x03 \x01(\tR\vvariantHash\x12e\n" +
	"\x0einterval_stats\x18\x04 \x03(\v2>.luci.analysis.v1.TestVariantFailureRateAnalysis.IntervalStatsR\rintervalStats\x12|\n" +
	"\x1arun_flaky_verdict_examples\x18\x05 \x03(\v2?.luci.analysis.v1.TestVariantFailureRateAnalysis.VerdictExampleR\x17runFlakyVerdictExamples\x12g\n" +
	"\x0frecent_verdicts\x18\x06 \x03(\v2>.luci.analysis.v1.TestVariantFailureRateAnalysis.RecentVerdictR\x0erecentVerdicts\x1a\xed\x01\n" +
	"\rIntervalStats\x12!\n" +
	"\finterval_age\x18\x01 \x01(\x05R\vintervalAge\x12=\n" +
	"\x1btotal_run_expected_verdicts\x18\x02 \x01(\x05R\x18totalRunExpectedVerdicts\x127\n" +
	"\x18total_run_flaky_verdicts\x18\x03 \x01(\x05R\x15totalRunFlakyVerdicts\x12A\n" +
	"\x1dtotal_run_unexpected_verdicts\x18\x04 \x01(\x05R\x1atotalRunUnexpectedVerdicts\x1a\xc9\x01\n" +
	"\x0eVerdictExample\x12A\n" +
	"\x0epartition_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\rpartitionTime\x124\n" +
	"\x16ingested_invocation_id\x18\x02 \x01(\tR\x14ingestedInvocationId\x12>\n" +
	"\vchangelists\x18\x03 \x03(\v2\x1c.luci.analysis.v1.ChangelistR\vchangelists\x1a\xf8\x01\n" +
	"\rRecentVerdict\x12A\n" +
	"\x0epartition_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\rpartitionTime\x124\n" +
	"\x16ingested_invocation_id\x18\x02 \x01(\tR\x14ingestedInvocationId\x12>\n" +
	"\vchangelists\x18\x03 \x03(\v2\x1c.luci.analysis.v1.ChangelistR\vchangelists\x12.\n" +
	"\x13has_unexpected_runs\x18\x04 \x01(\bR\x11hasUnexpectedRuns\"\xe7\x02\n" +
	" QueryTestVariantStabilityRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12k\n" +
	"\rtest_variants\x18\x02 \x03(\v2F.luci.analysis.v1.QueryTestVariantStabilityRequest.TestVariantPositionR\ftestVariants\x1a\xbb\x01\n" +
	"\x13TestVariantPosition\x12\x17\n" +
	"\atest_id\x18\x01 \x01(\tR\x06testId\x123\n" +
	"\avariant\x18\x02 \x01(\v2\x19.luci.analysis.v1.VariantR\avariant\x12!\n" +
	"\fvariant_hash\x18\x03 \x01(\tR\vvariantHash\x123\n" +
	"\asources\x18\x04 \x01(\v2\x19.luci.analysis.v1.SourcesR\asources\"\xbd\x01\n" +
	"!QueryTestVariantStabilityResponse\x12S\n" +
	"\rtest_variants\x18\x01 \x03(\v2..luci.analysis.v1.TestVariantStabilityAnalysisR\ftestVariants\x12C\n" +
	"\bcriteria\x18\x02 \x01(\v2'.luci.analysis.v1.TestStabilityCriteriaR\bcriteria\"\x9a\x04\n" +
	"\x15TestStabilityCriteria\x12^\n" +
	"\ffailure_rate\x18\x01 \x01(\v2;.luci.analysis.v1.TestStabilityCriteria.FailureRateCriteriaR\vfailureRate\x12X\n" +
	"\n" +
	"flake_rate\x18\x02 \x01(\v29.luci.analysis.v1.TestStabilityCriteria.FlakeRateCriteriaR\tflakeRate\x1a\x86\x01\n" +
	...
	"\x0etotal_verdicts\x18\x03 \x01(\x05R\rtotalVerdicts\x12n\n" +
	"\x0eflake_examples\x18\x04 \x03(\v2G.luci.analysis.v1.TestVariantStabilityAnalysis.FlakeRate.VerdictExampleR\rflakeExamples\x12%\n" +
	"\x0estart_position\x18\x05 \x01(\x03R\rstartPosition\x12!\n" +
	"\fend_position\x18\x06 \x01(\x03R\vendPosition\x123\n" +
	"\x16run_flaky_verdicts_1wd\x18\a \x01(\x05R\x13runFlakyVerdicts1wd\x12,\n" +
