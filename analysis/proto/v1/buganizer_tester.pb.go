...
const file_go_chromium_org_luci_analysis_proto_v1_buganizer_tester_proto_rawDesc = "" +
	"\n" +
	"=go.chromium.org/luci/analysis/proto/v1/buganizer_tester.proto\x12\x10luci.analysis.v1\"\x1a\n" +
	"\x18CreateSampleIssueRequest\"6\n" +
	"\x19CreateSampleIssueResponse\x12\x19\n" +
	"\bissue_id\x18\x01 \x01(\x03R\aissueId2\x81\x01\n" +
	"\x0fBuganizerTester\x12n\n" +
	"\x11CreateSampleIssue\x12*.luci.analysis.v1.CreateSampleIssueRequest\x1a+.luci.analysis.v1.CreateSampleIssueResponse\"\x00B3Z1go.chromium.org/luci/analysis/proto/v1;analysispbb\x06proto3"
