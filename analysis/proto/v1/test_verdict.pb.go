...
const file_go_chromium_org_luci_analysis_proto_v1_test_verdict_proto_rawDesc = "" +
	"\n" +
	"9go.chromium.org/luci/analysis/proto/v1/test_verdict.proto\x12\x10luci.analysis.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a4go.chromium.org/luci/analysis/proto/v1/sources.proto\"\xe6\x05\n" +
	"\vTestVerdict\x12\x17\n" +
	...
	"\x06status\x18\x04 \x01(\x0e2#.luci.analysis.v1.TestVerdictStatusB\x02\x18\x01R\x06status\x12A\n" +
	"\tstatus_v2\x18\b \x01(\x0e2$.luci.analysis.v1.TestVerdict.StatusR\bstatusV2\x12U\n" +
	"\x0fstatus_override\x18\t \x01(\x0e2,.luci.analysis.v1.TestVerdict.StatusOverrideR\x0estatusOverride\x12A\n" +
	"\x0epartition_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\rpartitionTime\x12I\n" +
	"\x13passed_avg_duration\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\x11passedAvgDuration\x12>\n" +
	"\vchangelists\x18\a \x03(\v2\x1c.luci.analysis.v1.ChangelistR\vchangelists\"v\n" +
	"\x06Status\x12\x16\n" +
	...
	"\n" +
	"EXONERATED\x10\x02*j\n" +
	"\x10TestResultStatus\x12\"\n" +
	"\x1eTEST_RESULT_STATUS_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04PASS\x10\x01\x12\b\n" +
	"\x04FAIL\x10\x02\x12\t\n" +
	"\x05CRASH\x10\x03\x12\t\n" +
	"\x05ABORT\x10\x04\x12\b\n" +
	"\x04SKIP\x10\x05*\x8b\x01\n" +
	"\x11TestVerdictStatus\x12#\n" +
	"\x1fTEST_VERDICT_STATUS_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"UNEXPECTED\x10\n" +
	"\x12\x18\n" +
	...
	"\n" +
	"EXONERATED\x10(\x12\f\n" +
	"\bEXPECTED\x102B3Z1go.chromium.org/luci/analysis/proto/v1;analysispbb\x06proto3"
