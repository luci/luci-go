...
func (x *ClusterRequest_TestResult) GetVariant() *Variant {
	if x != nil {
		return x.Variant
	}
	return nil
...
const file_go_chromium_org_luci_analysis_proto_v1_clusters_proto_rawDesc = "" +
	"\n" +
	"5go.chromium.org/luci/analysis/proto/v1/clusters.proto\x12\x10luci.analysis.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a3go.chromium.org/luci/analysis/proto/v1/common.proto\x1a4go.chromium.org/luci/analysis/proto/v1/sources.proto\x1a;go.chromium.org/luci/analysis/proto/v1/failure_reason.proto\"\xc0\x02\n" +
	"\x0eClusterRequest\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12N\n" +
	"\ftest_results\x18\x02 \x03(\v2+.luci.analysis.v1.ClusterRequest.TestResultR\vtestResults\x1a\xc3\x01\n" +
	"\n" +
	"TestResult\x12\x1f\n" +
	"\vrequest_tag\x18\x01 \x01(\tR\n" +
	"requestTag\x12\x17\n" +
	"\atest_id\x18\x02 \x01(\tR\x06testId\x12F\n" +
	"\x0efailure_reason\x18\x03 \x01(\v2\x1f.luci.analysis.v1.FailureReasonR\rfailureReason\x123\n" +
	"\avariant\x18\x04 \x01(\v2\x19.luci.analysis.v1.VariantR\avariant\"\xea\x03\n" +
...
var file_go_chromium_org_luci_analysis_proto_v1_clusters_proto_depIdxs = []int32{
	...
	38, // 31: luci.analysis.v1.ClusterRequest.TestResult.variant:type_name -> luci.analysis.v1.Variant
	25, // 32: luci.analysis.v1.ClusterResponse.ClusteredTestResult.clusters:type_name -> luci.analysis.v1.ClusterResponse.ClusteredTestResult.ClusterEntry
	36, // 33: luci.analysis.v1.ClusterResponse.ClusteredTestResult.ClusterEntry.cluster_id:type_name -> luci.analysis.v1.ClusterId
	37, // 34: luci.analysis.v1.ClusterResponse.ClusteredTestResult.ClusterEntry.bug:type_name -> luci.analysis.v1.AssociatedBug
	26, // 35: luci.analysis.v1.Cluster.TimewiseCounts.one_day:type_name -> luci.analysis.v1.Cluster.Counts
	26, // 36: luci.analysis.v1.Cluster.TimewiseCounts.three_day:type_name -> luci.analysis.v1.Cluster.Counts
	26, // 37: luci.analysis.v1.Cluster.TimewiseCounts.seven_day:type_name -> luci.analysis.v1.Cluster.Counts
	27, // 38: luci.analysis.v1.Cluster.MetricsEntry.value:type_name -> luci.analysis.v1.Cluster.TimewiseCounts
	29, // 39: luci.analysis.v1.ClusterSummary.MetricsEntry.value:type_name -> luci.analysis.v1.ClusterSummary.MetricValue
	43, // 40: luci.analysis.v1.DistinctClusterFailure.Exoneration.reason:type_name -> luci.analysis.v1.ExonerationReason
	44, // 41: luci.analysis.v1.DistinctClusterFailure.PresubmitRun.presubmit_run_id:type_name -> luci.analysis.v1.PresubmitRunId
	45, // 42: luci.analysis.v1.DistinctClusterFailure.PresubmitRun.mode:type_name -> luci.analysis.v1.PresubmitRunMode
	46, // 43: luci.analysis.v1.DistinctClusterFailure.PresubmitRun.status:type_name -> luci.analysis.v1.PresubmitRunStatus
	1,  // 44: luci.analysis.v1.Clusters.Cluster:input_type -> luci.analysis.v1.ClusterRequest
	4,  // 45: luci.analysis.v1.Clusters.Get:input_type -> luci.analysis.v1.GetClusterRequest
	6,  // 46: luci.analysis.v1.Clusters.GetReclusteringProgress:input_type -> luci.analysis.v1.GetReclusteringProgressRequest
	8,  // 47: luci.analysis.v1.Clusters.QueryClusterSummaries:input_type -> luci.analysis.v1.QueryClusterSummariesRequest
	11, // 48: luci.analysis.v1.Clusters.QueryClusterFailures:input_type -> luci.analysis.v1.QueryClusterFailuresRequest
	14, // 49: luci.analysis.v1.Clusters.QueryExoneratedTestVariants:input_type -> luci.analysis.v1.QueryClusterExoneratedTestVariantsRequest
	17, // 50: luci.analysis.v1.Clusters.QueryExoneratedTestVariantBranches:input_type -> luci.analysis.v1.QueryClusterExoneratedTestVariantBranchesRequest
	20, // 51: luci.analysis.v1.Clusters.QueryHistory:input_type -> luci.analysis.v1.QueryClusterHistoryRequest
	2,  // 52: luci.analysis.v1.Clusters.Cluster:output_type -> luci.analysis.v1.ClusterResponse
	5,  // 53: luci.analysis.v1.Clusters.Get:output_type -> luci.analysis.v1.Cluster
	7,  // 54: luci.analysis.v1.Clusters.GetReclusteringProgress:output_type -> luci.analysis.v1.ReclusteringProgress
	9,  // 55: luci.analysis.v1.Clusters.QueryClusterSummaries:output_type -> luci.analysis.v1.QueryClusterSummariesResponse
	12, // 56: luci.analysis.v1.Clusters.QueryClusterFailures:output_type -> luci.analysis.v1.QueryClusterFailuresResponse
	15, // 57: luci.analysis.v1.Clusters.QueryExoneratedTestVariants:output_type -> luci.analysis.v1.QueryClusterExoneratedTestVariantsResponse
	18, // 58: luci.analysis.v1.Clusters.QueryExoneratedTestVariantBranches:output_type -> luci.analysis.v1.QueryClusterExoneratedTestVariantBranchesResponse
	21, // 59: luci.analysis.v1.Clusters.QueryHistory:output_type -> luci.analysis.v1.QueryClusterHistoryResponse
