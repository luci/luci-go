...
const file_go_chromium_org_luci_analysis_proto_v1_metrics_proto_rawDesc = "" +
	"\n" +
	"4go.chromium.org/luci/analysis/proto/v1/metrics.proto\x12\x10luci.analysis.v1\"3\n" +
	"\x19ListProjectMetricsRequest\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parent\"W\n" +
	"\x1aListProjectMetricsResponse\x129\n" +
	"\ametrics\x18\x01 \x03(\v2\x1f.luci.analysis.v1.ProjectMetricR\ametrics\"\xd6\x01\n" +
	"\rProjectMetric\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tmetric_id\x18\x02 \x01(\tR\bmetricId\x12.\n" +
	"\x13human_readable_name\x18\x03 \x01(\tR\x11humanReadableName\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x1d\n" +
	"\n" +
	"is_default\x18\x05 \x01(\bR\tisDefault\x12#\n" +
	"\rsort_priority\x18\x06 \x01(\x05R\fsortPriority2x\n" +
	"\aMetrics\x12m\n" +
	"\x0eListForProject\x12+.luci.analysis.v1.ListProjectMetricsRequest\x1a,.luci.analysis.v1.ListProjectMetricsResponse\"\x00B3Z1go.chromium.org/luci/analysis/proto/v1;analysispbb\x06proto3"
