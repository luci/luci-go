...
const file_go_chromium_org_luci_analysis_proto_v1_projects_proto_rawDesc = "" +
	"\n" +
	"5go.chromium.org/luci/analysis/proto/v1/projects.proto\x12\x10luci.analysis.v1\x1a;go.chromium.org/luci/analysis/proto/v1/issue_tracking.proto\x1a4go.chromium.org/luci/analysis/proto/v1/project.proto\"\x15\n" +
	"\x13ListProjectsRequest\"M\n" +
	"\x14ListProjectsResponse\x125\n" +
	"\bprojects\x18\x01 \x03(\v2\x19.luci.analysis.v1.ProjectR\bprojects\"-\n" +
	...
	"\x0ebug_management\x18\x06 \x01(\v2\x1f.luci.analysis.v1.BugManagementR\rbugManagementJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"\x91\x01\n" +
	"\rBugManagement\x12A\n" +
	"\bpolicies\x18\x01 \x03(\v2%.luci.analysis.v1.BugManagementPolicyR\bpolicies\x12=\n" +
	"\bmonorail\x18\x02 \x01(\v2!.luci.analysis.v1.MonorailProjectR\bmonorail\"\xf6\x04\n" +
	...
	"\bpriority\x18\x03 \x01(\x0e2#.luci.analysis.v1.BuganizerPriorityR\bpriority\x12F\n" +
	"\ametrics\x18\x04 \x03(\v2,.luci.analysis.v1.BugManagementPolicy.MetricR\ametrics\x12S\n" +
	"\vexplanation\x18\x05 \x01(\v21.luci.analysis.v1.BugManagementPolicy.ExplanationR\vexplanation\x1a\xd5\x01\n" +
	"\x06Metric\x12\x1b\n" +
	"\tmetric_id\x18\x01 \x01(\tR\bmetricId\x12T\n" +
	"\x14activation_threshold\x18\x02 \x01(\v2!.luci.analysis.v1.MetricThresholdR\x13activationThreshold\x12X\n" +
	"\x16deactivation_threshold\x18\x03 \x01(\v2!.luci.analysis.v1.MetricThresholdR\x15deactivationThreshold\x1aQ\n" +
	"\vExplanation\x12!\n" +
	...
	"\x0edisplay_prefix\x18\x02 \x01(\tR\rdisplayPrefixJ\x04\b\x03\x10\x04\"\x9b\x01\n" +
	...
	"_seven_day2\xbe\x01\n" +
	"\bProjects\x12Y\n" +
	"\tGetConfig\x12).luci.analysis.v1.GetProjectConfigRequest\x1a\x1f.luci.analysis.v1.ProjectConfig\"\x00\x12W\n" +
	"\x04List\x12%.luci.analysis.v1.ListProjectsRequest\x1a&.luci.analysis.v1.ListProjectsResponse\"\x00B3Z1go.chromium.org/luci/analysis/proto/v1;analysispbb\x06proto3"
