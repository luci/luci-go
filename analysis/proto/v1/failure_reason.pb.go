...
var file_go_chromium_org_luci_analysis_proto_v1_failure_reason_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_analysis_proto_v1_failure_reason_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_analysis_proto_v1_failure_reason_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_analysis_proto_v1_failure_reason_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_analysis_proto_v1_failure_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_analysis_proto_v1_failure_reason_proto_rawDesc), len(file_go_chromium_org_luci_analysis_proto_v1_failure_reason_proto_rawDesc)))
	})
