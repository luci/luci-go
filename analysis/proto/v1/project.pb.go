...
const file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDesc = "" +
	"\n" +
	"4go.chromium.org/luci/analysis/proto/v1/project.proto\x12\x10luci.analysis.v1\"Z\n" +
	"\aProject\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12\x18\n" +
	"\aproject\x18\x03 \x01(\tR\aprojectB3Z1go.chromium.org/luci/analysis/proto/v1;analysispbb\x06proto3"

var (
	file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDescOnce sync.Once
	file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDesc), len(file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDesc)))
	})
...
var file_go_chromium_org_luci_analysis_proto_v1_project_proto_goTypes = []any{
...
func file_go_chromium_org_luci_analysis_proto_v1_project_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDesc), len(file_go_chromium_org_luci_analysis_proto_v1_project_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
