...
const file_go_chromium_org_luci_analysis_proto_config_project_config_proto_rawDesc = "" +
	"\n" +
	"?go.chromium.org/luci/analysis/proto/config/project_config.proto\x12\x14luci.analysis.config\x1a\x1fgoogle/protobuf/timestamp.proto\x1aMgo.chromium.org/luci/analysis/proto/config/test_variant_analysis_config.proto\"\x8a\a\n" +
	"\rProjectConfig\x12P\n" +
	"\x10project_metadata\x18\x06 \x01(\v2%.luci.analysis.config.ProjectMetadataR\x0fprojectMetadata\x12=\n" +
	"\flast_updated\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x12@\n" +
	"\n" +
	"clustering\x18\x05 \x01(\v2 .luci.analysis.config.ClusteringR\n" +
	"clustering\x12J\n" +
	"\x0ebug_management\x18\t \x01(\v2#.luci.analysis.config.BugManagementR\rbugManagement\x127\n" +
	"\ametrics\x18\v \x01(\v2\x1d.luci.analysis.config.MetricsR\ametrics\x12c\n" +
	"\x17test_stability_criteria\x18\f \x01(\v2+.luci.analysis.config.TestStabilityCriteriaR\x15testStabilityCriteria\x129\n" +
	"\x06realms\x18\x03 \x03(\v2!.luci.analysis.config.RealmConfigR\x06realms\x12>\n" +
	"\n" +
	"bug_system\x18\a \x01(\x0e2\x1f.luci.analysis.config.BugSystemR\tbugSystem\x12A\n" +
	"\bmonorail\x18\x01 \x01(\v2%.luci.analysis.config.MonorailProjectR\bmonorail\x12D\n" +
	"\tbuganizer\x18\b \x01(\v2&.luci.analysis.config.BuganizerProjectR\tbuganizer\x12W\n" +
	"\x14bug_filing_threshold\x18\x02 \x01(\v2%.luci.analysis.config.ImpactThresholdR\x12bugFilingThreshold\x12_\n" +
	"\x15bug_filing_thresholds\x18\n" +
	" \x03(\v2+.luci.analysis.config.ImpactMetricThresholdR\x13bugFilingThresholds\"4\n" +
	"\x0fProjectMetadata\x12!\n" +
	"\fdisplay_name\x18\x01 \x01(\tR\vdisplayName\"\xcf\x02\n" +
	"\aMetrics\x12J\n" +
	"\toverrides\x18\x01 \x03(\v2,.luci.analysis.config.Metrics.MetricOverrideR\toverrides\x1a\xf7\x01\n" +
	"\x0eMetricOverride\x12\x1b\n" +
	"\tmetric_id\x18\x01 \x01(\tR\bmetricId\x12\"\n" +
	"\n" +
	"is_default\x18\x02 \x01(\bH\x00R\tisDefault\x88\x01\x01\x12(\n" +
	"\rsort_priority\x18\x03 \x01(\x05H\x01R\fsortPriority\x88\x01\x01\x12<\n" +
	"\x18show_in_metrics_selector\x18\x04 \x01(\bH\x02R\x15showInMetricsSelector\x88\x01\x01B\r\n" +
	"\v_is_defaultB\x10\n" +
	"\x0e_sort_priorityB\x1b\n" +
	"\x19_show_in_metrics_selector\"\x9e\x06\n" +
	"\rBugManagement\x12C\n" +
	"\x1edisable_duplicate_bug_comments\x18\x01 \x01(\bR\x1bdisableDuplicateBugComments\x12E\n" +
	"\bpolicies\x18\x02 \x03(\v2).luci.analysis.config.BugManagementPolicyR\bpolicies\x12M\n" +
	"\x12default_bug_system\x18\x03 \x01(\x0e2\x1f.luci.analysis.config.BugSystemR\x10defaultBugSystem\x12D\n" +
	"\tbuganizer\x18\x04 \x01(\v2&.luci.analysis.config.BuganizerProjectR\tbuganizer\x12A\n" +
	"\bmonorail\x18\x05 \x01(\v2%.luci.analysis.config.MonorailProjectR\bmonorail\x12_\n" +
	"\rno_validation\x18\x06 \x01(\v28.luci.analysis.config.BugManagement.NoInvalidationActionH\x00R\fnoValidation\x12c\n" +
	"\vreopen_bugs\x18\a \x01(\v2@.luci.analysis.config.BugManagement.ReopenBugsInvalidationActionH\x00R\n" +
	"reopenBugs\x12g\n" +
	"\rfile_new_bugs\x18\b \x01(\v2A.luci.analysis.config.BugManagement.FileNewBugsInvalidationActionH\x00R\vfileNewBugs\x1a\x16\n" +
	"\x14NoInvalidationAction\x1a\x1e\n" +
	"\x1cReopenBugsInvalidationAction\x1a\x1f\n" +
	"\x1dFileNewBugsInvalidationActionB!\n" +
	"\x1fbug_closure_invalidation_action\"\xa7\b\n" +
	"\x13BugManagementPolicy\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06owners\x18\x02 \x03(\tR\x06owners\x12.\n" +
	"\x13human_readable_name\x18\x03 \x01(\tR\x11humanReadableName\x12C\n" +
	"\bpriority\x18\x04 \x01(\x0e2'.luci.analysis.config.BuganizerPriorityR\bpriority\x12J\n" +
	"\ametrics\x18\x05 \x03(\v20.luci.analysis.config.BugManagementPolicy.MetricR\ametrics\x12W\n" +
	"\vexplanation\x18\x06 \x01(\v25.luci.analysis.config.BugManagementPolicy.ExplanationR\vexplanation\x12X\n" +
	"\fbug_template\x18\a \x01(\v25.luci.analysis.config.BugManagementPolicy.BugTemplateR\vbugTemplate\x1a\xdd\x01\n" +
	"\x06Metric\x12\x1b\n" +
	"\tmetric_id\x18\x01 \x01(\tR\bmetricId\x12X\n" +
	"\x14activation_threshold\x18\x02 \x01(\v2%.luci.analysis.config.MetricThresholdR\x13activationThreshold\x12\\\n" +
	"\x16deactivation_threshold\x18\x03 \x01(\v2%.luci.analysis.config.MetricThresholdR\x15deactivationThreshold\x1aQ\n" +
	"\vExplanation\x12!\n" +
	"\fproblem_html\x18\x01 \x01(\tR\vproblemHtml\x12\x1f\n" +
	"\vaction_html\x18\x02 \x01(\tR\n" +
	"actionHtml\x1a\xc0\x02\n" +
	"\vBugTemplate\x12)\n" +
	"\x10comment_template\x18\x01 \x01(\tR\x0fcommentTemplate\x12]\n" +
	"\tbuganizer\x18\x02 \x01(\v2?.luci.analysis.config.BugManagementPolicy.BugTemplate.BuganizerR\tbuganizer\x12Z\n" +
	"\bmonorail\x18\x03 \x01(\v2>.luci.analysis.config.BugManagementPolicy.BugTemplate.MonorailR\bmonorail\x1a'\n" +
	"\tBuganizer\x12\x1a\n" +
	"\bhotlists\x18\x01 \x03(\x03R\bhotlists\x1a\"\n" +
	"\bMonorail\x12\x16\n" +
	"\x06labels\x18\x01 \x03(\tR\x06labels\"\xff\x04\n" +
	"\x0fImpactThreshold\x12U\n" +
	"\x13test_results_failed\x18\x04 \x01(\v2%.luci.analysis.config.MetricThresholdR\x11testResultsFailed\x12O\n" +
	"\x10test_runs_failed\x18\x05 \x01(\v2%.luci.analysis.config.MetricThresholdR\x0etestRunsFailed\x12Y\n" +
	"\x15presubmit_runs_failed\x18\x06 \x01(\v2%.luci.analysis.config.MetricThresholdR\x13presubmitRunsFailed\x12g\n" +
	"\x1ccritical_failures_exonerated\x18\a \x01(\v2%.luci.analysis.config.MetricThresholdR\x1acriticalFailuresExonerated\x129\n" +
	"\x16unexpected_failures_1d\x18\x01 \x01(\x03H\x00R\x14unexpectedFailures1d\x88\x01\x01\x129\n" +
	"\x16unexpected_failures_3d\x18\x02 \x01(\x03H\x01R\x14unexpectedFailures3d\x88\x01\x01\x129\n" +
	"\x16unexpected_failures_7d\x18\x03 \x01(\x03H\x02R\x14unexpectedFailures7d\x88\x01\x01B\x19\n" +
	"\x17_unexpected_failures_1dB\x19\n" +
	"\x17_unexpected_failures_3dB\x19\n" +
	"\x17_unexpected_failures_7d\"y\n" +
	"\x15ImpactMetricThreshold\x12\x1b\n" +
	"\tmetric_id\x18\x01 \x01(\tR\bmetricId\x12C\n" +
	"\tthreshold\x18\x02 \x01(\v2%.luci.analysis.config.MetricThresholdR\tthreshold\"\x9b\x01\n" +
	"\x0fMetricThreshold\x12\x1c\n" +
	"\aone_day\x18\x01 \x01(\x03H\x00R\x06oneDay\x88\x01\x01\x12 \n" +
	"\tthree_day\x18\x02 \x01(\x03H\x01R\bthreeDay\x88\x01\x01\x12 \n" +
	"\tseven_day\x18\x03 \x01(\x03H\x02R\bsevenDay\x88\x01\x01B\n" +
	"\n" +
	"\b_one_dayB\f\n" +
	"\n" +
	"_three_dayB\f\n" +
	"\n" +
	"_seven_day\"\xd9\x03\n" +
	"\x0fMonorailProject\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12Z\n" +
	"\x14default_field_values\x18\x02 \x03(\v2(.luci.analysis.config.MonorailFieldValueR\x12defaultFieldValues\x12*\n" +
	"\x11priority_field_id\x18\x03 \x01(\x03R\x0fpriorityFieldId\x12F\n" +
	"\n" +
	"priorities\x18\x04 \x03(\v2&.luci.analysis.config.MonorailPriorityR\n" +
	"priorities\x12>\n" +
	"\x1bpriority_hysteresis_percent\x18\x05 \x01(\x03R\x19priorityHysteresisPercent\x12%\n" +
	"\x0edisplay_prefix\x18\x06 \x01(\tR\rdisplayPrefix\x12+\n" +
	"\x11monorail_hostname\x18\a \x01(\tR\x10monorailHostname\x12H\n" +
	"!file_without_restrict_view_google\x18\b \x01(\bR\x1dfileWithoutRestrictViewGoogle\"E\n" +
	"\x12MonorailFieldValue\x12\x19\n" +
	"\bfield_id\x18\x01 \x01(\x03R\afieldId\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\xc0\x01\n" +
	"\x10MonorailPriority\x12\x1a\n" +
	"\bpriority\x18\x01 \x01(\tR\bpriority\x12C\n" +
	"\tthreshold\x18\x02 \x01(\v2%.luci.analysis.config.ImpactThresholdR\tthreshold\x12K\n" +
	"\n" +
	"thresholds\x18\x03 \x03(\v2+.luci.analysis.config.ImpactMetricThresholdR\n" +
	"thresholds\"\x86\x01\n" +
	"\vRealmConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12c\n" +
	"\x15test_variant_analysis\x18\x02 \x01(\v2/.luci.analysis.config.TestVariantAnalysisConfigR\x13testVariantAnalysis\"\x94\x01\n" +
	"\n" +
	"Clustering\x12T\n" +
	"\x0ftest_name_rules\x18\x01 \x03(\v2,.luci.analysis.config.TestNameClusteringRuleR\rtestNameRules\x120\n" +
	"\x14reason_mask_patterns\x18\x02 \x03(\tR\x12reasonMaskPatterns\"k\n" +
	"\x16TestNameClusteringRule\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\apattern\x18\x02 \x01(\tR\apattern\x12#\n" +
	"\rlike_template\x18\x03 \x01(\tR\flikeTemplate\"$\n" +
	"\x12BuganizerComponent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"\xbf\x04\n" +
	"\x10BuganizerProject\x12U\n" +
	"\x11default_component\x18\x01 \x01(\v2(.luci.analysis.config.BuganizerComponentR\x10defaultComponent\x12>\n" +
	"\x1bpriority_hysteresis_percent\x18\x02 \x01(\x03R\x19priorityHysteresisPercent\x12c\n" +
	"\x11priority_mappings\x18\x03 \x03(\v26.luci.analysis.config.BuganizerProject.PriorityMappingR\x10priorityMappings\x12D\n" +
	"\x1ffile_without_limit_view_trusted\x18\x04 \x01(\bR\x1bfileWithoutLimitViewTrusted\x1a\xe8\x01\n" +
	"\x0fPriorityMapping\x12C\n" +
	"\bpriority\x18\x01 \x01(\x0e2'.luci.analysis.config.BuganizerPriorityR\bpriority\x12C\n" +
	"\tthreshold\x18\x02 \x01(\v2%.luci.analysis.config.ImpactThresholdR\tthreshold\x12K\n" +
	"\n" +
	"thresholds\x18\x03 \x03(\v2+.luci.analysis.config.ImpactMetricThresholdR\n" +
	"thresholds\"\xa2\x04\n" +
	"\x15TestStabilityCriteria\x12b\n" +
	"\ffailure_rate\x18\x01 \x01(\v2?.luci.analysis.config.TestStabilityCriteria.FailureRateCriteriaR\vfailureRate\x12\\\n" +
	"\n" +
	"flake_rate\x18\x02 \x01(\v2=.luci.analysis.config.TestStabilityCriteria.FlakeRateCriteriaR\tflakeRate\x1a\x86\x01\n" +
	"\x13FailureRateCriteria\x12+\n" +
	"\x11failure_threshold\x18\x01 \x01(\x05R\x10failureThreshold\x12B\n" +
	"\x1dconsecutive_failure_threshold\x18\x02 \x01(\x05R\x1bconsecutiveFailureThreshold\x1a\xbd\x01\n" +
	"\x11FlakeRateCriteria\x12\x1d\n" +
	"\n" +
	...
	"\x13flake_threshold_1wd\x18\x04 \x01(\x05R\x11flakeThreshold1wd*D\n" +
	"\tBugSystem\x12\x1a\n" +
	"\x16BUG_SYSTEM_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bMONORAIL\x10\x01\x12\r\n" +
	"\tBUGANIZER\x10\x02*_\n" +
	"\x11BuganizerPriority\x12\"\n" +
	"\x1eBUGANIZER_PRIORITY_UNSPECIFIED\x10\x00\x12\x06\n" +
	"\x02P0\x10\x01\x12\x06\n" +
	"\x02P1\x10\x02\x12\x06\n" +
	"\x02P2\x10\x03\x12\x06\n" +
	"\x02P3\x10\x04\x12\x06\n" +
	"\x02P4\x10\x05B5Z3go.chromium.org/luci/analysis/proto/config;configpbb\x06proto3"
