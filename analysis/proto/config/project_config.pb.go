...
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x74, 0x5f, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0xf3, 0x02, 0x0a,
	...
	0x22, 0xf9, 0x03, 0x0a, 0x10, 0x42, 0x75, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x65, 0x72, 0x50, 0x72,
	...
	,
	...
	0x52, 0x0a, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x73, 0x2a, 0x44, 0x0a, 0x09,
...
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_goTypes = []interface{}{
	...
	(*Metrics_MetricOverride)(nil),                    // 18: luci.analysis.config.Metrics.MetricOverride
	(*BugManagementPolicy_Metric)(nil),                // 19: luci.analysis.config.BugManagementPolicy.Metric
	(*BugManagementPolicy_Explanation)(nil),           // 20: luci.analysis.config.BugManagementPolicy.Explanation
	(*BugManagementPolicy_BugTemplate)(nil),           // 21: luci.analysis.config.BugManagementPolicy.BugTemplate
	(*BugManagementPolicy_BugTemplate_Buganizer)(nil), // 22: luci.analysis.config.BugManagementPolicy.BugTemplate.Buganizer
	(*BugManagementPolicy_BugTemplate_Monorail)(nil),  // 23: luci.analysis.config.BugManagementPolicy.BugTemplate.Monorail
	(*BuganizerProject_PriorityMapping)(nil),          // 24: luci.analysis.config.BuganizerProject.PriorityMapping
	(*timestamppb.Timestamp)(nil),                     // 25: google.protobuf.Timestamp
	(*TestVariantAnalysisConfig)(nil),                 // 26: luci.analysis.config.TestVariantAnalysisConfig
}
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_depIdxs = []int32{
	...
	0,  // 1: luci.analysis.config.ProjectConfig.bug_system:type_name -> luci.analysis.config.BugSystem
	10, // 2: luci.analysis.config.ProjectConfig.monorail:type_name -> luci.analysis.config.MonorailProject
	17, // 3: luci.analysis.config.ProjectConfig.buganizer:type_name -> luci.analysis.config.BuganizerProject
	7,  // 4: luci.analysis.config.ProjectConfig.bug_filing_threshold:type_name -> luci.analysis.config.ImpactThreshold
	13, // 5: luci.analysis.config.ProjectConfig.realms:type_name -> luci.analysis.config.RealmConfig
	25, // 6: luci.analysis.config.ProjectConfig.last_updated:type_name -> google.protobuf.Timestamp
	14, // 7: luci.analysis.config.ProjectConfig.clustering:type_name -> luci.analysis.config.Clustering
	5,  // 8: luci.analysis.config.ProjectConfig.bug_management:type_name -> luci.analysis.config.BugManagement
	8,  // 9: luci.analysis.config.ProjectConfig.bug_filing_thresholds:type_name -> luci.analysis.config.ImpactMetricThreshold
	4,  // 10: luci.analysis.config.ProjectConfig.metrics:type_name -> luci.analysis.config.Metrics
	18, // 11: luci.analysis.config.Metrics.overrides:type_name -> luci.analysis.config.Metrics.MetricOverride
	6,  // 12: luci.analysis.config.BugManagement.policies:type_name -> luci.analysis.config.BugManagementPolicy
	0,  // 13: luci.analysis.config.BugManagement.default_bug_system:type_name -> luci.analysis.config.BugSystem
	17, // 14: luci.analysis.config.BugManagement.buganizer:type_name -> luci.analysis.config.BuganizerProject
	10, // 15: luci.analysis.config.BugManagement.monorail:type_name -> luci.analysis.config.MonorailProject
	1,  // 16: luci.analysis.config.BugManagementPolicy.priority:type_name -> luci.analysis.config.BuganizerPriority
	19, // 17: luci.analysis.config.BugManagementPolicy.metrics:type_name -> luci.analysis.config.BugManagementPolicy.Metric
	20, // 18: luci.analysis.config.BugManagementPolicy.explanation:type_name -> luci.analysis.config.BugManagementPolicy.Explanation
	21, // 19: luci.analysis.config.BugManagementPolicy.bug_template:type_name -> luci.analysis.config.BugManagementPolicy.BugTemplate
	9,  // 20: luci.analysis.config.ImpactThreshold.test_results_failed:type_name -> luci.analysis.config.MetricThreshold
	9,  // 21: luci.analysis.config.ImpactThreshold.test_runs_failed:type_name -> luci.analysis.config.MetricThreshold
	9,  // 22: luci.analysis.config.ImpactThreshold.presubmit_runs_failed:type_name -> luci.analysis.config.MetricThreshold
	9,  // 23: luci.analysis.config.ImpactThreshold.critical_failures_exonerated:type_name -> luci.analysis.config.MetricThreshold
	9,  // 24: luci.analysis.config.ImpactMetricThreshold.threshold:type_name -> luci.analysis.config.MetricThreshold
	11, // 25: luci.analysis.config.MonorailProject.default_field_values:type_name -> luci.analysis.config.MonorailFieldValue
	12, // 26: luci.analysis.config.MonorailProject.priorities:type_name -> luci.analysis.config.MonorailPriority
	7,  // 27: luci.analysis.config.MonorailPriority.threshold:type_name -> luci.analysis.config.ImpactThreshold
	8,  // 28: luci.analysis.config.MonorailPriority.thresholds:type_name -> luci.analysis.config.ImpactMetricThreshold
	26, // 29: luci.analysis.config.RealmConfig.test_variant_analysis:type_name -> luci.analysis.config.TestVariantAnalysisConfig
	15, // 30: luci.analysis.config.Clustering.test_name_rules:type_name -> luci.analysis.config.TestNameClusteringRule
	16, // 31: luci.analysis.config.BuganizerProject.default_component:type_name -> luci.analysis.config.BuganizerComponent
	24, // 32: luci.analysis.config.BuganizerProject.priority_mappings:type_name -> luci.analysis.config.BuganizerProject.PriorityMapping
	9,  // 33: luci.analysis.config.BugManagementPolicy.Metric.activation_threshold:type_name -> luci.analysis.config.MetricThreshold
	9,  // 34: luci.analysis.config.BugManagementPolicy.Metric.deactivation_threshold:type_name -> luci.analysis.config.MetricThreshold
	22, // 35: luci.analysis.config.BugManagementPolicy.BugTemplate.buganizer:type_name -> luci.analysis.config.BugManagementPolicy.BugTemplate.Buganizer
	23, // 36: luci.analysis.config.BugManagementPolicy.BugTemplate.monorail:type_name -> luci.analysis.config.BugManagementPolicy.BugTemplate.Monorail
	1,  // 37: luci.analysis.config.BuganizerProject.PriorityMapping.priority:type_name -> luci.analysis.config.BuganizerPriority
	7,  // 38: luci.analysis.config.BuganizerProject.PriorityMapping.threshold:type_name -> luci.analysis.config.ImpactThreshold
	8,  // 39: luci.analysis.config.BuganizerProject.PriorityMapping.thresholds:type_name -> luci.analysis.config.ImpactMetricThreshold
...
func file_go_chromium_org_luci_analysis_proto_config_project_config_proto_init() {
	...
	file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[16].OneofWrappers = []interface{}{}
	type x struct{}
