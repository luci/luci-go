...
type BugManagement struct {
	...
	//
	// Types that are valid to be assigned to BugClosureInvalidationAction:
	//
	//	*BugManagement_NoValidation
	//	*BugManagement_ReopenBugs
	//	*BugManagement_FileNewBugs
	BugClosureInvalidationAction isBugManagement_BugClosureInvalidationAction `protobuf_oneof:"bug_closure_invalidation_action"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *BugManagement) GetBugClosureInvalidationAction() isBugManagement_BugClosureInvalidationAction {
	if x != nil {
		return x.BugClosureInvalidationAction
	}
	return nil
}

func (x *BugManagement) GetNoValidation() *BugManagement_NoInvalidationAction {
	if x != nil {
		if x, ok := x.BugClosureInvalidationAction.(*BugManagement_NoValidation); ok {
...
func (x *BugManagement) GetReopenBugs() *BugManagement_ReopenBugsInvalidationAction {
	if x != nil {
		if x, ok := x.BugClosureInvalidationAction.(*BugManagement_ReopenBugs); ok {
			return x.ReopenBugs
		}
	}
	return nil
...
func (x *BugManagement) GetFileNewBugs() *BugManagement_FileNewBugsInvalidationAction {
	if x != nil {
		if x, ok := x.BugClosureInvalidationAction.(*BugManagement_FileNewBugs); ok {
			return x.FileNewBugs
		}
	}
	return nil
}

type isBugManagement_BugClosureInvalidationAction interface {
	isBugManagement_BugClosureInvalidationAction()
}

type BugManagement_NoValidation struct {
	NoValidation *BugManagement_NoInvalidationAction `protobuf:"bytes,6,opt,name=no_validation,json=noValidation,proto3,oneof"`
}

type BugManagement_ReopenBugs struct {
	ReopenBugs *BugManagement_ReopenBugsInvalidationAction `protobuf:"bytes,7,opt,name=reopen_bugs,json=reopenBugs,proto3,oneof"`
}

type BugManagement_FileNewBugs struct {
	FileNewBugs *BugManagement_FileNewBugsInvalidationAction `protobuf:"bytes,8,opt,name=file_new_bugs,json=fileNewBugs,proto3,oneof"`
}

func (*BugManagement_NoValidation) isBugManagement_BugClosureInvalidationAction() {}

func (*BugManagement_ReopenBugs) isBugManagement_BugClosureInvalidationAction() {}

func (*BugManagement_FileNewBugs) isBugManagement_BugClosureInvalidationAction() {}
...
type BugManagement_NoInvalidationAction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BugManagement_NoInvalidationAction) Reset() {
	*x = BugManagement_NoInvalidationAction{}
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BugManagement_NoInvalidationAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BugManagement_NoInvalidationAction) ProtoMessage() {}

func (x *BugManagement_NoInvalidationAction) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BugManagement_NoInvalidationAction.ProtoReflect.Descriptor instead.
func (*BugManagement_NoInvalidationAction) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_analysis_proto_config_project_config_proto_rawDescGZIP(), []int{3, 0}
}

type BugManagement_ReopenBugsInvalidationAction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BugManagement_ReopenBugsInvalidationAction) Reset() {
	*x = BugManagement_ReopenBugsInvalidationAction{}
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BugManagement_ReopenBugsInvalidationAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BugManagement_ReopenBugsInvalidationAction) ProtoMessage() {}

func (x *BugManagement_ReopenBugsInvalidationAction) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BugManagement_ReopenBugsInvalidationAction.ProtoReflect.Descriptor instead.
func (*BugManagement_ReopenBugsInvalidationAction) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_analysis_proto_config_project_config_proto_rawDescGZIP(), []int{3, 1}
}

type BugManagement_FileNewBugsInvalidationAction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BugManagement_FileNewBugsInvalidationAction) Reset() {
	*x = BugManagement_FileNewBugsInvalidationAction{}
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BugManagement_FileNewBugsInvalidationAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BugManagement_FileNewBugsInvalidationAction) ProtoMessage() {}

func (x *BugManagement_FileNewBugsInvalidationAction) ProtoReflect() protoreflect.Message {
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BugManagement_FileNewBugsInvalidationAction.ProtoReflect.Descriptor instead.
func (*BugManagement_FileNewBugsInvalidationAction) Descriptor() ([]byte, []int) {
	return file_go_chromium_org_luci_analysis_proto_config_project_config_proto_rawDescGZIP(), []int{3, 2}
}
...
func (x *BuganizerProject_PriorityMapping) Reset() {
	*x = BuganizerProject_PriorityMapping{}
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TestStabilityCriteria_FailureRateCriteria) Reset() {
	*x = TestStabilityCriteria_FailureRateCriteria{}
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TestStabilityCriteria_FlakeRateCriteria) Reset() {
	*x = TestStabilityCriteria_FlakeRateCriteria{}
	mi := &file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_rawDesc = string([]byte{
	...
	0x69, 0x63, 0x73, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x9e, 0x06, 0x0a,
	...
	,
	...
	0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x12, 0x2e, 0x0a,
	0x13, 0x68, 0x75, 0x6d, 0x61, 0x6e, 0x5f, 0x72, 0x65, 0x61, 0x64, 0x61, 0x62, 0x6c, 0x65, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x68, 0x75, 0x6d, 0x61,
	0x6e, 0x52, 0x65, 0x61, 0x64, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x43, 0x0a,
	0x08, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x27, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x2e,
	...
	0x74, 0x79, 0x12, 0x4a, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x05, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x6c, 0x75, 0x63, 0x69, 0x2e, 0x61, 0x6e, 0x61, 0x6c, 0x79,
	0x73, 0x69, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x42, 0x75, 0x67, 0x4d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x4d,
	0x65, 0x74, 0x72, 0x69, 0x63, 0x52, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x57,
	...
	0x73, 0x69, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x42, 0x75, 0x67, 0x4d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x45,
	0x78, 0x70, 0x6c, 0x61, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x65, 0x78, 0x70, 0x6c,
	0x61, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x58, 0x0a, 0x0c, 0x62, 0x75, 0x67, 0x5f, 0x74,
	0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e,
	...
	0x6e, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x42, 0x75, 0x67, 0x54, 0x65, 0x6d, 0x70,
	0x6c, 0x61, 0x74, 0x65, 0x52, 0x0b, 0x62, 0x75, 0x67, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	0x65, 0x1a, 0xdd, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12, 0x1b, 0x0a, 0x09,
	0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x49, 0x64, 0x12, 0x58, 0x0a, 0x14, 0x61, 0x63, 0x74,
	...
	0x61, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68,
	0x6f, 0x6c, 0x64, 0x12, 0x5c, 0x0a, 0x16, 0x64, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74,
	...
	0x48, 0x74, 0x6d, 0x6c, 0x1a, 0xc0, 0x02, 0x0a, 0x0b, 0x42, 0x75, 0x67, 0x54, 0x65, 0x6d, 0x70,
	0x6c, 0x61, 0x74, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12,
	0x5d, 0x0a, 0x09, 0x62, 0x75, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	0x62, 0x6d, 0x69, 0x74, 0x52, 0x75, 0x6e, 0x73, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x12, 0x67,
	0x0a, 0x1c, 0x63, 0x72, 0x69, 0x74, 0x69, 0x63, 0x61, 0x6c, 0x5f, 0x66, 0x61, 0x69, 0x6c, 0x75,
	0x72, 0x65, 0x73, 0x5f, 0x65, 0x78, 0x6f, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x18, 0x07,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xc0, 0x01, 0x0a, 0x10, 0x4d, 0x6f, 0x6e, 0x6f, 0x72, 0x61,
	...
	,
	...
	0x73, 0x22, 0x94, 0x01, 0x0a, 0x0a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x69, 0x6e, 0x67,
	0x12, 0x54, 0x0a, 0x0f, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x5f, 0x72, 0x75,
	0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x6c, 0x75, 0x63, 0x69,
	0x2e, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x65, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x12, 0x30, 0x0a, 0x14, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e,
	0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x5f, 0x70, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x12, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x4d, 0x61, 0x73, 0x6b,
	0x50, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x73, 0x22, 0x6b, 0x0a, 0x16, 0x54, 0x65, 0x73, 0x74,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xbf, 0x04, 0x0a, 0x10,
	...
	,
	...
	,
	...
	0x04, 0x12, 0x06, 0x0a, 0x02, 0x50, 0x34, 0x10, 0x05, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x6f, 0x2e,
...
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_goTypes = []any{
	...
	(*BugManagement_NoInvalidationAction)(nil),          // 20: luci.analysis.config.BugManagement.NoInvalidationAction
	(*BugManagement_ReopenBugsInvalidationAction)(nil),  // 21: luci.analysis.config.BugManagement.ReopenBugsInvalidationAction
	(*BugManagement_FileNewBugsInvalidationAction)(nil), // 22: luci.analysis.config.BugManagement.FileNewBugsInvalidationAction
	(*BugManagementPolicy_Metric)(nil),                  // 23: luci.analysis.config.BugManagementPolicy.Metric
	(*BugManagementPolicy_Explanation)(nil),             // 24: luci.analysis.config.BugManagementPolicy.Explanation
	(*BugManagementPolicy_BugTemplate)(nil),             // 25: luci.analysis.config.BugManagementPolicy.BugTemplate
	(*BugManagementPolicy_BugTemplate_Buganizer)(nil),   // 26: luci.analysis.config.BugManagementPolicy.BugTemplate.Buganizer
	(*BugManagementPolicy_BugTemplate_Monorail)(nil),    // 27: luci.analysis.config.BugManagementPolicy.BugTemplate.Monorail
	(*BuganizerProject_PriorityMapping)(nil),            // 28: luci.analysis.config.BuganizerProject.PriorityMapping
	(*TestStabilityCriteria_FailureRateCriteria)(nil),   // 29: luci.analysis.config.TestStabilityCriteria.FailureRateCriteria
	(*TestStabilityCriteria_FlakeRateCriteria)(nil),     // 30: luci.analysis.config.TestStabilityCriteria.FlakeRateCriteria
	(*timestamppb.Timestamp)(nil),                       // 31: google.protobuf.Timestamp
	(*TestVariantAnalysisConfig)(nil),                   // 32: luci.analysis.config.TestVariantAnalysisConfig
}
var file_go_chromium_org_luci_analysis_proto_config_project_config_proto_depIdxs = []int32{
	...
	31, // 1: luci.analysis.config.ProjectConfig.last_updated:type_name -> google.protobuf.Timestamp
	...
	20, // 17: luci.analysis.config.BugManagement.no_validation:type_name -> luci.analysis.config.BugManagement.NoInvalidationAction
	21, // 18: luci.analysis.config.BugManagement.reopen_bugs:type_name -> luci.analysis.config.BugManagement.ReopenBugsInvalidationAction
	22, // 19: luci.analysis.config.BugManagement.file_new_bugs:type_name -> luci.analysis.config.BugManagement.FileNewBugsInvalidationAction
	1,  // 20: luci.analysis.config.BugManagementPolicy.priority:type_name -> luci.analysis.config.BuganizerPriority
	23, // 21: luci.analysis.config.BugManagementPolicy.metrics:type_name -> luci.analysis.config.BugManagementPolicy.Metric
	24, // 22: luci.analysis.config.BugManagementPolicy.explanation:type_name -> luci.analysis.config.BugManagementPolicy.Explanation
	25, // 23: luci.analysis.config.BugManagementPolicy.bug_template:type_name -> luci.analysis.config.BugManagementPolicy.BugTemplate
	9,  // 24: luci.analysis.config.ImpactThreshold.test_results_failed:type_name -> luci.analysis.config.MetricThreshold
	9,  // 25: luci.analysis.config.ImpactThreshold.test_runs_failed:type_name -> luci.analysis.config.MetricThreshold
	9,  // 26: luci.analysis.config.ImpactThreshold.presubmit_runs_failed:type_name -> luci.analysis.config.MetricThreshold
	9,  // 27: luci.analysis.config.ImpactThreshold.critical_failures_exonerated:type_name -> luci.analysis.config.MetricThreshold
	9,  // 28: luci.analysis.config.ImpactMetricThreshold.threshold:type_name -> luci.analysis.config.MetricThreshold
	11, // 29: luci.analysis.config.MonorailProject.default_field_values:type_name -> luci.analysis.config.MonorailFieldValue
	12, // 30: luci.analysis.config.MonorailProject.priorities:type_name -> luci.analysis.config.MonorailPriority
	7,  // 31: luci.analysis.config.MonorailPriority.threshold:type_name -> luci.analysis.config.ImpactThreshold
	8,  // 32: luci.analysis.config.MonorailPriority.thresholds:type_name -> luci.analysis.config.ImpactMetricThreshold
	32, // 33: luci.analysis.config.RealmConfig.test_variant_analysis:type_name -> luci.analysis.config.TestVariantAnalysisConfig
	15, // 34: luci.analysis.config.Clustering.test_name_rules:type_name -> luci.analysis.config.TestNameClusteringRule
	16, // 35: luci.analysis.config.BuganizerProject.default_component:type_name -> luci.analysis.config.BuganizerComponent
	28, // 36: luci.analysis.config.BuganizerProject.priority_mappings:type_name -> luci.analysis.config.BuganizerProject.PriorityMapping
	29, // 37: luci.analysis.config.TestStabilityCriteria.failure_rate:type_name -> luci.analysis.config.TestStabilityCriteria.FailureRateCriteria
	30, // 38: luci.analysis.config.TestStabilityCriteria.flake_rate:type_name -> luci.analysis.config.TestStabilityCriteria.FlakeRateCriteria
	9,  // 39: luci.analysis.config.BugManagementPolicy.Metric.activation_threshold:type_name -> luci.analysis.config.MetricThreshold
	9,  // 40: luci.analysis.config.BugManagementPolicy.Metric.deactivation_threshold:type_name -> luci.analysis.config.MetricThreshold
	26, // 41: luci.analysis.config.BugManagementPolicy.BugTemplate.buganizer:type_name -> luci.analysis.config.BugManagementPolicy.BugTemplate.Buganizer
	27, // 42: luci.analysis.config.BugManagementPolicy.BugTemplate.monorail:type_name -> luci.analysis.config.BugManagementPolicy.BugTemplate.Monorail
	1,  // 43: luci.analysis.config.BuganizerProject.PriorityMapping.priority:type_name -> luci.analysis.config.BuganizerPriority
	7,  // 44: luci.analysis.config.BuganizerProject.PriorityMapping.threshold:type_name -> luci.analysis.config.ImpactThreshold
	8,  // 45: luci.analysis.config.BuganizerProject.PriorityMapping.thresholds:type_name -> luci.analysis.config.ImpactMetricThreshold
...
func file_go_chromium_org_luci_analysis_proto_config_project_config_proto_init() {
	...
	file_go_chromium_org_luci_analysis_proto_config_project_config_proto_msgTypes[3].OneofWrappers = []any{
		(*BugManagement_NoValidation)(nil),
		(*BugManagement_ReopenBugs)(nil),
		(*BugManagement_FileNewBugs)(nil),
	}
