...
var file_go_chromium_org_luci_analysis_proto_bq_clustered_failure_row_proto_rawDesc = []byte{
	...
	0x90, 0x0f, 0x0a, 0x13, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x46, 0x61, 0x69,
	...
	0x1a, 0x4e, 0x0a, 0x0f, 0x54, 0x65, 0x73, 0x74, 0x45, 0x78, 0x6f, 0x6e, 0x65, 0x72, 0x61, 0x74,
	...
	0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x4a, 0x04, 0x08, 0x1f, 0x10, 0x20, 0x4a, 0x04, 0x08, 0x1e,
	0x10, 0x1f, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75,
...
var file_go_chromium_org_luci_analysis_proto_bq_clustered_failure_row_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_go_chromium_org_luci_analysis_proto_bq_clustered_failure_row_proto_goTypes = []interface{}{
	...
	(*v1.FailureReason)(nil),                    // 4: luci.analysis.v1.FailureReason
	(*v1.BugTrackingComponent)(nil),             // 5: luci.analysis.v1.BugTrackingComponent
	(*v1.PresubmitRunId)(nil),                   // 6: luci.analysis.v1.PresubmitRunId
	(*v1.Changelist)(nil),                       // 7: luci.analysis.v1.Changelist
	(v1.ExonerationReason)(0),                   // 8: luci.analysis.v1.ExonerationReason
}
var file_go_chromium_org_luci_analysis_proto_bq_clustered_failure_row_proto_depIdxs = []int32{
	2,  // 0: luci.analysis.bq.ClusteredFailureRow.last_updated:type_name -> google.protobuf.Timestamp
	2,  // 1: luci.analysis.bq.ClusteredFailureRow.partition_time:type_name -> google.protobuf.Timestamp
	3,  // 2: luci.analysis.bq.ClusteredFailureRow.variant:type_name -> luci.analysis.v1.StringPair
	3,  // 3: luci.analysis.bq.ClusteredFailureRow.tags:type_name -> luci.analysis.v1.StringPair
	4,  // 4: luci.analysis.bq.ClusteredFailureRow.failure_reason:type_name -> luci.analysis.v1.FailureReason
	5,  // 5: luci.analysis.bq.ClusteredFailureRow.bug_tracking_component:type_name -> luci.analysis.v1.BugTrackingComponent
	2,  // 6: luci.analysis.bq.ClusteredFailureRow.start_time:type_name -> google.protobuf.Timestamp
	1,  // 7: luci.analysis.bq.ClusteredFailureRow.exonerations:type_name -> luci.analysis.bq.ClusteredFailureRow.TestExoneration
	6,  // 8: luci.analysis.bq.ClusteredFailureRow.presubmit_run_id:type_name -> luci.analysis.v1.PresubmitRunId
	7,  // 9: luci.analysis.bq.ClusteredFailureRow.changelists:type_name -> luci.analysis.v1.Changelist
	8,  // 10: luci.analysis.bq.ClusteredFailureRow.TestExoneration.reason:type_name -> luci.analysis.v1.ExonerationReason
