...
const file_go_chromium_org_luci_analysis_proto_bq_clustered_failure_row_proto_rawDesc = "" +
	"\n" +
	"Bgo.chromium.org/luci/analysis/proto/bq/clustered_failure_row.proto\x12\x10luci.analysis.bq\x1a\x1fgoogle/protobuf/timestamp.proto\x1a3go.chromium.org/luci/analysis/proto/bq/common.proto\x1a3go.chromium.org/luci/analysis/proto/v1/common.proto\x1a4go.chromium.org/luci/analysis/proto/v1/sources.proto\x1a;go.chromium.org/luci/analysis/proto/v1/failure_reason.proto\"\xb6\x13\n" +
	"\x13ClusteredFailureRow\x12\x18\n" +
	"\aproject\x18' \x01(\tR\aproject\x12+\n" +
	"\x11cluster_algorithm\x18\x01 \x01(\tR\x10clusterAlgorithm\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x02 \x01(\tR\tclusterId\x12,\n" +
	"\x12test_result_system\x18\x03 \x01(\tR\x10testResultSystem\x124\n" +
	"\x16ingested_invocation_id\x18\x15 \x01(\tR\x14ingestedInvocationId\x12$\n" +
	"\x0etest_result_id\x18\x04 \x01(\tR\ftestResultId\x12=\n" +
	"\flast_updated\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x12A\n" +
	"\x0epartition_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\rpartitionTime\x12\x1f\n" +
	"\vis_included\x18\a \x01(\bR\n" +
	"isIncluded\x12B\n" +
	"\x1eis_included_with_high_priority\x18\b \x01(\bR\x1aisIncludedWithHighPriority\x12\x19\n" +
	"\bchunk_id\x18\t \x01(\tR\achunkId\x12\x1f\n" +
	"\vchunk_index\x18\n" +
	" \x01(\x03R\n" +
	"chunkIndex\x12\x14\n" +
	"\x05realm\x18\v \x01(\tR\x05realm\x12N\n" +
	"\x12test_id_structured\x18- \x01(\v2 .luci.analysis.bq.TestIdentifierR\x10testIdStructured\x12\x17\n" +
	"\atest_id\x18\f \x01(\tR\x06testId\x12(\n" +
	"\x10previous_test_id\x18. \x01(\tR\x0epreviousTestId\x126\n" +
	"\avariant\x18\r \x03(\v2\x1c.luci.analysis.v1.StringPairR\avariant\x120\n" +
	"\x04tags\x18  \x03(\v2\x1c.luci.analysis.v1.StringPairR\x04tags\x12!\n" +
	"\fvariant_hash\x18\x0e \x01(\tR\vvariantHash\x12F\n" +
	"\x0efailure_reason\x18\x0f \x01(\v2\x1f.luci.analysis.v1.FailureReasonR\rfailureReason\x12\\\n" +
	"\x16bug_tracking_component\x18\x10 \x01(\v2&.luci.analysis.v1.BugTrackingComponentR\x14bugTrackingComponent\x129\n" +
	"\n" +
	"start_time\x18\x11 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12\x1a\n" +
	"\bduration\x18\x12 \x01(\x01R\bduration\x12Y\n" +
	"\fexonerations\x18! \x03(\v25.luci.analysis.bq.ClusteredFailureRow.TestExonerationR\fexonerations\x12J\n" +
	"\x10presubmit_run_id\x18\x14 \x01(\v2 .luci.analysis.v1.PresubmitRunIdR\x0epresubmitRunId\x12.\n" +
	"\x13presubmit_run_owner\x18\x1d \x01(\tR\x11presubmitRunOwner\x12,\n" +
	"\x12presubmit_run_mode\x18\" \x01(\tR\x10presubmitRunMode\x120\n" +
	"\x14presubmit_run_status\x18# \x01(\tR\x12presubmitRunStatus\x12!\n" +
	"\fbuild_status\x18$ \x01(\tR\vbuildStatus\x12%\n" +
	"\x0ebuild_critical\x18% \x01(\bR\rbuildCritical\x12G\n" +
	" ingested_invocation_result_index\x18\x16 \x01(\x03R\x1dingestedInvocationResultIndex\x12G\n" +
	" ingested_invocation_result_count\x18\x17 \x01(\x03R\x1dingestedInvocationResultCount\x12C\n" +
	"\x1eis_ingested_invocation_blocked\x18\x18 \x01(\bR\x1bisIngestedInvocationBlocked\x12\x1e\n" +
	"\vtest_run_id\x18\x19 \x01(\tR\ttestRunId\x121\n" +
	"\x15test_run_result_index\x18\x1a \x01(\x03R\x12testRunResultIndex\x121\n" +
	"\x15test_run_result_count\x18\x1b \x01(\x03R\x12testRunResultCount\x12-\n" +
	"\x13is_test_run_blocked\x18\x1c \x01(\bR\x10isTestRunBlocked\x123\n" +
	"\asources\x18( \x01(\v2\x19.luci.analysis.v1.SourcesR\asources\x12:\n" +
	"\n" +
	"source_ref\x18) \x01(\v2\x1b.luci.analysis.v1.SourceRefR\tsourceRef\x12&\n" +
	"\x0fsource_ref_hash\x18* \x01(\tR\rsourceRefHash\x128\n" +
	"\x18build_gardener_rotations\x18+ \x03(\tR\x16buildGardenerRotations\x12g\n" +
	"\x13test_variant_branch\x18, \x01(\v27.luci.analysis.bq.ClusteredFailureRow.TestVariantBranchR\x11testVariantBranch\x1aN\n" +
	"\x0fTestExoneration\x12;\n" +
	"\x06reason\x18\x01 \x01(\x0e2#.luci.analysis.v1.ExonerationReasonR\x06reason\x1a\xa7\x01\n" +
	...
	"\x12total_verdicts_24h\x18\x03 \x01(\x03R\x10totalVerdicts24hJ\x04\b\x13\x10\x14J\x04\b\x1f\x10 J\x04\b\x1e\x10\x1fJ\x04\b&\x10'B-Z+go.chromium.org/luci/analysis/proto/bq;bqpbb\x06proto3"
