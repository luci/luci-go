...
const file_go_chromium_org_luci_analysis_proto_bq_test_result_row_proto_rawDesc = "" +
	...
	"invocation\x12A\n" +
	"\x0epartition_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\rpartitionTime\x12N\n" +
	"\x06parent\x18\a \x01(\v26.luci.analysis.bq.TestResultRow.ParentInvocationRecordR\x06parent\x12\x12\n" +
	...
	"\x05realm\x18\x02 \x01(\tR\x05realm\x1a\x9c\x01\n" +
