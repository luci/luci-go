...
type TestVerdictRow_InvocationRecord struct {
	...
	// Whether the invocation is a root invocation.
	IsRootInvocation bool `protobuf:"varint,5,opt,name=is_root_invocation,json=isRootInvocation,proto3" json:"is_root_invocation,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *TestVerdictRow_InvocationRecord) GetIsRootInvocation() bool {
	if x != nil {
...
const file_go_chromium_org_luci_analysis_proto_bq_test_verdict_row_proto_rawDesc = "" +
	...
	"\x04JSONR\n" +
	"properties\x12,\n" +
	"\x12is_root_invocation\x18\x05 \x01(\bR\x10isRootInvocation\x1a(\n" +
