...
var file_go_chromium_org_luci_analysis_proto_bq_test_verdict_row_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xbc, 0x12, 0x0a, 0x0e, 0x54, 0x65, 0x73, 0x74, 0x56, 0x65, 0x72, 0x64, 0x69,
	...
	0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x1a, 0xa7, 0x03, 0x0a, 0x0a, 0x54, 0x65,
	...
	,
...
var file_go_chromium_org_luci_analysis_proto_bq_test_verdict_row_proto_goTypes = []interface{}{
	...
	(v1.TestVerdictStatus)(0),                       // 9: luci.analysis.v1.TestVerdictStatus
	...
	(*v1.FailureReason)(nil),                        // 15: luci.analysis.v1.FailureReason
	(v1.ExonerationReason)(0),                       // 16: luci.analysis.v1.ExonerationReason
...
var file_go_chromium_org_luci_analysis_proto_bq_test_verdict_row_proto_depIdxs = []int32{
	...
	8,  // 1: luci.analysis.bq.TestVerdictRow.partition_time:type_name -> google.protobuf.Timestamp
	9,  // 2: luci.analysis.bq.TestVerdictRow.status:type_name -> luci.analysis.v1.TestVerdictStatus
	2,  // 3: luci.analysis.bq.TestVerdictRow.results:type_name -> luci.analysis.bq.TestVerdictRow.TestResult
	3,  // 4: luci.analysis.bq.TestVerdictRow.exonerations:type_name -> luci.analysis.bq.TestVerdictRow.Exoneration
	4,  // 5: luci.analysis.bq.TestVerdictRow.counts:type_name -> luci.analysis.bq.TestVerdictRow.Counts
	5,  // 6: luci.analysis.bq.TestVerdictRow.buildbucket_build:type_name -> luci.analysis.bq.TestVerdictRow.BuildbucketBuild
	6,  // 7: luci.analysis.bq.TestVerdictRow.change_verifier_run:type_name -> luci.analysis.bq.TestVerdictRow.ChangeVerifierRun
	10, // 8: luci.analysis.bq.TestVerdictRow.sources:type_name -> luci.analysis.v1.Sources
	11, // 9: luci.analysis.bq.TestVerdictRow.source_ref:type_name -> luci.analysis.v1.SourceRef
	...
	14, // 12: luci.analysis.bq.TestVerdictRow.TestResult.status:type_name -> luci.analysis.v1.TestResultStatus
	8,  // 13: luci.analysis.bq.TestVerdictRow.TestResult.start_time:type_name -> google.protobuf.Timestamp
	13, // 14: luci.analysis.bq.TestVerdictRow.TestResult.tags:type_name -> luci.analysis.v1.StringPair
	15, // 15: luci.analysis.bq.TestVerdictRow.TestResult.failure_reason:type_name -> luci.analysis.v1.FailureReason
	16, // 16: luci.analysis.bq.TestVerdictRow.Exoneration.reason:type_name -> luci.analysis.v1.ExonerationReason
	7,  // 17: luci.analysis.bq.TestVerdictRow.BuildbucketBuild.builder:type_name -> luci.analysis.bq.TestVerdictRow.BuildbucketBuild.Builder
	17, // 18: luci.analysis.bq.TestVerdictRow.ChangeVerifierRun.mode:type_name -> luci.analysis.v1.PresubmitRunMode
