...
var file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDesc = []byte{
...
var (
	...
	file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDescData = file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDesc
)
...
func file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDescData)
	})
...
func file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*GroupedChangepointRow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_analysis_proto_bq_grouped_changepoint_row_proto_rawDesc = nil
