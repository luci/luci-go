...
// NewClient creates a new client for exporting test artifacts
...
// Client provides methods to export test artifacts to BigQuery
// via the BigQuery Write API.
type Client struct {
...
func (c *Client) ensureSchema(ctx context.Context) error {
	...
	if err := schemaApplier.EnsureTable(ctx, table, tableMetadata, bq.UpdateMetadata()); err != nil {
		return errors.Fmt("ensuring test artifact table: %w", err)
	}
...
func (c *Client) Insert(ctx context.Context, rows []*bqpb.AntsArtifactRow) error {
