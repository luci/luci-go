...
const tableName = "ants_test_artifacts"
...
const rowMessage = "luci.analysis.bq.legacy.AntsArtifactRow"
...
func init() {
	...
	tableMetadata = &bigquery.TableMetadata{
		...
		Description: "Contains test artifacts produced by Android.",
...
func generateRowSchema() (schema bigquery.Schema, err error) {
	fd, _ := descriptor.MessageDescriptorProto(&bqpb.AntsArtifactRow{})
