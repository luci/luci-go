		...
		expectedResults := []*lowlatency.TestResult{
			{
				...
				VariantHash:      "hash",
				Sources:          sources,
				RootInvocationID: lowlatency.RootInvocationID{Value: "test-root-invocation-name", IsLegacy: true},
				WorkUnitID:       lowlatency.WorkUnitID{Value: "test-invocation-name", IsLegacy: true},
				ResultID:         "one",
