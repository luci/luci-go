...
func file_go_chromium_org_luci_analysis_internal_admin_proto_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_analysis_internal_admin_proto_admin_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BackfillTestResultsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_go_chromium_org_luci_analysis_internal_admin_proto_admin_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BackfillTestResultsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
