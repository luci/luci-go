...
func file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_msgTypes[2].Exporter = func(v any, i int) any {
