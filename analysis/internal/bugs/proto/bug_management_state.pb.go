...
type BugManagementState struct {
	...
	PolicyState map[string]*BugManagementState_PolicyState `protobuf:"bytes,2,rep,name=policy_state,json=policyState,proto3" json:"policy_state,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDesc = []byte{
...
var (
	...
	file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDescData = file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDesc
)
...
func file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDescData)
	})
...
var file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_go_chromium_org_luci_analysis_internal_bugs_proto_bug_management_state_proto_rawDesc = nil
