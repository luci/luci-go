...
export interface DistinctClusterFailure {
  ...
  /**
   * The first 80 characters of the failure_reason.primary_error_message
...
export const ClusterRequest = {
  encode(message: ClusterRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.project !== "") {
      writer.uint32(10).string(message.project);
    }
    for (const v of message.testResults) {
      ClusterRequest_TestResult.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterRequest {
...
export const ClusterRequest_TestResult = {
  encode(message: ClusterRequest_TestResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.failureReason !== undefined) {
      FailureReason.encode(message.failureReason, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterRequest_TestResult {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterResponse = {
  encode(message: ClusterResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.clusteredTestResults) {
      ClusterResponse_ClusteredTestResult.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.clusteringVersion !== undefined) {
      ClusteringVersion.encode(message.clusteringVersion, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterResponse_ClusteredTestResult = {
  encode(message: ClusterResponse_ClusteredTestResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.requestTag !== "") {
      writer.uint32(10).string(message.requestTag);
    }
    for (const v of message.clusters) {
      ClusterResponse_ClusteredTestResult_ClusterEntry.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterResponse_ClusteredTestResult {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterResponse_ClusteredTestResult_ClusterEntry = {
  encode(
    message: ClusterResponse_ClusteredTestResult_ClusterEntry,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.clusterId !== undefined) {
      ClusterId.encode(message.clusterId, writer.uint32(10).fork()).ldelim();
    }
    if (message.bug !== undefined) {
      AssociatedBug.encode(message.bug, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterResponse_ClusteredTestResult_ClusterEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusteringVersion = {
  encode(message: ClusteringVersion, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.algorithmsVersion !== 0) {
      writer.uint32(8).int32(message.algorithmsVersion);
    }
    if (message.rulesVersion !== undefined) {
      Timestamp.encode(toTimestamp(message.rulesVersion), writer.uint32(18).fork()).ldelim();
    }
    if (message.configVersion !== undefined) {
      Timestamp.encode(toTimestamp(message.configVersion), writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusteringVersion {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Cluster = {
  encode(message: Cluster, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.metrics).forEach(([key, value]) => {
      Cluster_MetricsEntry.encode({ key: key as any, value }, writer.uint32(82).fork()).ldelim();
    });
...
export const Cluster_Counts = {
  encode(message: Cluster_Counts, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Cluster_Counts {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.nominal = longToString(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const Cluster_TimewiseCounts = {
  encode(message: Cluster_TimewiseCounts, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.oneDay !== undefined) {
      Cluster_Counts.encode(message.oneDay, writer.uint32(18).fork()).ldelim();
    }
    if (message.threeDay !== undefined) {
      Cluster_Counts.encode(message.threeDay, writer.uint32(26).fork()).ldelim();
    }
    if (message.sevenDay !== undefined) {
      Cluster_Counts.encode(message.sevenDay, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): Cluster_TimewiseCounts {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Cluster_MetricsEntry = {
  encode(message: Cluster_MetricsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      Cluster_TimewiseCounts.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): Cluster_MetricsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetReclusteringProgressRequest = {
  encode(message: GetReclusteringProgressRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetReclusteringProgressRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ReclusteringProgress = {
  encode(message: ReclusteringProgress, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    ...
    if (message.last !== undefined) {
      ClusteringVersion.encode(message.last, writer.uint32(42).fork()).ldelim();
    }
    if (message.next !== undefined) {
      ClusteringVersion.encode(message.next, writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ReclusteringProgress {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterSummariesRequest = {
  encode(message: QueryClusterSummariesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.project !== "") {
      writer.uint32(10).string(message.project);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterSummariesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterSummariesResponse = {
  encode(message: QueryClusterSummariesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.clusterSummaries) {
      ClusterSummary.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterSummariesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterSummary = {
  encode(message: ClusterSummary, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.clusterId !== undefined) {
      ClusterId.encode(message.clusterId, writer.uint32(10).fork()).ldelim();
    }
    if (message.title !== "") {
    ...
    if (message.bug !== undefined) {
      AssociatedBug.encode(message.bug, writer.uint32(26).fork()).ldelim();
    }
    Object.entries(message.metrics).forEach(([key, value]) => {
      ClusterSummary_MetricsEntry.encode({ key: key as any, value }, writer.uint32(58).fork()).ldelim();
    });
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterSummary {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterSummary_MetricValue = {
  encode(message: ClusterSummary_MetricValue, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.value !== "0") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterSummary_MetricValue {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          if (tag === 16) {
            message.dailyBreakdown.push(longToString(reader.int64() as Long));
...
export const ClusterSummary_MetricsEntry = {
  encode(message: ClusterSummary_MetricsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      ClusterSummary_MetricValue.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterSummary_MetricsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterFailuresRequest = {
  encode(message: QueryClusterFailuresRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.parent !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterFailuresRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterFailuresResponse = {
  encode(message: QueryClusterFailuresResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.failures) {
      DistinctClusterFailure.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterFailuresResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DistinctClusterFailure = {
  encode(message: DistinctClusterFailure, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.testId !== "") {
    ...
    if (message.partitionTime !== undefined) {
      Timestamp.encode(toTimestamp(message.partitionTime), writer.uint32(26).fork()).ldelim();
    }
    if (message.presubmitRun !== undefined) {
      DistinctClusterFailure_PresubmitRun.encode(message.presubmitRun, writer.uint32(34).fork()).ldelim();
    }
    if (message.isBuildCritical === true) {
      writer.uint32(40).bool(message.isBuildCritical);
    }
    for (const v of message.exonerations) {
      DistinctClusterFailure_Exoneration.encode(v!, writer.uint32(50).fork()).ldelim();
    }
    ...
    if (message.isIngestedInvocationBlocked === true) {
      writer.uint32(72).bool(message.isIngestedInvocationBlocked);
    }
    for (const v of message.changelists) {
      Changelist.encode(v!, writer.uint32(82).fork()).ldelim();
    }
    if (message.count !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DistinctClusterFailure {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DistinctClusterFailure_Exoneration = {
  encode(message: DistinctClusterFailure_Exoneration, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.reason !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DistinctClusterFailure_Exoneration {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DistinctClusterFailure_PresubmitRun = {
  encode(message: DistinctClusterFailure_PresubmitRun, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.presubmitRunId !== undefined) {
      PresubmitRunId.encode(message.presubmitRunId, writer.uint32(10).fork()).ldelim();
    }
    if (message.owner !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DistinctClusterFailure_PresubmitRun {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterExoneratedTestVariantsRequest = {
  encode(message: QueryClusterExoneratedTestVariantsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.parent !== "") {
      writer.uint32(10).string(message.parent);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterExoneratedTestVariantsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterExoneratedTestVariantsResponse = {
  encode(message: QueryClusterExoneratedTestVariantsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.testVariants) {
      ClusterExoneratedTestVariant.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterExoneratedTestVariantsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterExoneratedTestVariant = {
  encode(message: ClusterExoneratedTestVariant, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.testId !== "") {
      writer.uint32(10).string(message.testId);
    }
    if (message.variant !== undefined) {
    ...
    if (message.lastExoneration !== undefined) {
      Timestamp.encode(toTimestamp(message.lastExoneration), writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterExoneratedTestVariant {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterHistoryRequest = {
  encode(message: QueryClusterHistoryRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.project !== "") {
      writer.uint32(10).string(message.project);
    }
    if (message.failureFilter !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterHistoryRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryClusterHistoryResponse = {
  encode(message: QueryClusterHistoryResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.days) {
      ClusterHistoryDay.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryClusterHistoryResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterHistoryDay = {
  encode(message: ClusterHistoryDay, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.metrics).forEach(([key, value]) => {
      ClusterHistoryDay_MetricsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
    if (message.date !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterHistoryDay {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClusterHistoryDay_MetricsEntry = {
  encode(message: ClusterHistoryDay_MetricsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClusterHistoryDay_MetricsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
