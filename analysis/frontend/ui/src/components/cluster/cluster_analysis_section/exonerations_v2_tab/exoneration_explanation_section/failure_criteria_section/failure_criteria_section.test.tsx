...
describe('Test FailureCriteriaSection', () => {
  it('shows statistics related to the criteria', async () => {
    ...
    expect(screen.getByTestId('unexpected_verdict_count')).toHaveTextContent('(current value: 101)');
    expect(screen.getByTestId('consecutive_unexpected_verdict_count')).toHaveTextContent('(current value: 102)');
