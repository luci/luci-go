...
describe('Test ExonerationsTableRows component', () => {
  it('displays test variant statistics', async () => {
    const testVariantBranch = new ExoneratedTestVariantBranchBuilder().almostMeetsFailureThreshold().build();
  ...
  it('details popup opens and closes', async () => {
    const testVariantBranch = new ExoneratedTestVariantBranchBuilder().almostMeetsFlakyThreshold().build();
