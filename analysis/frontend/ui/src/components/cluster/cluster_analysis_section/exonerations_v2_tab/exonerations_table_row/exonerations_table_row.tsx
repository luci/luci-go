...
import { sourceRefLink, testHistoryLink } from '@/tools/urlHandling/links';
import { variantAsPairs } from '@/tools/variant_tools';
...
const ExonerationsTableRow = ({
  ...
  return (
    <TableRow>
      ...
      <WrappingTableCell>
        {variantAsPairs(testVariantBranch.variant).map((vp) => vp.key + ': ' + vp.value).join(', ')}
      </WrappingTableCell>
      <WrappingTableCell>
        <Link
      ...
      <WrappingTableCell>
        <Link
          ...
          href={testHistoryLink(project, testVariantBranch.testId, testVariantBranch.variant)}
          target="_blank">
          View
        </Link>
      </WrappingTableCell>
      ...
      <WrappingTableCell>
        ...
        <Dialog open={open} onClose={handleClose} maxWidth='lg' fullWidth>
          ...
          <DialogContent>
            <ExonerationExplanationSection criteria={criteria} project={project} testVariantBranch={testVariantBranch} />
          </DialogContent>
          <DialogActions>
      ...
      <WrappingTableCell>
        {dayjs(testVariantBranch.lastExoneration).fromNow()}
      </WrappingTableCell>
    </TableRow>
  );
};
