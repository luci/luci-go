...
import { SortableField } from '@/components/cluster/cluster_analysis_section/exonerations_tab/model/model';
        ...
        <TableCell
          ...
          <TableSortLabel
            ...
            onClick={() => toggleSort('beingExonerated')}>
              Is Being Exonerated <HelpTooltip text='Whether the test variant is currently being exonerated (ignored) by the commit queue.' />
          </TableSortLabel>
        </TableCell>
        <TableCell
