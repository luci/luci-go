  ...
  return (
    <>
      ...
      <Typography component='div'>
        Where:
        <ul>
          <li><strong>Recent verdicts</strong>: The 10 most recent verdicts for the test variant, filtered to:
            <ul>
              <li>at most one verdict per distinct changelist</li>
              <li>exclude changelists generated by automation (e.g. autorollers)</li>
            </ul>
          </li>
          <li><strong>Unexpected test run</strong>: A swarming task for which all test results were unexpected (skips excluded).</li>
        </ul>
      </Typography>
      <Typography variant="h6">
        Recent verdicts
      ...
      <Table size="small">
        ...
        <TableBody>
          {testVariant.recentVerdicts.map((verdict: TestVariantFailureRateAnalysis_RecentVerdict, i: number) => {
            return (
