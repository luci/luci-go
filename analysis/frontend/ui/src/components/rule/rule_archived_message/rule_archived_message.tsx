        ...
        >
            <Container maxWidth={false}>
                <Typography>
                    ...
                    <ul>
                        <li>Failures are no longer associated with this rule, even if they match the rule definition</li>
                        <li>This rule will not prevent new bugs from being filed by LUCI Analysis</li>
