...
const definitionUnavailableTooltipText = 'To view this information, your project administrator will need to grant you the "analysis.rules.getDefinition" permission. ' +
...
const RuleDefinition = ({
  ...
  if (definition) {
    return (
      <>
        <IconButton data-testid="rule-definition-edit" onClick={() => onEditClicked()} aria-label="edit" sx={{ float: 'right' }}>
          <Edit />
        </IconButton>
