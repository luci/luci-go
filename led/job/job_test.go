...
func TestFlattenToSwarming(t *testing.T) {
	...
	Convey(`FlattenToSwarming`, t, func() {
		...
		Convey(`bbagent`, func() {
			So(bbJob.FlattenToSwarming(ctx, "username", "parent_task_id", NoKitchenSupport(), false), ShouldBeNil)
		...
		Convey(`kitchen`, func() {
			...
			So(bbJob.FlattenToSwarming(ctx, "username", "parent_task_id", NoKitchenSupport(), false), ShouldErrLike,
