...
//
// Deprecated. Fields are copied to buildbucket.v2.Build, and will be removed
// later.
type Buildbucket struct {
	...
	// Deprecated. Renamed to user_packages and moved to
	// buildbucket.v2.BuildInfra.Buildbucket.
	...
	// Deprecated. env_vars is purely a reflection of build.experimental.
	EnvVars []*api.StringPair `protobuf:"bytes,3,rep,name=env_vars,json=envVars,proto3" json:"env_vars,omitempty"`
	// Deprecated. env_prefixes can be derived from cipd_packages.
	...
	// Deprecated. Moved to buildbucket.v2.BuildInfra.Swarming.
	...
	// launched.
	//
	// Deprecated. legacy_kitchen can be derived from buildbucket.exe.cmd[0].
	...
	//
	// Deprecated. Renamed to task_name and moved to
	// buildbucket.v2.BuildInfra.Swarming.
	...
	//
	// Deprecated. Moved to buildbucket.v2.Executable.
