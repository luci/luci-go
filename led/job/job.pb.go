...
type Definition struct {
	...
	// WILL BE DEPRECATED AFTER MIGRATION TO RBE-CAS.
	//
	...
	// If set, this holds the CASReference to use with the build, when launched.
	//
	// At the time of launch, this will be merged with
	// swarming.task_slice[*].properties.cas_input_root, if any.
	//
	// can only either use cas_user_payload or user_payload.
