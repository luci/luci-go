...
func ToSwarmingNewTask(sw *job.Swarming, userPayload *apipb.CASTree, casUserPayload *apipb.CASReference) (*swarming.SwarmingRpcsNewTaskRequest, error) {
	...
	for i, slice := range task.TaskSlices {
		...
		// validate isolate and rbe-cas related fields in the task slice.
		...
		//
		// (This is awkward due to the twisted logic.It will look a bit better,
		// after completely getting rid of isolate support.)
