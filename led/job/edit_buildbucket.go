...
func (bbm *buildbucketEditor) TaskPayload(cipdPkg, cipdVers, pathInTask string) {
	bbm.tweak(func() error {
		bbm.bb.BbagentArgs.ExecutablePath = path.Join(pathInTask, "luciexe")
		if cipdPkg != "" && cipdVers != "" {
...
// if you're editing this value, do so before passing the Definition through
