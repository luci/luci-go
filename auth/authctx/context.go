...
// ambient authentication (if requested options need it, e.g. when using
...
//   1. Updates LUCI_CONTEXT in 'ctx' to use the local token server.
//   2. Mutates 'env' so that various third party tools also use local tokens.
//
