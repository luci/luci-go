...
// Context know how to prepare an environment with ambient authentication for
...
type Context struct {
	...
	// the new LUCI_CONTEXT.
	//
	// Either way, subprocesses launched with an environment modified by
	// 'ExportIntoEnv' will see a functional LUCI_CONTEXT.
