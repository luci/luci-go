...
//
// For files, the returned value is a map from the pending item to PushedDirectoryItem.
// For in-tree symlinks, the returned value is a map from the relative path to its
