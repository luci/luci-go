...
WARNING: command /relative_cwd in isolated file will be unsupported soon.
Please conntact the LUCI team in crbug.com/1069704 if you see this warning.
`)
		} else {
			os.Stderr.WriteString(`
ERROR: command / relative_cwd in isolated file will be unsupported soon.
...
`)
	...
	isolSummary, err := archiver.Archive(deps, rootDir, opts.Blacklist, opts.Isolated, isol)
	if err != nil {
