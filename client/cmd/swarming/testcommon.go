...
type testService struct {
	...
	getTaskIsolated func(context.Context, *swarming.SwarmingRpcsFilesRef, string) error
}
...
func (s testService) GetTaskIsolated(c context.Context, ref *swarming.SwarmingRpcsFilesRef, output string) error {
	return s.getTaskIsolated(c, ref, output)
}
