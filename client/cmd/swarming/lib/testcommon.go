...
type testService struct {
	...
	getTaskFilesFromIsolate func(context.Context, string, *swarming.SwarmingRpcsFilesRef) ([]string, error)
	getTaskFilesFromCAS     func(context.Context, string, *rbeclient.Client, *swarming.SwarmingRpcsCASReference) ([]string, error)
...
func (s testService) GetTaskFilesFromIsolate(ctx context.Context, output string, isolateRef *swarming.SwarmingRpcsFilesRef) ([]string, error) {
	return s.getTaskFilesFromIsolate(ctx, output, isolateRef)
}

func (s testService) GetTaskFilesFromCAS(ctx context.Context, outdir string, cascli *rbeclient.Client, casRef *swarming.SwarmingRpcsCASReference) ([]string, error) {
	return s.getTaskFilesFromCAS(ctx, outdir, cascli, casRef)
}
