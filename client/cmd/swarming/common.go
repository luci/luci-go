...
type swarmingService interface {
	...
	CountTasksByTag(ctx context.Context, tag string) (*swarming.SwarmingRpcsTasksCount, error)
	ListTasksByTag(ctx context.Context, tag string) (*swarming.SwarmingRpcsTaskList, error)
...
func (s *swarmingServiceImpl) CountTasksByTag(ctx context.Context, tag string) (res *swarming.SwarmingRpcsTasksCount, err error) {
	err = retryGoogleRPC(ctx, "CountTasksByTag", func() (ierr error) {
		res, ierr = s.Service.Tasks.Count().Context(ctx).Tags(tag).Do()
		return
	})
	return
}

func (s *swarmingServiceImpl) ListTasksByTag(ctx context.Context, tag string) (res *swarming.SwarmingRpcsTaskList, err error) {
	err = retryGoogleRPC(ctx, "ListTasksByTag", func() (ierr error) {
		res, ierr = s.Service.Tasks.List().Context(ctx).Tags(tag).Do()
		return
	})
	return
}
