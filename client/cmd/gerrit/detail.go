...
func cmdDetail(authOpts auth.Options) *subcommands.Command {
	return &subcommands.Command{
		UsageLine: "detail <options> url id",
...
func (c *detailRun) Parse(a subcommands.Application, args []string) error {
...
func (c *detailRun) main(a subcommands.Application, args []string) error {
...
func (c *detailRun) Run(a subcommands.Application, args []string, _ subcommands.Env) int {
