...
func newChangeRun(authOpts auth.Options, cmdOpts changeRunOptions, apiFunc apiCall) *changeRun {
	...
	if c.jsonInput {
		c.Flags.StringVar(&c.input.jsonInput, "input", "", "an input file containing the json input for the request")
	}
	if c.queryInput {
...
https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#create-change`,
		CommandRun: func() subcommands.CommandRun {
			return newChangeRun(authOpts, changeRunOptions{jsonInput: true}, runner)
		},
	}
}
...
Example:
  ...
  gerrit change-query -options CURRENT_REVISION -options DETAILED_ACCOUNTS https://gerrit.host.example.com/repo owner:name@example.com`,
		CommandRun: func() subcommands.CommandRun {
			return newChangeRun(authOpts, changeRunOptions{queryInput: true}, runner)
		},
	}
}
...
https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#list-changes`,
		CommandRun: func() subcommands.CommandRun {
			return newChangeRun(authOpts, changeRunOptions{changeID: true, queryInput: true}, runner)
		},
	}
}
