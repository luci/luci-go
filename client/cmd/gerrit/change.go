...
func cmdGetMergeable(authOpts auth.Options) *subcommands.Command {
	...
	return &subcommands.Command{
		UsageLine: "get-mergable <options>",
		ShortDesc: "Checks if this change and revision are mergable",
		LongDesc: `Checks the mergeability check on a change and revision.
...
More information on "get mergerable" may be found here:
