...
func (af *testAuthFlags) NewClient(ctx context.Context, instance string, _ bool) (*cas.Client, error) {
...
func (af *testAuthFlags) NewClientLegacy(ctx context.Context, _ string, _ bool) (*client.Client, error) {
