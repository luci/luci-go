...
// or return an error.
type WriterGenerator func(string) (io.Writer, error)
...
func (d *Downloader) doFileJob(hash isolated.HexDigest, out io.Writer) {
...
// FetchFile downloads a single file from the isolateserver by hash.
//
// This method is non-blocking.
func (d *Downloader) FetchFile(hash isolated.HexDigest, out io.Writer) {
	d.wg.Add(1)
