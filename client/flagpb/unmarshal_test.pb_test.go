...
type MapContainer struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ss            map[string]string      `protobuf:"bytes,1,rep,name=ss,proto3" json:"ss,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Ii            map[int32]int32        `protobuf:"bytes,2,rep,name=ii,proto3" json:"ii,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	Sm1           map[string]*M1         `protobuf:"bytes,3,rep,name=sm1,proto3" json:"sm1,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDesc = string([]byte{
...
var (
	...
	file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDescData []byte
)
...
func file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDescGZIP() []byte {
	file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDescOnce.Do(func() {
		file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDesc), len(file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDesc)))
	})
...
func file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDesc), len(file_go_chromium_org_luci_client_flagpb_unmarshal_test_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
