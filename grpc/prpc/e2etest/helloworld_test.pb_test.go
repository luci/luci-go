...
var file_go_chromium_org_luci_grpc_prpc_e2etest_helloworld_test_proto_goTypes = []any{
...
func file_go_chromium_org_luci_grpc_prpc_e2etest_helloworld_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_grpc_prpc_e2etest_helloworld_test_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_go_chromium_org_luci_grpc_prpc_e2etest_helloworld_test_proto_msgTypes[1].Exporter = func(v any, i int) any {
