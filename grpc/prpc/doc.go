...
// ## v1.3
//
// v1.3 adds request/response body compression support using Lempel-Ziv coding
...
//  - A request MAY have a header "Accept-Encoding: gzip" (literally).
//    If it is present, then the server response body SHOULD be compressed.
//    If it is, then the response MUST include a header "Content-Encoding: gzip".
//
