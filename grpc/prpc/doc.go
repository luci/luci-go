...
// Protocol
//
// pRPC protocol has versions v1.0 and v1.1. This section describes
// them in this order.
//
//   v1.0
//
...
//   v1.1
//
// pRPC v1.1 is v1.0 with the following amendments.
//
...
//
// If a service implementation returns an error, the error MUST be converted to
...
//
// X-Prpc-Grpc-Code response header is deprecated and should not used.
