...
var (
	...
	grpcClientDuration = metric.NewCumulativeDistribution(
		...
		"Distribution of client-side Unary RPC duration (in milliseconds).",
...
// NewUnaryClientInterceptor returns an interceptor that gathers unary RPC call
...
func (m *ClientRPCStatsMonitor) HandleRPC(ctx context.Context, s stats.RPCStats) {
	...
	default:
		...
		// send_msg, sent_msg_bytes, recv_msg, and recv_msg_bytes.
	}
}
