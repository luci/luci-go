...
func file_go_chromium_org_luci_grpc_discovery_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_grpc_discovery_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Void); i {
			case 0:
				return &v.state
			case 1:
		...
		file_go_chromium_org_luci_grpc_discovery_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
