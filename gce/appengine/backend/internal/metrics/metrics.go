...
func UpdateFailures(c context.Context, creations int64, vm *model.VM) {
	creationFailures.Add(c, creations, vm.Prefix, vm.Attributes.GetProject(), vm.Attributes.GetZone())
}
