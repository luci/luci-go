...
func (x *Instance) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *Instance) GetConnected() *timestamp.Timestamp {
	if x != nil {
		return x.Connected
	}
	return nil
...
func (*UnimplementedInstancesServer) Delete(context.Context, *DeleteRequest) (*empty.Empty, error) {
