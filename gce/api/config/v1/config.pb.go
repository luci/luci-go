...
type Schedule struct {
	// The amount of VMs. Deprecated, prefer min and max.
	// TODO(crbug/1033250): Migrate all amounts to min/max.
...
type Amount struct {
	// The default amount to use outside scheduled hours. Deprecated, prefer min
	// and max.
...
func (m *Config) GetOwners() []string {
	if m != nil {
		return m.Owners
	}
	return nil
...
var fileDescriptor_56a5743e153a90ec = []byte{
	...
	,
}
