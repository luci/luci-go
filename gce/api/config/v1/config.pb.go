...
var file_go_chromium_org_luci_gce_api_config_v1_config_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x6e, 0x6f, 0x64, 0x65, 0x41, 0x66, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x79, 0x22, 0xd7,
	0x05, 0x0a, 0x02, 0x56, 0x4d, 0x12, 0x20, 0x0a, 0x04, 0x64, 0x69, 0x73, 0x6b, 0x18, 0x01, 0x20,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x1a, 0x38,
	...
	0x6d, 0x61, 0x78, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x22, 0xc7, 0x02, 0x0a, 0x06, 0x43, 0x6f,
	...
	,
	...
	0x4e, 0x10, 0x02, 0x42, 0x7a, 0xa2, 0xfe, 0x23, 0x47, 0x0a, 0x45, 0x68, 0x74, 0x74, 0x70, 0x73,
	...
	0x61, 0x73, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x67, 0x63, 0x65, 0x2d,
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x3a, 0x76, 0x6d, 0x73, 0x2e, 0x63, 0x66, 0x67,
...
var file_go_chromium_org_luci_gce_api_config_v1_config_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_go_chromium_org_luci_gce_api_config_v1_config_proto_goTypes = []interface{}{
	...
	(*ServiceAccount)(nil),    // 3: config.ServiceAccount
	(*AccessConfig)(nil),      // 4: config.AccessConfig
	(*NetworkInterface)(nil),  // 5: config.NetworkInterface
	(*Disk)(nil),              // 6: config.Disk
	(*Metadata)(nil),          // 7: config.Metadata
	(*NodeAffinity)(nil),      // 8: config.NodeAffinity
	(*Scheduling)(nil),        // 9: config.Scheduling
	(*VM)(nil),                // 10: config.VM
	(*TimePeriod)(nil),        // 11: config.TimePeriod
	(*TimeOfDay)(nil),         // 12: config.TimeOfDay
	(*Schedule)(nil),          // 13: config.Schedule
	(*Amount)(nil),            // 14: config.Amount
	(*Config)(nil),            // 15: config.Config
	(*Configs)(nil),           // 16: config.Configs
	nil,                       // 17: config.VM.LabelEntry
...
var file_go_chromium_org_luci_gce_api_config_v1_config_proto_depIdxs = []int32{
	...
	4,  // 1: config.NetworkInterface.access_config:type_name -> config.AccessConfig
	...
	8,  // 4: config.Scheduling.node_affinity:type_name -> config.NodeAffinity
	6,  // 5: config.VM.disk:type_name -> config.Disk
	7,  // 6: config.VM.metadata:type_name -> config.Metadata
	5,  // 7: config.VM.network_interface:type_name -> config.NetworkInterface
	3,  // 8: config.VM.service_account:type_name -> config.ServiceAccount
	9,  // 9: config.VM.scheduling:type_name -> config.Scheduling
	17, // 10: config.VM.label:type_name -> config.VM.LabelEntry
	18, // 11: config.TimeOfDay.day:type_name -> google.type.DayOfWeek
	11, // 12: config.Schedule.length:type_name -> config.TimePeriod
	12, // 13: config.Schedule.start:type_name -> config.TimeOfDay
	13, // 14: config.Amount.change:type_name -> config.Schedule
	14, // 15: config.Config.amount:type_name -> config.Amount
	10, // 16: config.Config.attributes:type_name -> config.VM
	11, // 17: config.Config.lifetime:type_name -> config.TimePeriod
	11, // 18: config.Config.timeout:type_name -> config.TimePeriod
	15, // 19: config.Configs.vms:type_name -> config.Config
