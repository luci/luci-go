...
func (m *Adjustable) Reset()         { *m = Adjustable{} }
func (m *Adjustable) String() string { return proto.CompactTextString(m) }
func (*Adjustable) ProtoMessage()    {}
func (*Adjustable) Descriptor() ([]byte, []int) {
	return fileDescriptor_56a5743e153a90ec, []int{9}
}

func (m *Adjustable) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Adjustable.Unmarshal(m, b)
}
func (m *Adjustable) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Adjustable.Marshal(b, m, deterministic)
}
func (m *Adjustable) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Adjustable.Merge(m, src)
}
func (m *Adjustable) XXX_Size() int {
	return xxx_messageInfo_Adjustable.Size(m)
}
func (m *Adjustable) XXX_DiscardUnknown() {
	xxx_messageInfo_Adjustable.DiscardUnknown(m)
}

var xxx_messageInfo_Adjustable proto.InternalMessageInfo

func (m *Adjustable) GetMin() int32 {
	if m != nil {
		return m.Min
	}
	return 0
...
func (m *Adjustable) GetMax() int32 {
	if m != nil {
		return m.Max
	}
	return 0
...
func (m *Adjustable) GetGroup() []string {
	if m != nil {
		return m.Group
	}
	return nil
...
// An amount of VMs.
// Scheduled changes an external amounts are mutually exclusive. Schedules can
// be used to vary the amount of VMs based on a time of day, while external can
// be used to allow the amount to be varied by an RPC at any time.
type Amount struct {
	...
	// The parameters for an amount of VMs which can be set via RPC.
	Adjustable           *Adjustable `protobuf:"bytes,3,opt,name=adjustable,proto3" json:"adjustable,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Amount) GetAdjustable() *Adjustable {
	if m != nil {
		return m.Adjustable
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Adjustable)(nil), "config.Adjustable")
...
var fileDescriptor_56a5743e153a90ec = []byte{
	...
	,
}
