...
type connectCmd struct {
	...
	server string
	// user is the name of the user to start the Swarming bot process as.
	user string
}
...
func newConnectCmd() *subcommands.Command {
	return &subcommands.Command{
		...
		CommandRun: func() subcommands.CommandRun {
			...
			cmd.Flags.StringVar(&cmd.user, "user", "", "Name of the user to start the Swarming bot process as.")
			return cmd
		},
	}
}
