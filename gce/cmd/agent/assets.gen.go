...
var files = map[string]string{
	...
	"swarming-start-bot.service.tmpl": string([]byte{35, 32,
		...
		84, 95, 83, 69, 84, 85, 80, 61, 49, 10, 69, 120, 101, 99,
		83, 116, 97, 114, 116, 61, 32, 123, 123, 46, 80, 121, 116, 104,
		111, 110, 125, 125, 32, 123, 123, 46, 66, 111, 116, 67, 111, 100,
		101, 125, 125, 32, 115, 116, 97, 114, 116, 95, 98, 111, 116, 10,
		10, 91, 73, 110, 115, 116, 97, 108, 108, 93, 10, 87, 97, 110,
		116, 101, 100, 66, 121, 61, 99, 108, 111, 117, 100, 45, 105, 110,
		105, 116, 46, 116, 97, 114, 103, 101, 116, 10}),
}
...
var fileSha256s = map[string][]byte{
	...
	"swarming-start-bot.conf.tmpl": {202, 12,
		...
		80, 147},
	"swarming-start-bot.service.tmpl": {241, 18,
		128, 11, 137, 144, 224, 166, 168, 87, 173, 247, 86, 61, 137, 191,
		185, 193, 187, 172, 80, 171, 120, 182, 211, 22, 152, 71, 43, 254,
		26, 25},
}
