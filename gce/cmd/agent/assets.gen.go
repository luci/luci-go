...
var files = map[string]string{
	"swarming-start-bot.bat.tmpl": string([]byte{58, 58,
		...
		66, 79, 84, 95, 83, 69, 84, 85, 80, 61, 49, 10, 83, 69,
		84, 32, 80, 65, 84, 72, 61, 37, 80, 65, 84, 72, 37, 59,
		67, 58, 92, 116, 111, 111, 108, 115, 92, 112, 121, 116, 104, 111,
		110, 51, 92, 98, 105, 110, 10, 64, 67, 58, 92, 116, 111, 111,
		108, 115, 92, 112, 121, 116, 104, 111, 110, 92, 98, 105, 110, 92,
		112, 121, 116, 104, 111, 110, 46, 101, 120, 101, 32, 123, 123, 46,
...
var fileSha256s = map[string][]byte{
	"swarming-start-bot.bat.tmpl": {200, 11,
		185, 18, 241, 79, 58, 71, 182, 95, 60, 124, 184, 91, 71, 103,
		122, 250, 40, 57, 33, 8, 56, 18, 133, 14, 124, 75, 45, 117,
		94, 104},
