...
var files = map[string]string{
	...
	"swarming-start-bot.service.tmpl": string([]byte{35, 32,
		...
		85, 80, 61, 49, 10, 69, 110, 118, 105, 114, 111, 110, 109, 101,
		110, 116, 70, 105, 108, 101, 61, 45, 47, 101, 116, 99, 47, 115,
		119, 97, 114, 109, 105, 110, 103, 47, 101, 110, 118, 10, 69, 120,
		101, 99, 83, 116, 97, 114, 116, 61, 32, 123, 123, 46, 80, 121,
		116, 104, 111, 110, 125, 125, 32, 123, 123, 46, 66, 111, 116, 67,
		111, 100, 101, 125, 125, 32, 115, 116, 97, 114, 116, 95, 98, 111,
		116, 10, 10, 91, 73, 110, 115, 116, 97, 108, 108, 93, 10, 87,
		97, 110, 116, 101, 100, 66, 121, 61, 99, 108, 111, 117, 100, 45,
		105, 110, 105, 116, 46, 116, 97, 114, 103, 101, 116, 10}),
}
...
var fileSha256s = map[string][]byte{
	...
	"swarming-start-bot.conf.tmpl": {202, 12,
		...
		80, 147},
	"swarming-start-bot.service.tmpl": {74, 227,
		149, 105, 31, 106, 224, 234, 102, 173, 119, 211, 209, 254, 89, 5,
		59, 235, 176, 179, 108, 42, 118, 206, 72, 252, 196, 100, 8, 49,
		139, 116},
}
