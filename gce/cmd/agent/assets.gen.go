...
var files = map[string]string{
	...
	"swarming-start-bot.service.tmpl": string([]byte{35, 32,
		...
		108, 46, 115, 101, 114, 118, 105, 99, 101, 10, 10, 91, 83, 101,
		114, 118, 105, 99, 101, 93, 10, 84, 121, 112, 101, 61, 115, 105,
		109, 112, 108, 101, 10, 85, 115, 101, 114, 61, 123, 123, 46, 85,
		115, 101, 114, 125, 125, 10, 76, 105, 109, 105, 116, 78, 79, 70,
		73, 76, 69, 61, 53, 48, 48, 48, 48, 10, 69, 110, 118, 105,
...
var fileSha256s = map[string][]byte{
	...
	"swarming-start-bot.conf.tmpl": {202, 12,
		...
		80, 147},
	"swarming-start-bot.service.tmpl": {125, 47,
		142, 43, 233, 193, 222, 104, 119, 107, 158, 216, 5, 195, 180, 165,
		242, 105, 137, 146, 198, 251, 12, 37, 251, 177, 108, 150, 208, 151,
		213, 205},
}
